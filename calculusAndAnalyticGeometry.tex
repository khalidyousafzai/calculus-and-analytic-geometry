...
%\includeonly{./tex/mathPreface,./tex/prefaceFirstBook,./tex/calculusPreliminaries,./tex/calculusLimitsAndContinuity,./tex/calculusDerivatives,./tex/calculusApplicationsOfDerivatives,./tex/calculusApplicationsOfDerivativesA,./tex/questions,./tex/calculusAppendixB}
%
%\includeonly{./tex/mathPreface,./tex/prefaceFirstBook,./tex/calculusApplicationsOfDerivatives,./tex/calculusApplicationsOfDerivativesA,./tex/questions,./tex/calculusAppendixB}
%
\includeonly{./tex/cktSymbols,./tex/cktPreface,./tex/prefaceFirstBook,./tex/calculusApplicationsOfDerivativesA,./tex/questions,./tex/calculusAppendixB}%
...
\include{./tex/calculusApplicationsOfDerivativesA}
