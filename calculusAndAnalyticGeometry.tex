...
%\includeonly{./tex/mathPreface,./tex/prefaceFirstBook,./tex/calculusPreliminaries,./tex/calculusLimitsAndContinuity,./tex/calculusDerivatives,./tex/calculusDerivativesA,./tex/calculusAppendixB}
\includeonly{./tex/mathPreface,./tex/prefaceFirstBook,./tex/calculusDerivativesA,./tex/calculusAppendixB}
%
...
\include{./tex/calculusDerivativesA}
