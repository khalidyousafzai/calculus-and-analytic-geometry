...
\usepackage{./tex/khalidUrduBooks}     % polyglossia must be the last package as it handles urdu
...
=======
\includeonly{./tex/cktSymbols,./calculusPreface,./tex/prefaceFirstBook,./tex/test,./tex/calculusDerivatives}%
