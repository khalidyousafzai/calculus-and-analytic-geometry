...
\typeout{kkk: to avail gnuplot functionality must run   "xelatex --shell-escape calculusAndAnalyticGeometry"}
...
\usetikzlibrary{shapes,snakes,3d, shadings,fadings,intersections,calc,decorations.markings, decorations.pathreplacing, external,shapes.misc,decorations.pathmorphing,patterns,shapes.arrows,matrix}
...
%============================
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%to write answere to the following "answer" file, enclose all questions in ابتدا{سوالات}  ، انتہا{سوالات}   environment 
%and enclose each answer within  \wf{\unexpanded{}}. this is places inside the  ابتدا{جواب} environment 
...
%\includeonly{./tex/calculusPreface,./tex/prefaceFirstBook,./tex/calculusFunctions,./tex/calculusLimitsAndContinuity,./tex/calculusDerivatives,./tex/calculusApplicationsOfDerivatives,./tex/calculusIntegration,./tex/calculusApplicationsOfIntegrals,./tex/calculusTranscendentalFunctions,./tex/calculusTechniquesOfIntegration,./tex/calculusInfiniteSeries,./tex/calculusConicSectionsParametrizedCurvesPolarCoordinates,./tex/calculusVectorsAndAnalyticGeometryInSpace,./tex/calculusVectorValuedFunctionsandMotionInSpace,./tex/calculusMultivariableFunctionsAndPartialDerivatives,./tex/calculusMultipleIntegrals,./tex/calculusIntegrationInVectorFields,./tex/calculusAppendixA,./tex/calculusAppendixB,./tex/calculusAppendixC,./tex/calculusAppendixD,./tex/calculusAppendixE,./tex/calculusAppendixF,./tex/calculusAppendixG,./tex/calculusAppendixH,./tex/calculusAppendixI,./tex/calculusIntegrationTable}
%

%\includeonly{,./tex/calculusIntegrationInVectorFields,./tex/calculusAppendixA,./tex/calculusAppendixB,./tex/calculusAppendixC,./tex/calculusAppendixD,./tex/calculusAppendixE,./tex/calculusAppendixF,./tex/calculusAppendixG,./tex/calculusAppendixH,./tex/calculusAppendixI,./tex/calculusIntegrationTable}%

%\includeonly{./tex/calculusDerivatives}
%\includeonly{,./tex/calculusMultivariableFunctionsAndPartialDerivatives}
%\includeonly{./tex/calculusIntegrationInVectorFields,./tex/calculusAppendixA,./tex/calculusAppendixB,./tex/calculusAppendixC,./tex/calculusAppendixD,./tex/calculusAppendixE,./tex/calculusAppendixF,./tex/calculusAppendixG,./tex/calculusAppendixH,./tex/calculusAppendixI}
%\includeonly{,./tex/calculusAppendixA,./tex/calculusAppendixB,./tex/calculusAppendixC,./tex/calculusAppendixD,./tex/calculusAppendixE,./tex/calculusAppendixF,./tex/calculusAppendixG,./tex/calculusAppendixH,./tex/calculusAppendixI,./tex/calculusIntegrationTable}
%\includeonly{./tex/calculusPreface,./tex/prefaceFirstBook,,./tex/calculusAppendixA.}
%\includeonly{,./tex/calculusApplicationsOfIntegrals}
%\includeonly{./tex/calculusConicSectionsParametrizedCurvesPolarCoordinates}
\includeonly{./tex/calculusVectorsAndAnalyticGeometryInSpace}
...
%=======================
\appendix
\addcontentsline{toc}{chapter}{ضمیمے}
\cleardoublepage
...
\chapter*{جوابات}
\typeout{kkk: am about to put answers at the end of the book}
...
\end{multicols}
\typeout{kkk:  finished putting answers at the end of the book}
