...
\addplot[no markers, domain=0:360,smooth , postaction = {decorate}, decoration = {markings, mark = at position 0.4 with {\arrow{Stealth[length = 2mm, bend]}}, mark = at position 0.85 with {\arrow{Stealth[length = 2mm, bend]}}}
] ({f(\x)},{g(\x)});
...
\end{align*}
 ان  مساوات کو آپس میں جمع کرتے ہوئے ہم دیکھتے ہیں کہ  \عددی{C_1} کے لئے  \عددی{b} تا   \عددی{a}  محور \عددی{y} پر لکیری تکمل کو \عددی{C_2} پر اسی قطع  پر   لیکن مخالف رخ کا تکمل کاٹتا ہے۔ یوں   ذیل ہو گا
\begin{align*}
