...
(ب) \quad 
اسی دوہرا تکمل کو   بطور  بار بار تکمل حل کرتے ہوئے، ترتیب الٹ کرنے سے، انتصابی لکیروں کی بجائے  افقی لکیریں استعمال کریں (شکل \حوالہ{شکل_بالکثرت_بار_بار_تکمل_الٹ_ترتیب})۔ تکمل درج ذیل ہو گا۔
\begin{align*}
...
مسئلہ فوبینی کی ایک صورت کہتی ہے کہ اس مجموعہ  کی حد  \عددی{r} اور \عددی{\theta} کے لحاظ سے  درج ذیل  بار بار تکمل  دیگا۔
\begin{align}
...
کارتیسی محدد میں تکمل کی حدیں تلاش کرنے کی ترکیب قطبی محدد میں بھی کارآمد ہے۔
