...
مسئلہ فوبینی مزید کہتا ہے کہ  دوہرا تکمل کی قیمت حاصل کرتے ہوئے ہم بارہا تکمل کسی بھی ترتیب سے حل کر سکتے ہیں، جو بہت کار آمد ثابت ہوتا ہے (جیسا ہم   مثال \حوالہ{مثال_بالکثرت_غیر_بنیادی_تفاعل} میں دیکھتے ہیں)۔بالخصوص حجم کی تلاش میں ہم محور \عددی{x} یا محور \عددی{y} کے عمودی سطحیں لے کر ٹکیاں کاٹ سکتے ہیں۔
