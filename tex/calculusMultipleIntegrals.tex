...
\end{minipage}
\end{figure}
کروی محدد میں  چھوٹے مستطیل حجم  سے  مراد  وہ \اصطلاح{کروی  پچر}\فرہنگ{کروی!پچر}\حاشیہب{spherical wedge}\فرہنگ{spherical!wedge}   ہے جس کو \عددی{\dif r}، \عددی{\dif \phi} اور \عددی{\dif \phi} تعین کرتے ہیں۔ یہ پچر تقریباً مستطیلی ہو گا جس کے ایک اطراف  کی  قوسی لمبائی  \عددی{r\dif\phi}، دوسرے طرف کی قوسی لمبائی  \عددی{r\sin\phi\dif\phi} اور موٹائی  \عددی{\dif r} ہو گی۔ یوں   کروی محدد میں چھوٹے ٹکڑے کا حجم \عددی{\dif H}  (شکل \حوالہ{شکل_کثرت_کروی_چھوٹا_حجم}) 
\begin{align}
\dif H=(\dif r)(r\sin\theta\dif\phi)(r\dif\theta)=r^2\sin\phi \dif r\dif \phi\dif \phi
\end{align}
...
\ابتدا{تعریف}
  \اصطلاح{یعقوبی مقطع}\حاشیہد{یہ ریاضی دان کارل   گستاف یعقوب یعقوبی کے نام سے منسوب ہے۔} یا محددی بدل \عددی{x=g(u,v)}، \عددی{y=h(u,v)} کے \اصطلاح{یعقوبی}\فرہنگ{یعقوبی}\حاشیہب{Jacobian}\فرہنگ{Jacobian} سے مراد درج ذیل ہے:
