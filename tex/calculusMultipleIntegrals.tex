...
\caption{شہتیر ب}
\end{subfigure}
\caption{دونوں شہتیر کا رقبہ عمودی تراش ایک جیسا ہے لیکن شہتیر الف کا جمودی معیار اثر زیادہ ہے لہٰذا  شہتیر الف زیادہ اکڑ ہو گا۔}
...
فرض کریں تفاعل  \عددی{f(r,\theta)} خطہ \عددی{R} پر معین ہے  جس  کے سرحد شعاع \عددی{\theta=\alpha} اور \عددی{\theta=\beta} اور استمراری منحنیات \عددی{r=g_1(\theta)} اور \عددی{r=g_2(\theta)}  ہیں۔مزید \عددی{\alpha} اور \عددی{\beta} کے بیچ ہر قیمت کے لئے \عددی{0\le g_1(\theta)\le g_2(\theta)\le a} ہے۔ یوں  \عددی{R} پنکھا نما  خطہ \عددی{Q} میں، جس کو عدم مساوات \عددی{0\le r\le a,\, \alpha\le\theta\le\beta} ظاہر کرتی ہیں، پایا جائے گا۔
...
اس حد کی قیمت تلاش کرنے کی خاطر ہمیں  مجموعہ \عددی{J_n}  یوں لکھنا ہو گا کہ \عددی{\Delta S_k}  کی قیمت \عددی{\Delta r} اور \عددی{\Delta\theta} کی روپ میں ہو۔ رقبہ \عددی{\Delta S_k} کی  اندرونی قوسی سرحد کا رداس \عددی{r_k-\tfrac{\Delta r}{2}} جبکہ اس کی   بیرونی قوسی سرحد کا رداس \عددی{r_k+\tfrac{\Delta r}{2}} ہے۔ ان قوسین سے مبدا تک دائری تکونی خطوں کے رقبے
\begin{gather}
\begin{aligned}
...
مبدا سے بڑھتی ہوئی  \عددی{r} کے رخ خطہ \عددی{R} سے گزرتا ہوا   شعاع  \عددی{L} کھینچیں۔ جن مقامات  پر \عددی{L}  اس خطہ میں داخل   اور اس سے     خارج ہوتا ہے، یہ تکمل کی  \عددی{r} حدیں  ہوں گے۔ ان کی قیمتیں عموماً \عددی{\theta} پر منحصر ہو گی۔
\item
\ترچھا{تکمل کی  \عددی{\theta} حدیں:}\quad
وہ \عددی{\theta} حدیں  منتخب کریں جن میں \عددی{R} سے گزرتی ہوئی تمام شعاعیں  شامل ہوں۔
\end{enumerate}
...
حل:\quad
ہم دو چشمہ کا خاکہ بنا کر تکمل کی حدیں معلوم کرتے ہیں۔ہم دیکھتے ہیں کہ ربع اول میں دو چشمہ کے رقبہ کو \عددی{4} سے ضرب دے کر پورا رقبہ حاصل کیا جا سکتا ہے۔
\begin{align*}
...
%================
\ابتدا{مثال}
محور \عددی{x} اور منحنی \عددی{y=\sqrt{1-x^2}}  کے بیچ نصف دائری خطہ \عددی{R} پر درج ذیل تکمل کی قیمت تلاش کریں۔
\begin{align*}
...
\item
\ترچھا{خاکہ:}\quad
خطہ \عددی{D} کا خاکہ بنائیں اور مستوی \عددی{xy} پر  اس کا انتصابی سایہ \عددی{R}  دکھائیں۔  خطہ \عددی{D} کی بالائی اور زیریں تحدیدی سطحوں کی نشاندہی کریں اور \عددی{R} کی بالائی اور زیریں تحدیدی منحنیات  کی نشاندہی کریں۔
\item
\ترچھا{تکمل کی \عددی{z} حدیں:}\quad
خطہ \عددی{R} میں  علامتی نقطہ \عددی{(x,y)} سے \عددی{z} محور کے متوازی  لکیر \عددی{M} کھینچیں۔  بڑھتے  \عددی{z} رک چلتے ہوئے،  یہ لکیر \عددی{z=f_1(x,y)} پر \عددی{D} میں داخل ہو گی اور  \عددی{z=f_2(x,y)} پر \عددی{D} سے خارج ہو گی۔یہی تکمل کی  \عددی{z} حدیں ہیں۔
\item
\ترچھا{تکمل کی \عددی{y} حدیں:}\quad
 نقطہ \عددی{(x,y)} سے گزرتی ہوئی  \عددی{y} محور کے متوازی  لکیر \عددی{L} کھینچیں۔ بڑھتے \عددی{y} رخ چلتے ہوئے  یہ لکیر \عددی{R} میں \عددی{y=g_1(x)} پر داخل اور \عددی{y=g_2(x)} پر خارج ہو گی۔ یہی تکمل کی \عددی{y} حدیں ہیں۔
\item
\ترچھا{تکمل کی \عددی{x} حدیں:}\quad
...
\item
\ترچھا{خاکہ:}\quad
یہ سطحیں ایک دوسرے کو قطع مکافی \عددی{x^2+3y^2=8-x^2-y^2} یعنی \عددی{x^2+2y^2=4} میں قطع کرتی ہیں۔ مستوی \عددی{xy} میں  \عددی{D} کے سایہ \عددی{R}  کی سرحد کی مساوات
...
\item
\ترچھا{خطہ:}\quad
ہم \عددی{D} اور مستوی \عددی{xz} میں اس کے  سایہ \عددی{R} کا خاکہ بناتے ہیں۔ خطہ \عددی{D} کی بالائی (دائیں ہاتھ)  تحدیدی سطح    مستوی \عددی{y=1} میں پائی جاتی ہے۔ اس کی زیریں (بائیں ہاتھ) تحدیدی سطح مستوی \عددی{y=x+z} میں پائی جاتی ہے۔ خطہ \عددی{R} کی بالائی  سرحد لکیر \عددی{z=1-x}  اور زیریں سرحد لکیر \عددی{z=0} ہیں۔
\item
\ترچھا{تکمل   کی \عددی{y} حدیں:}\quad
...
حل:\quad
ہم اس مکعب  کا خاکہ بنا کر اس پر  تکمل کی حدوں کی نشاندہی کرتے ہیں۔ اس کے بعد مساوات \حوالہ{مساوات-بالکثرت_تین_بعدی_اوسط} سے مکعب  پر \عددی{F} کی   اوسط قیمت حاصل کرتے ہیں۔
...
%=================
\ابتدا{سوال}
ثُمن اول  میں محددی مستویات اور مستوی \عددی{y+z=2} اور بیلن \عددی{x=4-y^2}   کے بیچ خطہ۔
\انتہا{سوال}
%=================
\ابتدا{جواب}
\wf{\unexpanded{
...
%=================
\ابتدا{سوال}
ثُمن اول میں محددی مستویات اور سطح \عددی{z=4-x^2-y} کے بیچ خطہ۔
\انتہا{سوال}
%=================
\ابتدا{سوال}
