...
%only Q1 to Q10 of ex14.4 is complete in the next tex file.
%audio of ex14.4 is missing. must do its audio
%edited and figures complete in this file
%done p1093 of finney
...
\addplot []coordinates {(-1.8,1)(-2.5,1)}node[left]{\RL{{خطہ \عددی{R} کی سرحد}}};
\addplot []coordinates {(-1.0,0.5)(-2.5,0.8)};
\end{axis}
\end{tikzpicture}
\caption{}
\end{subfigure}
