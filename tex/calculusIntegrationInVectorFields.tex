...
فرض کریں مستوی میں سمتی میدانی کا سیالی بہاؤ \عددی{\kvec{F}(x,y)=M(x,y)\ai+N(x,y)\aj} ہے  اور خطہ \عددی{R} کے ہر نقطہ پر \عددی{M} اور \عددی{N} کے یک رتبی جزوی تفرقات استمراری ہیں۔ خطہ \عددی{R} میں \عددی{(x,y)} ایک نقطہ ہے اور \عددی{S} ایک ایسا چھوٹا مستطیل ہے جو مکمل طور پر \عددی{R} میں پایا جاتا ہے اور جس کا ایک
...
\kvec{F}(x,y)=M(x,y)\ai+N(x,y)\aj
\end{align*}
اور نقطہ \عددی{(x,y)} پر چھوٹا مستطیل رقبہ \عددی{S} لیتے ہیں۔ اس مستطیل کو  شکل \حوالہ{شکل_سمتی_تکمل_بند_راہ_مستطیل_دائری_بہاؤ} میں  دوبارہ پیش کیا گیا ہے۔
...
رقبہ \عددی{S} کے گرد خلاف گھڑی \عددی{\kvec{F}} کا دائری بہاؤ مستطیل \عددی{S} کی اطراف کی ہمراہ  بہاؤ کی شرح کا مجموعہ ہو گا۔اکائی مماسی سمتیہ \عددی{\ai} کے رخ سمتی رفتار \عددی{\kvec{F}} کا غیر سمتی جزو ضرب لمبائی قطع تخمیناً نچلے ضلع کی ہمراہ بہاؤ کے برابر ہو گا: 
\begin{align}
...
مسئلہ گرین کا ایک روپ کہتا ہے کہ موزوں حالات میں مستوی میں  سادہ بند منحنی سے سمتی میدان کا خارجی بہاؤ، اس منحنی میں محیط خطہ پر میدان کے پھیلاو کے دہرا تکمل کے برابر ہو گا۔ مساوات \حوالہ{مساوات_سمتی_تکمل_عبور_کرتا_بہاؤ_تعریف} اور مساوات \حوالہ{مساوات_سمتی_تکمل_نفاذ} میں بہاؤ کے کلیات پر دوبارہ نظر ڈالیں۔
