...
NF=1\cdot ND
\end{align}
یعنی ترخیم پر کسی بھی نقطہ \عددی{N} کا ماسکہ سے فاصلہ  اور \عددی{N} کا ناظمہ پر قریبی نقطہ \عددی{  D} سے  فاصلہ ایک سا ہو گا۔  ترخیم کے لئے یہ دکھایا جا سکتا ہے کہ  مساوات \حوالہ{مساوات_مخروط_قطع_مکافی_خاصیت_الف} کی جگہ درج ذیل ہو گا۔
...
%=======================
\ابتدا{سوال}
درج ذیل ترخیم \عددی{a}، \عددی{b} اور \عددی{c} کی کن قیمتوں کے لئے مبدا پر محور \عددی{x} کے متوازی ہو گا اور نقطہ \عددی{(-1,2)} سے گزرے گا؟
\begin{align*}
4x^2+y^2+ax+by+c=0
\end{align*}
...
سنک بڑھانے سے قطع زائد کی صورت پر کیا اثر ہو گا؟ یہ جاننے کے لئے مساوات \عددی{\tfrac{x^2}{a^2}-\tfrac{y^2}{b^2}=1} کو \عددی{a} اور \عددی{b} کے بجائے \عددی{a} اور \عددی{e} کی صورت میں لکھیں۔ مختلف \عددی{e} کی قیمتوں کے لئے قطع زائد ترسیم کریں (\عددی{a} مستقل لیں)۔
\انتہا{سوال}
%=======================
...
\end{axis}
\end{tikzpicture}
\caption{سر نیچے تدویر پر کسی بھی نقطہ سے \عددی{B} تک پہنچنے کے لئے ایک سا  وقت درکار ہوتا ہے۔}
...
\حل
مساوات \عددی{r^2=\cos\theta} کے لئے ضروری ہے کہ \عددی{\cos\theta\ge 0} ہو لہٰذا پورا ترسیم حاصل کرنے کی خاطر ہم \عددی{\theta} کو وقفہ \عددی{-\tfrac{\pi}{2}} تا \عددی{\tfrac{\pi}{2}} میں رکھتے ہیں۔ درج ذیل کی وجہ سے یہ منحنی محور \عددی{x} کے لحاظ سے تشاکلی ہے۔ 
\begin{align*}
