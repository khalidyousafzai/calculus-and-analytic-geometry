...
%=====================
\ابتدا{سوال}
چار گل \عددی{r=\cos2\theta} کے اس پھول کے پتے کی زیادہ سے زیادہ چوڑائی دریافت کریں جو \عددی{x} محور پر پایا جاتا ہے۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{ 
$2y=\tfrac{2\sqrt{6}}{9}$
