...
سوال \حوالہ{سوال_مخروط_مساوات_منتقلی_الف} تا سوال \حوالہ{سوال_مخروط_مساوات_منتقلی_ب} میں دیے گئے مخروط حصوں کا (جیسا مناسب ہو) مرکز، ماسکے، رؤوس، متقاربات،  اور رداس دریافت کریں۔
...
\حصہ{سنک کے  لحاظ سے مخروط حصوں کی جماعت بندی}
...
کسی بھی زاویہ \عددی{\theta} کا سائن یا کوسائن معلوم کرنے کی خاطر ہم کیلکولیٹر میں \عددی{\theta} ریڈیئن داخل کرتے ہیں۔ کیلکولیٹر \عددی{2\pi} کا  مضرب \عددی{\theta} کے ساتھ جمع کر کے یا اس سے تفریق کر کے  \عددی{0} اور \عددی{2\pi} کے بیچ زاویہ حاصل کرتا ہے جس کا سائن اور کوسائن وہی ہو گا جو اصل زاویہ \عددی{\theta} کا ہو گا (لہٰذا ہم اس نئے زاویہ کو \عددی{\theta} ہی کہتے ہیں)۔ اب \عددی{\theta} سے تجاوز کیے بغیر کیلکولیٹر \عددی{\theta} کو \عددی{\alpha_1} کا مضرب جمع \عددی{\alpha_2} کا مضرب اور اسی طرح چلتے ہوئے، جمع  \عددی{\alpha_{10}} کا مضرب  لکھتا ہے۔یوں درج ذیل حاصل ہو گا۔
\begin{align*}
\theta\approx m_1\alpha_1+m_2\alpha_2+\cdots+m_{10}\alpha_{10}
\end{align*}
اس کے بعد کیلکولیٹر نقطہ \عددی{1,0} کو \عددی{m_1} گنا \عددی{\alpha_1} زاویہ گھماتا ہے۔اس کے بعد  \عددی{m_2} گنا \عددی{\alpha_2} زاویہ گھماتا ہے، اور اسی طرح چلتے ہوئے، \عددی{m_{10}} گنا \عددی{\alpha_{10}} زاویہ گھماتا ہے۔ اکائی دائرہ پر پائے جانے والے نقطہ \عددی{(1,0)}  کے آخری مقام کے محدد \عددی{(\cos\theta,\sin\theta)} ہوں گے (شکل \حوالہ{شکل_مخروط_کیلکولیٹر_سائن_کوسائن})۔
...
ہموار مقدار معلوم منحنیات کے لیے لمبائی کے کلیہ (مساوات \حوالہ{مساوات_مخروط_لمبائی_منحنی}) سے، حصہ \حوالہ{حصہ_استعمال_تکمل_سطح_طواف_کا_رقبہ} میں کارتیسی کلیات کی طرح،  سطح طواف کے درج ذیل کلیات  اخذ ہوتے ہیں۔
...
\end{align*}
جہاں \عددی{e} ترخیم کا سنک ہے۔ ماسوائے \عددی{e=0} یا \عددی{e=1} یہ تکمل، جو \اصطلاح{ترخیمی تکمل}\فرہنگ{تکمل!ترخیمی}\فرہنگ{ترخیمی!تکمل}\حاشیہب{elliptic integral}\فرہنگ{elliptic!integral} کہلاتا ہے، غیر بنیادی ہے۔ 
\begin{enumerate}[a.]
\item
قاعدہ ذوزنقہ میں \عددی{n=10} لے کر \عددی{a=1} اور \عددی{e=\tfrac{1}{2}} کے لیے  اس ترخیم کی لمبائی کا اندازہ لگائیں۔
\item
تفاعل \عددی{f(t)=\sqrt{1-e^2\cos^2t}} کے دو گنا تفرق کی قیمت \عددی{1} سے کم ہے۔ اس حقیقت کو استعمال کرتے ہوئے جزو-ا میں حاصل قیمت میں خلل کا بالائی حد تلاش کریں۔
\end{enumerate}
\انتہا{سوال}
%======================
...
\حل
ہم قطبی محدد کا مبدا اور ابتدائی شعاع ترسیم کرتے ہیں۔ ابتدائی شعاع  کے ساتھ \عددی{\tfrac{\pi}{6}} زاویے پر شعاع ترسیم کر کے اس پر مبدا سے \عددی{2} اکائیاں فاصلہ پر نقطہ \عددی{N(2,\tfrac{\pi}{6})} ہو گا۔ ہم اب \عددی{r=2} اور \عددی{r=-2} لیتے ہوئے اس نقطہ کے لیے  دیگر قطبی محدد تلاش کرتے ہیں۔
...
\end{align*}
ہوں گی۔ یہ کلیات \عددی{n=0} کے لیے \عددی{(2,\tfrac{\pi}{6})} اور \عددی{(-2,-\tfrac{5\pi}{6})} دیتے ہیں۔ اسی طرح \عددی{n=1} کے لیے یہ کلیات  \عددی{(2,\tfrac{13\pi}{6})} اور \عددی{(-2,\tfrac{7\pi}{6})}  دیتے ہیں، وغیرہ، وغیرہ۔ یوں نقطہ \عددی{N(2,\tfrac{\pi}{6})} کی لامتناہی قطبی محددی جوڑیاں پائی جاتی ہیں۔
\انتہا{مثال}
%==================
...
ایک مستوی میں بیک وقت کارتیسی اور قطبی محدد استعمال کرتے ہوئے ہم دونوں محدد کے مبدا ایک ہی نقطہ پر رکھتے ہیں اور ابتدائی شعاع کو مثبت محور \عددی{x} پر رکھتے ہیں۔ یوں شعاع \عددی{\theta=\tfrac{\pi}{2},\, r>0} مثبت محور \عددی{y}  ہو گا (شکل \حوالہ{شکل_مخروط_کارتیسی_قطبی_تعلق})۔ اب ان محددی نظام کے تعلقات درج ذیل ہوں گے۔
...
\end{align*}
ترسیم:\quad
انتصابی لکیر جو محور \عددی{x} کر \عددی{x=-4} پر قطع کرتی ہے۔
\item
\begin{align*}
&r^2=4r\cos\theta\\
&x^2+y^2=4x\\
...
\end{align*}
ترسیم:\quad
ایک سیدھی لکیر جس کی ڈھلوان \عددی{m=2} ہے اور جو محور \عددی{y} کو \عددی{y=-4} پر قطع کرتی ہے۔
\end{enumerate}
\انتہا{مثال}
...
\item
مستوی  \عددی{xy} میں ہر افقی خط کی  قطبی مساوات کس صورت کی ہو گی؟
\end{enumerate}
\انتہا{سوال}
%==================
\انتہا{سوالات}
...
\end{align*}
اگر مبدا پر \عددی{r=f(\theta)} کا زاویہ \عددی{\theta_0} ہو تب مبدا پر منحنی کی ڈھلوان \عددی{\tan\theta_0} ہو گی۔ مبدا پر ڈھلوان کی بات کرتے ہوئے ہم کہتے ہیں \قول{\عددی{(0,\theta)} پر ڈھلوان}  نا کہ \قول{مبدا پر ڈھلوان} کیونکہ قطبی منحنی مبدا سے کئی بار گزر سکتی ہے اور \عددی{\theta} کی مختلف قیمتوں کے لیے یہاں ڈھلوان مختلف ہو گی۔
...
\حل
مساوات \عددی{r^2=\cos\theta} کے لیے ضروری ہے کہ \عددی{\cos\theta\ge 0} ہو لہٰذا پورا ترسیم حاصل کرنے کی خاطر ہم \عددی{\theta} کو وقفہ \عددی{-\tfrac{\pi}{2}} تا \عددی{\tfrac{\pi}{2}} میں رکھتے ہیں۔ درج ذیل کی وجہ سے یہ منحنی محور \عددی{x} کے لحاظ سے تشاکلی ہے۔ 
\begin{align*}
...
صرف نقطے ترسیم کرنے سے کارتیسی ترسیم اس لیے بہتر ہے کہ کارتیسی ترسیم سے جلد دیکھا جا سکتا ہے کہاں قیمتیں مثبت، منفی یا غیر موجود ہوتی ہیں۔ اس کے علاوہ \عددی{r} کا بڑھنا اور گھٹنا بھی واضح ہوتا ہے۔ ہم \عددی{r=1+\cos(\tfrac{\theta}{2})} اور \عددی{r^2=\sin2\theta} کو مثال بنا کر اس ترکیب کو دیکھتے ہیں۔
...
%=====================
\ابتدا{سوال}
چار گل \عددی{r=\cos2\theta} کے اس پھول کے پتے کی زیادہ سے زیادہ چوڑائی دریافت کریں جو محور \عددی{x} پر پایا جاتا ہے۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{ 
$2y=\tfrac{2\sqrt{6}}{9}$
...
چاند، سیارے، مصنوعی سیارے اور دُم دار ستارے ترخیم، قطع مکافی اور قطع زائد پر حرکت کرتے ہیں۔ ان کی حرکت کو قطبی محدد میں ایک آسان مساوات سے ظاہر کیا جا سکتا ہے لہٰذا فلکیات اور فلکیاتی انجینئری میں قطبی محدد  اہمیت رکھتے ہیں۔ ہم اس مساوات کو یہاں حاصل کرتے ہیں۔
...
r=2a\sin\theta
\end{align}
مساوات \حوالہ{مساوات_مخروط_دائرہ_قطبی_پ} اور مساوات \حوالہ{مساوات_مخروط_دائرہ_قطبی_ت} میں \عددی{r} کی جگہ \عددی{-r} پر کر کے ان دائروں کی مساواتیں حاصل ہوں گی جن کے مرکز منفی محور \عددی{x} یا منفی محور \عددی{y} پر ہوں (شکل \حوالہ{شکل_مخروط_محددی_مرکوز_دائرے})۔
...
\end{tikzpicture}
\caption
{ایک ترخیم میں،  جس کا نصف محور اکبر \عددی{a} ہو،   ماسکہ تا ناظمہ فاصلہ   \عددی{k=\tfrac{a}{e}-ea} ہوتا  ہے لہٰذا 
...
سیاروں کے مدار معلوم کرنے کے لیے  مساوات \حوالہ{مساوات_مخروط_ترخیم_معیاری_قطبی} ابتدائی مساوات ہے۔
...
%===================
\ابتدا{مثال}
ایک ماسکہ سے مطابقتی ناظمہ تک فاصلہ مثال \حوالہ{مثال_مخروط_مدار_پلوٹو} میں معلوم کریں۔
...
سوال \حوالہ{سوال_مخروط_سنک_ناظمہ_قطبی_الف} تا سوال \حوالہ{سوال_مخروط_سنک_ناظمہ_قطبی_ب} میں مخروط حصوں کا سنک دیا  گیا ہے۔ مخروط حصے کا ایک ماسکہ مبدا پر واقع ہے اور اس کا مطابقتی ناظمہ بھی دیا گیا ہے۔ اس مخروط حصے کی قطبی مساوات تلاش کریں۔
...
\item
 جدول   \حوالہ{جدول_سوالات_سورج_سیارے} کی مدد سے معلوم کریں کہ ہماری نظام شمسی میں ہر سیارہ سورج کے کتنے نزدیک اور اس سے کتنا دور ہو سکتا ہے۔
\end{enumerate}
%
\begin{table}
...
\ابتدا{سوال}\ترچھا{سیاروں کے مدار پر حرکت}\\
...
\item
آپ \عددی{k=-1} لیں۔ اب \عددی{e} کی قیمت \عددی{\tfrac{7}{6}}، \عددی{\tfrac{5}{4}}، \عددی{\tfrac{4}{3}}، \عددی{\tfrac{3}{2}}، \عددی{2}، \عددی{3}، \عددی{5}، \عددی{10} اور \عددی{20} کرنے سے ترسیم پر کیا اثر ہو گا؟ یہ کچھ \عددی{e=\tfrac{1}{2}}، \عددی{\tfrac{1}{3}}، \عددی{\tfrac{1}{4}}، \عددی{\tfrac{1}{10}} اور \عددی{\tfrac{1}{20}} کے لیے کریں۔
\item
...
%==================
\ابتدا{سوال}
درج ذیل قطبی ترخیم کو مختلف\عددی{a>0} اور \عددی{0<e<1}، \عددی{-\pi\le\theta\le\pi} کے لیے  کمپیوٹر پر ترسیم کریں۔
\begin{align*}
...
شکل \حوالہ{شکل_مخروط_قطبی_رقبہ_کا_کلیہ} میں خطہ \عددی{OTS} کی حدیںود  شعاع \عددی{\theta=\alpha}، شعاع \عددی{\theta=\beta} اور منحنی \عددی{r=f(\theta)} ہیں۔  ہم اس خطہ کو \عددی{n} عدد پنکھا نما پٹیوں میں تقسیم کرتے ہیں جو زاویہ \عددی{TOS} کی خانہ بندی \عددی{P} پر مبنی ہے۔ ایک علامتی پٹی کا رداس \عددی{r_k=f(\theta_k)} اور وسطی زاویہ \عددی{\Delta \theta_k} ہو گا جبکہ اس کا رقبہ درج ذیل ہو گا۔
\begin{align*}
...
\حل
ہم قلب نما کا خاکہ کھینچتے ہیں تا کہ تکمل کی  حدود معلوم کر سکیں (شکل \حوالہ{شکل_مثال_مخروط_لمبائی_قوس_قلب_نما})۔ زاویہ \عددی{\theta} کو \عددی{0} سے \عددی{2\pi} کرنے سے نقطہ \عددی{N(r,\theta)} ٹھیک ایک بار پوری  قلب نما پر گھڑی کے الٹ رخ چلتا ہے لہٰذا \عددی{\alpha=0} اور \عددی{\beta=2\pi} ہوں گے۔ اب 
\begin{align*}
...
\حل
ہم اس گھیر کا خاکہ بنا کر تکمل کی حد تلاش کرتے ہیں (شکل \حوالہ{شکل_مثال_سطح_طواف_قطبی})۔ زاویہ \عددی{\theta} کی قیمت \عددی{-\tfrac{\pi}{4}} تا \عددی{\tfrac{\pi}{4}} کرنے سے نقطہ \عددی{N(r,\theta)} منحنی پر ٹھیک ایک بار گھڑی کے الٹ رخ چلتا ہے لہٰذا \عددی{\alpha=-\tfrac{\pi}{4}} اور \عددی{\beta=\tfrac{\pi}{4}} ہوں گے۔
