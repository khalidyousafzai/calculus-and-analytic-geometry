...
\حل
ہم رقبہ ترسیم کر کے خطے کی حدود اور  تکمل کی  حدود معلوم کرتے ہیں (شکل \حوالہ{شکل_مثال_مخروط_دائرہ_قلب_نما_بیچ_رقبہ})۔ بیرونی منحنی \عددی{r_2=1} جبکہ اندرونی منحنی \عددی{r_1=1-\cos\theta} ہے جبکہ \عددی{\theta} کی قیمت \عددی{-\tfrac{\pi}{2}} تا \عددی{\tfrac{\pi}{2}} ہے۔ مساوات \حوالہ{مساوات_مخروط_رقبہ_قطبی_رداس_کے_بیچ} سے درج ذیل رقبہ حاصل ہو گا۔
\begin{align*}
...
\حل
ہم قلب نما کا خاکہ کھینچتے ہیں تا کہ تکمل کی  حدود معلوم کر سکیں (شکل \حوالہ{شکل_مثال_مخروط_لمبائی_قوس_قلب_نما})۔ زاویہ \عددی{\theta} کو \عددی{0} سے \عددی{2\pi} کرنے سے نقطہ \عددی{N(r,\theta)} ٹھیک ایک بار پوری  قلب نما پر گھڑی مخالف رخ چلتا ہے لہٰذا \عددی{\alpha=0} اور \عددی{\beta=2\pi} ہوں گے۔ اب 
\begin{align*}
...
\حل
ہم اس گھیر کا خاکہ بنا کر تکمل کی حد تلاش کرتے ہیں (شکل \حوالہ{شکل_مثال_سطح_طواف_قطبی})۔ زاویہ \عددی{\theta} کی قیمت \عددی{-\tfrac{\pi}{4}} تا \عددی{\tfrac{\pi}{4}} کرنے سے نقطہ \عددی{N(r,\theta)} منحنی پر ٹھیک ایک بار گھڑی مخالف رخ چلتا ہے لہٰذا \عددی{\alpha=-\tfrac{\pi}{4}} اور \عددی{\beta=\tfrac{\pi}{4}} ہوں گے۔
...
%==========================
\ابتدا{سوال}
منحنیات \عددی{r=f(\theta),\, \alpha\le\theta\le\beta} اور \عددی{r=2f(\theta),\, \alpha\le\theta\le\beta}  کو محور \عددی{x} کے گرد گھما کر سطح طواف پیدا کی جاتی ہے۔ کیا ان سطح طواف کے رقبوں کی تناسب کے بارے میں کچھ کہنا ممکن ہو گا؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
%======================
\موٹا{پنکھا نما خطوں کے وسطانی مراکز}\\
چونکہ مثلث کا وسطانی مرکز ہر ایک وسطانیہ پر، راس سے دو تہائی دور مخالف قاعدہ پر،  واقع ہوتا ہے لہٰذا شکل \حوالہ{شکل_سوال_مخروط_قطبی_وسطانیہ} میں محور \عددی{x} کے لحاظ سے باریک سایہ دور  تکونی بیرم کا بازو تقریباً \عددی{\tfrac{2}{3}r\sin\theta} ہو گا۔ اسی طرح محور \عددی{y} کے لحاظ سے  اس باریک تکونی خطہ کا بازو \عددی{\tfrac{2}{3}r\cos\theta} ہو گا۔ یہ تخمین \عددی{\Delta\theta\to0} سے بہتر ہو کر خطہ \عددی{AOB} کے وسطانیہ کے محدد کے لیے درج ذیل کلیات دیتی ہیں
\begin{align*}
