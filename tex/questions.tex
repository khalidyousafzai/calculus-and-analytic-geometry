...
$y=x^2-4x+3$\\
جواب:\quad
شکل \حوالہ{شکل_سوال_استعمال_لائحہ_عمل_الف}
\انتہا{سوال}
%===================
\ابتدا{سوال}
$y=6-2x-x^2$
...
$y=x^3-3x+3$\\
جواب:\quad
شکل \حوالہ{شکل_سوال_استعمال_لائحہ_عمل_پ}
\انتہا{سوال}
%==========================
\ابتدا{سوال}
$y=x(6-2x)^2$
...
$y=-2x^3+6x^2-3$\\
جواب:\quad
شکل \حوالہ{شکل_سوال_استعمال_لائحہ_عمل_ت}
\انتہا{سوال}
%==========================
\ابتدا{سوال}
$y=1-9x-6x^2-x^3$
...
$y=(x-2)^3+1$\\
جواب:\quad
شکل \حوالہ{شکل_سوال_استعمال_لائحہ_عمل_ٹ}
\انتہا{سوال}
%==========================
\ابتدا{سوال}
$y=1-(x+1)^3$
...
\end{axis}
\end{tikzpicture}
\caption{حل سوال \حوالہ{سوال_استعمال_لائحہ_عمل_الف}}
...
\end{axis}
\end{tikzpicture}
\caption{حل سوال \حوالہ{سوال_استعمال_لائحہ_عمل_پ}}
...
\end{axis}
\end{tikzpicture}
\caption{حل سوال \حوالہ{سوال_استعمال_لائحہ_عمل_ت}}
\label{شکل_سوال_استعمال_لائحہ_عمل_ت}
\end{minipage}\hfill
\begin{minipage}{0.22\textwidth}
\centering
\begin{tikzpicture}[font=\tiny]
...
\end{axis}
\end{tikzpicture}
\caption{حل سوال \حوالہ{سوال_استعمال_لائحہ_عمل_ٹ}}
...
\begin{tikzpicture}[font=\tiny]
\begin{axis}[clip=false,width=4cm,axis lines=middle,xlabel style={at={(current axis.right of origin)},anchor=south east},ylabel style={at={(current axis.above origin)},anchor=south},xtick={\empty},ytick={\empty},axis line style={draw=none}]
\addplot[domain=-4.5:4.5,smooth]{1/4*x^4-6*x^2};
...
\draw(axis cs:3.46,-36)node[circ]{}node[below,align=center]{$x=2\sqrt{3}$\\  \RL{مقامی کم سے کم}};
\draw(axis cs:-2,-20)node[circ]{}node[left,align=center]{$x=-2\sqrt{3}$\\  تصریف};
\draw(axis cs:2,-20)node[circ]{}node[right,align=center]{$x=2\sqrt{3}$\\  تصریف};
\end{axis}
\end{tikzpicture}
\end{minipage}\hfill
\begin{minipage}{0.22\textwidth}
