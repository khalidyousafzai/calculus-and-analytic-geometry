...
\جزوحصہء{ٹکیاں}
فرض کریں ہم شکل \حوالہ{شکل_تکمل_استعمال_ٹکیاں} میں دکھائے گئے ٹھوس جسم کا حجم دریافت کرنا چاہتے ہیں۔ بند وقفہ \عددی{[a,b]} کے ہر نقطہ \عددی{x} پر جسم کا عمودی تراش خطہ \عددی{R(x)} ہے جس کا رقبہ \عددی{S(x)} ہے۔ یوں \عددی{S} متغیر \عددی{x} کا حقیقی قیمت تفاعل ہو گا۔ یہ  \عددی{x} کا استمراری تفاعل بھی ہو گا جس کو استعمال کرتے ہوئے ٹھوس  جسم کے حجم کی تعریف پیش کی جا سکتی ہے ، جو  تکمل سے درج ذیل طریقے سے حاصل کیا جا سکتا ہے۔
\begin{figure}
\centering
\begin{minipage}{0.45\textwidth}
\centering
...
ایک ٹھوس جسم  \عددی{x=-1} اور \عددی{x=1} پر محور \عددی{x}  کے عمودی مستویات  کے بیچ  واقع  ہے۔  محور \عددی{x} کے عمودی ، جسم  کے  عمودی تراش رقبے،  نصف دائرہ \عددی{y=-\sqrt{1-x^2}} اور نصف دائرہ \عددی{y=\sqrt{1-x^2}} کے بیچ پائے  جاتے ہیں ۔ 
\begin{enumerate}[a.]
\item
...
ایک ٹھوس جسم  \عددی{x=0} اور \عددی{x=4} پر  محور \عددی{x}  کے عمودی  مستویات  کے بیچ  واقع ہے۔ محور \عددی{x} کے عمودی جسم  کے رقبہ عمودی تراش، قطع مکافی  \عددی{y=-\sqrt{x}} اور قطع مکافی \عددی{y=\sqrt{x}} کے بیچ پائے جاتے ہیں۔ 
\begin{enumerate}[a.]
\item
...
ایک ٹھوس جسم \عددی{x=0} اور \عددی{x=4} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کے عمودی تراش کی صورت چوکور ہے جو  محور \عددی{x} کے عمودی ہیں اور جن کے وتر قطع مکافی \عددی{y=-\sqrt{x}} سے قطع مکافی \عددی{y=\sqrt{x}} تک ہیں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$16$
...
%========================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-1} اور \عددی{x=1} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کے عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے قطر دائری اقراص ہیں جو قطع مکافی \عددی{y=x^2} سے قطع مکافی \عددی{y=2-x^2} تک ہیں۔   
\انتہا{سوال}
%=====================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-1} اور \عددی{x=1} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کے چوکور عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے تلا کے کنارے نصف دائرہ \عددی{y=-\sqrt{1-x^2}} سے نصف دائرہ \عددی{y=\sqrt{1-x^2}} تک ہیں۔ \\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{16}{3}$  
...
%======================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-1} اور \عددی{x=1} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کے چوکور عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے وتر نصف دائرہ \عددی{y=-\sqrt{1-x^2}} سے نصف دائرہ \عددی{y=\sqrt{1-x^2}} تک ہیں۔ چوکور کے وتر کی لمبائی چوکور کے ضلع کے \عددی{\sqrt{2}} گنّا ہوتی ہے۔
\انتہا{سوال}
%======================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_شکل_دیا_گیا_ہے_الف}
ایک ٹھوس جسم کا تلا منحنی \عددی{y=2\sqrt{\sin x}} اور محور \عددی{x} پر وقفہ \عددی{[0,\pi]}  کے بیچ واقع  ہے۔ محور \عددی{x} کے عمودی عمودی تراش درج ذیل ہیں۔
\begin{enumerate}[a.]
\item
...
\end{figure}
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-\tfrac{\pi}{3}} اور \عددی{x=\tfrac{\pi}{3}} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کے  عمودی تراش محور \عددی{x} کے عمودی ہیں جن کی خواص درج ذیل ہیں۔
\begin{enumerate}[a.]
\item
...
%=====================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{y=0} اور \عددی{y=2} پر  محور \عددی{y} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کے دائری عمودی تراش محور \عددی{y} کے عمودی ہیں جن کے قطر محور \عددی{y} سے قطع مکافی \عددی{x=\sqrt{5}y^2} تک ہیں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$8\pi$
...
ایک ٹھوس جسم کا تلا قرص \عددی{x^2+y^2\le 1} ہے۔ عمودی تراش    \عددی{y=-1} اور \عددی{y=1} کے بیچ محور \عددی{y} کے عمودی ہیں جو مساوی الساقین مثلث ہیں جن کا ایک ضلع قرص میں  واقع ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_شکل_دیا_گیا_ہے_ب})۔
\انتہا{سوال}
%=====================
\موٹا{مسئلہ کوالئیرے}\\
\ابتدا{سوال}\ترچھا{بلدار ٹھوس جسم}\\
ایک چوکور جس کا ضلع \عددی{s} ہے لکیر \عددی{L} کے عمودی مستوی میں واقع ہے۔چوکور کا ایک راس \عددی{L} پر واقع ہے۔ یہ چوکور \عددی{L} پر \عددی{h} فاصلہ طے کرتے ہوئے ایک چکر کاٹ کر پیچ نما جسم دیتا ہے جس کا رقبہ عمودی تراش چوکور ہو گا۔
\begin{enumerate}[a.]
\item
اس جسم کا حجم تلاش کریں۔
\item
اگر چوکور ایک کے بجائے دو بار چکر کاٹتا تب حجم کتنا ہوتا؟ اپنے جواب کی وجہ پیش کریں۔ 
\end{enumerate} 
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
ایک ٹھوس جسم \عددی{x=01} اور \عددی{x=12} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کے عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے  قطر لکیر \عددی{y=\tfrac{x}{2}} سے لکیر \عددی{y=x} تک ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_ٹھوس_جسم_حجم_ب})۔ اس جسم کا حجم کیوں اس قائمہ مخروط جتنا ہو گا جس کا قد \عددی{12} اور جس کے تلا کا رداس \عددی{3} ہو؟ 
\انتہا{سوال}
%======================
\begin{figure}
\centering
...
کوالئیرے نے طالب علمی کے دوران دریافت کیا کہ اگر دو مستوی خطوں کو محور \عددی{x} کے یکساں وقفہ پر یوں رکھنا ممکن ہو کہ کسی بھی \عددی{x} پر دونوں خطوں کی چوڑائی ایک دوسرے جیسی ہو تب دونوں خطوں کا رقبہ ایک دوسرے جیسا ہو گا (شکل \حوالہ{شکل_سوال_تکمل_استعمال_چوڑائی_برابر})۔ ٹھوس اجسام کے لئے یہی مسئلہ کوالئیرے نے کبھی ثابت نہیں کیا۔ اگر شکل \حوالہ{سوال_تکمل_استعمال_چوڑائی_برابر} میں بالائی اور زیریں سرحدیں استمراری تفاعل ہوں تب اس مسئلے کو ثابت کریں۔
...
اگلے مثال میں محور طواف  محور \عددی{x} نہیں ہے، لیکن حجم حاصل کرنے کا اصول تبدیل نہیں ہوتا: تکمل کے موزوں حد استعمال کریں۔

\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_جذر_منتقل}
تفاعل \عددی{y=\sqrt{x}}، لکیر \عددی{y=1} اور لکیر \عددی{x=4} کے بیچ خطہ کو لکیر \عددی{y=1} کے گرد گھما کر ٹھوس جسم پیدا کیا جاتا ہے۔ اس جسم کا حجم تلاش کریں۔
...
منحنی \عددی{x=\tfrac{2}{y},\, 1\le y \le 4} کو محور \عددی{y} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔ اس جسم کا حجم دریافت کریں۔
...
\caption{}
\end{subfigure}
\caption{یہاں جسم طواف قرص کے بجائے چھلا نما ہے جس میں سوراخ پایا جاتا ہے  لہٰذا تکمل $\int_a^bS(x)\dif x$ ذرہ مختلف صورت اختیار کرتا ہے۔}
\label{شکل_تکمل_استعمال_ترکیب_چھلا}
\end{figure}
\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_چھلا_عجیب}
منحنی \عددی{y=x^2+1} اور لکیر \عددی{y=-x+3} کے بیچ خطہ کو محور \عددی{x} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔ اس ٹھوس جسم کا حجم تلاش کریں۔
...
\item
عمودی تراش کا بیرونی اور اندرونی رداس کو لکیری قطعہ  سے حاصل کریں۔
\item
...
ربع اول میں قطع مکافی \عددی{y=x^2}، لکیر \عددی{y=1} اور محور \عددی{y}  کے بیچ خطہ کو لکیر \عددی{x=\tfrac{3}{2}} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔ اس ٹھوس جسم کا حجم دریافت کریں۔

حل:\quad
\موٹا{پہلا قدم:}\quad
خطے کے خاکہ پر محور طواف \عددی{x=\tfrac{3}{2}} کے عمودی، لکیری قطعہ بنائیں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_پیچیدہ})۔\\
\موٹا{دوسرا قدم:}\quad
...
سوال \حوالہ{سوال_تکمل_استعمال_ایکس_محور_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_ایکس_محور_ب} میں دیے منحنیات اور لکیروں کے بیچ خطے کو محور \عددی{x} گھما کر جسم طواف پیدا کیا جاتا ہے۔جسم کا حجم تلاش کریں۔
...
%========================
\ابتدا{سوال}
ربع اول میں خطہ جس کی بائیں سرحد دائرہ \عددی{x^2+y^2=3}، دایاں سرحد لکیر \عددی{x=\sqrt{3}} اور بالائی سرحد لکیر \عددی{y=\sqrt{3}} ہے۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\sqrt{3}\pi$
...
\end{align*}
\عددی{\norm{P}\to 0} کرتے ہوئے اس مجموعہ کی حد ٹھوس جسم کا حجم  ہو گی:
\begin{align*}
...
حل:\quad
\موٹا{پہلا قدم:}\quad
خطے کا خاکہ بنا کر محور گردش کے متوازی اس پر قطعہ  دکھائیں۔ قطعہ کا قد (خول کا قد) اور محور گردش سے قطعہ کے فاصلہ (رداس خول) کی نشاندہی کریں۔ قطعہ  کی چوڑائی \عددی{\dif x} خول کی چوڑائی ہو گی۔ ہم نے شکل \حوالہ{شکل_مثال_تکمل_استعمال_نلکی_پہلی} میں خول دکھایا ہے۔ آپ کو ایسا کرنے کی ضرورت نہیں ہے۔\\
\موٹا{دوسرا قدم:}\quad
...
\begin{enumerate}[a.]
\item
خطے کا خاکہ بنا کر اس میں محور طواف کے متوازی قطعہ بنائیں۔ قطعہ کا قد یا لمبائی (قد خول)،  محور طواف سے قطعہ کا فاصلہ (رداس خول) اور قطعہ کی موٹائی (چوڑائی خول) کی نشاندہی کریں۔
\item
...
حل:\quad
\موٹا{پہلا قدم:}\quad
خطے پر محور طواف کے متوازی قطعہ بنائیں۔ قطعہ کا قد (قد خول)، محور طواف سے قطعہ کا فاصلہ (رداس خول) اور قطعہ کی موٹائی (چوڑائی خول \عددی{\dif x}) کی نشاندہی کریں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_خول_آخری})۔ہم نے خول بھی بنایا ہے۔ آپ کو ایسا کرنے کی ضرورت نہیں ہے۔\\
\موٹا{دوسرا قدم:}\quad
...
تفاعل \عددی{y=x^2} اور لکیر \عددی{y=x} کے بیچ خطہ کو مثال بناتے ہوئے شکل \حوالہ{شکل_تکمل_استعمال_چھلا_خول} میں ترکیب چھلا اور ترکیب خول دونوں دکھائے گئے ہیں۔شکل-\حوالہ{شکل_تکمل_استعمال_چھلا_خول}-ا اور ب میں محور \عددی{y} کے گرد خطہ گھمایا گیا ہے جبکہ شکل-ج اور د میں محور \عددی{x} کے گرد خطہ گھمایا گیا ہے۔ دونوں صورتوں میں حجم کو ترکیب چھلا اور ترکیب خول سے حل کیا گیا ہے۔ اس مخصوص خطے کے لئے دونوں محور طواف کے لئے دونوں تراکیب کارآمد ہیں لیکن ایسا ہر صورت میں نہیں ہو گا۔مثال کے طور پر محور \عددی{y} کے گرد گھماتے ہوئے ترکیب چھلا میں ہمیں \عددی{y} کے لحاظ سے تکمل حل کرنا ہو گا۔البتہ عین ممکن ہے کہ متکمل کو \عددی{y} کی صورت میں لکھنا ممکن نہ ہو۔ایسی صورت میں ہمیں ترکیب خول استعمال کرنی ہو گی جو ہمیں \عددی{x} کے لحاظ سے تکمل لینے کی اجازت دیگا۔

ترکیب چھلا اور ترکیب خول سے ہر صورت ایک  سے حجم حاصل ہوں گے۔ ہم حصہ \حوالہ{حصہ_استعمال_تکمل_الٹ_تفاعل_اور_ان_کے_تفرق} کے سوال \حوالہ{سوال_ماورائی_ترکیب_چھلا_اور_ترکیب_خول_مساوی_ہیں} میں ان کی برابر کو ثابت کر پائیں گے۔
...
سوال \حوالہ{سوال_تکمل_استعمال_ترکیب_خول_سے_تلاش_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_ترکیب_خول_سے_تلاش_ب} میں دیے منحنیات اور لکیروں میں محیط خطے کو محور \عددی{y} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔ اس جسم کا حجم ترکیب خول سے تلاش کریں۔
...
\انتہا{سوال}
%=====================
سوال \حوالہ{سوال_تکمل_استعمال_محور_طواف_وائے_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_محور_طواف_وائے_ب} میں طواف جسم کا حجم ترکیب خول سے معلوم کریں۔ منحنیات اور لکیروں میں محیط رقبہ کو محور \عددی{y} کے گرد گھمایا گیا ہے۔
...
تکون جس کے راس \عددی{(1,1)}، \عددی{(1,2)} اور \عددی{(2,2)} ہیں۔ (ا) محور \عددی{x} کے گرد، (ب) محور \عددی{y} کے گرد، (ج) لکیر \عددی{x=\tfrac{10}{3}} کے گرد، اور (د) لکیر \عددی{y=1} کے گرد۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%========================
\ابتدا{سوال}
ربع اول میں بالائی جانب منحنی \عددی{y=x^{-1/4}}، بائیں جانب لکیر \عددی{x=\tfrac{1}{16}}، اور نیچے جانب لکیر \عددی{y=1} سے گھیرے گئے خطے کو محور \عددی{x} کے گرد گھما کو جسم طواف پیدا کیا جاتا ہے۔ اس جسم کا حجم (ا) ترکیب چھلا، (ب) ترکیب خول سے معلوم کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
\عددی{\tfrac{9\pi}{16}}
...
%=========================
\ابتدا{سوال}
ربع اول میں بالائی جانب منحنی \عددی{y=\sqrt{x}}، بائیں جانب لکیر \عددی{x=\tfrac{1}{4}}، اور نیچے جانب لکیر \عددی{y=1} سے گھیرے گئے خطے کو محور \عددی{y} کے گرد گھما کو جسم طواف پیدا کیا جاتا ہے۔ اس جسم کا حجم (ا) ترکیب چھلا، (ب) ترکیب خول سے معلوم کریں۔
\انتہا{سوال}
%============================
\begin{figure}
\centering
...
\end{axis}
\end{tikzpicture}
\caption{منحنی $AB$ کے قطعہ $PQ$ کی لمبائی $\sqrt{\Delta x^2+\Delta y^2}$ ہو گی۔}
...
\end{axis}
\end{tikzpicture}
\caption{نقطہ $(c_k,f(c_k))$ پر ماس اور قطعہ متوازی ہیں۔}
...
اگر \عددی{f} ہموار ہو تب مسئلہ اوسط قیمت کے تحت \عددی{P} اور \عددی{Q} کے بیچ منحنی پر ایک ایسا نقطہ \عددی{(c_k,f(c_k))} پایا جائے گا جہاں منحنی کا مماس قطعہ \عددی{PQ} کا متوازی ہو گا (شکل \حوالہ{شکل_تکمل_استعمال_قطع_کثیر-الاضلاع})۔ اس نقطہ پر درج ذیل ہو گا۔
\begin{align*}
...
\end{align*}
چونکہ \عددی{[a,b]} پر \عددی{\sqrt{1+(f'(x))^2}} استمراری ہے لہٰذا خانہ بندی کا معیار صفر  کے قریب تر کرنے سے دائیں ہاتھ مجموعے کی حد  \عددی{\int_a^b\sqrt{a+(f'(x))^2}\dif x} ہو گی۔ منحنی کی لمبائی کی تعریف اس قطعی تکمل کی قیمت ہے۔
...
\end{align*} 
اس طرح مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ت} میں دیے دونوں تکمل درج ذیل ایک تفرقی  کلیہ کی صورت اختیار کرتے ہیں۔
\begin{align}\label{مساوات_تکمل_استعمال_لمبائی_قوس_ٹ}
L=\sqrt{\dif x^2+\dif y^2}
\end{align} 
ظاہر ہے کہ \عددی{\dif x} اور \عددی{\dif y} کو ایک ہی متغیر  کے لحاظ سے لکھنا ضروری ہے اور مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ٹ} میں دیا تکمل حل کرنے کے لئے تکمل کے موزوں حد بھی جاننا ضروری ہیں۔

ہم مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ٹ} کو مزید چھوٹا کر سکتے ہیں۔\عددی{\dif x^2} اور \عددی{\dif y^2} کو ایک چھوٹے مثلث کے اضلاع تصور کریں۔مسئلہ فیثاغورث  سے اس مثلث کا وتر \عددی{\dif s=\sqrt{\dif x^2+\dif y^2}} ہو گا (شکل \حوالہ{شکل_مثال_تکمل_فیثا_غورث})۔ تفریق \عددی{\dif s} کو اب قوس کی تفرقی  لمبائی تصور کیا جا سکتا ہے جس کا موزوں حدود کے بیچ تکمل لے کر قوس کی لمبائی دریافت کی جا سکتی ہے۔  مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ٹ} میں \عددی{\sqrt{\dif x^2+\dif y^2}} کو \عددی{\dif s} لکھنے سے مساوات کو \عددی{\dif s} کا تکمل لکھا جا سکتا ہے۔

\ابتدا{تعریف}
تفرقی لمبائی قوس اور لمبائی قوس کا تفرقی کلیہ درج ذیل ہیں۔
\begin{align*}
\dif s&=\sqrt{\dif x^2+\dif y^2}&&\text{\RL{تفرقی لمبائی قوس}}\\
L&=\int \dif s&&\text{\RL{لمبائی قوس کا تفرقی کلیہ}}
\end{align*}
\انتہا{تعریف}

\جزوحصہء{لا متناہی لمبائی کی  قوسین}\شناخت{حصہ_تکمل_استعمال_برف_کی_روئی}
...
\موٹا{اعدادی تکمل}\\
آپ سوچ رہے ہوں گے کہ کیوں اب تک لمبائی قوس میں زیادہ تر منحنیات کی مساواتیں پیچیدہ تھیں۔ اس کی وجہ لمبائی قوس کے تکمل میں \عددی{\sqrt{1+(\tfrac{\dif y}{\dif x})^2}} ہے جو عموماً مکمل مربع نہیں ہوتا  اور جس کی وجہ سے متکمل کا ضد تفرق ہم حاصل نہیں کر پاتے ہیں۔ حقیقت میں عموماً یہی جذر غیر بنیادی تکمل کا باعث بنتا ہے۔ اسی لئے، سوال \حوالہ{سوال_تکمل_استعمال_اعدادی_الف} اور سوال \حوالہ{سوال_تکمل_استعمال_اعدادی_ب}  کی طرح،  لمبائی قوس اور سطحی رقبہ کے تکمل  عموماً اعدادی طریقوں سے حل کئے جاتے ہیں۔ 
...
\end{tikzpicture}
\caption{غیر منفی تفاعل کی ترسیم کو محور $x$ کے گرد گھمانے سے سطح طواف پیدا کیا گیا ہے۔}
\end{subfigure}\hfill
\begin{subfigure}{0.3\textwidth}
\centering
...
اگر \عددی{f} ہموار ہو تب مسئلہ اوسط قیمت کے تحت \عددی{P} اور \عددی{Q} کے بیچ ایسا نقطہ \عددی{(c_k,f(c_k))} ضرور پایا جائے گا جہاں مماس قطعہ \عددی{PQ} کے متوازی ہو گا (شکل \حوالہ{شکل_تکمل_استعمال_مماس_متوازی_لکیر})۔اس نقطہ پر درج ذیل ہو گا۔
\begin{align*}
...
بری خبر یہ ہے کہ مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_ب} میں  \عددی{x_{k-1}}، \عددی{x_k} اور \عددی{c_k} ایک دوسرے سے مختلف ہیں اور انہیں ایک دوسرے جیسا کسی صورت نہیں بنایا جا سکتا ہے لہٰذا مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_ب} میں دیا گیا مجموعہ  ریمان مجموعہ نہیں ہے۔ اچھی خبر یہ ہے کہ اس سے کوئی فرق نہیں پڑتا۔ اعلیٰ احصاء کا مسئلہ بلس کہتا ہے کہ وقفہ \عددی{[a,b]} کی خانہ بندی کا معیار صفر تک پہچانے سے مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_ب} میں دیا گیا مجموعہ درج ذیل پر مرکوز ہو گا
\begin{align*}
...
\end{align*}
کو عموماً تفرقی لمبائی قوس \عددی{\dif s=\sqrt{\dif x^2+\dif y^2}} کی صورت میں لکھا جاتا ہے:
\begin{align*}
S=\int_a^b2\pi y\dif s\quad \text{اور}\quad S=\int_c^d2\pi x\dif s
\end{align*}
بایاں مساوات میں محور \عددی{x} سے قطعہ \عددی{\dif s} تک فاصلہ \عددی{y} ہے۔ دایاں مساوات میں محور \عددی{y} سے قطعہ \عددی{\dif s} کا فاصلہ \عددی{x} ہے۔ان دونوں کلیوں کو
\begin{align*}
...
\end{align*}
کسی مخصوص مسئلے میں آپ قوسچہ   \عددی{\dif s} اور رداس \عددی{\rho} کو کسی مشترکہ متغیر کی صورت میں لکھ کر تکمل کی حدود بھی اسی متغیر کے  روپ میں مہیا کریں گے۔ 
...
تفاعل \عددی{y=\sqrt{a^2-x^2},\, -a\le x\le x} کو محور \عددی{x} کے گرد گھمانے سے کروی سطح حاصل ہوتا ہے۔ دکھائیں کہ مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_پ} سے بھی رداس \عددی{a} کرہ کا سطحی رقبہ \عددی{4\pi a^2} حاصل ہوتا ہے۔
\انتہا{سوال}
%=======================
\ابتدا{سوال}\ترچھا{نئی تعریف کی پرکھ}\\
لکیری قطعہ \عددی{y=\tfrac{r}{h}x,\, 0\le x\le h} کو محور \عددی{x} کے گرد گھمانے سے مخروط پیدا ہوتا ہے جس کے پہلو کا رقبہ \عددی{\pi r\sqrt{r^2+h^2}} ہوتا ہے جہاں مخروط کا قد \عددی{h} اور اس کے تلا  کا رداس \عددی{r} ہے لہٰذا اس کے ترچھا قد \عددی{\sqrt{r^2+h^2}} ہو گا۔ تکمل سے مخروط کے پہلو کا رقبہ دریافت کر کے اس کلیہ کی تصدیق کریں۔ 
\انتہا{سوال}
%=================
\ابتدا{سوال}
   (ا) منحنی \عددی{y=\cos x,\, -\tfrac{\pi}{2}\le x\le \tfrac{\pi}{2}} کو محور \عددی{x} کے گرد گھما کر سطح طواف پیدا ہوتا ہے۔ اس سطح طواف کے رقبہ کا تکمل لکھیں جس کو حل کرنا حصہ \حوالہ{حصہ_تراکیب_تکونیاتی_بدل} میں سکھایا جائے گا۔ (ب) اس سطحی رقبے کو اعدادی طریقہ سے دریافت کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\end{align*}
\item
دکھائیں کہ \عددی{k} ویں ذیلی وقفہ میں مماسی قطعہ کی لمبائی \عددی{ L_k=\sqrt{(\Delta x_k)^2+(f'(m_k)\Delta x_k)^2}} ہے۔
\item
