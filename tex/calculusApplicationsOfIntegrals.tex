...
\begin{enumerate}[1.]
\item
\ترچھا{منحنیات ترسیم کر کے ایک نمائندہ مستطیل بنائیں۔} اس سے معلوم ہو گا کہ کونسی منحنی بالائی \عددی{f} اور کونسی زیریں \عددی{g} ہے۔ اس سے تکمل کی حد تعین کرنے میں بھی مدد ملتی ہے۔
\item
...
\item
وقفہ \عددی{[0,1]} میں \عددی{c}کی کونسی قیمت  اعظم حجم دے گی؟
\item
