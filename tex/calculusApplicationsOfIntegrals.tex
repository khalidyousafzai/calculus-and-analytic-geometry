...
\end{align} 
کو عموماً تفرقی روپ کے بجائے تفریقی روپ میں لکھا جاتا ہے۔ ایسا با ضابطہ طور پر کرنے کے لئے  تفرق کو تفریقوں کا حاصل تقسیم تصور کریں۔یوں پہلے تکمل میں درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
