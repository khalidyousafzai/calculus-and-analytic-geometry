...
%===========================
\ابتدا{سوال}
ہیلی کاپٹر کی پہنچ  بڑھانے کی خاطر اس کے نیچے تیل کا اضافی حوض نسب کرنا مطلوب ہے۔ منحنی \عددی{y=\tfrac{1}{3}-\tfrac{x^2}{3},\, -1\le x\le 1} کو محور \عددی{x} کے گرد گھما کر حوض بنایا جاتا ہے۔ اس حوض میں کتنے لٹر تیل آئے گا؟
\انتہا{سوال}
%=============================
