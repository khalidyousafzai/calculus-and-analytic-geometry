...
\end{align}
ہم توقع کرتے ہیں کہ  جیسے جیسے خانہ بندی کا معیار صفر کے قریب  پہنچتا ہو، ویسے ویسے یہ تخمین  بہتر سے  بہتر ہو گی، لہٰذا ہم \عددی{x=a} سے \عددی{x=b} تک \عددی{F} کے تکمل کو \عددی{a} سے \عددی{b} تک قوت \عددی{F} کے کام کی تعریف لیتے ہیں۔ 
