...
\item
عمودی تراش چوکور ہیں جن کے وتر مستوی  \عددی{xy} میں ہیں۔ چوکور کے وتر کی لمبائی چوکور کے ضلع کے \عددی{\sqrt{2}} گنّا ہوتی ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_رقبہ_عمودی_تراش_الف}-ج)۔
\item
...
%======================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-1} اور \عددی{x=1} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کی  چوکور عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے وتر نصف دائرہ \عددی{y=-\sqrt{1-x^2}} سے نصف دائرہ \عددی{y=\sqrt{1-x^2}} تک ہیں۔ چوکور کے وتر کی لمبائی چوکور کے ضلع کے \عددی{\sqrt{2}} گنّا ہوتی ہے۔
\انتہا{سوال}
%======================
...
%====================
\موٹا{اعدادی تکمل}\\
سوال \حوالہ{سوال_تکمل_استعمال_اعدادی_درستگی_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_اعدادی_درستگی_الف} میں محور \عددی{x} کے گرد  دی گئی  منحنیات گھمانے سے سطح طواف پیدا ہوں گی۔ ان سطح طواف کے رقبے اعدادی تراکیب سے \عددی{2} اعشاریہ درستگی تک معلوم کریں۔
