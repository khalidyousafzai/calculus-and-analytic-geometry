...
\item
رقبہ عمودی تراش کا تکمل حجم دیگا۔
\end{enumerate}
...
\end{align}
وقفہ \عددی{[a,b]} کی خانہ بندی باریک کرنے  سے حاصل مجموعہ تخمیناً  زیادہ بہتر ہو گا۔ ہم دکھانا چاہیں گے کہ خانہ بندی کا معیار صفر  کے قریب تر کرنے  سے مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_الف} کا مجموعہ قابل معلوم حد دیگا۔ ایسا کرنے کی خاطر ہم مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_الف} کو ایسے روپ میں لکھتے ہیں کہ اس پر مسئلہ \حوالہ{مسئلہ_تکمل_قطعی_تکمل_کی_موجودگی} (صفحہ \حوالہصفحہ{مسئلہ_تکمل_قطعی_تکمل_کی_موجودگی}) کا اطلاق  ہو۔ ہم تفرق کے مسئلہ اوسط قیمت سے شروع کرتے ہیں۔ 
...
\end{align}
ہم توقع کرتے ہیں کہ \عددی{[a,b]} کی زیادہ باریک خانہ بندی سے تخمین بہتر ہو گی۔ ہم دکھانا چاہتے ہیں کہ خانہ بندی کا معیار صفر کے قریب تر کرنے سے  مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_الف} میں دیا گیا مجموعہ قابل حل حد دیگا۔ 
