...
محور \عددی{x} کے گرد منحنی \عددی{y=2\sqrt{x},\, 1\le x\le 2} گھما کر سطح طواف پیدا کیا جاتا ہے (شکل \حوالہ{شکل_مثال_تکمل_استعمال_سطح_طواف_کا_رقبہ_الف})۔ سطح طواف کا رقبہ تلاش کریں۔
...
\انتہا{سوال}
%======================
سوال \حوالہ{سوال_تکمل_استعمال_ترسیم_تکمل_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_ترسیم_تکمل_ب} میں منحنی کو دیے گئے محور کے گرد گھما کر سطح  طواف پیدا کیا جاتا ہے۔ سطح کا رقبہ معلوم کریں۔ بہتر ہو گا کہ آپ دیے گئے منحنی کو کمپیوٹر پر ترسیم کر کے منحنی کی صورت سیکھیں۔ 
...
ستارہ نما \عددی{x^{2/3}+y^{2/3}=1} کا وہ حصہ جو محور \عددی{x} سے اوپر واقع ہے کو محور \عددی{x} کے گرد گھما کر سطح طواف پیدا کیا جاتا ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_دوبارہ_ستارہ_نما})۔  سطح طواف کا رقبہ معلوم کریں۔ (اشارہ۔ ربع اول میں منحنی کے حصہ \عددی{y=(1-x^{2/3})^{3/2},\, 0\le x\le 1}) کو محور \عددی{x} کے گرد گھما کر نتیجہ  کو دگنا کریں۔)
\انتہا{سوال}
%================
\begin{figure}
\centering
...
%=========================
\ابتدا{سوال}
نصف دائرہ \عددی{y=\sqrt{a^2-x^2}} کا وسطانی مرکز \عددی{(0,\tfrac{2a}{\pi})} ہے۔ اس نصف دائرے  کو لکیر \عددی{y=x-a} کے گرد گھما کر سطح طواف پیدا کیا جاتا ہے۔ اس سطح طواف کا سطحی رقبہ تلاش کریں۔
\انتہا{سوال}
%====================
\ابتدا{سوال}
