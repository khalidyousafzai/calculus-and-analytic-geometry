...
\موٹا{دوسرا قدم:}\quad
تکمل کی حدیں  جاننے کے لئے ہم \عددی{y=2-x^2} اور \عددی{y=-x} کو ایک ساتھ \عددی{x} کے لئے حل کرتے ہیں۔
\begin{align*}
...
تکمل کے حصول میں بعض اوقات تکمل کی  حد کی تلاش سب سے زیادہ تنگ کرنے والا عمل ثابت ہوتا ہے۔ انہیں معلوم کرنے کے لئے ہمیں یا تو ایک تفاعل کے جذر تلاش کرنے ہوتے ہیں اور یا دو منحنیات کے نقاط تقاطع۔
...
\موٹا{دوسرا قدم:}\quad
خطہ \عددی{A} میں تکمل کی حدیں \عددی{a=0} اور \عددی{b=2} ہیں۔ خطہ \عددی{B} کی بائیں حد \عددی{a=2} ہے۔اس کی دائیں حد جاننے کے لئے ہم مساوات  \عددی{y=\sqrt{x}} اور  \عددی{y=x-2} کو ایک ساتھ حل کرتے ہیں۔
\begin{align*}
...
\موٹا{دوسرا قدم:}\quad
تکمل کی زیریں حد \عددی{y=0} ہے۔ تکمل کی بالائی حد جاننے کے لئے ہم \عددی{x=y+2} اور \عددی{x=y^2} کو \عددی{y} کے لئے حل کرتے ہیں۔
\begin{align*}
...
رداس \عددی{3} کے بیلن کو دو مستوی سے کاٹ کر قوسی پچر بنایا جاتا ہے۔ایک مستوی بیلن کے محور پر عمودی ہے جبکہ دوسرا مستوی پہلے مستوی کو بیلن کے وسط پر \عددی{45^{\circ}} سے قطع کرتا ہے۔ پچر کا حجم تلاش کریں۔
...
کوالئیرے نے طالب علمی کے دوران دریافت کیا کہ اگر دو مستوی خطوں کو محور \عددی{x} کے یکساں وقفہ پر یوں رکھنا ممکن ہو کہ کسی بھی \عددی{x} پر دونوں خطوں کی چوڑائی یکساں  ہو تب دونوں خطوں کا رقبہ یکساں  ہو گا (شکل \حوالہ{شکل_سوال_تکمل_استعمال_چوڑائی_برابر})۔ ٹھوس اجسام کے لئے   کوالئیرے نے یہی مسئلہ  کبھی ثابت نہیں کیا۔ اگر شکل \حوالہ{سوال_تکمل_استعمال_چوڑائی_برابر} میں بالائی اور زیریں سرحدیں استمراری تفاعل ہوں تب اس مسئلے کو ثابت کریں۔
...
تفاعل \عددی{y=x^2} اور لکیر \عددی{y=x} کے بیچ خطہ کو مثال بناتے ہوئے شکل \حوالہ{شکل_تکمل_استعمال_چھلا_خول} میں ترکیب چھلا اور ترکیب خول دونوں دکھائی  گئی ہیں۔شکل \حوالہ{شکل_تکمل_استعمال_چھلا_خول}-ا اور ب میں محور \عددی{y} کے گرد خطہ گھمایا گیا ہے جبکہ شکل-ج اور د میں محور \عددی{x} کے گرد خطہ گھمایا گیا ہے۔ دونوں صورتوں میں حجم کو ترکیب چھلا اور ترکیب خول سے حل کیا گیا ہے۔ اس مخصوص خطے کے لئے دونوں محور طواف کے لئے دونوں تراکیب کارآمد ہیں لیکن ایسا ہر  مرتبہ نہیں ہو گا۔مثال کے طور پر محور \عددی{y} کے گرد گھماتے ہوئے ترکیب چھلا میں ہمیں \عددی{y} کے لحاظ سے تکمل حل کرنا ہو گا۔البتہ عین ممکن ہے کہ متکمل کو \عددی{y} کی صورت میں لکھنا ممکن نہ ہو۔ایسی صورت میں ہمیں ترکیب خول استعمال کرنی ہو گی جو ہمیں \عددی{x} کے لحاظ سے تکمل لینے کی اجازت دیگی۔
...
\end{align} 
عموماً تفارق  کے بجائے تفرقات میں لکھی  جاتی ہے۔ ایسا با ضابطہ طور پر کرنے کے لئے  تفارق کو تفرقات کا حاصل تقسیم تصور کریں۔یوں پہلے تکمل میں درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
...
\end{align} 
ظاہر ہے کہ \عددی{\dif x} اور \عددی{\dif y} کو ایک ہی متغیر  کے لحاظ سے لکھنا ضروری ہے اور مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ٹ} میں دیا  گیا تکمل حل کرنے کے لئے تکمل کی  موزوں حدیں جاننا   ضروری ہیں۔
...
لمبائی کی تعریف ہموار منحنیات کے لئے پیش کی گئی تھی جن کا ہر نقطے  پر مماس استمراری مڑتا ہے۔ برف کی روئی اتنی نا ہموار ہے کہ لمبائی کے  کلیہ کا اس پر اطلاق کرنا ممکن نہیں۔
...
\موٹا{اعدادی تکمل}\\
آپ سوچ رہے ہوں گے کہ  اب تک لمبائی قوس میں زیادہ تر منحنیات کی مساواتیں  کیوں پیچیدہ تھیں۔ اس کی وجہ لمبائی قوس کے تکمل میں \عددی{\sqrt{1+(\tfrac{\dif y}{\dif x})^2}} ہے جو عموماً مکمل مربع نہیں ہوتا  اور جس کی وجہ سے متکمل کا ضد تفرق ہم حاصل نہیں کر پاتے۔ حقیقت میں عموماً یہی جذر غیر بنیادی تکمل کا باعث بنتا ہے۔ اسی لئے، سوال \حوالہ{سوال_تکمل_استعمال_اعدادی_الف} اور سوال \حوالہ{سوال_تکمل_استعمال_اعدادی_ب}  کی طرح،  لمبائی قوس اور سطحی رقبہ کے تکمل  عموماً اعدادی طریقوں سے حل کیے  جاتے ہیں۔ 

\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_اعدادی_الف}
آپ کا ادارہ چھتوں کے لئے لوہے کی  نالیدار چادریں بناتا ہے۔نالیدار چادروں کی عمودی تراش درج ذیل کے مطابق درکار ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_اعدادی_الف})۔
\begin{align*}
...
\end{align*} 
قطعہ \عددی{PQ} کے پیدا کردہ مخروط مقطوع (شکل \حوالہ{مساوات_تکمل_استعمال_لکیر_قوس_اہم_متغیرات}) کے لئے اس سے درج ذیل حاصل ہوتا ہے۔
\begin{align*}
...
محور \عددی{y} کے گرد سطح طواف کے لئے ہم مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_پ} میں \عددی{x} اور \عددی{y} کی جگہیں   آپس میں تبدیل کرتے  ہیں۔
...
قوت مروڑ کا مجموعہ، مبدا کے گرد نظام گھومنے کے رجحان کی  ناپ ہے۔ اس مجموعہ کو \اصطلاح{نظام کی قوت مروڑ}\فرہنگ{قوت مروڑ!نظام}\حاشیہب{system torque}\فرہنگ{torque!system} کہتے ہیں۔
\begin{align}
...
بہت سارے موقعوں پر ہمیں سلاخ یا پتلی پٹی کی کمیت کا مرکز مطلوب ہوتا ہے۔ایسی صورتوں میں اگر ہم تقسیم کمیت  کو استمراری تفاعل کی صورت میں لکھ سکیں  تب ہمارے کلیات میں جمع کے بجائے تکمل ہو گا جیسے نیچے سمجھایا گیا ہے۔

فرض کریں ایک لمبی پٹی \عددی{x=a} تا \عددی{x=b} محور \عددی{x} پر پڑی ہے۔ ہم \عددی{[a,b]} اس پٹی کی خانہ بندی کرتے ہوئے اس کو \عددی{\Delta m_k} کمیت کے چھوٹے چھوٹے  ٹکڑوں میں تقسیم کرتے ہیں۔ \عددی{k} ویں ٹکڑے کی لمبائی \عددی{\Delta x_k} ہے اور یہ مبدا سے تقریباً \عددی{x_k} فاصلے پر واقع ہے۔اب تین چیزوں کا مشاہدہ کریں۔
...
ایک سلاخ جس کی لمبائی \عددی{\SI{10}{\meter}} ہے بائیں سے دائیں چلتے ہوئے موٹا ہوتا ہے (شکل \حوالہ{شکل_تکمل_استعمال_متغیر_پتلا_سلاخ}) لہٰذا اس کی کثافت مستقل ہونے کے بجائے \عددی{\delta(x)=1+\tfrac{x}{10}\,\si{\kilo\gram\per\meter}} ہے۔ سلاخ کا مرکز کمیت معلوم کریں۔
...
کئی بار ہمیں پتلی مستوی چادر کا مرکز کمیت درکار ہوتا ہے۔ ایسی صورت میں ہم فرض کرتے ہیں کہ کمیت کی تقسیم استمراری ہے لہٰذا \عددی{\bar{x}} اور \عددی{\bar{y}} کے کلیات میں متناہی مجموعوں کے بجائے تکمل پائے جاتے ہیں۔آئیں اس پر غور کرتے ہیں۔
\begin{figure}
\centering
\begin{tikzpicture}[font=\small]
...
\حل
ہم نصف دائرے کو تفاعل \عددی{y=\sqrt{a^2-x^2}} سے ظاہر کرتے ہیں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_تار_نصف_دائرہ})۔کمیت کی تقسیم محور \عددی{y} کے لحاظ سے تشاکلی ہے لہٰذا  \عددی{\bar{x}=0} ہو گا۔ہم تصور میں تار کو چھوٹے قطعات میں تقسیم کر کے \عددی{\bar{y}} تلاش کرتے ہیں۔ نمائندہ قطعہ کے لئے درج ذیل ہو گا۔
\begin{multicols}{2}
\begin{enumerate}[]
\item
لمبائی:\quad
...
تکون کے  راس  کے مخالف ضلع کے وسط تک قطعہ کو وسطانیہ کہتے ہیں۔ آپ کو یاد ہو گا کہ ضلع سے \عددی{\tfrac{1}{3}} فاصلہ پر وسطانیے  ایک دوسرے کو قطع کرتے ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_وسطانیہ})۔ دکھائیں کہ تکون کا وسطانی مرکز بھی اسی نقطہ پر واقع ہے۔ ایسا کرنے کی خاطر درج ذیل اقدام کریں۔
\begin{enumerate}[a.]
\item
...
\موٹا{پتلی تار}\\
\ابتدا{سوال}
مستقل کثافت کا ایک تار منحنی \عددی{y=\sqrt{x}} پر \عددی{x=0} سے \عددی{x=2} تک واقع ہے۔محور \عددی{x} کے لحاظ سے اس تار کا معیار اثر تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{13\delta}{6}$
...
%================
\ابتدا{سوال}
مستقل کثافت کا ایک تار منحنی \عددی{y=x^3} پر \عددی{x=0} سے \عددی{x=1} تک واقع ہے۔محور \عددی{x} کے لحاظ سے اس تار کا معیار اثر تلاش کریں۔
\انتہا{سوال}
%================
\ابتدا{سوال}
...
\end{align*}
یوں پانی، بوکا اور رسّی تینوں کو کھینچنے کے لئے درکار کام درج ذیل ہو گا۔
\begin{align*}
...
\item
\ترچھا{کام:}\quad
ہم اسپرنگ کو چھت سے یوں آویزاں تصور کرتے ہیں کہ اس کا آزاد سر \عددی{x=0} پر ہو (\حوالہ{شکل_مثال_تکمل_استعمال_تان_اسپرنگ_ب})۔اسپرنگ کی لمبائی کو اس کی  قدرتی لمبائی سے \عددی{x} میٹر زیادہ کرنے کے لئے درکار قوت \عددی{F=kx} ہو گی جو اسپرنگ کو نیچے رخ کھینچے گی۔یوں \عددی{x=0} سے \عددی{x=\SI{2}{\meter}} تک کھینچنے کے لئے کام درج ذیل ہو گا۔
\begin{align*}
...
\end{align*}
کام درکار ہو گا جو وقفہ \عددی{[0,3]} پر تفاعل \عددی{\frac{9114\pi}{4}(3.5-y)y^2} کا ریمان مجموعہ ہے۔ تیل کو حوض کے کنارے تک پمپ کرنے کے لئے درکار کام، خانہ بندی کا معیار صفر تک کرنے سے حاصل، ریمان مجموعے کی حد ہو گی:
\begin{align*}
...
\ابتدا{سوال}
اگر مثال \حوالہ{مثال_تکمل_استعمال_کنواں_اور_بوکا} میں بوکا کا حجم \عددی{\SI{20}{\liter}} ہو لیکن اس میں سوراخ بھی بڑا ہو تا کہ اب بھی  بوکا کو کنواں سے نکالتے ہوئے بوکا خالی ہو جاتا ہو۔ بوکا اور رسّی کی کمیت کو شامل نہ کرتے ہوئے ایک بار بوکا نکالنے کے لئے درکار کام دریافت کریں۔بوکا سے پانی کے اخراج کو مستقل تصور کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{1960}{\joule}$
...
\item
فرض کریں ایک برقیہ  \عددی{(1,0)} اور دوسرا \عددی{(-1,0)} پر واقع ہیں۔ تیسرے برقیے  کو \عددی{(5,0)} سے \عددی{(3,0)} تک منتقل کرنے کے لئے کتنی توانائی درکار ہو گی؟
\end{enumerate}
\انتہا{سوال}
%==================
...
\جزوحصہء{قاعدہ دولس}
آپ جانتے ہیں کہ  چننے کے بعد سیب کا ذائقہ  وقت کے ساتھ تبدیل ہوتا ہے۔ سیب میں شکر وقت کے ساتھ نشاستہ میں تبدیل ہوتا ہے۔ سیب میں نشاستہ کی مقدار معلوم کرنے کے لئے ہم سیب کا ایک باریک کتلے  کو خوردبین میں دیکھتے ہیں۔ نشاستہ کے ہر دانہ کی  سطح عمودی تراش خوردبین میں صاف نظر آتا ہے لہٰذا کتلے کی سطح میں نشاستہ کے رقبہ عمودی تراش کا تناسب معلوم کیا جا سکتا ہے۔ یہ دو بعدی تناسب سیب میں نشاستہ کے تین بعدی تناسب کے برابر ہو گا۔ دو بعدی اور تین بعدی تناسب کی یکسانیت  اوسط قیمت کی تصور پر مبنی ہے۔
