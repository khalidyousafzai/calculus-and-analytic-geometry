...
مساوات \حوالہ{مساوات_تکمل_استعمال_تعریف_حجم_الف} استعمال کرنے کے لیے درج ذیل تین اقدام کرنے ہوں گے۔
...
تکون کے  راس سے ، راس   کے مخالف ضلع کے وسط تک ، قطعہ کو وسطانیہ کہتے ہیں۔ آپ کو یاد ہو گا کہ ضلع سے \عددی{\tfrac{1}{3}} فاصلے  پر وسطانیے  ایک دوسرے کو قطع کرتے ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_وسطانیہ})۔ دکھائیں کہ تکون کا وسطانی مرکز بھی اسی نقطہ پر واقع ہے۔ ایسا کرنے کی خاطر درج ذیل اقدام کریں۔
\begin{enumerate}[a.]
\item
...
دکھائیں کہ جب \عددی{\alpha} کی قیمت کم ہو تب وسطانی مرکز سے قطعہ \عددی{AB} تک فاصلہ \عددی{d} تقریباً \عددی{\tfrac{2h}{3}} ہو گا۔ایسا درج ذیل اقدام سے ہو گا۔
\begin{enumerate}[a.]
\item
\begin{enumerate}[1.]
\item
...
\ابتدا{سوال}
اگر مثال \حوالہ{مثال_تکمل_استعمال_کنواں_اور_بوکا} میں بوکا کا حجم \عددی{\SI{20}{\liter}} ہو لیکن اس میں سوراخ بھی بڑا ہو تا کہ اب بھی  بوکا کو کنواں سے نکالتے ہوئے بوکا خالی ہو جاتا ہو۔ بوکا اور رسّی کی کمیت کو شامل نہ کرتے ہوئے ایک بار بوکا نکالنے کے لیے درکار کام دریافت کریں۔بوکا سے پانی کے اخراج کو مستقل تصور کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{1960}{\joule}$
...
%====================
\ابتدا{سوال}
فرض کریں کہ مثال \حوالہ{مثال_تکمل_استعمال_کنواں_اور_بوکا} میں بوکا کو اس رفتار سے اوپر کھینچا جاتا ہے کہ آخر میں بوکا میں \عددی{\SI{4}{\liter}} پانی ہوتا ہے۔ پانی نکالنے میں کتنا کام درکار ہو گا؟  بوکا اور رسّی کی کمیت کو شامل نہ کریں اور بوکا سے پانی کے اخراج کو مستقل تصور کریں۔\\
\انتہا{سوال}
%==================
\ابتدا{سوال}
ایک کوہ پیما چٹان سے لٹکی ہوئی \عددی{\SI{50}{\meter}} رسّی کو اوپر کھینچتا ہے۔ رسّی کی کثافتی وزن \عددی{\SI{0.624}{\newton\per\meter}} ہے۔ کتنا کام درکار ہو گا؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{780}{\joule}$
...
%===============
\ابتدا{سوال}
ریل گاڑی کے ڈبوں پر نسب اسپرنگ ان ڈبوں کو ایک دوسرے سے دور رکھتے ہیں اور ان کی ٹکراؤ کو محفوظ بناتے ہیں۔ ایسا ایک اسپرنگ جس کی قدرتی لمبائی \عددی{\SI{20}{\centi\meter}} ہے پر \عددی{\SI{100000}{\newton}} کی قوت  لاگو کرنے سے اسپرنگ کی کم سے کم لمبائی \عددی{\SI{12}{\centi\meter}} حاصل ہوتی ہے۔ (ا) اسپرنگ کا مقیاس لچک تلاش کریں۔ (ب) اسپرنگ کو پہلا \عددی{\si{\centi\meter}} دبانے کے لیے کتنا کام درکار ہو گا۔ اس کو دوسرا سنٹی میٹر دبانے کے لیے کتنا کام درکار ہو گا؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%====================
\ابتدا{سوال}
\اصطلاح{بے زنگ فولاد}\فرہنگ{فولاد!بے زنگ}\حاشیہب{stainless steel}\فرہنگ{stainless steel} کا بڑا حوض بنانے کے لیے آپ
 منحنی \عددی{y=x^2,0\le x\le\SI{4}{\meter}} کو محور \عددی{y} کے گرد گھماتے ہو۔ یہ حوض سمندری پانی سے بھرا ہوا ہے جس کی کثافت تقریباً  \عددی{\SI{10000}{\newton\per\meter\cubed}} ہے۔ حوض کو خالی کرنے کی خاطر اس پانی کو حوض کے کنارے تک پمپ کرنے کے لیے کتنا کام کرنا ہو گا؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{21446605.9}{\joule}$
...
F=\frac{GMm}{r^2}
\end{align*} 
جہاں زمین کی کمیت \عددی{M=\SI{5.975e24}{\kilo\gram}} ہے جبکہ تجاذبی مستقل \عددی{G=\SI{6.6720e-11}{\newton\meter\squared\per\kilo\gram\squared}} ہے۔ زمین کا رداس \عددی{\SI{6370000}{\meter}} ہے۔ یوں زمین سے \عددی{\SI{35780}{\kilo\meter}} بلندی پر مدار تک \عددی{\SI{1000}{\kilo\gram}} مصنوعی سیارے کو منتقل کرنے کے لیے درج ذیل  کام درکار ہو گا۔
\begin{align*}
...
\begin{enumerate}[a.]
\item
فرض کریں کہ ایک منفی برقیہ نقطہ \عددی{(1,0)} پر واقع ہے جبکہ دوسرے برقیے کو محور \عددی{x} پر نقطہ \عددی{(-1,0)} سے مبدا تک منتقل کیا جاتا ہے۔ ایسا کرنے کے لیے کتنا کام کرنا ہو گا؟
\item
فرض کریں ایک برقیہ  \عددی{(1,0)} اور دوسرا \عددی{(-1,0)} پر واقع ہیں۔ تیسرے برقیے  کو \عددی{(5,0)} سے \عددی{(3,0)} تک منتقل کرنے کے لیے کتنی توانائی درکار ہو گی؟
\end{enumerate}
\انتہا{سوال}
%==================
...
%==================
\ابتدا{سوال}
ایک سائکل سوار بمع سائکل کی کمیت \عددی{\SI{80}{\kilo\gram}} ہے۔ ساکن حال سے \عددی{\SI{40}{\kilo\meter}} کی رفتار تک پہنچنے کے لیے کتنی توانائی درکار ہو گی؟
\انتہا{سوال}
%======================
\ابتدا{سوال}
...
p&=\rho g h
\end{align}
فشار کی اکائی  نیوٹن فی مربع میٹر \عددی{\si{\newton\per\meter\squared}} ہے۔ آپ نے دیکھا کہ سیال کی قیمت پر برتن کی صورت کا کوئی اثر نہیں پایا جاتا۔
...
کسی بھی محددی نظام میں سیال میں ڈوبے ہوئے انتصابی تختی کی ایک طرف پر قوت سیال حاصل کرنے کے لیے درج ذیل اقدام کریں۔
\begin{enumerate}[a.]
\item
...
ہم حوض کی تلا کو \عددی{y=0} پر رکھتے ہیں  (شکل \حوالہ{شکل_مثال_تکمل_استعمال_بیلنی_حوض_نچلی_پٹی_ٹھیک}) جبکہ محدد \عددی{y} کو اوپر کے رخ رکھتے ہیں۔ ہم \عددی{y} پر نمائندہ افقی پٹی کے لیے درج ذیل لکھ سکتے ہیں۔
\begin{enumerate}[a.]
\item
گہرائی پٹی:\quad
$40-y$
...
سیال میں ڈوبی انتصابی تختی کے ایک طرف پر قوت سیال \عددی{F} معلوم کرنے کی لیے \عددی{\rho g}، تختی کے وسطانی مرکز کی گہرائی \عددی{\bar{h}} اور تختی کے رقبہ \عددی{S} کا حاصل ضرب لیں۔
...
\حل
مثلث کا وسطانی مرکز محدد \عددی{y} پر تلا سے راس کی جانب ایک تہائی فاصلہ پر  واقع ہے(شکل \حوالہ{شکل_مثال_تکمل_استعمال_مثلث_قوت_پانی}) لہٰذا \عددی{\bar{h}=1.5+2/3=\tfrac{13}{6}} ہو گا۔ مثلث کا رقبہ معلوم کرتے ہیں۔
\begin{align*}
...
مساوات \حوالہ{مساوات_تکمل_استعمال_قوت_سیال_وسطانی_مرکز} کہتی ہے کہ سیال میں ڈوبی انتصابی تختی پر قوت سیال وہی ہو گا جو تختی کے پورے رقبے کو تختی کے وسطانی مرکز، جو \عددی{\bar{h}} گہرائی پر ہے، منتقل کرنے سے  حاصل ہو گا۔عموماً اشکال کا وسطانی مرکز جدول سے دیکھا جا سکتا ہے اور یوں مساوات \حوالہ{مساوات_تکمل_استعمال_قوت_سیال_وسطانی_مرکز} قوت سیال معلوم کرنے کا ایک آسان ذریعہ بنتا ہے۔ ظاہر ہے کہ وسطانی مرکز حاصل کرتے ہوئے کسی نے   مساوات \حوالہ{مساوات_تکمل_استعمال_قوت_سیال_تکمل} کی تکمل کی طرح کا تکمل حل کرتے ہوئے وسطانی مرکز حاصل کیا ہو گا۔ چونکہ اس وقت آپ سیکھ رہے ہیں لہٰذا فی الحال قوت سیال دریافت کرنے کے لیے مسئلے کا خاکہ بنائیں اور مساوات \حوالہ{مساوات_تکمل_استعمال_قوت_سیال_تکمل} استعمال کریں۔
...
\item
حوض کے سر پر قوت کو آدھا کرنے کے لیے پانی کی سطح کو کتنا کم کرنا ہو گا؟
\item
...
%========================
\ابتدا{سوال}
مچھلیاں دیکھنے کے لیے ایک مچھلی گھر کی دیوار میں \عددی{\SI{2}{\meter}} چوڑا اور \عددی{\SI{1}{\meter}} اونچا شیشہ نسب ہے۔ شیشے کا تلا   سطح پانی سے \عددی{\SI{1.25}{\meter}} نیچے ہے۔ اس شیشے پر قوت پانی کتنی ہو گا۔ (سمندری پانی کی کثافت \عددی{\SI{1029}{\kilo\gram\per\meter\cubed}} ہے۔)
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{15126.3}{\newton}$
...
%=========================
\ابتدا{سوال}
دودھ کی فراہمی کے لیے ٹرک پر نسب  \عددی{\SI{2}{\meter}} قطر کا افقی بیلنی حوض استعمال کیا جاتا ہے۔ آدھے بھرے حوض کے ایک سر پر قوت سیال تلاش کریں۔ 
\انتہا{سوال}
%================
...
ایک مستطیل تالاب شکل \حوالہ{شکل_سوال_تکمل_استعمال_تالاب_پانی} میں دکھایا گیا ہے جس کی ایک طرف میں تکونی کھڑکی دی گئی ہے جو \عددی{\SI{62000}{\newton}} کی قوت برداشت کر سکتی ہے۔ اس خالی تالاب میں \عددی{\SI{10}{\meter\cubed\per\hour}} سے پانی بھرا جا رہا ہے۔ تکونی کھڑکی کتنی دیر میں اپنی برداشت کی  حد پر ہو گی؟
\انتہا{سوال}
%==========================
...
ریمان مجموعہ کی حد قطعی تکمل ہو گی۔
...
اگر کسی محددی لکیر پر ایک جسم کا مقام تفاعل \عددی{s(t)} دیتا ہو اور یہ جسم ایک ہی سمت میں حرکت کرتا ہو تب   \عددی{t=a} سے \عددی{t=b} تک جسم کے سمتی رفتار تفاعل \عددی{v(t)} کا تکمل  اس دورانیے میں طے شدہ فاصلہ دے گا۔ اگر جسم اس دورانیے میں سمت تبدیل کرتا ہو تب طے شدہ فاصل حاصل کرنے کے لیے ہمیں جسم کی رفتار \عددی{\abs{v(t)}} کا تکمل لینا ہو گا۔ جسم کی سمتی رفتار کا تکمل جسم کا \اصطلاح{ہٹاو}\فرہنگ{ہٹاو}\حاشیہب{displacement}\فرہنگ{displacement} \عددی{s(b)-s(a)} دے گا جو اس کی ابتدائی اور اختتامی مقامات کے بیچ فاصلہ ہے۔
...
آئیں دیکھیں ایسا کیوں ہو گا۔ فرض کریں کی تفاعل \عددی{s(t)}جسم کا مقام دیتا ہے اور \عددی{F} تفاعل \عددی{v} کا ضد تفرق ہے۔ تب
\begin{align*}
s(t)=F(t)+C
\end{align*}
...
\جزوحصہء{قاعدہ دولس}
آپ جانتے ہیں کہ  چننے کے بعد سیب کا ذائقہ  وقت کے ساتھ تبدیل ہوتا ہے۔ سیب میں شکر وقت کے ساتھ نشاستہ میں تبدیل ہوتا ہے۔ سیب میں نشاستہ کی مقدار معلوم کرنے کے لیے ہم سیب کا ایک باریک کتلے  کو خوردبین میں دیکھتے ہیں۔ نشاستہ کے ہر دانہ کی  سطح عمودی تراش خوردبین میں صاف نظر آتا ہے لہٰذا کتلے کی سطح میں نشاستہ کے رقبہ عمودی تراش کا تناسب معلوم کیا جا سکتا ہے۔ یہ دو بُعدی تناسب سیب میں نشاستہ کے تین بُعدی تناسب کے برابر ہو گا۔ دو بُعدی اور تین بُعدی تناسب کی یکسانیت  اوسط قیمت کی تصور پر مبنی ہے۔
...
\item
تفاعل \عددی{s} بالمقابل \عددی{t} ترسیم کریں اور مقام جسم کی ترسیم کے ساتھ تعلق پر تبصرہ کریں۔
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
دو اجسام محددی لکیر پر حرکت کرتے ہیں۔ ان اجسام کی سمتی رفتاروں کو شکل \حوالہ{شکل_سوال_تکمل_استعمال_دو_اجسام_رفتار} میں دکھایا گیا ہے۔ دیے گئے وقفے کے لیے اجسام کتنا فاصلہ طے کرتے ہیں اور ان کا ہٹاو کتنا ہو گا؟\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\end{figure}
\ابتدا{سوال}
ایک نمونی ریل گاڑی کی  \عددی{10} سیکنڈوں کے لیے پٹڑی پر آگے پیچھے  حرکت درج ذیل ہے۔ قاعدہ سمسن سے کل فاصلہ اور ہٹاو تلاش کریں۔
\begin{align*}
\begin{array}{rrrr}
\toprule
...
%===================
\ابتدا{سوال}
وہ واحد شکل جس کے لیے مساوات \حوالہ{مساوات_تکمل_استعمال_غلط_کلیہ} درست نتائج دیتا ہے بیلن ہے۔ لکیر \عددی{y=r,\, 0\le x\le h} کو محور \عددی{x} کر گرد گھما کر سطح طواف پیدا کریں۔ دکھائیں کہ مساوات \حوالہ{مساوات_تکمل_استعمال_غلط_کلیہ} سے اس  سطح طواف کا رقبہ \عددی{S=2\pi r h} حاصل ہوتا ہے۔
\انتہا{سوال}
%======================
\ابتدا{سوال}
