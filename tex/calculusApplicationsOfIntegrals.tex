...
\draw(2.5,1.845) circle (0.25cm and 0.625cm);
...
\draw(kSb)--(\len,0)--(kEb);
\draw([shift={(\angS:0.5*\ra cm and \ra cm)}]0,0) arc( \angS:\angE:0.5*\ra cm and \ra cm)coordinate[pos=0](kSa)coordinate[pos=1](kEa);
\draw(kSa)--(0,0)--(kEa);
\fill[white](uL) to [out=0,in=0](lL)--cycle;
...
\draw(kname) to [out=70,in=-155]++(0.5,1)node[right,align=center]{\RL{رقبہ عمودی تراش}\\  $S(x)=\pi (R(x))^2$};
...
%========================
\ابتدا{سوال}
ایک برتن کو رداس \عددی{\SI{16}{\centi\meter}} کے کرہ کا حصہ تصور کیا جا سکتا ہے۔برتن کی گہرائی \عددی{\SI{9}{\centi\meter}} ہے۔  برتن کا حجم تکمل کی مدد سے دریافت کریں۔
\انتہا{سوال}
%=======================
\ابتدا{سوال}
منحنی \عددی{y=\tfrac{x}{12}\sqrt{36-x^2},\, 0\le x\le \SI{6}{\centi\meter}} کو \عددی{x} محور کے گرد گھما کر ناشپاتی نما پیتل کا  گولہ بنایا جاتا ہے۔ پیتل کی کثافت \عددی{\SI{8.5}{\gram\per\centi\meter\cubed}} لیں۔ گولے کی کمیت کتنی ہو گی؟
\انتہا{سوال}
%==========================
\ابتدا{سوال}
