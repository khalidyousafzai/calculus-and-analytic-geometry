...
جب ایک دوسرے کو قطع کرنے والی منحنیات کے بیچ خطہ پایا جاتا ہو تب نقاط تقاطع سے تکمل کی  حدیں حاصل ہوں گی۔ 
...
%
\ابتدا{سوال}
مثبت استمراری تفاعل \عددی{f} اور \عددی{a\le x\le b} پر محور \عددی{x} کے بیچ رقبہ \عددی{4} ہے۔ منحنی \عددی{y=f(x)} اور \عددی{y=2f(x)} کے بیچ رقبہ  \عددی{x=a} تا \عددی{x=b} رقبہ تلاش کریں۔
\انتہا{سوال}
%============================
...
\موٹا{پہلا قدم:}\quad
\ترچھا{خاکہ۔}\quad
ہم اہرام کی چوٹی کو مبدا پر رکھ کر اہرام کو محور \عددی{x} پر لیٹا ہوا بنا کر نمائندہ رقبہ عمودی تراش بناتے ہیں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_اہرام_چوکور_قاعدہ})۔\\
\موٹا{دوسرا قدم:}\quad
...
ایک ٹھوس جسم  \عددی{x=-1} اور \عددی{x=1} پر محور \عددی{x}  کے عمودی سطحوں کے بیچ پایا جاتا ہے۔  محور \عددی{x} کے عمودی جسم  کے رقبہ عمودی تراش نصف دائرہ \عددی{y=-\sqrt{1-x^2}} اور نصف دائرہ \عددی{y=\sqrt{1-x^2}} کے بیچ پائے جاتے ہیں ۔ 
\begin{enumerate}[a.]
\item
...
ایک ٹھوس جسم  \عددی{x=0} اور \عددی{x=4} پر  محور \عددی{x}  کے عمودی  سطحوں کے بیچ پایا جاتا ہے۔ محور \عددی{x} کے عمودی جسم  کے رقبہ عمودی تراش، قطع مکافی  \عددی{y=-\sqrt{x}} اور قطع مکافی \عددی{y=\sqrt{x}} کے بیچ پائے جاتے ہیں۔ 
\begin{enumerate}[a.]
\item
...
ایک ٹھوس جسم \عددی{x=0} اور \عددی{x=4} پر  محور \عددی{x} کے عمودی سطحوں کے بیچ پایا جاتا ہے۔ جسم کے عمودی تراش کی صورت چوکور ہے جو  محور \عددی{x} کے عمودی ہیں اور جن کے وتر قطع مکافی \عددی{y=-\sqrt{x}} سے قطع مکافی \عددی{y=\sqrt{x}} تک ہیں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$16$
...
%========================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-1} اور \عددی{x=1} پر  محور \عددی{x} کے عمودی سطحوں کے بیچ پایا جاتا ہے۔ جسم کے عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے قطر دائری اقراص ہیں جو قطع مکافی \عددی{y=x^2} سے قطع مکافی \عددی{y=2-x^2} تک ہیں۔   
\انتہا{سوال}
%=====================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-1} اور \عددی{x=1} پر  محور \عددی{x} کے عمودی سطحوں کے بیچ پایا جاتا ہے۔ جسم کے چوکور عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے تلا کے کنارے نصف دائرہ \عددی{y=-\sqrt{1-x^2}} سے نصف دائرہ \عددی{y=\sqrt{1-x^2}} تک ہیں۔ \\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{16}{3}$  
...
%======================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-1} اور \عددی{x=1} پر  محور \عددی{x} کے عمودی سطحوں کے بیچ پایا جاتا ہے۔ جسم کے چوکور عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے وتر نصف دائرہ \عددی{y=-\sqrt{1-x^2}} سے نصف دائرہ \عددی{y=\sqrt{1-x^2}} تک ہیں۔ چوکور کے وتر کی لمبائی چوکور کے ضلع کے \عددی{\sqrt{2}} گنّا ہوتی ہے۔
\انتہا{سوال}
%======================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_شکل_دیا_گیا_ہے_الف}
ایک ٹھوس جسم کا تلا منحنی \عددی{y=2\sqrt{\sin x}} اور محور \عددی{x} پر وقفہ \عددی{[0,\pi]}  کے بیچ پایا جاتا ہے۔ محور \عددی{x} کے عمودی عمودی تراش درج ذیل ہیں۔
\begin{enumerate}[a.]
\item
...
\end{figure}
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-\tfrac{\pi}{3}} اور \عددی{x=\tfrac{\pi}{3}} پر  محور \عددی{x} کے عمودی سطحوں کے بیچ پایا جاتا ہے۔ جسم کے  عمودی تراش محور \عددی{x} کے عمودی ہیں جن کی خواص درج ذیل ہیں۔
\begin{enumerate}[a.]
\item
...
%=====================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{y=0} اور \عددی{y=2} پر  محور \عددی{y} کے عمودی سطحوں کے بیچ پایا جاتا ہے۔ جسم کے دائری عمودی تراش محور \عددی{y} کے عمودی ہیں جن کے قطر محور \عددی{y} سے قطع مکافی \عددی{x=\sqrt{5}y^2} تک ہیں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$8\pi$
...
ایک ٹھوس جسم کا تلا قرص \عددی{x^2+y^2\le 1} ہے۔ عمودی تراش    \عددی{y=-1} اور \عددی{y=1} کے بیچ محور \عددی{y} کے عمودی ہیں جو مساوی الساقین مثلث ہیں جن کا ایک ضلع قرص میں پایا جاتا ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_شکل_دیا_گیا_ہے_ب})۔
\انتہا{سوال}
%=====================
\موٹا{مسئلہ کوالئیرے}\\
...
ایک ٹھوس جسم \عددی{x=01} اور \عددی{x=12} پر  محور \عددی{x} کے عمودی سطحوں کے بیچ پایا جاتا ہے۔ جسم کے عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے  قطر لکیر \عددی{y=\tfrac{x}{2}} سے لکیر \عددی{y=x} تک ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_ٹھوس_جسم_حجم_ب})۔ اس جسم کا حجم کیوں اس قائمہ مخروط جتنا ہو گا جس کا قد \عددی{12} اور جس کے تلا کا رداس \عددی{3} ہو؟ 
\انتہا{سوال}
%======================
\begin{figure}
\centering
...
\end{scope}
\end{tikzpicture}
\caption{کرہ اور بیلن سے مخروط منفی کر کے ایک سا حجم ملتا ہے (سوال \حوالہ{سوال_تکمل_استعمال_نصف_کرہ_حجم})۔}
...
\end{align} 
ظاہر ہے کہ \عددی{\dif x} اور \عددی{\dif y} کو ایک سا  متغیر کی صورت میں لکھنا ضروری ہے اور مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ٹ} میں دیا تکمل حل کرنے کے لئے تکمل کے موزوں حد بھی جاننا ضروری ہیں۔
...
\end{align*}
دونوں نتائج ایک سا ہیں جیسا کہ ہونا چاہیے۔
\انتہا{مثال}
%========================
...
تکون کے  راس  کے مخالف ضلع کے وسط تک قطعہ کو وسطانیہ کہتے ہیں۔ آپ کو یاد ہو گا کہ ضلع سے \عددی{\tfrac{1}{3}} فاصلہ پر وسطانیے  ایک دوسرے کو قطع کرتے ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_وسطانیہ})۔ دکھائیں کہ تکون کا وسطانی مرکز بھی اسی نقطہ پر پایا جاتا ہے۔ ایسا کرنے کی خاطر درج ذیل اقدام کریں۔
\begin{enumerate}[a.]
\item
