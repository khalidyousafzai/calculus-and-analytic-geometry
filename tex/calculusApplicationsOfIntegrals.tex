...
%=====================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-1} اور \عددی{x=1} پر  \عددی{x} محور کے عمودی سطحوں کے بیچ پایا جاتا ہے۔ جسم کے چکور عمودی تراش \عددی{x} محور کے عمودی ہیں جن کے تلا کے کنارے نصف دائرہ \عددی{y=-\sqrt{1-x^2}} سے نصف دائرہ \عددی{y=\sqrt{1-x^2}} تک ہیں۔ \\
جواب:\quad
$\tfrac{16}{3}$  
\انتہا{سوال}
%======================
...
%====================
\ابتدا{سوال}
پانی کے حوض کے سر چکور ہیں جہاں چکور کا ضلع \عددی{\SI{2}{\meter}} ہے۔ 
\begin{enumerate}[a.]
\item
 پانی سے بھرے ہوئے حوض کے ایک سر پر قوت سیال تلاش کریں۔
\item
...
\موٹا{مسئلہ پاپس}\\
\ابتدا{سوال}
ایک چکور خطہ کے راس \عددی{(0,2)}، \عددی{(2,0)}، \عددی{(4,2)} اور \عددی{(2,4)} ہیں۔ اس خطہ کو محور \عددی{x} کے گرد گھما کر ایک ٹھوس جسم طواف پیدا کیا جاتا ہے۔ اس جسم کا حجم اور سطحی رقبہ تلاش کریں۔\\
جواب:\quad
...
محور \عددی{x} اور نصف دائرہ \عددی{y=\sqrt{a^2-x^2}} کے بیچ خطے کا وسطانی مرکز \عددی{(0,\tfrac{4a}{3\pi})} ہے۔ اس خطہ کہ لکیر \عددی{y=-a} گے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔ اس جسم طواف کا حجم تلاش کریں۔
\انتہا{سوال}
%=======================
\ابتدا{سوال}
