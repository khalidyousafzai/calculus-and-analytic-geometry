%this chapter and all before it have been edited by me using colouring. in this chapter i used AI a lot.
%dated 20 aug 2026

\باب{تکمل کا استعمال}\شناخت{باب_تکمل_کا_استعمال}

\موٹا{مجموعی جائزہ}\quad
ہم بہت سی معلومات کو تکمل کی مدد سے حاصل کر سکتے ہیں: منحنیات کے بیچ رقبہ، ٹھوس اجسام کے حجم اور سطحی رقبے، منحنیات کی لمبائیاں، زیر زمین  پایا جانے والا    پانی کی نکاسی کے لیے درکار کام، سیلاب روک   دروازوں پر اثر انداز قوتیں، ٹھوس اجسام کے نقطہ توازن کے محدد۔ ان تمام کو ہم بند وقفوں پر استمراری تفاعل کے ریمان مجموعوں کی  حدوں یعنی تکمل سے ظاہر کر کے ان حدوں  کو  احصاء سے حل کرتے ہیں۔

عملی استعمال میں ان قطعی تکملات کو ایک مخصوص طرز سے لکھا جاتا ہے جس کو سیکھ کر بوقت ضرورت  نئے تکمل لکھے جا سکتے ہیں۔ مخصوص عملی استعمال پر پہلے غور کیا جائے گا۔ اس کے بعد تکمل لکھنے کے طرز  پر  اور نئے تکمل لکھنے پر غور کیا جائے گا۔
...
\جزوحصہء{بنیادی کلیہ بطور ریمان مجموعوں کی حد} 
فرض کریں ایک خطہ کی بالائی سرحد  منحنی \عددی{y=f(x)} اور زیریں سرحد منحنی \عددی{y=g(x)} ہے  جبکہ اس کی  بائیں  اور دائیں سرحد بالترتیب خط \عددی{x=a} اور \عددی{x=b} ہیں (شکل \حوالہ{شکل_استعمال_تکمل_منحنیات_بیچ})۔ عین ممکن ہے کہ اس خطے کا رقبہ جیومیٹری سے حاصل کرنا ممکن ہو البتہ اختیاری استمراری \عددی{f} اور \عددی{g} کی صورت میں ہم عموماً رقبے کو تکمل سے حاصل کرتے ہیں۔ 
\begin{figure}
\centering
...
تکمل کی صورت دیکھنے کی خاطر ہم  وقفہ \عددی{[a,b]} پر خانہ بندی \عددی{P=\{x_0,x_1,\cdots,x_n\}} کے تحت خطہ کو \عددی{n} انتصابی مستطیلوں میں تقسیم کرتے ہیں (شکل \حوالہ{شکل_استعمال_تکمل_مستطیل_رقبے}) جہاں \عددی{k} واں مستطیل کا رقبہ درج ذیل ہو گا (شکل \حوالہ{شکل_استعمال_تکمل_چھوٹا_رقبہ})۔
\begin{align*}
\Delta S_k=\text{قد}\times \text{چوڑائی}=[f(c_k)-g(c_k)]\Delta x_k
\end{align*}
اس کے بعد ہم  خطہ  کے رقبے کو تخمیناً ان \عددی{n} مستطیل رقبوں کا مجموعہ لیتے ہیں۔
\begin{align*}
S\approx \sum\limits_{k=1}^n \Delta S_k=\sum\limits_{k=1}^n [f(c_k)-g(c_k)]\Delta x_k\quad\quad \text{\RL{ریمان مجموعہ}}
\end{align*}
چونکہ \عددی{f} اور \عددی{g} استمراری ہیں لہٰذا \عددی{\norm{P}\to 0} کرنے سے دائیں ہاتھ مجموعے کی حد  \عددی{\int_a^b[f(x)-g(x)]\dif x} ہو  گی۔(ذیل دیکھیں۔)
\begin{align*}
...
\end{tikzpicture}
\caption{
ہم خطہ کو تخمیناً محور \عددی{x} پر  عمودی مستطیلوں کے برابر لیتے ہیں۔
}
...
\end{tikzpicture}
\caption{
\عددی{k} واں مستطیل کا قد \عددی{f(c_k)-g(c_k)} اور اس کی چوڑائی \عددی{\Delta x_k} ہے  لہٰذا اس کا رقبہ\\ \عددی{\Delta S_k=(f(c_k)-g(c_k))\Delta x_k} ہو گا۔
}
...
\ابتدا{تعریف}
اگر پورے \عددی{[a,b]} پر \عددی{f} اور \عددی{g} استمراری ہوں اور \عددی{f(x)\ge g(x)} ہو تب \عددی{a} تا \عددی{b} منحنیات \عددی{f(x)} اور \عددی{g(x)} کے بیچ رقبہ \عددی{a} تا \عددی{b} متکمل \عددی{[f-g]} کا  (درج ذیل)تکمل ہو گا۔
...
مساوات \حوالہ{مساوات_تکمل_استعمال_رقبہ_تعریف} کو استعمال کرنے کے لیے ہم درج ذیل اقدام اٹھاتے ہیں۔

\موٹا{دو منحنیات کے بیچ رقبے کی تلاش}
\begin{enumerate}[1.]
\item
\ترچھا{منحنیات ترسیم کر کے ایک نمائندہ مستطیل بنائیں۔} اس سے معلوم ہو گا کہ کون سی منحنی بالائی \عددی{f} اور کون سی زیریں \عددی{g} ہے۔ اس سے تکمل کی حد تعین کرنے میں بھی مدد ملتی ہے۔
\item
\ترچھا{تکمل کی حد تلاش کریں۔}
\item
\ترچھا{متکمل \عددی{f(x)-g(x)} کا کلیہ لکھیں۔} اگر ممکن ہو اس کی سادہ صورت حاصل کریں۔
\item
\ترچھا{متکمل \عددی{[f(x)-g(x)]} کا تکمل \عددی{a} تا \عددی{b} حاصل کریں۔} قطعی تکمل سے حاصل عدد  درکار رقبہ ہو گا۔
\end{enumerate}
...
\موٹا{دوسرا قدم:}\quad
تکمل کی حدیں \عددی{a=0} اور \عددی{b=\tfrac{\pi}{4}} دی گئی ہیں۔\\
\موٹا{تیسرا قدم:}\quad
...
جب ایک دوسرے کو قطع کرنے والی منحنیات کے بیچ خطہ  واقع ہو تب نقاط تقاطع سے تکمل کی  حدیں حاصل ہوں گی۔ 
...
\حل
\موٹا{پہلا قدم:}\quad
منحنیات ترسیم کرتے ہوئے نمائندہ مستطیل بنائیں (شکل \حوالہ{شکل_مثال_استعمال_تکمل_رقبہ_تقاطع_تفاعل})۔ بالائی اور زیریں منحنیات کی نشاندہی کریں۔ ہم \عددی{f(x)=2-x^2} اور \عددی{g(x)=-x}  لیتے ہیں۔ نقاط تقاطع کے \عددی{x} محدد تکمل کی  حدیں ہوں گی۔\\
\موٹا{دوسرا قدم:}\quad
تکمل کی حدیں  جاننے کے لیے ہم \عددی{y=2-x^2} اور \عددی{y=-x} کو ایک ساتھ \عددی{x} کے لیے حل کرتے ہیں۔
\begin{align*}
2-x^2&=-x&&\text{\RL{$f(x)$ اور $g(x)$ کو برابر ٹہرائیں}}\\
x^2-x-2&=0&&\text{\RL{ایک جانب منتقلی}}\\
(x+1)(x-2)&=0&&\text{\RL{تجزی}}\\
x=-1,\quad x&=2&&\text{\RL{حل}}
\end{align*}
خطہ \عددی{x=-1} اور \عددی{x=2} کے بیچ  واقع ہے۔\\
 \موٹا{تیسرا قدم:}\quad
...
تکمل کے حصول میں بعض اوقات تکمل کی  حد کی تلاش سب سے زیادہ تنگ کرنے والا عمل ثابت ہوتا ہے۔ انہیں معلوم کرنے کے لیے ہمیں یا تو ایک تفاعل کے جذر تلاش کرنے ہوتے ہیں اور یا دو منحنیات کے نقاط تقاطع۔

مساوات \عددی{f(x)=g(x)} حل کرنے کے لیے  ہم \عددی{y=f(x)} اور \عددی{y=g(x)}  کو کمپیوٹر پر ترسیم کرتے ہوئے نقاط تقاطع دیکھ کر معلوم کر سکتے ہیں۔ اس کے علاوہ ہم مساوات \عددی{f(x)-g(x)=0} کا جذر بھی کمپیوٹر کی مدد سے تلاش کر سکتے ہیں۔ ان دونوں تراکیب کو درج ذیل پر لاگو کر کے دیکھیں (شکل \حوالہ{شکل_تکمل_استعمال_نقطہ_قطع})۔
\begin{align*}
...
\جزوحصہ{ایسی سرحدیں جن کے  کلیات  تبدیل ہوتے ہوں}
اگر سرحد کا کلیہ ایک یا ایک سے زیادہ نقطوں پر تبدیل ہوتا ہو تب ہم خطہ کو مطابقتی ذیلی خطوں میں تقسیم کرکے  ہر ذیلی خطے پر  انفرادی طور  مساوات \حوالہ{مساوات_تکمل_استعمال_رقبہ_تعریف} کا اطلاق کرتے ہیں۔

\ابتدا{مثال}\شناخت{مثال_استعمال_تکمل_تبدیل_کلیہ}
ربع اول میں \عددی{y=\sqrt{x}} کے   نیچے  اور \عددی{y=x-2}  کے اوپر  خطے کا رقبہ تلاش کریں۔

\حل
\موٹا{پہلا قدم:}\quad
ترسیم (شکل \حوالہ{شکل_مثال_استعمال_تکمل_تبدیل_کلیہ}) سے ہم دیکھتے ہیں کہ خطے کی بالائی سرحد \عددی{f(x)=\sqrt{x}} ہے جبکہ \عددی{0\le x\le 2}  پر اس کی نچلی سرحد \عددی{g(x)=0} اور \عددی{2\le x\le 4} پر نچلی سرحد \عددی{g(x)=x-2} ہے (نقطہ \عددی{x=2} پر \عددی{g(x)} کے دونوں کلیات ایک  سے  ہیں)۔ ہم \عددی{x=2} پر خطہ کو دو ذیلی حصوں \عددی{A} اور \عددی{B} میں تقسیم کر کے دونوں ذیلی خطوں کے لیے نمائندہ مستطیل بناتے ہیں۔\\
\موٹا{دوسرا قدم:}\quad
خطہ \عددی{A} میں تکمل کی حدیں \عددی{a=0} اور \عددی{b=2} ہیں۔ خطہ \عددی{B} کی بائیں حد \عددی{a=2} ہے۔اس کی دائیں حد جاننے کے لیے ہم مساوات  \عددی{y=\sqrt{x}} اور  \عددی{y=x-2} کو ایک ساتھ حل کرتے ہیں۔
\begin{align*}
\sqrt{x}&=x-2&&\text{\RL{$f(x)$ اور $g(x)$ کو برابر ٹہرائیں}}\\
x&=(x-2)^2=x^2-4x+4&&\text{\RL{مربع لیں}}\\
x^2-5x+4&=0&&\text{\RL{ایک جانب منتقلی}}\\
(x-1)(x-4)&=0&&\text{\RL{تجزی}}\\
x=1,\quad x&=4&&\text{\RL{حل}}
\end{align*}
صرف \عددی{x=4} مساوات \عددی{\sqrt{x}=x-2} کو مطمئن کرتا ہے جبکہ مربع لینے کی وجہ سے  اضافی حل \عددی{x=1}  پیدا ہوا ہے جس کو رد کیا جاتا ہے۔ یوں دائیں حد \عددی{b=4} ہے۔\\
\موٹا{تیسرا قدم:}
\begin{align*}
...
اگر سرحد کی مساواتیں \عددی{y} کے تفاعل ہوں تب تخمینی مستطیل کو انتصابی کے بجائے افقی بنایا جاتا ہے اور (ذیل دیکھیں)  بنیادی کلیہ میں \عددی{x} کی جگہ \عددی{y} پایا جائے گا (شکل \حوالہ{شکل_استعمال_تکمل_وائے_سرحد})۔
...
\end{minipage}
\caption
{ان اشکال میں دائیں سرحد $f$ اور بائیں  سرحد $g$ ہو گی لہٰذا $f(y)-g(y)$ غیر منفی ہو گا۔}
\label{شکل_استعمال_تکمل_وائے_سرحد}
\end{figure}

\ابتدا{مثال}\شناخت{مثال_استعمال_تکمل_تبدیل_کلیہ_دوم}
درج بالا مثال \حوالہ{مثال_استعمال_تکمل_تبدیل_کلیہ} کو اس  مرتبہ مساوات \حوالہ{مساوات_تکمل_استعمال_رقبہ_تعریف_دوم} کی مدد سے حل کریں۔

\حل
\موٹا{پہلا قدم:}\quad
ہم خطہ ترسیم کر کے نمائندہ افقی مستطیل بناتے ہیں (شکل \حوالہ{شکل_استعمال_تکمل_وائے_سرحد})۔ خطے کی دائیں  سرحد لکیر \عددی{x=y+2} ہے لہٰذا \عددی{f(y)=y+2} ہو گا۔خطے کی بائیں  سرحد \عددی{x=y^2} ہے لہٰذا \عددی{g(y)=y^2} ہو گا۔\\
\موٹا{دوسرا قدم:}\quad
تکمل کی زیریں حد \عددی{y=0} ہے۔ تکمل کی بالائی حد جاننے کے لیے ہم \عددی{x=y+2} اور \عددی{x=y^2} کو \عددی{y} کے لیے حل کرتے ہیں۔
\begin{align*}
y+2&=y^2&&\text{\RL{$f$ کو $g$ کے برابر  ٹہرائیں}}\\
y^2-y-2&=0\text{\RL{ایک ہاتھ منتقلی}}\\
(y+1)(y-2)&=0\text{\RL{تجزی}}\\
y=-1,\quad y&=2\text{\RL{حل}}
\end{align*}
تکمل کی بالائی حد \عددی{y=2} ہے (چونکہ \عددی{y=-1} افقی محور سے نیچے تفاعل کا نقطہ تقاطع دیتا ہے)۔\\
\موٹا{تیسرا قدم:}\quad
\begin{align*}
...
\end{align*}
یہ وہی جواب ہے جو مثال \حوالہ{مثال_استعمال_تکمل_تبدیل_کلیہ} میں حاصل کیا گیا۔ مثال \حوالہ{مثال_استعمال_تکمل_تبدیل_کلیہ} میں دو تکمل حل کرنے کی ضرورت پیش آئی جبکہ یہاں ایک  تکمل سے رقبہ  تلاش کرنا ممکن تھا۔
\انتہا{مثال}
%======================
...
مزید ایک  مرتبہ مثال \حوالہ{مثال_استعمال_تکمل_تبدیل_کلیہ} میں دیے گئے خطے کا رقبہ تلاش کریں۔

\حل
ہم  محور \عددی{x}  اور    \عددی{y=\sqrt{x},\, 0\le x\le 4} کے بیچ رقبہ سے  قاعدہ  \عددی{2} اور قد \عددی{2} کے تکون کا رقبہ منفی کرتے ہوئے درکار خطے کا رقبہ تلاش کر سکتے ہیں۔ 
\begin{align*}
...
گزشتہ تین مثالوں میں آپ نے دیکھا کہ دو منحنیات کے بیچ رقبہ بعض اوقات \عددی{x} کے بجائے \عددی{y} کے ساتھ تکمل لے کر نسبتاً آسانی سے حاصل ہوتا ہے۔ اسی طرح بعض اوقات تکمل اور جیومیٹری کے کلیات کو ملا کر جلد جواب حاصل ہوتا ہے۔ یوں تکمل لکھنے سے پہلے مسئلے پر غور کرنا بہتر ہو گا۔


%sec 6.1 question start here
%sec 6.1 question start here
\حصہء{سوالات}
\ابتدا{سوالات}
...
سوال \حوالہ{سوال_استعمال_تکمل_کل_سایہ_دار_رقبہ_الف} تا سوال \حوالہ{سوال_استعمال_تکمل_کل_سایہ_دار_رقبہ_ب} میں کُل سایہ دار رقبہ تلاش کریں۔
...
\ابتدا{سوال}
ہوائی جہاز کے پنکھے کی طرح کا خطہ منحنیات  \عددی{x-y^3=0} اور \عددی{x-y=0} گھیرتی ہیں۔ اس خطے کا رقبہ دریافت کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{1}{2}$
...
%===================
\ابتدا{سوال}
پنکھا نما خطہ \عددی{x-y^{1/3}=0} اور \عددی{x-y^{1/5}=0} کے بیچ  واقع  ہے۔ اس خطے کا رقبہ معلوم کریں۔
\انتہا{سوال}
%=======================
\ابتدا{سوال}
ربع اول میں لکیر \عددی{y=x}، لکیر \عددی{x=2}، منحنی \عددی{y=\tfrac{1}{x^2}}، اور  محور \عددی{x}    کے بیچ رقبہ تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$1$
...
%=======================
\ابتدا{سوال}
ربع اول میں بائیں جانب محور  \عددی{y} اور دائیں جانب منحنیات \عددی{y=\sin x} اور \عددی{y=\cos x} تکون نما خطہ گھیرتے ہیں۔ اس کا رقبہ معلوم کریں۔
\انتہا{سوال}
%======================
\ابتدا{سوال}
...
\begin{enumerate}[a.]
\item
خطے کا خاکہ کھینچیں اور اس پر افقی لکیر \عددی{y=c} اندازاً درست مقام پر بنائیں۔ قطع مکافی اور افقی لکیر جن نقطوں پر متقاطع ہیں، ان نقطوں کو \عددی{c} کے  روپ میں دریافت کر کے خاکے پر دکھائیں۔
\item
\عددی{y} کے لحاظ سے تکمل لے کر \عددی{c} کی قیمت معلوم کریں۔ (تکمل کی  حد میں \عددی{c} پایا جائے گا۔)
\item
\عددی{x} کے لحاظ سے تکمل لے کر \عددی{c} کی قیمت معلوم کریں۔ (اس مرتبہ \عددی{c}    متکمل میں بھی  پایا جائے گا۔)
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%====================
\ابتدا{سوال}
ربع اول میں بائیں جانب  محور \عددی{y}، نیچے لکیر \عددی{y=\tfrac{x}{4}}، بالائی بائیں منحنی \عددی{y=1+\sqrt{x}}، اور بالائی دائیں منحنی \عددی{y=\tfrac{2}{\sqrt{x}}} ایک رقبہ گھیرتے ہیں۔  رقبہ کو تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{11}{3}$
...
ربع اول میں بائیں جانب محور  \عددی{y}، نیچے لکیر \عددی{x=2\sqrt{y}}، بالائی بائیں منحنی \عددی{x=(y-1)^2}، اور بالائی دائیں
...
%
\ابتدا{سوال}
مثبت استمراری تفاعل \عددی{f} اور \عددی{a\le x\le b} پر محور \عددی{x} کے بیچ رقبہ \عددی{4} ہے۔ منحنی \عددی{y=f(x)} اور \عددی{y=2f(x)} کے بیچ    \عددی{x=a} تا \عددی{x=b} رقبہ تلاش کریں۔
\انتہا{سوال}
%============================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_رقبہ_محیط_خاکہ_پ}
درج ذیل میں سے کون سا تکمل شکل \حوالہ{شکل_سوال_تکمل_استعمال_رقبہ_محیط_خاکہ_پ} میں دکھایا گیا رقبہ دیتا ہے؟ اپنے جواب کی وجہ پیش کریں۔
\begin{enumerate}[a.]
\item
...
\item
یکے  بعد دیگرے  نقاط تقاطع کی  جوڑیوں  کے  درمیان \عددی{\abs{f(x)-g(x)}} کا تکمل حل کریں۔
\item
...
\انتہا{سوالات}
%===========================
%sec 6.1 questions end here
%sec 6.1 questions end here

\حصہ{ٹکیاں کاٹ کر حجم کی تلاش}\شناخت{حصہ_استعمال_تکمل_ترکیب_ٹکیاں}
قوسی سرحد کے خطوں کے رقبہ عمودی تراش سے بیلنی حجم معلوم کرنے کے لیے رقبہ عمودی تراش کو بیلن کے قد سے ضرب دیا جاتا ہے۔ اس طرز کے بیلنی حجم سے دیگر اشکال کے خطوں کا حجم تلاش کیا جا سکتا ہے۔

\جزوحصہء{ٹکیاں}
فرض کریں ہم شکل \حوالہ{شکل_تکمل_استعمال_ٹکیاں} میں دکھائے گئے ٹھوس جسم کا حجم دریافت کرنا چاہتے ہیں۔ بند وقفہ \عددی{[a,b]} کے ہر نقطہ \عددی{x} پر جسم کی عمودی تراش خطہ \عددی{R(x)} ہے جس کا رقبہ \عددی{S(x)} ہے۔ یوں \عددی{S} متغیر \عددی{x} کا حقیقی قیمت تفاعل ہو گا۔ یہ  \عددی{x} کا استمراری تفاعل بھی ہو گا جس کو استعمال کرتے ہوئے ٹھوس  جسم کے حجم کی تعریف پیش کی جا سکتی ہے، جو  تکمل سے درج ذیل طریقے سے حاصل کیا جا سکتا ہے۔
\begin{figure}
\centering
\begin{minipage}{0.45\textwidth}
\centering
...
\end{tikzpicture}
\caption
{عمودی تراش $R(x)$ کا رقبہ $S(x)$ متغیر $x$ کا استمراری تفاعل ہونے کی صورت میں ہم ٹھوس جسم کا حجم $x=a$ تا $x=b$ تفاعل $S(x)$ کا تکمل لے کر حاصل کر سکتے ہیں۔}
...
ہم محور \عددی{x} کے لحاظ سے وقفہ \عددی{[a,b]} کی خانہ بندی کر کے جسم کو خانہ بندی کے  نقاط پر محور \عددی{x} کے عمودی   مستویات سے کتلوں میں تقسیم کرتے  ہیں۔یوں نقطہ \عددی{x_{k-1}} اور \عددی{x_k} پر  مستویات  کے بیچ \عددی{k} واں کتلے  کا حجم تقریباً اس بیلن جتنا ہو گا جو ان  مستویات کے بیچ  واقع ہے اور جس کی عمودی تراش خطہ \عددی{R(x_k)} ہے (شکل \حوالہ{شکل_تکمل_استعمال_تخمینی_بیلن})۔ اس بیلن کا حجم درج ذیل ہو گا۔
\begin{align*}
H_k&=\text{\RL{رقبہ تلہ}}\times \text{قد}\\
&=S(x_k)\times (\text{\RL{$x_{k-1}$ اور $x_k$ کے بیچ فاصلہ}})\\
&=S(x_k)\Delta x_k
\end{align*}
اس طرح تمام چھوٹے بیلنوں کے حجم کا مجموعہ تخمیناً ٹھوس جسم کا حجم  ہو گا۔(ذیل دیکھیں۔)
\begin{align*}
\sum_{k=1}^nS(x_k)\Delta x_k
\end{align*} 
یہ وقفہ \عددی{[a,b]} پر تفاعل \عددی{S(x)} کا ریمان مجموعہ ہے۔ ہم توقع کرتے ہیں  کہ جیسے جیسے \عددی{[a,b]} کی خانہ بندی کا معیار صفر کے قریب ہوتا جائے، ویسے ویسے یہ مجموعے اصل حجم کی بہتر سے بہتر عکاسی کریں گے۔ یوں ٹھوس جسم کے حجم کی تعریف ان مجموعوں کا تحدیدی تکمل ہو گا۔

\ابتدا{تعریف} 
ایسا ٹھوس جسم جس کا رقبہ عمودی تراش \عددی{S(x)} قابل تکمل تفاعل ہو،اس   کا \عددی{x=a} سے \عددی{x=b} تک حجم،  تفاعل \عددی{S} کے  \عددی{x=a} تا \عددی{x=b}  کے (درج ذیل)  تکمل کے برابر  ہو گا۔
...
مساوات \حوالہ{مساوات_تکمل_استعمال_تعریف_حجم_الف} استعمال کرنے کے لیے درج ذیل تین اقدامات کرنے ہوں گے۔

\موٹا{ٹکیوں سے ٹھوس جسم کے  حجم کی تلاش}\\
\begin{enumerate}[1.]
\item
ٹھوس جسم  اور اس کی  نمائندہ عمودی تراش کا خاکہ کھینچیں۔
\item
 رقبہ عمودی تراش \عددی{S(x)} کا کلیہ اخذ کریں۔
\item
تکمل کی  زیریں اور بالائی حد تلاش کریں۔
\item
حجم معلوم کرنے کی خاطر \عددی{S(x)} کا تکمل حل کریں۔
\end{enumerate}

\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_اہرام_چوکور_قاعدہ}
ایک  ہرم  کا قد \عددی{\SI{3}{\meter}} اور اس کے چوکور بنیاد کا ضلع \عددی{\SI{3}{\meter}} ہے۔ ہرم  کی چوٹی سے \عددی{x} میٹر نیچے  ہرم کا رقبہ عمودی تراش چوکور ہو گا جس کا ضلع \عددی{x} میٹر ہو گا۔اس  ہرم کا حجم تلاش کریں۔

\حل
\موٹا{پہلا قدم:}\quad
\ترچھا{خاکہ۔}\quad
ہم ہرم  کی چوٹی کو مبدا پر رکھ کر ہرم  کو محور \عددی{x} پر لیٹا ہوا بنا کر نمائندہ رقبہ عمودی تراش بناتے ہیں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_اہرام_چوکور_قاعدہ})۔\\
\موٹا{دوسرا قدم:}\quad
...
\end{align*}
یوں ہرم  کا حجم \عددی{\SI{9}{\meter\cubed}} ہو گا۔
\انتہا{مثال}
%==========================
\begin{figure}
\centering
...
%\draw(0,0,0)--(3,-\lb/2,-\lb/2);
\end{tikzpicture}
\caption{ہرم  (مثال \حوالہ{مثال_تکمل_استعمال_اہرام_چوکور_قاعدہ}) }
...
رداس \عددی{3} کے بیلن کو دو مستوی سے کاٹ کر قوسی پچر بنایا جاتا ہے۔ایک مستوی بیلن کے محور پر عمودی ہے جبکہ دوسرا مستوی پہلے مستوی کو بیلن کے وسط پر \عددی{45^{\circ}}  کے زاویے پر قطع کرتا ہے۔ پچر کا حجم تلاش کریں۔

\حل
\موٹا{پہلا قدم:} \quad \ترچھا{خاکہ۔}\quad
ہم پچر اور نمائندہ عمودی تراش کا خاکہ بناتے ہیں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_قوسی_پچر})۔ عمودی تراش محور \عددی{x} کے عمودی ہے۔\\
...
محور \عددی{x} پر واقع  یکساں   قد کے  ایسے دو اجسام جن کے  ہر \عددی{x} پر  عمودی تراش کے رقبے  برابر ہوں،  ان کے  حجم بھی  برابر ہوں گے۔ یہ حقیقت  مساوات \حوالہ{مساوات_تکمل_استعمال_تعریف_حجم_الف} سے صاف ظاہر ہے چونکہ دونوں اجسام کے  رقبہ عمودی تراش تفاعل \عددی{S(x)}  برابر ہیں  (شکل \حوالہ{شکل_مثال_تکمل_استعمال_مسئلہ_کولئیرے_ٹھوس})۔
\انتہا{مثال}
%===========================
\begin{figure}
\centering
...
\end{tikzpicture}
\caption{ان اجسام کے حجم  برابرہیں۔ آپ سکوں کو ایک دوسرے کے اوپر رکھ کر اس کو ثابت کر سکتے ہیں۔}
\label{شکل_مثال_تکمل_استعمال_مسئلہ_کولئیرے_ٹھوس}
\end{figure}


%sec 6.2 questions start here
%sec 6.2 questions start here
\حصہء{سوالات}
\ابتدا{سوالات}
\موٹا{رقبہ عمودی تراش}\\
سوال \حوالہ{سوال_تکمل_استعمال_رقبہ_عمودی_تراش_الف} اور سوال \حوالہ{سوال_تکمل_استعمال_رقبہ_عمودی_تراش_ب} میں محور \عددی{x} کے عمودی، ٹھوس جسم کے رقبہ عمودی تراش \عددی{S(x)} کا کلیہ اخذ کریں۔ 

\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_رقبہ_عمودی_تراش_الف}
ایک ٹھوس جسم  \عددی{x=-1} اور \عددی{x=1} پر محور \عددی{x}  کے عمودی مستویات  کے بیچ  واقع  ہے۔  محور \عددی{x} کے عمودی، جسم  کے  عمودی تراش رقبے،  نصف دائرہ \عددی{y=-\sqrt{1-x^2}} اور نصف دائرہ \عددی{y=\sqrt{1-x^2}} کے بیچ  واقع ہیں۔ 
\begin{enumerate}[a.]
\item
عمودی تراش دائری  اقراص  ہیں جن کے قطر مستوی  \عددی{xy} میں ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_رقبہ_عمودی_تراش_الف}-ا)۔
\item
عمودی تراش چوکور ہیں جن کے قاعدے مستوی  \عددی{xy} میں ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_رقبہ_عمودی_تراش_الف}-ب)۔
\item
عمودی تراش چوکور ہیں جن کے وتر مستوی  \عددی{xy} میں ہیں۔ چوکور کے وتر کی لمبائی چوکور کے ضلع کے \عددی{\sqrt{2}} گنا ہوتی ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_رقبہ_عمودی_تراش_الف}-ج)۔
\item
عمودی تراش مساوی الاضلاع مثلث ہیں جن کے قاعدے مستوی  \عددی{xy} میں ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_رقبہ_عمودی_تراش_الف}-د)۔
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
(ا) \عددی{S(x)=\pi(1-x^2)}، \\
(ب) \عددی{S(x)=4(1-x^2)}،\\ (ج) \عددی{S(x)=2(1-x^2)}، \\
(د) \عددی{S(x)=\sqrt{3}(1-x^2)}
}}
\انتہا{جواب}
%======================
\begin{figure}
...
ایک ٹھوس جسم  \عددی{x=0} اور \عددی{x=4} پر  محور \عددی{x}  کے عمودی  مستویات  کے بیچ  واقع ہے۔ جسم  کے رقبہ عمودی تراش  محور \عددی{x} کے عمودی، قطع مکافی  \عددی{y=-\sqrt{x}} اور قطع مکافی \عددی{y=\sqrt{x}} کے بیچ  واقع ہیں۔ 
\begin{enumerate}[a.]
\item
عمودی تراش دائری اقراص ہیں جن کے قطر مستوی  \عددی{xy} میں ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_رقبہ_عمودی_تراش_ب}-ا)۔
\item
عمودی تراش چوکور ہیں جن کے قاعدے مستوی  \عددی{xy} میں ہیں (شکل \حوالہ{سوال_تکمل_استعمال_رقبہ_عمودی_تراش_ب}-ب)۔
\item
عمودی تراش چوکور ہیں جن کے وتر مستوی  \عددی{xy} میں ہیں۔
\item
عمودی تراش مساوی الاضلاع مثلث ہیں جن کے قاعدے مستوی  \عددی{xy} میں ہیں۔
\end{enumerate}
...
ایک ٹھوس جسم \عددی{x=0} اور \عددی{x=4} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کی عمودی تراش کی صورت چوکور ہے جو  محور \عددی{x} کے عمودی ہیں اور جن کے وتر قطع مکافی \عددی{y=-\sqrt{x}} سے قطع مکافی \عددی{y=\sqrt{x}} تک ہیں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$16$
...
%========================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-1} اور \عددی{x=1} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کی  عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے قطر دائری اقراص ہیں جو قطع مکافی \عددی{y=x^2} سے قطع مکافی \عددی{y=2-x^2} تک ہیں۔   
\انتہا{سوال}
%=====================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-1} اور \عددی{x=1} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کی  چوکور عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے  قاعدوں کے کنارے نصف دائرہ \عددی{y=-\sqrt{1-x^2}} سے نصف دائرہ \عددی{y=\sqrt{1-x^2}} تک ہیں۔ \\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{16}{3}$  
...
%======================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-1} اور \عددی{x=1} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کی  چوکور عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے وتر نصف دائرہ \عددی{y=-\sqrt{1-x^2}} سے نصف دائرہ \عددی{y=\sqrt{1-x^2}} تک ہیں۔ چوکور کے وتر کی لمبائی چوکور کے ضلع کے \عددی{\sqrt{2}} گنا ہوتی ہے۔
\انتہا{سوال}
%======================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_شکل_دیا_گیا_ہے_الف}
ایک ٹھوس جسم کا قاعدہ منحنی \عددی{y=2\sqrt{\sin x}} اور محور \عددی{x} پر وقفہ \عددی{[0,\pi]}  کے بیچ واقع  ہے۔درج ذیل عمودی تراش  محور \عددی{x} کے عمودی ہیں۔
\begin{enumerate}[a.]
\item
مساوی الاضلاع  مثلث جن کے قاعدے محور \عددی{x} سے منحنی تک ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_شکل_دیا_گیا_ہے_الف})۔
\item
انتصابی چوکور جن کے قاعدے محور \عددی{x} سے منحنی تک ہیں۔
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\end{figure}
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{x=-\tfrac{\pi}{3}} اور \عددی{x=\tfrac{\pi}{3}} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کی   عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے  خواص درج ذیل ہیں۔
\begin{enumerate}[a.]
\item
دائری اقراص جن کے قطر \عددی{y=\tan x} سے \عددی{y=\sec x} تک ہیں۔
\item
انتصابی چوکور جن کے قاعدے  \عددی{y=\tan x} سے \عددی{y=\sec x} تک ہیں۔
\end{enumerate}
\انتہا{سوال}
%=====================
\ابتدا{سوال}
ایک ٹھوس جسم \عددی{y=0} اور \عددی{y=2} پر  محور \عددی{y} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کی دائری عمودی تراش محور \عددی{y} کے عمودی ہیں جن کے قطر محور \عددی{y} سے قطع مکافی \عددی{x=\sqrt{5}y^2} تک ہیں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$8\pi$
...
ایک ٹھوس جسم کا قاعدہ قرص \عددی{x^2+y^2\le 1} ہے۔ عمودی تراش    \عددی{y=-1} اور \عددی{y=1} کے بیچ محور \عددی{y} کے عمودی ہیں جو مساوی الساقین مثلث ہیں جن کا ایک ضلع قرص میں  واقع ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_شکل_دیا_گیا_ہے_ب})۔
\انتہا{سوال}
%=====================
\موٹا{مسئلہ کوالئیرے}\\
\ابتدا{سوال}\ترچھا{بلدار ٹھوس جسم}\\
ایک چوکور جس کا ضلع \عددی{s} ہے لکیر \عددی{L} کے عمودی مستوی میں واقع ہے۔چوکور کا ایک راس \عددی{L} پر واقع ہے۔ یہ چوکور \عددی{L} پر \عددی{h} فاصلہ طے کرنے کے دوران    \عددی{L} کے گرد ایک چکر  کاٹ کر پیچ  دار  ستون  پیدا کرتا ہے جس کا رقبہ عمودی تراش چوکور ہو گا۔
\begin{enumerate}[a.]
\item
پیچ دار ستون کا حجم تلاش کریں۔
\item
اگر چوکور ایک کے بجائے دو  چکر کاٹتا تب حجم کتنا ہوتا؟ اپنے جواب کی وجہ پیش کریں۔ 
\end{enumerate} 
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
ایک ٹھوس جسم \عددی{x=01} اور \عددی{x=12} پر  محور \عددی{x} کے عمودی مستویات کے بیچ واقع ہے۔ جسم کی  عمودی تراش محور \عددی{x} کے عمودی ہیں جن کے  قطر لکیر \عددی{y=\tfrac{x}{2}} سے لکیر \عددی{y=x} تک ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_ٹھوس_جسم_حجم_ب})۔ اس جسم کا حجم کیوں اس قائمہ مخروط جتنا ہو گا جس کا قد \عددی{12} اور جس کے قاعدے  کا رداس \عددی{3} ہو؟ 
\انتہا{سوال}
%======================
\begin{figure}
\centering
...
\end{tikzpicture}
\caption
{کرہ اور بیلن دونوں میں  سے مخروط منفی کر کے دونوں صورتوں میں  برابر حجم  حاصل ہوتا ہے (سوال \حوالہ{سوال_تکمل_استعمال_نصف_کرہ_حجم})۔}
...
کوالئیرے نے طالب علمی کے دوران دریافت کیا کہ اگر دو مستوی خطوں کو محور \عددی{x} کے یکساں وقفہ پر یوں رکھنا ممکن ہو کہ کسی بھی \عددی{x} پر دونوں خطوں کی چوڑائی یکساں  ہو تب دونوں خطوں کا رقبہ یکساں  ہو گا (شکل \حوالہ{شکل_سوال_تکمل_استعمال_چوڑائی_برابر})۔ ٹھوس اجسام کے لیے   کوالئیرے نے یہی مسئلہ  کبھی ثابت نہیں کیا۔ اگر شکل \حوالہ{سوال_تکمل_استعمال_چوڑائی_برابر} میں بالائی اور زیریں سرحدیں استمراری تفاعل ہوں تب اس مسئلے کو ثابت کریں۔

\انتہا{سوال}
%======================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_نصف_کرہ_حجم}\ترچھا{نصف کرہ کا حجم بذریعہ مسئلہ کوالئیرے}\\
نصف کرہ کا حجم \عددی{H=\tfrac{2}{3}\pi R^3} ہے جہاں \عددی{R} رداس ہے۔رداس \عددی{R} اور قد \عددی{R} کے قائمہ بیلن سے  رداس \عددی{R} اور قد \عددی{R} کا قائمہ مخروط ہٹانے پر نصف کرہ کی عمودی تراش حاصل ہوتی  ہے۔ مخروط کو نوک کے بل رکھا تصور کریں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_نصف_کرہ_حجم})۔اس حقیقت کو استعمال کرتے ہوئے نصف کرہ کا حجم تلاش کریں۔  
\انتہا{سوال}

\انتہا{سوالات}
%===========================
%sec 6.2 questions end here
%sec 6.2 questions end here


\حصہ{اجسام طواف کے حجم۔ قرص اور چھلا}\شناخت{حصہ_استعمال_تکمل_قرص_اور_چھلا}
مستوی خطے کو کسی محور کے گرد گھمانے سے \اصطلاح{جسم طواف}\فرہنگ{جسم طواف}\حاشیہب{solid of revolution}\فرہنگ{solid of revolution} پیدا کیا جاتا ہے (شکل \حوالہ{شکل_تکمل_استعمال_جسم_طواف})۔ جسم طواف پیدا کرنے کے لیے گھمائے جانے والے مستوی خطے کو \اصطلاح{پیدا کار خطہ}\فرہنگ{پیداکار خطہ}\حاشیہب{generating region}\فرہنگ{generating!region} کہتے ہیں۔ جسم طواف کا حجم ٹکیوں کی ترکیب سے نہایت خوش اسلوبی سے حاصل ہوتا ہے۔
\begin{figure}
\centering
\begin{tikzpicture}
\pgfmathsetmacro{\la}{1}
...
اگر ہم مستوی خطہ کو استمراری تفاعل \عددی{y=R(x),\, a\le x\le b}  اور \عددی{x} کے بیچ خطہ سے ظاہر کر سکیں اور اگر محور \عددی{x} گھومنے کا محور (\اصطلاح{محور طواف}\فرہنگ{محور!طواف}\حاشیہب{axis of revolution}\فرہنگ{axis!of revolution}) بھی ہو تب ٹھوس جسم کا حجم درج ذیل طریقے  سے حاصل کیا جا سکتا ہے (شکل \حوالہ{شکل_تکمل_استعمال_استمراری_مستوی_پیداکار})۔
...
\موٹا{جسم طواف کا حجم (محور طواف محور \عددی{x} ہے)}\\
استمراری تفاعل \عددی{y=R(x),\, a\le x\le b} کو محور \عددی{x} کے گرد گھمانے سے پیدا ٹھوس جسم کا حجم درج ذیل ہو گا۔
...
منحنی \عددی{y=\sqrt{x},\,0\le x\le4} کو محور \عددی{x} کے گرد گھمانے سے ٹھوس جسم پیدا ہوتا ہے۔ اس جسم کا حجم تلاش کریں۔
...
\item
رقبہ عمودی تراش کا تکمل حجم دے گا۔
\end{enumerate}

اگلی  مثال میں محور طواف  محور \عددی{x} نہیں ہے، لیکن حجم حاصل کرنے کا اصول تبدیل نہیں ہوتا: تکمل کی  موزوں حد استعمال کریں۔

\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_جذر_منتقل}
تفاعل \عددی{y=\sqrt{x}}، لکیر \عددی{y=1}،  اور لکیر \عددی{x=4} کے بیچ خطہ کو لکیر \عددی{y=1} کے گرد گھما کر ٹھوس جسم پیدا کیا جاتا ہے۔ جسم کا حجم تلاش کریں۔
...
\end{figure}
منحنی \عددی{x=R(y),\, c\le y\le d} کو محور \عددی{y} کے گرد گھما کر ٹھوس جسم پیدا ہوتا ہے جس کا حجم تلاش کرتے ہوئے مساوات \حوالہ{مساوات_تکمل_استعمال_جسم_گردش_حجم} میں \عددی{x} کی جگہ \عددی{y} لکھا جاتا ہے۔


\موٹا{جسم طواف کا حجم (محور طواف محور \عددی{y} ہے)}\\
استمراری تفاعل \عددی{x=R(y),\, c\le y\le d} کو محور \عددی{y} کے گرد گھمانے سے پیدا ٹھوس جسم کا حجم درج ذیل ہو گا۔
...
منحنی \عددی{x=\tfrac{2}{y},\, 1\le y \le 4} کو محور \عددی{y} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔ جسم کا حجم دریافت کریں۔

\حل
ہم منحنی ترسیم کر کے ٹھوس جسم کا خاکہ بنا کر نمائندہ قرص اور رداس  کا نقش  بناتے ہیں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_معکوس})۔ جسم کا حجم درج ذیل ہو گا۔
\begin{align*}
...
\draw(0,{f(4/5)})node[circ]{}node[left]{$y$}--(4/5,{f(4/5)})node[circ]{}coordinate[pos=0.5](kcord);
\draw(kcord) to [out=-45,in=180]++(1,-0.5)node[right]{$R(y)=\frac{2}{y}$};
\end{tikzpicture}
\caption{}
\end{subfigure}\hfill
\begin{subfigure}{0.45\textwidth}
...
\draw(0,{f(4/5)})node[circ]{}node[left]{$y$}--(4/5,{f(4/5)})node[circ]{}coordinate[pos=0.5](kcord);
\draw(kcord) to [out=-45,in=180]++(1,-0.5)node[right]{$R(x)=\frac{2}{y}$};
...
\حل
ہم منحنی اور لکیر کے بیچ خطے کا  خاکہ بنا کر جسم طواف کا خاکہ بناتے ہیں اور عمودی تراش کے نمائندہ رداس کی نشاندہی کرتے ہیں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_قطع_مکافی_جسم_طواف})۔جسم کا حجم درج ذیل ہو گا۔
\begin{align*}
...
\end{figure}
\جزوحصہء{ترکیب چھلا}
اگر گھمایا  جانے والا خطہ محور طواف کو قطع نہ کرتا ہو اور نہ  ہی محور طواف کو مس کرتا ہو تب جسم طواف میں سوراخ پایا جائے گا (شکل \حوالہ{شکل_تکمل_استعمال_ترکیب_چھلا})۔ایسے جسم کا بیرونی رداس \عددی{R(x)} اور اندرونی رداس \عددی{r(x)} ہو گا۔ یوں اس کا رقبہ عمودی تراش درج ذیل ہو گا۔
\begin{align*}
...
\end{subfigure}
\caption
{یہاں جسم طواف قرص کے بجائے چھلا نما ہے جس میں سوراخ پایا جاتا ہے  لہٰذا تکمل $\int_a^bS(x)\dif x$ قدرے مختلف صورت اختیار کرتا ہے۔}
\label{شکل_تکمل_استعمال_ترکیب_چھلا}
\end{figure}
\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_چھلا_عجیب}
منحنی \عددی{y=x^2+1} اور لکیر \عددی{y=-x+3} کے بیچ خطہ کو محور \عددی{x} کے گرد گھما کر ٹھوس  جسم طواف پیدا کیا جاتا ہے۔  ٹھوس جسم کا حجم تلاش کریں۔
...
\موٹا{دوسرا قدم:}\quad
نقاط تقاطع سے تکمل کی حدیں تلاش کریں۔
\begin{align*}
x^2+1&=-x+3\\
x^2+x-2&=0\\
(x+2)(x-1)&=0\\
...
\begin{enumerate}[a.]
\item
خطے کا خاکہ بنا کر اس پر محور طواف کے عمودی لکیری قطعہ کھینچیں۔ خطہ کو محور طواف کے گرد گھمانے سے یہ قطعہ  نمائندہ عمودی تراش دے گا۔
\item
تکمل کی حدیں دریافت کریں۔
\item
عمودی تراش کے بیرونی اور اندرونی رداس کو لکیری قطعہ  سے حاصل کریں۔
\item
تکمل کے  ذریعہ حجم حاصل کریں۔
\end{enumerate}

اگر خطے کو محور \عددی{y} کے گرد گھما کر جسم طواف پیدا کیا جائے تب درج بالا اقدام استعمال کرتے ہوئے \عددی{x} کے بجائے \عددی{y} کے ساتھ تکمل لیں۔
...
\حل
\موٹا{پہلا قدم:}\quad
خطے کا خاکہ کھینچ کر خطہ پر محور طواف کے عمودی لکیری قطعہ  بنائیں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_دو_منحنیات_کے_بیچ})۔ یہاں محور طواف محور \عددی{y} ہے۔\\
\موٹا{دوسرا قدم:}\quad
قطع مکافی اور لکیر ایک دوسرے کو \عددی{y=0} اور \عددی{y=4} پر قطع کرتے ہیں لہٰذا تکمل کی حدیں \عددی{c=0} اور \عددی{d=4} ہوں گی۔\\
\موٹا{تیسرا قدم:}\quad
...
ربع اول میں قطع مکافی \عددی{y=x^2}، لکیر \عددی{y=1}، اور محور \عددی{y}  کے بیچ خطہ کو لکیر \عددی{x=\tfrac{3}{2}} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔ اس  جسم کا حجم دریافت کریں۔

\حل
\موٹا{پہلا قدم:}\quad
خطہ کے خاکہ پر محور طواف \عددی{x=\tfrac{3}{2}} کے عمودی، لکیری قطعہ بنائیں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_پیچیدہ})۔\\
\موٹا{دوسرا قدم:}\quad
تکمل کی حدیں \عددی{y=0} اور \عددی{y=1} ہیں۔\\
\موٹا{تیسرا قدم:}\quad
...
\انتہا{سوال}
%=========================
سوال \حوالہ{سوال_تکمل_استعمال_منحنیات_لکیریں_جسم_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_منحنیات_لکیریں_جسم_ب} میں منحنیات اور لکیروں کے بیچ خطے کو محور \عددی{x} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔ جسم کا حجم تلاش کریں۔
...
ربع اول میں خطے کی  بالائی سرحد لکیر \عددی{y=2}، زیریں سرحد منحنی \عددی{y=\sec x\tan x,\, 0\le x\le \tfrac{\pi}{2}}،  اور بائیں سرحد محور \عددی{y} ہے۔ خطے کو لکیر \عددی{y=2} کے گرد گھمایا جاتا ہے۔
\انتہا{سوال}
%=========================
سوال \حوالہ{سوال_تکمل_استعمال_محور_وائے_کے_گرد_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_محور_وائے_کے_گرد_ب} میں منحنیات اور لکیروں کے بیچ خطے کو محور \عددی{y} کے گرد گھمایا جاتا ہے۔ جسم طواف کا حجم دریافت کریں۔
...
سوال \حوالہ{سوال_تکمل_استعمال_ایکس_محور_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_ایکس_محور_ب} میں دی  گئی منحنیات اور لکیروں کے بیچ خطے کو محور \عددی{x} گھما کر جسم طواف پیدا کیا جاتا ہے۔جسم کا حجم تلاش کریں۔
...
سوال \حوالہ{سوال_تکمل_استعمال_وائے_محور_معلوم_حجم_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_وائے_محور_معلوم_حجم_ب} میں خطے کو محور \عددی{y} کے گرد گھمایا جاتا ہے۔ جسم طواف کا حجم معلوم کریں۔

\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_وائے_محور_معلوم_حجم_الف}
مثلث میں محیط خطہ جہاں مثلث کے راس \عددی{(1,0)}، \عددی{(2,1)}،  اور \عددی{(1,1)} ہیں۔ 
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{4\pi}{3}$
...
%=======================
\ابتدا{سوال}
مثلث جس کے   راس \عددی{(0,1)}، \عددی{(1,0)}،  اور \عددی{(1,1)} ہیں میں محیط خطہ۔ 
\انتہا{سوال}
%========================
\ابتدا{سوال}
ربع اول میں خطہ جس کی بالائی سرحد قطع مکافی \عددی{y=x^2}، زیریں سرحد محور \عددی{x}، اور دائیں سرحد لکیر \عددی{x=2} ہے۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$8\pi$
...
%========================
\ابتدا{سوال}
ربع اول میں خطہ جس کی بائیں سرحد دائرہ \عددی{x^2+y^2=3}، دائیں  سرحد لکیر \عددی{x=\sqrt{3}}،  اور بالائی سرحد لکیر \عددی{y=\sqrt{3}} ہے۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\sqrt{3}\pi$
...
\انتہا{سوال}
%========================
سوال \حوالہ{سوال_تکمل_استعمال_دیا_محور_الف} اور سوال \حوالہ{سوال_تکمل_استعمال_دیا_محور_ب} میں خطے کو دیے  گئے محور کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔جسم کا حجم معلوم کریں۔

\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_دیا_محور_الف}
ربع اول میں خطہ جس کی بالائی سرحد منحنی \عددی{y=x^2}، زیریں سرحد محور \عددی{x}، اور دائیں سرحد لکیر \عددی{x=1} ہے۔خطے کو لکیر \عددی{x=-1} کے گرد گھمایا جاتا ہے۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{7\pi}{6}$
...
ربع دوم میں خطہ جس کی بالائی سرحد منحنی \عددی{y=-x^3}، زیریں سرحد محور \عددی{x}،  اور بائیں  سرحد لکیر \عددی{x=-1} ہے۔ خطے کو لکیر \عددی{x=-2} کے گرد گھمایا جاتا ہے۔
\انتہا{سوال}
%======================
...
%=====================
\ابتدا{سوال}
ایک تکونی خطہ  جس کی سرحدیں \عددی{y=2x}، \عددی{y=0}،  اور \عددی{x=1} ہیں کو درج ذیل کے گرد گھمایا جاتا ہے۔
\begin{enumerate}[a.]
\item
لکیر \عددی{x=1}؛
\item
...
%========================
\ابتدا{سوال}
ایک مثلث جس کے راس \عددی{(0,0)}، \عددی{(b,0)}،  اور \عددی{(0,h)} ہیں میں محیط خطے کو درج ذیل کے گرد گھمایا جاتا ہے۔ جسم طواف کا حجم تکمل کی مدد سے حاصل کریں۔
\begin{enumerate}[a.]
\item
محور \عددی{x}؛
\item
...
منحنی \عددی{y=\tfrac{x}{12}\sqrt{36-x^2},\, 0\le x\le \SI{6}{\centi\meter}} کو محور \عددی{x} کے گرد گھما کر ناشپاتی نما پیتل کا  گولہ بنایا جاتا ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_ناشپاتی})۔ پیتل کی کثافت \عددی{\SI{8.5}{\gram\per\centi\meter\cubed}} لیں۔ گولے کی کمیت کتنی ہو گی؟
\انتہا{سوال}
%==========================
\ابتدا{سوال}
...
\begin{enumerate}[a.]
\item
ٹھوس جسم کی اقل حجم \عددی{c} کی کتنی قیمت پر حاصل ہو گی؟ اس اقل  حجم کو تلاش کریں۔
\item
وقفہ \عددی{[0,1]} میں \عددی{c}کی کون سی قیمت  اعظم حجم دے گی؟
\item
ٹھوس جسم کا حجم بالمقابل \عددی{c} کو پہلے \عددی{0\le c\le 1} کے لیے اور بعد میں بڑی قیمتوں کے لیے ترسیم کریں۔ جیسے جیسے  \عددی{c} کی قیمت وقفہ \عددی{[0,1]} سے دور ہوتی جاتی ہے، جسم کے حجم کو کیا ہوتا ہے؟ کیا اس کا طبعی مطلب بنتا ہے؟ اپنے جواب کی وجہ پیش کریں۔
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%===========================
\ابتدا{سوال}
ہیلی کاپٹر کی پہنچ  بڑھانے کی خاطر اس کے نیچے تیل کا اضافی حوض نصب کرنا مطلوب ہے۔ منحنی \عددی{y=\tfrac{1}{3}-\tfrac{x^2}{3},\, -1\le x\le 1} کو محور \عددی{x} کے گرد گھما کر حوض بنایا جاتا ہے۔ اس حوض میں کتنے لٹر تیل آئے گا؟
\انتہا{سوال}
%=============================
...
%==========================
\ابتدا{سوال}
(ا) نصف کروی برتن جس کا رداس \عددی{a} ہے میں پانی کی گہرائی \عددی{h} ہے۔ پانی کی مقدار معلوم کریں۔ (ب) نصف کروی حوض جس کا رداس \عددی{\SI{5}{\meter}} ہے میں پانی داخل ہونے کی شرح \عددی{\SI{0.2}{\meter\cubed\per\second}} ہے۔ جس لمحہ پانی کی گہرائی \عددی{\SI{4}{\meter}} ہو، اس لمحے پر گہرائی بڑھنے کی شرح کیا ہو گی؟
\انتہا{سوال}
%===========================
\ابتدا{سوال}
...
\begin{enumerate}[a.]
\item
نصف دائرہ \عددی{y=\sqrt{a^2-x^2}} کو محور \عددی{x} کے گرد گھما کر کرہ حاصل ہوتا ہے۔ قرص کے حجم کا کلیہ مساوات \حوالہ{مساوات_تکمل_استعمال_جسم_گردش_حجم} استعمال کرتے ہوئے کرہ کے حجم کا کلیہ \عددی{H=\tfrac{4}{3}\pi a^3} حاصل کریں۔
\item
رداس \عددی{r} اور قد \عددی{h} کے  قائمہ مخروط کا حجم احصاء کی مدد سے حاصل کریں۔
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\انتہا{سوالات}
%==========================
%sec 6.3 questions end here
%sec 6.3 questions end here


\حصہ{نلکی چھلے}
اجسام طواف کا حجم تلاش کرتے ہوئے بعض اوقات چھلا کے بجائے نلکی خول استعمال کرنا زیادہ بہتر ثابت ہوتا ہے (شکل \حوالہ{شکل_تکمل_استعمال_جسم_طواف_نلکی_الف})۔
\begin{figure}
\centering
\begin{subfigure}{0.45\textwidth}
\centering
...
\end{align*}
ہم \عددی{P} پر منحصر \عددی{n} مستطیلوں کو محور \عددی{y} کے گرد گھمانے سے حاصل حجم کے مجموعہ کو تخمیناً جسم طواف کا حجم لیتے ہیں۔
\begin{align*} 
H\approx \sum_{k=1}^n\Delta H_k=\sum_{k=1}^n2\pi c_kf(c_k)\Delta x_k\quad\quad \text{\RL{ریمان مجموعہ}}
\end{align*}
\عددی{\norm{P}\to 0} کرتے ہوئے اس مجموعے  کی حد ٹھوس جسم کا حجم  ہو گی۔(ذیل دیکھیں۔)
\begin{align*}
...
استمراری تفاعل \عددی{y=f(x),\, 0\le a\le x\le b} اور محور \عددی{x} کے بیچ خطے کو محور \عددی{y} کے گرد گھمانے سے حاصل جسم طواف کا حجم درج ذیل ہو گا۔
...
لکیر \عددی{x=4} اور محور  \عددی{x}  کے بیچ منحنی \عددی{y=\sqrt{x}} کے قطعہ کو  محور \عددی{y} کے گرد گھما کر جسم طواف حاصل کیا جاتا ہے۔ اس جسم کا حجم تلاش کریں۔
\begin{figure}
\centering
...
\حل
\موٹا{پہلا قدم:}\quad
خطے کا خاکہ بنا کر محور گردش کے متوازی اس پر قطعہ  دکھائیں۔ قطعہ کا قد (خول کا قد) اور محور گردش سے قطعہ کے فاصلہ (رداس خول) کی نشاندہی کریں۔ قطعہ  کی چوڑائی \عددی{\dif x} خول کی چوڑائی ہو گی۔ ہم نے شکل \حوالہ{شکل_مثال_تکمل_استعمال_نلکی_پہلی} میں خول دکھایا ہے۔ آپ کو ایسا کرنے کی ضرورت نہیں۔\\
\موٹا{دوسرا قدم:}\quad
تکمل کی حدیں معلوم کریں۔ خطہ میں \عددی{x} کی قیمت \عددی{a} تا \عددی{b} تبدیل ہوتی ہے لہٰذا تکمل کی حدیں \عددی{a} اور \عددی{b} ہوں گی۔
\begin{align*}
...
\انتہا{مثال}
%=====================
محور \عددی{y} کے گرد خطہ گھمانے سے حاصل جسم طواف کا حجم مساوات \حوالہ{مساوات_تکمل_استعمال_کلیہ_خول_وائے_محور} سے حاصل کیا جا سکتا ہے۔اگر ہم خطے کو محور \عددی{x} کے گرد گھما کر جسم طواف حاصل کریں تب حجم تلاش کرنے کی خاطر مساوات \حوالہ{مساوات_تکمل_استعمال_کلیہ_خول_وائے_محور} میں \عددی{x} کی جگہ \عددی{y} استعمال کیا جائے گا۔

\موٹا{کلیہ خول برائے  محور \عددی{x}  کے گرد طواف}\\
...
\end{align*} 
جہاں خول کا اوسط رداس \عددی{\tfrac{R_2+R_1}{2}}، خول کی موٹائی \عددی{R_2-R_1r}، اور خول کا قد \عددی{h} ہے۔
\begin{figure}
\centering
\begin{subfigure}{0.45\textwidth}
\centering
...
\begin{align*}
H&=(\text{لمبائی})\times(\text{چوڑائی})\times(\text{موٹائی})\\
&=2\pi x f(x)\dif x
\end{align*}

%=======================
\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_پہلے_بھی-حل}
منحنی \عددی{y=\sqrt{x}}، لکیر \عددی{x=4}، اور محور \عددی{x} کے بیچ خطے کو محور \عددی{x} کے گرد گھما کر جسم طواف حاصل کیا جاتا ہے۔ اس جسم کا حجم تلاش کریں۔

\حل
\موٹا{پہلا قدم:}\quad
خطے کا خاکہ بنائیں اور اس پر محور گردش کے متوازی قطعہ دکھائیں۔ قطعہ کی لمبائی (قد خول) اور محور طواف سے اس کے فاصلہ (رداس خول) کی نشاندہی کریں۔ قطعہ کی موٹائی، خول کی چوڑائی \عددی{\dif y} ہو گی۔ ہم نے شکل \حوالہ{شکل_مثال_تکمل_استعمال_پہلے_بھی-حل} میں محور \عددی{y} کے گرد بیلن دکھایا ہے۔ آپ کو ایسا بنانے کی ضرورت نہیں۔\\
\موٹا{دوسرا قدم:}\quad
تکمل کی حدیں معلوم کریں۔چونکہ خطہ میں \عددی{y} کی قیمت \عددی{c=0} تا \عددی{d=2} ہو سکتی ہے لہٰذا یہی اس کی حدیں ہیں۔\\
\موٹا{تیسرا قدم:}\quad
\begin{align*}
H&=\int_c^d2\pi(\text{\RL{رداس خول}})(\text{\RL{قد خول}})\dif y&&\text{\RL{مساوات \حوالہ{مساوات_تکمل_استعمال_کلیہ_خول_ایکس_محور}}}\\
...
\begin{enumerate}[a.]
\item
خطے کا خاکہ بنا کر اس میں محور طواف کے متوازی قطعہ بنائیں۔ قطعہ کے  قد یا لمبائی (قد خول)،  محور طواف سے قطعہ کے  فاصلہ (رداس خول) اور قطعہ کی موٹائی (چوڑائی خول) کی نشاندہی کریں۔
\item
تکمل کی حدیں معلوم کریں
\item
...
ربع اول میں قطع مکافی \عددی{y=x^2}، لکیر \عددی{y=1}،  اور محور \عددی{y} کے بیچ خطے کو محور طواف \عددی{x=2} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔اس جسم کا حجم تلاش کریں۔

\حل
\موٹا{پہلا قدم:}\quad
خطے پر محور طواف کے متوازی قطعہ بنائیں۔ قطعہ کے قد (قد خول)، محور طواف سے قطعہ کے  فاصلہ (رداس خول) اور قطعہ کی موٹائی (چوڑائی خول \عددی{\dif x}) کی نشاندہی کریں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_خول_آخری})۔ہم نے خول بھی بنایا ہے۔ آپ کو ایسا کرنے کی ضرورت نہیں۔\\
\موٹا{دوسرا قدم:}\quad
تکمل کی حدیں \عددی{a=0} اور \عددی{b=1} ہیں۔\\
\موٹا{تیسرا قدم:}
\begin{align*}
...
تفاعل \عددی{y=x^2} اور لکیر \عددی{y=x} کے بیچ خطہ کو مثال بناتے ہوئے شکل \حوالہ{شکل_تکمل_استعمال_چھلا_خول} میں ترکیب چھلا اور ترکیب خول دونوں دکھائی  گئی ہیں۔شکل \حوالہ{شکل_تکمل_استعمال_چھلا_خول}-ا اور ب میں محور \عددی{y} کے گرد خطہ گھمایا گیا ہے جبکہ شکل-ج اور د میں محور \عددی{x} کے گرد خطہ گھمایا گیا ہے۔ دونوں صورتوں میں حجم کو ترکیب چھلا اور ترکیب خول سے حل کیا گیا ہے۔ اس مخصوص خطے کے لیے دونوں محور طواف کے لیے دونوں تراکیب کارآمد ہیں لیکن ایسا ہر  مرتبہ نہیں ہو گا۔مثال کے طور پر محور \عددی{y} کے گرد گھماتے ہوئے ترکیب چھلا میں ہمیں \عددی{y} کے لحاظ سے تکمل حل کرنا ہو گا۔البتہ عین ممکن ہے کہ متکمل کو \عددی{y} کی صورت میں لکھنا ممکن نہ ہو۔ایسی صورت میں ہمیں ترکیب خول استعمال کرنی ہو گی جو ہمیں \عددی{x} کے لحاظ سے تکمل لینے کی اجازت دیگی۔

ترکیب چھلا اور ترکیب خول سے ہر صورت  یکساں  حجم حاصل ہوں گے۔ ہم حصہ \حوالہ{حصہ_استعمال_تکمل_الٹ_تفاعل_اور_ان_کے_تفرق} کے سوال \حوالہ{سوال_ماورائی_ترکیب_چھلا_اور_ترکیب_خول_مساوی_ہیں} میں ان کی برابری  کو ثابت کر پائیں گے۔


%sec 6.4 questions start here
%sec 6.4 questions start here
\حصہء{سوالات}
\ابتدا{سوالات}
...
سوال \حوالہ{سوال_تکمل_استعمال_ترکیب_خول_سے_تلاش_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_ترکیب_خول_سے_تلاش_ب} میں دی گئی  منحنیات اور لکیروں میں محیط خطے کو محور \عددی{y} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔ اس جسم کا حجم ترکیب خول سے تلاش کریں۔
...
\انتہا{سوال}
%=====================
سوال \حوالہ{سوال_تکمل_استعمال_محور_طواف_وائے_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_محور_طواف_وائے_ب} میں طواف جسم کا حجم ترکیب خول سے معلوم کریں۔ منحنیات اور لکیروں میں محیط رقبے  کو محور \عددی{y} کے گرد گھمایا گیا ہے۔
...
تکون جس کے راس \عددی{(1,1)}، \عددی{(1,2)}، اور \عددی{(2,2)} ہیں۔ (ا) محور \عددی{x} کے گرد، (ب) محور \عددی{y} کے گرد، (ج) لکیر \عددی{x=\tfrac{10}{3}} کے گرد، اور (د) لکیر \عددی{y=1} کے گرد گھمایا جاتا ہے۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%=======================
\ابتدا{سوال}
ربع اول میں منحنی \عددی{x=y-y^3} اور محور \عددی{y} میں محیط خطہ کو (ا) محور \عددی{x}، (ب) لکیر \عددی{y=1} کے گرد گھمایا جاتا ہے۔
\انتہا{سوال}
%======================
\ابتدا{سوال}
...
%=============================
\ابتدا{سوال}
تکونی خطہ جس کی سرحد لکیر \عددی{2y=x+4}، \عددی{y=x}، اور \عددی{x=0} ہیں کو (ا) محور \عددی{x}، (ب) محور \عددی{y}، (ج) لکیر \عددی{x=4}، اور (د) لکیر \عددی{y=8} کے گرد گھمایا جاتا ہے۔
\انتہا{سوال}
%=====================
\ابتدا{سوال}
...
%========================
\ابتدا{سوال}
منحنی \عددی{y=\sqrt{x}}، لکیر \عددی{y=2}،  اور \عددی{x=0} کے بیچ خطہ کو (ا) محور \عددی{x}، (ب) محور \عددی{y}، (ج) لکیر \عددی{x=4}، (د) لکیر \عددی{y=2} کے گرد گھمایا جاتا ہے۔
\انتہا{سوال}
%========================
\ابتدا{سوال}
ربع اول میں بالائی جانب منحنی \عددی{y=x^{-1/4}}، بائیں جانب لکیر \عددی{x=\tfrac{1}{16}}، اور نچلی جانب لکیر \عددی{y=1} سے گھیرے گئے خطے کو محور \عددی{x} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔ اس جسم کا حجم (ا) ترکیب چھلا، (ب) ترکیب خول سے معلوم کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
\عددی{\tfrac{9\pi}{16}}
...
%=========================
\ابتدا{سوال}
ربع اول میں بالائی جانب منحنی \عددی{y=\sqrt{x}}، بائیں جانب لکیر \عددی{x=\tfrac{1}{4}}، اور نچلی جانب لکیر \عددی{y=1} سے گھیرے گئے خطے کو محور \عددی{y} کے گرد گھما کو جسم طواف پیدا کیا جاتا ہے۔ اس جسم کا حجم (ا) ترکیب چھلا، (ب) ترکیب خول سے معلوم کریں۔
\انتہا{سوال}
%============================
\begin{figure}
\centering
...
\item
اس تفاعل کو محور \عددی{y} کے گرد گھمانے سے حاصل جسم طواف کا حجم تلاش کریں۔
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%=============================
\ابتدا{سوال}
فرض کریں وقفہ \عددی{x\ge 0} پر  تفاعل \عددی{f(x)} غیر منفی اور استمراری ہے۔ منحنی \عددی{f}، لکیر \عددی{x=b}، اور کارتیسی محدد کے بیچ خطہ کو محور \عددی{y} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے جہاں \عددی{b} کوئی مثبت عدد ہے۔ اس جسم طواف کا حجم \عددی{2\pi b^3} ہے۔تفاعل \عددی{f(x)} دریافت کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$3x$
...
\انتہا{سوالات}
%==========================
%sec 6.4 questions end here
%sec 6.4 questions end here



\حصہ{مستوی منحنیات کی لمبائیاں}\شناخت{حصہ_استعمال_تکمل_لمبائی_منحنی}
نقشہ پر سڑک کی لمبائی جاننے کی خاطر ہم فیتہ استعمال کرتے ہوئے نقشے  پر سڑک کی منحنی پر قریب قریب نقطوں کے مابین قطعات کو سیدھا تصور کرتے ہوئے ان کی لمبائیوں کا مجموعہ لیتے ہیں۔ اس طرح اندازاً لمبائی کی درستگی کی حد قطعات کی تعداد اور ناپنے کی درستگی پر منحصر ہو گی۔ 
...
\جزوحصہء{بنیادی کلیہ}
فرض کریں ہم \عددی{x=a} سے \عددی{x=b} تک منحنی \عددی{y=f(x)} کی لمبائی جاننا چاہتے ہیں۔ہم \عددی{[a,b]} کی خانہ بندی عمومی  طریقہ سے کر کے منحنی پر مطابقتی نقطوں کو سیدھے قطعات سے جوڑ کر کثیر الاضلاع بناتے ہیں جو اصل منحنی کو تخمیناً ظاہر کرتا ہے (شکل \حوالہ{شکل_تکمل_استعمال_کثیر-الاضلاع})۔ اگر ہم کثیر الاضلاع کی لمبائی کا کلیہ تلاش کر سکیں ہم اسی کلیہ کو منحنی کی لمبائی کے لیے استعمال کر سکتے ہیں۔
\begin{figure}
\centering
\begin{minipage}{0.45\textwidth}
\centering
...
\end{tikzpicture}
\caption
{منحنی $AB$ کے قطعہ $PQ$ کی لمبائی $\sqrt{\Delta x^2+\Delta y^2}$ ہو گی۔}
...
\end{axis}
\end{tikzpicture}
\caption{نقطہ $(c_k,f(c_k))$ پر مماس اور قطعہ متوازی ہیں۔}
\label{شکل_تکمل_استعمال_قطع_کثیر-الاضلاع}
\end{minipage}
\end{figure} 

قطعہ \عددی{PQ} کی لمبائی \عددی{\sqrt{(\Delta x_k)^2+(\Delta y_k)^2}} ہو گی (شکل \حوالہ{شکل_تکمل_استعمال_کثیر-الاضلاع})۔ یوں منحنی کی لمبائی تخمیناً درج ذیل  مجموعہ ہو گا۔
\begin{align}\label{مساوات_تکمل_استعمال_لمبائی_قوس_الف}
\sum_{k=1}^n \sqrt{(\Delta x_k)^2+(\Delta y_k)^2}
\end{align}
وقفہ \عددی{[a,b]} کی خانہ بندی باریک کرنے  سے حاصل مجموعہ تخمیناً  زیادہ بہتر ہو گا۔ ہم دکھانا چاہیں گے کہ خانہ بندی کا معیار صفر  کے قریب تر کرنے  سے مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_الف} کا مجموعہ قابل معلوم حد دے گا۔ ایسا کرنے کی خاطر ہم مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_الف} کو ایسے روپ میں لکھتے ہیں کہ اس پر مسئلہ \حوالہ{مسئلہ_تکمل_قطعی_تکمل_کی_موجودگی} (صفحہ \حوالہصفحہ{مسئلہ_تکمل_قطعی_تکمل_کی_موجودگی}) کا اطلاق  ہو۔ ہم تفرق کے مسئلہ اوسط قیمت سے شروع کرتے ہیں۔ 

\ابتدا{تعریف}
ایسا تفاعل جس کا  یک رتبی  تفرق استمراری ہو \اصطلاح{ہموار}\فرہنگ{ہموار!منحنی}\حاشیہب{smooth}\فرہنگ{smooth!curve} کہلاتا ہے اور اس کی منحنی کو \اصطلاح{ہموار منحنی}\فرہنگ{ہموار!منحنی}\حاشیہب{smooth curve}\فرہنگ{smooth!curve} کہتے ہیں۔
\انتہا{تعریف}

اگر \عددی{f} ہموار ہو تب مسئلہ اوسط قیمت کے تحت \عددی{P} اور \عددی{Q} کے بیچ منحنی پر ایک ایسا نقطہ \عددی{(c_k,f(c_k))} پایا جائے گا جہاں منحنی کا مماس قطعہ \عددی{PQ} کے متوازی ہو گا (شکل \حوالہ{شکل_تکمل_استعمال_قطع_کثیر-الاضلاع})۔ اس نقطہ پر درج ذیل ہو گا۔
\begin{align*}
f'(c_k)=\frac{\Delta y_k}{\Delta x_k},\quad \implies \Delta y_k=f'(c_k)\Delta x_k
\end{align*}

مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_الف} میں \عددی{\Delta y_k} کی اس قیمت کو پُر کرنے سے درج ذیل روپ ملتا ہے۔
\begin{align*}
\sum_{k=1}^n \sqrt{(\Delta x_k)^2+(f'(c_k)\Delta x_k)^2}&=\sum_{k=1}^n\sqrt{1+(f'(c_k))^2}\Delta x_k&&\text{\RL{ریمان مجموعہ}}
\end{align*}
چونکہ \عددی{[a,b]} پر \عددی{\sqrt{1+(f'(x))^2}} استمراری ہے لہٰذا خانہ بندی کا معیار صفر  کے قریب تر کرنے سے دائیں ہاتھ مجموعے کی حد  \عددی{\int_a^b\sqrt{a+(f'(x))^2}\dif x} ہو گی۔ ہم  اس   تکمل  کی قیمت  کو منحنی کی لمبائی کی تعریف مانتے ہیں۔
...
کبھی کبھار منحنی پر \عددی{\frac{\dif y}{\dif x}} غیر موجود لیکن \عددی{\frac{\dif x}{\dif y}} موجود ہو گا اور ہم \عددی{x} کو \عددی{y} کا تفاعل لکھ کر منحنی کی لمبائی مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ب} کے  درج ذیل مشابہ سے حاصل کر پاتے ہیں۔
...
\end{align*}
نقطہ \عددی{x=0} پر غیر معین یعنی غیر موجود ہے لہٰذا منحنی کی لمبائی حاصل کرنے کے لیے  مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ب} نا قابل استعمال ہے۔
...
\end{align*}
وقفہ \عددی{[0,1]} پر استمراری ہے لہٰذا منحنی کی لمبائی کی خاطر مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_پ}  قابل استعمال  ہے۔
\begin{align*}
...
\end{align} 
عموماً تفارق  کے بجائے تفرقات میں لکھی  جاتی ہے۔ ایسا با ضابطہ طور پر کرنے کے لیے  تفارق کو تفرقات کا حاصل تقسیم تصور کریں۔یوں پہلے تکمل میں درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
...
\end{align*} 
اس طرح مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ت} میں دیے گئے  دونوں تکمل درج ذیل  (یک ) تفرقی  کلیہ کی صورت اختیار کرتے ہیں۔
\begin{align}\label{مساوات_تکمل_استعمال_لمبائی_قوس_ٹ}
L=\int_a^b \sqrt{\dif x^2+\dif y^2}
\end{align} 
ظاہر ہے کہ \عددی{\dif x} اور \عددی{\dif y} کو ایک ہی متغیر  کے لحاظ سے لکھنا ضروری ہے اور مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ٹ} میں دیا  گیا تکمل حل کرنے کے لیے تکمل کی  موزوں حدیں جاننا   ضروری ہیں۔

ہم مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ٹ} کو مزید چھوٹا کر سکتے ہیں۔\عددی{\dif x^2} اور \عددی{\dif y^2} کو ایک چھوٹے مثلث کے اضلاع تصور کریں۔مسئلہ فیثاغورث   کے تحت  اس مثلث کا وتر \عددی{\dif s=\sqrt{\dif x^2+\dif y^2}} ہو گا (شکل \حوالہ{شکل_مثال_تکمل_فیثا_غورث})۔ تفرقہ  \عددی{\dif s} کو اب قوس کی تفرقی  لمبائی تصور کیا جا سکتا ہے جس کی  موزوں حدود کے  درمیان  تکمل لے کر قوس کی لمبائی دریافت کی جا سکتی ہے۔  مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ٹ} میں \عددی{\sqrt{\dif x^2+\dif y^2}} کو \عددی{\dif s} لکھنے سے مساوات کو \عددی{\dif s} کا تکمل لکھا جا سکتا ہے۔

\ابتدا{تعریف}
لمبائی قوس کا تفرقہ  اور   قوس کی لمبائی  کا تفرقی کلیہ درج ذیل ہیں۔
\begin{align*}
\dif s&=\sqrt{\dif x^2+\dif y^2}&&\text{\RL{لمبائی قوس کا تفرقہ}}\\
L&=\int \dif s&&\text{\RL{قوس کی لمبائی  کا تفرقی کلیہ}}
\end{align*}
\انتہا{تعریف}

\جزوحصہء{لا متناہی لمبائی کی  منحنیات}\شناخت{حصہ_تکمل_استعمال_برف_کی_روئی}
برف کی روئی پر صفحہ \حوالہصفحہ{حصہ_تفرق_برف_کی_روئی} پر غور کیا گیا۔ لامتناہی تکونی کثیر الاضلاع کی ترتیب \عددی{C_1,\, C_2,\,\cdots,C_n,\,\cdots} کی تحدیدی صورت کو برف کی روئی \عددی{K} کہتے ہیں۔  شکل \حوالہ{شکل_تکمل_استعمال_روئی_برف} میں اس ترتیب کی پہلی تین صورتیں دکھائی گئی ہیں۔ بناوٹ کے دوران ہر نیا متعارف کردہ راس بعد کے تمام منحنیات میں بطور راس پایا جاتا ہے اور تحدیدی منحنی \عددی{K} میں بطور نقطہ نظر آتا ہے۔ یوں ہر منحنی  \عددی{C} از خود منحنی \عددی{K} کی تخمینی صورت ہو گی۔ یوں \عددی{K} کی لمبائی منحنیات \عددی{C_n} کی تحدیدی لمبائی کے برابر ہو گی۔ کم از کم،  ہموار منحنیات کی لمبائی کی تعریف کے تحت،  ایسا ہی ہونا چاہیے۔ 
\begin{figure}
\centering
\begin{subfigure}{0.22\textwidth}
\centering
...
آئیں \عددی{C_n} کی تحدیدی لمبائی تلاش کریں۔ اگر ابتدائی مثلث الاضلاع کے ضلع کی لمبائی \عددی{1} ہو تب \عددی{C_1} کی کُل لمبائی \عددی{3} ہو گی۔\عددی{C_1} سے \عددی{C_2} حاصل کرتے ہوئے ہم \عددی{C_1} کے ہر ضلع کی جگہ چار اضلاع بناتے ہیں جہاں ہر ضلع ابتدائی ضلعے  کا \عددی{\tfrac{1}{3}} واں حصہ ہے۔یوں \عددی{C_2} کی کُل لمبائی \عددی{3\times 4\times \tfrac{1}{3}=3(\tfrac{4}{3})} ہو گی۔ اسی طرح \عددی{C_3} کی لمبائی حاصل کرنے کی خاطر ہمیں \عددی{C_2} کی لمبائی کو \عددی{\tfrac{4}{3}} سے ضرب دینا ہو گا۔یہی عمل دہراتے ہوئے \عددی{C_n} کی کُل لمبائی \عددی{3(\tfrac{4}{3})^{n-1}} حاصل ہوتی ہے۔  ان نتائج کو یہاں پیش کرتے ہیں۔
\begin{align*}
\renewcommand{\arraystretch}{1.5} 
\begin{array}{c|cccccc}
\text{\RL{شمار منحنی}}&1&2&3&\cdots&n&\cdots\\
\text{\RL{کُل لمبائی}}&3&3(\tfrac{4}{3})&3(\tfrac{4}{3})^2&\cdots&3(\tfrac{4}{3})^{n-1}&\cdots
\end{array}
\end{align*}
منحنی \عددی{C_{10}} کی لمبائی تقریباً \عددی{40} ہے جبکہ \عددی{C_{100}} کی لمبائی \عددی{\num{7000000000000}} سے زیادہ ہے۔ لمبائی اتنی تیزی سے بڑھتی ہے کہ اس کی تحدیدی قیمت متناہی نہیں ہو سکتی۔ یوں برف کی روئی کی لمبائی نہیں پائی جاتی، یعنی، اس کی لمبائی لامتناہی ہے۔

لمبائی کی تعریف ہموار منحنیات کے لیے پیش کی گئی تھی جن کا ہر نقطے  پر مماس استمراری مڑتا ہے۔ برف کی روئی اتنی نا ہموار ہے کہ لمبائی کے  کلیہ کا اس پر اطلاق کرنا ممکن نہیں۔

بنوا منڈلبرا کا نظریہ \اصطلاح{گنج غیر ہموار منحنیات}\فرہنگ{گنج غیر ہموار منحنیات}\حاشیہب{fractals}\فرہنگ{fractals} ایسی متعدد منحنیات پیش کرتا ہے جن کی لمبائی لامتناہی ہے۔ایسی منحنیات کو بڑا کر کے دیکھنے سے  یہ اتنی ہی غیر ہموار نظر آتی ہیں جتنی بغیر بڑا کیے نظر آتی ہیں۔ سمندر کے ساحل کی طرح  ان منحنیات کو  بھی بڑا کر کے ہموار نہیں بنایا جا سکتا۔

%sec 6.5 questions start here
%sec 6.5 questions start here
\حصہء{سوالات}
\ابتدا{سوالات}
\موٹا{ قوس کی لمبائی  کے تکمل کا حصول}\\
...
%===========================
\ابتدا{سوال}
(ا) نقطہ \عددی{(1,1)} سے گزرتی ہوئی ایسی منحنی تلاش کریں جس کی لمبائی درج ذیل ہو (مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_ب})۔
\begin{align*}
...
%=========================
\ابتدا{سوال}
(ا) نقطہ \عددی{(0,1)}  سے گزرتی ہوئی ایسی منحنی تلاش کریں جس کی لمبائی درج ذیل ہو (مساوات \حوالہ{مساوات_تکمل_استعمال_لمبائی_قوس_پ})۔
\begin{align*}
...
مساوات \عددی{x^{2/3}+y^{2/3}=1} خطوط کی ایک ایسی نسل کو ظاہر کرتی ہے جس کو ستارہ نما کہتے ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_ستارہ_نما})۔نصف ربع اول میں قوس کی لمبائی حاصل کر کے \عددی{8} سے ضرب دے کر کُل لمبائی حاصل ہو گی۔یوں \عددی{\tfrac{\sqrt{2}}{4}\le x\le 1} پر منحنی \عددی{y=(1-x^{2/3})^{3/2}} کی لمبائی حاصل کر کے \عددی{8} سے ضرب دیں۔
\انتہا{سوال}
%==========================
\begin{figure}
\centering
...
\موٹا{اعدادی تکمل}\\
آپ سوچ رہے ہوں گے کہ  اب تک لمبائی قوس میں زیادہ تر منحنیات کی مساواتیں  کیوں پیچیدہ تھیں۔ اس کی وجہ لمبائی قوس کے تکمل میں \عددی{\sqrt{1+(\tfrac{\dif y}{\dif x})^2}} ہے جو عموماً مکمل مربع نہیں ہوتا  اور جس کی وجہ سے متکمل کا ضد تفرق ہم حاصل نہیں کر پاتے۔ حقیقت میں عموماً یہی جذر غیر بنیادی تکمل کا باعث بنتا ہے۔ اسی لیے، سوال \حوالہ{سوال_تکمل_استعمال_اعدادی_الف} اور سوال \حوالہ{سوال_تکمل_استعمال_اعدادی_ب}  کی طرح،  لمبائی قوس اور سطحی رقبہ کے تکمل  عموماً اعدادی طریقوں سے حل کیے  جاتے ہیں۔ 

\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_اعدادی_الف}
آپ کا ادارہ چھتوں کے لیے لوہے کی  نالیدار چادریں بناتا ہے۔نالیدار چادروں کی عمودی تراش درج ذیل کے مطابق درکار ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_اعدادی_الف})۔
\begin{align*}
...
آپ کے انجینئری ادارے کو سرنگ بنانے کا کام ملا ہے۔ سرنگ کی لمبائی \عددی{\SI{100}{\meter}} جبکہ اس کی چوڑائی \عددی{\SI{20}{\meter}} ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_سرنگ})۔ سرنگ کی عمودی تراش \عددی{y=8\cos (\tfrac{\pi x}{20})} کے مطابق ہے۔مکمل ہونے کے بعد سرنگ کو اندر سے  پانی روک مسالہ کیا جائے گا جس پر \عددی{2000} روپیہ فی مربع میٹر لاگت متوقع ہے۔ مسالہ کرنے پر کُل کتنی لاگت آئے گی؟ (اشارہ۔ اعدادی طریقہ سے کوسائن تفاعل کی لمبائی دریافت کریں۔)
\انتہا{سوال}
%===============================
...
\draw(kT)++(0,-0.05) to [out=-30,in=180]++(0.75,-0.1)node[right]{\RL{مماسی تیلی کا  ڈھلوان $f'(x_{k-1})$ ہے}};
\end{tikzpicture}
\end{center}

\موٹا{کمپیوٹر کا استعمال}\\
سوال \حوالہ{سوال_تکمل_استعمال_کمپیوٹر_لمبائی_قوس_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_کمپیوٹر_لمبائی_قوس_ب} میں کمپیوٹر استعمال کرتے ہوئے درج ذیل اقدامات کریں۔
\begin{enumerate}[a.]
\item
...
\انتہا{سوالات}
%==========================
%sec 6.5 questions end here
%sec 6.5 questions end here


\حصہ{سطح طواف کا رقبہ}\شناخت{حصہ_استعمال_تکمل_سطح_طواف_کا_رقبہ}
بچپن میں آپ نے دوستوں کے ساتھ مل کر رسّی گھماتے ہوئے رسّی کے اوپر سے چھلانگیں ضرور لگائی ہوں گی۔ یہ رسّی فضا میں پھیر  کر ایک سطح بناتی ہے جس کو \اصطلاح{سطح طواف}\فرہنگ{طواف!سطح}\فرہنگ{سطح!طواف}\حاشیہب{surface of revolution}\فرہنگ{revolution!surface} کہتے ہیں۔ سطح طواف کا رقبہ رسّی کی لمبائی اور رسّی کے ہر حصے کے جھول پر منحصر ہو گا۔ اس حصہ میں سطح طواف کے  رقبے  اور سطح کو پیدا کرنے والی منحنی کی لمبائی اور جھول کے تعلق پر غور کیا جائے گا۔زیادہ پیچیدہ سطحوں پر  باب  \حوالہ{باب_سمتی_میدان_میں_تکمل} میں غور کیا جائے گا۔

\جزوحصہء{بنیادی کلیہ}
فرض کریں ہم غیر منفی تفاعل \عددی{y=f(x),\, a\le x\le b} کو \عددی{x}محور کے گرد گھما کر پیدا  ہونے والی سطح طواف کا سطحی رقبہ جاننا چاہتے ہیں۔ ہم \عددی{[a,b]} کی خانہ بندی کر کے نقاط خانہ بندی استعمال کرتے ہوئے ترسیم کو چھوٹے حصوں میں تقسیم کرتے ہیں۔ شکل \حوالہ{شکل_تکمل_استعمال_سطح_طواف_پہلا_الف}-ا میں نمائندہ حصہ \عددی{PQ}  اور اس کی پیدا کردہ پٹی دکھائی گئی ہے۔
\begin{figure}
\centering
\begin{subfigure}{0.3\textwidth}
\centering
...
\end{tikzpicture}
\caption
{غیر منفی تفاعل کی ترسیم کو محور $x$ کے گرد گھمانے سے سطح طواف پیدا کیا گیا ہے۔}
\end{subfigure}\hfill
\begin{subfigure}{0.3\textwidth}
\centering
...
\end{tikzpicture}
\caption{لکیری قطعہ $PQ$ مخروط مقطوع پیدا کرتا ہے۔}
\end{subfigure}\hfill
\begin{subfigure}{0.3\textwidth}
\centering
...
قوس \عددی{PQ} محور \عددی{x} کے گرد گھومتے ہوئے مخروط سطح پیدا کرتی ہے جس کو بڑا کر کے شکل \حوالہ{شکل_تکمل_استعمال_سطح_طواف_پہلا_الف}-ب میں دکھایا گیا ہے۔محور \عددی{x} اس مخروط سطح کا محور ہو گا۔ مخروط کے ایسے حصے کو \اصطلاح{مخروط مقطوع}\فرہنگ{مخروط مقطوع}\حاشیہب{frustum}\فرہنگ{frustum} کہتے ہیں۔ مخروط مقطوع کا سطحی رقبہ، {PQ} کی پیدا کردہ پٹی کے رقبے  کا تخمین ہو گا۔

مخروط مقطوع (شکل \حوالہ{شکل_تکمل_استعمال_سطح_طواف_پہلا_الف}-ج) کا سطحی رقبہ \عددی{2\pi} ضرب دونوں سروں کے رداس کی اوسط ضرب ترچھا قد   کے برابر ہو گا۔
\begin{align*}
\text{\RL{مخروط مقطوع کا سطحی رقبہ}}=2\pi\cdot \frac{r_1+r_2}{2}\cdot L=\pi(r_1+r_2)L
\end{align*} 
قطعہ \عددی{PQ} کے پیدا کردہ مخروط مقطوع (شکل \حوالہ{مساوات_تکمل_استعمال_لکیر_قوس_اہم_متغیرات}) کے لیے اس سے درج ذیل حاصل ہوتا ہے۔
\begin{align*}
\text{\RL{مخروط مقطوع کا سطحی رقبہ}}=
\pi(f(x_{k-1})+f(x_k))\sqrt{(\Delta x_k)^2+(\Delta y_k)^2}
\end{align*}
پوری سطح طواف کا رقبہ تخمیناً ایسے تمام چھوٹے قطعات کے  پیدا کردہ مخروط مقطوع کے سطحی رقبوں کا مجموعہ کے ہو گا۔
\begin{align}\label{مساوات_تکمل_استعمال_سطحی_رقبہ_الف}
\sum_{k=1}^n \pi(f(x_{k-1})+f(x_k))\sqrt{(\Delta x_k)^2+(\Delta y_k)^2}
\end{align}
ہم توقع کرتے ہیں کہ \عددی{[a,b]} کی زیادہ باریک خانہ بندی سے تخمین بہتر ہو گی۔ ہم دکھانا چاہتے ہیں کہ خانہ بندی کا معیار صفر کے قریب تر کرنے سے  مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_الف} میں دیا گیا مجموعہ قابل حل حد دے گا۔ 

یہ دکھانے کی خاطر ہم مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_الف} کو وقفہ \عددی{[a,b]} پر کسی تفاعل  کا ریمان مجموعہ لکھتے ہیں۔لمبائی قوس کے حصول کی طرح ہم تفارق  کے مسئلہ اوسط قیمت کی طرف دیکھتے ہیں۔
...
اگر \عددی{f} ہموار ہو تب مسئلہ اوسط قیمت کے تحت \عددی{P} اور \عددی{Q} کے بیچ ایسا نقطہ \عددی{(c_k,f(c_k))} ضرور پایا جائے گا جہاں مماس قطعہ \عددی{PQ} کے متوازی ہو گا (شکل \حوالہ{شکل_تکمل_استعمال_مماس_متوازی_لکیر})۔اس نقطے پر درج ذیل ہو گا۔
\begin{align*}
f'(c_k)&=\frac{\Delta y_k}{\Delta x_k}\\
\Delta y_k&=f'(c_k)\Delta x_k
\end{align*} 
مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_الف} میں درج بالا \عددی{\Delta y_k} پُر کرتے ہیں۔
\begin{multline}\label{مساوات_تکمل_استعمال_سطحی_رقبہ_ب}
\sum_{k=1}^n \pi(f(x_{k-1})+f(x_k))\sqrt{(\Delta x_k)^2+(\Delta y_k)^2}\\
=\sum_{k=1}^n\pi(f(x_{k-1})+f(x_k))\sqrt{1+(f'(c_k))^2}\Delta x_k
\end{multline}
اب یہاں ایک بُری خبر اور ایک اچھی خبر ہے۔

بُری خبر یہ ہے کہ مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_ب} میں  \عددی{x_{k-1}}، \عددی{x_k}،   اور \عددی{c_k} ایک دوسرے سے مختلف ہیں اور انہیں ایک  جیسا کسی صورت نہیں بنایا جا سکتا   لہٰذا مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_ب} میں دیا گیا مجموعہ  ریمان مجموعہ نہیں ہے۔ اچھی خبر یہ ہے کہ اس سے کوئی فرق نہیں پڑتا۔ اعلیٰ احصاء کا  \اصطلاح{مسئلہ بلس }\فرہنگ{مسئلہ!بلس}\حاشیہب{Bliss's theorem}\فرہنگ{theorem!Bliss's} کہتا ہے کہ وقفہ \عددی{[a,b]} کی خانہ بندی کا معیار صفر کے قریب تر کرنے  سے مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_ب} میں دیا گیا مجموعہ درج ذیل پر مرتکز ہو گا
\begin{align*}
\int_a^b2\pi f(x)\sqrt{1+(f'(x))^2}\dif x
\end{align*} 
جو ہم چاہتے ہیں۔یوں  \عددی{a} تا \عددی{b} تفاعل \عددی{f} کی ترسیم کو محور \عددی{x} کے گرد گھمانے سے حاصل سطح طواف کے رقبہ کی تعریف ہم اسی تکمل کو لیتے ہیں۔

\ابتدا{تعریف}\موٹا{محور \عددی{x} کے گرد سطح طواف کے رقبے  کا کلیہ}\\
اگر \عددی{[a,b]} پر تفاعل \عددی{f(x)\ge 0} ہموار ہو تب تفاعل \عددی{y=f(x)} کو محور \عددی{x} کے گرد گھمانے سے حاصل سطح طواف کا رقبہ درج ذیل ہو گا۔
...
مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_پ} میں جذر وہی ہے جو پیداکار منحنی کی لمبائی قوس کے کلیے میں پایا جاتا ہے۔

\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_سطح_طواف_کا_رقبہ_الف}
محور \عددی{x} کے گرد منحنی \عددی{y=2\sqrt{x},\, 1\le x\le 2} گھما کر سطح طواف پیدا کی جاتی ہے (شکل \حوالہ{شکل_مثال_تکمل_استعمال_سطح_طواف_کا_رقبہ_الف})۔ سطح طواف کا رقبہ تلاش کریں۔
...
محور \عددی{y} کے گرد سطح طواف کے لیے ہم مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_پ} میں \عددی{x} اور \عددی{y} کی جگہیں   آپس میں تبدیل کرتے  ہیں۔

\موٹا{محور \عددی{y} کے گرد سطح طواف کے رقبے کا کلیہ}\\
...
لکیری قطعہ \عددی{x=1-y,\, 0\le y\le 1} کو  محور \عددی{y} کے گرد گھما کر مخروط حاصل کیا جاتا ہے (شکل \حوالہ{شکل_مثال_تکمل_استعمال_سطح_طواف_کا_رقبہ_ب})۔ اس کا رقبہ پہلو تلاش کریں۔

\حل
یہ  رقبہ   جیومیٹری سے حاصل کیا جا سکتا ہے۔
\begin{align*}
...
\end{align*}
مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_ت} سے  رقبہ  حاصل کریں۔
\begin{align*}
...
\end{align*}
دونوں نتائج یکساں  ہیں، جیسا کہ ہونا چاہیے۔
\انتہا{مثال}
%========================

\جزوحصہء{مختصر تفرقی روپ}
درج ذیل مساواتوں
\begin{align*}
...
\end{align*}
کو عموماً  قوس کی  تفرقی    لمبائی \عددی{\dif s=\sqrt{\dif x^2+\dif y^2}} کی صورت میں درج ذیل  لکھا جاتا ہے۔
\begin{align*}
S=\int_a^b2\pi y\dif s\quad \text{اور}\quad S=\int_c^d2\pi x\dif s
\end{align*}
بائیں مساوات میں محور \عددی{x} سے قطعہ \عددی{\dif s} تک فاصلہ \عددی{y} ہے۔ دائیں  مساوات میں محور \عددی{y} سے قطعہ \عددی{\dif s} کا فاصلہ \عددی{x} ہے۔ان دونوں کلیوں کو
\begin{align*}
S=\int 2\pi(\text{\RL{رداس}})(\text{\RL{چوڑائی پٹی}})= \int 2\pi \rho \dif s
\end{align*}
لکھا جا سکتا ہے جہاں  تفرقی  لمبائی \عددی{\dif s} تک محور طواف سے فاصلہ \عددی{\rho} ہے (شکل \حوالہ{شکل_تکمل_استعمال_چھوٹا_تفریقی_کلیہ})۔
\begin{figure}
\centering
\begin{minipage}{0.45\textwidth}
\centering
...
\end{tikzpicture}
\caption
{قوس $AB$ کو محور طواف کے گرد گھما کر حاصل سطح طواف کا رقبہ $\int_a^b2\pi \rho \dif s$ ہو گا۔}
...
\end{tikzpicture}
\caption
{قوس $y=x^3$ کو محور $x$ کے گرد گھما کر سطح طواف پیدا کیا گیا ہے۔}
\label{شکل_مثال_تکمل_استعمال_سطح_طواف_چھوٹا_تفریقی}
\end{minipage}
\end{figure}

\موٹا{مختصر تفرقی روپ}\\
\begin{align*}
S=\int 2\pi \rho \dif s
\end{align*}
کسی مخصوص مسئلے میں آپ قوسچہ    کی تفرقی لمبائی \عددی{\dif s} اور رداس \عددی{\rho} کو کسی مشترکہ متغیر کی صورت میں لکھ کر تکمل کی حدود بھی اسی متغیر کے  روپ میں مہیا کریں گے۔ 

\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_سطح_طواف_چھوٹا_تفریقی}
منحنی \عددی{y=x^3,\, 0\le x\le \tfrac{1}{2}} کو محور \عددی{x} کے گرد گھما کر سطح طواف پیدا کی جاتی ہے (شکل \حوالہ{شکل_مثال_تکمل_استعمال_سطح_طواف_چھوٹا_تفریقی})۔ اس کا سطحی رقبہ معلوم کریں۔

\حل
ہم مختصر تفرقی روپ سے شروع کرتے ہیں۔
\begin{align*}
S&=\int 2\pi \rho \dif s\\
&=\int 2\pi y\dif s\\
&=\int 2\pi y\sqrt{\dif x^2+\dif y^2}&&\dif s=\sqrt{\dif x^2+\dif y^2}
\end{align*} 
ہم نے   فیصلہ کرنا ہو گا کہ آیا \عددی{\dif s} کو \عددی{\dif x} یا \عددی{\dif y} کے  روپ میں لکھیں۔منحنی کی مساوات \عددی{y=x^3} سے \عددی{\dif y} کو \عددی{\dif x} کی صورت میں لکھنا زیادہ آسان ہے لہٰذا ہم درج ذیل استعمال کریں گے۔
\begin{align*}
...
%sec 6.6 questions start here
%sec 6.6 questions start here
\حصہء{سوالات}
\ابتدا{سوالات}
\موٹا{سطحی رقبہ کے تکمل}\\
سوال \حوالہ{سوال_تکمل_استعمال_سطحی_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_سطحی_ب} میں درج ذیل اقدامات کریں۔
\begin{enumerate}[a.]
\item
دی گئی  منحنی کو دیے گئے محور کے گرد گھما کر سطح طواف حاصل کیا جاتا ہے۔ اس کے سطحی رقبے کا تکمل لکھیں۔
\item
منحنی کو ترسیم کر کے اس کی صورت دیکھیں۔ سطحی رقبہ   بھی ترسیم کریں۔
\item
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) \عددی{2\pi\int_0^{\pi/4}\tan x\sqrt{1+\sec^4x}\dif x}، \\
(ج) \عددی{\approx 3.84}
}}
\انتہا{جواب}
%====================
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) \عددی{2\pi\int_0^{\pi/3}(\int_0^y\tan t\dif t)\sec y\dif y}، \\
(ج) \عددی{\approx 2.08}
}}
\انتہا{جواب}
%====================
...
\ابتدا{سوال}
لکیری قطعہ \عددی{y=\tfrac{x}{2},\, 0\le x\le 4} کو محور \عددی{x} کے گرد گھما کر مخروط پیدا کیا جاتا ہے۔ اس کے پہلو کا رقبہ تکمل سے تلاش کریں۔ جیومیٹری کے کلیہ (پہلو کا رقبہ=\عددی{\tfrac{1}{2}}(محیط تلہ)(ترچھا قد)) سے اپنے جواب کی تصدیق کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$4\pi \sqrt{5}$
...
%==================
\ابتدا{سوال}
لکیری قطعہ \عددی{y=\tfrac{x}{2},\, 0\le x\le 4} کو محور \عددی{y} کے گرد گھما کر مخروط پیدا کیا جاتا ہے۔ اس کے پہلو کا رقبہ تکمل سے تلاش کریں۔ جیومیٹری کے کلیہ سے اپنے جواب کی تصدیق کریں۔
\انتہا{سوال}
%======================
\ابتدا{سوال}
لکیری قطعہ \عددی{y=\tfrac{x}{2}+\tfrac{1}{2},\, 1\le x\le 3} کو محور \عددی{x} کے گرد گھما کر مخروط مقطوع پیدا کیا جاتا ہے۔ اس کے پہلو کا رقبہ تکمل سے تلاش کریں۔ جیومیٹری کے کلیہ (رقبہ مخروط مقطوع=\عددی{\pi}(\عددی{r_1+r_2})(ترچھا قد)) سے اپنے جواب کی تصدیق کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$3\pi \sqrt{5}$
...
%======================
\ابتدا{سوال}
لکیری قطعہ \عددی{y=\tfrac{x}{2}+\tfrac{1}{2},\, 1\le x\le 3} کو محور \عددی{y} کے گرد گھما کر مخروط مقطوع پیدا کیا جاتا ہے۔ اس کے پہلو کا رقبہ تکمل سے تلاش کریں۔ جیومیٹری کے کلیہ (رقبہ مخروط مقطوع=\عددی{\pi}(\عددی{r_1+r_2})(ترچھا قد)) سے اپنے جواب کی تصدیق کریں۔
\انتہا{سوال}
%======================
سوال \حوالہ{سوال_تکمل_استعمال_ترسیم_تکمل_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_ترسیم_تکمل_ب} میں منحنی کو دیے گئے محور کے گرد گھما کر سطح طواف پیدا کی جاتی ہے۔ سطح کا رقبہ معلوم کریں۔ بہتر ہو گا کہ آپ دیے گئے منحنی کو کمپیوٹر پر ترسیم کر کے منحنی کی صورت سیکھیں۔ 
...
تفاعل \عددی{y=\sqrt{a^2-x^2},\, -a\le x\le x} کو محور \عددی{x} کے گرد گھمانے سے کروی سطح حاصل ہوتا ہے۔ دکھائیں کہ مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_پ} سے بھی رداس \عددی{a}  کے کرہ کا سطحی رقبہ \عددی{4\pi a^2} حاصل ہوتا ہے۔
\انتہا{سوال}
%=======================
\ابتدا{سوال}\ترچھا{نئی تعریف کی پرکھ}\\
لکیری قطعہ \عددی{y=\tfrac{r}{h}x,\, 0\le x\le h} کو محور \عددی{x} کے گرد گھمانے سے مخروط پیدا ہوتا ہے جس کے پہلو کا رقبہ \عددی{\pi r\sqrt{r^2+h^2}} ہوتا ہے جہاں مخروط کا قد \عددی{h} اور اس کے قاعدے   کا رداس \عددی{r} ہے لہٰذا اس کا ترچھا قد \عددی{\sqrt{r^2+h^2}} ہو گا۔ تکمل سے مخروط کے پہلو کا رقبہ دریافت کر کے اس کلیے  کی تصدیق کریں۔ 
\انتہا{سوال}
%=================
\ابتدا{سوال}
   (ا) منحنی \عددی{y=\cos x,\, -\tfrac{\pi}{2}\le x\le \tfrac{\pi}{2}} کو محور \عددی{x} کے گرد گھما کر سطح طواف پیدا ہوتا ہے۔ اس سطح طواف کے رقبہ کا تکمل لکھیں جس کو حل کرنا حصہ \حوالہ{حصہ_تراکیب_تکونیاتی_بدل} میں سکھایا جائے گا۔ (ب)  سطحی رقبے کو اعدادی طریقہ سے دریافت کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
ستارہ نما \عددی{x^{2/3}+y^{2/3}=1} کا وہ حصہ جو محور \عددی{x} سے اوپر واقع ہے کو محور \عددی{x} کے گرد گھما کر سطح طواف پیدا کی جاتی ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_دوبارہ_ستارہ_نما})۔  سطح طواف کا رقبہ معلوم کریں۔ (اشارہ۔ ربع اول میں منحنی کے حصہ \عددی{y=(1-x^{2/3})^{3/2},\, 0\le x\le 1}) کو محور \عددی{x} کے گرد گھما کر نتیجہ  کو دگنا کریں۔)
\انتہا{سوال}
%================
\begin{figure}
\centering
...
ڈبل روٹی اندر سے نرم اور باہر سے کرارا ہوتی ہے۔کیا آپ جانتے ہیں کہ کروی ڈبل روٹی کے یکساں  موٹے کتلوں میں  ایک جتنا کرارا حصہ پایا جاتا ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_ڈبل_روٹی})؟ یہ دیکھنے کی خاطر نصف دائرہ \عددی{y=\sqrt{r^2-x^2}} کو محور \عددی{x} کے گرد گھما کر کرہ بنائیں۔فرض کریں محور \عددی{x} پر وقفہ \عددی{h} کے اوپر نصف دائرے کی قوس \عددی{AB} ہے۔ دکھائیں کہ نصف دائرے کو محور \عددی{x} کے گرد گھمانے سے \عددی{AB} سے حاصل رقبے کی قیمت \عددی{h} کے مقام پر منحصر نہیں۔ (کرارا رقبے  کی قیمت \عددی{h} پر منحصر ہو گی۔)
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_کرہ_سے_پٹی}
دو متوازی سطحیں جن کے مابین فاصلہ \عددی{h} ہے،  رداس \عددی{R} کے کروی سطح سے ایک پٹی کاٹتی ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_کرہ_سے_پٹی})۔ دکھائیں کہ اس پٹی کا رقبہ \عددی{2\pi Rh} ہو گا۔   
\انتہا{سوال}
%===================
\begin{figure}
\centering
...
\انتہا{سوال}
%====================
\ابتدا{سوال}\ترچھا{محور طواف کو قطع کرنے والی  منحنیات سے حاصل سطح طواف}\\
...
\end{align}
تفاعل \عددی{y=\tfrac{x^3}{9}-\sqrt{3},\, -\sqrt{3}\le x\le \sqrt{3}}  کو محور \عددی{x} کے گرد گھمانے سے حاصل دوہرے مخروط کا سطحی رقبہ مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_ٹ} استعمال کرتے ہوئے  دریافت کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$5\sqrt{2}\pi$
...
%=================
\ابتدا{سوال}
قوس \عددی{y=\tfrac{x^3}{9}-\sqrt{3},\, -\sqrt{3}\le x\le \sqrt{3}} کو محور \عددی{x} کے گرد گھما کر سطح طواف پیدا کی جاتی ہے۔ مساوات \حوالہ{مساوات_تکمل_استعمال_سطحی_رقبہ_ٹ} میں مطلق کی علامت ہٹا کر سطحی رقبہ تلاش کرنے سے کیا ہو گا؟
\انتہا{سوال}
%====================
\موٹا{اعدادی تکمل}\\
سوال \حوالہ{سوال_تکمل_استعمال_اعدادی_درستگی_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_اعدادی_درستگی_الف} میں محور \عددی{x} کے گرد  دی گئی  منحنیات گھمانے سے سطح طواف پیدا ہوں گی۔ ان سطح طواف کے رقبے اعدادی تراکیب سے \عددی{2} اعشاریہ مقامات تک درستگی تک معلوم کریں۔
...
فرض کریں \عددی{[a,b]} پر \عددی{f} ہموار ہے۔ وقفہ \عددی{[a,b]} کی خانہ بندی کریں اور \عددی{k} واں ذیلی وقفہ \عددی{[x_{k-1},x_k]} کے وسطی نقطہ \عددی{m_k=(\tfrac{x_{k-1}+x_k}{2})} پر منحنی کا مماس خط  کھینچیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_تفرق_متبادل_کلیہ})۔
\begin{enumerate}[a.]
\item
درج ذیل دکھائیں۔
\begin{align*}
...
\end{align*}
\item
دکھائیں کہ \عددی{k} واں ذیلی وقفہ میں مماسی قطعہ کی لمبائی \عددی{ L_k=\sqrt{(\Delta x_k)^2+(f'(m_k)\Delta x_k)^2}} ہے۔
\item
دکھائیں کہ مماسی قطعہ کو محور \عددی{x} کے گرد گھمانے سے حاصل سطح طواف کا رقبہ پہلو \عددی{2\pi f(m_k)\sqrt{1+(f'(m_k))^2}\Delta x_k} ہو گا۔
\item
دکھائیں کہ وقفہ \عددی{[a,b]} پر \عددی{y=f(x)} کو محور \عددی{x}  کے  گرد گھمانے سے حاصل سطح طواف کا رقبہ درج ذیل ہو گا۔
\begin{align*}
...
%sec 6.6 questions end here
%sec 6.6 questions end here



\حصہ{معیار اثر اور مرکز کمیت}\شناخت{حصہ_استعمال_تکمل_معیار_اثر_اور_مرکز_کمیت}
بہت سے ڈھانچے  اور میکانی نظام  ایسا  برتاؤ  کرتے ہیں جیسے ان کی کمیت ایک نقطے میں سموئی   ہو،   جس کو مرکز کمیت کہتے ہیں۔ اس نقطے کا مقام جاننا اہم ہے، جسے ریاضی کی مدد سے معلوم کیا جا سکتا ہے۔ اس باب میں یک بُعدی اور دو بُعدی اجسام  پر توجہ دی جائے گی۔ تین بُعدی چیزوں پر   باب \حوالہ{باب_تکمل_بالکثرت} میں غور کیا جائے گا۔

\جزوحصہء{لکیر پر کمیت}
ہم اپنا ریاضیاتی  نمونہ مرحلہ وار  تیار کرتے ہیں۔ ابتدائی  مرحلے  میں ہم استوار   محور \عددی{x}  پر کمیت \عددی{m_1}، \عددی{m_2}،  اور \عددی{m_3} تصور کرتے ہیں اور مبدا کو اس محور کا  چول تصور کرتے ہیں۔یہ نظام متوازن یا غیر متوازن ہو گا۔ توازن کا دارومدار کمیتوں کی مقدار اور ان کے مقامات پر ہے۔ 
...
\end{tikzpicture}
\end{center}
ہر کمیت \عددی{m_k} پر نیچے رخ قوت \عددی{m_kg} عمل کرتی ہے، جہاں \عددی{g} ثقلی اسراع ہے (قوت \عددی{m_kg} کو کمیت \عددی{m_k} کا وزن کہتے ہیں)۔ ہر ایسی قوت محور کو مبدا کے گرد گھمانے کی کوشش کرتی ہے۔ گھومنے کے اس اثر کو \اصطلاح{قوت مروڑ}\فرہنگ{قوت مروڑ}\حاشیہب{torque}\فرہنگ{torque} کہتے ہیں۔  قوت \عددی{m_kg} کو مبدا سے فاصلہ \عددی{x_k} سے ضرب دینے سے قوت مروڑ کی مقدار حاصل ہوتی ہے، جہاں فاصلہ مثبت یا منفی ممکن ہے۔ مبدا سے بائیں جانب کمیت منفی (گھڑی مخالف) قوت مروڑ پیدا کرتی ہے،  جبکہ مبدا سے دائیں جانب کمیت مثبت (گھڑی رخ) قوت مروڑ پیدا کرتی  ہے۔

قوت مروڑ کا مجموعہ، مبدا کے گرد نظام  کے گھومنے کے رجحان کی  ناپ ہے۔ اس مجموعے  کو \اصطلاح{نظام کی قوت مروڑ}\فرہنگ{قوت مروڑ!نظام}\حاشیہب{system torque}\فرہنگ{torque!system} کہتے ہیں۔
\begin{align}
...
عدد \عددی{(m_1x_1+m_2x_2+m_3x_3)} کو \اصطلاح{مبدا کے لحاظ سے نظام کا معیار اثر} کہتے ہیں جو انفرادی کمیت کے  \اصطلاح{معیارات  اثر}\فرہنگ{معیارات  اثر}\حاشیہب{moments}\فرہنگ{moments}  \عددی{m_1x_1}، \عددی{m_2x_2}،  اور \عددی{m_3x_3} کا مجموعہ ہے۔
\begin{align*}
M_0=\text{\RL{مبدا کے لحاظ سے نظام کا معیار اثر}}=\sum m_kx_k
\end{align*}

ہم نظام کو متوازن بنانے کی خاطر نظام کے چول کا مقام جاننا چاہتے ہیں، یعنی چول کو کس نقطہ \عددی{\bar{x}} پر رکھنے سے نظام کی قوت مروڑ صفر ہو گی۔
\begin{center}
\begin{tikzpicture}
\pgfmathsetmacro{\fa}{0.8}
\pgfmathsetmacro{\fb}{3}
...
\end{tikzpicture}
\end{center}
اس مخصوص مقام پر چول رکھنے سے، چول کے لحاظ سے  ہر ایک  کمیت کی قوت مروڑ درج ذیل لکھی جا سکتی ہے، جہاں فاصلہ مثبت یا منفی ہو سکتا ہے۔
\begin{align*}
\text{\RL{$\bar{x}$کے لحاظ سے $m_k$ کا معیار اثر}}&=(\text{\RL{$\bar{x}$ سے $m_k$ کا فاصلہ}})(\text{\RL{نیچے رخ قوت}})\\
&=(x_k-\bar{x})m_kg
\end{align*} 
ان معیارات اثر کے مجموعے  کو صفر کے برابر پُر کرنے سے ہمیں ایسی مساوات ملتی ہے جسے ہم \عددی{\bar{x}} کے لیے حل کر سکتے ہیں۔(ذیل دیکھیں۔)
\begin{align*}
...
\bar{x}&=\frac{\sum m_kx_k}{\sum m_k}&&\text{\RL{$\bar{x}$ کے لیے حل}}
\end{align*} 
یہاں  آخری مساوات کہتی ہے کہ \عددی{\bar{x}} معلوم کرنے کے لیے مبدا کے لحاظ سے نظام کے معیار اثر کو نظام کی کُل کمیت سے تقسیم کریں۔
\begin{align*}
\bar{x}=\frac{\sum x_km_k}{\sum m_k}=\frac{\text{\RL{مبدا کے لحاظ سے نظام کا معیار اثر}}}{\text{\RL{نظام کی کمیت}}}
\end{align*}
نقطہ \عددی{\bar{x}} کو نظام کا \اصطلاح{مرکز کمیت}\فرہنگ{مرکز کمیت}\حاشیہب{center of mass}\فرہنگ{mass!center of} کہتے ہیں۔

\جزوحصہء{تار اور پتلی سلاخ}
بہت سے مواقع پر ہمیں سلاخ یا پتلی پٹی کا   مرکز کمیت    جاننے کی ضرورت ہوتی ہے۔ایسی صورتوں میں اگر ہم کمیت   کی تقسیم کو استمراری تفاعل کی صورت میں لکھ سکیں  تب ہمارے کلیات میں جمع کے بجائے تکمل ہو گا۔ اس پر اب بات کرتے ہیں۔

فرض کریں ایک لمبی پٹی \عددی{x=a} تا \عددی{x=b} محور \عددی{x} پر واقع ہے۔ ہم وقفہ  \عددی{[a,b]} پر  پٹی کی خانہ بندی کر کے پٹی  کو \عددی{\Delta m_k} کمیت کے چھوٹے چھوٹے  ٹکڑوں میں تقسیم کرتے ہیں۔ \عددی{k} واں ٹکڑے کی لمبائی \عددی{\Delta x_k} ہے اور یہ مبدا سے تقریباً \عددی{x_k} فاصلے پر واقع ہے۔اب تین چیزوں کا مشاہدہ کریں۔
...
\end{tikzpicture}
\end{center}
اول، ہر   کمیت   \عددی{\Delta m_k} کو  نقطہ \عددی{x_k}   پر رکھنے سے پیدا  نقطوی کمیتی نظام کا   تقریباً وہی (درج ذیل)  مرکز کمیت حاصل ہو گا جو  پٹی کا مرکز کمیت  \عددی {\bar{x}}  ہے۔
\begin{align*}
...
\end{align}
مساوات \حوالہ{مساوات_تکمل_استعمال_مرکز_کمیت_الف} کا آخری شمار کنندہ بند وقفہ \عددی{[a,b]} پر استمراری تفاعل \عددی{x\delta(x)} کا ریمان مجموعہ  ہے جبکہ نسب نما اس وقفے  پر تفاعل \عددی{\delta(x)} کا ریمان مجموعہ ہے۔ہم توقع کرتے ہیں کہ زیادہ باریک خانہ بندی سے مساوات \حوالہ{مساوات_تکمل_استعمال_مرکز_کمیت_الف} میں تخمین بہتر ہوں گے  لہٰذا ہم درج ذیل لکھ سکتے ہیں۔
\begin{align*}
\bar{x}=\frac{\int_a^bx\delta(x)\dif x}{\int_a^b\delta(x)\dif x}
\end{align*} 
ہم \عددی{\bar{x}} کو درج بالا کلیہ سے معلوم کرتے ہیں۔

\موٹا{معیار اثر، کمیت، اور محور  \عددی{x}  پر کثافتی تفاعل $\delta(x)$ کی  سلاخ یا پٹی کا مرکز کمیت}\\
\begin{gather}
...
مساوات \حوالہ{مساوات_تکمل_استعمال_مرکز_کمیت_ب} کے حصول میں کثافت کی بات کی گئی۔ عام طور پر  کثافت سے مراد کمیت فی اکائی حجم ہوتا ہے البتہ بعض اوقات ہم وہ اکائیاں استعمال کرتے ہیں جن کی پیمائش نسبتاً زیادہ آسان ہو۔یوں تار، سلاخ،  اور پٹی کے لیے  ہم کمیت فی اکائی لمبائی کو کثافت کہتے ہیں، جبکہ مستوی سطحوں کے لیے  کمیت فی اکائی رقبہ کو  کثافت کہتے ہیں۔ 


\ابتدا{مثال}\ترچھا{مستقل کثافت کی سلاخ یا پٹی}\\
مستقل کثافت  رکھنے والی سلاخ یا پٹی کا مرکز کمیت تلاش کریں۔
...
\end{align*}
مستقل کثافت کی صورت میں مرکز کمیت سلاخ یا پٹی کے عین وسطی نقطے  پر ہو گا۔
\انتہا{مثال}
%===============
\begin{figure}
\centering
...
\end{tikzpicture}
\caption{مستقل کثافت کی پتلی سیدھی سلاخ کا مرکز کمیت دونوں سروں کے وسطی نقطے پر ہو گا۔}
...
\draw[-latex](\l+0.1,0)--++(0.5,0)node[right]{$x$};
\end{tikzpicture}
\caption{متغیر موٹائی کی  سیدھی سلاخ کو متغیر کثافت کی سیدھی سلاخ تصور کیا جا سکتا ہے۔}
\label{شکل_تکمل_استعمال_متغیر_پتلا_سلاخ}
\end{minipage}
\end{figure}
\ابتدا{مثال}\ترچھا{متغیر کثافت}\\
ایک سلاخ جس کی لمبائی \عددی{\SI{10}{\meter}} ہے بائیں سے دائیں چلتے ہوئے موٹی  ہوتی جاتی ہے (شکل \حوالہ{شکل_تکمل_استعمال_متغیر_پتلا_سلاخ}) لہٰذا اس کی کثافت مستقل ہونے کے بجائے \عددی{\delta(x)=1+\tfrac{x}{10}\,\si{\kilo\gram\per\meter}} ہے۔ سلاخ کا مرکز کمیت معلوم کریں۔
...
\end{tikzpicture}
\caption
{ہر کمیت \عددی{m_k} کا ہر   محور کے لحاظ سے معیار اثر ہو گا۔}
...
\end{tikzpicture}
\caption{دو بُعدی کمیتوں کا جھرمٹ اپنے مرکز کمیت پر متوازن ہو گا۔}
\label{شکل_تکمل_استعمال_معیار_اثر_تعریف_ب}
\end{minipage}
\end{figure}

\جزوحصہء{مستوی پر  کمیت کی تقسیم}
فرض کریں ایک مستوی پر  متناہی تعداد  کی  کمیتیں  پائی جاتی ہیں۔یوں نقطہ \عددی{(x_k,y_k)} پر کمیت \عددی{m_k} ہو گی(شکل \حوالہ{شکل_تکمل_استعمال_معیار_اثر_تعریف_الف})۔اس نظام کی کمیت درج ذیل ہو گی۔
\begin{align*}
M&=\sum m_k&&\text{\RL{نظام کی کمیت}}
\end{align*} 
ہر کمیت \عددی{m_k} کا دونوں محور کے لحاظ سے معیار اثر ہو گا۔ محور \عددی{x} کے لحاظ سے اس کا معیار اثر \عددی{m_ky_k}، جبکہ محور \عددی{y} کے لحاظ سے  اس کا معیار اثر \عددی{m_kx_k} ہو گا۔دونوں محور کے لحاظ سے پورے نظام کا معیار اثر درج ذیل ہو گا۔
\begin{align*}
...
\end{align}
یک بُعدی صورت کی طرح \عددی{\bar{x}} کی اس قیمت کے لیے نظام لکیر \عددی{x=\bar{x}} پر توازن میں ہو گا (شکل \حوالہ{شکل_تکمل_استعمال_معیار_اثر_تعریف_ب})۔
...
\end{align}
یک بُعدی صورت کی طرح \عددی{\bar{y}} کی اس قیمت کے لیے نظام لکیر \عددی{y=\bar{y}} پر توازن میں ہو گا۔ لکیر \عددی{y=\bar{y}} کے لحاظ سے تمام قوت مروڑ ایک دوسرے کو منسوخ کر کے صفر قوت مروڑ پیدا کرتی ہیں۔ توازن کے اعتبار سے یوں معلوم ہوتا ہے جیسے  نظام کی پوری کمیت نقطہ \عددی{(\bar{x},\bar{y})} میں  سموئی ہوئی  ہے۔ اس نقطے کو نظام کا  \اصطلاح{مرکز کمیت}\فرہنگ{مرکز کمیت}\حاشیہب{center of mass}\فرہنگ{mass!center} کہتے ہیں۔


\جزوحصہء{پتلی مسطح  چادر}
کئی  مرتبہ ہمیں پتلی مسطح  چادر کا مرکز کمیت درکار ہوتا ہے۔ ایسی صورت میں ہم فرض کرتے ہیں کہ کمیت کی تقسیم استمراری ہے لہٰذا \عددی{\bar{x}} اور \عددی{\bar{y}} کے کلیات میں متناہی مجموعوں کے بجائے تکمل پائے جاتے ہیں۔آئیں اس پر غور کرتے ہیں۔
\begin{figure}
\centering
\begin{tikzpicture}[font=\small]
...
\end{tikzpicture}
\caption
{چادر کو انتصابی پتلی پٹیوں میں تقسیم کیا گیا ہے۔ نمائندہ پٹی کا کسی ایک انفرادی محور کے لحاظ سے معیار اثر وہی ہو گا جو پٹی کی کمیت \عددی{\dif m} کو پٹی کے  مرکز کمیت پر منجمد کرنے سے حاصل ہو گا۔}
\label{شکل_تکمل_استعمال_چادر_انتصابی_پٹی_مرکز_کمیت}
\end{figure}
فرض کریں مستوی  \عددی{xy} میں ایک پتلی چادر واقع ہے۔ چادر کو کسی ایک محور کے متوازی باریک پٹیوں میں تقسیم کریں (شکل \حوالہ{شکل_تکمل_استعمال_چادر_انتصابی_پٹی_مرکز_کمیت} میں پٹیاں محور \عددی{y} کے متوازی ہیں)۔ کسی ایک نمائندہ پٹی کی کمیت کا مرکز \عددی{(\tilde{x},\tilde{y})} ہو گا۔ ہم پٹی کی کمیت \عددی{\Delta m} کو نقطہ \عددی{(\tilde{x},\tilde{y})} پر منجمد تصور کرتے ہیں۔یوں محور \عددی{y} کے لحاظ سے پٹی کا معیار اثر \عددی{\tilde{x}\Delta m} ہو گا، جبکہ محور \عددی{x} کے لحاظ سے پٹی کا معیار اثر \عددی{\tilde{y}\Delta m} ہو گا۔ اس طرح مساوات \حوالہ{مساوات_تکمل_استعمال_مرکز_کمیت_ایکس} اور مساوات \حوالہ{مساوات_تکمل_استعمال_مرکز_کمیت_وائے} درج ذیل صورت اختیار کرتی  ہیں۔
\begin{align*}
\bar{x}=\frac{M_y}{M}=\frac{\sum \tilde{x}\Delta m}{\sum \Delta m},\quad \bar{y}=\frac{M_x}{M}=\frac{\sum \tilde{y}\Delta m}{\sum \Delta m}
\end{align*}
یک بُعدی صورت کی طرح یہاں بھی ریمان مجموعے پائے جاتے ہیں، جن کی قیمتیں، پٹی کی چوڑائی کو  کم سے کم کرنے سے، قطعی تکملات کی قیمتیں ہوں گی۔ ان تکملات کو علامتی  طور پر درج ذیل لکھا جاتا ہے۔
\begin{align*}
\bar{x}=\frac{\int \tilde{x}\dif m}{\int \dif m},\quad \bar{y}=\frac{\int\tilde{y}\dif m}{\int\dif m}
\end{align*} 

\موٹا{مستوی \عددی{xy} میں باریک چادر کے معیار اثر، کمیت اور مرکز کمیت}
\begin{gather}
\begin{aligned}
...
ان تکملات کے حصول کے لیے ہم چادر کو محددی مستوی میں رکھ کر کسی ایک محدد کے متوازی  ایک نمائندہ پٹی کا خاکہ بناتے ہیں۔ اس پٹی کی کمیت اور مرکز کمیت کے محدد \عددی{ (\tilde{x},\tilde{y})} کو \عددی{x} اور \عددی{y} کی صورت میں لکھا جاتا ہے۔ اس کے بعد ہم  محددی مستوی میں چادر کے مقام کے اعتبار سے موزوں حدود کے بیچ  \عددی{\tilde{y}\dif m}، \عددی{\tilde{x}\dif m}، اور \عددی{\dif m} کے تکملات  لیتے ہیں۔
...
(ا) نمائندہ پٹی کے لیے درج ذیل لکھا جا سکتا ہے۔
\begin{multicols}{2}
\begin{enumerate}[]
\item
مرکز کمیت:\quad
...
ایک پتلی چادر، جس  کی کثافت مستقل \عددی{\delta} ہے، کو بالائی طرف سے قطع مکافی \عددی{y=4-x^2} اور زیریں طرف سے محور \عددی{x}  گھیرتا ہے (شکل \حوالہ{شکل_مثال_تکمل_استعمال_مستقل_کثافت})۔ اس چادر کا مرکز کمیت تلاش کریں۔

\حل
چونکہ  چادر  کی کثافت مستقل ہے اور  کمیت  کی تقسیم محور \عددی{y} کے لحاظ سے تشاکلی ہے، لہٰذا مرکز کمیت محور \عددی{y} پر پایا جائے گا۔ یوں \عددی{\bar{x}=0} ہو گا۔ ہمیں صرف \عددی{\bar{y}=\tfrac{M_x}{M}} معلوم کرنا ہے۔

افقی پٹیاں لینے سے  درج ذیل مشکل تکمل پیدا ہوتا ہے
\begin{align*}
M_x=\int_0^42\delta y\sqrt{4-y}\dif y
\end{align*} 
لہٰذا ہم انتصابی پٹیاں لے کر آگے بڑھتے ہیں۔ نمائندہ انتصابی پٹی کے لیے درج ذیل لکھا جا سکتا ہے۔
\begin{multicols}{2}
\begin{enumerate}[]
\item
مرکز کمیت:\quad
...
\end{enumerate}
\end{multicols}
محور \عددی{x} کے لحاظ سے پٹی کا معیار اثر درج ذیل ہو گا
\begin{align*}
\tilde{y}\dif m=\frac{4-x^2}{2}\cdot \delta(4-x^2)\dif x=\frac{\delta}{2}(4-x^2)^2\dif x
\end{align*}
لہٰذا محور \عددی{y} کے لحاظ سے چادر کا معیار اثر درج ذیل ہو گا۔
...
\حل
کمیت اب بھی محور \عددی{y} کے لحاظ سے تشاکلی ہے لہٰذا \عددی{\bar{x}=0} ہو گا۔ یوں \عددی{\delta=2x^2} کے لیے مساوات \حوالہ{مساوات_تکمل_استعمال_محور_ایکس_لحاظ_معیار_اثر} اور مساوات \حوالہ{مساوات_تکمل_استعمال_محور_کمیت_چادر} درج ذیل صورت اختیار کریں گے۔
\begin{align*}
...
\حل
ہم نصف دائرے کو تفاعل \عددی{y=\sqrt{a^2-x^2}} سے ظاہر کرتے ہیں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_تار_نصف_دائرہ})۔کمیت کی تقسیم محور \عددی{y} کے لحاظ سے تشاکلی ہے لہٰذا  \عددی{\bar{x}=0} ہو گا۔ہم تصور میں تار کو چھوٹے قطعات میں تقسیم کر کے \عددی{\bar{y}} تلاش کرتے ہیں۔ نمائندہ قطعہ کے لیے درج ذیل ہو گا۔
\begin{multicols}{2}
\begin{enumerate}[]
\item
لمبائی:\quad
...
\end{tikzpicture}
\caption{مرکز کمیت تار پر نہیں پایا جاتا۔}
\end{subfigure}
...
\جزوحصہ{وسطانی مرکز}
مستقل کثافت کی صورت میں \عددی{\bar{x}} اور \عددی{\bar{y}} کے  کلیات میں  نسب نما اور شمار کنندہ میں پائے جانے والے \عددی{\delta} ایک دوسرے کو منسوخ کرتے ہیں۔یوں \عددی{\bar{x}} اور \عددی{\bar{y}} کے  نقطہ نظر سے \عددی{\delta} کو شروع سے اکائی \عددی{(1)} تصور کیا جا سکتا ہے۔ مستقل کثافت کی صورت میں کسی چیز کی کمیت کا مرکز اس چیز کی شکل و صورت پر منحصر ہو گا نہ کہ اس مادّے پر جس سے یہ چیز بنی ہو۔ایسی صورت میں مرکز کمیت کو عموماً \اصطلاح{وسطانی مرکز}\فرہنگ{وسطانی مرکز}\حاشیہب{centroid}\فرہنگ{centroid} کہتے ہیں۔ یوں اگر آپ سے کہا جائے کہ تکون، مخروط،  یا کرہ کا وسطانی مرکز تلاش کریں۔ آپ  \عددی{\delta=1}  لے کر معیار اثر  کو کمیت   سے تقسیم  کر کے \عددی{\bar{x}} اور \عددی{\bar{y}}  معلوم کریں۔

%sec 6.7 questions start here
%sec 6.7 questions start here
...
\موٹا{پتلی سلاخ}\\
\ابتدا{سوال}
ایک بچہ، جس کی کمیت \عددی{\SI{40}{\kilo\gram}}  ہے، اور دوسرا بچہ، جس کی کمیت \عددی{\SI{50}{\kilo\gram}} ہے، ہنڈولا پر جھول رہے ہیں۔ اگر \عددی{\SI{40}{\kilo\gram}}   بچہ چول سے \عددی{\SI{2}{\meter}} فاصلے پر ہو، تب ہنڈولا کو متوازن رکھنے کی خاطر دوسرا بچہ چول سے دوسری جانب کتنے فاصلے پر ہو گا؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{8}{5}\,\si{\meter}$
...
%=================
\ابتدا{سوال}
ایک شہتیر کے سروں کو دو  ترازوؤں پر رکھا جاتا ہے  جو \عددی{\SI{100}{\kilo\gram}} اور \عددی{\SI{20}{\kilo\gram}} کی پیمائش دیتی  ہیں۔ شہتیر کی کمیت کا مرکز کہاں ہو گا؟
\انتہا{سوال}
%=================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_سلاخ_مڑا_الف}
لوہے کی ایک پتلی سلاخ کو وسط سے \عددی{90^{\circ}} زاویہ پر موڑ پر ڈھانچہ بنایا جاتا ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_سلاخ_مڑا_الف})۔ڈھانچے  کی کمیت کا مرکز تلاش کریں۔ (اشارہ۔ انفرادی  بازوؤں   کے مراکز کمیت کہاں ہوں گے؟)
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$(\tfrac{L}{4},\tfrac{L}{4})$
...
لوہے کی ایک پتلی سلاخ کو \عددی{90^{\circ}} پر موڑ کر ڈھانچہ  بنایا جاتا ہے، جہاں ایک بازو کی لمبائی دوسرے بازو کی لمبائی سے دگنی ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_سلاخ_مڑا_ب})۔ ڈھانچے کی کمیت کا مرکز تلاش کریں۔ (اشارہ۔ انفرادی بازوؤں کی کمیت کے مراکز کہاں ہوں گے؟) 
\انتہا{سوال}
%=====================
\begin{figure}
\centering
...
\end{tikzpicture}
\caption{لوہے کا  ڈھانچہ برائے سوال \حوالہ{سوال_تکمل_استعمال_سلاخ_مڑا_الف}}
...
\end{tikzpicture}
\caption{ڈھانچہ برائے سوال \حوالہ{سوال_تکمل_استعمال_سلاخ_مڑا_ب}}
\label{شکل_سوال_تکمل_استعمال_سلاخ_مڑا_ب}
\end{minipage}
\end{figure}
سوال \حوالہ{سوال_تکمل_استعمال_سلاخ_کثافت_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_سلاخ_کثافت_ب} میں محور \عددی{x} کے مختلف وقفوں پر  واقع پتلی سلاخوں کے  کثافتی تفاعل دیے گئے ہیں۔مساوات \حوالہ{مساوات_تکمل_استعمال_مرکز_کمیت_ب} استعمال کرتے ہوئے مبدا کے لحاظ سے سلاخ کا معیار اثر، کمیت،  اور مرکز کمیت تلاش کریں۔
...
سوال \حوالہ{سوال_تکمل_استعمال_چادر_کثافت-الف} تا سوال \حوالہ{سوال_تکمل_استعمال_چادر_کثافت-ب} میں وہ خطہ دیا گیا ہے جہاں مستقل کثافت \عددی{\delta} کی  پتلی چادر  واقع  ہے۔ چادر کی کمیت کا مرکز تلاش کریں۔
...
وہ خطہ جس کی  بالائی سرحد \عددی{y=\tfrac{1}{x^3}}، زیریں سرحد \عددی{y=-\tfrac{1}{x^3}}، بائیں سرحد \عددی{x=1}، اور دائیں  سرحد \عددی{x=a>1} ہیں۔ اس کے علاوہ \عددی{\lim_{a\to\infty}\bar{x}} بھی معلوم کریں۔
\انتہا{سوال}
%=====================
\موٹا{متغیر کثافت کی  پتلی چادریں}\\
\ابتدا{سوال}
...
\ابتدا{جواب}
\wf{\unexpanded{
(الف) \عددی{\tfrac{224\pi}{3}}، (ب) \عددی{\bar{x}=2,\,\bar{y}=0}، (ج)
\begin{center}
\begin{tikzpicture}[declare function={fx(\x)=\x;fy(\x)=4/(sqrt(\x));}]
\begin{axis}[clip=false,view/h=110,small,axis lines=middle,xtick={1,4},ytick={-4,4},ztick={\empty},
xticklabels={\llap{$1$},\rlap{$4$}},yticklabels={$-4$,$4$},enlargelimits=true, xlabel={$x$}, ylabel={$y$},zlabel={$z$}, xlabel style={anchor=west},ylabel style={anchor=east},zlabel style={anchor=south},colormap={}{gray(0cm)=(0.6);gray(1cm)=(0.9);}]
\addplot[thick,domain=1:4,samples y=0]({fx(x)},{fy(x)})node[pos=0.65,above right]{$y=\frac{4}{\sqrt{x}}$};
\addplot[thick,domain=1:4,samples y=0]({fx(x)},{-fy(x)})node[pos=0.65,below right]{$y=-\frac{4}{\sqrt{x}}$};
\addplot[] coordinates {(1,-4)(1,4)};
\addplot[] coordinates {(4,{-fy(4)})(4,{fy(4)})};
\addplot[] coordinates {(2,0)}node[circ]{}node[above]{$(2,0)$};
\end{axis}
\end{tikzpicture}
\end{center}
}}
...
تکون کے  راس سے، راس   کے مخالف ضلع کے وسط تک، قطعہ کو وسطانیہ کہتے ہیں۔ آپ کو یاد ہو گا کہ ضلع سے \عددی{\tfrac{1}{3}} فاصلے  پر وسطانیے  ایک دوسرے کو قطع کرتے ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_وسطانیہ})۔ دکھائیں کہ تکون کا وسطانی مرکز بھی اسی نقطہ پر واقع ہے۔ ایسا کرنے کی خاطر درج ذیل اقدامات کریں۔
\begin{enumerate}[a.]
\item
...
\انتہا{سوال}
%======================
سوال \حوالہ{سوال_تکمل_استعمال_راس_سے_وسطانیہ_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_راس_سے_وسطانیہ_ب} میں  مثلث کے راس دیے گئے ہیں۔ سوال \حوالہ{سوال_تکمل_استعمال_وسطانیہ} کا نتیجہ استعمال کر کر مثلث کا وسطانی مرکز دریافت کریں۔
...
\موٹا{پتلا  تار}\\
\ابتدا{سوال}
مستقل کثافت کا    تار منحنی \عددی{y=\sqrt{x}} پر \عددی{x=0} سے \عددی{x=2} تک واقع ہے۔محور \عددی{x} کے لحاظ سے اس تار کا معیار اثر تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{13\delta}{6}$
...
%================
\ابتدا{سوال}
مستقل کثافت کا  تار منحنی \عددی{y=x^3} پر \عددی{x=0} سے \عددی{x=1} تک واقع ہے۔محور \عددی{x} کے لحاظ سے اس تار کا معیار اثر تلاش کریں۔
\انتہا{سوال}
%================
\ابتدا{سوال}
کثافت  کو \عددی{\delta=k\sin\theta} لیتے ہوئے، جہاں \عددی{k} مستقل ہے، مثال \حوالہ{مثال_تکمل_استعمال_تار_نصف_دائرہ} کو دوبارہ حل کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%================
\ابتدا{سوال}
کثافت کو  \عددی{\delta=1+k\abs{\cos\theta}} لیتے ہوئے، جہاں \عددی{k} مستقل ہے، مثال \حوالہ{مثال_تکمل_استعمال_تار_نصف_دائرہ} کو دوبارہ حل کریں۔
\انتہا{سوال}
%================
\begin{figure}
\centering
...
قابل تفرق مسطح  منحنی کے وسطانی مراکز کے محدد درج ذیل ہوں گے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_کلیات_تصدیق_الف})۔
\begin{align*}
...
قوس \عددی{y=\tfrac{x^2}{4p}} میں \عددی{p>0} کی قیمت جو بھی ہو، شکل \حوالہ{شکل_سوال_تکمل_استعمال_کلیات_تصدیق_پ} میں دکھائے گئے قطع مکافی خطہ  کے وسطانی مرکز کا \عددی{y} محدد \عددی{\bar{y}=\tfrac{3}{5}a} ہو گا۔
\انتہا{سوال}
%=======================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_کلیات_تصدیق_ت}
مستقل کثافت کے  باریک تار سے، محور \عددی{y} کے لحاظ سے تشاکلی، دائری قوس بنائی  جاتی ہے، جس کا مرکز مبدا پر ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_کلیات_تصدیق_ت})۔ اس کے وسطانی مرکز کا \عددی{y} محدد \عددی{\bar{y}=\tfrac{a\sin\alpha}{\alpha}=\tfrac{ac}{s}} ہو گا۔
\انتہا{سوال}
%======================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_کلیات_تصدیق_ب}\ترچھا{گزشتہ سوال کو جاری رکھا گیا ہے}\\
دکھائیں کہ جب \عددی{\alpha} کی قیمت کم ہو تب وسطانی مرکز سے قطعہ \عددی{AB} تک فاصلہ \عددی{d} تقریباً \عددی{\tfrac{2h}{3}} ہو گا۔ایسا درج ذیل اقدامات سے ہو گا۔
\begin{enumerate}[a.]
\item
\begin{enumerate}[1.]
\item
...
\end{enumerate}
\item
آپ \عددی{\alpha=0.2,0.4,0.6,0.8,1} لے کر  مساوات \حوالہ{مساوات_تکمل_استعمال_درکار_وسطانی} کا دایاں ہاتھ حل کر کے دیکھیں کہ \عددی{45^{\circ}} سے بڑے زاویوں کے لیے بھی خلل (یعنی \عددی{d} اور \عددی{\tfrac{2}{3}} میں فرق)  بہت کم ہے۔ 
\end{enumerate}
\انتہا{سوال}

\انتہا{سوالات}
%=====================
%sec 6.7 questions end here
%sec 6.7 questions end here
...
جب کوئی جسم،  جس پر مستقل قوت \عددی{F} عمل کرتی ہو، قوت کی سمت میں سیدھی لکیر پر فاصلہ  \عددی{d} طے  کرے، تب ہم (سائنسی طور پر) کہتے ہیں کہ قوت \عددی{F} اس جسم پر  (ذیل) کام \عددی{W} کرتی ہے۔
\begin{align}\label{مساوات_تکمل_استعمال_کام_مستقل_قوت}
W=Fd
\end{align}
آپ دیکھ سکتے ہیں کہ سائنس میں لفظ \قول{کام } کا معنی روزمرہ زندگی میں استعمال معنی سے مختلف ہے۔ اگر آپ کسی گاڑی کو سڑک پر دھکا لگا کر ایک جگہ سے دوسری جگہ منتقل کریں تب آپ کی روزمرہ خیال کے مطابق آپ نے کام کیا اور مساوات \حوالہ{مساوات_تکمل_استعمال_کام_مستقل_قوت} کے تحت بھی آپ نے کام کیا۔ اس کے برعکس، اگر آپ پورا دن گاڑی کو دھکا لگاتے رہیں لیکن گاڑی اپنی جگہ سے حرکت نہ کرے، تب اگرچہ آپ کا خیال ہو گا کہ آپ نے بہت کام کیا لیکن مساوات \حوالہ{مساوات_تکمل_استعمال_کام_مستقل_قوت} کے تحت آپ نے کوئی کام نہیں کیا۔

مساوات \حوالہ{مساوات_تکمل_استعمال_کام_مستقل_قوت} سے واضح ہے کہ قوت کی اکائی کو فاصلے  کی اکائی سے ضرب دینے سے کام کی اکائی حاصل ہو گی۔ بین الاقوامی نظام اکائی میں قوت کی اکائی نیوٹن \عددی{\si{\newton}} اور فاصلے کی اکائی میٹر \عددی{\si{\meter}} ہے،  لہٰذا اس نظام میں کام کی اکائی نیوٹن میٹر  \عددی{\si{\newton}\cdot\si{\meter}} ہو گی،  جس کو خصوصی نام \اصطلاح{جاول}\فرہنگ{جاول}\حاشیہب{joule}\فرہنگ{joule} دیا گیا ہے اور جس کو \عددی{\si{\joule}} سے ظاہر کیا جاتا ہے۔
...
اگر آپ پانی کی ایسی بالٹی  اٹھائیں جس سے پانی ٹپکتا ہو،  تب لاگو قوت کی قیمت بلندی کے ساتھ تبدیل ہو گی۔ایسی صورت میں قوت کا کلیہ \عددی{W=Fd} تبدیل کرتے ہوئے تکمل کا استعمال ضروری ہو گا جو قوت  کی تبدیلی کا حساب رکھ سکے۔ 

فرض کریں  کہ محور \عددی{x} سے اس لکیر کو ظاہر کرنا ممکن ہے جس پر قوت عمل کرتی ہے اور قوت کی مقدار \عددی{F} کو  فاصلہ \عددی{x} کا استمراری تفاعل تصور کیا جا سکتا ہے۔ ہم وقفہ \عددی{x=a} تا \عددی{x=b} پر قوت کا کام   معلوم کرنا چاہتے ہیں۔  ہم وقفہ \عددی{[a,b]} کی خانہ بندی کرتے ہوئے ہر ذیلی وقفہ \عددی{[x_{k-1},x_k]} میں کوئی نقطہ \عددی{c_k} منتخب کرتے ہیں۔ اگر ذیلی وقفہ چھوٹا ہو، تب \عددی{x_{k-1}} سے \عددی{x_k} تک کے  فاصلے میں  استمراری  قوت \عددی{F} کی تبدیلی (استمراری ہونے کی وجہ سے) بہت کم ہو گی،  جسے رد کیا جا سکتا ہے۔یوں \عددی{x_{k-1}} سے \عددی{x_k} تک حرکت کے دوران کام کی قیمت تخمیناً \عددی{F(c_k)\Delta x_k} ہو گی۔یوں درج ذیل ریمان مجموعہ \عددی{x=a} سے \عددی{x=b} تک قوت \عددی{F} کا کام دے گا۔
\begin{align}
\sum_{k=1}^n F(c_k)\Delta x_k
\end{align}
ہم توقع کرتے ہیں کہ  جیسے جیسے خانہ بندی کا معیار صفر کے قریب تر   پہنچتا ہو، ویسے ویسے یہ تخمین  بہتر سے  بہتر ہو گی، لہٰذا ہم \عددی{x=a} سے \عددی{x=b} تک \عددی{F} کے تکمل کو \عددی{a} سے \عددی{b} تک قوت \عددی{F} کے کام کی تعریف لیتے ہیں۔ 
...
گاؤں میں کنویں سے پانی نکالنے کے لیے بوکا استعمال کیا جاتا ہے۔ کنویں  کی گہرائی \عددی{\SI{20}{\meter}}، خالی بوکے  کی کمیت \عددی{\SI{2}{\kilo\gram}}،  اور رسّی کی کمیت \عددی{\SI{0.1}{\kilo\gram\per\meter}} ہے۔ بوکے  میں ابتدائی طور پر \عددی{\SI{10}{\liter}} پانی ہوتا ہے۔چونکہ بوکے سے پانی رستا ہے، لہٰذا جتنی دیر میں بوکے کو نیچے سے اوپر کھینچا جاتا ہے اتنی دیر میں بوکا خالی ہو جاتا ہے۔ بوکا سے پانی کے اخراج کو مستقل تصور کریں۔ درج ذیل کام معلوم کریں۔ 
\begin{enumerate}[a.]
\item
...
\item
پانی، بوکا، اور رسّی بلند کرنا کا کام۔
\end{enumerate}
\حل
\begin{enumerate}[a.]
\item
\ترچھا{صرف پانی:}\quad
پانی اٹھانے کے لیے  درکار قوت پانی کے وزن کے برابر  ہو گی، جو ابتدا میں \عددی{(10)(9.8)=\SI{98}{\newton}} اور آخر میں صفر ہے۔یوں مبدا کو کنویں  کی تہہ میں رکھتے ہوئے قوت کو
\begin{align*}
...
\item
\ترچھا{صرف بوکا:}\quad
صرف بوکا اٹھانے کے لیے درکار کام مساوات \حوالہ{مساوات_تکمل_استعمال_کام_مستقل_قوت} کے تحت \عددی{(2)(9.8)(20)=\SI{392}{\joule}} ہو گا۔یوں پانی اور بوکا دونوں  اٹھانے کے لیے درکار کام درج ذیل ہو گا۔
\begin{align*}
W=980+392=\SI{1372}{\joule}
\end{align*}
\item
\ترچھا{پانی، بوکا، اور رسّی:}\quad
مبدا سے \عددی{x} بلندی پر پانی، بوکا، اور رسّی کی کمیت کو \عددی{g=\SI{9.8}{\meter\per\second\squared}} سے ضرب دینے سے درج ذیل درکار قوت حاصل ہوتی ہے۔
\begin{align*}
F(x)=\underbrace{(98-4.9x)}_{\text{\RL{پانی کا متغیر وزن}}}+\underbrace{(19.6)}_{\text{\RL{بوکا کا مستقل وزن}}}+\underbrace{(0.1)(9.8)(20-x)}_{\text{\RL{رسّی کا متغیر وزن}}}
\end{align*}
صرف رسّی کو اوپر کھینچنے کا کام درج ذیل ہو گا۔
\begin{align*}
W&=\int_0^{20}(0.1)(9.8)(20-x)\dif x=\int_0^{20}(19.6-0.98x)\dif x\\
&=\big[19.6x-\frac{0.98x^2}{2}\big]_0^{20}=392-196=\SI{196}{\joule}
\end{align*}
یوں پانی، بوکا،  اور رسّی تینوں کو کھینچنے کے لیے درکار کام درج ذیل ہو گا۔
\begin{align*}
...
\اصطلاح{قانون ہک}\فرہنگ{قانون!ہک}\حاشیہب{Hooke's law}\فرہنگ{law!Hooke's} کے تحت  کسی بھی اسپرنگ کی قدرتی لمبائی کو تان کر یا دبا کر \عددی{x} اکائیاں تبدیل کرنے کے لیے  درکار قوت \عددی{F}  لمبائی \عددی{x} کے راست متناسب ہو گی۔
\begin{align}\label{مساوات_تکمل_استعمال_قانون_ہک}
F&=kx    &&\text{\RL{قانون ہک}} 
\end{align} 
\اصطلاح{مستقلہ اسپرنگ}\فرہنگ{مستقلہ اسپرنگ} \عددی{k} جو اسپرنگ کی خاصیت ہے کو \اصطلاح{مقیاس لچک}\فرہنگ{مقیاس لچک}\حاشیہب{spring constant}\فرہنگ{spring constant} کہتے ہیں۔ مقیاس لچک کو قوت فی اکائی لمبائی میں ناپا جاتا ہے۔ جب تک لاگو قوت اسپرنگ کے  دھاتی تار کو بگاڑ نہ دے قانون ہک (مساوات \حوالہ{مساوات_تکمل_استعمال_قانون_ہک}) بہترین نتائج دیتا ہے۔ اس حصہ میں ہم فرض کرتے ہیں کہ لاگو قوت اسپرنگ کو خراب نہیں کرتی۔

\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_تان_اسپرنگ_الف}
ایک اسپرنگ،  جس کا مقیاس لچک \عددی{k=\SI{8}{\newton\per\meter}} ہے، کی لمبائی  \عددی{\SI{1}{\meter}} سے تبدیل کر کے  \عددی{\SI{0.8}{\meter}}  کی جاتی ہے۔ درکار کام تلاش کریں۔

\حل
ہم اسپرنگ کو محور \عددی{x} پر پڑا ہوا تصور کرتے ہیں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_تان_اسپرنگ_الف})۔ اسپرنگ کا ایک سر مبدا پر ہے،  جبکہ اس کا دوسرا سر \عددی{x=1} پر  باندھا  گیا  ہے۔ یوں ہم قوت کو \عددی{F=8x} لکھ سکتے ہیں، جہاں \عددی{x} کی قیمت \عددی{0} تا \عددی{\SI{0.2}{\meter}} ہو گی۔ درکار کام درج ذیل ہو گا۔
\begin{align*}
...
\caption{}
\end{subfigure}
\caption{اسپرنگ کی لمبائی میں تبدیلی اور قوت کے درمیان راست تناسب ہے۔}
\label{شکل_مثال_تکمل_استعمال_تان_اسپرنگ_الف}
\end{figure}
\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_تان_اسپرنگ_ب}
ایک اسپرنگ، جس کی قدرتی لمبائی \عددی{\SI{1}{\meter}} ہے، کو \عددی{\SI{24}{\newton}} قوت سے تان کر  اس کی لمبائی \عددی{\SI{1.8}{\meter}}  کی جاتی ہے۔
\begin{enumerate}[a.]
\item
مقیاس لچک \عددی{k} تلاش کریں۔
\item
اسپرنگ کی لمبائی کو  قدرتی لمبائی سے \عددی{\SI{2}{\meter}}  بڑھانے کے لیے درکار کام تلاش کریں۔
\item
...
\item
\ترچھا{کام:}\quad
ہم اسپرنگ کو چھت سے یوں آویزاں تصور کرتے ہیں کہ اس کا آزاد سر \عددی{x=0} پر ہو (\حوالہ{شکل_مثال_تکمل_استعمال_تان_اسپرنگ_ب})۔اسپرنگ کی لمبائی کو اس کی  قدرتی لمبائی سے \عددی{x} میٹر زیادہ کرنے کے لیے درکار قوت \عددی{F=kx} ہو گی، جو اسپرنگ کو نیچے رخ کھینچے گی۔یوں \عددی{x=0} سے \عددی{x=\SI{2}{\meter}} تک کھینچنے کے لیے کام درج ذیل ہو گا۔
\begin{align*}
...
\end{align*}
یوں اسپرنگ کی کُل لمبائی \عددی{1+1.5=\SI{2.5}{\meter}} ہو گی۔
\end{enumerate}
\انتہا{مثال}
%================
\begin{figure}
...
کسی برتن یا حوض سے پانی کی نکاسی کے لیے  کتنا کام درکار ہو گا؟ ہم پانی کو افقی تہوں میں تقسیم کرتے ہوئے ایک ایک تہہ کو برتن سے باہر نکالتے ہیں۔یوں، اگر تہہ کی موٹائی \عددی{\dif y} اور اس کا  سطحی رقبہ \عددی{S} ہو، تب اس کی کمیت \عددی{\rho S\dif y} اور وزن \عددی{\rho S g \dif y} ہو گا،  جہاں پانی کی کثافت کو \عددی{\rho} اور کشش ثقل کو \عددی{g} سے ظاہر کیا گیا ہے۔ اس تہہ کو بلندی \عددی{h} تک منتقل کرنے کے لیے  \عددی{\dif W=Fh=\rho S g  h \dif y} کام  درکار  ہو گا۔یوں تمام تہوں کو نکالنے کے لیے درکار کام  جاننے کے لیے  تکمل حل کرنا ہو گا۔  اگلی  مثال میں ایک ٹھوس مثال پیش کی گئی ہے۔

\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_نکاسی_پانی}
پانی سے بھرے ہوئے ایک بیلنی حوض کا رداس \عددی{\SI{5}{\meter}} اور قد \عددی{h=\SI{10}{\meter}} ہے۔ پانی کو \عددی{\SI{14}{\meter}} بلندی تک منتقل کرنے کے  لیے  کتنا کام کرنا ہو گا؟
...
\end{align*}
ہو گی، جہاں پانی کی کثافت \عددی{\rho=\SI{1000}{\kilo\gram\per\meter\cubed}} ہے۔ اس تہہ پر کشش ثقل کی وجہ سے نیچے رخ  قوت عمل کرے گی، لہٰذا اس تہہ کو اٹھانے کی خاطر تہہ کے وزن کے برابر (درج ذیل) قوت \عددی{F} درکار ہو گی۔
\begin{align*}
F=(g)(\dif M) =(9.8)(\num{25000}\pi \Delta y)=\num{245000}\pi\Delta y \,\si{\newton}
\end{align*}
یوں اس تہہ کو \عددی{y}  بلندی سے \عددی{\SI{14}{\meter}}  بلندی تک اٹھانے کے لیے درج ذیل کام کرنا ہو گا۔
\begin{align*}
\dif W=(\text{قوت})(\text{فاصلہ})=(\num{245000}\pi)(14-y)\Delta y\,\si{\joule}
\end{align*}
تمام پانی کو اس بلندی تک اٹھانے کے لیے تخمیناً 
\begin{align*}
W\approx \sum_0^{10}\Delta W=\sum_0^{10}\Delta y\,\si{\joule}
\end{align*}
کام کرنا ہو گا،  جو وقفہ \عددی{0\le y\le 10} پر تفاعل \عددی{\num{245000}\pi(14-y)} کا ریمان مجموعہ ہے۔ حوض خالی کرنے کے لیے درکار کام  \عددی{\norm{P}\to 0} کی صورت میں اس ریمان مجموعے کی    حد ہو گی۔
\begin{align*}
...
\end{align*}
ایک کلو واٹ طاقت کے بجلی کا پمپ ایک سیکنڈ میں \عددی{\SI{1000}{\joule}} کام کرتا ہے۔اس پمپ کو یہ حوض خالی کرنے کے لیے تقریباً \عددی{19} گھنٹے اور \عددی{15} منٹ کا وقت درکار ہو گا۔
\انتہا{مثال}
%========================
\begin{figure}
\centering
...
\end{tikzpicture}
\caption{زیتون تیل کا مخروط حوض (مثال \حوالہ{مثال_تکمل_استعمال_مخروط_حوض})}
\label{شکل_مثال_تکمل_استعمال_مخروط_حوض}
\end{minipage}
\end{figure}
\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_مخروط_حوض}
ایک مخروط حوض،  جس کو شکل \حوالہ{شکل_مثال_تکمل_استعمال_مخروط_حوض} میں دکھایا گیا ہے، کنارے سے \عددی{\SI{0.5}{\meter}} نیچے تک  زیتون کے تیل  سے بھرا ہوا ہے۔ زیتون کے  تیل کی کثافت \عددی{\rho=\SI{930}{\kilo\gram\per\meter\cubed}} ہے۔ تیل کو حوض کے کنارے تک پمپ کرنے کے لیے کتنا کام درکار ہو گا؟
...
\end{align*}
اس تہہ کو اٹھانے کے لیے اس تہہ کے  وزن کے برابر قوت \عددی{F(y)} درکار ہو گی۔
\begin{align*}
F(y)=\rho g \Delta H=(930)(9.8)\big(\frac{\pi}{4}y^2\Delta y\big)=\frac{9114\pi}{4}y^2\Delta y\,\si{\newton}
\end{align*}
حوض کے کنارے سے اس تہہ تک کا فاصلہ \عددی{3.5-y} ہے، لہٰذا اس تہہ کو حوض کے کنارے تک اٹھانے کے لیے درج ذیل کام درکار ہو گا۔
\begin{align*}
\Delta W=\frac{9114\pi}{4}(3.5-y)y^2\Delta y\,\si{\joule}
\end{align*}
\عددی{y=0} سے \عددی{y=3} تک تمام تہوں کو حوض کے کنارے تک اٹھانے کے لیے تخمیناً
\begin{align*}
W\approx\sum_0^{3}\frac{9114\pi}{4}(3.5-y)y^2\Delta y\,\si{\joule}
\end{align*}
کام درکار ہو گا، جو وقفہ \عددی{[0,3]} پر تفاعل \عددی{\frac{9114\pi}{4}(3.5-y)y^2} کا ریمان مجموعہ ہے۔ تیل کو حوض کے کنارے تک پمپ کرنے کے لیے درکار کام، خانہ بندی کا معیار صفر تک کرنے سے حاصل، ریمان مجموعے کی حد ہو گا۔
\begin{align*}
...
\ابتدا{سوال}
اگر مثال \حوالہ{مثال_تکمل_استعمال_کنواں_اور_بوکا} میں بوکے  کا حجم \عددی{\SI{20}{\liter}} ہو لیکن اس میں سوراخ بھی بڑا ہو تا کہ اب بھی  بوکے کو کنواں سے نکالتے ہوئے بوکا خالی ہو جاتا ہو۔ بوکے  اور رسّی کی کمیت کو شامل نہ کرتے ہوئے  بوکا نکالنے کے لیے درکار کام دریافت کریں۔بوکے  سے پانی کے اخراج  کی شرح کو مستقل تصور کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{1960}{\joule}$
...
%====================
\ابتدا{سوال}
فرض کریں  مثال \حوالہ{مثال_تکمل_استعمال_کنواں_اور_بوکا} میں بوکے  کو اس رفتار سے اوپر کھینچا جاتا ہے کہ آخر میں بوکے میں \عددی{\SI{4}{\liter}} پانی ہوتا ہے۔ پانی نکالنے میں کتنا کام درکار ہو گا؟  بوکا اور رسّی کی کمیت کو شامل نہ کریں اور بوکے سے پانی کے اخراج  کی شرح کو مستقل تصور کریں۔\\
\انتہا{سوال}
%==================
\ابتدا{سوال}
ایک کوہ پیما چٹان سے لٹکی ہوئی \عددی{\SI{50}{\meter}} رسّی کو اوپر کھینچتا ہے۔ رسّی کا  وزن \عددی{\SI{0.624}{\newton\per\meter}} ہے۔ کتنا کام درکار ہو گا؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{780}{\joule}$
...
%=====================
\ابتدا{سوال}
ریت کو تھیلے میں ڈال کر \عددی{\SI{6}{\meter}} بلند چھت تک برقرار رفتار سے کھینچ کر پہنچایا جاتا ہے۔ تھیلے میں سوراخ سے ریت کا اخراج ہوتا ہے جس کی شرح  کو مستقل تصور کیا جا سکتا ہے۔  ابتدائی طور پر تھیلے  میں \عددی{\SI{50}{\kilo\gram}} ریت  ہوتی ہے جو  آخر میں آدھی رہ جاتی ہے۔ رسّی اور تھیلے کی کمیت کو نظر انداز کرتے ہوئے درکار کام معلوم کریں۔
\انتہا{سوال}
%==================
\ابتدا{سوال}
آج کل، بالخصوص بلند  عمارتوں میں، سیڑھیوں کے ساتھ ساتھ  \اصطلاح{مصعد}\حاشیہب{lift} بھی پائے جاتے ہیں۔ مصعد کو چھت پر رکھی  ہوئی موٹر کی طاقت سے چلایا جاتا ہے۔  کئی لڑیوں پر مشتمل رسّی کی کثافت \عددی{\SI{6}{\kilo\gram\per\meter}} ہونے کی صورت میں صرف رسّی کو زمین سے  \عددی{\SI{60}{\meter}} بلند عمارت کی چھت تک اٹھانے میں موٹر کتنا کام کرے گی؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{1764}{\joule}$
...
%=====================
\ابتدا{سوال}
نقطہ \عددی{(x,0)} پر واقع ذرہ، جس کی کمیت \عددی{m} ہے، پر قوت \عددی{F=\tfrac{k}{x^2}} عمل کرتی ہے، جہاں \عددی{k} مستقل ہے۔ یہ ذرہ سکون سے شروع  کر کے   نقطہ \عددی{b} سے نقطہ \عددی{a} پہنچتا ہے، جہاں \عددی{0<a<b} ہیں۔ اس ذرے پر کتنا کام ہوا؟
\انتہا{سوال}
%==================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_انجن}
ایک بیلن، جس کا رقبہ عمودی تراش \عددی{S} ہے، میں  پائے جانے والی گیس پر میکانی دباؤ ڈالا جاتا ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_انجن})۔ اگر گیس کا حجم \عددی{V} اور اس کا دباؤ \عددی{p} ہو، تب دکھائیں کہ گیس کو \عددی{(p_1,V_1)} حال سے \عددی{(p_2,V_2)} حال تک پہنچانے میں درج ذیل  کام درکار ہو گا؟  
\begin{align*}
W=\int_{(p_1,V_1)}^{(p_2,V_2)}p\dif V
\end{align*}
(اشارہ: شکل \حوالہ{شکل_سوال_تکمل_استعمال_انجن} کو دیکھ کر بوکے پر قوت کو \عددی{F=pS} اور چھوٹے حجم کو \عددی{\dif V=S\dif x} لکھا جا سکتا ہے۔)
\انتہا{سوال}
%=====================
\begin{figure}
\centering
...
\end{tikzpicture}
\caption
{گاڑی کا انجن  ایک بیلن پر مشتمل ہوتا ہے، جس میں بوکا چلتا ہے۔ بوکے کی حرکت سے گیس کا حجم اور دباؤ تبدیل ہوتے ہیں (سوال \حوالہ{سوال_تکمل_استعمال_انجن})۔}
\label{شکل_سوال_تکمل_استعمال_انجن}
\end{figure}

\ابتدا{سوال}
اگر گیس کا ابتدائی حجم \عددی{V_1=\SI{1500}{\centi\meter\cubed}}، ابتدائی دباؤ \عددی{\SI{103360}{\newton\per\meter\squared}}، اور اختتامی حجم \عددی{\SI{200}{\centi\meter\cubed}} ہو، تب سوال \حوالہ{سوال_تکمل_استعمال_انجن} کے تکمل سے کام دریافت کریں۔ یہاں آپ فرض کریں کہ گیس کا دباؤ ایک \اصطلاح{حرارت نا گزر عمل}\فرہنگ{حرارت نا گزر عمل}\حاشیہب{adiabatic process}\فرہنگ{adiabatic process} ہے، جس میں نظام اور ماحول کے درمیان حرارت کا تبادلہ نہیں ہوتا۔ حرارت نا گزر عمل کے قانون کے تحت \عددی{pV^{1.4}=c} ہو گا، جہاں \عددی{c} مستقل ہے۔ 
\انتہا{سوال}
%======================
\موٹا{اسپرنگ}\\
\ابتدا{سوال}
ایک اسپرنگ، جس کی قدرتی لمبائی \عددی{\SI{2}{\meter}} ہے، کی لمبائی کو \عددی{\SI{5}{\meter}} بنانے کے لیے درکار کام \عددی{\SI{1800}{\joule}} ہے۔ اس اسپرنگ کا مقیاس لچک تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{400}{\newton\per\meter}$
...
%==================
\ابتدا{سوال}
ایک اسپرنگ، جس کی قدرتی لمبائی \عددی{\SI{30}{\centi\meter}} ہے، پر \عددی{\SI{400}{\newton}} قوت لاگو کرتے ہوئے اس  کو کھینچ کر \عددی{\SI{45}{\centi\meter}} لمبائی تک پہنچایا جاتا ہے۔ (ا) مقیاس لچک تلاش کریں۔ (ب) اسپرنگ کی لمبائی کو \عددی{\SI{35}{\centi\meter}} کرنے کے لیے کتنی قوت درکار ہو گی؟ (ج) قدرتی لمبائی سے \عددی{\SI{600}{\newton}} قوت اسپرنگ کی لمبائی کو کتنا زیادہ کرتی ہے؟
\انتہا{سوال}
%====================
\ابتدا{سوال}
...
%=====================
\ابتدا{سوال}
اگر \عددی{\SI{90}{\newton}} کی قوت اسپرنگ کی لمبائی کو قدرتی لمبائی سے \عددی{\SI{1}{\meter}} زیادہ کرتی ہو، تب اسپرنگ کی قدرتی لمبائی سے اس کی لمبائی کو \عددی{\SI{5}{\meter}} زیادہ کرنے کے لیے کتنا کام درکار ہو گا؟
\انتہا{سوال}
%===============
\ابتدا{سوال}
ریل گاڑی کے ڈبوں پر نصب اسپرنگ ان ڈبوں کو ایک دوسرے سے دور رکھتے ہیں اور ان کے  ٹکراؤ کو محفوظ بناتے ہیں۔ ایسا ایک اسپرنگ، جس کی قدرتی لمبائی \عددی{\SI{20}{\centi\meter}} ہے، پر \عددی{\SI{100000}{\newton}} کی قوت  لاگو کرنے سے اسپرنگ کی لمبائی \عددی{\SI{12}{\centi\meter}}  ہو جاتی ہے۔ (ا) اسپرنگ کا مقیاس لچک تلاش کریں۔ (ب) اسپرنگ کو پہلا \عددی{\si{\centi\meter}} دبانے کے لیے کتنا کام درکار ہو گا۔ اسے  دوسرا سنٹی میٹر دبانے کے لیے کتنا کام درکار ہو گا؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%=================
\ابتدا{سوال}
گھریلو استعمال کی ترازو پر \عددی{\SI{74}{\kilo\gram}} کا شخص کھڑا ہونے سے ترازو \عددی{\SI{1.5}{\milli\meter}}  دبتی ہے۔ فرض کریں کہ یہ ترازو قانون ہک کے تحت کام کرتی ہے۔ ایک شخص، جس کے  ترازو پر کھڑا ہونے سے ترازو \عددی{\SI{3}{\milli\meter}} دبتی  ہو، کا وزن کتنا ہو گا؟
\انتہا{سوال}
%====================
\موٹا{پانی کی نکاسی}\\
ثقلی اسراع کی قیمت عموماً \عددی{g=\SI{9.8}{\meter\per\second\squared}} لی جاتی ہے۔ حقیقت میں سطح سمندر پر اس کی قیمت قطبین پر \عددی{\SI{9.832}{\meter\per\second\squared}} اور  عرضی خط استوا پر \عددی{\SI{9.780}{\meter\per\second\squared}} ہے۔ ان دو قیمتوں میں فرق تقریباً \عددی{\SI{0.5}{\percent}} ہے۔

\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_حوض_زیر_زمین_الف}
بارانی علاقوں میں بارش کے پانی کو زیر زمین حوض میں ذخیرہ کیا جاتا ہے۔ زیر زمین حوض،  جس کو شکل \حوالہ{شکل_سوال_تکمل_استعمال_حوض_زیر_زمین_الف} میں دکھایا گیا ہے،  پانی سے بھرا ہوا ہے۔ حوض کو خالی کرتے ہوئے  پانی کو سطح زمین پر لایا جاتا ہے۔(ا) حوض کو خالی کرنے کے لیے کتنا کام کرنا ہو گا؟ (ب)  \عددی{\SI{0.25}{\kilo\watt}} کا پمپ حوض کو کتنی دیر میں خالی کرے گا؟ (ج) دکھائیں کہ ابتدائی \عددی{5} گھنٹوں میں تقریباً آدھا حوض خالی ہو جائے گا۔ (د) خط استوا پر جزو-ب کا جواب کیا ہو گا؟ قطبین پر یہ جواب کیا ہو گا؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_حوض_زیر_زمین_ب}
 زیر زمین حوض،  جس کو شکل \حوالہ{شکل_سوال_تکمل_استعمال_حوض_زیر_زمین_ب} میں دکھایا گیا ہے، پانی سے بھرا ہوا ہے۔ حوض کا کنارہ سطح زمین سے \عددی{\SI{4}{\meter}} نیچے ہے۔ حوض کو خالی کرتے ہوئے  پانی کو سطح زمین پر لایا جاتا ہے۔(ا) حوض کو خالی کرنے کے لیے کتنا کام کرنا ہو گا؟ (ب)  \عددی{\SI{0.25}{\kilo\watt}} کا پمپ حوض کو کتنی دیر میں خالی کرے گا؟ (ج) آدھا حوض کتنی دیر میں خالی ہو گا؟ (پورا حوض خالی کرنے کے نصف دورانیہ سے کم وقت درکار ہو گا)۔ (د) خط استوا پر جزو-ب کا جواب کیا ہو گا؟ قطبین پر یہ جواب کیا ہو گا؟\\
\انتہا{سوال}
%======================
\ابتدا{سوال}
اگر حوض کے کنارے سے \عددی{\SI{4}{\meter}} بلند کے بجائے حوض کے کنارے تک پانی کو اٹھایا جائے تب مثال \حوالہ{مثال_تکمل_استعمال_نکاسی_پانی} میں کتنا کام درکار ہو گا؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{38484510}{\joule}$
...
%======================
\ابتدا{سوال}
اگر مثال \حوالہ{مثال_تکمل_استعمال_نکاسی_پانی} میں حوض آدھا بھرا ہو، تب حوض کے کنارے سے \عددی{\SI{4}{\meter}} بلندی تک پانی کو پہنچانے کے لیے کتنا کام کرنا ہو گا؟
\انتہا{سوال}
%======================
\ابتدا{سوال}
ایک بیلنی حوض،  جس کا رداس \عددی{\SI{4}{\meter}} اور قد \عددی{\SI{10}{\meter}} ہے، مٹی کے تیل سے بھرا ہوا ہے۔ مٹی کے تیل کی کثافت \عددی{\SI{0.81}{\gram\per\centi\meter}} ہے۔ تمام تیل کو حوض کے بالائی کنارے تک پمپ  کرنے کے لیے کتنا کام کرنا ہو گا؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{19.95e6}{\joule}$
...
ایک مشروب،  جس کی کثافت \عددی{\SI{0.769}{\gram\per\centi\meter\cubed}} ہے،  سے مخروط  مقطوع ڈبیا  بھری  ہوئی ہے (\حوالہ{شکل_سوال_مخروط_ڈبیا})۔اس ڈبیا کا بالائی رداس \عددی{\SI{4.5}{\centi\meter}}، زیریں رداس \عددی{\SI{3}{\centi\meter}}،  اور گہرائی \عددی{\SI{15}{\centi\meter}} ہے۔ مشروب کو چسنا کے ذریعہ پیا جاتا ہے جو ڈبیا کی بالائی سطح سے \عددی{\SI{2.5}{\centi\meter}} باہر نکلا ہوا ہے۔ پورا مشروب پینے کے لیے کتنا کام کرنا ہو گا؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{0.43}{\joule}$
...
%=======================
\ابتدا{سوال}
فرض کریں مثال \حوالہ{مثال_تکمل_استعمال_مخروط_حوض} میں مخروط حوض دودھ سے بھرا ہوا ہے، جس کی کثافت \عددی{\SI{1032}{\kilo\gram\per\meter\cubed}} ہے۔ (ا) دودھ کو حوض کے کنارے تک پمپ کرنے کے لیے کتنا کام درکار ہو گا؟  (ب) دودھ کو حوض کے کنارے سے \عددی{\SI{1}{\meter}} بلندی تک پمپ کرنے کے لیے کتنا کام درکار ہو گا؟
\انتہا{سوال}
%====================
\ابتدا{سوال}
\اصطلاح{زنگ مزاحم  فولاد}\فرہنگ{فولاد!زنگ مزاحم}\حاشیہب{stainless steel}\فرہنگ{stainless steel} کا بڑا حوض بنانے کے لیے آپ  منحنی \عددی{y=x^2,0\le x\le\SI{4}{\meter}} کو محور \عددی{y} کے گرد گھماتے ہیں۔ یہ حوض سمندری پانی سے بھرا ہوا ہے، جس کی کثافت تقریباً  \عددی{\SI{10000}{\newton\per\meter\cubed}} ہے۔ حوض کو خالی کرنے کی خاطر   پانی کو حوض کے کنارے تک پمپ کرنے کے لیے کتنا کام کرنا ہو گا؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{21446605.9}{\joule}$
...
نصف کروی حوض، جس کا رداس \عددی{\SI{5}{\meter}} ہے،  پانی سے بھرا ہوا ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_نصف_کروی_حوض_الف})۔ پانی کو حوض کے بالائی کنارے سے \عددی{\SI{4}{\meter}} بلندی تک پمپ کرنے کے لیے کتنا کام درکار ہو گا؟ پانی کی کثافت کو \عددی{\SI{9800}{\newton\per\meter\cubed}} لیں۔
\انتہا{سوال}
%====================
\begin{figure}
\centering
...
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_نصف_کروی_حوض_ب}
 \اصطلاح{بنزین}\حاشیہب{benzene} سے بھرا ہوا  نصف کروی حوض، جس کا رداس \عددی{\SI{4}{\meter}} ہے، کو شکل \حوالہ{شکل_سوال_تکمل_استعمال_نصف_کروی_حوض_ب} میں دکھایا گیا ہے۔  بنزین کی کثافت \عددی{\SI{876}{\kilo\gram\per\meter\cubed}} ہے۔ حوض کو خارجی نل، جو حوض کے بالائی سطح سے \عددی{\SI{1}{\meter}} بلندی پر ہے، کے ذریعے خالی کرنے کے لیے کتنا کام کرنا ہو گا؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{4027512}{\joule}$
...
%=========================
\ابتدا{سوال}
آپ کے گاؤں میں پانی کی فراہمی کے لیے  \عددی{\SI{8}{\meter}} قد کا   حوض تعمیر کیا جاتا ہے، جس کا تلا زمین سے \عددی{\SI{20}{\meter}} بلندی پر ہے۔ زیر زمین پانی کی سطح \عددی{\SI{100}{\meter}} نیچے ہے۔ پانی کو \عددی{\SI{10}{\centi\meter}} رداس کے پائپ سے \عددی{\SI{3}{\kilo\watt}} پمپ کی مدد سے  حوض کے  تلے میں نل کے ذریعے بھرا جاتا ہے۔ خالی حوض کتنی دیر میں بھرے گا؟ (پائپ کو پانی سے بھرنے کے لیے درکار وقت کو نظر انداز کریں۔) 
\انتہا{سوال}
%=======================
\موٹا{دیگر استعمال}\\
\ابتدا{سوال}\ترچھا{مصنوعی سیارے کا خلائی مدار میں بھیجنا}\\
کشش ثقل کی قیمت زمین کے مرکز سے فاصلہ \عددی{r} پر منحصر ہوتی ہے۔ کمیت \عددی{m} کے مصنوعی سیارے پر کشش ثقل درج ذیل ہو گی
\begin{align*}
F=\frac{GMm}{r^2}
\end{align*} 
جہاں زمین کی کمیت \عددی{M=\SI{5.975e24}{\kilo\gram}} ہے،  جبکہ تجاذبی مستقل \عددی{G=\SI{6.6720e-11}{\newton\meter\squared\per\kilo\gram\squared}} ہے۔ زمین کا رداس \عددی{\SI{6370000}{\meter}} ہے۔ یوں سطح  زمین   سے  \عددی{\SI{29410}{\kilo\meter}} بلندی پر مدار تک \عددی{\SI{1000}{\kilo\gram}} مصنوعی سیارے کو منتقل کرنے کے لیے درج ذیل  کام درکار ہو گا۔
\begin{align*}
W=\int_{\num{6370000}}^{\num{35780000}}\frac{1000MG}{r^2}\dif r
\end{align*}
حقیقت میں مصنوعی سیارہ ایک راکٹ پر نصب ہو گا، جس کو یہاں نظر انداز کیا گیا ہے۔ اس تکمل کی قیمت تلاش کریں۔ تکمل کی  زیریں حد سطح زمین کو ظاہر کرتی ہے، جہاں سے سیارہ روانہ ہو گا۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{5.144e10}{\joule}$
...
\انتہا{جواب}
%====================
\ابتدا{سوال}\ترچھا{برقیوں (الیکٹرانوں) کو ایک دوسرے کے قریب لانا۔}
دو  برقیے، جن کے بیچ فاصلہ \عددی{r} ہو، کے مابین درج ذیل قوت دفع پائی جاتی ہے،  جہاں \عددی{\epsilon_0=\SI{8.85e-12}{\farad\per\meter}} برقی مستقل ہے اور \عددی{e=\SI{-1.602e-19}{\coulomb}} \اصطلاح{برقیہ}\فرہنگ{برقیہ}\حاشیہب{electron}\فرہنگ{electron} کا \اصطلاح{بار}\فرہنگ{بار}\حاشیہب{charge}\فرہنگ{charge!electron} ہے۔
  \begin{align*}
F=\frac{e^2}{4\pi\epsilon_0 r^2}
\end{align*}
\begin{enumerate}[a.]
\item
فرض کریں کہ ایک برقیہ نقطہ \عددی{(1,0)} پر واقع ہے، جبکہ دوسرے برقیے کو محور \عددی{x} پر نقطہ \عددی{(-1,0)} سے مبدا تک منتقل کیا جاتا ہے۔ ایسا کرنے کے لیے کتنا کام کرنا ہو گا؟
\item
فرض کریں ایک برقیہ  \عددی{(1,0)} اور دوسرا \عددی{(-1,0)} پر واقع ہے۔ تیسرے برقیے  کو \عددی{(5,0)} سے \عددی{(3,0)} تک منتقل کرنے کے لیے کتنی توانائی درکار ہو گی؟
\end{enumerate}
\انتہا{سوال}
%==================
\موٹا{کام اور حرکی توانائی}\\
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_حرکی_توانائی_تعریف}
 متغیر قوت \عددی{F(x)} ایک جسم،  جس کی کمیت \عددی{m} ہے، کو محور \عددی{x} پر  \عددی{x_1} سے \عددی{x_2} تک  منتقل کرتی ہے۔ جسم کی سمتی رفتار \عددی{v} کو \عددی{\tfrac{\dif x}{\dif t}} لکھا جا سکتا ہے۔ قانون نیوٹن \عددی{F=m\tfrac{\dif v}{\dif t}} اور زنجیری قاعدہ
\begin{align*}
\frac{\dif v}{\dif t}=\frac{\dif v}{\dif x}\frac{\dif x}{\dif t}=v\frac{\dif v}{\dif x}
\end{align*}
کو استعمال کرتے ہوئے  دکھائیں کہ  جسم کو \عددی{x_1} سے \عددی{x_2} منتقل کرنے میں درج ذیل کام درکار ہو گا
\begin{align*}
W=\int_{x_1}^{x_2} F(x)\dif x=\frac{1}{2}mv_2^2-\frac{1}{2}mv_1^2
\end{align*}
جہاں \عددی{x_1} پر جسم کی رفتار \عددی{v_1} اور \عددی{x_2} پر اس کی رفتار \عددی{v_2} ہے۔ طبیعیات  میں \عددی{\tfrac{1}{2}mv^2} کو رفتار \عددی{v} سے چلنے والے جسم کی \اصطلاح{حرکی توانائی}\فرہنگ{توانائی!حرکی}\حاشیہب{kinetic energy}\فرہنگ{energy!kinetic} کہتے ہیں۔ یوں کسی جسم کی حرکی توانائی میں تبدیلی اس جسم پر کیے گئے کام کے برابر ہو گی۔
\انتہا{سوال}
%====================
...
%==================
\ابتدا{سوال}
ایک سائیکل سوار بمع سائیکل کی کمیت \عددی{\SI{80}{\kilo\gram}} ہے۔ ساکن حالت  سے \عددی{\SI{40}{\kilo\meter\per\hour}} کی رفتار تک پہنچنے کے لیے کتنی توانائی درکار ہو گی؟
\انتہا{سوال}
%======================
\ابتدا{سوال}
ایک گاڑی،  جس کی کمیت \عددی{\SI{880}{\kilo\gram}} ہے، کی رفتار \عددی{\SI{40}{\kilo\meter\per\hour}} سے بڑھ کر \عددی{\SI{60}{\kilo\meter\per\hour}} کرنے کے لیے کتنی توانائی درکار ہو گی؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{67901}{\joule}$
...
\انتہا{سوالات}
%======================
%sec 6.8 questions end here
%sec 6.8 questions end here



\حصہ{فشار سیال اور قوت سیال}
فشار \عددی{p} سے مراد وہ قوت ہے جو اکائی رقبہ پر عمل کرتی ہے۔ یوں اگر رقبہ \عددی{S} پر قوت \عددی{F} عمل کرتی ہو تب فشار \عددی{p} درج ذیل ہو گا۔
\begin{align}\label{مساوات_تکمل_استعمال_فشار_اور_قوت}
p=\frac{F}{S}
\end{align}
\جزوحصہء{مستقل گہرائی پر قوت سیال اور فشار سیال}
 شکل \حوالہ{شکل_تکمل_استعمال_فشار_سیال_تعریف} میں ساکن سیال کو ایک برتن میں دکھایا گیا ہے، جہاں تل کا رقبہ \عددی{S}، سیال کی گہرائی \عددی{h} اور  سیال کی کثافت \عددی{\rho} ہے۔ یوں سیال کا حجم \عددی{Sh}،  کمیت \عددی{\rho Sh}،  اور وزن \عددی{g\rho Sh} ہو گا۔ سیال کے وزن کے برابر قوت \عددی{F=g\rho Sh} رقبہ \عددی{S} پر عمل کرے گی۔ یوں اکائی رقبے  پر قوت \عددی{g\rho h} ہو گی،  جس کو \اصطلاح{فشار}\فرہنگ{فشار}\حاشیہب{pressure}\فرہنگ{pressure} \عددی{p} یا \قول{دباؤ} کہتے ہیں۔
\begin{align}\label{مساوات_تکمل_استعمال_فشار_سیال_الف}
p&=\rho g h
\end{align}
فشار کی اکائی  نیوٹن فی مربع میٹر \عددی{\si{\newton\per\meter\squared}} ہے۔ آپ نے دیکھا کہ فشار  کی قیمت پر برتن کی صورت کا کوئی اثر نہیں پایا جاتا۔

 مستقل گہرائی کے رقبے  \عددی{S} پر درج ذیل قوت پائی جائے گی۔
\begin{align}
F=pS
\end{align}
%
...
سیال میں \عددی{h} گہرائی پر کسی بھی رخ فشار کی قیمت  مساوات \حوالہ{مساوات_تکمل_استعمال_فشار_سیال_الف} دیتی ہے۔ یوں کسی بھی گہرائی پر افقی اور  انتصابی دیواروں پر فشار کی قیمت ایک  جیسی ہو گی۔ 
...
\end{align*}
ہے لہٰذا اس پر کُل قوت درج ذیل ہو گی۔
\begin{align*}
...
اس مثال میں پٹی کے نچلے حصے کی گہرائی \عددی{\SI{40}{\meter}} اور بالائی حصے کی گہرائی \عددی{\SI{39}{\meter}} تھی، لہٰذا ان پر فشار   مختلف ہو گا۔ ہم نے اس حقیقت کو نظر انداز کیا۔ آئیں متغیر گہرائی کی صورت میں فشار پر غور کریں۔

\جزوحصہء{متغیر گہرائی پر فشار}
فرض کریں ہم کثافت \عددی{\rho} کے سیال میں ڈوبی ہوئی انتصابی تختی کی ایک طرف پر قوت سیال جاننا چاہتے ہیں۔ ہم تختی کو مستوی  \عددی{xy} میں خطہ \عددی{y=a} تا \عددی{y=b} تصور کرتے ہیں (شکل \حوالہ{شکل_تکمل_استعمال_قوت_سیال})۔ ہم \عددی{[a,b]} کی خانہ بندی کرتے ہیں۔ ہم اس خطہ کو نقاط خانہ بندی پر محور \عددی{y} کے عمودی فرضی سطحوں سے باریک افقی پٹیوں میں تقسیم کرتے ہیں۔ ایک نمائندہ پٹی، جو \عددی{y} سے \عددی{y+\Delta y} تک ہو، کی چوڑائی \عددی{\Delta y} ہو گی، جبکہ اس پٹی کے نچلے ضلع کی لمبائی \عددی{L(y)} ہو گی۔ ہم فرض کرتے ہیں کہ \عددی{L(y)} متغیر \عددی{y} کا استمراری تفاعل ہے۔
\begin{figure}
\centering
\begin{tikzpicture}[font=\small]
...
نیچے سے اوپر چلتے ہوئے گہرائی کی تبدیلی سے پٹی پر فشار تبدیل ہوتا ہے۔ اب اگر پٹی کی چوڑائی بہت کم ہو، تب فشار کی اس تبدیلی کو رد کیا جا سکتا ہے اور ہم کہہ سکتے ہیں کہ پٹی پر ہر جگہ فشار وہی ہو گا جو پٹی کے نچلے کنارے پر ہے۔ یوں پٹی کی ایک طرف پر قوت درج ذیل ہو گی۔
\begin{align*}
...
\end{align}
ہو گی، جو \عددی{[a,b]} پر استمراری تفاعل کا ریمان مجموعہ ہے۔ ہم توقع کرتے ہیں کہ خانہ بندی کا معیار صفر  کے قریب تر کرنے  سے یہ مجموعہ بہتر سے بہتر نتیجہ دے گا۔ ہم ان مجموعوں کی تحدیدی قیمت کو  تختی پر قوت کی تعریف لیتے ہیں۔

\ابتدا{تعریف}\موٹا{تکمل برائے قوت سیال}\\
فرض کریں محور \عددی{y} پر \عددی{y=a} سے \عددی{y=b} تک کا خطہ، سیال میں ڈوبی  ہوئی ایک تختی کو ظاہر کرتا ہے۔مزید فرض کریں کہ \عددی{y} پر اس تختی کی سطح پر افقی پٹی  کی بائیں سے دائیں  لمبائی \عددی{L(y)} ہے۔ اس تختی کی ایک طرف پر قوت سیال درج ذیل ہو گی۔
...
ایک مساوی الساقین مثلث تختی، جس کا قاعدہ \عددی{\SI{4}{\meter}} اور قد \عددی{\SI{2}{\meter}} ہے،   پانی کے تالاب میں یوں ڈوبی ہوئی ہے کہ اس کا قاعدہ  اوپر ہو۔ قاعدے پر پانی کی گہرائی \عددی{\SI{1.5}{\meter}} ہے۔ تختی کی  ایک طرف پر قوت تلاش کریں۔ (پانی کی کثافت کو \عددی{\rho=\SI{1000}{\kilo\gram\per\meter\cubed}} لیں۔)

\حل
ہم تختی کے  نچلے راس کو محدد کے مبدا پر تصور کرتے ہیں (شکل \حوالہ{شکل_مثال_تکمل_استعمال_مثلث_قوت_پانی})۔یوں سطح پانی \عددی{y=3.5} پر ہو گی، جبکہ تختی کا بالائی کنارہ \عددی{y=2} پر ہو گا۔ تختی کا دایاں کنارہ \عددی{y=x} اور بایاں کنارہ \عددی{y=-x} ہو گا۔ یوں \عددی{y} پر پٹی کی لمبائی
\begin{align*}
L(y)=2x=2y
\end{align*}
اور پانی کی گہرائی\عددی{(3.5-y)} ہو گی۔ تختی کی ایک طرف پر پانی کی قوت درج ذیل ہو گی۔
\begin{align*}
...
کسی بھی محددی نظام میں سیال میں ڈوبی ہوئی انتصابی تختی کی ایک طرف پر قوت سیال حاصل کرنے کے لیے درج ذیل اقدامات  کریں۔
\begin{enumerate}[a.]
\item
نمائندہ افقی پٹی کی لمبائی اور گہرائی کے عمومی کلیے تلاش کریں۔
\item
...
ہم اب مثال \حوالہ{مثال_تکمل_استعمال_بیلنی_حوض_نچلی_پٹی} میں بیلنی حوض کی نچلی ایک میٹر چوڑی پٹی پر قوت سیال کی بالکل درست قیمت معلوم کر سکتے ہیں۔

ہم حوض کے  تل کو \عددی{y=0} پر رکھتے ہیں  (شکل \حوالہ{شکل_مثال_تکمل_استعمال_بیلنی_حوض_نچلی_پٹی_ٹھیک})، جبکہ محدد \عددی{y} کو اوپر کے رخ رکھتے ہیں۔ ہم \عددی{y} پر نمائندہ افقی پٹی کے لیے درج ذیل لکھ سکتے ہیں۔
\begin{enumerate}[a.]
\item
گہرائی پٹی:\quad
$40-y$
...
اگر ہمیں سیال میں ڈوبی ہوئی   انتصابی تختی کا وسطانی مرکز معلوم  ہو، تب ہم اس تختی کی  ایک طرف پر قوت سیال با آسانی معلوم کر سکتے ہیں (شکل \حوالہ{شکل_تکمل_استعمال_وسطانی_مرکز_اور_قوت_سیال})۔  مساوات \حوالہ{مساوات_تکمل_استعمال_قوت_سیال_تکمل} سے درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
...
سیال میں ڈوبی ہوئی  انتصابی تختی کی  ایک طرف پر قوت سیال \عددی{F} معلوم کرنے کے  لیے \عددی{\rho g}، تختی کے وسطانی مرکز کی گہرائی \عددی{\bar{h}}، اور تختی کے رقبہ \عددی{S} کا حاصل ضرب لیں۔
...
\حل
مثلث کا وسطانی مرکز محدد \عددی{y} پر تلا سے راس کی جانب ایک تہائی فاصلے  پر  واقع ہے(شکل \حوالہ{شکل_مثال_تکمل_استعمال_مثلث_قوت_پانی})، لہٰذا \عددی{\bar{h}=1.5+2/3=\tfrac{13}{6}} ہو گا۔ مثلث کا رقبہ معلوم کرتے ہیں۔
\begin{align*}
S&=\frac{1}{2}(\text{\RL{قاعدہ}})(\text{\RL{قد}})=\frac{1}{2}(4)(2)=4
\end{align*}
یوں تختی کی ایک طرف پر قوت درج ذیل ہو گی۔
\begin{align*}
...
مساوات \حوالہ{مساوات_تکمل_استعمال_قوت_سیال_وسطانی_مرکز} کہتی ہے کہ سیال میں ڈوبی  ہوئی انتصابی تختی پر قوت سیال وہی ہو گی   جو تختی کے پورے رقبے کو تختی کے وسطانی مرکز، جو \عددی{\bar{h}} گہرائی پر ہے، منتقل کرنے سے  حاصل ہو گی۔ عموماً اشکال کا وسطانی مرکز جدول سے دیکھا جا سکتا ہے اور یوں مساوات \حوالہ{مساوات_تکمل_استعمال_قوت_سیال_وسطانی_مرکز} قوت سیال معلوم کرنے کا ایک آسان ذریعہ بنتا ہے۔ ظاہر ہے کہ وسطانی مرکز حاصل کرتے ہوئے کسی نے   مساوات \حوالہ{مساوات_تکمل_استعمال_قوت_سیال_تکمل} کے تکمل کی طرح کا تکمل حل کرتے ہوئے وسطانی مرکز حاصل کیا ہو گا۔ چونکہ اس وقت آپ سیکھ رہے ہیں، لہٰذا فی الحال قوت سیال دریافت کرنے کے لیے مسئلے کا خاکہ بنائیں اور مساوات \حوالہ{مساوات_تکمل_استعمال_قوت_سیال_تکمل} استعمال کریں۔

%sec 6.9 questions start here
%sec 6.9 questions start here
\حصہء{سوالات}
\ابتدا{سوالات}
\ابتدا{سوال}
حوض کی اندرونی سطح  پر مثال \حوالہ{مثال_تکمل_استعمال_بیلنی_حوض_نچلی_پٹی} میں  کُل قوت سیال کتنی   ہو گی؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{1.23e9}{\newton}$
...
مثلث تختی کی ایک طرف پر مثال \حوالہ{مثال_تکمل_استعمال_مثلث_قوت_پانی} میں قوت سیال دریافت کی گئی۔ اس تختی پر شکل \حوالہ{شکل_سوال_تکمل_استعمال_مثلث_قوت_پانی_الف} کے محدد استعمال کرتے ہوئے قوت سیال دوبارہ معلوم کریں۔ 
\انتہا{سوال}
%=======================
\begin{figure}
\centering
...
مثلث تختی کی ایک طرف پر مثال \حوالہ{مثال_تکمل_استعمال_مثلث_قوت_پانی} میں قوت سیال دریافت کیا گیا۔ اس تختی پر شکل \حوالہ{شکل_سوال_تکمل_استعمال_مثلث_قوت_پانی_ب} کے محدد استعمال کرتے ہوئے قوت سیال دوبارہ معلوم کریں۔ 
\انتہا{سوال}
%=======================
\ابتدا{سوال}
اگر مثال \حوالہ{مثال_تکمل_استعمال_مثلث_قوت_پانی} میں تختی کو مزید دو میٹر نیچے منتقل کیا جائے، تب اس کی ایک طرف پر قوت سیال کتنی  ہو گی؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{163333}{\newton}$
...
%======================
\ابتدا{سوال}
اگر مثال \حوالہ{مثال_تکمل_استعمال_مثلث_قوت_پانی} میں تختی کو اتنا اوپر منتقل کیا جائے کہ اس کا تلا سطح پانی پر ہو،  تب اس کی ایک طرف پر قوت سیال کتنی  ہو گی؟
\انتہا{سوال}
%======================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_سمندری_پانی_الف}
مساوی الساقین مثلث تختی کو شکل \حوالہ{شکل_سوال_تکمل_استعمال_سمندری_پانی_الف} میں دکھایا گیا ہے، جس کا قاعدہ  سطح پانی سے \عددی{\SI{1}{\meter}} نیچے ہے۔
\begin{enumerate}[a.]
\item
تختی کی ایک طرف پر قوت سیال تلاش کریں۔
\item
اگر صاف پانی کے بجائے سمندری پانی ہو، تب قوت سیال کتنی ہو گی؟ سمندری پانی کی کثافت \عددی{\SI{1029}{\kilo\gram\per\meter\cubed}} ہے۔ 
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
اگر گزشتہ سوال میں تختی کو قاعدے  کے گرد آدھا چکر گھمایا جائے، تب اس کا کچھ حصہ پانی سے باہر ہو گا (شکل \حوالہ{شکل_سوال_تکمل_استعمال_سمندری_پانی_ب})۔ اب تختی کی ایک طرف پر  قوت سیال  کتنی ہو گی؟ 
\انتہا{سوال}
%=====================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_تکونی_سر}
ایک حوض کی    آمنے سامنے  انتصابی  دیواریں مساوی الساقین مثلث   کی شکل کی ہیں (شکل \حوالہ{شکل_سوال_تکمل_استعمال_تکونی_سر})۔
\begin{enumerate}[a.]
\item
 پانی سے بھرے ہوئے حوض کی  ایک    انتصابی دیوار  پر قوت سیال تلاش کریں۔
\item
حوض کی  انتصابی دیوار  پر قوت کو آدھا کرنے کے لیے پانی کی سطح کو کتنا کم کرنا ہو گا؟
\item
کیا حوض کی لمبائی کا حوض کی انتصابی دیوار  پر قوت سیال کا اثر ہو گا؟ اپنے جواب کی وجہ پیش کریں۔
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%====================
\ابتدا{سوال}
پانی کے حوض کی آمنے سامنے انتصابی دیواریں  چوکور ہیں، جہاں چوکور کا ضلع \عددی{\SI{2}{\meter}} ہے۔ 
\begin{enumerate}[a.]
\item
 پانی سے بھرے ہوئے حوض کی  ایک انتصابی دیوار  پر قوت سیال تلاش کریں۔
\item
...
%========================
\ابتدا{سوال}
مچھلیاں دیکھنے کے لیے ایک مچھلی گھر کی دیوار میں \عددی{\SI{2}{\meter}} چوڑا اور \عددی{\SI{1}{\meter}} اونچا شیشہ نصب ہے۔ شیشے کا تل سطح پانی سے \عددی{\SI{1.25}{\meter}} نیچے ہے۔  شیشے پر قوت پانی کتنی ہو گی۔ (سمندری پانی کی کثافت \عددی{\SI{1029}{\kilo\gram\per\meter\cubed}} ہے۔)
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{15126.3}{\newton}$
...
%=====================                          
\ابتدا{سوال}
مچھلیوں کے حوض کا تل \عددی{1.5\times 0.5\,\si{\meter}} اور اس کی گہرائی \عددی{\SI{0.75}{\meter}} ہے۔ پانی کی سطح بالائی کنارے سے \عددی{\SI{5}{\centi\meter}} نیچے ہے۔
\begin{enumerate}[a.]
\item
حوض کے اطراف پر قوت سیال دریافت کریں۔
\item
حوض کے تل پر قوت سیال دریافت کریں۔
\end{enumerate}
\انتہا{سوال}
%=====================
\ابتدا{سوال}
دودھ کے ڈبے کا تل \عددی{10\times 10\,\si{\centi\meter}} اور اس کا قد \عددی{\SI{20}{\centi\meter}} ہے۔ دودھ سے بھرے ہوئے ڈبے کی ایک طرف پر قوت سیال معلوم کریں۔ کثافت دودھ کو \عددی{\SI{1032}{\kilo\gram\per\meter\cubed}} لیں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{20.2}{\newton}$
...
%=====================
\ابتدا{سوال}
زیتون کے  تیل کے ڈبے کا تل \عددی{14\times 12\,\si{\centi\meter}} اور قد \عددی{\SI{26.5}{\centi\meter}} ہے۔ بھرے ہوئے ڈبے کے تل  اور ایک طرف پر قوت سیال تلاش کریں۔ زیتون کے تیل کی کثافت \عددی{\SI{930}{\kilo\gram\per\meter\cubed}} لیں۔
\انتہا{سوال}
%========================
\ابتدا{سوال}
ایک دائری تختی کا آدھا حصہ پانی میں انتصابی ڈوبا ہوا  ہے۔ تختی کا رداس \عددی{\SI{0.25}{\meter}} ہے۔ تختی کی ایک طرف پر قوت سیال تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
 $\SI{102.08}{\newton}$
...
%=========================
\ابتدا{سوال}
دودھ کی فراہمی کے لیے ٹرک پر نصب  \عددی{\SI{2}{\meter}} قطر کا  قائمہ  بیلنی حوض  افقی رکھ کر استعمال کیا جاتا ہے۔ آدھے بھرے حوض کے ایک دائری  سرے  پر قوت سیال تلاش کریں۔ 
\انتہا{سوال}
%================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_کھڑکی_محفوظ_الف}
ایک مکعب حوض کی دیوار میں قطع مکافی کھڑکی دی گئی ہے، جو \عددی{\SI{150000}{\newton}} کی قوت برداشت کر سکتی ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_کھڑکی_محفوظ_الف})۔ حوض میں \عددی{\SI{25000}{\kilo\gram\per\meter\cubed}} کثافت کا سیال بھرا جائے گا۔ 
\begin{enumerate}[a.]
\item
جب حوض میں سیال کی گہرائی \عددی{\SI{1.25}{\meter}} ہو، تب کھڑکی پر قوت سیال کتنی  ہو گی؟
\item
...
پانی کے مکعب حوض کی دیوار میں \عددی{1\times 1\,\si{\meter}} چوکور  کھڑکی دی گئی ہے،  جو \عددی{\SI{40000}{\newton}} کی قوت برداشت کر سکتی ہے (شکل \حوالہ{شکل_سوال_تکمل_استعمال_کھڑکی_محفوظ_ب})۔
\begin{enumerate}[a.]
\item
اگر حوض میں پانی کی گہرائی \عددی{\SI{3}{\meter}} ہو، تب کھڑکی پر قوت سیال کتنی  ہو گی؟
\item
حوض میں سیال کی کتنی گہرائی تک کھڑکی محفوظ ہو گی؟
\end{enumerate}
\انتہا{سوال}
...
پانی کا حوض  شکل \حوالہ{شکل_سوال_تکمل_استعمال_لمبی_حوض} میں دکھایا گیا ہے۔ حوض کے آخری تکونی سرے  \عددی{\SI{1200000}{\newton}} قوت برداشت کر سکتے ہیں۔ حوض میں پانی کا وہ حجم تلاش کریں جس پر حوض کے تکونی سرے  اپنی برداشت کی حد پر ہوں گے۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\end{tikzpicture}
\caption{حوض کے آخری سرے تکونی ہیں (سوال \حوالہ{سوال_تکمل_استعمال_لمبی_حوض})۔}
...
ایک مستطیل تالاب شکل \حوالہ{شکل_سوال_تکمل_استعمال_تالاب_پانی} میں دکھایا گیا ہے،  جس کی ایک طرف میں تکونی کھڑکی دی گئی ہے،  جو \عددی{\SI{62000}{\newton}} کی قوت برداشت کر سکتی ہے۔  خالی تالاب میں \عددی{\SI{10}{\meter\cubed\per\hour}}  کی شرح سے پانی بھرا جا رہا ہے۔ تکونی کھڑکی کتنی دیر میں اپنی برداشت کی  حد پر ہو گی؟
\انتہا{سوال}
%==========================
\ابتدا{سوال}\شناخت{سوال_تکمل_استعمال_اوسط_فشار_سیال}
ایک انتصابی تختی، جس کا قد \عددی{a} اور چوڑائی \عددی{b} ہے،  کو کثافت \عددی{\rho} کے سیال میں ڈبویا جاتا ہے۔ تختی کا بالائی کنارہ سطح سیال پر ہے۔ تختی  کے لمبے کنارے پر اوسط فشار سیال کتنا ہو گا؟ اپنے جواب کی وجہ پیش کریں۔ 
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{wb}{2}$
...
%=====================
\ابتدا{سوال}
دکھائیں کہ سوال \حوالہ{سوال_تکمل_استعمال_اوسط_فشار_سیال} میں تختی کی ایک طرف پر قوت کی مقدار سوال \حوالہ{سوال_تکمل_استعمال_اوسط_فشار_سیال} میں حاصل اوسط فشار  اور  تختی کے رقبے کا حاصل ضرب ہو گی۔
\انتہا{سوال}

\انتہا{سوالات}
%==========================
%sec 6.9 questions end here
%sec 6.9 questions end here



\حصہ{بنیادی نقش  اور نمونہ سازی کے اطلاقات}\شناخت{حصہ_استعمال_تکمل_بنیادی_نقش_دیگر_نمونی_استعمال}
اس باب میں ریمان مجموعے  کے استعمال سے ہم نے  مقداروں کا حساب کرنا سیکھا۔ یہ عمل درج ذیل تین اقدامات  پر مشتمل ہے۔
\begin{enumerate}[a.]
\item
مطلوبہ مقدار  کو ایک یا ایک سے زائد تفاعل سے ظاہر کیا جاتا ہے،جو بند وقفہ \عددی{[a,b]} پر استمراری ہوں۔
\item
وقفہ \عددی{[a,b]} کی خانہ بندی کر کے ہر ذیلی وقفے  میں ایک نقطہ \عددی{c_k} منتخب کیا جاتا ہے۔ \عددی{k} ویں ذیلی وقفے کی لمبائی \عددی{\Delta x_k}  ہو گی۔ 

مطلوبہ  مقدار  کی تخمینی قیمت کو مجموعے  کی صورت میں لکھا جاتا ہے۔

اس مجموعے کو وقفہ \عددی{[a,b]} پر استمراری تفاعل کا ریمان مجموعہ کہا جاتا ہے۔
\item
خانہ بندی کا معیار صفر کے قریب تر کرنے سے ریمان مجموعہ بہتر سے بہتر نتیجہ دے گا۔

ریمان مجموعے  کی حد قطعی تکمل ہو گی۔

قطعی تکمل استعمال کرتے ہوئے  مطلوبہ مقدار  کا حساب لگایا جاتا ہے۔
\end{enumerate}

درج بالا اقدام سے لکیر کی لمبائی، خطے کا رقبہ، اجسام کا حجم، کام، وغیرہ کا حساب ممکن ہے۔

حقیقت میں انجینئری، حیاتیات، علم کیمیا، اقتصادیات، ارضیات، طب، اور دیگر شعبوں میں ہزاروں کی تعداد میں مسائل  کو ان اقدامات  سے حل کیا جا سکتا ہے۔

اس حصے  میں ان اقدامات  پر دوبارہ غور کیا جائے گا اور کئی نئے تکمل متعارف کیے جائیں گے، جو ان اقدامات سے پیدا ہوتے ہیں۔

\جزوحصہء{فاصلہ بالمقابل ہٹاؤ}
اگر کسی محددی لکیر پر ایک جسم کا مقام تفاعل \عددی{s(t)} دیتا ہو اور یہ جسم ایک ہی سمت میں حرکت کرتا ہو، تب   \عددی{t=a} سے \عددی{t=b} تک جسم کے سمتی رفتار تفاعل \عددی{v(t)} کا تکمل  اس دورانیے میں طے شدہ فاصلہ دے گا۔ اگر جسم اس دورانیے میں سمت تبدیل کرتا ہو، تب طے شدہ فاصلہ  حاصل کرنے کے لیے ہمیں جسم کی رفتار \عددی{\abs{v(t)}} کا تکمل لینا ہو گا۔ جسم کی سمتی رفتار کا تکمل جسم کا \اصطلاح{ہٹاؤ}\فرہنگ{ہٹاؤ}\حاشیہب{displacement}\فرہنگ{displacement} \عددی{s(b)-s(a)} دے گا، جو اس کے ابتدائی اور اختتامی مقامات کے بیچ فاصلہ ہے۔

یہ دیکھنے کے لیے ہم وقتی وقفہ \عددی{a\le t\le b} کی خانہ بندی کرتے ہیں، جہاں \عددی{k} ویں ذیلی  وقفے کی لمبائی  \عددی{\Delta t_k} ہے۔ اگر \عددی{\Delta t_k} بہت کم ہو، تب دورانیہ \عددی{t_{k-1}} تا \عددی{t_k}  میں جسم کی سمتی رفتار \عددی{v(t)} میں تبدیلی قابل نظر انداز ہو گی،  لہٰذا اس ذیلی وقفے کے دائیں سرے پر جسم کی سمتی رفتار \عددی{v(t_k)} کو   ذیلی وقفہ پر جسم کی سمتی رفتار تصور کیا جا سکتا ہے۔ یوں \عددی{k} ویں ذیلی وقفے  کے دوران جسم کے مقام میں تبدیلی درج ذیل ہو گی۔
\begin{align*}
v(t_k)\Delta t_k
\end{align*}
اگر \عددی{v(t_k)} مثبت ہو، تب یہ تبدیلی مثبت ہو گی،  اور اگر \عددی{v(t_k)} منفی ہو تب،  یہ تبدیلی منفی ہو گی۔ دونوں صورتوں میں \عددی{k} ویں ذیلی وقفے  میں جسم 
\begin{align*}
\abs{v(t_k)}\Delta t_k
\end{align*}
فاصلہ طے کرے گا۔یوں پورے وقفے میں جسم کُل درج ذیل فاصلہ طے کرے گا۔
\begin{align}\label{مساوات_تکمل_استعمال_طے_فاصلہ}
\sum_{k=1}^n \abs{v(t_k)}\Delta t_k
\end{align}
مساوات \حوالہ{مساوات_تکمل_استعمال_طے_فاصلہ} میں مجموعہ، وقفہ \عددی{[a,b]} پر تفاعل رفتار  \عددی{\abs{v(t)}} کا ریمان مجموعہ ہے۔ ہم توقع کرتے ہیں کہ خانہ بندی کا معیار صفر کے قریب تر کرنے سے یہ تخمینی مجموعہ  بہتر سے بہتر  نتیجہ دے گا۔ یوں ایسا معلوم ہوتا ہے کہ وقفہ \عددی{[a,b]} میں جسم کا طے شدہ فاصلہ حاصل کرنے کے لیے درج ذیل تکمل استعمال کیا جا سکتا ہے۔
\begin{align}
\text{\RL{طے شدہ فاصلہ}}=\int_a^b \abs{v(t)}\dif t
\end{align}
یہ ریاضیاتی نمونہ ہر  موقع   پر بالکل درست فاصلہ دیتا ہے۔

اگر ہم جاننا چاہتے ہیں کہ وقتی دورانیے کے  اختتام پر  ابتدائی مقام سے جسم کتنا دور ہو گا، تب ہم \عددی{v(t)} کا تکمل، نہ کہ \عددی{\abs{v(t)}} کا تکمل لیں گے۔

آئیں دیکھیں ایسا کیوں ہو گا۔ فرض کریں کہ تفاعل \عددی{s(t)}جسم کا مقام دیتا ہے اور \عددی{F} تفاعل \عددی{v} کا ضد تفرق ہے۔ تب
\begin{align*}
s(t)=F(t)+C
\end{align*}
ہو گا،  جہاں \عددی{C} مستقل ہے۔ یوں لمحہ \عددی{t=a} سے \عددی{t=b} تک جسم کا ہٹاؤ 
\begin{align*}
s(b)-s(a)=(F(b)+C)-(F(a)+C)=F(b)-F(a)=\int_a^bv(t)\dif t
\end{align*}
ہو گا یعنی:
\begin{align}
\text{ہٹاؤ}=\int_a^bv(t)\dif t
\end{align}

\ابتدا{مثال}\شناخت{مثال_تکمل_استعمال_فاصلہ_ہٹاو}
ایک لکیر پر لمحہ \عددی{t=0} سے لمحہ \عددی{t=\tfrac{3\pi}{2}\,\si{\second}} تک  ایک جسم کی سمتی    رفتار \عددی{v(t)=5\cos t\,\si{\meter\per\second}} ہے۔ یہ جسم کُل کتنا فاصلہ طے کرتا ہے؟ اس کا کُل ہٹاؤ کتنا ہو گا؟

\حل
\begin{align*}
\text{\RL{طے شدہ فاصلہ}}&=\int_0^{\tfrac{3\pi}{2}}\abs{5\cos t}\dif t&&\text{\RL{رفتار کا تکمل فاصلہ ہو گا}}\\
...
\end{align*}
\begin{align*}
\text{ہٹاؤ}&=\int_0^{\tfrac{3\pi}{2}}5\cos t\dif t&&\text{\RL{سمتی رفتار کا تکمل ہٹاؤ ہو گا}}\\\
&=\left.5\sin t\right]_0^{\tfrac{3\pi}{2}}=5(-1)-5(0)=\SI{-5}{\meter}
\end{align*}
اس دورانیے میں جسم \عددی{\SI{5}{\meter}} آگے اور \عددی{\SI{10}{\meter}} پیچھے سفر کرتا ہے۔ یوں یہ \عددی{\SI{15}{\meter}} فاصلہ طے کرتا ہے، جبکہ اس کا ہٹاؤ \عددی{\SI{-5}{\meter}} ہو گا (شکل \حوالہ{شکل_مثال_تکمل_استعمال_فاصلہ_ہٹاو})۔
\انتہا{مثال}
%=========================
\begin{figure}
\centering
...
\end{axis}
\end{tikzpicture}
\caption{ابتدائی نقطہ $s(0)$ سے جسم کا ہٹاؤ۔}
\end{subfigure}
\caption{سمتی رفتار تفاعل اور ہٹاؤ (مثال \حوالہ{مثال_تکمل_استعمال_فاصلہ_ہٹاو})}
\label{شکل_مثال_تکمل_استعمال_فاصلہ_ہٹاو}
\end{figure}

\جزوحصہء{قاعدہ دولس}
آپ جانتے ہیں کہ  چننے کے بعد سیب کا ذائقہ  وقت کے ساتھ تبدیل ہوتا ہے۔ سیب میں شکر وقت کے ساتھ نشاستے میں تبدیل ہوتی ہے۔ سیب میں نشاستے  کی مقدار معلوم کرنے کے لیے ہم سیب کے ایک باریک کتلے  کو خوردبین میں دیکھتے ہیں۔ نشاستہ کے ہر دانے  کی  سطح عمودی تراش میں  خوردبین  سے  صاف نظر آتی ہے، لہٰذا کتلے کی سطح میں نشاستے  کے رقبے اور عمودی تراش کے رقبے  کا تناسب معلوم کیا جا سکتا ہے۔ یہ دو بُعدی تناسب سیب میں نشاستہ کے تین بُعدی تناسب کے برابر ہو گا۔ دو بُعدی اور تین بُعدی تناسب کی یکسانیت  اوسط  کی قیمت کے  تصور پر مبنی ہے۔

فرض کریں ہم کسی ٹھوس  جسم میں دانہ دار مادّہ کی تناسب جاننا چاہتے ہیں۔ ہم ٹھوس جسم سے موزوں نمونہ حاصل کرتے ہیں جس کو کاٹ کر ایک مکعب حاصل کیا جاتا ہے۔ اس مکعب کا ضلع \عددی{L} ہے۔ اس مکعب کو شکل \حوالہ{شکل_تکمل_استعمال_مسئلہ_دوسل} میں دکھایا گیا ہے جہاں مکعب کا ضلع محور \عددی{x} پر  ہے۔ ہم وقفہ \عددی{[0,L]} کے عمودی سطحوں سے اس مکعب کو کتلوں میں تقسیم کرتے ہیں۔ فرض کریں \عددی{x} پر دانہ دار مادے کے رقبے کا تناسب \عددی{r(x)} ہے۔ فرض کریں کہ \عددی{r(x)} متغیر \عددی{x} کا استمراری تفاعل ہے۔ 

اب وقفہ \عددی{[0,L]} کی خانہ بندی کریں۔نقاط خانہ بندی پر محور \عددی{x} کے عمودی سطحوں سے مکعب کو کتلوں میں تقسیم کریں۔ \عددی{k} ویں ذیلی وقفے کی لمبائی \عددی{\Delta x_k} ہو گی، جو نقطہ \عددی{x_{k-1}} اور نقطہ \عددی{x_k} پر واقع سطحوں کے بیچ فاصلہ  ہے۔اگر یہ سطحیں کافی قریب قریب  ہوں،  تب یہ دانوں کو بیلنی شکل میں کاٹیں گی۔ ان بیلنوں کا قاعدہ \عددی{x_k} پر ہو گا۔ ان سطحوں کے بیچ دانہ دار مادّہ کا حجمی تناسب وہی ہو گا  جو \عددی{x_k} پر سطح میں دانہ دار مادّہ کا سطحی تناسب ہے،  جو ان بیلنوں کے قاعدے  کے برابر ہے، جو از خود تقریباً \عددی{r(x)} ہو گا۔یوں دو قریبی سطحوں کے بیچ دانہ دار مادّہ کی مقدار درج ذیل ہو گی۔
\begin{align*}
(\text{\RL{تناسب}})\times(\text{\RL{کتلے کا حجم}})=r(x)L^2\Delta x_k
\end{align*}

پورے مکعب میں دانہ دار مادّے  کی مقدار
\begin{align*}
\sum_{k=1}^nr(x)L^2\Delta x_k
\end{align*}
ہو گی، جو وقفہ \عددی{[0,L]} پر تفاعل \عددی{r(x)L^2} کا ریمان مجموعہ ہے۔ ہم توقع کرتے ہیں کہ خانہ بندی کا معیار صفر کے قریب تر کرنے سے یہ مجموعہ بہتر سے بہتر نتیجہ دے گا، لہٰذا درج ذیل تکمل، جو ریمان مجموعہ کی حد کو ظاہر کرتا ہے، مکعب  میں دانہ دار مادّہ  کی مقدار دے گا۔
\begin{align*}
\int_0^L r(x)L^2\dif x
\end{align*}

اس مقدار کو مکعب کے حجم \عددی{L^3} سے تقسیم کرنے سے مکعب میں دانہ دار مادّہ کا تناسب حاصل ہو گا۔ اگر ہم نے موزوں نمونی مکعب منتخب کیا ہو تب پورے ٹھوس جس میں دانہ دار مادّہ کا تناسب وہی ہو گا جو اس نمونی مکعب میں ہے۔یوں درج ذیل ہو گا۔
\begin{align*}
\text{\RL{ٹھوس جسم میں دانہ دار مادّے کا تناسب}}&=\text{\RL{مکعب میں دانہ دار مادّے کا تناسب}}\\
&=\frac{\int_0^L r(x)L^2\dif x}{L^3}\\
&=\frac{1}{L}\int_0^L r(x)\dif x\\
&=\text{\RL{$[0,L]$ پر $r$  کی اوسط قیمت}}\\
...
جناب دولس پتھر میں دانہ دار مادّے کے تناسب میں دلچسپی رکھتے تھے۔ وہ نمونی پتھر کی ایک سطح کو اچھی طرح چمکدار بنا کر سطح کے برابر مومی کاغذ کو چمکیلی سطح پر رکھ کر دانہ دار خطوں کی نشاندہی کرتے۔کاغذ کا وزن کرنے کے بعد، دانہ دار خطوں کو کاغذ سے کاٹ کر کاغذ کا وزن دوبارہ کرتے۔ یوں دانہ دار خطوں کے رقبے کا تناسب حاصل کیا جاتا۔ یہ ترکیب آج بھی پٹرول   کے  تیل کی تلاش میں استعمال کی جاتی ہے۔
\begin{figure}
\centering
\begin{subfigure}{0.3\textwidth}
\centering
...
\caption{}
\end{subfigure}
\caption{قاعدہ دولس کے مراحل۔}
\label{شکل_تکمل_استعمال_مسئلہ_دوسل}
\end{figure}

\جزوحصہء{ناکارہ تکمل، ناکارہ نمونہ کشی}
بعض اوقات ریمان مجموعے  سے حاصل تکمل ہمارے  کام آتا ہے اور بعض اوقات کسی کام کا نہیں ہوتا۔ اس کا دارومدار مسئلے کی نمونہ کشی پر ہوتا ہے۔بعض طریقہ کار موزوں اور بعض غیر موزوں ہوتے ہیں۔ آئیں ایک غیر موزوں ریمان مجموعے کی مثال دیکھیں۔
...
\end{align} 
حاصل ہوتا ہے۔ یہ کلیہ  ہر  مرتبہ  بالکل درست نتیجہ دیتا ہے،  جو دیگر ذرائع سے حاصل معلومات کے عین مطابق ہوتا ہے۔

آئیں شکل \حوالہ{شکل_تکمل_استعمال_غلط_مثال}-ب کی طرح بیلنی پٹیاں لے کر ریمان مجموعہ حاصل کر کے دیکھیں۔ یہ ریمان مجموعہ بھی مرتکز ہے جو درج ذیل نسبتاً آسان تکمل دیتا ہے۔
\begin{align}\label{مساوات_تکمل_استعمال_غلط_کلیہ}
S=\int_a^b 2\pi f(x)\dif x
\end{align}
ہم کہہ سکتے ہیں کہ حجم کی تلاش میں ہم نے بیلنی پٹیاں استعمال کیں،  لہٰذا یہاں بھی ان کا استعمال درست ہو گا۔ حقیقت میں  مساوات \حوالہ{مساوات_تکمل_استعمال_غلط_کلیہ} کوئی پیش گوئی نہیں کرتی اور نہ  ہی اس سے کبھی درست نتائج حاصل ہوتے ہیں، جو دیگر تراکیب سے حاصل جوابات کے ساتھ مشابہت رکھتے ہوں۔ نمونہ کشی کے دوران موازنے  کے قدم پر یہ کلیہ نا کام ثابت ہوتا ہے۔

یاد رہے،  اگر آپ ایک بہت اچھا نظر آنے والا  تکمل حاصل کرنے میں کامیاب ہوں،  تو اس کا  ہرگز   یہ  مطلب نہیں  کہ  حاصل تکمل درست نتائج بھی دے گا۔ آپ کو تکمل کے نتائج کو پرکھنا بھی ہو گا۔
\begin{figure}
\centering
\begin{subfigure}{0.45\textwidth}
\centering
...
\draw[-latex](\b-1/4*\rb,0)--++(0.5,0)node[right]{$x$};
\end{tikzpicture}
\caption{سطحی رقبہ بیلنی پٹیوں سے حاصل نہیں ہوتا۔}
\end{subfigure}
\caption{مخروط پٹی لینے سے کارآمد تکمل جبکہ بیلنی پٹی سے غیر کارآمد تکمل حاصل ہو گا۔}
\label{شکل_تکمل_استعمال_غلط_مثال}
\end{figure}

\جزوحصہء{مسئلہ پاپس}
سطح طواف کے رقبے  اور جسم طواف کے حجم کا وسطانی مراکز کے  ساتھ تعلق  \اصطلاح{مسئلہ پاپس}\فرہنگ{مسئلہ!پاپس}\حاشیہب{Pappus's theorem}\فرہنگ{Pappus's theorem} پیش کرتا ہے\حاشیہد{اسکندریا کا رہائشی قدیم یونانی ریاضی دان۔مسائل پاپس تقریباً 1700 سال قدیم ہیں۔}۔

\ابتدا{مسئلہ}\موٹا{مسئلہ پاپس برائے حجم}
اگر   مستوی خطے  کو سطح مستوی میں پائی جانے والی ایک   لکیر کے گرد گھمایا جائے،  جہاں خطے کو لکیر قطع نہ کرتی ہو،  تب جسم طواف کا حجم
خطے کے رقبے اور ایک چکر کے دوران  (خطہ کے)  وسطانی نقطے کے طے کردہ فاصلے کے حاصل ضرب  کے برابر ہو گا۔ اگر خطے کا رقبہ \عددی{S} اور وسطانی نقطے کا محور سے فاصلہ \عددی{\rho} ہو،  تب جسم طواف کا حجم درج ذیل ہو گا۔ 
...
ہم محور طواف کو محور \عددی{x}  اور خطہ \عددی{R} کو ربع اول میں لیتے ہیں۔ ہم \عددی{y} پر، محور \عددی{y} کے عمودی، خطے  کی  عمودی تراش کی لمبائی کو \عددی{L(y)} سے ظاہر کرتے ہیں (شکل \حوالہ{شکل_ثبوت_تکمل_استعمال_پاپس_الف})۔ ہم فرض کرتے ہیں کہ \عددی{L(y)} استمراری ہے۔ اس خطے  کو محور \عددی{x} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔
...
\end{align}
خطہ \عددی{R} کے وسطانی مرکز کا \عددی{y} محدد \عددی{\bar{y}} درج ذیل ہو گا
\begin{align*}
\bar{y}=\frac{1}{S}\int_c^dyL(y)\dif y
\end{align*}
جس کو مساوات \حوالہ{مساوات_تکمل_استعمال_حجم_مثال} کے آخری تکمل میں پُر کرنے سے  \عددی{H=2\pi \bar{y}S} ملتا ہے۔ اس میں رداس  \عددی{\bar{y}} کو \عددی{\rho} سے ظاہر کرتے ہوئے  \عددی{H=2\pi \rho S} حاصل ہوتا ہے۔
\انتہا{ثبوت}
%=====================
\begin{figure}
\centering
...
رداس \عددی{a} کے دائری قرص کو محور کے گرد گھما کر اندرسہ\حاشیہب{torus}\فرہنگ{اندرسہ}\فرہنگ{torus} پیدا کیا جاتا ہے (شکل \حوالہ{شکل_مثال_تکمل_استعمال_پاپس_اندرسہ})۔ قرص کے مرکز اور محور کے بیچ فاصلہ \عددی{b\ge a} ہے۔ اس اندرسے کا حجم درج ذیل ہو گا۔
\begin{align*}
...
\حل
ربع اول میں محور \عددی{x} اور نصف دائرہ \عددی{y=\sqrt{a^2-x^2}} کے بیچ خطے  کو محور \عددی{y} کے گرد گھمانے سے نصف کرہ حاصل ہوتا ہے (شکل \حوالہ{شکل_مثال_تکمل_استعمال_نصف_کرہ})۔ تشاکل کی وجہ سے وسطانی مرکز کا \عددی{\bar{x}=0} ہو گا۔ مساوات \حوالہ{مساوات_تکمل_استعمال_مسئلہ_پاپس_الف} میں \عددی{\rho} کی جگہ \عددی{\bar{y}} لکھتے ہوئے درج ذیل حاصل ہو گا۔
\begin{align*}
...
اگر ایک ہموار مستوی منحنی کی قوس کو ایسی لکیر کے گرد ایک بار گھمایا جائے،  جو اس قوس کو قطع نہ کرتی ہو، تب قوس کی لمبائی اور  ایک چکر کے دوران قوس کے وسطانی مرکز کے طے شدہ فاصلے  کے حاصل ضرب کو طواف  قوس سے پیدا ہونے والے سطحے کا رقبہ کہیں گے۔  اگر محور طواف سے وسطانی مرکز کا فاصلہ \عددی{\rho}  اور قوس کی لمبائی \عددی{L}  ہو تب درج ذیل لکھا جائے گا۔
\begin{align}
S=2\pi \rho L
\end{align} 
\انتہا{مسئلہ}
...
اس مسئلے کے ثبوت میں ہم فرض کرتے ہیں کہ محور طواف کو محور \عددی{x} سے ظاہر کیا جا سکتا ہے  اور قوس کو متغیر \عددی{x} کا استمراری تفاعل تصور کیا جا سکتا ہے۔

\ابتدا{ثبوت}
ہم محور \عددی{x} کو محور طواف لیتے ہیں اور ربع اول میں \عددی{x=a} تا \عددی{x=b} تک قوس واقع ہے۔ اس قوس کے طواف سے درج ذیل رقبہ حاصل ہو گا۔
...
\end{align*}
ہو گا، جس کو مساوات \حوالہ{مساوات_تکمل_استعمال_مسئلہ_پاپس_رقبہ}  کے آخری تکمل میں پُر کرنے سے \عددی{S=2\pi \bar{y}L} ملتا ہے۔رداس \عددی{\bar{y}} کو \عددی{\rho} سے ظاہر کرتے ہوئے  \عددی{S=2\pi\rho L} حاصل ہوتا ہے۔
\انتہا{ثبوت}
%======================

\ابتدا{مثال}
اندر سے کا سطحی رقبہ (مثال \حوالہ{مثال_تکمل_استعمال_پاپس_اندرسہ} میں) درج ذیل ہو گا۔
\begin{align*}
S=2\pi(b)(2\pi a)=4\pi^2ba
\end{align*}
\انتہا{مثال}
%========================
%sec 6.10 questions start here
%sec 6.10 questions start here

\حصہء{سوالات}
\ابتدا{سوالات}
\موٹا{فاصلہ اور ہٹاؤ}\\
سوال \حوالہ{سوال_تکمل_استعمال_فاصلہ_ہٹاو_الف} تا سوال \حوالہ{سوال_تکمل_استعمال_فاصلہ_ہٹاو_ب} میں ایک جسم محددی لکیر پر سمتی رفتار \عددی{v(t)} سے حرکت کرتا ہے۔ (ا) سمتی رفتار کو ترسیم کر کے دیکھیں کہ یہ  کہاں  مثبت اور کہاں منفی ہے۔ (ب) اس کے بعد دیے گئے دورانیے میں طے شدہ فاصلہ تلاش کریں۔ (ج) جسم کا ہٹاؤ بھی تلاش کریں۔
...
\item
لمحہ \عددی{t=3} تک جسم نے کُل کتنا فاصلہ طے کیا ہو گا؟
\item
تفاعل \عددی{s} بالمقابل \عددی{t} ترسیم کریں اور جسم  کے مقام کی ترسیم کے ساتھ  اس کے تعلق پر تبصرہ کریں۔
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\item
کیا جسم کبھی  مبدا کے دائیں جانب  بھی ہو گا؟ اپنے جواب کی وجہ پیش کریں۔
\item
...
دو اجسام محددی لکیر پر حرکت کرتے ہیں۔ ان اجسام کی سمتی رفتاروں کو شکل \حوالہ{شکل_سوال_تکمل_استعمال_دو_اجسام_رفتار} میں دکھایا گیا ہے۔ دیے گئے وقفے کے لیے اجسام کتنا فاصلہ طے کرتے ہیں اور ان کا ہٹاؤ کتنا ہو گا؟\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\end{figure}
\ابتدا{سوال}
ایک نمونی ریل گاڑی کی  \عددی{10} سیکنڈوں کے  دوران  پٹڑی پر آگے پیچھے  حرکت درج ذیل ہے۔ قاعدہ سمسن سے کُل فاصلہ اور ہٹاؤ تلاش کریں۔
\begin{align*}
\begin{array}{rrrr}
\toprule
...
\انتہا{سوال}
%======================
\موٹا{سطحی رقبے کی نمونہ کشی}\\
\ابتدا{سوال}
لکیر \عددی{y=\tfrac{x}{\sqrt{3}},\, 0\le x\le \sqrt{3}} کو محور \عددی{x} کے گرد گھما کر سطح طواف پیدا کی جاتی ہے جس کا رقبہ
\begin{align*}
\text{\RL{سطح طواف}}=\frac{1}{2}(\text{\RL{تلا کا محیط}})(\text{\RL{ترچھا قد}})=\frac{1}{2}(2\pi)(2)=2\pi
\end{align*}
ہونا چاہیے۔  مساوات \حوالہ{مساوات_تکمل_استعمال_غلط_کلیہ} میں \عددی{f(x)=\tfrac{x}{\sqrt{3}}} پُر کرنے سے کیا حاصل ہوتا ہے؟\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\sqrt{3}\pi$
...
%===================
\ابتدا{سوال}
بیلن وہ واحد شکل  ہے جس کے لیے مساوات \حوالہ{مساوات_تکمل_استعمال_غلط_کلیہ} درست نتائج دیتی ہے۔ لکیر \عددی{y=r,\, 0\le x\le h} کو محور \عددی{x} کر گرد گھما کر سطح طواف پیدا کریں۔ دکھائیں کہ مساوات \حوالہ{مساوات_تکمل_استعمال_غلط_کلیہ} سے اس  سطح طواف کا رقبہ \عددی{S=2\pi r h} حاصل ہوتا ہے۔
\انتہا{سوال}
%======================
\ابتدا{سوال}
ہر وہ جسم جو مائع میں تیرتا ہو اپنی کمیت کے برابر مائع کی جگہ لیتا ہے (اصول آرشمیدسی)۔ یوں ہٹائے گئے مائع کی کمیت معلوم کر کے اس جسم کی کمیت معلوم کی جا سکتی ہے۔ ایک کشتی کی کمیت جاننے کی خاطر ہم \اصطلاح{خط آب }\فرہنگ{خط آب}\حاشیہب{water line}\فرہنگ{water line} کو \عددی{10} برابر حصوں میں تقسیم کر کے نقاط  خانہ بندی پر کشتی کے ڈوبے ہوئے حصے کا رقبہ عمودی تراش \عددی{S(x)} معلوم کرتے ہیں۔ اس کے بعد قاعدہ سمسن استعمال کر کے \عددی{S(x)} کے تکمل کی تخمین تلاش کرتے ہیں۔ نقاط خانہ بندی پر ڈوبے ہوئے رقبے \عددی{S(x)} درج ذیل ہیں، جہاں نقطوں کے بیچ فاصلہ \عددی{\SI{1}{\meter}} ہے اور رقبے کی اکائی \عددی{\si{\meter\squared}} ہے۔
\begin{align*}
...
\موٹا{مسئلہ پاپس}\\
\ابتدا{سوال}
ایک چوکور خطے کے راس \عددی{(0,2)}، \عددی{(2,0)}، \عددی{(4,2)}،  اور \عددی{(2,4)} ہیں۔ اس خطہ کو محور \عددی{x} کے گرد گھما کر ایک ٹھوس جسم طواف پیدا کیا جاتا ہے۔ اس جسم کا حجم اور سطحی رقبہ تلاش کریں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%=====================
\ابتدا{سوال}
لکیر \عددی{2x+y=6} اور محددی لکیروں کے بیچ تکونی خطے  کو لکیر \عددی{x=5} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔ اس جسم کا حجم مسئلہ پاپس کی مدد سے معلوم کریں۔ (جیسا آپ صفحہ \حوالہصفحہ{سوال_تکمل_استعمال_وسطانیہ} پر سوال \حوالہ{سوال_تکمل_استعمال_وسطانیہ} میں دیکھ چکے ہیں، تکون کے تین وسطانیوں کا نقطہ تقاطع تکون کا وسطانی مرکز ہو گا اور یہ قاعدے  کے وسطی نقطے سے مخالف راس کی جانب لکیر پر  ایک تہائی فاصلے  پر ہو گا۔)
\انتہا{سوال}
%===================
\ابتدا{سوال}
دائرہ \عددی{(x-2)^2+y^2=1} کو محور \عددی{y} کے گرد گھما کر اندرسہ پیدا کیا جاتا ہے۔ اس اندرسے  کا حجم تلاش کریں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$4\pi^2$
...
%=====================
\ابتدا{سوال}
مسئلہ پاپس  سے قائمہ دائری مخروط کا سطحی رقبہ پہلو تلاش کریں۔
\انتہا{سوال}
%====================
...
%====================
\ابتدا{سوال}
آپ نے سوال \حوالہ{سوال_تکمل_استعمال_وسطانی_مرکز_نصف_دائرہ} میں دریافت کیا کہ نصف دائرہ \عددی{y=\sqrt{a^2-x^2}} کا وسطانی مرکز \عددی{(0,\tfrac{2a}{\pi})} ہے۔ اس نصف دائرے  کو لکیر \عددی{y=a} کے گرد گھمایا جاتا ہے۔حاصل سطح طواف کا سطحی رقبہ تلاش کریں۔
\انتہا{سوال}
%=================
\ابتدا{سوال}
...
محور \عددی{x} اور نصف دائرہ \عددی{y=\sqrt{a^2-x^2}} کے بیچ خطے کا وسطانی مرکز \عددی{(0,\tfrac{4a}{3\pi})} ہے (مثال \حوالہ{مثال_تکمل_استعمال_نصف_کرہ})۔ اس خطے  کو لکیر \عددی{y=-a} گے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔ اس جسم طواف کا حجم تلاش کریں۔
\انتہا{سوال}
%=======================
\ابتدا{سوال}
لکیر \عددی{y=x-a} کے گرد سوال \حوالہ{سوال_تکمل_استعمال_وسطانی_مرکز_درکار_الف} کا خطہ گھما کر ٹھوس جسم طواف پیدا کیا جاتا ہے۔ اس جسم کا حجم تلاش کریں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%=========================
\ابتدا{سوال}
نصف دائرہ \عددی{y=\sqrt{a^2-x^2}} کا وسطانی مرکز \عددی{(0,\tfrac{2a}{\pi})} ہے۔ اس نصف دائرے  کو لکیر \عددی{y=x-a} کے گرد گھما کر سطح طواف پیدا کی جاتی ہے۔ اس سطح طواف کا سطحی رقبہ تلاش کریں۔
\انتہا{سوال}
%====================
\ابتدا{سوال}
محور \عددی{x} کے لحاظ سے مثال \حوالہ{مثال_تکمل_استعمال_نصف_کرہ} کے نصف دائری خطے  کا معیار اثر تلاش کریں۔ اگر آپ پہلے سے جانتے ہوئے معلومات استعمال کریں،  تب آپ کو تکمل لینے کی ضرورت پیش نہیں آئے گی۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{2a^3}{3}$
