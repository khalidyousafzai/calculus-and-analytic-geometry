...
\newcommand*{\حل}{\موٹا{حل}\\}
\newcommand*{\حلء}{\موٹا{حل}\quad}

\def\اردوعدد#1{\protect\farsidigits{\number#1}}			%to use proper urdu  numerals
...
%--------------------
%--------------------
\newenvironment*{قانونء}				
{\par\medskip  \quad\nopagebreak}%
{\par\hfill \vspace{\baselineskip}\par }
%{\par\medskip }
%--------------------
%--------------------
...
%the following doesnot have numberin
\newenvironment*{مسئلہء}				
{\par\noindent\ignorespaces  مسئلہ  \quad}%
{\par\noindent }
%--------------------
%--------------------


%the following doesnot say مسئلہ
\newenvironment*{مسئلہءء}				
{\par\noindent\ignorespaces}%
{\par\noindent }
%--------------------
%--------------------
...
%\newcounter{kcocounter}[section]
\renewcommand{\thekcocounter}{\thechapter.\arabic{kcocounter}}
%\renewcommand{\thekcocounter}{\arabic{kcocounter}}
...
%the following is the environment for end of chapter questions 
%it too accepts the answer environment above
\newenvironment*{سوالاتباب}				
{\noindent\ignorespaces\wf{
\موٹا{مشق برائے باب} 
\thechapter
\quad
