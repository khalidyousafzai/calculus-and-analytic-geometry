...
\جزوحصہء{منفصل مظہر کا نمونہ بذریعہ تفرقی تفاعل}
...
\جزوحصہء{نظریہ}
ترکیب نیوٹن مساوات \عددی{f(x)=0} کے حل کی تخمینی قیمتوں کی ترتیب حاصل کرتی ہے جو اصل حل تک پہنچنے کی کوشش کرتی ہے۔ہم اس ترتیب کا پہلا عدد \عددی{x_0} منتخب کرتے ہیں۔ موزوں صورتوں میں یہ ترتیب قدم بہ قدم آگے بڑھتے ہوئے دیگر نقطے دیتی ہے۔  \عددی{x_0} پر \عددی{f} کا مماس   محور \عددی{x} کو ترتیب کے اگلے نقطہ \عددی{x_1} پر قطع کرتا ہے (شکل \حوالہ{شکل_استعمال_نیوٹن_ترکیب})۔
\begin{figure}
\centering
\begin{minipage}{0.45\textwidth}
\centering
...
ابتدائی نقطہ \عددی{x_0} کو ترسیم دیکھ کر یا قیاساً منتخب کیا جا سکتا ہے۔یہ ترکیب نقطہ \عددی{(x_0,f(x_0))} پر تفاعل کے مماس کو تفاعل کا تخمین لیتے ہوئے مماس اور محور \عددی{x} کے مقطع کو \عددی{x_1} کہتا ہے جو ترتیب کا دوسرا عدد ہو گا۔\عددی{x_1} عموماً \عددی{x_0} سے بہتر حل ہو گا۔ اسی طرح  نقطہ \عددی{(x_1,f(x_1))} پر تفاعل کا مماس محور \عددی{x}  کو \عددی{x_2}  پر قطع کرے گا جو ترتیب کا تیسرا عدد ہو گا۔\عددی{x_2} عموماً \عددی{x_1} سے بہتر حل ہو گا۔اسی طرح قدم بہ قدم چلتے ہوئے بہتر سے بہتر حل کی ترتیب حاصل کی جاتی ہے۔یہ ترتیب اصل حل کے نزدیک سے نزدیک ہوتی چلی جاتی ہے۔ قابل قبول حل تک پہنچ کر ہم رک جاتے ہیں۔ 
...
چونکہ ترکیب نیوٹن کی مرتکزیت بہت تیز ہے (جس پر جلد بات کی جائے گی)  زیادہ تر کیلکولیٹر جذر کو  ترکیب نیوٹن سے تلاش کرتے ہیں۔اگر درج بالا جدول میں \عددی{5} کے  بجائے \عددی{13} اعشاریہ مقامات تک درست ہندسے  لیے جاتے تب اگلے قدم میں \عددی{\sqrt{2}} کی قیمت \عددی{10} اعشاریہ مقامات تک درست حاصل ہوتی۔ 
...
\end{minipage}
\caption{
جذر \عددی{r} کے دونوں اطراف ابتدائی نقطہ لیتے ہوئے ترکیب نیوٹن \عددی{r} پر مرتکز ہو گا۔
}
...
ترکیب نیوٹن بہت تیزی سے مرتکز ہوتا ہے، لیکن چونکہ مرتکزیت لازمی نہیں  لہٰذا یہ دیکھنا لازم  ہو گا کہ آیا ترکیب مرتکز ہے یا نہیں۔ مرتکزیت یقینی بنانے کی خاطر ہم تفاعل ترسیم کر کے موزوں ابتدائی نقطہ \عددی{x_0} منتخب کر سکتے ہیں۔ صفر کے قریب ہونے کو \عددی{\abs{f(x_n)}} کی قیمت سے دیکھا جا سکتا ہے جبکہ مرتکزیت کو \عددی{\abs{x_n-x_{n+1}}} سے پرکھا جا سکتا ہے۔
...
\end{align}
کی صورت میں  وقفہ کے اندر کسی بھی ابتدائی نقطہ \عددی{x_0} کے لیے ترکیب مرتکز ہو گی۔حقیقت میں اس مسئلے کا اطلاق مشکل ثابت ہوتا ہے لہٰذا \عددی{f(x_n)} اور \عددی{\abs{x_n-x_{n+1}}} کی قیمتوں سے مرتکزیت دیکھی جاتی ہے۔

عدم مساوات \حوالہ{مساوات_استعمال_مرکوزیت_نیوٹن_الف} مرتکزیت کے لیے \اصطلاح{کافی} نا کہ لازمی شرط ہے۔ایسی مثالیں پائی جاتی ہیں جہاں جذر \عددی{r} پر ایسا کوئی وقفہ نہیں پایا جاتا   جس پر عدم مساوات \حوالہ{مساوات_استعمال_مرکوزیت_نیوٹن_الف} مطمئن ہوتی ہو لیکن ترکیب نیوٹن مرتکز ہوتی ہے۔ ایسے تمام وقفے پر ترکیب نیوٹن مرتکز ہو گی جس میں \عددی{x_0} اور درکار جذر کے بیچ وقفے پر منحنی \عددی{y=f(x)} محور \عددی{x} کی طرف محدب (جھکا) ہو (شکل \حوالہ{شکل_استعمال_نیوٹن_مرکوزیت})۔
...
\end{tikzpicture}
\caption{ترکیب نیوٹن کی عدم مرتکزیت۔}
\label{شکل_استعمال-نیوٹن_عدم_مرکوزیت}
\end{minipage}
\end{figure}

اگر ترکیب نیوٹن مرتکز ہو تب ہم توقع کرتے ہیں کہ یہ جذر پر مرتکز ہو گا۔حقیقت میں عموماً ایسا ہی ہو گا البتہ بعض اوقات یہ کسی ایسے نقطے پر مرتکز ہو گا جہاں جذر  موجود نہیں  ہو گا۔ خوش قسمتی سے ایسے مواقع بہت کم پائے جاتے ہیں۔

بعض اوقات آپ ایک جذر کو تلاش کرنا چاہیں گے جبکہ ترکیب نیوٹن کسی دوسرے جذر پر مرتکز ہو گا۔ شکل \حوالہ{شکل_استعمال_نیوٹن_غلط_جذر_حاصل} میں ایسی دو مثالیں دی گئی ہیں۔ 
...
\end{tikzpicture}
\end{minipage}
\caption{ترکیب نیوٹن کسی دوسرے جذر پر مرتکز ہو سکتا ہے۔}
