...
درج ذیل کثیر رکنی وقفہ \عددی{[-3,3]} کے ہر نقطہ پر استمراری   اور \عددی{(-3,3)} کے ہر نقطہ پر قابل تفرق ہے۔
\begin{align*}
f(x)=\frac{x^3}{3}-3x
\end{align*}
...
\begin{enumerate}[a.]
\item
ایسی  کثیر رکنی \عددی{f(x)} تشکیل دیں جس کے صفر \عددی{x=-2,-1,0,1,2} پر پائے جاتے ہوں۔
\item
...
\begin{enumerate}
\item
ہر ایسی  کثیر رکنی جس میں سب سے زیادہ طاقت جفت ہو  کا کم سے کم ایک افقی مماس پایا جاتا ہے۔
\item
ہر ایسی کثیر رکنی جس میں سب سے زیادہ طاقت طاق ہو  کا کم سے کم ایک افقی مماس پایا جاتا ہے۔
\end{enumerate}
\انتہا{سوال}
%=======================
...
\begin{enumerate}[a.]
\item
\عددی{-0.5\le x\le  1.5} پر \عددی{y=9x^{2/3}(x-1)} ترسیم کریں۔ اس کے بعد احصاء کی مدد سے مقعر، مقامی اقل اور مقامی اعظم نقطوں کی تصدیق کریں۔ مبدا کی  بائیں جانب کون سا مقعر ہے؟ (ہو سکتا ہے کہ آپ کو کمپیوٹر میں \عددی{x^{2/3}} کو \عددی{(x^2)^{1/3}} لکھنا پڑے۔)
\item
...
اس حصہ میں  ناطق تفاعل (دو کثیر رکنیوں کا حاصل تقسیم)  کے علاوہ دیگر تفاعل، جن کی \عددی{x\to \mp \infty} پر دلچسپ حد ہوں، کی ترسیمات پر  متقارب اور غالب اجزاء کی مدد سے   غور کیا جائے گا۔
...
ناطق تفاعل کی حد، \عددی{x\to\pm\infty} کرتے ہوئے،    حاصل کرنے کی خاطر نسب نما میں \عددی{x}   کی بلند تر طاقت سے    شمار کنندہ اور نسب نما  کو  تقسیم کریں۔ اس کے بعد کیا ہو گا، یہ ملوث   کثیر رکنیوں کے درجات   پر منحصر ہے۔
...
\begin{enumerate}[a.]
\item
اگر شمار کنندہ اور نسب نما کی بلند تر طاقت ایک سی  ہو ں تب تفاعل کی حد بلند تر ارکان کے ضرائب  کا حاصل تقسیم ہو گی۔
\item
...
\begin{enumerate}[a.]
\item 
اگر   \عددی{f}  کا درجہ اور \عددی{g}    کے درجے کے برابر ہوں تب  \عددی{\lim\limits_{x\to \mp \infty} \frac{f(x)}{g(x)}=\frac{a_n}{b_n}} یعنی    \عددی{f} اور \عددی{g} کے اول ضرائب کی نسبت کے برابر ہو گا۔ 
\item 
...
کثیر رکنی \عددی{a_nx^n+a_{n-1}x^{n-1}+\cdots+a_1x+a_0,\, a_n\ne 0} کا اول  ضریب  \عددی{a_n} ہے جو بلند تر طاقتی جزو کا  ضریب  ہے۔
...
مسئلہ \حوالہ{مسئلہ_حد_بیچ} (صفحہ \حوالہصفحہ{مسئلہ_حد_بیچ} مسئلہ محصور) بھی \عددی{x\to \mp\infty} پر حد کے لیے قابل لاگو ہے۔ اس کی ایک مثال پیش کرتے ہیں۔


\ابتدا{مثال}\شناخت{مثال_استعمال_مسئلہ_بیچ}
مسئلہ محصور استعمال کرتے ہوئے درج ذیل منحنی کے متقارب تلاش کریں۔
\begin{align*}
y=2+\frac{\sin x}{x}
\end{align*}
\حل
...
\end{align*}
اور \عددی{\lim_{x\to \mp\infty}\abs{\tfrac{1}{x}}=0} ہے لہٰذا مسئلہ محصور کے تحت \عددی{\lim_{x\to\mp\infty}\tfrac{\sin x}{x}=0} ہو گا۔یوں 
\begin{align*}
...
ان میں سے کون سا خط متقارب ہے؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
%==========================
...
جزوی طور پر بند شریانوں کا  رداس  بڑا کرتے ہوئے خون کی عمومی بہاؤ حاصل کی جا سکتی ہے۔  \سن{1830} کے لگ بھگ فرانس کے جین پوزوئے نے درج ذیل کلیہ اخذ کیا
\begin{align*}
H=&kr^4&& \text{\RL{($k$ مستقل)}}
\end{align*}
جو مستقل دباؤ پر  فی اکائی وقت میں    چھوٹی نالی میں حجم بہاؤ \عددی{H} دیتا ہے۔  نالی کا رداس \عددی{r} ہے۔رداس  \عددی{\SI{10}{\percent}} بڑھانے  سے بہاؤ پر کیا اثر ہو گا؟\\
\حل
...
%=============================
\ابتدا{سوال}
خون کے بہاؤ میں \عددی{\SI{50}{\percent}} اضافہ حاصل کرنے کی خاطر مثال \حوالہ{مثال_استعمال_شریانہ} میں \عددی{r} کو کتنا فی صد بڑھانا ہو گا؟
\انتہا{سوال}
%=====================
%Q55
\ابتدا{سوال}
...
\end{align*}
کام کرتا ہے جہاں \عددی{W} اکائی وقت میں کام ہے، \عددی{P} دباؤ خون ہے، \عددی{V} دل سے اکائی وقت میں خارج خون کا حجم ہے، \عددی{\delta}خون کی کثافت ہے، \عددی{v} دل سے اخراج کے وقت خون کی اوسط رفتار ہے، اور \عددی{g} ثقلی اسراع ہے۔
