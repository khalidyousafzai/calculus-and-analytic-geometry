...
بند دائرہ کار کے ہر نقطہ پر استمراری تفاعل کی   دائرہ کار پر مطلق زیادہ سے زیادہ قیمت اور مطلق کم سے کم قیمت ہو گی جن پر ترسیم کھینچتے وقت  نظر رکھا جاتا ہے۔ مسائل کے حل میں انتہائی قیمتوں  کے کردار پر اس باب میں  جبکہ تکمل احصاء کا نظریہ مرتب کرنے میں ان کے کردار پر اگلے دو ابواب میں غور کیا جائے گا۔  

\ابتدا{مسئلہ}\شناخت{مسئلہ_استعمال_بلند_تر_کمتر}\موٹا{استمراری تفاعل کا مسئلہ کم سے کم اور زیادہ سے زیادہ}\\
بند دائرہ کار \عددی{I} کے ہر نقطہ پر استمراری تفاعل \عددی{f} کی  \عددی{I} پر مطلق زیادہ سے زیادہ قیمت \عددی{M} اور مطلق کم سے کم  قیمت \عددی{m} پائی جائے گی۔یعنی \عددی{I} میں ایسا \عددی{x_1} اور \عددی{x_2} پایا جائے گا کہ \عددی{f(x_1)=m} اور \عددی{f(x_2)=M} ہوں اور \عددی{I} میں تمام \عددی{x} کے لئے \عددی{m\le f(x)\le M} ہو (شکل \حوالہ{شکل_استعمال_بلند_تر_کم_تر})۔
\انتہا{مسئلہ}
%===================
...
\end{axis}
\end{tikzpicture}
\caption{زیادہ سے زیادہ اور کم سے کم  قیمت آخری نقطوں پر ہیں۔}
\end{subfigure}
\begin{subfigure}{0.5\textwidth}
\centering
...
\end{axis}
\end{tikzpicture}
\caption{کم سے کم قیمت  اندرونی نقطہ  پر جبکہ زیادہ سے زیادہ  قیمت آخری نقطہ پر  ہے۔}
\end{subfigure}%
\begin{subfigure}{0.5\textwidth}
\centering
...
\end{axis}
\end{tikzpicture}
\caption{زیادہ سے زیادہ قیمت  اندرونی نقطہ  پر جبکہ کم سے کم   قیمت آخری نقطہ پر ہے۔}
\end{subfigure}
\caption{زیادہ سے زیادہ اور کم سے کم قیمت کے  نقطوں کے چند ممکنہ مقامات۔}
\label{شکل_استعمال_بلند_تر_کم_تر}
\end{figure}

\ابتدا{مثال}\شناخت{مثال_استعمال_انتہائی_سائن_کوسائن}
وقفہ \عددی{[-\pi/2,\pi/2]} پر تفاعل \عددی{f(x)=\cos x} ایک مرتبہ زیادہ سے زیادہ قیمت \عددی{1} اور دو  مرتبہ کم سے کم  قیمت \عددی{0} اختیار کرتا ہے۔اسی وقفے پر  تفاعل \عددی{g(x)=\sin x} ایک  مرتبہ زیادہ سے زیادہ  قیمت \عددی{1} اور ایک  مرتبہ کم سے کم قیمت \عددی{-1} اختیار کرتا ہے (شکل \حوالہ{شکل_مثال_استعمال_انتہائی_سائن_کوسائن})۔ 
\begin{figure}
\centering
\begin{tikzpicture}
...
\end{axis}
\end{tikzpicture}
\caption{کھلے وقفہ پر زیادہ سے زیادہ اور کم سے کم قیمتوں کا ہونا یقینی نہیں ۔}
...
\end{axis}
\end{tikzpicture}
\caption{واحد ایک نقطہ  پر عدم استمرار کی وجہ سے زیادہ سے زیادہ اور کم سے کم قیمتیں غیر یقینی ہو سکتی  ہیں۔}
...
\end{cases}
\end{align*}
دکھایا گیا ہے جو وقفہ \عددی{[-1,1]} پر استمراری ہے ماسوائے واحد نقطہ \عددی{x=0}  پر، جس کی وجہ سے تفاعل کی نہ  زیادہ سے زیادہ قیمت اور نہ ہی  کم سے کم قیمت پائی جاتی ہے۔

\جزوحصہء{مقامی بالمقابل مطلق (عالمگیر) انتہا}
شکل \حوالہ{شکل_استعمال_مقامی_مطلق_انتہا} میں تفاعل کے پانچ انتہائی نقطے دکھائے گئے ہیں تفاعل کا کم سے کم  قیمت نقطہ \عددی{a} پر ہے اگرچہ \عددی{e} پر بھی \عددی{x} کی مقامی قیمتوں کے لحاظ سے \عددی{f} کی قیمت کم ہے۔نقطہ \عددی{c} پر تفاعل کی مقامی زیادہ سے زیادہ قیمت پائی جاتی ہے جبکہ \عددی{d} پر اس کی مطلق زیادہ سے زیادہ قیمت پائی جاتی ہے۔
\begin{figure}
\centering
\begin{tikzpicture}
...
\text{(ج)}&y=x^2&(0,2]&\text{\RL{مطلق زیادہ سے زیادہ قیمت \عددی{x=2} پر \عددی{4} ہے جبکہ مطلق کم سے کم قیمت موجود نہیں }}\\
...
\end{axis}
\end{tikzpicture}
\caption{نہ مطلق زیادہ سے زیادہ اور نہ مطلق کم سے کم قیمت پائی جاتی ہے}
\end{subfigure}
...
تفاعل \عددی{f} کا کھلے دائرہ کار \عددی{D} میں اندرونی نقطہ \عددی{c} پر اس صورت مقامی زیادہ سے زیادہ قیمت پائی جائے گی جب \عددی{D} میں کسی بھی کھلے وقفہ جس میں \عددی{c} پایا جاتا ہو میں تمام \عددی{x} کے لئے
\begin{align*}
f(x)\le f(c)
\end{align*}
...
ہم مقامی انتہا کی تعریف کو وقفے  کے آخری سروں تک وسعت دے سکتے ہیں۔یوں آخری سر \عددی{c} پر مقامی انتہا سے مراد نصف کھلے  وقفہ میں موزوں عدم مساوات کا مطمئن ہونا ہے۔ شکل \حوالہ{شکل_استعمال_مقامی_مطلق_انتہا} میں تفاعل \عددی{f} کی  \عددی{c} اور \عددی{d} پر مقامی زیادہ سے زیادہ قیمتیں  جبکہ  \عددی{a}، \عددی{e}،  اور \عددی{b} پر مقامی کم سے کم قیمتیں  پائی جاتی ہیں۔

مطلق زیادہ سے زیادہ قیمت بھی مقامی زیادہ سے زیادہ قیمت ہو گی۔مطلق زیادہ سے زیادہ قیمت اپنے  پڑوس میں بھی زیادہ سے زیادہ قیمت ہو گی۔یوں تمام مقامی زیادہ سے زیادہ قیمتوں کے جدول میں مطلق زیادہ سے زیادہ قیمت (اگر موجود ہو) بھی پائی جائے گی۔ اسی طرح تمام مقامی کم سے کم قیمتوں کے جدول میں مطلق کم سے کم قیمت (اگر موجود ہو) بھی پائی جائے گی۔
...
فرض کریں  تفاعل \عددی{f} کے دائرہ کار کے  اندرونی نقطہ \عددی{c} پر \عددی{f} کی کم سے کم یا زیادہ سے زیادہ قیمت پائی جاتی ہو اور \عددی{c} پر \عددی{f'} معین ہو تب درج ذیل ہو گا۔
\begin{align*}
f'(c)=0
\end{align*} 
\انتہا{مسئلہ}
...
فرض کریں  \عددی{c} پر \عددی{f} کی مقامی زیادہ سے زیادہ قیمت پائی جاتی ہے (شکل \حوالہ{شکل_مسئلہ_استعمال_یک_درجی_تفرق_انتہا})۔ یوں \عددی{c} کے قریبی پڑوس میں تمام \عددی{x} پر \عددی{f(x)-f(c)\le 0} ہو گا۔چونکہ \عددی{c} اندرونی نقطہ ہے لہٰذا \عددی{f'(c)} کی تعریف درج ذیل دو طرفہ حد ہو گی۔
\begin{align*}
...
\end{tikzpicture}
\caption
{مقامی زیادہ سے زیادہ قیمت \عددی{c} پر  ہے۔نقطہ \عددی{c} پر  ڈھلوان بیک وقت غیر مثبت  اور غیر منفی اعداد کی  حد ہونے کی وجہ سے صفر ہو گا۔(مسئلہ \حوالہ{مسئلہ_استعمال_یک_درجی_تفرق_انتہا})}
...
\ابتدا{جواب}
\wf{\unexpanded{
\عددی{x=-3} پر مطلق زیادہ سے زیادہ؛ \عددی{x=-\tfrac{19}{3}} پر  مطلق کم سے کم۔\\
\begin{minipage}{0.45\textwidth}
\centering
\begin{tikzpicture}[font=\small]
...
\ابتدا{جواب}
\wf{\unexpanded{
مطلق زیادہ سے زیادہ:\عددی{3}، مطلق کم سے کم :\عددی{-1} ہے۔\\
\begin{minipage}{0.45\textwidth}
\centering
\begin{tikzpicture}[font=\small]
...
\ابتدا{جواب}
\wf{\unexpanded{
مطلق زیادہ سے زیادہ:\عددی{-0.25}، مطلق کم سے کم :\عددی{-4} ہے۔\\
\begin{minipage}{0.45\textwidth}
\centering
\begin{tikzpicture}[font=\small]
...
\ابتدا{جواب}
\wf{\unexpanded{
مطلق زیادہ سے زیادہ:\عددی{2}، مطلق کم سے کم :\عددی{-1} ہے۔\\
\begin{minipage}{0.45\textwidth}
\centering
\begin{tikzpicture}[font=\small]
...
\ابتدا{جواب}
\wf{\unexpanded{
مطلق زیادہ سے زیادہ:\عددی{2}، مطلق کم سے کم :\عددی{0} ہے۔
\begin{minipage}{0.45\textwidth}
\centering
\begin{tikzpicture}[font=\small]
...
\ابتدا{جواب}
\wf{\unexpanded{
مطلق زیادہ سے زیادہ:\عددی{1}، مطلق کم سے کم :\عددی{-1} ہے۔\\
\begin{minipage}{0.45\textwidth}
\centering
\begin{tikzpicture}[font=\small]
...
\ابتدا{جواب}
\wf{\unexpanded{
مطلق زیادہ سے زیادہ:\عددی{\tfrac{2}{\sqrt{3}}}، مطلق کم سے کم :\عددی{-1} ہے۔\\
\begin{minipage}{0.45\textwidth}
\centering
\begin{tikzpicture}[font=\small]
...
سوال \حوالہ{سوال_استعمال_مقامی_تلاش_الف} تا سوال \حوالہ{سوال_استعمال_مقامی_تلاش_الف} میں دیے  گئے دائرہ کار پر مقامی زیادہ سے زیادہ یا کم سے کم قیمت تلاش کریں۔یہ قیمتیں کن نقطوں پر پائی جاتی ہیں؟ ان میں سے کون سی مطلق انتہائی قیمتیں ہیں؟ 
...
وقفہ \عددی{[0,1]} پر ایسا معین تفاعل پیش کریں جس کا \عددی{x=0} پر نہ کوئی مقامی زیادہ سے زیادہ قیمت اور نہ ہی مقامی کم سے کم قیمت پائی جاتی ہو۔
\انتہا{سوال}
%===============================
...
%======================
\ابتدا{ثبوت}
چونکہ \عددی{f} استمراری ہے لہٰذا \عددی{[a,b]} پر \عددی{f} کی مطلق زیادہ سے زیادہ اور مطلق کم سے کم قیمتیں ہوں گی۔یہ صرف درج ذیل نقطوں پر پائی جائیں گی۔
\begin{enumerate}[1.]
\item
...
اگر زیادہ سے زیادہ قیمت اور کم سے کم قیمت دونوں \عددی{a} یا \عددی{b} پر پائی  جاتی ہوں تب \عددی{f} مستقل ہو گا۔یوں \عددی{f'=0} ہو گا لہٰذا وقفے  کے کسی بھی نقطے کو \عددی{c} لیا جا سکتا ہے۔یوں ثبوت مکمل ہوتا ہے۔
\انتہا{ثبوت}
%=======================
...
%KKK??? am here 6 aug 2026
\ابتدا{مثال}\شناخت{مثال_استعمال_رول_تصدیق_الف}
درج ذیل کثیررکنی وقفہ \عددی{[-3,3]} کے ہر نقطہ پر استمراری ہے اور \عددی{(-3,3)} کے ہر نقطہ پر قابل تفرق ہے۔
\begin{align*}
f(x)=\frac{x^3}{3}-3x
\end{align*}
...
مسئلہ رول کی ترچھی صورت مسئلہ اوسط قیمت ہے (شکل \حوالہ{شکل_استعمال_مسئلہ_اوسط_جیومیٹری})۔ قطعہ  \عددی{AB} کے متوازی نقطہ \عددی{A} اور \عددی{B} کے بیچ کہیں پر  تفاعل کا  ایسا مماس پایا جاتا ہے جس کا ڈھلوان قطعہ کے ڈھلوان کے برابر ہو گا۔
...
\end{tikzpicture}
\caption
{وقفہ \عددی{[a,b]} پر \عددی{f} اور قطعہ  \عددی{AB} کی ترسیم۔}
\end{subfigure}\hfill
\begin{subfigure}[t]{0.45\textwidth}
\centering
\begin{tikzpicture}[font=\small]
...
\end{tikzpicture}
\caption
{نقطہ \عددی{c=1} پر مماس قطعہ  \عددی{AB} کے متوازی ہے (مثال \حوالہ{مثال_استعمال_یہاں_نقطہ_دیکھ_سکتے_ہیں})}
...
\begin{enumerate}[a.]
\item
ایسا کثیررکنی \عددی{f(x)} تشکیل دیں جس کے صفر \عددی{x=-2,-1,0,1,2} پر پائے جاتے ہوں۔
\item
...
\item
اگر \عددی{c} پر \عددی{f'} کی علامت تبدیل نہ ہو (\عددی{c} کے دونوں اطراف \عددی{f'} کی علامت ایک سی ہے) تب \عددی{c} پر \عددی{f} کی کوئی انتہائی قیمت نہیں پائی جاتی ہے (شکل \حوالہ{شکل_استعمال_مقامی_انتہا_نہیں})۔
\end{enumerate}
...
(ب) \عددی{t=-1.5} پر مقامی زیادہ سے زیادہ \عددی{5.25}؛\\
 (ج) \عددی{t=-1.5} پر مطلق زیادہ سے زیادہ \عددی{5.25} ہے۔ 
}}
\انتہا{جواب}
%=============================
\ابتدا{سوال}
...
مقامی انتہا کا مقام تعین کرنے کی خاطر \عددی{y'} کی علامت کی تبدیلی کے بجائے درج ذیل پرکھ استعمال کیا جا سکتا ہے۔
...
\draw(axis cs:-1,5)node[circ]{}node[above,xshift=-0.5em,align=center]{\RL{مقامی زیادہ سے زیادہ}\\ $(-1,5)$};
\draw(axis cs:1,1)node[circ]{}node[above]{$(1,1)$}node[right,xshift=1em]{ \RL{مقامی کم سے کم}};
...
\draw(axis cs:0,-3)node[circ]{}node[below,xshift=-0.5em,align=center]{$(0,-3)$\\  \RL{مقامی کم سے کم}};
...
\draw(axis cs:1,2)node[circ]{}node[right,yshift=0.5em,fill=white,align=left]{\RL{مقامی زیادہ سے زیادہ}\\$(1,2)$};
...
\draw(axis cs:0,1)node[circ]{}node[above,fill=white,yshift=0.5em,align=center]{\RL{مقامی زیادہ سے زیادہ}\\$(0,1)$};
...
\draw(axis cs:2,3.33)node[circ]{}node[left,xshift=-1em,align=center]{$x=2$\\  \RL{مقامی زیادہ سے زیادہ}};
\end{axis}
\end{tikzpicture}
\end{minipage}
}}
...
\begin{enumerate}
\item
ہر ایسے کثیررکنی جس میں سب سے زیادہ طاقت جفت ہو  کا کم سے کم ایک افقی مماس پایا جاتا ہے۔
\item
ہر ایسے کثیررکنی جس میں سب سے زیادہ طاقت طاق ہو  کا کم سے کم ایک افقی مماس پایا جاتا ہے۔
\end{enumerate}
\انتہا{سوال}
%=======================
...
\ابتدا{جواب}
\wf{\unexpanded{
\عددی{y'=0} اور \عددی{y''=0} کے صفر بالترتیب نقطہ انتہا اور نقطہ تصریف ہیں۔ تصریف \عددی{x=-\sqrt[3]{2}} پر اور مقامی زیادہ سے زیادہ \عددی{x=-2} پر ہیں۔ \\
\begin{minipage}{0.45\textwidth}
\centering
\begin{tikzpicture}[font=\small]
...
\begin{enumerate}
\item
\عددی{k=0} اور  اس کی قریبی مثبت اور منفی قیمتوں کے لئے \عددی{f(x)=x^3+kx} کو ایک ساتھ ترسیم کریں۔\عددی{k} کی قیمت کی ترسیم کی صورت پر کیا اثر پایا جاتا ہے؟
\item
...
%=========================
\ابتدا{سوال}
گزشتہ سوال میں چوکور سروں کے بجائے چوکور اطراف تصور کریں۔یوں ڈبے کا حجم \عددی{h\times h\times w} اور  گولائی \عددی{2h+2w} ہو گی۔ اب ڈبے کی زیادہ سے زیادہ حجم کیا ہو گی؟
\انتہا{سوال}
%=================
