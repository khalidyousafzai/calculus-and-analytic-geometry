...
(ا) ایک مستطیل ڈبہ کی لمبائی اور گولائی کا مجموعہ \عددی{\SI{108}{\centi\meter}} ہے (شکل \حوالہ{شکل_سوال_استعمال_ڈبہ_حجم_الف})۔ اس ڈبے  کے سر چوکور ہیں۔اس ڈبے کا زیادہ سے زیادہ حجم کیا ہو سکتا ہے؟   (ب) اس ڈبے کی لمبائی بالمقابل حجم ترسیم کریں اور جزو-الف کے جواب کے ساتھ موازنہ کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%=========================
\ابتدا{سوال}
مکعب اور کرہ کی سطحی رقبوں کے مجموعے کو مستقل رکھیں۔ مکعب کے ضلع اور کرہ کے رداس کی کون سی نسبت (ا) اقل، (ب) زیادہ سے زیادہ مجموعی حجم دے گی؟
\انتہا{سوال}
%=============================
...
%=======================
\ابتدا{سوال}
\عددی{a} کی کس قیمت کے لئے \عددی{f(x)=x^2+\tfrac{a}{x}} کا (ا) \عددی{x=2} پر مقامی اقل قیمت ہو گی، (ب) \عددی{x=1} پر نقطہ تصریف ہو گا۔
\انتہا{سوال}
%========================
\ابتدا{سوال}
\عددی{a} اور \عددی{b} کی کون سی قیمتوں کے لئے \عددی{f(x)=x^3+ax^2+bx} کی (ا) \عددی{x=-1} پر مقامی اعظم اور \عددی{x=3} پر مقامی اقل قیمت ہو گی، (ب) \عددی{x=4} پر مقامی اقل اور \عددی{x=1} پر نقطہ تصریف ہو گا۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%=======================
\ابتدا{سوال}
دکھائیں کہ \عددی{a} کی کسی بھی قیمت کے لئے \عددی{f(x)=x^2+\tfrac{a}{x}} کی مقامی اقل قیمت نہیں پائی جاتی ہے۔
\انتہا{سوال}
%========================
\ابتدا{سوال}
\begin{enumerate}[a.]
...
شکل \حوالہ{شکل_استعمال_منحنی_کا_مماس} کی علامتیت استعمال کرتے ہوئے، نقطہ \عددی{(a,f(a))} سے گزرتے ہوئے مماس کی نقطہ و ڈھلوان مساوات
\begin{align*}
y=f(a)+f'(a)(x-a)
\end{align*}
...
\end{align*}
ان حساب سے اس غلط فہمی میں مبتلا مت ہونا کہ خط بندی استعمال کرتے ہوئے جو بھی کرنا ممکن ہو، کیلکولیٹر کا استعمال اس سے بہتر ہو گا۔ حقیقت میں ہم کبھی بھی خط بندی سے جذر تلاش نہیں کریں گے۔ خط بندی کی افادیت اس حقیقت میں ہے کہ وقفہ دلچسپی پر ہم پیچیدہ کلیہ کی جگہ سادہ کلیہ استعمال کر پاتے ہیں۔ اگر ہمیں \عددی{0} کے قریب \عددی{x} کی قیمتوں کے لئے \عددی{\sqrt{1+x}} کے ساتھ کام کرنا ہو اور ہم معمولی خلل کو برداشت کر سکتے ہوں تب بہتر ہو گا کہ اس کے  بجائے ہم \عددی{1+\tfrac{x}{2}} کے ساتھ کام کریں۔ ظاہر ہے ایسی صورت میں ہم جاننا چاہیں گے کہ ایسا کرنے سے کتنا خلل پیدا ہو گا۔ ایسے خلل پر باب \حوالہ{باب_لامتناہی_تسلسل} میں غور کیا جائے گا۔
...
%=======================
\ابتدا{سوال}
گھڑیال کی لٹکن کی لمبائی اٹل رکھنے کی خاطر اس کا درجہ حرارت برقرار رکھا جاتا ہے۔ لٹکن کا دوری عرصہ \عددی{T} لٹکن کی لمبائی \عددی{L} اور کروی اسراع \عددی{g} پر منحصر ہے۔یوں سطح زمین پر گھڑیال کو ایک جگہ سے دوسری جگہ منتقل کرنے سے \عددی{g} کی مقامی قیمت میں معمولی تبدیل کی وجہ سے  \عددی{T} میں معمولی تبدیلی پیدا ہو گی۔\عددی{\Delta T} پر نظر رکھنے سے \عددی{g} میں تبدیلی \عددی{T=2\pi\sqrt{\tfrac{L}{g}}} سے حاصل کی جا سکتی ہے۔
\begin{enumerate}[a.]
\item
...
قابل تفرق منحنی کو بڑا کرنے سے  مقامی نقطے پر منحنی سیدھا خط نما نظر آتا ہے۔اس حقیقت کو استعمال کرتے ہوئے کسی بھی نقطے پر منحنی کا تفرق ترسیم کا  ڈھلوان ناپ کر حاصل کیا جا سکتا ہے۔ 
\begin{enumerate}[a.]
\item
...
چونکہ ترکیب نیوٹن کی مرکوزیت بہت تیز ہے (جس پر جلد بات کی جائے گی) لہٰذا  عموماً  کیلکولیٹر جذر کا حصول ترکیب نیوٹن سے تلاش کرتے ہیں۔اگر درج بالا جدول میں \عددی{5} کے  بجائے \عددی{13} اعشاریہ درست ہندسے  لیے جاتے تب اگلے قدم میں \عددی{\sqrt{2}} کی قیمت \عددی{10} اعشاریہ درست حاصل ہوتی۔ 
...
سازگار حالات میں ترکیب نیوٹن کی جذر \عددی{r} کو ارتکاز کی رفتار درج ذیل اعلیٰ احصاء کا کلیہ دیتا ہے
...
\end{align} 
جہاں \عددی{c} مستقل ہے، اور اعظم قیمت اور اقل قیمت \عددی{r} پر وقفہ میں پائی جاتی اعظم اور اقل  قیمتیں ہیں۔ درج بالا کلیہ کہتا ہے کہ قدم \عددی{n+1} میں خلل کی قیمت قدم \عددی{n} میں خلل کی قیمت کے مربع ضرب مستقل سے زیادہ نہیں ہو گی۔ اس بات کی گہرائی سمجھنے کی خاطر فرض کریں کہ \عددی{c\le 1} ہے اور \عددی{\abs{x_n-r}<10^{-3}} ہے تب \عددی{\abs{x_{n+1}-r}<10^{-6}} ہو گا۔یوں ایک ہی قدم میں درستگی \عددی{3} اعشاریہ سے \عددی{6} اعشاریہ ہو گئی ہے۔ 
...
%=======================
\ابتدا{سوال}
\عددی{\pi} کی قیمت کا تخمینہ مساوات \عددی{\tan x=0} کے حل سے حاصل کیا جا سکتا ہے۔نقطہ \عددی{x_0=3} سے شروع کرتے ہوئے ترکیب نیوٹن  سے، کیلکولیٹر کے استعمال کے ساتھ،  \عددی{\pi} کی قیمت جتنے اعشاریہ درستگی تک ممکن ہو حاصل کریں۔ 
\انتہا{سوال}
%===================
