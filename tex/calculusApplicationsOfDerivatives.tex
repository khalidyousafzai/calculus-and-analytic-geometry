...
g(x)=f(a)+\frac{f(b)-f(a)}{b-a}(x-a)&&\text{\RL{(نقطوی و ڈھلوان روپ)}}
\end{align} 
...
شکل \حوالہ{شکل_استعمال_منحنی_کا_مماس} کی علامتیت استعمال کرتے ہوئے، نقطہ \عددی{(a,f(a))} سے گزرتے ہوئے مماس کی نقطوی و ڈھلوان مساوات درج ذیل ہے۔
\begin{align*}
y=f(a)+f'(a)(x-a)
\end{align*}
