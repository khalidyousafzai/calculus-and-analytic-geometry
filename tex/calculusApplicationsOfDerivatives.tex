...
فرض کریں تفاعل \عددی{f} کا دائرہ کار \عددی{D} ہے۔نقطہ \عددی{c} پر تفاعل \عددی{f} کی مطلق اعظم قیمت  تب پائی جائے گی جب \عددی{D} میں تمام \عددی{x} کے لئے درج ذیل ہو
\begin{align*}
f(x)\le f(c)
\end{align*}
اور \عددی{D} میں \عددی{c} پر تب \عددی{f} کی مطلق اقل قیمت  پائی جائے گی  جب \عددی{D} میں تمام \عددی{x} کے لئے درج ذیل ہو۔
\begin{align*}
f(x)\ge f(c)
\end{align*} 
\انتہا{تعریف}
...
تفاعل \عددی{f} کا کھلے دائرہ کار \عددی{D} میں اندرونی نقطہ \عددی{c} پر اس صورت مقامی اعظم قیمت پائی جائے گی جب \عددی{D} میں کسی بھی کھلے وقفہ جس میں \عددی{c} پایا جاتا ہو میں تمام \عددی{x} کے لئے
\begin{align*}
f(x)\le f(c)
\end{align*}
...
جیسا درج ذیل مسئلہ سمجھاتا ہے تفاعل کی   انتہا کے  حصول کے لئے  چند قیمتوں کی تحقیق ضروری ہو گی۔
...
یوں مقامی اعظم قیمت کے لئے مسئلہ ثابت ہوا۔مقامی اقل قیمت کے لئے مسئلہ ثابت کرنے کے لئے \عددی{f(x)\ge f(c)} استعمال کرنا ہو گا جس سے مساوات \حوالہ{مساوات_استعمال_یک_درجی_تفرق_الف} اور مساوات \حوالہ{مساوات_استعمال_یک_درجی_تفرق_ب} کی عدم مساوات الٹ ہو جاتی ہیں۔
\begin{figure}
\centering
...
اگرچہ تفاعل کی انتہا صرف نقطہ فاصل اور آخری نقطوں پر پائی جا سکتی ہیں، ضروری نہیں  کہ ہر نقطہ فاصل یا ہر آخری نقطے   پر انتہا قیمت پائی جاتی ہو۔ شکل \حوالہ{شکل_مثال_استعمال_نقطہ_فاصل_نہیں_الف} اور شکل \حوالہ{شکل_مثال_استعمال_نقطہ_فاصل_نہیں_ب} اندرونی نقطوں کے لئے اس حقیقت کی وضاحت کرتی ہے اور سوال \حوالہ{سوال_استعمال_نا_مقامی_زیادہ_نا_مقامی_کم} میں آپ سے ایسا تفاعل پیش کرنے کو کہا گیا ہے جو اپنے دائرہ کار کے آخری نقطوں پر انتہائی قیمت اختیار نہیں کرتا۔
\begin{figure}
\centering
\begin{minipage}{0.45\textwidth}
\centering
...
\ابتدا{مثال}
ایک گاڑی ساکن حال سے شروع ہر کر \عددی{8} سیکنڈوں میں کل \عددی{120} میٹر فاصلہ طے کرتی ہے۔ان \عددی{8} سیکنڈوں کے لئے گاڑی کی اوسط رفتار \عددی{\tfrac{120}{8}=\SI{15}{\meter\per\second}} ہے۔ مسئلہ اوسط قیمت کہتا ہے  کہ  ان آٹھ سیکنڈوں میں کسی  ایک لمحے رفتار پیما ٹھیک یہی رفتار دکھائے گا۔
\انتہا{مثال}
%=======================
...
%====================
\ابتدا{سوال}
وقفہ \عددی{[0,2]} پر \عددی{a}، \عددی{m}،  اور \عددی{b} کی کون سی قیمتوں کے لئے  درج ذیل تفاعل مسئلہ اوسط قیمت کے قیاس کو مطمئن کرتا ہے؟
\begin{align*}
...
%===================
\ابتدا{سوال}
دکھائیں  \عددی{a} اور \عددی{b} کی کسی بھی قیمتوں کے لئے \عددی{\abs{\sin b-\sin a}\le\abs{b-a}} ہو گا۔
\انتہا{سوال}
%======================
\ابتدا{سوال}
...
دو مثبت اعداد \عددی{a} اور \عددی{b} کے  \اصطلاح{ہندسی اوسط}\فرہنگ{اوسط!ہندسی}\حاشیہب{geometric mean}\فرہنگ{mean!geometric} سے مراد عدد \عددی{\sqrt{ab}} ہے۔دکھائیں کہ  مسئلہ اوسط قیمت کے نتیجہ میں مثبت اعداد کے وقفہ \عددی{[a,b]}  پر تفاعل \عددی{f(x)=\tfrac{1}{x}} کے لئے \عددی{c} کی قیمت \عددی{\sqrt{ab}} ہے۔ 
\انتہا{سوال}
%=======================
\ابتدا{سوال}\ترچھا{حسابی اوسط۔}\quad
دو اعداد \عددی{a} اور \عددی{b} کا  \اصطلاح{حسابی اوسط}\فرہنگ{اوسط!حسابی}\حاشیہب{arithmetic mean}\فرہنگ{mean!arithmetic} \عددی{\tfrac{a+b}{2}} ہے۔ دکھائیں کہ مسئلہ اوسط قیمت میں وقفہ \عددی{[a,b]} پر تفاعل \عددی{f(x)=x^2} کے لئے \عددی{c} کی قیمت \عددی{\tfrac{a+b}{2}} ہو گی۔
\انتہا{سوال}
%=========================
...
\end{enumerate}
تب \عددی{a} اور \عددی{b} کے بیچ \عددی{f} کا ٹھیک ایک صفر پایا جائے گا۔چونکہ یہ پورے \عددی{[a,b]} پر بڑھ رہا ہے اور یا  پورے \عددی{[a,b]} پر گھٹ رہا ہے لہٰذا یہ محور \عددی{x} کو ایک ہی مرتبہ قطع کر سکتا ہے۔اس کے باوجود مسئلہ \حوالہ{مسئلہ_حد_متوسط_قیمت} کے تحت اس کا کم سے کم ایک صفر ہو گا۔ مثال کے طور پر \عددی{[-1,1]} پر \عددی{f(x)=x^3+3x+1} قابل تفرق ہے، \عددی{f(-1)=-3} اور \عددی{f(1)=5} کی علامتیں ایک دوسرے کی الٹ ہیں، اور تمام \عددی{x} کے لئے \عددی{f'(x)=3x^2+3>0} ہے  لہٰذا \عددی{[-1,1]} پر \عددی{f} کا ٹھیک ایک صفر پایا جاتا ہے (شکل \حوالہ{شکل_استعمال_یک_صفر_مثال})۔
\begin{figure}
\centering
\begin{tikzpicture}[font=\small]
...
اس حصے میں مقامی انتہائی قیمت کی  موجودگی کے لئے تفاعل کے نقطہ فاصل  کو پرکھنا دکھایا جائے گا۔ 
...
درج ذیل کے لئے وہ وقفے  تلاش کریں جہاں \عددی{f} گھٹتا ہو  اور  جہاں \عددی{f} بڑھتا ہو۔
\begin{align*}
...
ہم نے حصہ \حوالہ{حصہ_استعمال_تفاعل_کی_انتہائی_قیمتیں} میں تفاعل کی انتہا  قیمتوں کی تلاش میں یک رتبی تفرق کا کردار دیکھا۔ تفاعل کے   نقاط انتہا صرف نقطہ فاصل اور تفاعل  کے دائرہ کار کے آخری نقطوں  پر پائے جاتے ہیں۔ ہم نے یہ بھی دیکھا کہ نقطہ فاصل پر نقطہ انتہا کی موجودگی لازمی نہیں۔ہم نے حصہ \حوالہ{حصہ_استعمال_مسئلہ_اوسط_قیمت} میں یہ بھی دیکھا کہ قابل تفرق تفاعل کی تقریباً تمام معلومات اس کے تفرق میں سمیٹی گئی ہیں۔مکمل تفاعل کے حصول کے لئے  ہمیں صرف کسی ایک نقطے  پر تفاعل کی قیمت درکار ہوتی ہے۔اگر تفاعل کا تفرق \عددی{2x} ہے اور تفاعل مبدا سے گزرتا ہو تب تفاعل لازماً \عددی{x^2} ہو گا۔اگر تفاعل کا تفرق \عددی{2x} ہو اور تفاعل نقطہ \عددی{(0,4)} سے گزرتا ہو تب تفاعل لازماً  \عددی{x^2+4} ہو گا۔
...
%=======================
\ابتدا{سوال}
\عددی{x>0} کے لئے ایسا تفاعل \عددی{y=f(x)} ترسیم کرین جس کا \عددی{f(1)=0} اور \عددی{f'(x)=\tfrac{1}{x}} ہے۔ کیا تفاعل کے مقعر کے بارے میں کچھ کہنا ممکن ہو گا؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
%======================
\ابتدا{سوال}
...
\begin{enumerate}
\item
\عددی{k=0} اور  اس کی قریبی مثبت اور منفی قیمتوں کے لئے \عددی{f(x)=x^3+kx} کو ایک ساتھ ترسیم کریں۔\عددی{k} کی قیمت کا ترسیم کی شکل و صورت پر کیا اثر پایا جاتا ہے؟
\item
\عددی{f''(x)} تلاش کریں۔آپ دیکھیں گے کہ \عددی{f''(x)} دو درجی مساوات ہے۔ \عددی{f''(x)} کا ممیز تلاش کریں (\عددی{ax^2+bx+c} کا ممیز \عددی{b^2-4ac} ہے)۔ \عددی{k} کی کن قیمتوں کے لئے ممیز مثبت ہے؟ صفر ہے؟ منفی ہے؟ \عددی{k} کی کن قیمتوں کے لئے \عددی{f'(x)} کے  صفروں کی تعداد دو ہے؟ ایک ہے؟  صفر ہے؟ اب بتائیں کہ \عددی{k} کی قیمت کا \عددی{f(x)} کی ترسیم کی شکل و  صورت کے ساتھ کیا تعلق ہے۔
\item
...
\begin{enumerate}[a.]
\item
\عددی{k=-4} اور اس کی  قریبی قیمتوں کے لئے  ایک ساتھ \عددی{-1\le x\le 4} پر \عددی{f(x)=x^4+kx^3+6x^2} ترسیم کریں۔ \عددی{k} کی قیمت ترسیم کی  شکل و صورت پر کس طرح اثر انداز ہوتی ہے؟
\item
\عددی{f''(x)} تلاش کریں۔آپ دیکھیں گے کہ \عددی{f''(x)} دو درجی مساوات ہے۔ \عددی{f''(x)} کا ممیز تلاش کریں (\عددی{ax^2+bx+c} کا ممیز \عددی{b^2-4ac} ہے)۔ \عددی{k} کی کن قیمتوں کے لئے ممیز مثبت ہے؟ صفر ہے؟ منفی ہے؟ \عددی{k} کی کن قیمتوں کے لئے \عددی{f'(x)} کے  صفروں کی تعداد دو ہے؟ ایک ہے؟  صفر ہے؟ اب بتائیں کہ \عددی{k} کی قیمت کا \عددی{f(x)} کی ترسیم کی شکل و  صورت کے ساتھ کیا تعلق ہے۔
\end{enumerate}
\انتہا{سوال}
...
\begin{enumerate}[a.]
\item
\عددی{-3\le x\le 3} کے لئے \عددی{y=x^{2/3}(x^2-2)} ترسیم کریں۔اس کے بعد احصاء کے استعمال سے مقعر، اٹھان اور نیچے گرنے کی تصدیق کریں۔ (ہو سکتا ہے کہ آپ کو کمپیوٹر میں \عددی{x^{2/3}} کو \عددی{(x^2)^{1/3}} لکھنا پڑے۔)
\item
...
تفاعل \عددی{f(x)=\tfrac{1}{x}} تمام \عددی{x\ne 0} کے لئے معین ہے۔ مثبت اور بتدریج بڑھتی \عددی{x}  کے لئے \عددی{\tfrac{1}{x}} کی قیمت بتدریج  گھٹے گی۔ منفی \عددی{x} جس کی مقدار بتدریج بڑھتی ہو  کے لئے \عددی{\tfrac{1}{x}} کی مقدار بتدریج  گھٹے گی۔ ہم مختصراً کہتے ہیں کہ \عددی{x\to\mp\infty} پر \عددی{f(x)=\tfrac{1}{x}} کی حد \عددی{0} ہے۔ 
\begin{figure}
\centering
\begin{tikzpicture}
...
\end{align}
ہم مستقل تفاعل کی حد سوال \حوالہ{سوال_استعمال_تصدیق_حد_الف} اور سوال \حوالہ{سوال_استعمال_تصدیق_حد_ب} کے لئے  رکھتے ہیں جبکہ دوسرے تفاعل کو یہاں ثابت کرتے ہیں۔
...
\begin{enumerate}[a.]
\item
فرض کریں \عددی{\epsilon>0} دیا گیا ہے۔ہمیں ایسا عدد \عددی{M} تلاش کرنا ہے کہ تمام \عددی{x} کے لئے درج ذیل مطمئن ہو۔
\begin{align*}
...
\item
فرض کریں \عددی{\epsilon>0} دیا گیا ہے۔ہمیں ایسا عدد \عددی{N} تلاش کرنا ہے کہ تمام \عددی{x} کے لئے درج ذیل مطمئن ہو۔
\begin{align*}
...
\جزوحصہء{ناطق تفاعل کے لئے خلاصہ}
\begin{enumerate}[a.]
\item 
...
مساوات \حوالہ{مساوات_مثال_استعمال_بیلن_چادر_الف} کو \عددی{h} کے لئے حل کرتے ہوئے:
\begin{align*}
h=\frac{1000}{\pi r^2}
\end{align*}
...
\end{align*}
\عددی{r} کی چھوٹی قیمت کے لئے \عددی{\tfrac{2000}{r}} جزو غالب ہو گا جس کی وجہ سے \عددی{S} کی قیمت بڑی ہو گی۔ ٹین کا ڈبہ نلکی یا پائپ نما ہو گا۔ \عددی{r} کی بڑی قیمت کے لئے \عددی{2\pi r^2} جزو غالب ہو گا جس کی وجہ سے \عددی{S} کی قیمت بڑی ہو گی۔ ٹین کا ڈبہ چپٹی صورت کا ہو گا۔ \عددی{r} کی مذکورہ بالا قیمتوں کے بیچ کہیں سطحی رقبہ  اقل  ہو گا۔

\عددی{S} اپنے پورے دائرہ کار \عددی{(0,r)} میں قابل تفرق ہے لہٰذا  \عددی{S}  کی اقل قیمت تلاش کرنے کی خاطر اس کے تفرق کو صفر کے برابر پُر کرتے ہوئے نقطہ فاصل \عددی{r} کے لئے حل کرتے ہیں۔ 
\begin{align*}
...
\end{align*}
ہو گا۔\عددی{A} سے \عددی{B} تک پہنچنے کے لئے درکار کُل وقت دونوں کا مجموعہ ہو گا۔
...
بغیر ڈھکن ٹینکی جس کا تلا چوکور اور  حجم \عددی{\SI{256}{\meter\cubed}} ہو درکار ہے۔ یہ ٹینکی \عددی{\SI{1}{\centi\meter}} موٹی فولادی چادر سے بنائی جائے گی۔ بطور انجنیئر آپ کا کام ہے کہ ہلکی ترین ٹینکی بنانے کے لئے ٹینکی کے اضلاع تلاش کریں۔ اضلاع کیا ہوں گے؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%===================
\ابتدا{سوال}
ایک مستطیل اشتہار میں \عددی{\SI{50}{\centi\meter\squared}} رقبے پر لکھائی ہو گی۔بالائی اور نچلی جانب \عددی{\SI{4}{\centi\meter}} اور اطراف پر \عددی{\SI{2}{\centi\meter}} خالی جگہ ہو گی۔کم سے کم کاغذ استعمال کرنے کے لئے مستطیل اشتہار کے اضلاع کیا ہوں گے؟ 
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
ایک مستطیل شیشہ کے اوپر نصف دائری شیشہ مل کر کھڑکی بناتے ہیں (شکل \حوالہ{شکل_سوال_استعمال_کھڑکی})۔مستطیل شیشہ شفاف   جبکہ نصف دائری شیشہ ہلکا سیاہ ہے اور فی مربع رقبہ نصف روشنی کو گزرنے دیتا ہے۔ کھڑکی کا محیط مستقل ہے۔زیادہ سے زیادہ روشنی کے لئے کھڑکی کی جسامت تلاش کریں۔ 
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\ابتدا{سوال}\شناخت{سوال_استعمال_پانی_نالی}
 پانی کی نالی تعمیر کرنی ہے جس کی جسامت شکل \حوالہ{شکل_سوال_استعمال_پانی_نالی} میں دکھائی گئی ہے۔ صرف زاویہ \عددی{\theta} متغیر ہے۔ زیادہ سے زیادہ حجم کے لئے \عددی{\theta} کی قیمت تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tfrac{\pi}{6}$
...
\item
وقفہ \عددی{0\le t\le 6} کے لئے \عددی{x} بالمقابل \عددی{t} ترسیم کریں۔اسی وقفہ کے لئے \عددی{\tfrac{\dif x}{\dif t}} بالمقابل \عددی{t} کو بھی ترسیم کریں۔ ترسیمات کا  آپس میں اور حاصل جوابات کے ساتھ موازنہ کریں۔
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%=======================
\ابتدا{سوال}
\عددی{a} کی کس قیمت کے لئے \عددی{f(x)=x^2+\tfrac{a}{x}} (ا)  کی \عددی{x=2} پر مقامی اقل قیمت ہو گی، (ب) \عددی{x=1} پر نقطہ تصریف ہو گا۔
\انتہا{سوال}
%========================
\ابتدا{سوال}
\عددی{a} اور \عددی{b} کی کون سی قیمتوں کے لئے \عددی{f(x)=x^3+ax^2+bx}  (ا)  کی \عددی{x=-1} پر مقامی اعظم اور \عددی{x=3} پر مقامی اقل قیمت ہو گی، (ب)کا  \عددی{x=4} پر مقامی اقل اور \عددی{x=1} پر نقطہ تصریف ہو گا۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%=======================
\ابتدا{سوال}
دکھائیں کہ \عددی{a} کی کسی بھی قیمت کے لئے \عددی{f(x)=x^2+\tfrac{a}{x}} کی مقامی اقل قیمت نہیں پائی جاتی۔
\انتہا{سوال}
%========================
\ابتدا{سوال}
\begin{enumerate}[a.]
...
\end{align*}
اگرچہ ہمیں یہاں معلوم نہیں   خلل کتنا چھوٹا ہو گا (جسے جاننے کے لئے ہمیں باب \حوالہ{باب_لامتناہی_تسلسل} کا انتظار کرنا ہو گا) یہ ضروری ہے کہ اس مساوات کی صورت پر ہم غور کریں۔
...
%=========================
\ابتدا{سوال}
گزشتہ سوال کو \عددی{2} کے بجائے \عددی{0.5} کے لئے دہرائیں۔ اب کیا دیکھنے کو ملتا ہے؟ کیا \عددی{2} کی جگہ کوئی بھی مثبت عدد \عددی{x} استعمال کیا جا سکتا ہے؟ وجہ بیان کریں۔
\انتہا{سوال}
%===========================
\موٹا{کمپیوٹر کا استعمال}\\
...
اس زمرے میں نظریہ بھی کچھ مدد مہیا کرتا ہے۔ اعلیٰ احصاء کا ایک مسئلہ کہتا ہے کہ جذر \عددی{r} پر وقفہ (جس میں \عددی{r} پایا جاتا ہو) میں تمام \عددی{x} کے لئے
\begin{align}\label{مساوات_استعمال_مرکوزیت_نیوٹن_الف}
\abs{\frac{f(x)f''(x)}{[f'(x)]^2}}<1
\end{align}
کی صورت میں  وقفہ کے اندر کسی بھی ابتدائی نقطہ \عددی{x_0} کے لئے ترکیب مرتکز ہو گی۔حقیقت میں اس مسئلے کا اطلاق مشکل ثابت ہوتا ہے لہٰذا \عددی{f(x_n)} اور \عددی{\abs{x_n-x_{n+1}}} کی قیمتوں سے مرکوزیت دیکھی جاتی ہے۔
...
ترکیب نیوٹن سے جذر کا حصول ابتری کا شکار ہو سکتا ہے یعنی  مساوات کے لئے حاصل جذر کی قیمت ابتدائی نقطے کے  مقام  کو بہت حساس ہو گی۔
