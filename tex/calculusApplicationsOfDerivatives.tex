...
اگر \عددی{y=f(x)} کا دو رتبی تفرق موجود ہو تب ہم مسئلہ اوسط قیمت کا نتیجہ صریح \حوالہ{نتیجہ_صریح_استعمال_سوم} استعمال کرتے ہوئے اخذ کر سکتے ہیں کہ \عددی{y''>0} کی صورت میں \عددی{y'} کی قیمت بڑھے گی اور \عددی{y''<0} کی صورت میں \عددی{y'} کی قیمت گھٹے گی۔ 
