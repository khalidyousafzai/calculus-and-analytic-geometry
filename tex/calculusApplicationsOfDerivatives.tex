...
\ابتدا{مثال}
ایک گاڑی ساکن حال سے شروع ہر کر \عددی{8} سیکنڈوں میں کُل \عددی{120} میٹر فاصلہ طے کرتی ہے۔ان \عددی{8} سیکنڈوں کے لیے گاڑی کی اوسط رفتار \عددی{\tfrac{120}{8}=\SI{15}{\meter\per\second}} ہے۔ مسئلہ اوسط قیمت کہتا ہے  کہ  ان آٹھ سیکنڈوں میں کسی  ایک لمحے رفتار پیما ٹھیک یہی رفتار دکھائے گا۔
\انتہا{مثال}
%=======================
...
%=================================
\ابتدا{سوال}
ایک بیلنی گودام  تعمیر کرنی ہے جس کی چھت نصف کروی ہو گی۔ فی مربع سطحی رقبہ نصف کرہ پر لاگت بیلنی دیوار کی فی مربع سطحی رقبہ کی لاگت سے دگنی ہے۔مستقل حجم کی صورت میں کم سے کم کُل لاگت کے لیے گودام کی جسامت تلاش کریں۔تعمیر میں نچلی سطح (زمین) پر لاگت اور ضیاع کو نظر انداز کریں۔ 
\انتہا{سوال}
%==============================
...
\end{enumerate}
کُل لاگت  \عددی{6000} روپیہ کی مستقل مقدار اور فی فرد \عددی{32} روپیہ ہے۔زیادہ سے زیادہ منافع کے لیے کتنے افراد درکار ہیں؟   
\انتہا{سوال}
%==========================
...
چونکہ ترکیب نیوٹن کا ارتکاز بہت تیز ہے (جس پر جلد بات کی جائے گی)  زیادہ تر کیلکولیٹر جذر کو  ترکیب نیوٹن سے تلاش کرتے ہیں۔اگر درج بالا جدول میں \عددی{5} کے  بجائے \عددی{13} اعشاریہ مقامات تک درست ہندسے  لیے جاتے تب اگلے قدم میں \عددی{\sqrt{2}} کی قیمت \عددی{10} اعشاریہ مقامات تک درست حاصل ہوتی۔ 
...
ترکیب نیوٹن بہت تیزی سے مرتکز ہوتا ہے، لیکن چونکہ ارتکاز لازمی نہیں  لہٰذا یہ دیکھنا لازم  ہو گا کہ آیا ترکیب مرتکز ہے یا نہیں۔ ارتکاز یقینی بنانے کی خاطر ہم تفاعل ترسیم کر کے موزوں ابتدائی نقطہ \عددی{x_0} منتخب کر سکتے ہیں۔ صفر کے قریب ہونے کو \عددی{\abs{f(x_n)}} کی قیمت سے دیکھا جا سکتا ہے جبکہ ارتکاز کو \عددی{\abs{x_n-x_{n+1}}} سے پرکھا جا سکتا ہے۔
...
\end{align}
کی صورت میں  وقفہ کے اندر کسی بھی ابتدائی نقطہ \عددی{x_0} کے لیے ترکیب مرتکز ہو گی۔حقیقت میں اس مسئلے کا اطلاق مشکل ثابت ہوتا ہے لہٰذا \عددی{f(x_n)} اور \عددی{\abs{x_n-x_{n+1}}} کی قیمتوں سے ارتکاز دیکھا جاتا ہے۔

عدم مساوات \حوالہ{مساوات_استعمال_مرکوزیت_نیوٹن_الف} ارتکاز کے لیے \اصطلاح{کافی} نا کہ لازمی شرط ہے۔ایسی مثالیں پائی جاتی ہیں جہاں جذر \عددی{r} پر ایسا کوئی وقفہ نہیں پایا جاتا   جس پر عدم مساوات \حوالہ{مساوات_استعمال_مرکوزیت_نیوٹن_الف} مطمئن ہوتی ہو لیکن ترکیب نیوٹن مرتکز ہوتی ہے۔ ایسے تمام وقفے پر ترکیب نیوٹن مرتکز ہو گی جس میں \عددی{x_0} اور درکار جذر کے بیچ وقفے پر منحنی \عددی{y=f(x)} محور \عددی{x} کی طرف محدب (جھکا) ہو (شکل \حوالہ{شکل_استعمال_نیوٹن_مرکوزیت})۔
...
\end{tikzpicture}
\caption{ترکیب نیوٹن کا عدم ارتکاز۔}
