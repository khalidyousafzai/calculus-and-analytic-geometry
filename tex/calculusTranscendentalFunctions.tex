...
قوس \عددی{y=4\cosh(\tfrac{x}{4}),\, -\ln 16\le x\le \ln 81} کو محور \عددی{x} کے گرد گھما کر سطح طواف پیدا کی جاتی ہے (شکل \حوالہ{شکل_سوال_ماورائی_کمتر_سطح})۔  سطح طواف کا رقبہ تلاش کریں۔
