...
\end{align*}
ہو گی۔ یاد رہے کہ ہر مہینہ روپیہ کا قدر کم ہو گا لہٰذا پہلے مہینہ کے \عددی{40000} اور آخری مہینہ کے \عددی{40000} روپیہ کے قدر ایک جیسے نہیں ہوں گے۔ہم حساب کو آسان بنانے کی خاطر تصور کرتے ہیں کہ اس شخص کو ماہوار کے بجائے ہر سال \عددی{\num{40000}\times 12=\num{480000}} روپیہ ملتے ہیں جن کی اصل قدر
\begin{align*}
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) ایک جیسا (ب) تیز (ج) ایک جیسا (د) ایک جیسا (ہ) آہستہ \\
(و) تیز (ز) آہستہ (ح) ایک جیسا 
}}
\انتہا{جواب}
%======================
\ابتدا{سوال}
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) ایک جیسا (ب) ایک جیسا (ج) ایک جیسا (د) تیز \\
(ہ) تیز (و) ایک جیسا (ز) آہستہ (ح) تیز 
}}
\انتہا{جواب}
%======================
\ابتدا{سوال}
