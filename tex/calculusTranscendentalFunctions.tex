...
سالانہ \اصطلاح{افراط زر}\فرہنگ{ افراطزر  }\حاشیہب{inflation}\فرہنگ{inflation} سے مراد ایک سال میں روپیہ کی قدر میں کمی ہے۔ یوں \عددی{\SI{10}{\percent}} افراط زر کا مطلب ہے کہ ایک سال بعد روپیہ کی قیمت \عددی{\SI{90}{\percent}} ہو گی۔
 ...
 ایک شخص \عددی{\num{5000000}} روپیہ بنک میں پانچ سال کے لیے جمع کرتا ہے۔بنک ہر مہینہ اس شخص کو \عددی{\num{40000}} روپیہ دیگا اور پانچ سال کے آخر میں اس کو پورے \عددی{5000000} روپیہ واپس کرے گا۔ اگر سالانہ افراطزر     \عددی{\SI{12}{\percent}} ہو تب اس شخص نے کیا پایا اور کیا کھویا؟
...
ہم دیکھتے ہیں کہ مثال \حوالہ{مثال_ماورائی_قاعدہ_لھوپیٹال_الف} کے جزو-ج میں قاعدہ لھوپیٹال کے استعمال کے باوجود \عددی{\tfrac{0}{0}} حاصل ہوتا ہے۔ قاعدہ لھوپیٹال کا  پائیدار  روپ کہتا ہے   جب تک یہ قاعدہ  \عددی{\tfrac{0}{0}}   دے ہم  قاعدہ مزید ایک مرتبہ استعمال کر سکتے ہیں۔ آئیے  درج بالا  مثال  کا  جزو-ج  حل کرتے ہیں۔
\begin{align*}
...
\end{align*}
ہے،  لہٰذا قاعدہ لھوپیٹال درج ذیل دیگا۔
\begin{align*}
...
\end{align*} 
اس کے باوجود محور \عددی{x} پر آپ مبدا سے صرف \عددی{\SI{43}{\centi\meter}} فاصلہ پر ہوں گے۔
...
قوت نما، کثیررکنی اور لوگارتھمی تفاعل کا ایک دوسرے کے ساتھ مذکورہ بالا موازنہ کو زیادہ درستگی سے بیان کرنے کی خاطر ہم ایک تعریف پیش کرتے ہیں۔جب ہم کہتے ہیں کہ \عددی{x\to \infty} کرنے سے کسی بھی تفاعل \عددی{g(x)} کے بڑھنے کی شرح سے  تفاعل \عددی{f(x)} کے بڑھنے کی شرح زیادہ ہے تب اس سے مراد درج ذیل ہو گا۔
...
\end{align*}
ہے  جو غیر صفر اور متناہی حد ہے۔ زیادہ تیزی سے بڑھنے کے عمومی مطلب کو ہم اس لیے نظر انداز  کرتے ہیں کہ جب ہم کہیں کہ \عددی{x} کی بڑی قیمتوں کے لیے \عددی{f} کے بڑھنے کی شرح \عددی{g} کے بڑھنے کی شرح سے زیادہ ہے تب اس سے مراد \قول{\عددی{x} کی بڑی قیمتوں کے لیے \عددی{f} کے لحاظ سے \عددی{g} کی قیمت قابل نظر انداز ہے،} لینا چاہیے۔

\ابتدا{مثال}
\عددی{x\to\infty} کرتے ہوئے \عددی{x^2} کے لحاظ سے \عددی{e^x} درج ذیل کی وجہ سے زیادہ تیزی سے بڑھتا ہے۔
\begin{align*}
...
\end{align*}
(ب) \عددی{x\to\infty} کرتے ہوئے مختلف اساس کے قوت نما تفاعل کبھی بھی ایک شرح  سے نہیں بڑھتے۔اگر \عددی{a>b>0} ہو تب \عددی{a^x} کے بڑھنے کی شرح \عددی{b^x} کے بڑھنے کی شرح سے زیادہ ہو گی۔
\begin{align*}
...
%================
\ابتدا{مثال}
قوت نما تفاعل کے برعکس \عددی{x\to\infty} کرتے ہوئے مختلف اساس کے لوگارتھمی تفاعل ایک سی  شرح سے بڑھتے  ہیں:
\begin{align*}
...
\جزوحصہء{رتبہ اور \قول{o} علامتیت}
بڑے \عددی{O} اور چھوٹے \عددی{o} کی علامت کمپیوٹر سائنس میں عام استعمال ہوتی ہے۔ انہیں یہاں متعارف کیا جاتا ہے۔

\ابتدا{تعریف}
اگر \عددی{   x\to\infty} کرتے ہوئے \عددی{\lim_{x\to \infty}\frac{f(x)}{g(x)}=0} ہو تب  ہم کہتے ہیں کہ \عددی{f} کا رتبہ \عددی{g} سے کم ہے جس کو \عددی{f=o(g)}  سے ظاہر کیا جاتا ہے۔ اس کو \قول{\عددی{f}، \عددی{g} کا چھوٹا عددی{o} ہے} پڑھا جاتا ہے۔ 
\انتہا{تعریف}
%===================
...
تعریف پر دوبارہ نظر دوڑاتے ہوئے  آپ دیکھیں گے کہ کافی بڑے \عددی{x} پر مثبت تفاعل کے لیے  \عددی{f=o(g)}سے مراد \عددی{f=O(g)} ہے۔ اس کے علاوہ اگر \عددی{f} اور \عددی{g}  کے بڑھنے کی شرح ایک دوسرے جتنی ہو تب \عددی{f=O(g)} اور \عددی{g=O(f)} ہوں گے (سوال \حوالہ{سوال_ماورائی_ایک_برابر_شرح})۔ 

\جزوحصہ{ترتیبی اور ثنائی تلاش}
کمپیوٹر کسی لائحہ کار کے تحت قدم با قدم چل کر کوئی کام سر انجام دیتا ہے۔اس لائحہ کار کو \اصطلاح{کمپیوٹر الخوارزم}\فرہنگ{الخوارزم!کمپیوٹر}\حاشیہب{computer algorithm}\فرہنگ{algorithm} کہتے ہیں۔اس لائحہ کار کی کارگزاری جاننے کی خاطر ماہرین عموماً اس کام کو سرانجام کرنے کے لیے درکار قدموں کی گنتی کرتے ہیں۔ ایک ہی کام سرانجام دینے کے دو مختلف لائحہ کار کی کارگزاری میں بہت زیادہ فرق ہو سکتا ہے جنہیں بڑے \عددی{O} علامتی روپ میں پیش کیا جاتا ہے۔ آئیں ایک مثال دیکھتے ہیں۔

ایک لغت میں کسی ایک حرف سے شروع ہونے والے الفاظ کی تعداد  \عددی{\num{26000}} ہے۔ آپ اس حرف سے شروع ہونے والے ایک لفظ کو دو طریقوں سے تلاش کر سکتے ہیں۔ پہلی ترکیب میں آپ پہلے لفظ سے شروع کرتے ہوئے یک بہ یک لفظ پڑھ کر درکار لفظ تک پہنچتے ہیں۔ اس ترکیب کو \اصطلاح{ترتیبی تلاش}\فرہنگ{تلاش!ترتیبی}\حاشیہب{sequential search}\فرہنگ{search!sequential} کہتے ہیں جو لغت میں ترتیب سے الفاظ لکھے گئے ہونے سے استفادہ نہیں کرتا ہے۔ اس ترتیب میں آپ ہر صورت لفظ تلاش کر پائیں گے (یا جان جائیں گے کہ یہ لفظ لغت میں موجود نہیں ہے) لیکن عین ممکن ہے کہ آپ کو \عددی{\num{26000}} قدم چلنا پڑے۔
...
%======================
\ابتدا{سوال}
\عددی{x\to \infty} کرتے ہوئے کب کثیررکنی \عددی{f(x)} کا رتبہ کثیررکنی \عددی{g(x)} کے رتبہ سے کم ہو گا؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
%===================
\ابتدا{سوال}
\عددی{x\to \infty} کرتے ہوئے کب کثیررکنی \عددی{f(x)} کا رتبہ زیادہ سے زیادہ کثیررکنی \عددی{g(x)} کے رتبہ کے برابر ہو گا؟ اپنے جواب کی وجہ پیش
 کریں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\end{align*}
(ب) دکھائیں کہ درج ذیل کی قیمت ، مستقل\عددی{a} کی قیمت پر منحصر نہیں ہے۔ اس سے تفاعل \عددی{f(x)=\ln(x+a)} اور \عددی{g(x)=\ln x} کی اضافی شرح نمو کے بارے میں کیا کہا جا سکتا ہے؟
\begin{align*}
...
%=============================
\ابتدا{سوال}
دکھائیں کہ \عددی{x\to \infty} کرتے ہوئے \عددی{\sqrt{10x+1}} اور \عددی{\sqrt{x+1}} کی شرح نمو ایک دوسرے کے برابر ہیں۔ یہ دکھانے کی خاطر دکھائیں کہ دونوں تفاعل کی شرح نمو تفاعل \عددی{\sqrt{x}} کی  شرح نمو کے برابر ہے۔ 
\انتہا{سوال}
%====================
\ابتدا{سوال}
دکھائیں کہ \عددی{x\to \infty} کرتے ہوئے \عددی{\sqrt{x^4+x}} اور \عددی{\sqrt{x^4-x^3}} کی شرح نمو ایک دوسرے کے برابر ہیں۔ یہ دکھانے کی خاطر دکھائیں کہ دونوں تفاعل کی شرح نمو تفاعل \عددی{x^2} کی  شرح نمو کے برابر ہے۔ 
\انتہا{سوال}
%====================
...
\item
تفاعل \عددی{x^{1/10}} کو بھی \عددی{\ln x} سے بڑھنے  کے لیے  بہت وقت درکار ہو گا۔ کیلکولیٹر استعمال کرتے ہوئے \عددی{x} کی وہ قیمت تلاش کریں جس پر \عددی{x^{1/10}} کی ترسیم \عددی{\ln x} کی ترسیم کو کٹ کرتی ہو یا جہاں \عددی{\ln x=10\ln(\ln x)} ہو۔
\item
...
(ا) آپ کمپیوٹر کی مدد سے ایک کام سرانجام دینا چاہتے ہیں۔ آپ کے پاس تین الخوارزم موجود ہیں جن  کے لیے کمپیوٹر کو درکار   قدموں کی تعداد  درج ذیل تفاعل دیتے ہیں۔ \عددی{n} کی بڑی قیمت کی صورت میں ان میں سے کونسا الخوارزم  بہترین ہے؟ اپنے جواب کی وجہ پیش کریں۔
\begin{align*}
...
\حصہ{معکوس تکونیاتی تفاعل}\شناخت{حصہ_ماورائی_الٹ_تکونیاتی_تفاعل}
معکوس تکونی تفاعل کی ضرورت اس وقت پیش آتی ہے جب ہم مثلث کے ضلع کو ناپ کر زاویہ تلاش کرنا چاہتے ہیں۔ یہ تفاعل اہم ضد تفرق بھی مہیا کرتے ہیں اور تفرقی مساوات کے حل میں عموماً پائے جاتے ہیں۔ اس حصہ میں ان تفاعل کی تعریف پیش کی جائے گی، ان کو ترسیم کرنا سکھایا جائے گا اور ان کی قیمت حاصل کرنا سکھایا جائے گا۔

\جزوحصہء{معکوس تکونیاتی  کی تعریف}
چھ بنیادی تکونیاتی تفاعل کی قیمتیں دہراتی ہیں لہٰذا یہ یک بہ یک تفاعل نہیں ہیں البتہ ان کے دائرہ کار کو ایسے وقفوں پر پابند کیا جا سکتا ہے جہاں یہ یک بہ یک ہوں (جدول \حوالہ{جدول_ماورائی_تکونیاتی_تفاعل_ایک_ایک})۔
\begin{table}
...
y&=\csc^{-1}x
\end{align*}
ہم کہیں گے \قول{\عددی{x} کا معکوس سائن \عددی{y} کے برابر ہے}، وغیرہ۔ یاد رہے کہ ان معکوس تفاعل میں \عددی{-1} سے مراد معکوس تفاعل ہے اور لہٰذا اس کو ہرگز مقلوب تصور نہیں کیا جائے۔ مثال کے طور پر \عددی{\sin x} کا مقلوب \عددی{(\sin x)^{-1}=\tfrac{1}{\sin x}=\csc x} ہو گا۔
...
\جزوحصہء{معکوس سائن اور معکوس کوسائن}
 متغیر \عددی{x} کے معکوس سائن یعنی \عددی{\sin^{-1}x} سے مراد وہ زاویہ ہے جس کا سائن \عددی{x} کے برابر ہو۔ اسی طرح \عددی{\cos^{-1}x} سے مراد وہ زاویہ ہے جس کے کوسائن کی قیمت \عددی{x} ہو۔
...
تفاعل \عددی{y=\sin^{-1}x} (شکل \حوالہ{شکل_ماورائی_سائن_اور_الٹ_سائن}) کی ترسیم مبدا کے لحاظ سے تشاکلی ہے (اور عین \عددی{x=\sin y} کی ترسیم پر پائی جاتی ہے)۔ یوں معکوس سائن طاق تفاعل ہے:
...
معکوس سائن کی مخصوص قیمتوں کو قائمہ مثلث سے شکل \حوالہ{مثال_ماورائی_سائن_مخصوص_قیمتیں} میں حاصل کرنا دکھایا گیا ہے۔ اس طرح درج ذیل دیگر قیمتیں بھی حاصل کی جا سکتی ہیں۔ یاد رہے کہ \عددی{\sin^{-1}x} کا سعت \عددی{[-\tfrac{\pi}{2},\tfrac{\pi}{2}]} ہے  لہٰذا زاویے ربع اول اور ربع چہارم میں پائے جائیں گے۔
\begin{align*}
\renewcommand{\arraystretch}{2} 
...
معکوس کوسائن کی مخصوص قیمتوں کو قائمہ مثلث سے شکل \حوالہ{مثال_ماورائی_کوسائن_مخصوص_قیمتیں} میں حاصل کرنا دکھایا گیا ہے۔ اس طرح درج ذیل دیگر قیمتیں بھی حاصل کی جا سکتی ہیں۔ یاد رہے کہ \عددی{\cos^{-1}x} کا سعت \عددی{[0,\pi]} ہے  لہٰذا زاویے ربع اول اور ربع دوم میں پائے جائیں گے۔
\begin{align*}
\renewcommand{\arraystretch}{2} 
\begin{array}{c|cccccc}
x&\tfrac{\sqrt{3}}{2}&\tfrac{\sqrt{2}}{2}&\tfrac{1}{2}&-\tfrac{1}{2}&-\tfrac{\sqrt{2}}{2}&-\tfrac{\sqrt{3}}{2}\\
...
\انتہا{مثال}
%=====================
\جزوحصہء{تماثل جن میں معکوس سائن اور معکوس کوسائن پائے جاتے ہوں}
ہم شکل \حوالہ{شکل_ماورائی_کوسائن_اور_الٹ_کوسائن_تعلق} میں دیکھتے ہیں کہ \عددی{x} کا معکوس کوسائن تماثل
...
متغیر \عددی{x} کا معکوس ٹینجنٹ وہ زاویہ ہو گا جس کا ٹینجنٹ \عددی{x} ہو۔ اسی طرح \عددی{x} کا معکوس کوٹینجنٹ وہ زاویہ ہو گا جس کا کوٹینجنٹ \عددی{x} ہو۔
...
\tan^{-1}(-x)=-\tan^{-1}x
\end{align} 
ہے، یعنی، معکوس ٹینجنٹ طاق تفاعل ہے۔ تفاعل \عددی{y=\cot^{-1}x} کی ترسیم میں ایسی کوئی تشاکلی نہیں پائی جاتی ہے (شکل \حوالہ{شکل_ماورائی_ترسیم_الٹ_کوٹینجنٹ})۔
\begin{figure}
\centering
\begin{minipage}{0.45\textwidth}
\centering
...
انتباہ: \quad
متغیر \عددی{x} کی منفی قیمتوں کے لیے \عددی{\sec^{-1}x} کی تعریف پر اتفاق نہیں پایا جاتا ہے۔ہم ربع دوم میں \عددی{\tfrac{\pi}{2}} اور \عددی{\pi} کے بیچ زاویہ لیں گے۔ اس انتخاب کی وجہ سے \عددی{\sec^{-1}x=\cos^{-1}(1/x)} ہو گا اور \عددی{\sec^{-1}x} کے دائرہ کار کے ہر حصہ پر \عددی{\sec^{-1}x} بڑھتا ہوا تفاعل ہو گا۔
...
رداس \عددی{r} کے دائرہ میں مرکز پر زاویہ \عددی{\theta} اور قوس کی لمبائی \عددی{s} کا تعلق \عددی{s=r\theta} ہے لہٰذا  اکائی دائرہ میں \عددی{s=\theta} ہو گا (شکل \حوالہ{شکل_ماورائی_قوس_اور_الٹ_کوسائن})۔ یوں متغیر \عددی{x} کا معکوس کوسائن \عددی{\cos^{-1}x} زاویہ \عددی{\theta}دیگا جس کی قیمت مخالف قوس کی لمبائی \عددی{s} کے برابر ہو گی۔ معکوس سائن کے لیے بھی اس قسم کا تعلق پایا جاتا ہے۔
%=======================
...
(ب) غیر معین؛ ایسا کوئی زاویہ نہیں پایا جاتا ہے جس کا کوسائن \عددی{2} کے برابر ہو۔
}}
\انتہا{جواب}
%===================
\ابتدا{سوال}
...
معکوس تکونیاتی تفاعل مختلف اقسام کے تفاعل، جو انجینئری، طبیعیات اور ریاضیات میں رونما ہوتے ہیں،  کے ضد تفرق مہیا کرتے ہیں۔ اس حصہ میں ہم معکوس تکونیاتی تفاعل کے  تفرق حاصل کرتے ہیں اور متعلقہ تکملات پر غور کرتے ہیں۔
...
معکوس تکونیاتی تفاعل کے تفرق درج ذیل ہیں۔
\begin{align}
...
\حل
یہاں ریاضی فقرہ \عددی{\sqrt{4x-x^2}} مساوات \حوالہ{مساوات_ماورائی_کلیات_تکمل_الف} تا مساوات \حوالہ{مساوات_ماورائی_کلیات_تکمل_پ} میں سے کسی بھی تکمل میں پائے جانے والے ریاضیاتی عبارت کی طرح نہیں ہے لہٰذا ہم اس کا مربع مکمل کرتے ہیں:
\begin{align*}
...
\end{align*} 
قوت نمائی تفاعل \عددی{e^x} کا جفت اور طاق حصہ، جنہیں  بالترتیب \عددی{x} کا ہذلولی کوسائن اور ہذلولی سائن کہتے ہیں، از خود اہمیت کے حامل ہیں۔ یہ لچکدار ٹھوس مادّہ میں لہروں کی حرکت، کھمبوں کے بیچ برقی تاروں کا روپ، اور دھاتی \اصطلاح{سرد کار}\حاشیہب{heat sink} میں حرارتی کی تقسیم کو بیان کرتے ہیں۔
...
ہم چھ بنیادی ہذلولی تفاعل کو تکمل میں استعمال کرتے ہیں۔ چونکہ \عددی{\tfrac{\dif}{\dif x}(\sinh x)=\cosh x>0} لہٰذا \عددی{x} کے لحاظ سے ہذلولی سائن بڑھتا تفاعل ہے۔ ہم اس کے معکوس کو درج ذیل سے ظاہر کرتے ہیں۔
\begin{align*}
y=\sinh^{-1}x
\end{align*}
وقفہ \عددی{-\infty<x<\infty} میں ہر \عددی{x} کے لیے \عددی{y=\sinh^{-1}x} کی قیمت وہ ہو گی جس کے ہذلولی سائن  کی قیمت \عددی{x} ہو۔ تفاعل \عددی{y=\sinh x} اور \عددی{y=\sinh^{-1}x} کے ترسیمات کو شکل \حوالہ{شکل_ماورائی_چھ_بنیادی_الٹ_ہذلولی_ترسیمات}-ا میں پیش کیا گیا ہے۔

جیسا آپ شکل \حوالہ{شکل_ماورائی_چھ_بنیادی_ہذلولی_تفاعل}-ب میں دیکھ سکتے ہیں، تفاعل \عددی{y=\cosh x} یک بہ یک نہیں ہے۔ البتہ اس کی پابند شدہ روپ \عددی{y=\cosh x,\,x\ge 0} یک بہ یک ہے لہٰذا اس کا معکوس پایا جائے گا جس کو درج ذیل سے ظاہر کیا جاتا ہے۔
\begin{align*}
y=\cosh^{-1}x
\end{align*}
...
\end{axis}
\end{tikzpicture}
\caption{ہذلولی سائن اور معکوس ہذلولی سائن کے ترسیمات۔ یہ دونوں لکیر \عددی{y=x} کے لحاظ سے تشاکلی ہیں۔}
\end{subfigure}\hfill
\begin{subfigure}{0.45\textwidth}
\centering
...
\end{axis}
\end{tikzpicture}
\caption{ہذلولی کوسائن اور معکوس ہذلولی کوسائن کے ترسیمات۔ یہ دونوں لکیر \عددی{y=x} کے لحاظ سے تشاکلی ہیں۔}
\end{subfigure}\hfill
\begin{subfigure}{0.45\textwidth}
\centering
...
\end{axis}
\end{tikzpicture}
\caption{ہذلولی سیکنٹ اور معکوس ہذلولی سیکنٹ کے ترسیمات۔ یہ دونوں لکیر \عددی{y=x} کے لحاظ سے تشاکلی ہیں۔}
\end{subfigure}\hfill
\begin{subfigure}{0.45\textwidth}
\centering
...
تفاعل \عددی{y=\cosh x} کی طرح \عددی{y=\sech x=\tfrac{1}{\cosh x}} بھی یک بہ یک نہیں ہے، البتہ \عددی{x} کو غیر منفی قیمتوں پر پابند کرنے سے  \عددی{y=\sech x} یک بہ یک ہوتا ہے جس کا معکوس پایا جائے گا۔ اس معکوس کو
\begin{align*}
y=\sech^{-1}x
\end{align*}
سے ظاہر کیا جاتا ہے۔ وقفہ \عددی{(0,1]} میں \عددی{x} کی ہر قیمت کے لیے \عددی{y=\sech^{-1}x} وہ عدد ہو گا جس کا معکوس ہذلولی سیکنٹ \عددی{x} ہو گا۔
...
\end{align*}
سے ظاہر کیا گیا ہے اور    جنہیں شکل \حوالہ{شکل_ماورائی_چھ_بنیادی_الٹ_ہذلولی_ترسیمات}-د، ہ، و میں ترسیم کیا گیا ہے۔
...
\جزوحصہء{معکوس ہذلولی تفاعل کے تفرق اور تکمل}
...
%===================
\ابتدا{سوال}
کلیہ \عددی{\sinh^{-1}x=\ln(x+\sqrt{x^2+1}),\,-\infty<x<\infty} اخذ کریں۔ اس کلیہ میں جذر کے ساتھ منفی کے بجائے مثبت علامت کیوں استعمال ہوتا ہے؟
\انتہا{سوال}
%=====================
\ابتدا{سوال}
ایک جسم پر، جس کی کمیت \عددی{m} ہے،  ساکن حال سے ثقلی کشش کی وجہ سے  زمین کی طرف گرتے ہوئے سمتی رفتار \عددی{v} کے مربع کے متناسب ہوائی مزاحمت عمل کرتی ہے۔یوں \عددی{t} سیکنڈ بعد اس جسم کی سمتی رفتار درج ذیل تفرقی مساوات کو مطمئن کرے گی،
\begin{align*}
...
یہ ثابت کیا جا سکتا ہے نقطہ \عددی{A} اور \عددی{B} کے بیچ تمام قابل تفرق قوسین میں سب سے کم سطح طواف پیدا کرنے والی قوس \عددی{y=4\cosh\tfrac{x}{4}} ہے۔ یوں \عددی{A} اور \عددی{b} پر واقع سخت دائری تاروں کے بیچ صابن  کے جھاگ کی سطح یہی قوسی صورت اپنائے گی۔
\انتہا{سوال}
%==================
\begin{figure}
\centering
...
%
\ابتدا{سوال}
(ا) قوس \عددی{y=\cosh x,\,-\ln 2\le x\le \ln 2} کا وسطانی مرکز تلاش کریں۔ (ب) وسطانی مرکز کو \عددی{2}اعشاریہ مقامات تک درستگی تک تلاش کریں۔ اس منحنی کو ترسیم کرتے ہوئے وسطانی مرکز کی نشاندہی کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
دائری تفاعل اور قطع  زائد تفاعل کے بیچ دوسری مشابہت یہ ہے کہ قطع زائد \عددی{x^2-y^2=1} کے دائیں حصہ میں نقطہ \عددی{(\cosh u,\sinh u)} کے متغیر  \عددی{u}  کی قیمت خطہ \عددی{AON} کے رقبے  کی دگنا ہو گی(شکل \حوالہ{شکل_ماورائی_دائری_اور_قطع_زائد_تعلق})۔ اس کی تصدیق کرنے کی خاطر درج ذیل اقدام کریں۔
\begin{enumerate}[a.]
\item
...
\end{align*}
دکھائیں کہ \عددی{a} درج ذیل کو مطمئن کرتا ہے(سوال \حوالہ{سوال_ماورائی_لیزم_ب} کے نتائج استعمال کریں۔)
...
\end{align*}
اس آخری مساوات کے دونوں اطراف کو \عددی{y} سے تقسیم کرتے ہوئے  سے درج ذیل حاصل ہو گا جہاں تیسرے قدم پر \عددی{v>0} کی وجہ سے \عددی{\ln v} میں مطلق قیمت کی علامت کی ضرورت پیش نہیں آتی۔
\begin{gather}
...
\end{align*}
یوں یہ جسم کو رکنے کے لیے درج ذیل فاصلہ درکار ہو گا۔
...
\end{align*} 
فی منٹ ملی گرام میں گلوکوز کی شرح \عددی{G} ہے جبکہ بدن میں خون کا حجم  \عددی{V} لٹر ہے جو بالغ شخص کے لیے تقریباً \عددی{\SI{5}{\liter}} ہو گا۔ ارتکاز \عددی{c(t)} کو ملی گرام فی دس مربع سنٹی میٹر ناپا جاتا ہے۔جزو \عددی{-kc} کو اس لیے شامل کیا گیا ہے کہ گلوکوز مسلسل دیگر اجزاء میں تبدیل ہو گا اور اس تبدیلی کی شرح اس وقت پائے جانے والی گلوکوز کے راست متناسب ہو گی۔ (ا) \عددی{c(0)} کو \عددی{c_0} سے ظاہر کرتے ہوئے اس مساوات کو حل کریں۔ (ب) برقرار حال ارتکاز \عددی{\lim_{t\to \infty}c(t)} تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
ایک پانی سے بھرے ہوئے انتصابی بیلنی حوض کی تہہ میں نصب نلکی کو کھول کر حوض خالی کا جاتا ہے۔ شروع میں پانی کی نکاسی تیز ہوتی ہے لیکن جیسے جیسے پانی کی سطح  گرتی ہے، پانی کی نکاسی بھی آہستہ ہوتی جاتی ہے۔ ایسی صورت میں پانی کی گہرائی کی شرح تبدیلی، گہرائی \عددی{y} کے جذر کے راست متناسب ہوتی ہے:
\begin{align*}
...
%======================
\ابتدا{سوال}
ایک حوض میں \عددی{\SI{500}{\liter}} خالص پانی پایا جاتا ہے۔ ایک محلول جس میں \عددی{\SI{0.1}{\kilo\gram\per\liter}} پایا کھاد پایا جاتا ہے کو \عددی{\SI{5}{\liter\per\minute}} شرح سے حوض میں شامل کیا جاتا ہے۔ حوض سے محلول کا انعکاس \عددی{\SI{15}{\liter\per\minute}} ہے۔ حوض میں کھاد کی اعظم مقدار معلوم کریں اور اس مقدار تک پہنچنے کے لیے درکار وقت معلوم کریں۔
\انتہا{سوال}
%====================
\ابتدا{سوال}
 دفتر کے ایک کمرے میں ابتدائی طور پر \عددی{\SI{150}{\meter\cubed}} صاف ہوا پائی جاتی ہے۔ لمحہ \عددی{t=0} پر قریبی کمرے  میں موجود افسران سگریٹ نوشی شروع کرتے ہیں جس کی وجہ سے  \عددی{\SI{4}{\percent}} زہریلی کاربن مونو اکسائڈ \عددی{\SI{0.01}{\meter\cubed\per\minute}} شرح سے اس کمرے  میں داخل ہوتی ہے جہاں ایک پنکھا پوری ہوا کو یکساں رکھتا ہے۔ اس کمرے سے ہوا کا انخلا \عددی{\SI{0.01}{\meter\cubed\per\minute}} ہے۔ اس کمرے میں کب زہریلی گیس \عددی{\SI{0.01}{\percent}} ہو گی؟
\انتہا{سوال}
...
بعض اوقات ہم ابتدائی قیمت مسئلہ \عددی{y=f(x,y),\,y(x_0)=y_0} کا بالکل درست حل معلوم نہیں کر سکتے ہیں یا نہیں کرنا چاہتے ہیں۔ ایسی صورت میں ہم عموماً کمپیوٹر استعمال کرتے ہوئے موزوں وقفہ پر ہر \عددی{x} کے لیے \عددی{y} کی تخمینی قیمت   تلاش کر سکتے ہیں۔ ایسے حل کو ہم \اصطلاح{اعدادی حل}\فرہنگ{اعدادی!حل}\حاشیہب{numerical solution}\فرہنگ{numerical!solution} کہتے ہیں اور اس حل کو حاصل کرنے کے طریقہ کو \اصطلاح{اعدادی ترکیب}\فرہنگ{اعدادی!ترکیب}\حاشیہب{numerical method}\فرہنگ{numerical!method} کہتے ہیں۔ اعدادی تراکیب عموماً بہت کم وقت میں  درست نتائج دیتے ہیں اور جہاں بھی تحلیلی حل نا ممکن، غیر ضروری یا پیچیدہ ہو، وہاں اعدادی تراکیب کو ترجیح دی جاتی ہے۔ اس حصہ میں ہم ایسے ایک ترکیب پر غور کرتے ہیں جس کو \اصطلاح{ترکیب یولر}\فرہنگ{ترکیب یولر}\حاشیہب{Euler' method}\فرہنگ{Euler's method} کہتے ہیں۔ 

\جزوحصہء{میدان ڈھلوان}
ابتدائی معلومات \عددی{y(x_0)=y_0} تفرقی مساوات \عددی{y'=f(x,y)} پر یہ شرط مسلط کرتی ہے کہ تفرقی مساوات کا حل نقطہ  \عددی{(x_0,y_0)} سے گزرے گا اور اس نقطہ ہر حل کا ڈھلوان \عددی{f(x_0,y_0)} ہو گا۔ ہم \عددی{f} کے دائرہ کار میں منتخب نقطوں \عددی{(x,y)} پر \عددی{f(x,y)} ڈھلوان والے قلیل سیدھے خطوط بنا کر اس ڈھلوان کو تصویری جامہ پہنا سکتے ہیں۔ نقطہ \عددی{(x,y)} سے گزرتے ہوئے حل کا  ڈھلوان اس نقطہ پر بنائے گئے قلیل خط کے ڈھلوان کا  برابر ہو گا لہٰذا یہ خط اس نقطہ پر حل کا مماس ہو گا۔ہم ان مماس پر نظر دوڑا کر حل کے رویہ کو جان سکتے ہیں (شکل \حوالہ{شکل_ماورائی_میدان_ڈھلوان})۔
...
\end{align*}
سے  کر سکتے ہیں۔ \عددی{x_0} کی بالکل پڑوس میں تفاعل \عددی{L(x)} اصل حل \عددی{y(x)} کا اچھا تخمین ہو گا (شکل \حوالہ{شکل_ماورائی_خط_بندی_مماس})۔ ترکیب یولر میں اس طرح کے خط بندیوں کو آپس میں جوڑ کر زیادہ لمبے فاصلہ کے لیے حل تلاش کیا جاتا ہے۔ اب اس ترکیب پر غور کرتے ہیں۔
...
\حل
اس مسئلے کا بالکل درست تحلیلی حل \عددی{y=2e^x-1} ہے۔ جدول \حوالہ{جدول_ماورائی_یولر_موازنہ} میں، مساوات \حوالہ{مساوات_ماورائی_ترکیب_یولر_ایکس} اور مساوات \حوالہ{مساوات_ماورائی_ترکیب_یولر_وائے} استعمال کرتے ہوئے، ترکیب یولر سے حاصل \عددی{4} اعشاریہ مقامات تک درست تخمینی نتائج کا تحلیل حل کے ساتھ موازنہ کیا گیا ہے۔ دس قدم بعد \عددی{x=1} تک پہنچ کر ترکیب یولر سے حاصل تخمینی حل میں \عددی{\SI{5.6}{\percent}} خلل پایا جاتا ہے۔
\begin{table}
...
ایسا معلوم ہوتا ہے کہ ترکیب یولر میں قدموں کی تعداد مزید بڑھا کر اس سے بھی بہتر نتیجہ حاصل ہو گا۔ حقیقت میں ایسا کرنے سے نا صرف کمپیوٹر کو حل حاصل کرنے میں زیادہ وقت درکار ہو گا بلکہ کمپیوٹر میں ہندسوں کی تعداد پر پابندی کی وجہ سے پیدا پورم پور خلل بڑھتا ہے۔

خلل اور اس کو کم کرنے کے طریقوں پر یہاں غور نہیں کیا جائے گا۔ انہیں سمجھنے کے لیے مزید اعلیٰ درجے کی نصاب درکار ہو گی۔ ترکیب یولر سے زیادہ بہتر اعدادی تراکیب پائے جاتے ہیں جنہیں تفرقی مساوات پڑھنے کے دوران سیکھیں گے۔ اعدادی ترکیب میں قدموں کی تعداد اور خلل کے تعلق پر غور کرنے کے لیے آپ کو سوالات میں موقع ملے گا۔
...
\begin{enumerate}[a.]
\item
دیے گئے تفرقی مساوات کا میدان ڈھلوان مستوی  \عددی{xy} میں کھینچیں۔
\item
...
\انتہا{سوال}
%======================
سوال \حوالہ{سوال_ماورائی_صریح_حل_غیر_موجود_الف}  اور سوال \حوالہ{سوال_ماورائی_صریح_حل_غیر_موجود_ب} کا بنیادی تفاعل کی صورت میں صریح حل نہیں پایا جاتا ہے۔ان تفرقی مساوات پر ترسیمی غور کریں۔ مذکورہ بالا جزو-الف تا جزو-ز میں اعظم کرنے کی کوشش کریں۔
...
\end{align*}
(ب) متغیرات کی علیحدگی کے بعد کمپیوٹر کے ریاضی پروگرام کی مدد سے تکمل کرتے ہوئے خفی حل تلاش کریں۔ (ج) جزو-ب کے نتیجہ کو مستقل \عددی{C=-6,-4,-2,0,2,4,6} کے لیے  ترسیم کریں۔ (د) اس حل کو ترسیم کریں جو ابتدائی شرط \عددی{y(0)=-1} کو مطمئن کرتا ہو۔
\انتہا{سوال}
