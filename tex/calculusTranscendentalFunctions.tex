...
\end{align*}
اس کے بعد دکھائیں کہ \عددی{[a,b]} کے کسی نقطہ پر \عددی{C(t)} اور \عددی{K(t)} کی قیمتیں ایک سی ہیں اور \عددی{[a,b]} پر ان کے تفرق بھی ایک سی ہیں۔ صفحہ \حوالہصفحہ{سوال_تکمل_یکتائی_حل_کی_شرط} پر سوال \حوالہ{سوال_تکمل_یکتائی_حل_کی_شرط} کے نتیجہ کے  مطابق \عددی{[a,b]} میں تمام \عددی{t} کے لئے \عددی{C(t)=K(t)} ہو گا۔ بالخصوص \عددی{C(b)=K(b)} ہو گا۔
\انتہا{سوال}
%========================
\موٹا{کمپیوٹر کا استعمال}\\
...
\end{align*}
لکھا جا سکتا ہے لہٰذا \عددی{x} کی ہر مثبت قیمت کے  لئے  درج ذیل ہو گا۔
\begin{align*}
...
کسی  عنصر کے آدھے ایٹموں کو تابکاری کے ذریعہ تبدیل ہونے کے لئے درکار وقت کو اس عنصر کی \اصطلاح{نصف حیات}\فرہنگ{نصف حیات}\حاشیہب{half life}\فرہنگ{half life} کہتے ہیں۔ کسی بھی عنصر کی نصف حیات، ابتدائی ایٹموں کی تعداد پر نہیں  بلکہ عنصر پر منحصر ہوتی ہے۔
...
ریڈان 222 گیس کے لئے \عددی{k=0.18} دن ہے لہٰذا اس کی نصف حیات \عددی{3.8} دن ہو گی جبکہ رات کی تاریکی میں  نظر آنے کی خاطر گھڑیوں میں استعمال ہونے والے ریڈیم 226 کا \عددی{k=4.3\times 10^{-4}} سال ہے لہٰذا اس کی نصف حیات \عددی{1600} سال ہو گی۔
...
کاربن 14 جس کی نصف حیات \عددی{5700} سال ہے، کو عموماً قدیم چیزوں کی عمر معلوم کرنے کے لئے استعمال کیا جاتا ہے۔ ایک نمونہ میں \عددی{\SI{10}{\percent}} تابکار کاربن کے ایٹم تبدیل تبدیل ہو چکے ہیں۔ اس نمونے کی عمر تلاش کریں۔
...
کاربن 14 کے علاوہ دیگر تابکار عناصر کو بھی تعین زمان کے لئے استعمال کیا جا سکتا ہے۔ یورینیم (جس کی نصف حیات \عددی{4.5} ارب سال ہے) کو \عددی{2} ارب سال پرانے چٹانوں کے عمر تلاش کرنے کے لئے استعمال کیا گیا ہے۔
...
%===================
\ابتدا{سوال}
ایک شخص نے بنک میں رقم کو \عددی{100} سال کے لئے جمع کیا۔ سو سال بعد اس کے خاندان کو \عددی{90} گنّا رقم حاصل ہوتی ہے۔ مسلسل سود در سود کی شرح تلاش کریں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{4.50}{\percent}$
...
%=====================
\ابتدا{سوال}
ایک شخص نے بنک میں رقم کو \عددی{100} سال کے لئے جمع کیا۔ سو سال بعد اس کے خاندان کو \عددی{131} گنّا رقم حاصل ہوتی ہے۔ مسلسل سود در سود کی شرح تلاش کریں۔
\انتہا{سوال}
%=====================
...
کمپیوٹر کسی لائحہ کار کے تحت قدم با قدم چل کر کوئی کام سر انجام دیتا ہے۔اس لائحہ کار کو \اصطلاح{کمپیوٹر الخوارزم}\فرہنگ{الخوارزم!کمپیوٹر}\حاشیہب{computer algorithm}\فرہنگ{algorithm} کہتے ہیں۔اس لائحہ کار کی کارگزاری جاننے کی خاطر ماہرین عموماً اس کام کو سرانجام کرنے کے لئے درکار قدموں کی گنتی کرتے ہیں۔ ایک ہی کام سرانجام دینے کے دو مختلف لائحہ کار کی کارگزاری میں بہت زیادہ فرق ہو سکتا ہے جنہیں بڑے \عددی{O} علامتی روپ میں پیش کیا جاتا ہے۔ آئیں ایک مثال دیکھتے ہیں۔
...
انتباہ: \quad
متغیر \عددی{x} کی منفی قیمتوں کے لئے \عددی{\sec^{-1}x} کی تعریف پر اتفاق نہیں پایا جاتا ہے۔ہم ربع دوم میں \عددی{\tfrac{\pi}{2}} اور \عددی{\pi} کے بیچ زاویہ لیں گے۔ اس انتخاب کی وجہ سے \عددی{\sec^{-1}x=\cos^{-1}(1/x)} ہو گا اور \عددی{\sec^{-1}x} کے دائرہ کار کے ہر حصہ پر \عددی{\sec^{-1}x} بڑھتا ہوا تفاعل ہو گا۔
...
علامت کے بارے میں ہم کیا کر سکتے ہیں؟ ہم دیکھتے ہیں (شکل \حوالہ{شکل_ماورائی_ڈھلوان_مثبت_سیکنٹ}) کہ \عددی{\abs{x}>1} کے لئے \عددی{y=\sec^{-1}x} کی ترسیم کا ڈھلوان مثبت رہتا ہے لہٰذا درج ذیل لکھا جا سکتا ہے۔
...
\end{tikzpicture}
\caption{
قوس \عددی{y=\sec^{-1}x} کا ڈھلوان \عددی{x<-1} اور \عددی{x>1} دونوں کے لئے مثبت ہے۔
}
...
\end{align*}
ہو گا۔ یہ جانے کے لئے کہ یہ جسم کتنا فاصلہ طے کرنے کے بعد رکے گا ہم \عددی{t\to \infty} پر \عددی{s(t)} کی حد تلاش کرتے ہیں۔ چونکہ \عددی{-\tfrac{k}{m}<0} ہے لہٰذا \عددی{t\to\infty} کرنے سے \عددی{e^{-(k/m)t}\to 0} ہو گا۔ یوں درج ذیل حاصل ہوتا ہے۔
\begin{align*}
...
%=====================
\ابتدا{سوال}
(ا) درج ذیل تفرقی مساوات کے میدان ڈھلوان کا خاکہ وقفہ \عددی{-3\le x\le 3,\, -3\le y\le 3} کے لئے  کھینچیں۔
\begin{align*}
