%edited grammar using colour coding and chatgpt. 28 aug 2026
%edited the entire chapter
...
\end{align*}
اس مساوات میں تمام \عددی{P} متغیر \عددی{x} کے کثیررکنی ہیں،  جہاں کثیررکنیوں کے عددی سر ناطق ہیں۔
یوں \عددی{y=\tfrac{1}{\sqrt{x+1}}} ایک الجبرائی تفاعل ہے، کیونکہ یہ مساوات \عددی{(x+1)y^2-1=0} کو مطمئن کرتا ہے، جہاں \عددی{P_2=x+1}، \عددی{P_1=0} اور \عددی{P_0=-1} ہیں۔ کثیررکنیوں اور ناطق عددی سروں والے ناطق تفاعل الجبرائی ہوں گے۔ اسی طرح الجبرائی تفاعلات کے مجموعے، حاصل ضرب، حاصل تقسیم، ناطق طاقتیں اور ناطق جذر بھی الجبرائی ہوں گے۔

وہ تفاعل جو الجبرائی نہیں ہوں \اصطلاح{ماورائی}\فرہنگ{ماورائی}\حاشیہب{transcendental}\فرہنگ{transcendental} کہلاتے ہیں۔ چھ بنیادی تکونیاتی تفاعل \عددی{\sin}، \عددی{\cos}، \عددی{\tan}، \عددی{\csc}، \عددی{\sec}، \عددی{\cot} اور ان کے  معکوس  تفاعل ماورائی ہیں۔ اسی طرح قوت نمائی تفاعل     اور لوگارتھمی تفاعل بھی ماورائی تفاعل ہیں۔

وہ اعداد جو ناطق عددی سر والے کثیررکنی مساوات کو مطمئن کرتے ہوں \اصطلاح{الجبرائی} کہلاتے ہیں۔چونکہ \عددی{-2} مساوات \عددی{x+2=0} کو مطمئن کرتا ہے ، لہٰذا \عددی{-2} الجبرائی عدد ہے۔ اسی طرح   \عددی{\sqrt{3}}  مساوات \عددی{x^2-3=0} کو مطمئن کرتا ہے ، لہٰذا \عددی{\sqrt{3}} بھی الجبرائی عدد ہے۔ وہ اعداد جو الجبرائی نہ ہوں ، \اصطلاح{ماورائی} کہلاتے ہیں۔یوں  \عددی{e} اور \عددی{\pi} ماورائی اعداد ہیں۔

  ریاضیات میں بہت سے تفاعل ایک دوسرے کے معکوس ہوتے  ہیں۔ غالباً سب سے زیادہ جانی پہچانی   معکوس تفاعل کی جوڑی \عددی{\ln x} اور \عددی{e^x} ہے۔ موزوں وقفہ پر پابند تکونیاتی تفاعل کے اہم معکوس پائے  جاتے ہیں۔ پابند وقفہ پر تفاعل کو پابند شدہ تفاعل کہتے ہیں۔ اسی طرح  لوگارتھمی اور قوت نمائی تفاعل کی  دیگر معکوس جوڑیاں پائی جاتی ہیں۔ ہذلولی تفاعل اور ان کے معکوس تفاعل کا استعمال آویزاں رسّی،  حرکی توانائی کی منتقلی، اور ہوا میں گرتے ہوئے جسم پر قوت رگڑ کے مسائل میں کام آتا ہے۔ اس باب میں ان تمام تفاعلات  پر غور کیا جائے گا۔ ان مسائل  کا بھی ذکر کیا جائے گا جنہیں  حل کرنے میں یہ تفاعل   مدد گار ثابت ہوتے ہیں۔

\حصہ{معکوس تفاعلات  اور ان کے تفارق}\شناخت{حصہ_استعمال_تکمل_الٹ_تفاعل_اور_ان_کے_تفرق}
اس حصہ میں ہم معکوس تفاعل کی تعریف پیش کرتے ہیں اور ان کے کلیات، ترسیمات، اور معکوس جوڑیوں کے تفرق پر غور کرتے ہیں۔

\جزوحصہء{یک بہ یک تفاعل}
تفاعل سے مراد وہ قاعدہ ہے جو اپنی دائرہ کار کے ہر نقطہ کو اپنی سعت میں ایک قیمت مختص کرتا ہو۔بعض تفاعل ایک ہی قیمت کو ایک سے زیادہ  نقطوں  کے لیے مختص کرتے ہیں۔ یوں \عددی{-1} کا مربع اور \عددی{1} کا مربع \عددی{1} ہے؛ اسی طرح \عددی{\tfrac{\pi}{3}} اور \عددی{\tfrac{2\pi}{3}} کا سائن \عددی{\tfrac{\sqrt{3}}{2}} ہے۔ اس کے بر عکس دیگر تفاعل کسی ایک قیمت کو کبھی بھی دو مرتبہ مختص نہیں کرتے ہیں۔ مختلف اعداد کے  مربع جذر اور اسی طرح مختلف اعداد کے مکعب بھی      ہر صورت ایک دوسرے سے مختلف ہوتے ہیں۔ ایسا تفاعل جس کے انفرادی نقطوں پر منفرد قیمت ہو کو \اصطلاح{یک بہ یک تفاعل}\فرہنگ{یک بہ یک تفاعل}\حاشیہب{one to one function}\فرہنگ{one to one} کہتے ہیں۔

\ابتدا{تعریف}
دائرہ کار \عددی{D} پر تفاعل \عددی{f(x)}  تب \اصطلاح{یک بہ یک} ہو گا جب \عددی{x_1\ne x_2} کی صورت میں \عددی{f(x_1)\ne f(x_2)} ہو۔
\انتہا{تعریف}
%=====================

\ابتدا{مثال}
چونکہ کسی بھی غیر منفی اعداد کے لیے \عددی{x_1\ne x_2} کی صورت میں \عددی{\sqrt{x_1}\ne \sqrt{x_2}} ہے  لہٰذا \عددی{f(x)=\sqrt{x}} غیر منفی اعداد کے کسی بھی دائرہ کار پر    یک بہ یک تفاعل ہے۔
\انتہا{مثال}
%====================
\ابتدا{مثال}
چونکہ \عددی{\sin(\tfrac{\pi}{6})=\sin(\tfrac{5\pi}{6})} ہے لہٰذا وقفہ \عددی{[0,\pi]} پر \عددی{g(x)=\sin x} یک بہ یک تفاعل نہیں۔ اس کے برعکس  ، ربع اول میں تمام زاویوں کے سائن مختلف ہیں لہٰذا وقفہ \عددی{[0,\tfrac{\pi}{2}]} پر \عددی{g(x)=\sin x} یک بہ یک تفاعل ہے۔
\انتہا{مثال}
%====================
\begin{figure}
\centering
...
\addplot[thick,domain=0:1.2]{f(x)}node[right]{$y=x^3$};
\addplot[thick,domain=0:1.2](-x,{-f(x)});
\draw(-1.2,1)--(1.2,1);
\end{axis}
\end{tikzpicture}
\caption{یک بہ یک تفاعل۔}
\end{subfigure}\hfill
\begin{subfigure}{0.45\textwidth}
\centering
\begin{tikzpicture}[declare function={f(\x)=\x^3;g(\x)=sqrt{\x};}]
\begin{axis}[clip=false,small,axis lines=middle,enlargelimits=true,xlabel={$x$},ylabel={$y$},xlabel style={at={(current axis.right of origin)},anchor=west},ylabel style={at={(current axis.above origin)},anchor=south},xtick={\empty},ytick={\empty}]
\addplot[thick,domain=0:0.5]{g(x)};
\addplot[thick,domain=0.5:2]{g(x)}node[right]{$y=\sqrt{x}$};
\draw(-0.25,1)--(2,1);
\end{axis}
\end{tikzpicture}
\caption{یک بہ یک تفاعل۔}
...
\begin{axis}[clip=false,small,axis lines=middle,enlargelimits=true,xlabel={$x$},ylabel={$y$},xlabel style={at={(current axis.right of origin)},anchor=west},ylabel style={at={(current axis.above origin)},anchor=south},xtick={\empty},ytick={\empty}]
\addplot[thick,domain=-1.25:1.25]{f(x)}node[right]{$y=x^2$};
\draw(-1.25,1)--(1.25,1);
...
\begin{axis}[clip=false,small,axis lines=middle,enlargelimits=true,xlabel={$x$},ylabel={$y$},xlabel style={at={(current axis.right of origin)},anchor=west},ylabel style={at={(current axis.above origin)},anchor=south},xtick={\empty},ytick={\empty}]
\addplot[thick,domain=-0.2:3.3]{g(x)}node[pos=0.5,above]{$y=\sin x$};
...
\caption{غیر یک بہ یک تفاعل۔}
\end{subfigure}
\caption{یک بہ یک تفاعل کی ترسیم کسی بھی افقی لکیر کو زیادہ سے زیادہ ایک  مرتبہ  قطع کرتی ہے جبکہ غیر یک بہ یک تفاعل کی ترسیم، ایک یا ایک سے زیادہ افقی لکیروں کو ایک سے زیادہ  مرتبہ قطع کرتی ہے۔}
\label{شکل_ماورائی_ایک_ایک_تفاعل_افقی_لکیر_پرکھ}
\end{figure}
یک بہ یک تفاعل \عددی{y=f(x)} کی ترسیم کسی بھی افقی لکیر کو زیادہ سے زیادہ ایک  مرتبہ  قطع کرتی ہے ۔ اگر کسی تفاعل کی ترسیم کسی افقی لکیر کو ایک سے زیادہ مرتبہ قطع کرتی ہو تب یہ تفاعل \عددی{y} کی اس قیمت کو ایک سے زیادہ مرتبہ اختیار کرتا ہے لہٰذا یہ یک بہ یک تفاعل نہیں ہو گا (شکل \حوالہ{شکل_ماورائی_ایک_ایک_تفاعل_افقی_لکیر_پرکھ})۔

\موٹا{افقی لکیر کی پرکھ}\\
کوئی بھی تفاعل \عددی{y=f(x)} صرف اور صرف اس صورت یک بہ یک تفاعل ہو گا جب اس کی ترسیم ہر افقی لکیر کو زیادہ سے زیادہ ایک  مرتبہ  قطع کرتی ہو۔ 

\جزوحصہء{معکوس}
چونکہ یک بہ یک تفاعل کا ہر مخارج   ایک انفرادی مداخل  سے آتا ہے لہٰذا یک بہ یک تفاعل کو معکوس کرتے ہوئے ہر مخارج کو واپس اس مداخل پر بھیجا جا سکتا ہے جس سے یہ مخارج حاصل ہوتا ہے (شکل \حوالہ{شکل_ماورائی_الٹ_واپس_بھیجتا_ہے})۔ یک بہ یک تفاعل \عددی{f} کو معکوس کر کے جو تفاعل حاصل ہوتا ہے اس کو \عددی{f} کا \اصطلاح{معکوس}\فرہنگ{معکوس}\حاشیہب{inverse}\فرہنگ{inverse} کہتے ہیں ، جس کو \عددی{f^{-1}} سے ظاہر کیا جاتا ہے،  جہاں \عددی{f^{-1}} میں \عددی{-1} کو طاقت نہ سمجھا جائے: یعنی \عددی{f(x)^{-1}} سے مراد \عددی{\tfrac{1}{f(x)}} نہیں۔ ہم \عددی{f^{-1}} کو \قول{\عددی{f} کا معکوس} پڑھتے ہیں۔
\begin{figure}
\centering
\begin{tikzpicture}
\pgfmathsetmacro{\r}{1}
...
\draw[thick,-stealth](kL) to [out=30,in=150]node[pos=0.5,above]{$f$}(kR);
\draw[thick,-stealth](kR) to [out=-150,in=-30]node[pos=0.5,below]{$f^{-1}$}(kL);
...
\end{tikzpicture}
\caption{
تفاعل \عددی{f} کا معکوس ہر مخارج کو واپس اس  انفرادی مداخل پر بھیجتا ہے جہاں سے وہ آیا  ہو۔
}
\label{شکل_ماورائی_الٹ_واپس_بھیجتا_ہے}
\end{figure}

جیسا شکل \حوالہ{شکل_ماورائی_الٹ_واپس_بھیجتا_ہے} سے ظاہر ہے، \عددی{f} سے \عددی{f^{-1}} یا \عددی{f^{-1}} سے \عددی{f} حاصل کیا جا سکتا ہے۔ یوں کسی بھی \عددی{x} کے لیے \عددی{f(x)} حاصل کر کے اس \عددی{f(x)} کا معکوس \عددی{f^{-1}(f(x))} حاصل کیا جا سکتا ہے جو \عددی{x} ہو گا۔ تفاعل \عددی{f^{-1}(f(x))} یا تفاعل \عددی{f(f^{-1}(x))} میں \عددی{x} پُر کرنے سے واپس \عددی{x} ملتا ہے۔ ایسا تفاعل جو ہر عدد کو اسی عدد کے لیے مختص کرتا ہو  \اصطلاح{شناختی تفاعل}\فرہنگ{شناختی تفاعل}\فرہنگ{تفاعل!شناختی}\حاشیہب{identity function}\فرہنگ{identity function}\فرہنگ{function!identity} کہلاتا ہے۔ یوں تفاعل \عددی{f} اور \عددی{g} کو ایک دوسرے  کا معکوس تفاعل ہونے کے لیے پرکھا جا سکتا ہے۔اگر \عددی{(f\circ g)(x)=(g\circ f)(x)=x} ہو تب \عددی{f} اور \عددی{g} ایک دوسرے کے معکوس تفاعل ہوں گے ورنہ یہ ایک دوسرے کے معکوس تفاعل نہیں ہوں گے۔ اگر \عددی{f} اپنے دائرہ کار کا مکعب لیتا ہو تب \عددی{g} اس صورت \عددی{f} کا معکوس ہو گا جب \عددی{g} ہر قیمت کا مکعب جذر لیتا ہو، ورنہ یہ \عددی{f} کا معکوس نہیں ہو گا۔

تفاعل \عددی{f} اور \عددی{g} ایک دوسرے کے معکوس صرف اور صرف اس صورت ہوں گے جب
\begin{align*}
f(g(x))=x\quad \text{اور}\quad g(f(x))=x
\end{align*}
ہوں۔ایسی صورت میں \عددی{g=f^{-1}} اور \عددی{f=g^{-1}} ہوں گے۔

ایک تفاعل کا معکوس صرف اور صرف اس صورت ہو گا جب یہ یک بہ یک تفاعل ہو۔ یوں بڑھتے تفاعل کا معکوس تفاعل ہو گا اور  گھٹتے تفاعل کا بھی معکوس تفاعل ہو گا۔ جن تفاعل کا تفرق مثبت ہو وہ اپنے دائرہ کار میں بڑھتے ہیں لہٰذا ان کا معکوس ہو گا (صفحہ \حوالہصفحہ{نتیجہ_صریح_استعمال_سوم} پر مسئلہ اوسط قیمت کا ضمنی نتیجہ \حوالہ{نتیجہ_صریح_استعمال_سوم})۔اسی طرح جن تفاعل کا تفرق منفی ہو وہ اپنے دائرہ کار میں گھٹتے ہیں لہٰذا ان کا بھی  معکوس ہو گا۔
\begin{figure}
\centering
\begin{subfigure}{0.45\textwidth}
\centering
...
\addplot[thick,domain=-1:-0.8]{f(x)};
\addplot[thick,domain=-0.8:3]{f(x)}node[below]{$y=f(x)$};
...
\end{tikzpicture}
\caption{
نقطہ \عددی{x} پر \عددی{f} کی قیمت جاننے کے لیے ہم \عددی{x} سے انتصابی رخ چلتے ہوئے ترسیم تک پہنچ کر افقی سمت محور \عددی{y} تک پہنچ کر درکار قیمت پڑھتے ہیں۔
}
\end{subfigure}\hfill
\begin{subfigure}{0.45\textwidth}
\centering
...
%\addplot[domain=0:1.5]{g(x)};
\addplot[thick,domain=-1:-0.8]{f(x)};
\addplot[thick,domain=-0.8:3]{f(x)}node[below]{$x=f^{-1}(y)$};
...
\end{tikzpicture}
\caption{}
تفاعل \عددی{f} کی ترسیم کو \عددی{f^{-1}} کی ترسیم تصور کیا جا سکتا ہے۔ وہ \عددی{x} جو \عددی{y} دیتا ہو کو تلاش کرنے کی خاطر، ہم  \عددی{y} سے افقی رخ  ترسیم تک اور  یہاں سے انتصابی رخ محور \عددی{x} تک پہنچ کر درکار \عددی{x} پڑھتے ہیں۔ \عددی{f} کا دائرہ کار \عددی{f^{-1}} کی سعت ہو گا جبکہ \عددی{f} کی سعت \عددی{f^{-1}} کا دائرہ کار ہو گا۔
...
\begin{axis}[clip=false,small,axis lines=middle,enlargelimits=true,xlabel={$x$},ylabel={$y$},xlabel style={at={(current axis.right of origin)},anchor=west},ylabel style={at={(current axis.above origin)},anchor=south},xtick={\empty},ytick={\empty}, xmin=-1.25, xmax=3.5, ymin=-1.25, ymax=2.25]
\addplot[thick,domain=0:1.5]{g(x)}node[above]{$x=f^{-1}(y)$};
\addplot[thick,gray,domain=-1:-0.8]{f(x)};
\addplot[thick,gray,domain=-0.8:3]{f(x)};
...
\begin{tikzpicture}[declare function={f(\x)=(\x+1)^(1/3);g(\x)=\x^3-1;}]
\begin{axis}[clip=false,small,axis lines=middle,enlargelimits=true,xlabel={$x$},ylabel={$y$},xlabel style={at={(current axis.right of origin)},anchor=west},ylabel style={at={(current axis.above origin)},anchor=south},xtick={\empty},ytick={\empty}, xmin=-1.25, xmax=3.5, ymin=-1.25, ymax=2.25]
\addplot[thick,domain=0:1.5]{g(x)}node[pos=0.75,right]{$y=f^{-1}(x)$};
...
\end{subfigure}
\caption{تفاعل \عددی{f} کے معکوس \عددی{f^{-1}} کی ترسیم۔}
\label{شکل_ماورائی_تفاعل_کے_الٹ-کی_ترسیم}
\end{figure}
\جزوحصہء{معکوس کی تلاش}
تفاعل کے معکوس کی ترسیم کا تفاعل کی ترسیم کے ساتھ کیا تعلق ہے؟ فرض کریں ایک تفاعل کی ترسیم شکل  \حوالہ{شکل_ماورائی_تفاعل_کے_الٹ-کی_ترسیم}-الف کی طرح  بڑھتی ہو، یعنی یہ بائیں سے دائیں اوپر اٹھتی  ہو۔ کسی بھی \عددی{x} کے لیے ترسیم سے قیمت پڑھنے کے لیے ہم محور \عددی{x} پر نقطہ \عددی{x} سے شروع ہو کر محور \عددی{y} کے متوازی چل کر ترسیم تک پہنچتے ہیں اور یہاں سے محور \عددی{x} کے متوازی چل کر محور \عددی{y} تک پہنچ کر تفاعل کی قیمت \عددی{y} پڑھتے ہیں۔ہم اس عمل کو معکوس کرتے ہوئے \عددی{y} سے شروع کرتے ہوئے \عددی{x} پڑھ سکتے ہیں (شکل \حوالہ{شکل_ماورائی_تفاعل_کے_الٹ-کی_ترسیم}-ب دیکھیں)۔

تفاعل \عددی{f} کی ترسیم حاصل کرنے کی خاطر ہم \عددی{f^{-1}} کی ترسیم میں مداخل مخارج جوڑیوں  کا آپس میں تبادلہ  کرتے ہیں۔ اس ترسیم کو عمومی طرز پر دکھانے کی خاطر ہمیں ان جوڑیوں کا \عددی{45^{\circ}} کی لکیر \عددی{y=x} میں عکس لینا ہو گا اور ساتھ ہی  حرف \عددی{x} اور حرف \عددی{y} کا ایک دوسرے کے ساتھ تبادلہ کرنا ہو گا۔ یوں غیر تابع متغیر، جس کو اب \عددی{x} کہتے ہیں، افقی محور پر دکھایا جائے گا اور تابع متغیر، جس کو اب \عددی{y} کہتے ہیں، کو انتصابی محور پر دکھایا جائے گا۔ تفاعل \عددی{f(x)} اور \عددی{f^{-1}(x)} کی ترسیمات لکیر \عددی{y=x} کے لحاظ سے تشاکلی ہیں۔

شکل \حوالہ{شکل_ماورائی_تفاعل_کے_الٹ-کی_ترسیم} میں \عددی{f^{-1}} کو متغیر \عددی{x} کا تفاعل لکھنا دکھایا گیا ہے جس کو درج ذیل بیان کیا جا سکتا ہے۔
\begin{enumerate}[a.]
\item
مساوات \عددی{y=f(x)} کو  \عددی{x} کے لیے حل کریں۔ یوں \عددی{x} کو \عددی{y} کی صورت میں لکھا جائے گا۔
\item
...
تفاعل \عددی{y=\tfrac{x}{2}+1} کا معکوس حاصل کریں جہاں غیر تابع متغیر \عددی{x} ہو۔

\حل
قدم  \اردوعدد{1}:\quad
\عددی{x} کے لیے حل کرتے ہیں۔
\begin{align*}
y&=\frac{x}{2}+1\\
2y&=x+2\\
x&=2y-2
...
y=2x-2
\end{align*}
یوں تفاعل \عددی{f(x)=\tfrac{x}{2}+1} کا معکوس تفاعل \عددی{f^{-1}(x)=2x-2} ہو گا۔
...
تفاعل \عددی{y=x^2,\, x\ge 0} کا معکوس تلاش کریں جہاں غیر تابع متغیر \عددی{x} ہو۔
...
\begin{align*}
y&=x^2\\
\sqrt{y}&=\sqrt{x^2}=\abs{x}=x&&\text{\RL{$x\ge 0$ کی وجہ سے $\abs{x}=x$ ہو گا}}
\end{align*}
قدم  \اردوعدد{2}:\quad
 حاصل نتیجہ میں \عددی{x} اور \عددی{y} کا آپس میں تبادلہ کرتے ہیں۔
\begin{align*}
y=\sqrt{x}
\end{align*}
یوں تفاعل \عددی{y=x^2,\, x\ge 0} کا معکوس \عددی{y=\sqrt{x}} ہو گا (شکل \حوالہ{شکل_ماورائی_الٹ_تفاعل_تعریف})۔

 دھیان رہے کہ پابند تفاعل \عددی{y=\sqrt{x},\,x\ge 0} یک بہ یک تفاعل ہے لہٰذا اس کا معکوس پایا جاتا ہے ، جبکہ تفاعل \عددی{y=x^2} ایک غیر پابند تفاعل ہے جو یک بہ یک تفاعل نہیں،  لہٰذا اس کا معکوس نہیں پایا جاتا۔
\انتہا{مثال}
%=====================

\موٹا{کمپیوٹر کا استعمال}\\
تفاعل \عددی{y=f(x)} کا معکوس تفاعل نہایت آسانی سے درج ذیل مقدار معلوم روپ استعمال کرتے ہوئے ترسیم کیا جا سکتا ہے۔
\begin{align*}
x(t)=f(t),\quad y(t)=t
\end{align*}
...
x_2(t)& =f(t),\quad y_2(t)=t&&\text{\RL{تفاعل کا معکوس}}
\end{align*}
اس سے بھی زیادہ بہتر ہو گا کہ تفاعل، تفاعل کا معکوس اور شناختی تفاعل \عددی{y=x} کو ساتھ ساتھ ترسیم کریں جہاں شناختی تفاعل درج ذیل ہو گا۔
\begin{align*}
x_3(t)&=t,\quad y_3(t)=t&&\text{\RL{شناختی تفاعل}}
\end{align*}

تفاعل \عددی{y=\tfrac{x^5}{x^2+1}} اور \عددی{y=x+\cos x} کے ساتھ ان کے معکوس تفاعل اور شناختی تفاعل ایک ساتھ ترسیم کر کے دیکھیں۔ ترسیم میں  محور \عددی{x} اور محور \عددی{y} کے اکائی فاصلے برابر نظر آنے چاہیے تا کہ لکیر \عددی{y=x} کے لحاظ سے تفاعل اور اس کا معکوس تشاکلی  نظر آئے۔ 
\begin{figure}
\centering
...
\end{tikzpicture}
\caption{
تفاعل \عددی{y=\sqrt{x}} اور \عددی{y=x^2,\, x\ge 0} ایک دوسرے کے معکوس ہیں (مثال \حوالہ{مثال_ماورائی_الٹ_تفاعل_کی_مثال})۔
}
...
\end{tikzpicture}
\caption{
لکیر \عددی{y=x} میں منعکس غیر انتصابی لکیروں کے ڈھلوان ایک دوسرے کے  مقلوب  ہوتے ہیں۔
}
...
\جزوحصہء{قابل تفرق تفاعل کے معکوس کے تفرق}
تفاعل \عددی{f(x)=\tfrac{x}{2}+1}  اور اس کے معکوس \عددی{f^{-1}(x)=2x-2} (مثال \حوالہ{مثال_ماورائی_الٹ}) کے تفرق درج ذیل ہیں۔
\begin{align*}
\frac{\dif}{\dif x}f(x)&=\frac{\dif}{\dif x}\big(\frac{x}{2}+1\big)=\frac{1}{2}\\
\frac{\dif}{\dif x}f^{-1}(x)&=\frac{\dif}{\dif x}(2x-2)=2
\end{align*}
یہ تفارق ایک دوسرے کے مقلوب  ہیں۔ تفاعل \عددی{f} کی ترسیم لکیر \عددی{y=\tfrac{x}{2}+1} اور \عددی{f^{-1}} کی ترسیم لکیر \عددی{y=2x-2} ہے۔ ان لکیروں کے ڈھلوان ایک دوسرے کے  مقلوب  ہیں (شکل \حوالہ{شکل_ماورائی_عکس_میں_تفرق_تعلق})۔

یہ نتیجہ کسی مخصوص تفاعل کے لیے نہیں۔ لکیر \عددی{y=x} میں کسی بھی غیر افقی یا غیر انتصابی لکیر کے عکس کا ڈھلوان اس لکیر کے ڈھلوان کا  مقلوب ہو گا۔ یوں اگر دی گئی  لکیر کا ڈھلوان \عددی{m\ne 0} (شکل \حوالہ{شکل_ماورائی_عکس_میں_تفرق_تعلق}) ہو تب منعکس لکیر کا ڈھلوان \عددی{\tfrac{1}{m}} ہو گا (سوال \حوالہ{سوال_ماورائی_درکار_ڈھلوان_الٹ})۔ 

تفاعل اور اس کے معکوس کے ڈھلوانوں   کا مقلوبی  تعلق دیگر تفاعلات  کو بھی مطمئن کرتا ہے۔ اگر نقطہ \عددی{(a,f(a))} پر \عددی{y=f(x)} کا ڈھلوان \عددی{f'(a)\ne 0} ہو تب مطابقتی نقطہ \عددی{(f(a),a)} پر \عددی{y=f^{-1}(x)} کا ڈھلوان \عددی{\tfrac{1}{f'(a)}} ہو گا (شکل \حوالہ{شکل_ماورائی_ڈھلوان_بالعکس_متناسب})۔ یوں نقطہ \عددی{f(a)} پر \عددی{f^{-1}} کا تفرق، نقطہ \عددی{a} پر \عددی{f} کے تفرق کا   مقلوب  ہو گا۔ یہ تعلق اس صورت درست ہو گا جب \عددی{f} درج ذیل مسئلہ میں پیش   شرائط کو مطمئن کرتا ہو۔ یہ شرائط اعلیٰ احصاء سے حاصل ہوتی ہیں۔ 
...
\end{subfigure}
\caption{
معکوس تفاعل کے مطابقتی نقطوں پر ڈھلوان ایک دوسرے کے  مقلوب 
\عددی{\left.\tfrac{\dif f^{-1}}{\dif x}\right\vert_{f(a)}=\tfrac{1}{\left.\tfrac{\dif f}{\dif x}\right\vert_{a}}} ہوں گے۔
}
\label{شکل_ماورائی_ڈھلوان_بالعکس_متناسب}
\end{figure}
\ابتدا{مسئلہ}\شناخت{مسئلہ_ماورائی_الٹ_تفرق_قاعدہ}\موٹا{معکوس تفاعل کے تفرق کا قاعدہ}\\
اگر وقفہ \عددی{I} کے ہر نقطہ پر \عددی{f} قابل تفرق ہو اور \عددی{I} پر \عددی{\tfrac{\dif f}{\dif x}} کبھی بھی صفر  نہ ہو، تب وقفہ \عددی{f(I)} کے ہر نقطہ پر \عددی{f^{-1}} قابل تفرق ہو گا۔ کسی ایک مخصوص نقطہ \عددی{f(a)} پر \عددی{\tfrac{\dif f^{-1}}{\dif x}} کا تفرق نقطہ \عددی{a} پر تفرق \عددی{\tfrac{\dif f}{\dif x}} کا مقلوب ہو گا۔
...
تفاعل \عددی{f(x)=x^2,\,x\ge 0} اور اس کے معکوس \عددی{f^{-1}(x)=\sqrt{x}} کے لیے درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
...
\end{tikzpicture}
\caption{
نقطہ \عددی{(4,2)} پر \عددی{f^{-1}(x)=\sqrt{x}} کا تفرق نقطہ \عددی{(2,4)} پر \عددی{f(x)=x^2} کے تفرق کا مقلوب ہو گا (مثال \حوالہ{مثال_ماورائی_تفرق_الٹ_تفرق})۔
}
...
\draw(6,2)node[circ]{}node[below]{$(6,2)$}node[above]{معکوس ڈھلوان $\tfrac{1}{12}$};
\end{axis}
\end{tikzpicture}
\caption{
...
\حلء
(شکل \حوالہ{شکل_مثال_ماورائی_ایک_نقطہ_پر_تفرق_سے_الٹ_تفرق_کا_حصول})
\begin{align*}
...
\dif y=f'(a)\dif x
\end{align*}
ہو گی۔اس کا مطلب ہے کہ \عددی{y} کی تبدیلی، \عددی{x} کی تبدیلی کے تقریباً \عددی{f'(a)} گنا ہو گی اور \عددی{x} کی تبدیلی، \عددی{y} کی تبدیلی کے تقریباً  \عددی{\tfrac{1}{f'(a)}} گنا ہو گی۔

%sec 7.1 questions start here
%sec 7.1 questions start here

\حصہء{سوالات}
\ابتدا{سوالات}
\موٹا{یک بہ یک تفاعل کی نشاندہی}\\
سوال \حوالہ{سوال_ماورائی_ایک_ایک_نشاندہی_الف} تا سوال \حوالہ{سوال_ماورائی_ایک_ایک_نشاندہی_ث} میں تفاعل کی  ترسیمات دی گئی ہیں۔ ان میں  یک بہ یک تفاعل کی نشاندہی کریں۔
...
\موٹا{معکوس تفاعل کی ترسیم}\\
سوال \حوالہ{سوال_ماورائی_ترسیم_دیا_الف} تا سوال \حوالہ{سوال_ماورائی_ترسیم_دیا_ت} میں \عددی{y=f(x)} کی ترسیم دی گئی ہے۔ اس کو نقل کر کے لکیر  \عددی{y=x} بھی کھینچیں۔ لکیر \عددی{y=x} کے لحاظ سے تشاکل استعمال کرتے ہوئے \عددی{y=f^{-1}(x)} ترسیم کریں۔(\عددی{f^{-1}} کا کلیہ معلوم کرنے کی ضرورت نہیں۔) \عددی{f^{-1}} کے دائرہ کار اور سعت کی نشاندہی  کریں۔
...
\ابتدا{جواب}
\wf{\unexpanded{
دائرہ کار \عددی{(0,1]}، سعت \عددی{[0,\infty)}\\
\begin{minipage}{0.45\textwidth}
\centering
...
\ابتدا{جواب}
\wf{\unexpanded{
دائرہ کار \عددی{[-1,1]}، سعت \عددی{-\tfrac{\pi}{2},\tfrac{\pi}{2}} \\
\begin{minipage}{0.45\textwidth}
\centering
...
(ا) تفاعل \عددی{f(x)=\sqrt{1-x^2},\, 0\le x\le 1} ترسیم کریں۔ اس ترسیم میں کون سا تشاکل  پایا جاتا ہے؟ (ب) دکھائیں کہ \عددی{f} اپنا ہی معکوس ہے۔ (یاد رہے کہ \عددی{x\ge 0} کی صورت میں \عددی{\sqrt{x^2}=x} ہوتا ہے۔)
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
لکیر \عددی{y=x} کے لحاظ سے تشاکلی ہے۔ \\
\begin{minipage}{0.45\textwidth}
\centering
...
%==============
\ابتدا{سوال}
(ا) تفاعل \عددی{f(x)=\tfrac{1}{x}} ترسیم کریں۔ اس ترسیم میں کون سا  تشاکل پایا جاتا ہے؟ (ب) دکھائیں کہ \عددی{f} اپنا ہی معکوس ہے۔
\انتہا{سوال}
%==================
\موٹا{معکوس تفاعل کے کلیات}\\
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) \عددی{f^{-1}(x)=\tfrac{x}{2}-\tfrac{3}{2}}\\
(ب) 
\begin{minipage}{0.45\textwidth}
\centering
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) \عددی{f^{-1}(x)=-\tfrac{x}{4}+\tfrac{5}{4}}\\
 (ب) 
\begin{minipage}{0.45\textwidth}
\centering
...
\begin{enumerate}
\item
دکھائیں کہ \عددی{f(x)=x^3} اور \عددی{g(x)=\sqrt[3]{x}} ایک دوسرے کے معکوس ہیں۔
\item
\عددی{f} اور \عددی{g} ترسیم کریں جس میں ان کے نقاط تقاطع \عددی{(1,1)} اور \عددی{(-1,-1)} نظر آئیں۔ آپ کو لکیر \عددی{y=x}  کے لحاظ سے  تشاکل نظر آنا چاہیے۔
\item
نقاط \عددی{(1,1)} اور \عددی{(-1,-1)} پر \عددی{f} اور \عددی{g} کی ترسیمات کے مماس کا ڈھلوان تلاش کریں۔ (کُل چار مماس۔)
\item
...
\end{tikzpicture}
\end{minipage}\\
 (ج) \عددی{(1,1)} پر \عددی{f} کا ڈھلوان \عددی{3} ہے؛ \عددی{(1,1)} پر \عددی{g} کا  ڈھلوان \عددی{\tfrac{1}{3}} ہے؛ \عددی{-1,-1} پر \عددی{f} کا  ڈھلوان \عددی{3} اور \عددی{(-1,-1)} پر \عددی{g} ڈھلوان \عددی{\tfrac{1}{3}} ہے۔  (د) \عددی{x=0} پر \عددی{y=x^3} کا مماس \عددی{y=0} ہے؛ \عددی{x=0} پر \عددی{y=\sqrt[3]{x}} کا مماس \عددی{x=0} ہے۔
}}
\انتہا{جواب}
%========================
\ابتدا{سوال}
\begin{enumerate}
\item
دکھائیں کہ \عددی{h(x)=\tfrac{x^3}{4}} اور \عددی{k(x)=(4x)^{1/3}} ایک دوسرے کے معکوس ہیں۔
\item
\عددی{h} اور \عددی{k} ترسیم کریں جس میں ان کے نقاط تقاطع \عددی{(2,2)} اور \عددی{(-2,-2)} نظر آئیں۔ آپ کو لکیر \عددی{y=x} کے لحاظ سے  تشاکل نظر آنا چاہیے۔
\item
نقاط \عددی{(2,2)} اور \عددی{(-2,-2)} پر \عددی{h} اور \عددی{k} کی ترسیمات کے مماس کا  ڈھلوان تلاش کریں۔ (کُل چار مماس۔)
\item
مبدا پر ان منحنیات کے مماس تلاش کریں۔
\end{enumerate}
\انتہا{سوال}
...
%=======================
\ابتدا{سوال}
فرض کریں قابل تفرق تفاعل \عددی{y=f(x)} کا معکوس پایا جاتا ہے اور \عددی{f} کی ترسیم نقطہ \عددی{(2,4)} سے گزرتی ہے ، جہاں اس کا ڈھلوان \عددی{\tfrac{1}{3}} ہے۔ نقطہ \عددی{x=4} پر \عددی{\tfrac{\dif f^{-1}}{\dif x}} کی قیمت تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$3$
...
%=====================
\ابتدا{سوال}
فرض کریں قابل تفرق تفاعل \عددی{y=g(x)} کا معکوس پایا جاتا ہے اور \عددی{g} کی ترسیم مبدا سے گزرتی ہے ، جہاں اس کا  ڈھلوان \عددی{2} ہے۔ مبدا پر \عددی{g^{-1}} کی ترسیم کا  ڈھلوان تلاش کریں۔
\انتہا{سوال}
%===================
\ابتدا{سوال}
\begin{enumerate}[a.]
\item
تفاعل \عددی{f(x)=mx} کا معکوس تلاش کریں ، جہاں \عددی{m} غیر صفر مستقل ہے۔
\item
تفاعل \عددی{y=f(x)} کی ترسیم مبدا سے گزرتی لکیر ہے ، جس کا ڈھلوان \عددی{m} غیر صفر ہے۔ اس تفاعل کے معکوس کے بارے میں کیا کہا جا سکتا ہے؟
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\begin{enumerate}[a.]
\item
تفاعل \عددی{f(x)=x+1} کا معکوس تلاش کریں۔ \عددی{f} اور اس کا معکوس ایک ساتھ ترسیم کریں۔ لکیر \عددی{y=x} کو بھی شامل کریں۔
\item
تفاعل \عددی{f(x)=x+b}  کا معکوس تلاش کریں جہاں \عددی{b} مستقل ہے۔ \عددی{f^{-1}} کی ترسیم کا \عددی{f} کی ترسیم کے ساتھ کیا تعلق ہے؟
\item
لکیر \عددی{y=x} کے متوازی تفاعل کے معکوس کے بارے میں کیا کہنا ممکن ہو گا؟
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\begin{enumerate}[a.]
\item
تفاعل \عددی{f(x)=-x+1} کا معکوس معلوم کریں۔ لکیر \عددی{y=-x+1} اور لکیر \عددی{y=x} کو ایک ساتھ ترسیم کریں۔ ان لکیروں کے بیچ زاویہ کتنا ہے؟
\item
تفاعل \عددی{f(x)=-x+b} کا معکوس معلوم کریں جہاں \عددی{b} مستقل ہے۔ لکیر \عددی{y=-x+b} اور لکیر \عددی{y=x} کے مابین زاویہ کتنا ہے؟
\item
لکیر \عددی{y=x} کے عمودی تفاعل کے معکوس کے بارے میں کیا کہا جا سکتا ہے؟
\end{enumerate}
\انتہا{سوال}
%========================
...
x_2>x_1\quad \implies f(x_2)<f(x_1)
\end{align*}
دکھائیں کہ بڑھتے تفاعل اور گھٹتے تفاعل یک بہ یک تفاعل ہیں یعنی دکھائیں کہ \عددی{I} میں کسی بھی دو نقطوں \عددی{x_1} اور \عددی{x_2} کے لیے \عددی{x_2\ne x_1} سے مراد \عددی{f(x_2)\ne f(x_1)} ہو گا۔ 
\انتہا{سوال}
%======================
سوال \حوالہ{سوال_ماورائی_الٹ_پایا_الف} تا سوال \حوالہ{سوال_ماورائی_الٹ_پایا_ب} میں سوال \حوالہ{سوال_ماورائی_بڑھتا_گھٹتا_تفاعل} کے نتائج استعمال کرتے ہوئے دکھائیں کہ دیے گئے  تفاعل کا اپنے وقفہ پر معکوس پایا جاتا ہے۔ مسئلہ \حوالہ{مسئلہ_ماورائی_الٹ_تفرق_قاعدہ} کی مدد سے \عددی{\tfrac{\dif f^{-1}}{\dif x}} کا کلیہ تلاش کریں۔
...
\ابتدا{سوال}
اگر \عددی{f(x)} یک بہ یک ہو تب \عددی{g(x)=-f(x)} کے بارے میں کیا کہا جا سکتا ہے؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
%====================
\ابتدا{سوال}
اگر \عددی{f(x)} یک بہ یک اور غیر صفر ہو تب \عددی{h(x)=\tfrac{1}{f(x)}} کے بارے میں کیا کہنا ممکن ہے؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
%===================
\ابتدا{سوال}
فرض کریں کہ \عددی{g} کی سعت، \عددی{f} کے دائرہ کار میں پائی جاتی ہے ، لہٰذا مرکب تفاعل \عددی{f\circ g} معین ہے۔ اگر \عددی{f} اور \عددی{g} یک بہ یک ہوں تب \عددی{f\circ g} کے بارے میں کیا کہنا ممکن ہو گا؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
%======================
\ابتدا{سوال}
اگر مرکب تفاعل \عددی{f\circ g} یک بہ یک ہو تب کیا \عددی{g} لازماً یک بہ یک ہو گا؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
%===================
\ابتدا{سوال}
فرض کریں وقفہ \عددی{[a,b]} پر \عددی{f(x)} مثبت، استمراری اور بڑھتا تفاعل  ہے۔ ترسیم کی تاویل کرتے ہوئے درج ذیل دکھائیں۔
\begin{align*}
...
\end{align*}
اس میں \عددی{a} کی جگہ \عددی{x} پُر کرنے سے  
\begin{align*}
g'(f(x))\cdot f'(x)=1
\end{align*}
ملتا ہے جو زنجیری قاعدہ یاد دلاتی ہے۔ یقیناً درج بالا اور زنجیری قاعدہ کے بیچ تعلق پایا جاتا ہے۔

فرض کریں \عددی{f} اور \عددی{g} قابل تفرق اور ایک دوسرے کے معکوس ہیں لہٰذا \عددی{(f\circ g)(x)=x} ہو گا۔ زنجیری قاعدہ استعمال کرتے ہوئے اس مساوات کے دونوں اطراف کا \عددی{x} کے لحاظ سے  تفرق لے کر  \عددی{(f\circ g)'(x)} کو \عددی{f} اور \عددی{g} کے تفرق کی صورت میں لکھ کر دیکھیں  کیا حاصل ہوتا ہے؟ (مسئلہ \حوالہ{مسئلہ_ماورائی_الٹ_تفرق_قاعدہ} کو دیکھنے کا یہ بھی ایک طریقہ ہے۔)
\انتہا{سوال}
%=========================
\ابتدا{سوال}\شناخت{سوال_ماورائی_ترکیب_چھلا_اور_ترکیب_خول_مساوی_ہیں}\ترچھا{ترکیب چھلا اور ترکیب خول کی مساوات}\\
فرض کریں وقفہ \عددی{a\le x\le b} پر \عددی{f} قابل تفرق ہے جہاں \عددی{a>0} ہے اور \عددی{f} کا قابل تفرق معکوس \عددی{f^{-1}} پایا جاتا ہے۔ تفاعل \عددی{f}،  لکیر \عددی{x=a} اور لکیر \عددی{y=f(b)} کے بیچ خطہ ، کو محور \عددی{y} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔اس جسم کے حجم کے  تکمل ، جو  ترکیب چھلا اور ترکیب خول     دیتی ہیں، کی قیمتیں یکساں ہیں۔
\begin{align*}
...
\end{align*}
اس کے بعد دکھائیں کہ \عددی{[a,b]} کے کسی نقطے  پر \عددی{C(t)} اور \عددی{K(t)} کی قیمتیں ایک جیسی ہیں اور \عددی{[a,b]} پر ان کے تفرق بھی ایک جیسے ہیں۔ صفحہ \حوالہصفحہ{سوال_تکمل_یکتائی_حل_کی_شرط} پر سوال \حوالہ{سوال_تکمل_یکتائی_حل_کی_شرط} کے نتیجہ کے  مطابق \عددی{[a,b]} میں تمام \عددی{t} کے لیے \عددی{C(t)=K(t)} ہو گا۔ بالخصوص \عددی{C(b)=K(b)} ہو گا۔
\انتہا{سوال}
%========================
\موٹا{کمپیوٹر کا استعمال}\\
سوال \حوالہ{سوال_ماورائی_کمپیوٹر_تخمینی_تفاعل_الف} تا سوال \حوالہ{سوال_ماورائی_کمپیوٹر_تخمینی_تفاعل_ب} میں آپ چند تفاعل اور ان کے معکوس پر غور کریں گے۔ اس کے علاوہ دیے گئے نقطہ پر ان کے تفرق اور خطی تخمینی تفاعل  پر غور کریں گے۔ ان سوالات میں درج ذیل اقدام کریں۔ 
\begin{enumerate}[a.]
\item
دیے گئے وقفہ پر تفاعل \عددی{y=f(x)} اور اس کا تفرق ترسیم کریں۔ آپ کیسے جانتے ہیں کہ اس وقفہ پر \عددی{f} یک بہ یک ہے؟
\item
مساوات \عددی{y=f(x)} کو \عددی{x} کے لیے حل کر کے حاصل معکوس تفاعل کو \عددی{g} سے ظاہر کریں۔
\item
دیے گئے نقطہ \عددی{(x_0,f(x_0))} پر \عددی{f} کے مماس کی مساوات دریافت کریں۔
\item
لکیر \عددی{y=x} کی  دوسری جانب تشاکلی نقطہ \عددی{(f(x_0),x_0)} پر \عددی{g} کے مماس کی مساوات دریافت کریں۔ مسئلہ \حوالہ{مسئلہ_ماورائی_الٹ_تفرق_قاعدہ} کی مدد سے اس مماسی لکیر کا ڈھلوان معلوم کریں۔
\item
تفاعل \عددی{f}، \عددی{g}، لکیر \عددی{y=x}، دونوں مماسی خطوط،  اور نقطہ \عددی{(x_0,f(x_0))} اور \عددی{(f(x_0),x_0)} کو جوڑنے والا سیدھا خط ترسیم کریں۔ آپ کو جو تشاکلی نظر آتی ہے اس پر تبصرہ کریں؟
\end{enumerate}
...
\انتہا{سوال}
%===========================
سوال \حوالہ{سوال_ماورائی_خفی_حل_الف} اور سوال \حوالہ{سوال_ماورائی_خفی_حل_ب} میں درج بالا تمام اقدام بروئے کار لاتے ہوئے دیے گئے وقفہ پر خفی تفاعل  کو حل کر کے  \عددی{y=f(x)} اور \عددی{x=f^{-1}(y)} حاصل کریں۔
...
%sec 7.1 questions end here
%sec 7.1 questions end here



\حصہ{قدرتی لوگارتھم}
ریاضیات  اور سائنس میں تفاعل اور معکوس کی  اہم ترین   جوڑی قدرتی لوگارتھم \عددی{\ln x}اور قوت نما تفاعل \عددی{e^x} کی جوڑی ہے۔ تفاعل \عددی{e^x} کی وضاحت  \عددی{\ln x} سے ہوتی ہے لہٰذا ہم پہلے \عددی{\ln x}  متعارف کرتے ہیں۔شروع میں لوگارتھم  کی اہمیت   حساب میں آسانی   پیدا   کرنے  کی وجہ سے سامنے آئی۔سترھویں صدی میں  لوگارتھم کی  خوبیوں نے   فلکی میکانیات کا حساب اور ساحل سے دور جہاز رانی ممکن بنایا۔ اگرچہ آج کل پیچیدہ حساب کمپیوٹر کی مدد سے کیا جاتا ہے، بہر حال لوگارتھم کی خوبیاں آج بھی اتنی ہی اہمیت رکھتی ہیں۔
...
اگر \عددی{x>1} ہو تب \عددی{t=1} سے \عددی{t=x} تک منحنی \عددی{y=\tfrac{1}{t}} کے نیچے رقبہ \عددی{\ln x} ہو گا (شکل \حوالہ{شکل_ماورائی_قدرتی_لوگارتھمی_تفاعل_تعریف})۔ اگر \عددی{0<x<1}ہو تب \عددی{x} سے \عددی{1} تک منحنی \عددی{y=\tfrac{1}{t}}  کے نیچے رقبے کا منفی \عددی{\ln x} ہو گا۔ قدرتی لوگارتھمی تفاعل وقفہ \عددی{x\le 0} کے لیے غیر معین ہے۔ لوگارتھمی تفاعل  کے لئے درج ذیل ہو گا۔
\begin{align*}
\ln 1&=\int_1^1\frac{1}{t}\dif t=0&&\text{\RL{بالائی اور زیریں حد یکساں ہیں}}
\end{align*}
%
\begin{figure}
\centering
...
\end{subfigure}
\caption{
تفاعل \عددی{y=\tfrac{1}{x},\,x>0} اور قدرتی لوگارتھمی تفاعل \عددی{y=\ln x} کا تعلق۔ قدرتی لوگارتھمی تفاعل \عددی{x>1} کے لیے مثبت اور \عددی{x<1} کے لیے منفی ہے۔ 
}
...
\end{align*}
لکھا جائے گا جہاں  \عددی{x} کے دو مختلف معنی ہیں۔ اسی لیے ہم تکمل میں متغیر کو تبدیل کرتے ہوئے \عددی{t} لکھتے ہیں۔

\عددی{x} کی مختلف قیمتوں کے لیے  تین اعشاریہ مقامات تک   درست قدرتی لوگارتھمی قیمتیں درج ذیل ہیں۔
\begin{align*}
...
\end{align*}
لکھا جا سکتا ہے لہٰذا \عددی{x} کی ہر مثبت قیمت کے  لیے  درج ذیل ہو گا۔
\begin{align*}
...
آپ نے مثال \حوالہ{مثال_ماورائی_قدرتی_لوگارتھمی_تفرق} میں دیکھا کہ تفاعل \عددی{y=\ln 2x} کا تفرق وہی ہے جو تفاعل \عددی{y=\ln x} کا ہے۔ درحقیقت کسی بھی تفاعل \عددی{y=\ln ax} کے لیے درست ہے جہاں \عددی{a} کوئی عدد ہے:
\begin{align}\label{مساوات_ماورائی_لوگارتھمی_تفرق_ب}
\frac{\dif}{\dif x}\ln ax=\frac{1}{ax}\frac{\dif}{\dif x}(ax)=\frac{1}{ax}(a)=\frac{1}{x}
\end{align}

\ابتدا{مثال}
اگر مساوات \حوالہ{مساوات_ماورائی_لوگارتھمی_تفرق_الف} میں \عددی{u=x^2+3} پُر کیا جائے تب درج ذیل ہو گا۔
\begin{align*}
...
کمپیوٹر کی ایجاد سے پہلے   ریاضیات  میں سب سے زیادہ  آسانی لوگارتھم  کی وجہ سے ہوئی\حاشیہد{اسکاچی ریاضی دان جان نیپر نے سولھویں صدی میں لوگارتھم ایجاد کیا۔ انہوں نے اپنی زندگی کے آخری بیس برس لوگارتھمی جدول مکمل کرنے میں صرف کیے}۔ لوگارتھم کی وہ خوبیاں جن کی بدولت حساب میں آسانی  پیدا ہوئی،  جدول \حوالہ{جدول_ماورائی_خواص_قدرتی_لوگارتھم} میں دی گئی ہیں۔ ان خواص کی وجہ سے مثبت اعداد کے ضرب کی جگہ جمع اور مثبت اعداد کی تقسیم کی جگہ تفریق استعمال ہونے لگا۔ اس کے علاوہ طاقت کی جگہ ضرب استعمال کیا جانے لگا۔ وقتی طور پر ہم جزو د میں طاقت \عددی{n} کو ناطق عدد تصور کرتے ہیں۔ اس کی وضاحت جزو د کے ثبوت کے دوران ہو گی۔  
\begin{table}
...
\begin{tabular}{rrl}
 \toprule
\multicolumn{3}{c}{\RL{کسی بھی اعداد \عددی{a>0} اور \عددی{x>0} کے لیے۔}}\\
\midrule
ا)& قاعدہ ضرب& $\ln ax=\ln a+\ln x$\\
ب)&قاعدہ حاصل تقسیم & $\ln \dfrac{a}{x}=\ln a-\ln x$\\
ج)&قاعدہ مقلوب& $\ln \dfrac{1}{x}=-\ln x$\\
...
\ln \sec x&=\ln \frac{1}{\cos x}=-\ln \cos x&&\text{\RL{مقلوب}}\\
...
اس کی دلیل عجیب اور  عمدہ ہے۔ ہم دیکھتے ہیں کہ \عددی{\ln ax} کا تفرق اور \عددی{\ln x} کا تفرق یکساں ہیں (مساوات \حوالہ{مساوات_ماورائی_لوگارتھمی_تفرق_ب})۔ مسئلہ اوسط قیمت کا ضمنی نتیجہ دوم (صفحہ \حوالہ{نتیجہ_صریح_استعمال_دوم}) کہتا ہے کہ ان تفاعلات میں مستقل کا فرق ہو گا۔
\begin{align}\label{مساوات_ماورائی_مستقل_کیا_الف}
\ln ax&=\ln x+C &&\text{\RL{$C$ مستقل}}
\end{align}
اب صرف یہ دکھانا باقی ہے کہ \عددی{C} اور \عددی{\ln a}  برابر ہیں۔

مساوات \حوالہ{مساوات_ماورائی_مستقل_کیا_الف} \عددی{x} کی تمام مثبت قیمتوں کے لیے درست ہے لہٰذا یہ \عددی{x=1} کے لیے بھی درست ہو گا۔یوں درج ذیل ہو گا۔
\begin{align*}
\ln (a\cdot 1)&=\ln 1+C\\
\ln a&=0+C&&\ln 1=0\\
C&=\ln a&&\text{\RL{ترتیب دی گئی ہے}}
\end{align*}
مساوات \حوالہ{مساوات_ماورائی_مستقل_کیا_الف} میں \عددی{C=\ln a} پُر کرنے سے ہمیں درکار تعلق حاصل ہوتا ہے۔
...
ہم مساوات \حوالہ{مساوات_ماورائی_مستقل_کیا_ب} کو دو  مرتبہ  استعمال کر کے ثبوت پیش کرتے ہیں۔ مساوات \حوالہ{مساوات_ماورائی_مستقل_کیا_ب} میں \عددی{a} کی جگہ \عددی{\tfrac{1}{x}} پُر کرنے سے
\begin{align*}
...
\ln\frac{1}{x}=-\ln x
\end{align*}
ہو گا۔ مساوات \حوالہ{مساوات_ماورائی_مستقل_کیا_ب} میں \عددی{x} کی جگہ \عددی{\tfrac{1}{x}} پُر کرنے سے
\begin{align*}
...
تمام مثبت \عددی{x} قیمتوں کے لیے درج ذیل ہو گا۔ (درج ذیل میں یاد رہے کہ ہم نے طاقتی قاعدہ صرف ناطق اعداد کے لیے ثابت کیا ہے۔)
\begin{align*}
...
\end{align*}
چونکہ \عددی{\ln x^n} اور \عددی{n\ln x} کے تفرق  برابر ہیں لہٰذا
\begin{align*}
\ln x^n&=n\ln x+C&&\text{\RL{$C$ مستقل}}
\end{align*}
ہو گا جس میں \عددی{x=1} پُر کرنے سے \عددی{C=0} ملتا ہے۔
\انتہا{ثبوت}
%=================

اگرچہ ہم نے غیر ناطق \عددی{n} کے لیے قاعدہ \عددی{\ln x^n=n\ln x} ثابت نہیں کیا، یہ قاعدہ غیر ناطق اعداد کے لیے بھی درست ہے،  لہٰذا اس کو بغیر فقر استعمال کریں۔ 

\جزوحصہء{$\ln x$ کی ترسیم اور سعت}
چونکہ \عددی{x>0} کے لیے  \عددی{\tfrac{\dif}{\dif x}(\ln x)=\tfrac{1}{x}} ہے لہٰذا \عددی{\ln x} متغیر \عددی{x} کا بڑھتا تفاعل ہے۔ اس کا دو رتبی تفرق، \عددی{-\tfrac{1}{x^2}}، منفی ہے لہٰذا \عددی{\ln x} کی ترسیم نیچے مقعر ہے۔
...
\ابتدا{مثال}
تفاعل \عددی{y=\tfrac{(x^2+1)(x+3)^{1/2}}{x-1},\, x>1} کے لیے \عددی{\dif y\!/\!\dif x} تلاش کریں۔
...
\end{align*}
اس کو \عددی{\tfrac{\dif y}{\dif x}} کے لیے حل کرتے ہیں۔
\begin{align*}
\frac{\dif y}{\dif x}=y\big(\frac{2x}{x^2+1}+\frac{1}{2x+6}-\frac{1}{x-1}\big)
\end{align*}
آخر میں ہم \عددی{y} کی قیمت پُر کرتے ہیں۔
\begin{align*}
...
\frac{\dif y}{\dif x}&=y\frac{\dif}{\dif x}(\ln f(x))&&\text{\RL{$\frac{\dif y}{\dif x}$ کے لیے حل کریں}}\\
\frac{\dif y}{\dif x}&=f(x)\frac{\dif}{\dif x}(\ln f(x))&&\text{\RL{$y=f(x)$ پُر کریں}}
\end{align*}
...
\end{align*}
اور \عددی{n=-1} کے لیے مساوات \حوالہ{مساوات_ماورائی_تفاعل_لوگارتھمی_تکمل_پ} کی طرف دیکھ سکتے ہیں۔

مساوات \حوالہ{مساوات_ماورائی_تفاعل_لوگارتھمی_تکمل_پ} کے تحت درج ذیل ہو گا
\begin{align*}
\int\frac{f'(x)}{f(x)}\dif x=\ln\abs{f(x)}+C
\end{align*}
جہاں \عددی{f(x)} قابل تفرق تفاعل ہے ، جس کی علامت پورے دائرہ کار پر تبدیل نہیں ہوتی۔
...
ہمیں مساوات \حوالہ{مساوات_ماورائی_تفاعل_لوگارتھمی_تکمل_پ} کی مدد سے \عددی{\tan x} اور \عددی{\cot x} کے  تکمل لے سکتے ہیں۔ٹینجنٹ کے لیے درج ذیل ہو گا۔
\begin{align*}
...
&=-\ln\abs{\cos x}+C=\ln\frac{1}{\abs{\cos x}}+C&&\text{\RL{قاعدہ مقلوب}}\\
&=\ln\abs{\sec x}+C
\end{align*}
کوٹینجنٹ کے لیے درج ذیل ہو گا۔
\begin{align*}
...
\انتہا{سوال}
%==================
سوال \حوالہ{سوال_ماورائی_سادہ_الف} اور سوال \حوالہ{سوال_ماورائی_سادہ_ب} میں خواص لوگارتھم کی مدد سے دی گئی ریاضیاتی عبارت کی سادہ صورت تلاش کریں۔
...
\موٹا{لوگارتھمی تفرق}\\
سوال \حوالہ{سوال_لوگارتھمی_تفرق_الف} تا سوال \حوالہ{سوال_لوگارتھمی_تفرق_ب} میں لوگارتھمی تفرق استعمال کرتے ہوئے \عددی{y} کا ، دیے گئے  آزاد  متغیر کے لحاظ سے ، تفرق لیں۔
...
\ابتدا{سوال}
درج ذیل کی  مطلق انتہائی قیمتیں تلاش کریں۔
\begin{multicols}{2}
\begin{enumerate}[a.]
\item
...
%==========================
\ابتدا{سوال}
(ا) ثابت کریں کہ \عددی{x>1} کے لیے \عددی{f(x)=x-\ln x} بڑھتا ہے۔ (ب) \عددی{x>1} کی صورت میں جزو-ا استعمال کرتے ہوئے دکھائیں کہ \عددی{\ln x<x} ہو گا۔
\انتہا{سوال}
%========================
\ابتدا{سوال}
...
%========================
\ابتدا{سوال}
ربع اول میں محددی لکیروں، منحنی \عددی{x=\tfrac{2}{\sqrt{y+1}}}،  اور لکیر \عددی{y=3} کے بیچ موجود  خطے کو محور \عددی{y} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔اس جسم کا حجم تلاش کریں۔
 \انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$4\pi\ln 4$
...
%========================
\ابتدا{سوال}
منحنی \عددی{y=\tfrac{9x}{\sqrt{x^3+9}}} اور محور \عددی{x} پر \عددی{x=0} تا \عددی{x=3} کے بیچ خطہ  کو صفحہ \حوالہصفحہ{سوال_تکمل_استعمال_ترکیب_چھلا_ث} پر سوال \حوالہ{سوال_تکمل_استعمال_ترکیب_چھلا_ث}  میں محور \عددی{y} کے گرد گھما کر \عددی{36\pi} حجم کا جسم طواف پیدا کیا  گیا۔ اگر اس خطہ کو محور \عددی{x} کے گرد گھما کر جسم طواف پیدا کیا جائے تب اس جسم کا حجم کتنا ہو گا؟
\انتہا{سوال}
%==========================
\ابتدا{سوال}
درج ذیل منحنیات کی لمبائیاں  تلاش کریں۔
\begin{multicols}{2}
\begin{enumerate}[a.]
\item
...
%===================
\ابتدا{سوال}
(ا) منحنی \عددی{y=\tfrac{1}{x}} اور محور \عددی{x} پر \عددی{x=1} تا \عددی{x=2} کے بیچ خطے کا وسطانی مرکز دو اعشاریہ مقامات تک    تلاش کریں۔ (ب) خطے کا خاکہ بنا کر وسطانی مرکز دکھائیں۔
 \انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%======================
\ابتدا{سوال}
(ا) ایک پتلی چادر جس کی کثافت مستقل ہے منحنی \عددی{y=\tfrac{1}{\sqrt{x}}} اور محور \عددی{x} پر \عددی{x=1} تا \عددی{=16} کے بیچ پائی  جاتی ہے۔ اس چادر کی کمیت کا مرکز تلاش کریں۔ (ب) اگر چادر کی کثافت \عددی{\delta(x)=\tfrac{4}{\sqrt{x}}} ہو تب اس کی کمیت کا مرکز کیا ہو گا؟
\انتہا{سوال}
%========================
...
%=======================
\ابتدا{سوال}
نقطہ \عددی{x=0} پر \عددی{\ln(1+x)} کی خط بندی کی خاطر \عددی{x=1} کے قریب \عددی{x} کی تخمین کے بجائے ہم \عددی{x=0} کے قریب \عددی{\ln(1+x)} کی تخمین لیتے ہیں۔اس طرح نسبتاً سادہ کلیہ حاصل ہوتا ہے۔ (ا) نقطہ \عددی{x=0} کے قریب \عددی{\ln(1+x)\approx x} کی خط بندی کریں۔ (ب) وقفہ \عددی{[0,0.1]} پر \عددی{\ln(1+x)} کے بجائے \عددی{x}  استعمال کرنے سے پیدا خلل کو \عددی{5} اعشاریہ  مقامات تک تلاش کریں۔ (ج) منحنی \عددی{y=\ln(1+x)} اور \عددی{y=x} کو ایک ساتھ وقفہ \عددی{[0,0.5]} پر ترسیم کریں۔ کس نقطہ پر خط بندی بہترین ہے؟  کمترین   بہتر  ہے؟ ترسیم سے خلل  کی بالائی حد  پڑھ کر تلاش کریں۔
 \انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
 (ب)\عددی{0.00469}
...
%=================
\ابتدا{سوال}
اگرچہ چھوٹے وقفوں  پر خط بندی   ، لوگارتھمی تفاعل کے لئے  ، بہترین نتائج  دیتی  ہے،مخصوص  لوگارتھمی   قیمتیں قاعدہ سمسن  زیادہ بہتر   دیتا ہے۔

یہ دیکھنے کی خاطر \عددی{\ln(1.2)} اور \عددی{\ln(0.8)} کی \عددی{5} اعشاریہ مقامات تک  قیمتیں بالترتیب \عددی{0.18232} اور \عددی{-0.22314} ہیں۔ ان قیمتوں کہ پہلے کلیہ \عددی{\ln(1+x)\approx x} اور اور بعد میں \عددی{n=2} لیتے ہوئے قاعدہ سمسن سے حاصل کریں۔ (نتائج حیرت کن حد تک درست ہیں!)
\انتہا{سوال}
%========================
\ابتدا{سوال}
...
%============================
\ابتدا{سوال}
کیا ہر نقطہ پر \عددی{y=\ln 3x} اور \عددی{y=\ln 3x} کے تفرق برابر ہو سکتے ہیں(تفرق لے کر دیکھیں) ؟ تفاعل \عددی{y=\ln kx} جہاں \عددی{k} مثبت مستقل ہے کے لیے کیا کہا جا سکتا ہے؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
%============================
\ابتدا{سوال}
تفاعل \عددی{\ln x}، \عددی{\ln 2x}، \عددی{\ln 4x}، \عددی{\ln 8x}،  اور \عددی{\ln 16x} کو \عددی{0<x\le 10} کے لیے ترسیم کریں۔ آپ کیا دیکھتے ہیں؟ وجہ بیان کریں۔
\انتہا{سوال}
%==========================
\ابتدا{سوال}
تفاعل \عددی{y=\ln\abs{\sin x}} کو ترسیم کر کے کمپیوٹر کے شیشہ پر  \عددی{0\le x\le 22} اور \عددی{-2\le y\le 0} کے بیچ نتائج  دیکھیں۔ آپ کو کیا نظر آتا ہے؟ وجہ بیان کریں۔  ترسیم میں محاریب    الٹی کرنے کے لیے تفاعل میں کیا تبدیلی کرنی ہو گی؟
\انتہا{سوال}
%=======================
\ابتدا{سوال}
(ا) تفاعل \عددی{y=\sin x} اور \عددی{y=\ln(a+\sin x)} کو \عددی{a=2,4,8,20,50} کے لیے ایک ساتھ \عددی{0\le x\le 23} پر ترسیم کریں۔  (ب) \عددی{a} کی قیمت بڑھنے سے ترسیمات افقی صورت کیوں اختیار کرتی  ہیں؟ (اشارہ۔ \عددی{a} کے لحاظ سے \عددی{\abs{y'}} کی بالائی حد تلاش کریں۔)
\انتہا{سوال}
%======================
\ابتدا{سوال}
...
%sec 7.2 questions end here
%sec 7.2 questions end here


\حصہ{قوت نمائی تفاعل}
جب مقدار \عددی{y} کی  زمانی  شرح تبدیلی مقدار کی موجودہ  قدر  \عددی{y} کے راست متناسب ہو، ہمارے پاس  ایسا تفاعل  ہے    جو درج ذیل تفرقی مساوات کو مطمئن کرے گا۔
\begin{align*}
\frac{\dif y}{\dif t}&=k y&&\text{\RL{$k$ مستقل}}
\end{align*} 
اگر لمحہ \عددی{t=0} پر \عددی{y=y_0} ہو،  یہ تفاعل  قوت نمائی تفاعل \عددی{y=y_0e^{kt}} ہو گا۔  اس حصہ میں قوت نمائی تفاعل کی تعریف (یہ \عددی{\ln x} کا معکوس ہے) پیش کی جائے گی اور اس کی خصوصیات  پر غور کیا جائے گا ، جن کی بدولت قوت نمائی تفاعل ریاضیات اور  اس کے  اطلاق  میں کثرت سے پایا جاتا ہے (حصہ \حوالہ{حصہ_ماورائی_افزائش_تنزل})۔

\جزوحصہء{\عددی{\ln x} کا معکوس اور عدد \عددی{e}}
تفاعل \عددی{\ln x} متغیر \عددی{x} کا بڑھتا تفاعل ہے۔ \عددی{\ln x} کا دائرہ کار \عددی{(0,\infty)} اور سعت \عددی{(-\infty,\infty)}  ہے ،جبکہ اس کا معکوس \عددی{\ln^{-1} x} ہے ، جس کا دائرہ کار \عددی{(-\infty,\infty)} اور سعت \عددی{(0,\infty)} ہے۔ لکیر \عددی{y=x} میں \عددی{\ln x} کا عکس تفاعل \عددی{\ln^{-1} x} کی ترسیم دیتا ہے۔ آپ تصدیق کر سکتے ہیں کہ تفاعل \عددی{\ln^{-1} x} کے لیے
\begin{align*}
...
\end{tikzpicture}
\caption
{تفاعل $y\ln x$ اور تفاعل $y=\ln^{-1} x$۔ عدد $e$ سے مراد $\ln^{-1} 1$ ہے۔}
\label{شکل_ماورائی_قوت_نمائی_تعریف}
\end{figure}
اگرچہ \عددی{e} ناطق عدد نہیں، ہم باب \حوالہ{باب_لامتناہی_تسلسل}  میں دیکھیں گے کہ درج ذیل کلیہ سے، کمپیوٹر استعمال کرتے ہوئے، ہم  جتنے اعشاریہ تک اس کی قیمت چاہیں معلوم کر سکتے ہیں۔
\begin{align*}
...
\جزوحصہء{تفاعل $y=e^x$}
ہم معمول کی طرح   \عددی{e} کو \عددی{x} کی ناطق طاقت (ذیل دیکھیں) تک   لے جا  سکتا ہیں۔
\begin{align*}
...
\end{align} 
چونکہ \عددی{\ln x} یک بہ یک ہے اور \عددی{\ln(\ln^{-1}x)=x} ہے لہٰذا مساوات \حوالہ{مساوات_ماورائی_قوت_نمائی_لوگارتھم_الف} کے تحت درج ذیل ہو گا۔
\begin{align}\label{مساوات_ماورائی_قوت_نمائی_لوگارتھم_ب}
e^x&=\ln^{-1}x&&\text{\RL{ناطق $x$}}
\end{align}

مساوات \حوالہ{مساوات_ماورائی_قوت_نمائی_لوگارتھم_ب} کی مدد سے \عددی{e^x} کی تعریف کو وسعت دے کر غیر ناطق \عددی{x} کو بھی شامل کیا جا سکتا ہے۔ \عددی{x} کی تمام قیمتوں کے لیے تفاعل \عددی{\ln^{-1}x} معین ہے،  لہٰذا ہم اس کو استعمال کرتے ہوئے \عددی{e^x} کو ان نقطوں پر بھی قیمت مختص کر سکتے ہیں جہاں پہلے \عددی{e^x} کی کوئی قیمت نہیں پائی جاتی تھی۔ اس طرح قوت نمائی تفاعل کی عالمگیر تعریف درج ذیل ہو گی۔

\ابتدا{تعریف} $e^x$\\
ہر حقیقی عدد \عددی{x} کے لئے  \عددی{e^x=\ln^{-1}x\,} ہو گا۔
\انتہا{تعریف}

\جزوحصہء{ایسی مساواتیں جن میں $\ln x$ اور $e^x$ موجود ہوں}
چونکہ \عددی{\ln x} اور \عددی{e^x} ایک دوسرے کے معکوس ہیں لہٰذا ان کی معکوس مساواتیں درج ذیل ہوں گی۔
\begin{align}
e^{\ln x}&=x&&\text{\RL{تمام $x>0$}}\label{مساوات_ماورائی_الٹ_الف}\\
\ln(e^x)&=x,&&\text{\RL{تمام $x$}}\label{مساوات_ماورائی_الٹ_ب}
\end{align}
اگلی مثال کے کچھ حصوں کو کیلکولیٹر سے حل کریں۔
...
%======================
\ابتدا{مثال}
اگر \عددی{e^{2k}=10} ہو    ، \عددی{k} کتنا ہو گا؟
...
اگرچہ \عددی{e^x} کی  پیش  کردہ تعریف \عددی{\ln^{-1}x}  گول مول سی ہے، یہ  قوت نما کے الجبرائی قواعد (جدول \حوالہ{جدول_ماورائی_قواعد_قوت_نما})  کو مطمئن کرتا ہے۔
\begin{table}
...
\toprule
\multicolumn{2}{c}
{تمام  \عددی{x}، \عددی{x_1}، اور \عددی{x_2} کے لئے}\\
\midrule
ا )&
...
\end{align*}
تب مساوات کے دونوں  اطراف کے لوگارتھم لیتے ہوئے 
\begin{align*}
x_1&=\ln y_1\\
x_2&=\ln y_2
\end{align*}
...
قوت نمائی تفاعل ایک ایسے قابل تفرق تفاعل کا معکوس ہے جس کا تفرق کبھی بھی صفر نہیں ہوتا، لہٰذا قوت نمائی تفاعل بھی قابل تفرق ہو گا۔ \عددی{y=e^x} سے شروع کرتے ہوئے درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
y&=e^x\\
...
ہم حصہ \حوالہ{حصہ_ماورائی_افزائش_تنزل} میں دیکھیں گے کہ یہ خاصیت صرف \عددی{e^x} کا  مستقل مضرب تفاعل رکھتا ہے۔
...
\end{aligned}
\end{gather}
آپ دیکھ سکتے ہیں کہ \عددی{x>\sqrt{3}} کے لیے حل درست ہے۔

تفرقی مساوات میں حل کو پُر کر کے تصدیق کرنا بہتر ثابت ہوتا ہے۔ مساوات \حوالہ{مساوات_ماورائی_مثال_الف} اور مساوات \حوالہ{مساوات_ماورائی_مثال_ب} کو تفرقی مساوات میں پُر کرتے ہیں۔
\begin{align*}
...
&=2x
\end{align*}
یوں تفرقی مساوات کو حاصل  کیا گیا  حل مطمئن کرتا ہے۔
\انتہا{مثال}
%====================
%sec 7.3 questions start here
%sec 7.3 questions start here
\حصہء{سوالات}
\ابتدا{سوالات}
...
سوال \حوالہ{سوال_ماورائی_قوت_نما_لوگارتھم_حل_الف} تا سوال \حوالہ{سوال_ماورائی_قوت_نما_لوگارتھم_حل_ب} میں \عددی{t} یا \عددی{x} (جیسا موزوں ہو) کے لحاظ سے \عددی{y} کے لیے حل کریں۔
...
\انتہا{سوال}
%====================
سوال \حوالہ{سوال_ماورائی_کے_الف} اور سوال \حوالہ{سوال_ماورائی_کے_ب} کو \عددی{k} کے لیے حل کریں۔
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) \عددی{k=\ln 2}، (ب) \عددی{k=\tfrac{1}{10}\ln 2}،\\
 (ج) \عددی{k=1000\ln a}
}}
\انتہا{جواب}
%==========================
...
\انتہا{سوال}
%=======================
سوال \حوالہ{سوال_ماورائی_ٹی_الف} تا سوال \حوالہ{سوال_ماورائی_ٹی_ب} کو \عددی{t} کے لیے حل کریں۔
...
\ابتدا{سوال}
وقفہ \عددی{[0,1]} پر \عددی{f(x)=e^x-2x} کی مطلق اعظم قیمت اور مطلق اقل قیمت تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
تفاعل \عددی{f(x)=2e^{\sin\tfrac{x}{2}}} کی مطلق انتہا قیمتیں کیا اور کہاں ہیں (شکل \حوالہ{شکل_سوال_ماورائی_قوت_نما_سائن})۔
\انتہا{سوال}
%======================
\begin{figure}
\centering
...
\end{figure}
\ابتدا{سوال}
تفاعل \عددی{f(x)=x^2\ln\tfrac{1}{x}} کی مطلق اعظم قیمت تلاش کریں۔ یہ قیمت کہاں پائی جاتی ہے۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%===================
\ابتدا{سوال}
تفاعل \عددی{f(x)=(x-3)^2e^x} اور اس کا یک  رتبی تفرق ایک ساتھ ترسیم کریں۔ \عددی{f'} کی قیمت اور علامت کے لحاظ سے \عددی{f} کے رویے  پر تبصرہ کریں۔ احصاء کی مدد سے ترسیم پر نمایاں نقطوں کی نشاندہی کریں۔
\انتہا{سوال}
%=====================
\ابتدا{سوال}
...
منحنی \عددی{x=\tfrac{e^y+e^{-y}}{2},\,0\le y\le \ln 2} کو محور \عددی{y} کے گرد گھما کر سطح طواف پیدا کی جاتی ہے (شکل \حوالہ{شکل_سوال_ماورائی_سطح_طواف_رقبہ})۔ اس سطح کا رقبہ تلاش کریں۔
\انتہا{سوال}
%========================
\ابتدا{سوال}
(ا) دکھائیں \عددی{\int\ln x\dif x=x\ln x-x+C} ہو گا۔(ب) وقفہ \عددی{[1,e]} پر \عددی{\ln x} کی اوسط قیمت تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\item
وقفہ \عددی{[0,0.2]} پر \عددی{e^x} کی جگہ \عددی{1+x} استعمال کرنے سے پیدا خلل کو \عددی{5} اعشاریہ  مقامات تک تلاش کریں۔
\item
...
\begin{enumerate}[a.]
\item
مساوات \عددی{e^{x_1}e^{x_2}=e^{x_1+x_2}} جس کو اس حصہ میں حاصل کیا گیا، سے شروع کر کے دکھائیں کہ کسی بھی حقیقی عدد \عددی{x} کے لیے \عددی{e^{-x}=\tfrac{1}{e^x}} ہو گا۔ اس کے بعد کسی بھی دو اعداد \عددی{x_1} اور \عددی{x_2} کے لیے دکھائیں کہ \عددی{\tfrac{e_{x_1}}{e^{x_2}}=e^{x_1-x_2}} ہو گا۔
\item
کسی بھی دو اعداد \عددی{x_1} اور \عددی{x_2} کے لیے دکھائیں کہ \عددی{(e^{x_1})^{x_2}=e^{x_1x_2}=(e^{x_2})^{x_1}} ہو گا۔
\end{enumerate}
\انتہا{سوال}
%==================
\ابتدا{سوال}\ترچھا{$e$ کا اعشاری اظہار}\\
مساوات\عددی{\ln x=1} کو حل کرتے ہوئے \عددی{e} کی قیمت اتنے اعشاریہ مقامات  تک تلاش کریں جتنے تک آپ کا کیلکولیٹر استعمال کرتے ہوئے ممکن ہو۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\num{2.71828183}$  
...
\انتہا{جواب}
%=====================
\ابتدا{سوال}\ترچھا{$\ln x$ اور $e^x$ کے مابین معکوس تعلق}\\
...
دکھائیں کہ کسی بھی عدد \عددی{a>1} کے لیے درج ذیل ہو گا (شکل \حوالہ{شکل_سوال_ماورائی_قوت_نما_تعلق_الف})۔
\begin{align*}
...
\begin{enumerate}[a.]
\item
دکھائیں کہ \عددی{x} کے ہر وقفہ پر \عددی{e^x} کی ترسیم اوپر  کو  مقعر  ہے۔
\item
...
\end{align*}
یہ عدم مساوات کہتی ہے کہ دو مثبت اعداد کی  ہندسی اوسط ان کی لوگارتھمی اوسط سے کم ہو گی جو از خود ان کی حسابی اوسط سے کم ہو گی۔
\end{enumerate}
\انتہا{سوال}

\انتہا{سوالات}
%=========================
%sec 7.3 questions end here
%sec 7/3 questions end here


\حصہ{$a^x$ \, اور \, $\log_a x$}
اب تک,  ماسوائے \عددی{e} کے , ہم نے مثبت اعداد کو غیر ناطق طاقت دینا نہیں سیکھا۔ قوت نمائی تفاعل کی تعریف \عددی{e^x=\ln^{-1}x}، متغیر  \عددی{x} کی تمام حقیقی قیمتوں، ناطق اور غیر ناطق،  کے لیے درست ہے۔ اس حصہ میں ہم اس تعریف کو استعمال کر کے کسی بھی مثبت عدد کو کسی بھی ناطق یا غیر ناطق کی طاقت دینا سیکھ کر مثبت عدد \عددی{a} کے لیے قوت نمائی تفاعل \عددی{y=a^x} کی تعریف پیش کریں گے۔ اس کے ساتھ ساتھ ہم تفرق کے طاقتی قاعدہ کو حتمی شکل دیں گے (جو تمام قوت نما کے لیے درست ہو گا) اور ایک تفاعل کو دوسرے تفاعل کی طاقت دیں گے مثلاً \عددی{x^x} اور \عددی{(\sin x)^{\tan x}}، وغیرہ۔

جیسا  کہ  \عددی{e^x} بہت سارے قوت نما تفاعل میں سے ایک ہے، اسی طرح \عددی{\ln x} بھی بہت سارے لوگارتھمی تفاعل،جو تفاعل \عددی{a^x} کے معکوس ہیں،  میں سے ایک ہے۔

\جزوحصہء{تفاعل $a^x$}
چونکہ کسی بھی مثبت عدد \عددی{a} کے لیے \عددی{a=e^{\ln a}} ہوتا ہے ، لہٰذا  ہم \عددی{a^x} کو \عددی{(e^{\,\ln a})^x=e^{\,x\ln a}} تصور کر سکتے ہیں۔ یوں ہم درج ذیل تعریف پیش کرتے ہیں۔

\ابتدا{تعریف}
کسی بھی عدد \عددی{a>0} اور  عدد \عددی{x} کے لئے درج ذیل ہو گا۔
\begin{align}\label{مساوات_ماورائی_تعریف_طاقتی_الف}
a^x&=e^{\,x\ln a}
\end{align}
\انتہا{تعریف}
...
\جزوحصہء{قاعدہ طاقت (حتمی روپ)}
ہم اب کسی بھی  \عددی{x>0} اور  حقیقی عدد \عددی{n} کے لئے \عددی{x^n} کی تعریف \عددی{x^n=e^{n\ln x}}  لے سکتے ہیں۔ یوں مساوات \عددی{\ln x^n=n\ln x} میں \عددی{n} کا  ناطق ہونا ضروری نہیں؛ جب تک \عددی{x>0} ہو یہ کوئی بھی عدد ہو سکتا  ہے ۔ہم درج ذیل لکھ سکتے ہیں۔
\begin{align*}
\ln x^n=\ln (e^{n\ln x})&=n\ln x \cdot \ln e&& \ln e^u=u \text{\RL{چونکہ}}\\
&=n\ln x
\end{align*}
قاعدہ \عددی{a^x\!/\!a^y=a^{x-y}} اور تعریف \عددی{x^n=e^{n\ln x}} مل کر ہمیں قاعدہ طاقت کے تفرق  کا حتمی روپ  طے کرنے کے قابل بناتے ہیں۔ہم \عددی{x^n} کا \عددی{x} کے لحاظ سے تفرق لیتے ہیں۔
\begin{align*}
\frac{\dif}{\dif x}x^n&=\frac{\dif}{\dif x}e^{n\ln x}&& \text{\RL{$x^n,\, x>0$ کی تعریف}}\\
&=e^{n\ln x}\cdot \frac{\dif}{\dif x}(x\ln x)&&\text{\RL{$e^u$ کے لئے زنجیری قاعدہ}}\\
&=x^n\cdot \frac{n}{x}&&\text{\RL{دوبارہ تعریف}}\\
&=nx^{n-1}&&\text{\RL{جدول \حوالہ{جدول_ماورائی_قوت_نما_عمومی_قواعد} قاعدہ-ج}}
\end{align*}
مختصراً، جب تک \عددی{x>0} ہو درج ذیل ہو گا۔
\begin{align*}
\frac{\dif}{\dif x}x^n=nx^{n-1}
\end{align*}
زنجیری قاعدہ اس مساوات کو وسعت دے کر طاقتی قاعدے کا حتمی روپ دیتا ہے۔

\موٹا{طاقتی قاعدہ (حتمی روپ)}\\
اگر  \عددی{n}    حقیقی عدد ہو اور \عددی{u}  متغیر \عددی{x} کا مثبت قابل تفرق تفاعل ہو ، تب \عددی{u^n} متغیر \عددی{x} کا قابل تفرق تفاعل ہو گا اور اس کا تفرق درج ذیل ہو گا۔
\begin{align*}
...
\ابتدا{مثال}
\begin{align*}
\frac{\dif}{\dif x}x^{\sqrt{2}}&=\sqrt{2}\,x^{\sqrt{2}-1}\quad (x>0)&& \text{\RL{ا)}}\\
\frac{\dif}{\dif x} (\sin x)^{\pi}&=\pi (\sin x)^{\pi-1} \cos x \quad (\sin x>0)&&\text{\RL{ب)}}
\end{align*}
\انتہا{مثال}

\جزوحصہء{$a^x$  کا تفرق}
ہم تعریف \عددی{a^x=e^{x\ln a}} سے آغاز کر کے تفرق لیتے ہیں۔
\begin{align*}
\frac{\dif}{\dif x}a^x&=\frac{\dif}{\dif x}e^{x\ln a}=e^{x\ln a}\cdot \frac{\dif}{\dif x}(x\ln a)&&\text{\RL{زنجیری قاعدہ}}\\
&=a^x\ln a
\end{align*}
اگر \عددی{a>0} ہو تب درج ذیل ہو گا۔
\begin{align*}
\frac{\dif}{\dif x}a^x=a^x\ln a
\end{align*}
زنجیری قاعدہ   سے  درج ذیل  زیادہ عمومی روپ  حاصل ہو گا۔

اگر \عددی{a>0} ہو اور \عددی{u} متغیر \عددی{x} کا قابل تفرق تفاعل ہو، تب \عددی{a^u} متغیر \عددی{x} کا قابل تفرق تفاعل ہو گا اور اس کا تفرق درج ذیل ہو گا۔
\begin{align}\label{مساوات_ماورائی_عمومی_روپ_ب}
\frac{\dif}{\dif x}a^u=a^u \ln a\frac{\dif u}{\dif x}
\end{align}

مساوات \حوالہ{مساوات_ماورائی_عمومی_روپ_ب}  دکھاتی ہے کیوں \عددی{e^x} احصاء میں پسندیدہ  قوت نمائی تفاعل ہے۔ اگر \عددی{a=e} ہو  تب \عددی{\ln a=1} ہو گا اور مساوات \حوالہ{مساوات_ماورائی_عمومی_روپ_ب}درج ذیل سادہ صورت اختیار کرتی ہے۔
\begin{align*}
\frac{\dif}{\dif x}e^x=e^x\ln e=e^x
\end{align*}

\ابتدا{مثال}
\begin{align*}
\frac{\dif}{\dif x}3^x&=3^x \ln 3&& \text{\RL{ا)}}\\
\frac{\dif}{\dif x}3^{-x}&=3^{-x}\ln 3 \frac{\dif}{\dif x}(-x)=-3^{-x}\ln 3 &&\text{\RL{ب)}}\\
\frac{\dif}{\dif x}3^{3\sin x}&=3^{\sin x}\ln 3 \frac{\dif}{\dif x}(\sin x)=3^{\sin x} (\ln 3)\cos x&&\text{\RL{ج)}}
\end{align*}
\انتہا{مثال}

ہم مساوات \حوالہ{مساوات_ماورائی_عمومی_روپ_ب} سے دیکھتے ہیں کہ \عددی{\ln a>0} یعنی  \عددی{a>1}  کی صورت میں \عددی{a^x} کا تفرق مثبت ہو گا جبکہ \عددی{\ln a<0} یعنی \عددی{0<a<1}  کی صورت میں \عددی{a^x} کا تفرق منفی  ہو گا۔ دونوں میں \عددی{a^x} یک بہ یک ہے۔  دہرا تفرق
\begin{align*}
\frac{\dif^2}{\dif x^2}(a^x)=\frac{\dif}{\dif x}(a^x\ln a)=(\ln a)^2 a^x
\end{align*}
تمام \عددی{x} کے لئے مثبت ہے، لہٰذا حقیقی اعداد کی لکیر پر \عددی{a^x} کی ترسیم اوپر کی طرف مقعر ہو گی (شکل \حوالہ{شکل_ماورائی_اوپر_مقعر_قوت_نما})۔

\begin{figure}
\centering
\begin{tikzpicture}[font=\small,declare function={f(\x)=sin(deg(\x));}]
\pgfmathsetmacro{\k}{pi/2}
\begin{axis}[,clip=false,small,axis lines=middle,xlabel={$x$},ylabel={$y$},xlabel style={at={(current axis.right of origin)},anchor=west},ylabel style={at={(current axis.above origin)},anchor=south},xtick={-1,1},xticklabels={$-1$,$1$},ytick={1},yticklabels={$1$},enlarge y limits=0.2,enlargelimits=true]
\addplot[domain=-2:0.51,smooth]{10^(x)}node[above,xshift=0.5em]{$y=10^x$};
\addplot[domain=-2:1,smooth]{3^(x)}node[above right]{$y=3^x$};
\addplot[domain=-2:1.5,smooth]{2^(x)}node[right]{$y=2^x$};
\addplot[domain=2:-0.5,smooth]{(1/10)^(x)}node[above,xshift=-1em,yshift=0.5em]{$y=(\frac{1}{10})^x$};
\addplot[domain=2:-1,smooth]{(1/3)^(x)}node[above left,yshift=-0.25em]{$y=(\frac{1}{3})^x$};
\addplot[domain=2:-1.5,smooth]{(1/2)^(x)}node[left,yshift=-0.5em]{$y=(\frac{1}{2})^x$};
\addplot[domain=-2:2,smooth]{1^(x)}node[above]{$y=1^x$};
\end{axis}
\end{tikzpicture}
\caption{قوت نمائی تفاعل کی ترسیم  اوپر کو مقعر ہو گی۔}
\label{شکل_ماورائی_اوپر_مقعر_قوت_نما}
\end{figure}

\جزوحصہء{دیگر طاقتی تفاعل}
 مثبت اعداد کو من مانی  حقیقی  طاقت  تک اٹھا نے کی صلاحیت ہمیں  \عددی{x>0} کے لئے \عددی{x^x} اور \عددی{x^{\ln x}} جیسے تفاعلات   کی تعریف پیش کرنے کے قابل بناتی  ہے۔ایسے تفاعلات کا تفرق حاصل کرنے کے لئے ہم  تفاعل   کو \عددی{e}  کی طاقت لکھتے   ہیں۔

\ابتدا{مثال}
اگر \عددی{y=x^x,\, x>0} ہو، \عددی{\dif y\!/\!\dif x} تلاش کریں۔

\حل
تفاعل \عددی{x^x} کو \عددی{e} کی طاقت لکھیں۔
\begin{align*}
y&=x^x=e^{x\ln x} && \text{\RL{مساوات \حوالہ{مساوات_ماورائی_تعریف_طاقتی_الف} میں $a=x$ ہے}}
\end{align*}
اب  سادہ تفرق لیں۔
\begin{align*}
\frac{\dif y}{\dif c}&=\frac{\dif}{\dif x}e^{x\ln x}\\
&=e^{x\ln x}\frac{\dif}{\dif x}(x\ln x)\\
&=x^x\big(x\cdot\frac{1}{x}+\ln x\big)\\
&=x^x(1+\ln x)
\end{align*}
\انتہا{مثال}

\جزوحصہء{$a^u$ کا تکمل}
اگر \عددی{a\ne 1} ہو، \عددی{\ln a \ne 0} ہو گا، اور ہم  مساوات \حوالہ{مساوات_ماورائی_عمومی_روپ_ب} کے دونوں اطراف \عددی{\ln a} سے تقسیم کر سکتے ہیں۔ ایسا کر کے درج ذیل حاصل ہو گا۔
\begin{align*}
a^u\frac{\dif u}{\dif x}=\frac{1}{\ln a}\frac{\dif}{\dif x}(a^u)
\end{align*}
متغیر \عددی{x} کے لحاظ سے تکمل کرتے ہیں۔
\begin{align*}
\int a^u \frac{\dif u}{\dif x}\dif x=\int \frac{1}{\ln a} \frac{\dif}{\dif x}(a^u)\dif x=\frac{1}{\ln a}\int \frac{\dif}{\dif x}(a^u)\dif x=\frac{1}{\ln a}a^u+C
\end{align*}
بائیں ہاتھ پہلے  تکمل کو تفرقی روپ میں  لکھ کر درج ذیل حاصل ہو گا۔
\begin{align}\label{مساوات_ماورائی_تکمل_ج}
\int a^u\dif u=\frac{a^u}{\ln a}+C
\end{align}

\ابتدا{مثال}
\begin{align*}
\int 2^x\dif x&=\frac{2^x}{\ln 2}+C&&\text{\RL{مساوات \حوالہ{مساوات_ماورائی_تکمل_ج} میں $a=2,\, u=x$ ہیں}}\\
\int 2^{\sin x}\cos x\dif x&=\int 2^u \dif u =\frac{2^u}{\ln u}+C\\
&=\frac{2^{\sin x}}{\ln 2}+C&&\text{\RL{مساوات \حوالہ{مساوات_ماورائی_تکمل_ج} میں $u=\sin x$ ہے}}
\end{align*}
\انتہا{مثال}
%==========================================================================

\جزوحصہء{اساس $a$ کا لوگارتھم}
جیسا ہم دیکھ چکے ہیں، اگر \عددی{a}  ماسوائے \عددی{1} کوئی مثبت عدد ہو، تب تفاعل \عددی{a^x} یک بہ یک ہو گا، اور ہر نقطے پر اس کا تفرق غیر صفر ہو گا۔ یوں اس کا قابل تفرق معکوس بھی ہو گا۔ ہم \عددی{x} کے اساس \عددی{a}   لوگارتھم کو \عددی{\log_a x}  سے ظاہر کرتے ہیں۔

\ابتدا{تعریف}
کسی بھی مثبت عدد \عددی{a\ne 1} کے لئے درج ذیل ہو گا۔
\begin{align*}
\log_a x=a^x \text{\RL{معکوس}}
\end{align*}
\انتہا{تعریف}

تفاعل \عددی{y=a^x} کی ترسیم کا  لکیر \عددی{y=x}    کی دوسری طرف عکس سے  \عددی{y=\log_a x} کی ترسیم حاصل کی جا سکتی ہے (شکل \حوالہ{شکل_ماورائی_منعکس_تفاعلات})۔

\begin{figure}
\centering
\begin{tikzpicture}[font=\small,declare function={f(\x)=sin(deg(\x));}]
\pgfmathsetmacro{\k}{pi/2}
\begin{axis}[,clip=false,small,axis lines=middle,xlabel={$x$},ylabel={$y$},xlabel style={at={(current axis.right of origin)},anchor=west},ylabel style={at={(current axis.above origin)},anchor=south},xtick={1,2},xticklabels={$1$,$2$},ytick={1,2},yticklabels={$1$,$2$},enlarge y limits=0.2,enlargelimits=true]
\addplot[domain=-3:2.585,smooth]{2^(x)}node[above]{$y=2^x$};
\addplot[thin,domain=-2:6,smooth]{x}node[above]{$y=x$};
\addplot[domain=0.125:6,smooth]{log2(x)}node[above right]{$y=\log_2 x$};
\end{axis}
\end{tikzpicture}
\caption{تفاعل $2^x$ اور اس کے معکوس $\log_2 x$ کی ترسیمات۔}
\label{شکل_ماورائی_منعکس_تفاعلات}
\end{figure}

چونکہ \عددی{\log_a x} اور \عددی{a^x} ایک دوسرے کے معکوس ہیں لہٰذا درج ذیل مماثل  تفاعل ہوں گے۔

\موٹا{$a^x$ اور $\log_a x$ کی معکوس مساواتیں}
\begin{align}
a^{\log_a x}&=x\quad (x>0)\label{مساوات_ماورائی_مماثل_چار}\\
\log_a (a^x)&=x\quad (x \text{\RL{تمام}})\label{مساوات_ماورائی_مماثل_پانچ}
\end{align}

\ابتدا{مثال}
\begin{align*}
\log_2(2^5)&=5&&\text{\RL{ا)}}\\
2^{\log_2 (3)}&=3&&\text{\RL{ب)}}\\
\log_{10}(10^{-7})&=-7&&\text{\RL{ج)}}\\
10^{\log_{10} (4)}&=4&&\text{\RL{د)}}
\end{align*}
\انتہا{مثال}
%===================================

\جزوحصہء{$\log_a x$ کی قیمت کا حصول}
تفاعل \عددی{\log_a x} کی قیمت تلاش کرتے وقت یاد رکھیں یہ تفاعل   \عددی{\ln x} کا   مضرب ہے۔
\begin{align}\label{مساوات_ماورائی_مماثل_چھ}
\log_a x=\frac{1}{\ln a}\cdot \ln x=\frac{\ln x}{\ln a}
\end{align}
ہم مساوات \حوالہ{مساوات_ماورائی_مماثل_چھ} کو مساوات \حوالہ{مساوات_ماورائی_مماثل_چار} سے اخذ کر سکتے ہیں۔
\begin{align*}
a^{\log_a (x)}&=x&&\text{\RL{مساوات \حوالہ{مساوات_ماورائی_مماثل_چار}}}\\
\ln a^{\log_a (x)}&=\ln x&& \text{\RL{دونوں اطراف قدرتی لوگارتھم لیں}}\\
\log_a (x)\cdot \ln a&=\ln x&&\text{\RL{جدول \حوالہ{جدول_ماورائی_خواص_قدرتی_لوگارتھم} میں قاعدہ طاقت}}\\
\log_a x&=\frac{\ln x}{\ln a}&&\text{\RL{$\log_a x$ کے لئے حل کریں}}
\end{align*}
...
\begin{table}
\centering
\caption{اساس $a$ لوگارتھم کے خواص}
\label{جدول_ماورائی_لوگارتھم_اے_خواص}
\renewcommand{\arraystretch}{2}
\begin{tabular}{rrl}
\toprule
& کسی بھی اعداد $x>0$ اور $y>0$ کے لئے&\\
\midrule
ا)&  قاعدہ ضرب& \عددی{\log_a xy=\log_a x+\log_a y}\\
ب)& قاعدہ حاصل تقسیم& \عددی{\log_a\tfrac{x}{y}=\log_a x-\log_a y}\\
ج)& قاعدہ مقلوب&\عددی{\log_a \tfrac{1}{y}=-\log_a y}\\
د)&قاعدہ طاقت&\عددی{\log_a x^y=y\log_a x}\\
\bottomrule
\end{tabular}
\end{table}

تفاعل \عددی{\log_a x} کے ریاضیاتی   خواص  (جدول \حوالہ{جدول_ماورائی_لوگارتھم_اے_خواص})   وہی  ہیں جو \عددی{\ln x}  کے ہیں۔ قدرتی لوگارتھم کے مطابقتی خواص کو \عددی{\ln a} سے تقسیم کر کے انہیں اخذ کیا جا سکتا ہے۔مثال کے طور پر درج ذیل ہو گا۔
\begin{align*}
\ln xy&=\ln x+\ln y&&\text{\RL{قدرتی لوگارتھم کا قاعدہ طاقت}}\\
\frac{\ln xy}{\ln a}&=\frac{\ln x}{\ln a}+\frac{\ln y}{\ln a}&&\text{\RL{$\ln a$ سے تقسیم}}\\
\log_a xy&=\log_a x+\log_a y &&\text{\RL{اساس $\, a \,$ کے لوگارتھم کا قاعدہ طاقت}}
\end{align*}
%===========================


\جزوحصہء{$\log_a u\,$ کا تفرق}
اساس \عددی{a} کے لوگارتھم کا تفرق حاصل کرنے کی خاطر ہم اس کو پہلے  قدرتی لوگارتھم  کی صورت میں لکھتے ہیں۔ اگر \عددی{u} متغیر \عددی{x} کا مثبت قابل تفرق تفاعل ہو تب
\begin{align*}
...
\انتہا{مثال}
%===============
\جزوحصہء{ \عددی{\log_a x} پر مشتمل تکملات}
جہاں  اساس \عددی{a} کے  لوگارتھم  کا تکمل پایا جاتا ہو ہم اس کو پہلے قدرتی لوگارتھم کی صورت میں بدلتے ہیں۔
...
\انتہا{مثال}
%===================
\جزوحصہء{اساس $\,10\,$ کا  لوگارتھم}
اساس \عددی{10}  کے لوگارتھم کو ہم عموماً \عددی{\log_{10}} کے بجائے \عددی{\log} لکھتے ہیں۔اساس \عددی{10} کا  لوگارتھم،  جس کو \اصطلاح{عام لوگارتھم}\فرہنگ{لوگارتھم!عام}\حاشیہب{common logarithm}\فرہنگ{logarithm!common} کہتے ہیں،  کئی سائنسی کلیات میں پایا جاتا ہے۔ مثال کے طور پر،  زلزلہ کی شدت کو عموماً اساس \عددی{10} کے  لوگارتھمی\حاشیہد{رکٹر پیمائش میں اکائی کا اضافہ حیطہ میں تقریباً \عددیء{10} گنا  اور توانائی میں تقریباً \عددی{31.623} گنا کا اضافہ ظاہر کرتا ہے۔} \اصطلاح{رکٹر پیمائش}\فرہنگ{رکٹر پیمائش}\فرہنگ{پیما!رکٹر}\حاشیہب{Richter scale}\فرہنگ{Richter scale} میں پیش کیا  جاتا ہے۔ رکٹر پیما کا کلیہ 
\begin{align*}
\text{شدت}\, R=\log_{10}\big(\frac{a}{T}\big)+B
\end{align*}
ہے ، جہاں زلزلہ پیما کے مقام پر زمینی لرزش کا حیطہ \عددی{a} ہے،  جس کو مائیکرو میٹر میں ناپا جاتا ہے، زلزلہ کی موج کا دوری عرصہ \عددی{T} ہے،  جس کو سیکنڈ میں ناپا جاتا ہے،  جبکہ \عددی{B} ایک تجربی جزو ہے،  جو مرکز زلزلہ سے زلزلہ پیما تک پہنچنے میں شدت کی کمی کو ظاہر کرتا ہے۔ 

جاپان کے شہر ناگاساکی پر گرائے  گئے ایٹمی بم نے \عددی{\SI{1.34e14}{\joule}}  توانائی خارج کی،  جو رکٹر پیما پر \عددی{5} کے برابر ہے۔  آج تک سب سے بڑا ایٹمی دھماکہ \عددی{7.1} شدت کا تھا،  جس میں \عددی{\SI{2.09e17}{\joule}} توانائی خارج کی گئی۔  اکتوبر \اردوعدد{8}  \سن{2005} کو آزاد کشمیر میں \عددی{7.6} شدت کا زلزلہ آیا ، جس میں \عددی{\SI{1.585e16}{\joule}} توانائی خارج ہوئی۔

\ابتدا{مثال}
مرکز زلزلہ سے زلزلہ پیما تک فاصلہ \عددی{\SI{10000}{\kilo\meter}} ہے،  جس کے لیے \عددی{B=6.8} ہو گا۔ مقام زلزلہ پیما پر زمین کی انتصابی حرکت \عددی{\SI{10}{\micro\meter}} اور دوری عرصہ \عددی{\SI{1}{\second}} ہیں۔ زلزلہ کی شدت تلاش کریں۔
...
\انتہا{مثال}
%====================
محلول کی\اصطلاح{تیزابیت}\فرہنگ{تیزابیت} \حاشیہب{acidity}\فرہنگ{acidity} کو \عددی{\pH} (\اصطلاح{مخفی قوہ  ہائیڈروجن})\فرہنگ{pH}\فرہنگ{مخفی قوہ!ہائیڈروجن} میں ناپا جاتا ہے، جو اساس \عددی{10} کا لوگارتھمی پیمانہ ہے۔ محلول میں ہائیڈرونیم بارداریہ \عددی{[\ce{H3O^+}]} کے گھناپن کے معکوس  کا عام لوگارتھم  اس محلول کی \عددی{\pH} قیمت ہو گی۔
\begin{align*}
\pH=\log_{10}\frac{1}{[\ce{H3O^+}]}=-\log_{10}[\ce{H3O^+}]
\end{align*}
ہائیڈرونیم بارداریہ کے گھناپن کو مول فی لٹر (\si{\mole\per\liter}) میں ناپا جاتا ہے۔تیزاب کی \عددی{\pH} قیمت \عددی{7} سے کم جبکہ القلی کی  \عددی{7} سے زیادہ ہوتی ہے۔ سرکہ کی \عددی{\pH} قیمت \عددی{3} جبکہ مقطر پانی کی \عددی{\pH} قیمت \عددی{7} ہوتی ہے۔  \عددی{\pH}  کا  پیمانہ \عددی{0} سے \عددی{14} تک ہے۔ جدول \حوالہ{جدول_ماورائی_خوراک_ہائیڈروجن_مخفی_قوہ} میں کئی   غذاؤں کی  \عددی{\pH}   قیمت  دی گئی ہے۔
\begin{table}
\caption
{زیادہ تر غذائیں   تیزابی ($\, \pH<7 \,$) ہوتی ہیں۔}
\label{جدول_ماورائی_خوراک_ہائیڈروجن_مخفی_قوہ}
\centering
\begin{tabular}{rr}
\toprule
غذا& \multicolumn{1}{c}{$\pH$}\\
\midrule
کیلا& \عددی{4.5-4.7}\\
چکوترہ& \عددی{3.0-3.3}\\
سنترا & \عددی{3.0-4.0}\\
...
لوگارتھم کے استعمال کی دوسری مثال ڈیسی بیل \عددی{\si{\deci\bel}} پیمانہ ہے ، جو صدا کی بلندی کو ناپنے کے لیے استعمال کیا جاتا ہے۔ اگر صدا کی شدت \عددی{I}  واٹ فی مربع میٹر ہو تب
\begin{align}\label{مساوات_ماورائی_سطح_صدا}
\text{\RL{سطح صدا}}=10\log_{10}(I\times 10^{12})\,\si{\deci\bel}
\end{align}
ہو گی۔ جیسا اگلی مثال دکھاتی ہے، شدت  صدا کو دگنا کرنے سے سطح صدا میں تقریباً \عددی{\SI{3}{\deci\bel}} کا اضافہ ہوتا ہے۔

\ابتدا{مثال}
صدا کی شدت کو دگنا کرنے سے سطح صدا میں کتنا اضافہ ہو گا؟

\حل
مساوات \حوالہ{مساوات_ماورائی_سطح_صدا} کے تحت \عددی{2I} شدت صدا کے لیے 
\begin{align*}
...
خاموش گاڑی& \عددی{\SI{50}{\deci\bel}}\\
...
%sec 7.4 questions start here
%sec 7.4 questions start here
\حصہء{سوالات}
\ابتدا{سوالات}
\موٹا{الجبرائی حساب}

سوال \حوالہ{سوال_ماورائی_سادہ_صورت_فقرہ_الف} تا سوال \حوالہ{سوال_ماورائی_سادہ_صورت_فقرہ_ب} میں  دی گئی ریاضیاتی عبارت کی سادہ صورت تلاش کریں۔
...
انسانی خون کی  \عددی{\pH}  قیمت \عددی{7.37} سے \عددی{7.44} تک ہوتی ہے۔ انسانی خون میں بارداریہ \عددی{[\ce{H3O^+}]} کی مطابقتی حدود تلاش کریں۔ 
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$[10^{-7.44},10^{-7.37}]$
...
دماغی سیال میں \عددی{[\ce{H3O^+}]} کا گھناپن تقریباً \عددی{\SI{4.8e-8}{\mole\per\liter}} ہے۔ اس سیال کا\عددی{\pH} تلاش کریں۔
\انتہا{سوال}
%====================
%Q79
\ابتدا{سوال}
صدا کو افزائش کار (ایمپلی فائر)  \عددی{k} سے ضرب دے کر  سطح صدا  \عددی{\SI{10}{\deci\bel}}   بلند   کرتا ہے۔ جزو  ضربی \عددی{k} کی قیمت تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$k=10$
...
%Q81
\ابتدا{سوال}
کسی بھی محلول میں \عددی{[\ce{H3O^+}]}  اور \عددی{[OH^-]} کے گھناپن کا حاصل ضرب \عددی{10^{-14}} ہوتا ہے۔
\begin{enumerate}[a.]
\item
\عددی{[\ce{H3O^+}]} کی کیا قیمت گھناپن کے مجموعہ \عددی{S=[\ce{H3O^+}]+[\ce{OH^-}]} کو اقل  کرتی ہے؟
\item
اس محلول کا  \عددی{\pH} تلاش کریں  جس میں \عددی{S} کی قیمت اقل ہو۔
\item
\عددی{[\ce{H3O^+}]} اور \عددی{[OH^-]} کی کون سی نسبت \عددی{S} کو اقل بناتی ہے؟
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%Q84
\ابتدا{سوال}
کیا \عددی{x>0} کے لیے  \عددی{x^{\ln 2}} اور \عددی{2^{\ln x}}  برابر ہو سکتے ہیں؟دونوں تفاعل ترسیم کرتے ہوئے بتائیں کیا ہوتا ہے۔
\انتہا{سوال}
%====================
%Q85
\ابتدا{سوال}\ترچھا{$2^x$ کی خط بندی}\\
(ا) نقطہ \عددی{x=0} پر \عددی{f(x)=2^x} کی خط بندی دریافت کریں۔ اس کے بعد عددی سروں کو \عددی{2} اعشاریہ مقامات تک   پورم پور کریں۔ (ب) وقفہ \عددی{-3\le x\le 3} اور وقفہ \عددی{-1\le x\le 1} کے لیے تفاعل اور خط بندی کو ایک ساتھ ترسیم کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
(ا) نقطہ \عددی{x=3} پر \عددی{f(x)=\log_3 x} کی خط بندی تلاش کریں۔ اس کے بعد عددی سروں کو \عددی{2} اعشاریہ  مقامات تک پورم پور کریں۔   (ب) وقفہ \عددی{0\le x\le 8} اور \عددی{2\le x \le 4} کے لیے تفاعل اور خط بندی کو ایک ساتھ ترسیم کریں۔
\انتہا{سوال}
%====================
...
\end{align*}
کیلکولیٹر استعمال کرتے ہوئے  \عددی{5} اعشاریہ مقامات کی درستگی تک 
...
\انتہا{سوالات}
%=======================
%sec 7.4 questions end here
%sec 7.4 questions end here


\حصہ{افزائش اور تنزل}\شناخت{حصہ_ماورائی_افزائش_تنزل}
اس حصے میں ہم قوت نما تبدیلی کا قاعدہ   حاصل کریں گے۔ اس کے علاوہ ان عملی استعمال پر غور کیا جائے گا جن کی وجہ سے لوگارتھمی اور قوت نمائی تفاعل کی  اہمیت  ہے۔

\جزوحصہء{قوت نما تبدیلی کا قاعدہ}
فرض کریں ہم کسی مقدار \عددی{y} (جو سمتی رفتار، درجہ حرارت، برقی رو، یا کچھ اور ہو سکتا ہے) میں دلچسپی رکھتے ہیں ، جس میں کسی بھی لمحہ \عددی{t} پر اضافہ یا کمی اس لمحہ موجود مقدار کے راست متناسب  ہے۔ اگر ہمیں لمحہ \عددی{t=0} پر مقدار کی قیمت \عددی{y_0} بھی معلوم ہو تب ہم درج ذیل ابتدائی قیمت مسئلہ حل کر کے  متغیر \عددی{t} کا تفاعل \عددی{y}  حاصل کر سکتے ہیں۔
\begin{gather}
...
\end{aligned}
\end{gather}
اگر \عددی{y} مثبت ہو اور بڑھ رہا ہو تب \عددی{k} مثبت ہو گا اور مساوات \حوالہ{مساوات_ماورائی_قوت_نمائی_مساوات_الف} کہتی ہے کہ اضافے  کی شرح اب تک  جمع  شدہ  مقدار کے راست متناسب ہے۔ اگر \عددی{y} منفی ہو اور گھٹ رہا ہو تب \عددی{k} منفی ہو گا اور مساوات \حوالہ{مساوات_ماورائی_قوت_نمائی_مساوات_الف} کہتی ہے کہ تنزل کی شرح اب تک   رہ گئی مقدار کے راست متناسب ہے۔

ہم دیکھ سکتے ہیں کہ مساوات \حوالہ{مساوات_ماورائی_قوت_نمائی_مساوات_الف} کا ایک حل \عددی{y=0}  ہے۔ غیر صفر حل حاصل کرنے کے لیے ہم مساوات \حوالہ{مساوات_ماورائی_قوت_نمائی_مساوات_الف} کے دونوں اطراف کو \عددی{y} سے تقسیم کر کے حل کرتے ہیں۔
\begin{align*}
...
\end{align*}
ہم \عددی{\mp e^C} کی تمام ممکنہ قیمتوں کے علاوہ  \عددی{0} کو بھی \عددی{A} کی   ممکنہ قیمت تصور کر کے، حل \عددی{y=0} کو بھی اس کلیہ میں شامل کر سکتے  ہیں۔

ہم ابتدائی قیمت مسئلہ کے لیے \عددی{A} کی قیمت حاصل کرنے کی خاطر \عددی{t=0} پر \عددی{y=y_0}  پُر کرتے ہیں۔ 
\begin{align*}
y_0=Ae^{k\cdot 0}=A
\end{align*}
یوں اس ابتدائی قیمت مسئلے کا حل \عددی{y=y_0e^{kt}} ہو گا۔

درج ذیل \اصطلاح{قوت نما تبدیلی کا قاعدہ} ہے ، جس میں \عددی{k} کو \اصطلاح{شرح کا مستقل}\فرہنگ{مستقل!شرح کا}\حاشیہب{rate constant}\فرہنگ{constant!rate} کہتے ہیں۔
...
\end{align}
مساوات \حوالہ{مساوات_ماورائی_قوت_نما_تبدیلی_قاعدہ} کا حصول ہم پر واضح کرتا ہے  کہ صرف اور صرف  قوت نما تفاعل کا  ایک مستقل مضرب ہی   خود  کا تفرق ہو سکتا ہے۔ 

\جزوحصہء{نمو آبادی}
کوئی بھی آبادی (انسانی، نباتاتی، جراثیمی، وغیرہ) غیر استمراری تفاعل ہو گا چونکہ یہ صرف منفصل قیمتیں اختیار کرتی ہے۔ اس کے باوجود جب آبادی میں فردی تعداد بہت زیادہ ہو تب اس آبادی کو نہ صرف استمراری بلکہ قابل تفرق تفاعل  سے ظاہر کرنا ممکن ہوتا ہے۔ اگر ہم فرض کریں کہ آبادی میں بچے پیدا کرنے والوں کا تناسب برقرار رہتا ہے تب کسی بھی لمحہ \عددی{t} پر بچوں کی پیدائشی شرح اس لمحے پر افراد کی تعداد \عددی{y(t)} کے راست تناسب ہو گی۔ اگر ہم  باہر سے آنے اور جانے والوں کو رد کریں اور ساتھ ہی مرنے والوں کی تعداد کو بھی رد کریں تب نمو آبادی کی شرح \عددی{\tfrac{\dif y}{\dif t}} پیدائشی شرح \عددی{ky} کے برابر ہو گی۔یوں \عددی{\frac{\dif y}{\dif t}=ky} لہٰذا \عددی{y=y_0e^{kt}} ہو گا۔ حقیقت میں کسی بھی آبادی پر دیگر عوامل بھی اثر انداز ہوں گے جن پر یہاں غور نہیں کیا جائے گا۔

سادہ الفاظ میں ہم کہنا چاہ رہے ہیں کہ  اگر آبادی کے ایک ٹولا میں، جس میں   \عددی{m} افراد   ہوں ، سالانہ  (یا کسی بھی مخصوص دارانیے میں)  \عددی{c} بچے پیدا ہوتے ہوں تب  ہم توقع کرتے ہیں کہ  \عددی{m} افراد  پر مشتمل اس آبادی کے کسی دوسرے ٹولا میں بھی اسی دوران \عددی{c} بچے پیدا ہوں گے۔ دونوں ٹولوں  کو ملا کر ہم کہہ سکتے ہیں کہ اس دورانیے میں \عددی{2m} افراد کے مجموعی  ٹولے میں  \عددی{2c} بچے پیدا ہوں گے، یعنی شرح پیدائش دگنی ہو گی۔اسی طرح \عددی{3m} افراد کے ٹولا میں ہم توقع کرتے ہیں کہ اس دورانیے میں \عددی{3c} بچے پیدا ہوں گے، یعنی شرح پیدائش تین گنا ہو گی۔ہم دیکھ سکتے  ہیں کہ بچے پیدا ہونے کی شرح ٹولا  میں افراد کی تعداد  کے راست متناسب ہے۔ یوں  \عددی{\frac{\dif y}{\dif t}=ky} ہو گا، جہاں موجود افراد کی تعداد \عددی{y} ، بچوں کی  پیدائش کی شرح \عددی{\dif y\!/\!\dif t} ، اور تناسب کا مستقل \عددی{k} ہے۔

\ابتدا{مثال}\شناخت{مثال_ماورائی_پھیلاو_بیماری}
بیماری  پھیلنے  کا ایک نمونہ فرض کرتا ہے کہ بیمار ہونے والوں کی شرح \عددی{\tfrac{\dif y}{\dif t}} اس وقت  بیماروں   کی تعداد \عددی{y} کے راست متناسب ہے۔ یوں جتنے زیادہ افراد کو بیماری لاحق ہو، بیماری اتنی زیادہ تیزی سے پھیلے گی۔

اس عمل کو سمجھنے کی کوشش کرتے ہیں۔ہم فرض کرتے ہیں کہ ایک آبادی میں رہنے سہنے  کا انداز سب کا ایک جیسے ہے۔اس آبادی میں  اگر \عددی{n}   بیمار  افراد  کی ٹولی کسی مخصوص  دورانیے میں   \عددی{c}  افراد کو   بیماری منتقل کرتی ہو تب   \عددی{n}  بیماروں  کی دوسری  ٹولی  بھی \عددی{c}   افراد کو بیماری منتقل کرے گی، یعنی  مجموعی طور پر \عددی{2n} بیمار افراد  اسی دورانیے میں \عددی{2c} افراد کو بیماری منتقل کرتے ہیں، یعنی  بیماری منتقل کرنے کی شرح دگنی ہو گی۔ اسی طرح \عددی{3n} بیمار افراد  اسی دورانیے میں  \عددی{3c} کو   بیماری منتقل کریں گے، یعنی بیماری منتقل کرنے کی شرح تین گنا ہو گی۔ آپ دیکھ سکتے ہیں کہ  بیماری منتقل کرنے کی شرح موجودہ  بیمار افراد  کی تعداد کے راست متناسب ہے۔ یوں \عددی{\tfrac{\dif y}{\dif t}\propto y} ہو گا، جہاں بیماروں کی  موجودہ تعداد \عددی{y} اور   بیماری پھیلنے  کی شرح \عددی{\dif\!/\!\dif t} ہے۔
...
\عددی{k} کی قیمت،
\item
\عددی{y=1000} کرنے کے لیے درکار \عددی{t} کی قیمت۔
\end{enumerate}
...
ہم مساوات \حوالہ{مساوات_ماورائی_مثال_بیماری} میں \عددی{y=1000} پُر کر کے \عددی{t} حاصل کرتے ہیں۔
\begin{align*}
1000&=\num{10000}e^{(\ln 0.8)t}\\
e^{(\ln 0.8)t}&=0.1\\
(\ln 0.8)t&=\ln 0.1\\
...
\end{align*}
یوں بیماروں کی تعداد \عددی{1000} کرنے کے لیے ہمیں دس سال سے کچھ زیادہ انتظار کرنا ہو گا۔
\انتہا{مثال}
%======================
...
ربا پر کاروبار کرنے والا بنک ایک شخص کو \عددی{A_0} روپیہ سود پر دیتا ہے۔ایک سال بعد اس شخص پر \عددی{r\times A_0} کا سود واجب الادا ہو گا لہٰذا ایک سال بعد  اس شخص پر کُل قرضہ  \عددی{A_0+rA_0=A_0(1+r)}   ہو گا۔ ہم کہتے ہیں کہ سالانہ سود کی شرح \عددی{r} ہے۔ فرض کریں کہ یہ شخص سالانہ سود ادا نہیں کرتا۔ یوں دوسرے سال کی ابتدا میں اس شخص پر \عددی{A_0(1+r)} قرضہ ہو گا اور بنک اگلے سال اس مقدار پر سود حاصل کرے گا۔ چونکہ سود کی شرح \عددی{r} ہے لہٰذا دوسرے سال اس شخص پر سود \عددی{r\times A_0(1+r)} ہو گا اور دوسرے سال کے آخر میں اس پر کُل قرضہ
\begin{align*}
...
اب بنک کہہ سکتا ہے کہ سال میں ایک  مرتبہ کے بجائے وہ ماہوار \عددی{\tfrac{r}{12}} شرح سے سود وصول کرے  گا (جو ظاہری طور پر ربا کی وہی شرح معلوم ہوتی ہے)۔یوں پہلے مہینے کے آخر میں واجب الادا ربا کی مقدار \عددی{\tfrac{r}{12}A_0} اور 
قرضہ \عددی{A_t=A_0(1+\tfrac{r}{12})} ہو گا۔ اسی طرح دوسرے مہینے کے آخر میں قرضہ \عددی{A_t=A_0(1+\tfrac{r}{12})^2} ہو گا۔ایک سال بعد قرضہ \عددی{A_t=A_0(1+\tfrac{r}{12})^{12}} اور \عددی{t} سال بعد قرضہ \عددی{A_t=A_0(1+\tfrac{r}{12})^{12t}} ہو گا ، جس کو \عددی{A_t=A_0(1+\tfrac{r}{k})^{kt}} لکھا جا سکتا ہے ، جہاں \عددی{k=12} ہے۔

یہ بنک ماہوار کے بجائے ہفتہ وار سود بھی وصول کر سکتا ہے۔چونکہ سال میں \عددی{52} ہفتے ہوتے ہیں لہٰذا ایسی صورت میں \عددی{k=52} ہو گا اور \عددی{t} سال بعد قرضہ درج ذیل ہو گا۔
\begin{align*}
A_t=A_0\big(1+\frac{r}{k}\big)^{kt}
\end{align*}
سود پر چلنے والا بنک زیادہ سے زیادہ ربا حاصل کرنے کی خاطر، سال میں  زیادہ سے زیادہ مرتبہ ربا حاصل کرنا چاہے گا۔ آئیں دیکھیں کہ \عددی{k\to \infty} کرنے سے \عددی{t} سال بعد قرضہ کتنا ہو گا؟
\begin{align*}
\lim_{k\to \infty}A_t&=\lim_{k\to \infty} A_0\big(1+\frac{r}{k}\big)^{kt}
\end{align*}
اس مساوات میں  \عددی{x=r\!/\!k} لیتے ہوئے درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
\lim_{k\to \infty}A_t&=\lim_{x\to 0} A_0\big [(1+x)^{\tfrac{1}{x}}\big]^{rt}\\
&=A_0e^{rt}
\end{align*}
درج بالا حد کے حصول میں نا قابل معلوم روپ \عددی{1^{\infty}} حاصل ہوتا ہے۔ایسی حد کی تلاش حصہ \حوالہ{حصہ_ماورائی_قاعدہ_لھوپیٹال} میں سکھائی جائے گی جہاں مثال \حوالہ{مثال_ماورائی_قوت_نما_متبادل_تعریف} میں آپ دیکھیں گے کہ چوکور قوسین میں بند مقدار کی حد  \عددی{e} کے برابر ہے۔   یوں \عددی{t} سال بعد اس شخص پر قرضہ درج ذیل ہو گا۔
...
اس کلیہ کے تحت  ربا کو \اصطلاح{مسلسل سود در سود}\فرہنگ{سود در سود!مسلسل}\حاشیہب{compound continuous interest}\فرہنگ{interest!continuous compound} کہتے ہیں۔
 ...
 اس عمل پر دوبارہ نظر ثانی کرتے ہیں۔ اگر بنک  ایک شخص کو \عددی{m}    روپیہ  قرضہ سود پر دے کر سالانہ (یا کسی دوسرے مخصوص دورانیہ میں) \عددی{c} روپیہ سود لیتا ہو تب  بنک  دوسرے شخص کو بھی   \عددی{m}    روپیہ قرضہ  سود پر دے کر  اسی دورانیے میں اس شخص سے  \عددی{c} روپیہ سود  لے گا۔یوں    اگر بنک مجموعی طور پر      \عددی{2m}    روپیہ قرضہ  سود پر دے،  وہ    اسی دورانیے میں   \عددی{2c} روپیہ سود   کی مد میں وصول کرے گا، یعنی وصولی کی شرح دگنی ہو گی۔ اسی طرح \عددی{3m} روپیہ  قرض دے کر بنک اسی دورانیے میں \عددی{3c} روپیہ سود وصول کرے گا، یعنی شرح وصولی تین گنا ہو گی۔ ہم دیکھتے ہیں کہ شرح وصولی عین قرض کے راست متناسب ہے، یعنی \عددی{\dif y\!/\!\dif t\propto y} ہو گا، جہاں  \عددی{y} قرض ہے اور \عددی{\dif y\!/\!\dif t} شرح وصولی ہے۔اس مساوات کو  درج ذیل لکھ کر
\begin{align*}
\dif y\!/\!\dif t=ry
\end{align*}
جہاں  \عددی{r} ایک مستقل ہے، ہم تکمل لیتے ہیں۔ یوں درج ذیل حاصل ہو گا جو  (نئے متغیرات کی صورت میں) مساوات \حوالہ{مساوات_ماورائی_سود_در_سود} ہے۔
\begin{align*}
y=y_0e^{rt}
\end{align*}

\ابتدا{مثال}
آپ آج بنک سے مسلسل سود در سود کی سالانہ \عددی{\SI{15}{\percent}} شرح پر \عددی{\num{100000}} روپیہ حاصل کرتے ہیں۔ پانچ سال بعد آپ کو کتنی مقدار واپس کرنی ہو گی؟ اگر بنک سالانہ سود وصول کرتا ہو تب پانچ سال بعد قرضہ کتنا ہو گا؟
...
A(5)=\num{100000}e^{(0.15)(5)}=\num{211700}
\end{align*}
اگر بنک سال میں ایک مرتبہ  ربا وصول کرے تب پانچ سال بعد آپ کو درج ذیل قرضہ دینا ہو گا۔
\begin{align*}
A(5)=\num{100000}(1+0.15)^5=\num{201136}
\end{align*}
\انتہا{مثال}
%=========================
\ابتدا{مثال}
سالانہ \اصطلاح{افراط زر}\فرہنگ{ افراطزر  }\حاشیہب{inflation}\فرہنگ{inflation} سے مراد ایک سال میں روپیہ کی قدر میں کمی ہے۔ یوں \عددی{\SI{10}{\percent}} افراط زر کا مطلب ہے کہ ایک سال بعد روپیہ کی قیمت \عددی{\SI{90}{\percent}} ہو گی۔

 ایک شخص \عددی{\num{5000000}} روپیہ بنک میں پانچ سال کے لیے جمع کرتا ہے۔بنک ہر مہینہ اس شخص کو \عددی{\num{40000}} روپیہ دے گا اور پانچ سال کے آخر میں اس کو پورے \عددی{5000000} روپیہ واپس کرے گا۔ اگر سالانہ افراطزر     \عددی{\SI{12}{\percent}} ہو تب اس شخص نے کیا پایا اور کیا کھویا؟
...
\end{align*}
ہو گی۔ یاد رہے کہ ہر مہینہ روپیہ کی قدر کم ہو گی لہٰذا پہلے مہینہ کے \عددی{40000} اور آخری مہینہ کے \عددی{40000} روپیہ کی  قدر ایک جیسی  نہیں ہوں گی۔ہم حساب کو آسان بنانے کی خاطر تصور کرتے ہیں کہ اس شخص کو ماہوار کے بجائے ہر سال \عددی{\num{40000}\times 12=\num{480000}} روپیہ ملتے ہیں جن کی اصل قدر
\begin{align*}
...
%======================
\جزوحصہء{تابکاری}
ایک ایٹم اپنی کمیت کا کچھ حصہ خارج کر کے دوسرے ایٹم میں تبدیل ہوتا ہے۔ اس عمل کو \اصطلاح{تابکاری تحلیل}\فرہنگ{تابکاری تحلیل}\حاشیہب{radioactive decay}\فرہنگ{radioactive decay} کہتے ہیں اور جس ایٹم نے مادّہ خارج کیا ہو اس کو \اصطلاح{تابکار}\فرہنگ{تابکار}\حاشیہب{radioactive}\فرہنگ{radioactive} کہتے ہیں۔ تابکار کاربن \اردوعدد{14 } مادّہ خارج کر کے نائٹروجن میں تبدیل ہوتا ہے، ریڈیم تابکاری    کے  کئی مراحل سے گزر کر آخر کار سیسہ میں تبدیل ہوتا ہے۔  

تجربہ سے دیکھا گیا ہے کہ اکائی وقت میں خارج ہونے والے  ذرات کی تعداد،  اس وقت تابکار ایٹموں کی تعداد کے تقریباً  راست تناسب ہوتا ہے۔ یوں تابکار تحلیل کو مساوات  \عددی{\tfrac{\dif y}{\dif t}=-ky,\, k>0} سے  ظاہر  کیا جاتا  ہے (یہاں \عددی{k\, (<0)} کی جگہ \عددی{-k\,(k>0)}استعمال کرنا بہتر ثابت ہوتا ہے چونکہ اس طرح آپ دیکھ سکتے ہیں کہ \عددی{y} گھٹ رہا ہے)۔ اگر لمحہ \عددی{t=0} پر تابکار ایٹموں کی تعداد \عددی{y_0} ہو تب لمحہ \عددی{t} پر درج ذیل ہو گا۔
\begin{align}\label{مساوات_ماورائی_تابکاری_تحلیل}
y&=y_0e^{-kt},\quad k>0&&\text{\RL{مساوات تابکاری}}
\end{align}

تابکاری  کی شرح کو بغیر تجربہ بھی سمجھا جا سکتا ہے۔ فرض کریں  تابکار عنصر  کے ایک چھوٹے ٹکڑے سے، جس کی کمیت    \عددی{m}   ہے،  فی سیکنڈ  \عددی{c} ذرات خارج ہوتے  ہیں۔یوں ہم توقع کریں گے کہ  اس کے کسی دوسرے ٹکڑے سے ، جس کی کمیت بھی       \عددی{m}    ہو، اسی شرح سے ذرات خارج ہوں گے۔یوں  دونوں ٹکڑوں کا مجموعی فی سیکنڈ اخراج    \عددی{(2c)} یعنی دگنا ہو گا۔ دوسرے  لفظوں  میں ، کمیت دگنی کرنے سے  (جو موجود ایٹموں کی تعداد دگنی کرنے کے مترادف ہے) فی سیکنڈ ذرات کا اخراج  دگنا ہو گا۔اسی طرح   \عددی{n} ٹکڑوں سے، جہاں ہر ٹکڑے کی انفرادی کمیت \عددی{m} ہو، فی سیکنڈ اخراج \عددی{n} گنا ہو گا۔ یوں ہم دیکھتے ہیں کہ فی سیکنڈ اخراج  موجود  کمیت یعنی موجود ایٹموں کی تعداد \عددی{y} کے راست متناسب ہے، یعنی\عددی{\tfrac{\dif y}{\dif t}\propto y}   ہے۔

\ابتدا{مثال}\ترچھا{نصف حیات}\\
کسی  عنصر کے آدھے ایٹموں کو تابکاری کے ذریعہ تبدیل ہونے کے لیے درکار وقت کو اس عنصر کی \اصطلاح{نصف حیات}\فرہنگ{نصف حیات}\حاشیہب{half life}\فرہنگ{half life} کہتے ہیں۔ کسی بھی عنصر کی نصف حیات، ابتدائی ایٹموں کی تعداد پر نہیں  بلکہ عنصر پر منحصر ہوتی ہے۔
...
t&=\frac{\ln 2}{k}
\end{align*}
اس دورانیہ \عددی{(t=\tfrac{\ln 2}{k})} کو نصف حیات کہتے ہیں ، جو صرف \عددی{k} پر منحصر ہے  نا کہ ابتدائی ایٹموں کی تعداد پر۔
\انتہا{مثال}
%=====================
\begin{align}
\text{\RL{نصف حیات}}=\frac{\ln 2}{k}
\end{align}

ریڈان \اردوعدد{222} گیس کے لیے \عددی{k=0.18} دن ہے ، لہٰذا اس کی نصف حیات \عددی{3.8} دن ہو گی،  جبکہ رات کی تاریکی میں  نظر آنے کی خاطر گھڑیوں میں استعمال ہونے والے ریڈیم  \اردوعدد{226 } کا \عددی{k=4.3\times 10^{-4}} سال ہے،  لہٰذا اس کی نصف حیات \اردوعدد{1600} سال ہو گی۔

\ابتدا{مثال}\ترچھا{پولونیم  \اردوعدد{210}}\\
پولونیم  \اردوعدد{210}  کی نصف حیات   کو دنوں میں ناپا جاتا ہے۔ اگر  آج،  یعنی لمحہ  \عددی{t=0} پر ، پولونیم  \اردوعدد{210}   کے ایٹموں کی تعداد  \عددی{y_0}  ہو  تب \عددی{t} دنوں بعد اس کے ایٹموں کی تعداد \عددی{{y=y_0e^{-5\times 10^{-3}t}}  } ہو گی۔ اس عنصر کی نصف حیات تلاش کریں۔
...
\ابتدا{مثال}\ترچھا{کاربن  \اردوعدد{14}  تعین زمان}\\
کاربن  \اردوعدد{14} جس کی نصف حیات \عددی{5700} سال ہے، کو  قدیم اشیاء کی عمر معلوم کرنے کے لیے عموماً  استعمال کیا جاتا ہے۔ ایک نمونہ میں \عددی{\SI{10}{\percent}} تابکار کاربن  کے  ایٹم تبدیل  ہو چکے ہیں۔ اس نمونے کی عمر تلاش کریں۔
...
\end{align*}
\موٹا{دوسرا قدم:}\quad \ترچھا{درکار وقت ،  جس میں $\SI{90}{\percent}$ ایٹم باقی رہ جائیں۔}
\begin{align*}
...
کاربن \اردوعدد{14}  کے علاوہ دیگر تابکار عناصر کو بھی تعین زمان کے لیے استعمال کیا جا سکتا ہے۔ یورینیم (جس کی نصف حیات \اردوعدد{4.5} ارب سال ہے) کو \اردوعدد{2} ارب سال پرانی چٹانوں کی  عمر تلاش کرنے کے لیے استعمال کیا گیا ہے۔


\جزوحصہء{منتقلی حرارت: نیوٹن کا قانون ٹھنڈک}
کوئی بھی گرم جسم کچھ دیر میں ٹھنڈا ہو کر  اردگرد  ماحول کے درجہ حرارت پر آن پہنچتا ہے۔ جسم کے درجہ حرارت میں تبدیلی کی شرح، جسم اور ماحول کے درجہ حرارت میں فرق کے راست متناسب ہوتی ہے۔ اس حقیقت کو \اصطلاح{نیوٹن کا قانون ٹھنڈک} کہتے ہیں۔

گر لمحہ \عددی{t} پر جسم کا درجہ حرارت متغیر \عددی{T} ہو اور اردگرد  ماحول کا درجہ حرارت مستقل \عددی{T_S} ہو تب
\begin{align}\label{مساوات_ماورائی_قانون_ٹھنڈک}
\frac{\dif T}{\dif t}=-k(T-T_S)
\end{align}
ہو گا۔ہم \عددی{(T-T_S)}  کو \عددی{y}  لے کر تفرق کرتے ہیں۔
\begin{align*}
\frac{\dif y}{\dif t}&=\frac{\dif}{\dif t}(T-T_S)=\frac{\dif T}{\dif t}-\frac{\dif T_S}{\dif t}\\
&=\frac{\dif T}{\dif t}-0&&\text{\RL{$T_S$ مستقل}}\\
&=\frac{\dif T}{\dif t}
\end{align*}
یوں مساوات \حوالہ{مساوات_ماورائی_قانون_ٹھنڈک} میں بائیں ہاتھ درج بالا نتیجہ اور دائیں ہاتھ \عددی{T-T_S}   کی جگہ \عددی{y} لکھ کر درج ذیل  حاصل ہو گا
\begin{align*}
\frac{\dif y}{\dif t}=-ky
\end{align*} 
...
\end{align*} 
پانچ منٹ بعد \عددی{T=38} ہو گا جس  کو استعمال کر کے   ذیل حاصل ہو گا۔
\begin{align*}
38&=18+80e^{-5k}\\
e^{-5k}&=\frac{1}{4}\\
-5k&=\ln\frac{1}{4}=-\ln 4\\
...
\end{align*}
بالٹی میں ڈالنے کے  تقریباً \اردوعدد{13} منٹ بعد انڈے کا درجہ حرارت \عددی{\SI{20}{\celsius}} ہو گا۔
\انتہا{مثال}
%==================

%sec7.5 questions start here
%sec7.5 questions start here
\حصہء{سوالات}
\ابتدا{سوالات}
...
سطح سمندر سے  \عددی{h} بلندی پر فضائی دباو \عددی{p} کی تبدیلی کی شرح \عددی{\tfrac{\dif p}{\dif h}}  عموماً \عددی{p}کے  راست متناسب تصور کی  جاتی ہے۔ سطح سمندر پر فضائی دباو \عددی{\SI{101293}{\newton\per\meter\squared}} اور \عددی{\SI{20}{\kilo\meter}} بلندی  پر  \عددی{\SI{9000}{\newton\per\meter\squared}} لیں۔
\begin{enumerate}[a.]
\item
...
بعض کیمیائی اعمال میں اجزاء کی تبدیلی کی شرح اس لمحے پر موجود مواد کی مقدار پر منحصر ہوتی ہے۔ ایسے ایک کیمیائی عمل کو 
\begin{align*}
...
%=====================
\ابتدا{سوال}
خام شکر کو  ایک مرحلہ سے گزارا جاتا ہے ، جس میں شکر کے  سالمہ  کی ساخت تبدیل ہوتی ہے۔ اس عمل کے شروع ہونے کے بعد کسی بھی لمحہ پر تبدیلی کی شرح،   خام مال کی باقی مقدار کے راست تناسب ہوتی ہے۔ اگر \عددی{\SI{1000}{\kilo\gram}} خام مال سے شروع کرتے ہوئے ابتدائی \عددی{10} گھنٹوں بعد باقی خام مال کی مقدار  \عددی{\SI{800}{\kilo\gram}} ہو تب مزید \عددی{14} گھنٹوں بعد خام مال کی مقدار کتنی ہو گی؟
\انتہا{سوال}
%=======================
\ابتدا{سوال}\ترچھا{زیر آب کام}\\
سمندری پانی کی سطح سے \عددی{x} میٹر نیچے  گہرائی میں روشنی  کی شدت \عددی{L(x)} درج ذیل تفرقی مساوات کو مطمئن کرتی ہے۔
\begin{align*}
\frac{\dif L}{\dif x}=-kL
\end{align*}
آپ تجربہ سے جانتے ہیں کہ سطح سے \عددی{\SI{6}{\meter}} نیچے روشنی کی شدت آدھی ہے۔ آپ سطحی روشنی کی شدت کے  \عددی{\tfrac{1}{10}} حصہ میں کام کر سکتے ہیں۔ یوں کتنی گہرائی تک آپ کام کر سکیں گے؟\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{19.93}{\meter}$
...
\انتہا{جواب}
%=========================
\ابتدا{سوال}\ترچھا{برق گیر  (کپیسٹر)  پر  برقی دباو}\\
برق گیر  سے برقی نکاسی کی شرح اس پر موجود برقی دباو کے راست متناسب ہے۔ یوں \عددی{t} سیکنڈ بعد اس پر دباو \عددی{V} درج ذیل کلیہ کو مطمئن کرتا ہے۔
\begin{align*}
...
فرض کریں ہیضہ کے جراثیم بغیر رکاوٹ قوت نمائی طور پر بڑھ سکتے ہیں۔ لمحہ \عددی{t=0} پر ایک جرثومہ ہوتا ہے۔ جرثومہ  آدھے  گھنٹے میں ٹوٹ کر دو جرثوموں میں تبدیل ہوتا ہے۔ \عددی{24} گھنٹوں بعد کتنے جرثومے پائے جائیں گے؟ (اگرچہ بیمار شخص کے جسم میں ہر گھنٹہ متعدد جرثومے مارے جاتے ہیں۔ اس مثال سے آپ دیکھ سکتے ہیں کہ صبح ظاہری طور پر بالکل تندرست شخص، شام کو یک دَم کیوں   سخت بیمار ہو سکتا ہے۔)\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
تجربہ گاہ میں ایک قسم کے  جرثوموں کی  افزائش کے لیے بہترین ماحول مہیا کیا جاتا ہے تاکہ  ان کی تعداد قوت نمائی بڑھ سکے۔\عددی{3} گھنٹوں بعد جرثوموں کی تعداد \عددی{\num{10000}} اور \عددی{5} گھنٹوں بعد ان کی تعداد \عددی{\num{40000}} ہوتی ہے۔ ابتدائی جرثوموں کی تعداد دریافت کریں۔
\انتہا{سوال}
%=======================
\ابتدا{سوال}\ترچھا{بیماری کا پھیلانا (مثال \حوالہ{مثال_ماورائی_پھیلاو_بیماری})}\\
فرض کریں کہ مثال \حوالہ{مثال_ماورائی_پھیلاو_بیماری} میں     ایک سال میں بیمار افراد کی تعداد میں \عددی{\SI{25}{\percent}} کمی رونما ہوتی ہے۔
\begin{enumerate}[a.]
\item
کتنے سالوں میں بیماروں کی تعداد \عددی{1000} ہو گی؟
\item
کتنے عرصے میں بیماری کا خاتمہ ہو گا۔ (بیماروں کی تعداد ایک سے کم ہونے کو خاتمہ تصور کیا جاتا ہے۔) 
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
پاکستان کی آبادی میں \سن{2017} میں ہر \عددی{8} سیکنڈ میں ایک بچے کا اضافہ ہوا۔
\begin{enumerate}[a.]
\item
...
فرض کریں تیل کے  کنواں سے حاصل تیل میں ہر سال \عددی{\SI{10}{\percent}} کمی رونما ہوتی ہے۔کتنے سالوں میں حاصل تیل کی مقدار \عددی{\SI{20}{\percent}} رہ جائے گی؟\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
\عددی{15.28} سال
...
فروخت میں اضافہ پیدا کرنے کی خاطر آپ کا ادارہ قیمت میں چھوٹ کو خریداری کے ساتھ یوں منسلک کرتا ہے کہ ایک شے کی قیمت \عددی{p(x)}،  خریدی گئی اشیاء کی تعداد کا تفاعل ہو۔ ہر اضافی ایک عدد خریداری پر مزید \عددی{\SI{1}{\percent}} چھوٹ دی جاتی ہے۔ \عددی{100} عدد کی خریداری پر فی اکائی قیمت \عددی{p(100)=20.09} روپیہ ہے۔
\begin{enumerate}[a.]
\item
...
\item
کیا  \عددی{100} کی خریداری پر آمدنی \عددی{r(x)=x\cdot p(x)}  در حقیقت \عددی{90} کی خریداری پر آمدنی سے کم ہو گی؟ دکھائیں کہ حقیقت میں \عددی{100} کی خریداری پر آمدنی اعظم ہو گی۔ 
\item
آمدنی \عددی{r(x)=x\cdot p(x)} کو \عددی{0\le x\le 200} کے لیے ترسیم کریں۔
\end{enumerate} 
\انتہا{سوال}
%===================
\ابتدا{سوال}\ترچھا{مسلسل سود در سود}\\
آپ بنک سے \عددی{A_0} روپیہ کا قرضہ لیتے ہیں ، جس پر آپ کو \عددی{\SI{4}{\percent}} مسلسل سود در سود ادا کرنا ہو گا۔
\begin{enumerate}[a.]
\item
 آپ کو \عددی{5} سال بعد کتنی رقم ادا کرنی ہو گی؟
\item
آپ کو کتنے سالوں میں دگنی رقم ادا کرنی ہو گی؟ کتنے سالوں میں تگنی رقم ادا کرنی ہو گی؟ 
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%===================
\ابتدا{سوال}
ایک شخص نے بنک میں رقم کو \عددی{100} سال کے لیے جمع کیا۔ سو سال بعد اس کے خاندان کو \عددی{90} گنا رقم حاصل ہوتی ہے۔ مسلسل سود در سود کی شرح تلاش کریں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{4.50}{\percent}$
...
%=====================
\ابتدا{سوال}
ایک شخص نے بنک میں رقم کو \عددی{100} سال کے لیے جمع کیا۔ سو سال بعد اس کے خاندان کو \عددی{131} گنا رقم حاصل ہوتی ہے۔ مسلسل سود در سود کی شرح تلاش کریں۔
\انتہا{سوال}
%=====================
\ابتدا{سوال}\ترچھا{ریڈان  \اردوعدد{222}}\\
ریڈان \اردوعدد{222 } گیس کی تابکاری تحلیل کا کلیہ \عددی{y=y_0e^{-0.18t}} ہے ، جہاں وقت \عددی{t} کو دنوں میں ناپا جاتا ہے۔ کتنے عرصہ میں ریڈان \اردوعدد{222 }کے کسی بھی نمونہ میں \عددی{\SI{90}{\percent}} مواد باقی ہو گا؟\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
\عددی{0.585} دن
...
\انتہا{جواب}
%======================
\ابتدا{سوال}\ترچھا{پولونیم \اردوعدد{210}}\\
پولونیم  \اردوعدد{210 } کی نصف حیات \عددی{139}  دن ہے۔ اگر آپ کے پاس پولونیم  \اردوعدد{210 }کے نمونہ میں \عددی{\SI{95}{\percent}} مواد تابکاری کی وجہ سے تبدیل ہو جائے تب یہ نمونہ آپ کے کسی کام کا نہیں ہو گا۔ یہ نمونہ کتنے دنوں تک آپ کے کام کا ہو گا؟
\انتہا{سوال}
%===================
\ابتدا{سوال}\شناخت{سوال_ماورائی_اوسط_زندگی}\ترچھا{تابکار مادّہ کی اوسط حیات}\\
تابکاری تحلیل کی مساوات \عددی{y=y_0e^{-kt}} میں  \عددی{\tfrac{1}{k}} کو تابکار مرکزہ کی \اصطلاح{اوسط حیات}\فرہنگ{اوسط حیات!مرکزہ}\حاشیہب{mean life}\فرہنگ{mean life!nucleus} کہتے ہیں۔ ریڈان مرکزہ کی اوسط حیات تقریباً \عددی{\tfrac{1}{0.18}=5.6} دن ہے۔ کاربن 12 کی اوسط حیات تقریباً \عددی{8000} سال ہے۔ دکھائیں کہ کسی بھی تابکار مادّہ کی تین اوسط حیات کے برابر وقت میں \عددی{\SI{95}{\percent}} مادّہ تبدیل ہو جائے گا۔ یوں نصف حیات سے آپ با آسانی معلوم کر سکتے ہیں کہ مادّہ کتنے عرصہ میں  ختم ہو گا۔
\انتہا{سوال}
%=================
\ابتدا{سوال}\ترچھا{کیلیفورنیم  \اردوعدد{252}}\\
کیلیفورنیم    \اردوعدد{252} کو \سن{1950} میں  دریافت کیا گیا۔ اب تک مغربی دنیا میں اس عنصر کے صرف \عددی{\SI{8}{\gram}} جمع کیے گئے ہیں۔ اس کی قیمت سونے سے \عددی{654} گنا زیادہ ہے۔ اس کی نصف حیات \عددی{2.645} سال ہے اور  \عددی{\SI{1}{\micro\gram}} کیلیفورنیم فی سیکنڈ \عددی{170\times 10^6} تعدیلی برقیہ خارج کرتا ہے۔
\begin{enumerate}[a.]
\item
تابکاری تحلیل کی مساوات میں اس عنصر کا \عددی{k} کتنا ہو گا؟
\item
اس عنصر کی اوسط حیات کتنی ہو گی؟ (سوال \حوالہ{سوال_ماورائی_اوسط_زندگی} سے رجوع کریں۔)
\item
کتنے عرصے  میں \عددی{\SI{95}{\percent}} عنصر تابکاری تحلیل کی وجہ سے تبدیل ہو جائے گا؟
\end{enumerate}
\انتہا{سوال}
%===================

\ابتدا{سوال}\ترچھا{یخنی}\\
ایک کمرہ ، جس کا درجہ حرارت \عددی{\SI{20}{\celsius}} ہے،  میں ایک پیالی یخنی کا درجہ حرارت دس منٹ میں \عددی{\SI{90}{\celsius}} سے گر کر \عددی{\SI{60}{\celsius}} ہو جاتا  ہے۔ نیوٹن کا قانون ٹھنڈک استعمال کرتے ہوئے درج ذیل کا جواب دیں۔
\begin{enumerate}[a.]
\item
مزید کتنے وقت میں یخنی کا درجہ حرارت \عددی{\SI{35}{\celsius}}ہو گا؟
\item
اگر \عددی{\SI{90}{\celsius}} گرم یخنی کے پیالے کو \عددی{\SI{-15}{\celsius}} کے ٹھنڈی فریج میں رکھا جائے تب اس کو \عددی{\SI{35}{\celsius}} تک ٹھنڈا ہونے میں کتنا وقت درکار ہو گا؟ 
\end{enumerate} 
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
المونیم کا   شہتیر  باہر سے کمرے کے  اندر لایا جاتا ہے۔اندر  درجہ حرارت \عددی{\SI{20}{\celsius}} ہے ، جبکہ  باہر موسم ٹھنڈا ہے۔دس منٹ بعد شہتیر کا درجہ حرارت \عددی{\SI{2}{\celsius}} ہے،  جبکہ مزید دس منٹ بعد اس کا درجہ حرارت \عددی{\SI{10}{\celsius}} ہے۔ نیوٹن کا قانون ٹھنڈک استعمال کرتے ہوئے شہتیر کا ابتدائی درجہ حرارت تلاش کریں۔
\انتہا{سوال}
%====================
\ابتدا{سوال}\ترچھا{اردگرد ماحول کا درجہ حرارت نا معلوم}\\
ایک جگ،  جو \عددی{\SI{46}{\celsius}} درجہ حرارت پانی سے بھرا ہوا ہے ، کو فریج میں رکھا جاتا ہے۔ دس منٹ بعد اس کا درجہ حرارت \عددی{\SI{39}{\celsius}} ہوتا ہے۔ مزید دس منٹ بعد اس کا درجہ حرارت \عددی{\SI{33}{\celsius}} ہوتا ہے۔ نیوٹن کا قانون ٹھنڈک استعمال کرتے ہوئے فریج کا درجہ حرارت تلاش کریں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\SI{-3}{\celsius}$
...
چاندی کی  سلاخ کا موجودہ درجہ حرارت، کمرے کے درجہ حرارت سے \عددی{\SI{60}{\celsius}} زیادہ ہے۔ بیس منٹ قبل  اس کا درجہ حرارت، کمرے کے درجہ حرارت سے \عددی{\SI{70}{\celsius}} زیادہ تھا۔ (ا) پندرہ منٹ کے بعد اس کا درجہ حرارت، کمرے سے کتنا زیادہ ہو گا؟ (ب) دو گھنٹوں بعد کتنا ہو گا؟ (ج) کتنی دیر بعد کمرے سے سلاخ کا درجہ حرارت \عددی{\SI{10}{\celsius}} زیادہ ہو گا؟  
\انتہا{سوال}
%=================
\ابتدا{سوال}\ترچھا{آتش فشاں}\\
زمانہ قدیم میں ایک آتش فشاں کے پھٹنے سے قریبی درخت جل جاتے ہیں اور آتش فشاں میں ایک جھیل بن جاتا ہے۔ اس جھیل میں موجود کوئلہ میں زندہ درختوں کے لحاظ سے  \عددی{\SI{44.5}{\percent}} کاربن\اردوعدد{14 } پایا جاتا ہے۔ یہ جھیل کتنا قدیم ہے؟\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\begin{enumerate}[a.]
\item
ایک \اصطلاح{متحجر  ہڈی}\فرہنگ{متحجر  ہڈی}\حاشیہب{fossil bone}\فرہنگ{fossil bone} \سن{2000} میں دریافت کی گئی۔ اس میں ابتدائی کاربن\اردوعدد{14 } کا \عددی{\SI{17}{\percent}} حصہ باقی تھا۔ یہ جانور کب زندہ تھا؟
\item
اگر جزو-ا میں \عددی{\SI{17}{\percent}} کے بجائے \عددی{\SI{18}{\percent}} حصہ باقی ہو تب کیا جواب ہو گا؟
\item
اگر جزو-ا میں \عددی{\SI{17}{\percent}} کے بجائے \عددی{\SI{16}{\percent}} حصہ باقی ہو تب کیا جواب ہو گا؟
\end{enumerate}
\انتہا{سوال}
%=========================
...
%sec 7.5 questions end here
%sec 7.5 questions end here


\حصہ{قاعدہ لھوپیٹال}\شناخت{حصہ_ماورائی_قاعدہ_لھوپیٹال}
ایسا کسر جس کا نسب نما اور شمار کنندہ دونوں تحدیدی نقطہ پر  صفر  کے قریب تر پہنچتے ہوں، کی حد تلاش کرنے کا قاعدہ یعقوب برنولی نے دریافت کیا جس کو \اصطلاح{قاعدہ لھوپیٹال}\فرہنگ{قاعدہ !لھوپیٹال}\حاشیہب{L'Hospital's Rule}\فرہنگ{Rule!L'Hospital's}  کہتے ہیں۔

\جزوحصہء{غیر معین حاصل تقسیم}
اگر نقطہ \عددی{x=a} پر تفاعل \عددی{f(x)} اور \عددی{g(x)} کی قیمتیں صفر ہوں تب \عددی{x=a}  رکھتے  ہوئے  \عددی{\lim_{x\to a}\tfrac{f(x)}{g(x)}} کا حصول ممکن نہیں ہو گا ، چونکہ ایسا کرنے سے \عددی{\tfrac{0}{0}} ملتا ہے جو بے معنی ہے اور  جس کو \اصطلاح{غیر معین روپ}\فرہنگ{غیر معین روپ}\حاشیہب{indeterminate form}\فرہنگ{indeterminate form} کہتے ہیں۔ اب تک ہم دیکھ چکے ہیں کہ جو حد غیر معین روپ  دیتی ہیں، ان کی حد تلاش کرنا   کبھی آسان اور کبھی مشکل ہوتا ہے۔ہم نے حصہ \حوالہ{حصہ_تفرق_تکونیاتی_تفاعل_کا_تفرق} میں کافی محنت کے بعد \عددی{\lim_{x\to 0}\tfrac{\sin x}{x}} کی قیمت حاصل کی۔ اس کے برعکس تفرق کے حصول میں استعمال ہونے والی درج ذیل حد تلاش کرنے میں ہمیں کوئی دشواری پیش نہیں ہوئی،
\begin{align*}
f'(a)=\lim_{x\to a}\frac{f(x)-f(a)}{x-a}
\end{align*}
اگرچہ اس حد میں \عددی{x=a}  رکھنے سے ہر صورت \عددی{\tfrac{0}{0}} حاصل ہوتا ہے۔ قاعدہ لھوپیٹال  کی مدد سے ہم تفرق کے حصول میں حد کے استعمال سے استفادہ کرتے ہوئے ان حدوں  کو تلاش کرتے ہیں جو غیر معین روپ کو جنم دیتی  ہیں۔

\ابتدا{مسئلہ}\موٹا{قاعدہ لھوپیٹال (پہلا روپ)}\\
...
%=========================
\ابتدا{ثبوت}
ہم \عددی{f'(a)} اور \عددی{g'(a)}، جو از خود حد کو ظاہر کرتے ہیں، سے شروع کر  کے الٹ  چلتے ہیں۔یوں درج ذیل ہو گا۔
\begin{align*}
\frac{f'(a)}{g'(a)}&=\frac{\lim_{x\to a}\frac{f(x)-f(a)}{x-a}}{\lim_{x\to a}\frac{g(x)-g(a)}{x-a}}=\lim_{x\to a}\frac{\dfrac{f(x)-f(a)}{x-a}}{\dfrac{g(x)-g(a)}{x-a}}\\
...
قاعدہ لھوپیٹال استعمال کرتے ہوئے \عددی{f} کے تفرق \عددی{f'} کو \عددی{g} کے تفرق \عددی{g'} سے تقسیم کریں۔ یاد رہے کہ \عددی{\tfrac{f}{g}} کا تفرق \عددی{(\tfrac{f}{g})'}  درست نتیجہ نہیں دے گا۔

\ابتدا{مثال}\شناخت{مثال_ماورائی_قاعدہ_لھوپیٹال_الف}
\begin{align*}
\lim_{x\to 0}\frac{3x-\sin x}{x}&=\left. \frac{3-\cos x}{a}\right\vert_{x=0}=2 && \text{\RL{(ا)}}\\
\lim_{x\to 0}\frac{\sqrt{1+x}-1}{x}&=\left.\frac{\tfrac{1}{2\sqrt{1+x}}}{1}\right\vert_{x=0}=\frac{1}{2} && \text{\RL{(ب)}}\\
\lim_{x\to 0}\frac{x-\sin x}{x^3}&=\left.\frac{1-\cos x}{3x^2}\right\vert_{x\to 0}=?\quad \text{\RL{اب بھی $\frac{0}{0}$ ملتا ہے}} && \text{\RL{(ج)}}
\end{align*}
\انتہا{مثال}
%======================

ہم دیکھتے ہیں کہ مثال \حوالہ{مثال_ماورائی_قاعدہ_لھوپیٹال_الف} کے جزو-ج میں قاعدہ لھوپیٹال کے استعمال کے باوجود \عددی{\tfrac{0}{0}} حاصل ہوتا ہے۔ قاعدہ لھوپیٹال کا  پائیدار  روپ کہتا ہے   جب تک یہ قاعدہ  \عددی{\tfrac{0}{0}}   دے ہم  قاعدہ مزید ایک مرتبہ استعمال کر سکتے ہیں۔ آئیں   درج بالا  مثال  کا  جزو-ج  حل کرتے ہیں۔
\begin{align*}
...
&=\lim_{x\to 0}\frac{\cos x}{6}=\frac{1}{6}&&\text{\RL{اس مرتبہ  $\frac{0}{0}$ نہیں ملا}}
\end{align*}
...
\end{align}
اگر دائیں ہاتھ حد موجود ہو(یا  \عددی{\infty} اور یا \عددی{-\infty} ہو)۔
\انتہا{مسئلہ}
%========================

متناہی حد موجود ہونے  کی صورت میں مسئلہ \حوالہ{مسئلہ_ماورائی_لھوپیٹال_دوم}کا ثبوت کتاب کے آخر میں ضمیمہ  \حوالہ{ضمیمہ_ہ}  میں پیش کیا گیا ہے۔ 
...
\انتہا{مثال}
%===========================
قاعدہ لھوپیٹال استعمال کرتے ہوئے جیسے   ہی \عددی{\tfrac{0}{0}} سے کچھ ہٹ کر ملتا ہے آپ حد تلاش کر پائیں گے۔
...
\end{align*}
اگر \عددی{\tfrac{0}{0}} ملنے کے بعد رکنے کے بجائے ہم مزید ایک بار قاعدہ لھوپیٹال استعمال کریں تب ہمیں درج ذیل \موٹا{غلط} نتیجہ حاصل ہو گا۔
\begin{align*}
...
بعض اوقات ہم غیر معین روپ \عددی{0\cdot\infty} اور \عددی{\infty-\infty} کو الجبرا کی مدد سے \عددی{\tfrac{0}{0}} یا \عددی{\tfrac{\infty}{\infty}} لکھ سکتے ہیں۔ یاد رہے ہم   ہرگز نہیں  کہہ رہے کہ   \عددی{0\cdot \infty} یا \عددی{\infty-\infty}  اعداد ہیں، بالکل ایسا ہی جیسے ہم نہیں  کہتے  کہ \عددی{\tfrac{0}{0}} یا \عددی{\tfrac{\infty}{\infty}}  کوئی عدد  ہے۔ یہ روپ   عدد کو ظاہر نہیں کرتے  بلکہ  تفاعل کا رویہ  بیان کرتے ہیں۔

\ابتدا{مثال}
\begin{align*}
\lim_{x\to 0^+}&x\cot x&&\text{\RL{$0\cdot \infty $ کی وجہ سے $x\cot x$ کو مختلف روپ میں لکھیں}}\\
...
\end{align*}
دونوں صورتوں میں حد جاننا ممکن نہیں۔ہم   تفاعل کو نئی صورت
\begin{align*}
...
بعض اوقات ایسے حدود  جو نا قابل معلوم روپ \عددی{1^{\infty}}، \عددی{0^0} یا \عددی{\infty^0} دیتے ہوں  کا لوگارتھم پہلے لینے سے حد تلاش کرنا ممکن ہو جاتا ہے۔ ہم  قاعدہ لھوپیٹال سے لوگارتھم کی حد حاصل کرنے کے بعد قوت نما  کر کے  اصل تفاعل کا رویہ جانتے ہیں۔
...
\ابتدا{مثال}\شناخت{مثال_ماورائی_قوت_نما_متبادل_تعریف}
دکھائیں  کہ \عددی{\lim_{x\to 0^+}(1+x)^{1/x}=e} ہو گا۔
...
\حل
حد کی تلاش نا قابل معلوم روپ \عددی{\infty^{0}} دیتی ہے۔ ہم \عددی{f(x)=x^{1/x}} لے کر \عددی{\lim_{x\to\infty}\ln f(x)} تلاش کرتے ہیں۔ چونکہ
\begin{align*}
...
\انتہا{سوال}
%=====================
\موٹا{وہ حد  جن میں اساس اور قوت نما پائے جاتے ہوں}\\
...
%========================
\موٹا{نظریہ اور استعمال}\\
سوال \حوالہ{سوال_ماورائی_گول_دائرہ_الف} تا سوال \حوالہ{سوال_ماورائی_گول_دائرہ_ب} میں قاعدہ لھوپیٹال سے حد تلاش کرنا ممکن نہیں ہو گا۔ آپ ایک ہی چکر  میں گھومتے رہیں گے۔ کسی دوسرے طریقے سے حد تلاش کریں۔
...
%=======================
\ابتدا{سوال}
درج ذیل تفاعل کو \عددی{x=0} پر استمراری بنانے کے لیے درکار \عددی{c} کی قیمت تلاش کریں۔
\begin{align*}
f(x)=
\begin{cases}
...
%=====================
\ابتدا{سوال}
درج ذیل تفاعل کو \عددی{\theta=0} پر دائیں سے استمراری بنانے کے لیے درکار \عددی{c} کی قیمت تلاش کریں۔
\begin{align*}
g(\theta)=
\begin{cases}
...
\end{align*}
جیسا آپ دیکھ سکتے ہیں، حد سے نا قابل معلوم روپ \عددی{1^{\infty}} حاصل ہوتا ہے۔ قاعدہ لھوپیٹال سے حد کی تصدیق کریں۔
\انتہا{سوال}
%======================
\ابتدا{سوال}
اگر \عددی{x>0} ہو تب درج ذیل کی اعظم قیمت  (اگر پائی جاتی ہو) تلاش کریں۔
\begin{enumerate}[a.]
\item
$x^{1/x}$
\item
...
\item
دکھائیں کہ ہر مثبت عدد صحیح \عددی{n} کے لیے \عددی{\lim_{x\to \infty}x^{1/{x^n}}=1} ہو گا۔
\end{enumerate}
\انتہا{سوال}
%==============
\موٹا{کمپیوٹر کا استعمال}

\ابتدا{سوال}\ترچھا{مستقل \عددی{e} کی قیمت کی تلاش}\\
\begin{enumerate}[a.]
\item
...
\end{align*}
\item
تفاعل \عددی{f(x)=(1+1/x)^x} کی قیمت \عددی{x=10,10^2,10^3,\cdots} کے لیے کیلکولیٹر کی مدد سے تلاش کرتے ہوئے دیکھیں کہ آپ اصل قیمت \عددی{e=\num{2.718281828459045}\cdots} کے کتنے قریب پہنچتے ہیں۔ اگرچہ ہم توقع کرتے ہیں کہ \عددی{x} کی قیمت بڑھانے سے زیادہ بہتر جواب حاصل ہو گا، بعض کیلکولیٹروں  میں پورم پور خلل کی وجہ سے کسی مخصوص حد سے \عددی{x} کی قیمت بڑھنے  کے بعد نتائج کم درست ہوں گے۔
\item
تفاعل \عددی{f(x)=(1+1/x)^x} کو ترسیم کریں۔ یہاں بھی \عددی{x} کی زیادہ بڑی قیمت پر پورم پور خلل کی وجہ سے نتیجہ کم درست ہو گا۔
\end{enumerate}
\انتہا{سوال}
%======================
\ابتدا{سوال}
آئیں درج ذیل دو حدوں  میں فرق پر غور کریں۔
\begin{align*}
\lim_{x\to\infty}\big(1+\frac{1}{x^2}\big)^x\quad \text{}\quad \lim_{x\to \infty}\big(1+\frac{1}{x}\big)^x=e
\end{align*}
\begin{enumerate}[a.]
\item
وقفہ \عددی{x\ge 0} کے لیے درج ذیل تفاعل ترسیم کریں۔
\begin{align*}
...
\end{align*}
(ب) قاعدہ لھوپیٹال سے اس حد کی تصدیق کریں۔ ایسا کرنے کے لیے پہلے \عددی{f(x)} کو \عددی{\tfrac{x+\sqrt{x^2+x}}{x+\sqrt{x^2+x}}} سے ضرب دے کر شمار کنندہ  کی سادہ صورت حاصل کریں۔
\انتہا{سوال}
%=================
\ابتدا{سوال}
...
%===================
\ابتدا{سوال}
(ا) تفاعل  \عددی{f(x)=\tfrac{(x-1)^2}{x\ln x-x-\cos \pi x}}  کو \عددی{x=1} کے قریب قریب ترسیم کرتے ہوئے درج ذیل کی اندازاً قیمت تلاش کریں۔ اس کی تصدیق قاعدہ لھوپیٹال کی مدد سے کریں۔
\begin{align*}
\lim_{x\to1}\frac{(x-1)^2}{x\ln x-x-\cos \pi x}
\end{align*} 
(ب) تفاعل \عددی{f(x)} کو \عددی{0<x\le 11} کے لیے ترسیم کریں۔
\انتہا{سوال}
%===================
...
\item
وقفہ \عددی{[0,\pi]} پر \عددی{f} کی اعظم قیمت ترسیم سے معلوم کریں۔ یہ قیمت کس نقطے  پر پائی جاتی ہے؟
\item
جزو-ج میں اپنے جواب کو مزید بہتر بنانے کی خاطر \عددی{f'} کو ترسیم کر کے دیکھیں کہ یہ محور \عددی{x} کو کہاں قطع کرتی ہے۔ اپنے کام کو آسان بنانے کی خاطر آپ \عددی{f'} میں قوت نما جزو ضربی  کو رد کرتے ہوئے صرف اس  جزو ضربی  کو ترسیم کر سکتے ہیں جس کا صفر پایا جاتا ہو۔
\item
اعظم \عددی{f} کا مقام بہتر جاننے کی خاطر مساوات \عددی{f'=0} کو اعدادی طریقہ سے حل کریں۔
\item
جزو-ج، د اور ہ میں حاصل نقطوں پر \عددی{f} کی اعظم قیمت  حاصل کریں۔ اعظم قیمت کے لئے آپ کی  سب سے بہتر   قیمت کیا ہے؟
\end{enumerate}
\انتہا{سوال}
%====================
...
\item
اب وقفہ \عددی{0\le x\le \pi} پر \عددی{f} ترسیم کریں۔ اگرچہ نقطہ \عددی{x=\tfrac{\pi}{2}} پر \عددی{f} نا قابل معلوم ہے،  اس کے باوجود ترسیم میں اس نقطے  پر درز نہیں پایا جاتا۔ ایسا کیوں ہے؟ نقطہ \عددی{x=\tfrac{\pi}{2}} پر ترسیم \عددی{f} کی کیا قیمت دیتی ہے؟ (اشارہ:  قاعدہ لھوپیٹال استعمال کرتے ہوئے \عددی{x\to (\pi/2)^-} اور \عددی{x=(\pi/2)^+} کے لیے \عددی{f} کی حدیں تلاش کریں۔)
\item
جزو-ب کی ترسیم سے \عددی{f} کی اعظم اور اقل قیمت تلاش کریں اور وہ نقطے بھی تلاش کریں جہاں یہ قیمتیں پائی جاتی ہیں۔
\end{enumerate}
\انتہا{سوال}
%=========================
...
\end{align*}
بھرتا ہے لیکن ان کلیات  کو دیکھ کر یہ کہنا ممکن نہیں ہو گا کہ قدرتی لوگارتھم ان میں کتنا  ٹھیک بیٹھتا ہے۔ ہم مساوات \حوالہ{مساوات_سوال_ماورائی_لوگارتھم} میں سے ضد تفرق 
\begin{align*}
...
\begin{enumerate}[a.]
\item
وقفہ \عددی{0\le x\le 50} پر \عددی{k=\mp1, \mp 0.5,\mp 0.1, \mp 0.05} کے لیے \عددی{f(x)=\tfrac{x^k-1}{k}}  ترسیم کریں۔ ان کے ساتھ \عددی{\ln x} بھی ترسیم کریں۔
\item
درج ذیل دکھائیں۔
\begin{align*}
...
\انتہا{سوالات}
%====================
%sec 7.6 questions end here
%sec 7.6 questions end here


\حصہ{اضافی شرح نمو}\شناخت{حصہ_ماورائی_اضافی_شرح_نمو}
اس حصہ میں \عددی{x} کی بڑی  قیمتوں کے لئے  \عددی{x} کے تفاعل کی شرح تبدیلی پر غور کیا جائے گا۔ ہم ان تفاعل پر غور کریں گے جو \عددی{x\to \infty} کرنے سے آخر کار مثبت ہو کر مثبت ہی رہتے ہیں۔ 

\جزوحصہء{اضافی شرح نمو}
آپ نے دیکھا ہو گا کہ  متغیر  \عددی{x} بڑھانے سے کثیررکنی اور ناطق تفاعل (جنہیں ہم نے باب \حوالہ{باب_تفرق_کا_استعمال} میں ترسیم کیا تھا) کے لحاظ سے قوت نما تفاعل، مثلاً \عددی{2^x} اور \عددی{e^x}، زیادہ تیزی سے بڑھتے  نظر آتے ہیں۔ قوت نما تفاعل یقیناً \عددی{x} کے لحاظ سے زیادہ تیزی سے بڑھتے ہیں اور آپ شکل \حوالہ{شکل_ماورائی_قوت_نما_اور_دیگر_تفاعل} میں دیکھ سکتے ہیں کہ \عددی{x} بڑھانے سے \عددی{x^2} کے لحاظ سے  \عددی{2^x}  زیادہ تیزی سے بڑھتا ہے۔ درحقیقت \عددی{x\to \infty} کرنے سے تفاعل \عددی{2^x} اور \عددی{e^x} کے بڑھنے کی شرح، \عددی{x} کی کسی بھی طاقت (مثلاً \عددی{x^{\num{1000000}}}) کے بڑھنے کی شرح سے زیادہ ہو گی (سوال \حوالہ{سوال_ماورائی_قوت_نمائی_کثیر_رکنی_سے_تیز})۔
\begin{figure}
\centering
\begin{minipage}{0.45\textwidth}
\centering
...
متغیر \عددی{x} بڑھاتے ہوئے تفاعل \عددی{y=e^x} کے بڑھنے کی شرح کو سمجھنے کی خاطر تصور کریں کہ آپ اس تفاعل کو ترسیم کرتے ہیں جہاں محور کا پیمانہ  \عددی{\SI{1}{\centi\meter}} ہے۔یوں \عددی{x=\SI{1}{\centi\meter}} پر \عددی{y=e^1\approx \SI{3}{\centi\meter}} ہو گا۔ یوں \عددی{x=\SI{6}{\centi\meter}} پر \عددی{y=e^6\approx\SI{403}{\centi\meter}} یعنی تقریباً \عددی{4} میٹر ہو گا جو  تقریباً کمرے کی چھت کے برابر ہو گا۔اسی طرح \عددی{x=\SI{10}{\centi\meter}} پر
 \عددی{y=e^{10}\approx \SI{22026}{\centi\meter}} یعنی \عددی{\SI{220}{\meter}} ہو گا جو شہر کی  زیادہ تر عمارتوں سے زیادہ بلند ہو گا۔ اگر \عددی{x=\SI{24}{\centi\meter}} ہو تب \عددی{y} چاند تک آدھے فاصلہ سے زیادہ طے کر چکا ہو گا اور \عددی{x=\SI{24}{\centi\meter}} پر ترسیم اتنا بلند ہو گا کہ سورج کے قریب ترین  ستارہ ، \قول{پروکسیما سنتوری} جو ایک سرخ بونا ہے،  سے زیادہ دور  پہنچ پائے گا۔
\begin{align*}
e^{43}&\approx \SI{4.73e18}{\centi\meter}\\
&=\SI{4.73e13}{\kilo\meter}\\
&\approx \text{\RL{$\,5\,$ نوری سال}}&&\text{\RL{خلا میں شعاع کی رفتار تقریباً $\,\SI{3e8}{\meter\per\second} \,$ ہے}}
\end{align*} 

سورج سے پروکسیما سنتوری تک  فاصلہ تقریباً \عددی{4.22}  نوری سال ہے۔اس کے باوجود محور \عددی{x} پر آپ مبدا سے صرف \عددی{\SI{43}{\centi\meter}} یعنی دو فٹ  فاصلہ پر ہوں گے۔

اس کے برعکس \عددی{x\to\infty} کرنے سے لوگارتھمی تفاعل \عددی{y=\log_2x} اور \عددی{y=\ln x} کے بڑھنے کی شرح \عددی{x} کے کسی بھی مثبت طاقت کے بڑھنے کی شرح سے کم ہو گی (سوال \حوالہ{سوال_ماورائی_لوگارتھم_سب_سے_آہستہ})۔یوں   محور کا پیمانہ \عددی{\SI{1}{\centi\meter}} لیتے ہوئے،  \عددی{y=\ln x} کی ترسیم پر  مبدا سے صرف \عددی{\SI{43}{\centi\meter}} بلندی تک پہنچنے کی خاطر آپ کو محور \عددی{x} پر \عددی{5} نوری سال دور جانا ہو گا (شکل \حوالہ{شکل_ماورائی_قوت_نما_اور_لوگارتھمی_تفاعل})۔

قوت نما، کثیررکنی ، اور لوگارتھمی تفاعل کا ایک دوسرے کے ساتھ مذکورہ بالا موازنے  کو زیادہ درستگی سے بیان کرنے کی خاطر ہم ایک تعریف پیش کرتے ہیں۔جب ہم کہتے ہیں کہ \عددی{x\to \infty} کرنے سے کسی بھی تفاعل \عددی{g(x)} کے بڑھنے کی شرح سے  تفاعل \عددی{f(x)} کے بڑھنے کی شرح زیادہ ہے تب اس سے مراد درج ذیل ہو گا۔

\ابتدا{تعریف}\موٹا{\عددی{x\to \infty} کرتے ہوئے بڑھنے کی شرح}\\
فرض کریں کافی بڑے \عددی{x} کے لیے \عددی{f(x)} اور \عددی{g(x)} مثبت ہیں۔
\begin{enumerate}[a.]
\item
اگر 
\begin{align*}
...
ان تعریفات کے تحت  تفاعل \عددی{y=2x} تفاعل \عددی{y=x}  کے مقابلے میں زیادہ تیزی سے نہیں بڑھتا۔ اس کی وجہ 
\begin{align*}
\lim_{x\to\infty}\frac{2x}{x}=\lim_{x\to \infty}2=2
\end{align*}
ہے  جو غیر صفر اور متناہی حد ہے۔ زیادہ تیزی سے بڑھنے کے   سادہ عمومی مطلب کو ہم اس لیے نظر انداز  کرتے ہیں کہ جب ہم کہیں کہ \قول{\عددی{x} کی بڑی قیمتوں کے لیے \عددی{f} کے بڑھنے کی شرح \عددی{g} کے بڑھنے کی شرح سے زیادہ ہے } تب اس سے مراد \قول{\عددی{x} کی بڑی قیمتوں کے لیے \عددی{f} کے لحاظ سے \عددی{g} کی قیمت قابل نظر انداز ہے،} لینا چاہیے۔

\ابتدا{مثال}
\عددی{x\to\infty} کرتے ہوئے \عددی{x^2} کے مقابلے   میں \عددی{e^x} کی   زیادہ تیزی سے بڑھنے  کی وجہ درج ذیل  ہے۔
\begin{align*}
...
%===================
\ابتدا{مثال}
(ا) \عددی{x\to \infty} کرتے ہوئے \عددی{2^x} کے مقابلے میں، درج ذیل وجہ سے،   \عددی{3^x} زیادہ تیزی سے بڑھتا ہے۔
\begin{align*}
\lim_{x\to \infty}\frac{3^x}{2^x}=\lim_{x\to \infty}\big(\frac{3}{2}\big)^x=\infty
\end{align*}
(ب) \عددی{x\to\infty} کرتے ہوئے مختلف اساس کے قوت نما تفاعل کبھی بھی ایک  ہی شرح  سے نہیں بڑھتے۔اگر \عددی{a>b>0} ہو تب \عددی{a^x} کے بڑھنے کی شرح \عددی{b^x} کے بڑھنے کی شرح سے زیادہ ہو گی۔
\begin{align*}
...
%=============
\ابتدا{مثال}
\عددی{x\to\infty} کرتے ہوئے \عددی{x^2} کے بڑھنے کی شرح، درج ذیل وجہ سے،  \عددی{\ln x} کے بڑھنے کی شرح سے زیادہ ہو گی۔
\begin{align*}
...
%================
\ابتدا{مثال}
\عددی{x\to\infty} کرنے سے \عددی{\ln x} کے بڑھنے کی شرح، درج ذیل وجہ سے،  \عددی{x} کے بڑھنے کی شرح سے کم ہو گی۔
\begin{align*}
...
%================
\ابتدا{مثال}
قوت نما تفاعل کے برعکس \عددی{x\to\infty} کرتے ہوئے مختلف اساس کے لوگارتھمی تفاعل، درج ذیل وجہ سے،  ایک ہی   شرح سے بڑھتے  ہیں۔
\begin{align*}
...
اگر \عددی{x\to\infty} کرتے ہوئے \عددی{f} کے بڑھنے کی شرح اور \عددی{g} کے بڑھنے کی شرح  برابر ہو، اور \عددی{x\to\infty} کرتے ہوئے \عددی{gf} کے بڑھنے کی شرح اور \عددی{h} کے بڑھنے کی شرح   برابر ہو، تب \عددی{x\to \infty} کرتے ہوئے \عددی{f} اور \عددی{h} کے بڑھنے کی شرح   برابر ہو گی۔ اس کی وجہ
\begin{align*}
...
\ابتدا{مثال}
دکھائیں کہ \عددی{x\to\infty} کرتے ہوئے \عددی{\sqrt{x^2+5}} اور \عددی{(2\sqrt{x}-1)^2} کے بڑھنے کی شرح  برابر ہے۔

\حل
ہم دکھاتے ہیں کہ دونوں تفاعلات کے بڑھنے کی شرح وہی ہے جو تفاعل \عددی{x} کی ہے۔
\begin{align*}
...
\end{align*}
یوں دونوں تفاعل کے بڑھنے کی شرح  برابر ہے۔
\انتہا{مثال}
%=======================

\جزوحصہء{رتبہ اور$\, O\,$علامتیت}
بڑے \عددی{O} اور چھوٹے \عددی{o} کی علامت کمپیوٹر سائنس اور ریاضیاتی تجزیہ  میں عام استعمال ہوتی ہے۔ انہیں یہاں متعارف کیا جاتا ہے۔

\ابتدا{تعریف}
اگر \عددی{   x\to\infty} کرتے ہوئے \عددی{\lim_{x\to \infty}\frac{f(x)}{g(x)}=0} ہو  , ہم کہتے ہیں \موٹا{\عددی{f} کا رتبہ \عددی{g} سے کم ہے } اور اس  کو \عددی{f=o(g)}  سے ظاہر کرتے ہیں۔ہم  اس کو \قول{\عددی{f}، \عددی{g} کا چھوٹا \عددی{o} ہے} پڑھتے ہیں۔ 
\انتہا{تعریف}
%===================

یوں \عددی{x\to \infty} کرتے ہوئے \عددی{f=o(g)}  سے مراد \عددی{x\to \infty} کرتے ہوئے \عددی{f} کے بڑھنے کی شرح \عددی{g}  کے مقابلے میں کم ہے۔
...
%===================
\ابتدا{تعریف}
فرض کریں کافی بڑے \عددی{x} پر \عددی{f(x)} اور \عددی{g(x)} مثبت ہیں۔ تب کافی بڑے  \عددی{x} پر اگر کسی مثبت عدد صحیح \عددی{M} کے لیے
\begin{align*}
\frac{f(x)}{g(x)}\le M
\end{align*}
ہو تب \عددی{x\to\infty} پر\قول{\عددی{f} کا رتبہ زیادہ سے زیادہ \عددی{g} کے رتبے جتنا } ہو گا۔ اس کو ہم \عددی{f=O(g)} سے ظاہر کرتے ہیں جس
 کو \قول{\عددی{f}، \عددی{g} کا بڑا \عددی{O} ہے}  پڑھا جاتا ہے۔
\انتہا{تعریف}
%=====================

\ابتدا{مثال}
چونکہ کافی بڑے \عددی{x} کے لیے \عددی{\frac{x+\sin x}{x}\le 2} ہے لہٰذا \عددی{x\to \infty} پر \عددی{x+\sin x=O(x)} ہو گا۔
\انتہا{مثال}
%=====================
\ابتدا{مثال}
\عددی{x\to\infty} پر \عددی{\frac{e^x+x^2}{e^x}\to 1}  کی وجہ سے \عددی{x\to\infty} پر \عددی{e^x+x^2=O(e^x)} ہو گا۔ اسی طرح 
\عددی{x\to\infty} پر \عددی{\frac{x}{e^x}\to 0}  کی وجہ سے \عددی{x\to\infty} پر \عددی{x=O(e^x)} ہو گا۔
\انتہا{مثال}
%=====================

تعریفات  پر دوبارہ نظر دوڑاتے ہوئے  آپ دیکھیں گے کہ کافی بڑے \عددی{x} پر مثبت تفاعل کے لیے  \عددی{f=o(g)}سے مراد \عددی{f=O(g)} ہے۔ اس کے علاوہ اگر \عددی{f} اور \عددی{g}  کے بڑھنے کی شرح  برابر  ہو تب \عددی{f=O(g)} اور \عددی{g=O(f)} ہوں گے (سوال \حوالہ{سوال_ماورائی_ایک_برابر_شرح})۔ 

\جزوحصہ{ترتیبی اور ثنائی تلاش}
کمپیوٹر کسی لائحہ کار کے تحت قدم بہ قدم چل کر  کام سر انجام دیتا ہے۔اس لائحہ کار کو \اصطلاح{کمپیوٹر الخوارزم}\فرہنگ{الخوارزم!کمپیوٹر}\حاشیہب{computer algorithm}\فرہنگ{algorithm} کہتے ہیں۔اس لائحہ کار کی کارگزاری جاننے کی خاطر ماہرین عموماً اس کام کو سرانجام کرنے کے لیے درکار قدموں کی گنتی کرتے ہیں۔ ایک ہی کام سرانجام دینے والے  دو مختلف لائحہ کار کی کارگزاری میں بہت زیادہ فرق ہو سکتا ہے جنہیں بڑے \عددی{O} علامتی روپ میں پیش کیا جاتا ہے۔ آئیں ایک مثال دیکھتے ہیں۔

ایک لغت میں کسی ایک حرف سے شروع ہونے والے الفاظ کی تعداد  \عددی{\num{26000}} ہے۔ آپ اس حرف سے شروع ہونے والے ایک لفظ کو دو طریقوں سے تلاش کر سکتے ہیں۔ پہلی ترکیب میں آپ پہلے لفظ سے شروع کرتے ہوئے  ایک ایک لفظ پڑھ کر درکار لفظ تک پہنچتے ہیں۔ اس ترکیب کو \اصطلاح{ترتیبی تلاش}\فرہنگ{تلاش!ترتیبی}\حاشیہب{sequential search}\فرہنگ{search!sequential} کہتے ہیں،  جو لغت میں ترتیب سے الفاظ لکھے گئے ہونے سے استفادہ نہیں کرتی۔ اس ترتیب میں آپ ہر صورت لفظ تلاش کر پائیں گے (یا جان جائیں گے کہ یہ لفظ لغت میں موجود نہیں) لیکن عین ممکن ہے کہ آپ کو \عددی{\num{26000}} قدم چلنا پڑے۔

اس سے بہتر ترکیب میں آپ لغت کے عین وسط (ایک دو الفاظ آگے پیچھے ہو سکتے ہیں) میں ایک لفظ کو دیکھتے ہیں۔ چونکہ لغت میں الفاظ ترتیب سے ہیں لہٰذا آپ معلوم کر پائیں گے کہ آیا درکار لفظ پہلے  نصف یا دوسرے  نصف  میں ہے۔ لغت کے اس نصف حصے کو رد کریں جس میں لفظ موجود نہیں۔یوں پہلے قدم میں \عددی{\num{13000}} الفاظ سے چھٹکارا حاصل ہوتا ہے۔  اب منتخب حصے  کے وسط  میں جا کر دیکھیں کہ درکار لفظ کس جانب پایا جاتا ہے۔ یوں دوسرے قدم میں \عددی{6500} الفاظ سے چھٹکارا حاصل ہوتا ہے۔ اسی طرح ہر قدم پر آدھے حصے کو رد کرتے ہوئے چلتے جائیں جب تک آپ درکار لفظ تلاش نہیں کر پاتے یا الفاظ ختم نہیں ہو جاتے۔ چونکہ
\begin{align*}
\frac{26000}{2^{15}}<1
\end{align*}
ہوتا ہے لہٰذا  آپ کو زیادہ سے زیادہ \عددی{15} قدم چل کر درکار لفظ مل جائے گا یا آپ جان جائیں گے کہ یہ لفظ لغت میں موجود نہیں۔ اس ترتیب کو \اصطلاح{ثنائی!تلاش}\فرہنگ{ثنائی تلاش}\حاشیہب{binary search}\فرہنگ{search!binary} کہتے ہیں۔

ایک سلسلہ ، جس کی لمبائی \عددی{n} ہو ،  میں کسی جزو کی تلاش کے لیے ترتیبی تلاش کو \عددی{n} قدم درکار ہو سکتے ہیں۔ اس کے برعکس ثنائی تلاش استعمال کرتے ہوئے  اگر  \عددی{2^{m-1}<n\le 2^m}  ہو تب \عددی{m-1<\log_2n\le m} ہو گا اور ایک لفظ تک پہنچنے کی خاطر زیادہ سے زیادہ \عددی{m=\lceil\log_2n\rceil} (\عددی{\log_2n} کا عدد صحیح چھت تفاعل)   مرتبہ  دو حصوں میں تقسیم  کرنے کی ضرورت پیش آئے گی۔ یوں ثنائی تلاش میں  \عددی{\log_2 n} کے لگ بھگ  قدم درکار ہوں گے۔ 

بڑے \عددی{O} روپ میں اس تمام کو نہایت خوش اسلوبی سے ظاہر کیا جا سکتا ہے۔ ترتیبی سلسلہ میں ترتیبی تلاش کو \عددی{O(n)} کے لگ بھگ قدم درکار ہوں گے جبکہ ثنائی تلاش کو \عددی{O(\log_2n)} کے لگ بھگ قدم درکار ہوں گے۔ ہماری مثال میں ان  دونوں میں بہت زیادہ فرق پایا جاتا ہے (\عددی{\num{26000}} بالمقابل \عددی{15}) اور چونکہ \عددی{n\to \infty} کرتے ہوئے \عددی{\log_2n} کے لحاظ سے \عددی{n} زیادہ تیزی سے بڑھتا ہے لہٰذا \عددی{n} بڑھانے سے یہ فرق زیادہ بڑھے گا۔


%sec 7.7 questions start here
%sec 7.7 questions start here
...
\ابتدا{سوال}
\عددی{x\to\infty} کرتے ہوئے درج ذیل میں سے کون سا تفاعل \عددی{e^x}  کے مقابلے میں  زیادہ تیزی سے بڑھتا ہے؟ کون سا \عددی{e^x} کی شرح سے بڑھتا ہے؟  کون سا \عددی{e^x}  کے مقابلے میں  کم تیزی سے بڑھتا ہے؟
\begin{multicols}{4}
\begin{enumerate}[a.]
\item
$x+3$
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) آہستہ (ب) آہستہ (ج) آہستہ (د) تیز (ہ) آہستہ  (و) آہستہ\\
 (ز) ایک سا (ح) آہستہ
}}
\انتہا{جواب}
%======================
...
\ابتدا{سوال}
\عددی{x\to\infty} کرتے ہوئے درج ذیل میں سے کون سا تفاعل \عددی{x^2} کے مقابلے میں زیادہ تیزی سے بڑھتا ہے؟ کون سا \عددی{x^2} کی شرح سے بڑھتا ہے؟  کون سا \عددی{x^2} کے مقابلے میں کم تیزی سے بڑھتا ہے؟
\begin{multicols}{4}
\begin{enumerate}[a.]
\item
$x^2+4x$
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) ایک سا (ب) تیز (ج) ایک سا  (د) ایک سا (ہ) آہستہ \\
(و) تیز (ز) آہستہ (ح) ایک سا
}}
\انتہا{جواب}
%======================
\ابتدا{سوال}
...
\ابتدا{سوال}
\عددی{x\to\infty} کرتے ہوئے درج ذیل میں سے کون سا تفاعل \عددی{\ln x} کے مقابلے میں زیادہ تیزی سے بڑھتا ہے؟ کون سا \عددی{\ln x} کی شرح سے بڑھتا ہے؟  کون سا \عددی{\ln x} کے مقابلے میں کم تیزی سے بڑھتا ہے؟
\begin{multicols}{4}
\begin{enumerate}[a.]
\item
$\log_3x$
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) ایک سا (ب) ایک سا (ج) ایک سا(د) تیز \\
(ہ) تیز (و) ایک سا (ز) آہستہ (ح) تیز 
}}
\انتہا{جواب}
%======================
\ابتدا{سوال}
...
\انتہا{سوال}
%======================
\موٹا{تفاعلات کو شرح نمو کے لحاظ سے ترتیب دینا}
...
\ابتدا{سوال}
\عددی{x\to\infty} کرتے ہوئے کون سا درست اور کون سا غلط ہے؟
\begin{multicols}{3}
\begin{enumerate}[a.]
\item
$x=o(x)$
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) غلط (ب) غلط (ج) درست (د) درست\\
 (ہ) درست (و) درست (ز) غلط (ح) درست
}}
\انتہا{جواب}
%============
\ابتدا{سوال}
...
%======================
\ابتدا{سوال}
\عددی{x\to \infty} کرتے ہوئے کب کثیررکنی \عددی{f(x)} کا رتبہ کثیررکنی \عددی{g(x)} کے رتبے سے کم ہو گا؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
%===================
\ابتدا{سوال}
\عددی{x\to \infty} کرتے ہوئے کب کثیررکنی \عددی{f(x)} کا رتبہ زیادہ سے زیادہ کثیررکنی \عددی{g(x)} کے رتبے  کے برابر ہو گا؟ اپنے جواب کی وجہ پیش
 کریں۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
موجودہ حصے  میں پیش کی گئی تعریفات  کو زیادہ عمومی بنانے کی خاطر ہم اس میں \عددی{x\to\infty} کی پابندی ختم کر کے اس  کے بجائے \عددی{x\to a} پر حد لیتے ہیں ، جہاں \عددی{a} حقیقی عدد ہے۔ دکھائیں کہ قاعدہ سمسن سے حاصل قطعی تکمل کی تخمین میں \عددی{h\to 0} کرتے ہوئے خلل \عددی{O(h^4)} ہو گا ، جبکہ قاعدہ ذوزنقہ سے حاصل تخمین میں خلل \عددی{O(h^2)} ہو گا۔ یوں ان دو تراکیب کے نتائج کی درستگی کو اس طرح بھی بیان کیا جا سکتا ہے۔  
\انتہا{سوال}
%===================
\موٹا{دیگر موازنے}

\ابتدا{سوال}
ناطق تفاعل کی حدوں کے بارے میں حصہ \حوالہ{حصہ_استعمال_تفرق_حد_متقارب_اور_غالب_اجزاء} میں حاصل نتیجہ ہمیں \عددی{x\to \infty} کی صورت میں کثیررکنی کی اضافی  شرح نمو کے بارے میں کیا بتاتا ہے؟\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\end{align*}
(ب) دکھائیں کہ درج ذیل کی قیمت ، مستقل\عددی{a} کی قیمت پر منحصر نہیں۔ اس سے تفاعل \عددی{f(x)=\ln(x+a)} اور \عددی{g(x)=\ln x} کی اضافی شرح نمو کے بارے میں کیا کہا جا سکتا ہے؟
\begin{align*}
...
%=============================
\ابتدا{سوال}
دکھائیں کہ \عددی{x\to \infty} کرتے ہوئے \عددی{\sqrt{10x+1}} اور \عددی{\sqrt{x+1}} کی شرح نمو   برابر ہیں۔ یہ دکھانے کی خاطر دکھائیں کہ دونوں تفاعل کی شرح نمو تفاعل \عددی{\sqrt{x}} کی  شرح نمو کے برابر ہے۔ 
\انتہا{سوال}
%====================
\ابتدا{سوال}
دکھائیں کہ \عددی{x\to \infty} کرتے ہوئے \عددی{\sqrt{x^4+x}} اور \عددی{\sqrt{x^4-x^3}} کی شرح نمو   برابر ہیں۔ یہ دکھانے کی خاطر دکھائیں کہ دونوں تفاعل کی شرح نمو تفاعل \عددی{x^2} کی  شرح نمو کے برابر ہے۔ 
\انتہا{سوال}
%====================
\ابتدا{سوال}\شناخت{سوال_ماورائی_قوت_نمائی_کثیر_رکنی_سے_تیز}
دکھائیں کہ \عددی{x\to \infty} کرتے ہوئے \عددی{e^x} کی شرح نمو کسی بھی \عددی{x^n} کی  شرح نمو سے زیادہ ہو گی، جہاں \عددی{n} کوئی بھی مثبت عدد صحیح ہو سکتا ہے، مثلاً \عددی{x^{\num{1000000}}}۔ (اشارہ۔ \عددی{x^n} کا \عددی{n} واں تفرق کیا ہے؟)
\انتہا{سوال}
%=================
\ابتدا{سوال}\ترچھا{تفاعل \عددی{e^x} ہر کثیررکنی سے زیادہ تیزی سے بڑھتا ہے}\\
دکھائیں کہ \عددی{x\to\infty} کرتے ہوئے \عددی{e^x} کسی بھی کثیررکنی \عددی{a_nx^n+a_{n-1}x^{n-1}+\cdots+a_1x+a_0} سے زیادہ تیزی سے بڑھتا ہے۔
\انتہا{سوال}
%====================
...
\item
اگرچہ \عددی{x^{1/\num{1000000}}} کی قیمت آخر کار \عددی{\ln x} کی قیمت سے زیادہ ہو گی، وہاں تک پہنچنے کے لیے آپ کو محور \عددی{x} پر بہت دور جانا ہو گا۔ ایسا \عددی{x>1} تلاش کریں جس پر \عددی{x^{1/{\num{1000000}}}>\ln x} ہو۔ دھیان رہے کہ \عددی{x>1} کی صورت میں مساوات \عددی{\ln x=x^{1/\num{1000000}}} کو \عددی{\ln(\ln x)=\tfrac{\ln x}{\num{1000000}}} بھی لکھا جا سکتا ہے۔
\item
تفاعل \عددی{x^{1/10}} کو بھی \عددی{\ln x} سے بڑھنے  کے لیے  بہت وقت درکار ہو گا۔ کیلکولیٹر استعمال کرتے ہوئے \عددی{x} کی وہ قیمت تلاش کریں جس پر \عددی{x^{1/10}} کی ترسیم \عددی{\ln x} کی ترسیم کو قطع  کرتی ہو یا جہاں \عددی{\ln x=10\ln(\ln x)} ہو۔نقطہ تقاطع  کے مقام کی نشاندہی   دو قریبی  \عددی{10} کی طاقتوں کے بیچ    کر کے   وقفے کو  بار بار آدھا کرتے ہوئے   مقام تک پہنچنے کی کوشش کریں۔
\item
اس  نقطے   کی پڑوس میں، جس پر \عددی{\ln x=10\ln(\ln x)} ہو ،  دونوں  مساوات  کو کمپیوٹر پر ترسیم کر کے  نقطہ تقاطع \عددی{x} تلاش کریں۔
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\انتہا{جواب}
%===================
\ابتدا{سوال}\ترچھا{تفاعل \عددی{\ln x} کی شرح نمو ہر کثیررکنی سے کم ہے}\\
دکھائیں کہ \عددی{x\to\infty} کرتے ہوئے \عددی{\ln x} کی شرح نمو کسی بھی غیر مستقل کثیررکنی سے کم ہو گی۔
\انتہا{سوال}
%===================
\موٹا{الخوارزم اور تلاش}\\

\ابتدا{سوال}\شناخت{سوال_ماورائی_تلاش_کی_قدمیں}
(ا) آپ کمپیوٹر کی مدد سے ایک کام سرانجام دینا چاہتے ہیں۔ آپ کے پاس تین الخوارزم موجود ہیں جن  کے لیے کمپیوٹر کو درکار   قدموں کی تعداد  درج ذیل تفاعل دیتے ہیں۔ \عددی{n} کی بڑی قیمت کی صورت میں ان میں سے کون سا الخوارزم سب سے بہتر  ہے؟ اپنے جواب کی وجہ پیش کریں۔
\begin{align*}
n\log_2n,\quad n^{3/2},\quad n(\log_2n)^2
\end{align*}
(ب) جزو-الف میں دیے گئے تفاعل کو ایک ساتھ ترسیم کرتے ہوئے دیکھیں کون سا زیادہ تیزی سے بڑھتا ہے۔\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%====================
\ابتدا{سوال}
درج ذیل تفاعل کے لیے سوال \حوالہ{سوال_ماورائی_تلاش_کی_قدمیں} کو دہرائیں۔
\begin{align*}
...
%=====================
\ابتدا{سوال}
ایک مرتب سلسلہ،  جس میں دس لاکھ اجزاء پائے جاتے ہیں ، میں سے آپ کو ایک جزو تلاش کرنا ہے۔ ترتیبی تلاش کے لیے کتنے قدم درکار ہوں گے؟ ثنائی تلاش کے لیے کتنے قدم درکار ہوں گے؟\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%sec 7.7 questions end here
%sec 7.7 questions end here


\حصہ{معکوس تکونیاتی تفاعلات}\شناخت{حصہ_ماورائی_الٹ_تکونیاتی_تفاعل}
معکوس تکونی تفاعلات کی ضرورت اس وقت پیش آتی ہے جب ہم مثلث کے ضلع کو ناپ کر زاویہ تلاش کرنا چاہتے ہیں۔ یہ تفاعل اہم ضد تفرق بھی مہیا کرتے ہیں اور تفرقی مساوات کے حل میں عموماً پائے جاتے ہیں۔ اس حصہ میں ان تفاعلات کی تعریف پیش کی جائے گی، ان کو ترسیم کرنا سکھایا جائے گا،  اور ان کی قیمت حاصل کرنا سکھایا جائے گا۔

\جزوحصہء{معکوس تکونیاتی تفاعلات   کی تعریف}
چھ بنیادی تکونیاتی تفاعل کی قیمتیں (بار بار)  دہراتی ہیں ، لہٰذا یہ یک بہ یک تفاعل نہیں،  البتہ ان کے دائرہ کار کو ایسے وقفوں پر پابند کیا جا سکتا ہے جہاں یہ یک بہ یک ہوں (جدول \حوالہ{جدول_ماورائی_تکونیاتی_تفاعل_ایک_ایک})۔
\begin{table}
\caption{تکونیاتی تفاعل کو یک بہ یک بنانے کی خاطر دائرہ کار کو پابند کیا گیا ہے۔}
...
چونکہ پابند دائرہ کار والے تکونیاتی تفاعل یک بہ یک ہیں لہٰذا ان کے معکوس پائے جاتے ہیں جنہیں ظاہر کرنے کا طریقہ درج ذیل ہے۔
\begin{align*}
y&=\sin^{-1}x\\
y&=\cos^{-1}x\\
y&=\tan^{-1}x\\
...
y&=\csc^{-1}x
\end{align*}
ہم کہیں گے \قول{\عددی{x} کا معکوس سائن ، \عددی{y} کے برابر ہے}  (یعنی \عددی{x} کے معکوس سائن کی قیمت \عددی{y} کے برابر ہو گی)، وغیرہ۔ یاد رہے کہ ان معکوس تفاعل میں \عددی{-1} سے مراد معکوس تفاعل ہے  لہٰذا اس کو ہرگز مقلوب تصور نہ  کیا جائے۔ مثال کے طور پر \عددی{\sin x} کا مقلوب \عددی{(\sin x)^{-1}=\tfrac{1}{\sin x}=\csc x} ہو گا۔

معکوس تکونیاتی تفاعل کے دائرہ کار یوں منتخب کیے جاتے ہیں کہ درج ذیل مطمئن ہوں۔
\begin{align}
...
ان تعلقات کو استعمال کر کے \عددی{\cos^{-1}x}، \عددی{\sin^{-1}x} ، اور \عددی{\tan^{-1}x} کی قیمتیں جانتے ہوئے ہم بالترتیب \عددی{\sec^{-1}x}، \عددی{\csc^{-1}x} ، اور \عددی{\cot^{-1}x} کی قیمتیں معلوم کر سکتے ہیں۔ جیسا آگے چند مثالوں میں دکھایا گیا ہے، قائمہ مثلث استعمال کر کے \عددی{\cos^{-1}x}، \عددی{\sin^{-1}x} ، اور \عددی{\tan^{-1}x} کی چند قیمتیں حاصل کی جا سکتی ہیں۔

\جزوحصہء{معکوس سائن اور معکوس کوسائن}
 متغیر \عددی{x} کے معکوس سائن یعنی \عددی{\sin^{-1}x} سے مراد وہ زاویہ ہے جس کے سائن  کی قیمت \عددی{x} کے برابر ہوگی۔ اسی طرح \عددی{\cos^{-1}x} سے مراد وہ زاویہ ہے جس کے کوسائن کی قیمت \عددی{x} ہوگی۔

\ابتدا{تعریف}
\عددی{y=\sin^{-1}x} سے مراد وقفہ \عددی{[-\pi/2,\pi/2]} میں وہ عدد \عددی{y} ہے جس کے لیے \عددی{\sin y=x} ہو۔ اسی طرح 
\عددی{y=\cos^{-1}x} سے مراد وقفہ \عددی{[0,\pi]} میں وہ عدد \عددی{y} ہے جس کے لیے \عددی{\cos y=x} ہو۔
\انتہا{تعریف}
%=============

تفاعل \عددی{y=\sin^{-1}x} (شکل \حوالہ{شکل_ماورائی_سائن_اور_الٹ_سائن}) کی ترسیم مبدا کے لحاظ سے تشاکلی ہے (اور عین \عددی{x=\sin y} کی ترسیم پر پائی جاتی ہے)۔ یوں معکوس سائن  ایک طاق تفاعل ہے۔
\begin{align}\label{مساوات_ماورائی_الٹ_سائن_تعلق}
\sin^{-1}(-x)&=-\sin^{-1}x &&\text{\RL{طاق تفاعل}}
\end{align}
تفاعل \عددی{y=\cos^{-1}x} (شکل \حوالہ{شکل_ماورائی_کوسائن_اور_الٹ_کوسائن}) کی ترسیم میں ایسا  کوئی تشاکل نہیں پایا جاتا۔
\begin{figure}
\centering
\begin{subfigure}{0.45\textwidth}
\centering
...
\end{subfigure}
\caption{
ترسیمات برائے (ا) \عددی{y=\sin x,\,-\pi/2\le x\le \pi/2}  اور (ب)  معکوس سائن تفاعل \عددی{y=\sin^{-1}x}؛ لکیر \عددی{y=x} میں عکس \عددی{\sin^{-1}x} درحقیقت قوس \عددی{x=\sin y} کا کچھ حصہ ہے۔
}
...
\end{subfigure}
\caption{
ترسیمات برائے (ا) \عددی{y=\cos x,\,0\le x\le \pi}  اور (ب) معکوس کوسائن تفاعل \عددی{y=\cos^{-1}x}؛ لکیر \عددی{y=x} میں عکس \عددی{\cos^{-1}x} درحقیقت قوس \عددی{x=\cos y} کا کچھ حصہ ہے۔
}
...
\end{tikzpicture}
\end{subfigure}
\caption{سائن اور معکوس سائن کی مخصوص قیمتیں (مثال \حوالہ{مثال_ماورائی_سائن_مخصوص_قیمتیں})۔}
\label{شکل_مثال_ماورائی_سائن_مخصوص_قیمتیں}
\end{figure}

معکوس سائن کی مخصوص قیمتوں کو قائمہ مثلث سے شکل \حوالہ{مثال_ماورائی_سائن_مخصوص_قیمتیں} میں حاصل کرنا دکھایا گیا ہے۔ اس طرح درج ذیل دیگر قیمتیں بھی حاصل کی جا سکتی ہیں۔ یاد رہے کہ \عددی{\sin^{-1}x} کی سعت \عددی{[-\tfrac{\pi}{2},\tfrac{\pi}{2}]} ہے  لہٰذا زاویے ربع اول اور ربع چہارم میں پائے جائیں گے۔
\begin{align*}
\renewcommand{\arraystretch}{2} 
...
\end{tikzpicture}
\end{subfigure}
\caption{کوسائن اور معکوس سائن کی مخصوص قیمتیں (مثال \حوالہ{مثال_ماورائی_کوسائن_مخصوص_قیمتیں})۔}
\label{شکل_مثال_ماورائی_کوسائن_مخصوص_قیمتیں}
\end{figure}

معکوس کوسائن کی مخصوص قیمتوں کو قائمہ مثلث سے شکل \حوالہ{مثال_ماورائی_کوسائن_مخصوص_قیمتیں} میں حاصل کرنا دکھایا گیا ہے۔ اس طرح درج ذیل دیگر قیمتیں بھی حاصل کی جا سکتی ہیں۔ یاد رہے کہ \عددی{\cos^{-1}x} کی سعت \عددی{[0,\pi]} ہے  لہٰذا زاویے ربع اول اور ربع دوم میں پائے جائیں گے۔
\begin{align*}
\renewcommand{\arraystretch}{2} 
\begin{array}{c|cccccc}
x&\tfrac{\sqrt{3}}{2}&\tfrac{\sqrt{2}}{2}&\tfrac{1}{2}&-\tfrac{1}{2}&-\tfrac{\sqrt{2}}{2}&-\tfrac{\sqrt{3}}{2}\\
...
\انتہا{مثال}
%=====================
\جزوحصہء{ایسے مماثل جن میں معکوس سائن اور معکوس کوسائن پائے جاتے ہوں}
ہم شکل \حوالہ{شکل_ماورائی_کوسائن_اور_الٹ_کوسائن_تعلق} میں دیکھتے ہیں کہ \عددی{x} کا معکوس  کوسائن درج ذیل  مماثل
...
\end{align}
اگرچہ شکل \حوالہ{شکل_ماورائی_سائن_کوسائن_تعلق} میں دیے گئے مثلث سے یہ ثابت نہیں کیا جا سکتا   لیکن مساوات \حوالہ{مساوات_ماورائی_تماثل_ج} وقفہ \عددی{[-1,1]} میں دیگر \عددی{x} کے لیے بھی درست ہے۔ یہ حقیقت مساوات \حوالہ{مساوات_ماورائی_الٹ_سائن_تعلق} اور مساوات \حوالہ{مساوات_ماورائی_تماثل_ب} کا نتیجہ ہے (سوال \حوالہ{سوال_ماسوائے_ثبوت_مکمل_درکار})۔
\begin{figure}
\centering
\begin{minipage}{0.45\textwidth}
\centering
...
\جزوحصہء{\عددی{\tan x}، \عددی{\cot x}، \عددی{\sec x} ، اور \عددی{\csc x} کے معکوس}
متغیر \عددی{x} کا معکوس ٹینجنٹ وہ زاویہ ہو گا جس کے  ٹینجنٹ  کی قیمت \عددی{x} ہو۔ اسی طرح \عددی{x} کا معکوس کوٹینجنٹ وہ زاویہ ہو گا جس کا کوٹینجنٹ \عددی{x} ہو۔
...
ہم کھلا وقفہ لیتے ہیں  تاکہ  ان  نقطوں سے نجات حاصل کر سکیں جن پر ٹینجنٹ اور کوٹینجنٹ غیر معین ہیں۔

تفاعل \عددی{y=\tan^{-1}x} کی ترسیم تفاعل \عددی{x=\tan y} کی ترسیم، جو مبدا کے لحاظ سے تشاکلی ہے، کا کچھ حصہ  ہے ، لہٰذا یہ بھی مبدا کے لحاظ سے تشاکلی ہو گی(شکل \حوالہ{شکل_ماورائی_ترسیم_الٹ_ٹینجنٹ})۔ الجبرائی طور پر اس سے مراد 
\begin{align}
\tan^{-1}(-x)&=-\tan^{-1}x &&\text{\RL{طاق تفاعل}}
\end{align} 
ہے، یعنی، معکوس ٹینجنٹ طاق تفاعل ہے۔ تفاعل \عددی{y=\cot^{-1}x} کی ترسیم میں ایسا کوئی تشاکل نہیں پایا جاتا (شکل \حوالہ{شکل_ماورائی_ترسیم_الٹ_کوٹینجنٹ})۔
\begin{figure}
\centering
\begin{minipage}{0.45\textwidth}
\centering
...
تفاعل \عددی{\sec x} اور \عددی{\csc x} کے  پابند شدہ روپ کے معکوس کی ترسیمات کو بالترتیب شکل \حوالہ{شکل_ماورائی_ترسیم_الٹ_سیکنٹ} اور شکل \حوالہ{شکل_ماورائی_ترسیم_الٹ_کوسیکنٹ} میں دکھایا گیا ہے۔
\begin{figure}
\centering
\begin{minipage}{0.45\textwidth}
\centering
...
انتباہ: \quad
متغیر \عددی{x} کی منفی قیمتوں کے لیے \عددی{\sec^{-1}x} کی تعریف پر اتفاق نہیں پایا جاتا۔ہم ربع دوم میں \عددی{\tfrac{\pi}{2}} اور \عددی{\pi} کے بیچ زاویہ لیں گے۔ اس انتخاب کی وجہ سے \عددی{\sec^{-1}x=\cos^{-1}(1/x)} ہو گا اور \عددی{\sec^{-1}x} کے دائرہ کار کے ہر حصے  پر \عددی{\sec^{-1}x} بڑھتا ہوا تفاعل ہو گا۔

\ابتدا{مثال}\شناخت{مثال_ماورائی_کوٹینجنٹ_مخصوص_قیمتیں}\ترچھا{معکوس کوٹینجنٹ \عددی{\tan^{-1}x} کی مخصوص قیمتیں}\\
معکوس کوٹینجنٹ کی مخصوص قیمتوں کا حصول شکل \حوالہ{شکل_مثال_ماورائی_کوٹینجنٹ_مخصوص_قیمتیں} میں دکھایا گیا ہے۔ درج ذیل دیگر قیمتیں بھی اسی طرح حاصل کی جا سکتی ہیں۔
\begin{align*}
\renewcommand{\arraystretch}{2} 
\begin{array}{c|cccccc}
...
\end{tikzpicture}
\end{subfigure}
\caption{معکوس کوٹینجنٹ کی مخصوص قیمتیں (مثال \حوالہ{مثال_ماورائی_کوٹینجنٹ_مخصوص_قیمتیں})۔}
...
\حل
چونکہ \عددی{\alpha=\sin^{-1}\tfrac{2}{3}} ہے لہٰذا ہم \عددی{\alpha} کو قائمہ مثلث کا ایک زاویہ تصور کرتے ہیں جس کا مخالف ضلع \عددی{2} اور وتر \عددی{3}  ہے۔ مثلث کا تیسرا ضلع (قاعدہ) درج ذیل ہو گا (شکل \حوالہ{شکل_مثال_ماورائی_مثلث_سے_زاویے})۔
\begin{align*}
...
\end{tikzpicture}
\caption
{اکائی دائرہ میں زاویہ \عددی{\theta=\cos^{-1}x} مخالف قوس کی لمبائی \عددی{s} کے برابر ہو گا۔}
\label{شکل_ماورائی_قوس_اور_الٹ_کوسائن}
\end{minipage}
\end{figure}

رداس \عددی{r} کے دائرہ میں مرکز پر زاویہ \عددی{\theta} اور قوس کی لمبائی \عددی{s} کا تعلق \عددی{s=r\theta} ہے ، لہٰذا  اکائی دائرہ میں \عددی{s=\theta} ہو گا (شکل \حوالہ{شکل_ماورائی_قوس_اور_الٹ_کوسائن})۔ یوں متغیر \عددی{x} کا معکوس کوسائن \عددی{\cos^{-1}x} زاویہ \عددی{\theta}دے گا ، جس کی قیمت مخالف قوس کی لمبائی \عددی{s} کے برابر ہو گی۔ معکوس سائن کے لیے بھی اس قسم کا تعلق پایا جاتا ہے۔
%=======================
\ابتدا{مثال}\شناخت{مثال_ماورائی_الٹ_تکونیاتی_قیمت_تلاش}
\عددی{\cot\big(\sec^{-1}(-\tfrac{2}{\sqrt{3}})+\csc^{-1}(-2)\big)} کی قیمت تلاش کریں۔

\حل
ہم  اندرونی قوسین سے شروع کر کے  باہر کی جانب چلتے ہوئے زاویوں اور نسبتوں کو مثلثات   کی مدد سے ظاہر کریں گے۔
...
\end{align*}
\موٹا{تیسرا قدم:} \quad
 کوٹینجنٹ کی قیمت   حاصل کرتے ہیں (شکل \حوالہ{مثال_ماورائی_الٹ_تکونیاتی_قیمت_تلاش}-ج)۔کوٹینجنٹ  کا زاویہ ربع دوم میں ہے۔
\begin{align*}
...
%sec 7.8 questions start here
%sec 7.8 questions start here

\حصہء{سوالات}
\ابتدا{سوالات}
\موٹا{معکوس تکونیاتی تفاعل کی مخصوص قیمتیں}\\
...
\sec\alpha=\tfrac{13}{12},\, \csc\alpha=\tfrac{13}{5},\,\cot\alpha=\tfrac{12}{5}$
}}
\انتہا{جواب}
%=========================
\ابتدا{سوال}
...
$\sin\alpha=\tfrac{2}{\sqrt{5}},\,\cos\alpha=-\tfrac{1}{\sqrt{5}},\\
 \tan\alpha=-2,\,\csc\alpha=\tfrac{\sqrt{5}}{2},\, \cot\alpha=-\tfrac{1}{2}$
}}
\انتہا{جواب}
%=========================
\ابتدا{سوال}
...
\انتہا{سوال}
%=========================
\موٹا{تکونیاتی اور معکوس تکونیاتی اجزاء کی قیمتوں کا حصول}\\
...
\موٹا{تکونیاتی  تفاعلات}

سوال \حوالہ{سوال_ماورائی_تکونیاتی_فقرے_الف} تا سوال \حوالہ{سوال_ماورائی_تکونیاتی_فقرے_ب} میں تکونیاتی  تفاعلات کی قیمت تلاش کریں۔
...
آپ کے اسکول کے تدریسی  کمروں  میں لکھائی کا \اصطلاح{تختہ سیاہ}\حاشیہب{black board} زمین سے \عددی{\SI{1.25}{\meter}} کی اونچائی سے شروع ہوتا ہے،  جبکہ اس کا قد \عددی{\SI{2}{\meter}}   ہے۔ آپ تختہ سیاہ سے \عددی{x} میٹر کے فاصلہ پر ہیں ۔ دکھائیں کہ آپ کا دیکھنے کا زاویہ \عددی{\alpha=\cot^{-1}\tfrac{x}{3.25}-\cot^{-1}\tfrac{x}{1.25}} ہے (شکل \حوالہ{شکل_سوال_ماورائی_تختہ_سیاہ})۔ 
\انتہا{سوال}
%====================
\begin{figure}
\centering
...
ایک مخروط کا ترچھا قد \عددی{\SI{3}{\meter}} ہے (شکل \حوالہ{شکل_ماورائی_مخروط_زیادہ_حجم})۔ مخروط کا اعظم حجم کس زاویہ \عددی{\alpha} پر حاصل ہو گا۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
(ا) مماثل \عددی{\sec^{-1}(-x)=\pi-\sec^{-1}x} کو شکل \حوالہ{شکل_سوال_ماورائی_تماثل_سیکنٹ} کی مدد سے جیومیٹریائی  طور پر اخذ کریں۔ (ب) اسی مماثل کو درج ذیل دو مساوات کی مدد سے  تحلیلی طور پر اخذ کریں۔
\begin{align*}
...
مماثل \عددی{\sin^{-1}x+\cos^{-1}x=\tfrac{\pi}{2}} کو \عددی{0<x<1} کے لیے شکل \حوالہ{شکل_ماورائی_سائن_کوسائن_تعلق} سے اخذ کیا گیا۔ اس کی تصدیق وقفہ \عددی{[-1,1]} کے باقی حصہ کے لیے کرنے کی خاطر  \عددی{x=1}، \عددی{x=0} ، اور \عددی{x=-1} اس مماثل میں  رکھ کر کے دیکھیں۔ اس کے بعد وقفہ \عددی{(-1,0)} میں \عددی{x} کے لیے اس کی تصدیق کی خاطر \عددی{x=-a,\, a>0} لیتے ہوئے مساوات \حوالہ{مساوات_ماورائی_الٹ_سائن_تعلق} اور مساوات \حوالہ{مساوات_ماورائی_تماثل_ب} کا اطلاق مجموعہ \عددی{\sin^{-1}(-a)+\cos^{-1}(-a)} پر کریں۔
\انتہا{سوال}
%============
\ابتدا{سوال}
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) معین؛ ایسا زاویہ پایا جاتا ہے جس کا ٹینجنٹ \عددی{ 2} کے برابر ہے۔ \\
(ب) غیر معین؛ ایسا کوئی زاویہ نہیں پایا جاتا  جس کا کوسائن \عددی{2} کے برابر ہو۔
}}
\انتہا{جواب}
%===================
\ابتدا{سوال}
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) دائرہ کار: تمام حقیقی اعداد ، ماسوائے وہ جن کا روپ \عددی{\tfrac{\pi}{2}+k\pi} ہو ، جہاں \عددی{k} عدد صحیح ہے؛
 سعت: \عددی{-\tfrac{\pi}{2}<y<\tfrac{\pi}{2}}\\
(ب) دائرہ کار:\عددی{-\infty<x<\infty}؛\\
 سعت \عددی{-\infty\le y\le \infty}
}}
\انتہا{جواب}
%======================
\ابتدا{سوال}
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) دائرہ کار: \عددی{-\infty<x<\infty}؛ سعت \عددی{0\le y\le \pi} (ب) دائرہ کار: \عددی{-1\le x\le 1}؛ \\
سعت \عددی{-1\le y\le 1}
}}
\انتہا{جواب}
%======================
\ابتدا{سوال}
...
\انتہا{سوالات}
%===================
%sec 7.8 questions end here
%sec 7.8 questions end here


\حصہ{معکوس تکونیاتی تفاعل کے تفرق؛ تکمل}
 انجینئری، طبیعیات، اور ریاضیات میں رونما ہونے والے مختلف اقسام کے  تفاعلات  کے ضد تفرق، معکوس تکونیاتی تفاعل مہیا کرتے ہیں۔ اس حصہ میں ہم معکوس تکونیاتی تفاعل کے  تفرق  (جدول \حوالہ{جدول_ماورائی_معکوس_تکونیاتی_تفرق})حاصل کرتے ہیں اور متعلقہ تکملات پر غور کرتے ہیں۔
...
\ابتدا{مثال}
\begin{align*}
\int_0^1\frac{e^{\tan x}}{1+x^2}\dif x&=\int_0^{\pi/4}e^u\dif u&&
\begin{minipage}{0.35\textwidth}
\(u=\tan^{-1}u,  \dif u=\tfrac{\dif x}{1+x^2}\)\\
\(u(0)=1,\, u(1)=\pi\!/\!4\)
\end{minipage}\\
...
\begin{table}
\caption{معکوس تکونیاتی تفاعل کے تفرق۔}
\label{جدول_ماورائی_معکوس_تکونیاتی_تفرق}
\renewcommand{\arraystretch}{2}
\centering
\begin{tabular}{r|l}
\toprule
\اردوعدد{1}&
$\frac{\dif\, (\sin^{-1}u)}{\dif x}=\frac{\frac{\dif u}{\dif x}}{\sqrt{1-u^2}},\quad  \abs{u}<1 $\\
\اردوعدد{2}&
$\frac{\dif\, (\cos^{-1}u)}{\dif x}=-\frac{\frac{\dif u}{\dif x}}{\sqrt{1-u^2}},\quad  \abs{u}<1 $\\
\اردوعدد{3}&
$\frac{\dif\,(\tan^{-1}u)}{\dif x}=\frac{\frac{\dif u}{\dif x}}{1+u^2} $\\
\اردوعدد{4}&
$\frac{\dif\, (\cot^{-1}u)}{\dif x}=-\frac{\frac{\dif u}{\dif x}}{1+u^2} $\\
\اردوعدد{5}&
$\frac{\dif\, (\sec^{-1}u)}{\dif x}=\frac{\frac{\dif u}{\dif x}}{\abs{u}\sqrt{u^2-1}},\quad \abs{u}>1 $\\
\اردوعدد{6}&
$\frac{\dif\, (\csc^{-1}u)}{\dif x}=\frac{-\frac{\dif u}{\dif x}}{\abs{u}\sqrt{u^2-1}},\quad \abs{u}>1 $\\
\bottomrule
\end{tabular}
\end{table}

آئیں    جدول \حوالہ{جدول_ماورائی_معکوس_تکونیاتی_تفرق} کے کلیہ \اردوعدد{1} سے کلیہ \اردوعدد{5} اخذ   کرتے ہیں۔ 
کلیہ \اردوعدد{3}   بھی اسی طرح حاصل کیا جا سکتا ہے۔  کلیہ \اردوعدد{2}، کلیہ \اردوعدد{4}،  اور کلیہ \اردوعدد{6}
کو موزوں مماثل کے  تفرق  لے کر   کلیات\اردوعدد{1}،  \اردوعدد{3}،  اور \اردوعدد{5}    سے حاصل کیا جا سکتا ہے (سوال \حوالہ{سوال_ماورائی_الٹ_تکونیاتی_تفرقی_کلیات_الف} تا سوال \حوالہ{سوال_ماورائی_الٹ_تکونیاتی_تفرقی_کلیات_ب})۔

\جزوحصہء{تفاعل \عددی{y=\sin^{-1}u} کا تفرق}
ہم   جدول \حوالہ{جدول_ماورائی_معکوس_تکونیاتی_تفرق} کا  کلیہ \اردوعدد{1} اخذ کرتے ہیں۔ ہم جانتے ہیں کہ وقفہ \عددی{-\tfrac{y}{2}<y<\tfrac{y}{2}} میں تفاعل \عددی{x=\sin y} قابل تفرق ہے اور اس کا تفرق، یعنی کوسائن، اس وقفہ پر مثبت ہے۔ یوں حصہ \حوالہ{حصہ_استعمال_تکمل_الٹ_تفاعل_اور_ان_کے_تفرق}  کا  مسئلہ \حوالہ{مسئلہ_ماورائی_الٹ_تفرق_قاعدہ} ہمیں یقین دہانی کراتا ہے  کہ پورے وقفہ \عددی{-1<x<1} پر معکوس تفاعل \عددی{y=\sin^{-1}x} قابل تفرق ہو گا۔ چونکہ نقطہ \عددی{x=1} اور \عددی{x=-1} پر اس کی ترسیم کے مماس انتصابی ہیں (شکل \حوالہ{شکل_ماورائی_انتصابی_مماس})، لہٰذا ان نقطوں  پر ہم  معکوس تفاعل \عددی{y=\sin^{-1}x} کو قابل تفرق تصور نہیں کر سکتے۔ 
\begin{figure}
\centering
\begin{minipage}{0.45\textwidth}
\centering
...
\end{tikzpicture}
\caption
{تفاعل \عددی{y=\sin^{-1}x} کی ترسیم کے مماس نقطہ \عددی{x=-1} اور \عددی{x=1} پر انتصابی ہیں۔}
...
ہم \عددی{y=\sin^{-1}x} کا تفرق درج ذیل طریقہ سے حاصل کرتے ہیں۔
\begin{align*}
...
\end{align*}
یوں \عددی{x} کے لحاظ سے \عددی{y=\sin^{-1}x} کا تفرق درج ذیل ہو گا۔
\begin{align*}
\frac{\dif}{\dif x}(\sin^{-1}x)=\frac{1}{\sqrt{1-x^2}}
\end{align*}
اگر \عددی{x} کے لحاظ سے \عددی{u} قابل تفرق تفاعل ہو تب \عددی{y=\sin^{-1}u} پر زنجیری قاعدہ 
\begin{align*}
\frac{\dif y}{\dif x}=\frac{\dif y}{\dif u}\frac{\dif u}{\dif x}
\end{align*}
کے اطلاق سے درج ذیل حاصل ہو گا ، جو درکار  کلیہ \اردوعدد{1} ہے۔
\begin{align*}
\frac{\dif}{\dif x}(\sin^{-1}u)&=\frac{1}{\sqrt{1-u^2}}\frac{\dif u}{\dif x}&&\abs{u}<1
\end{align*}

\جزوحصہء{تفاعل \عددی{y=\sec^{-1}u} کا تفرق}
ہم  کلیہ \اردوعدد{5}   اخذ کرتے ہیں۔ ہم \عددی{y=\sec^{-1}x,\, \abs{x}>1} کا تفرق بھی اسی طرح حاصل کرتے ہیں۔
\begin{align*}
...
\end{align*}
درج بالا میں تیسرے قدم پر چونکہ \عددی{\abs{x}>1} ہے،  لہٰذا \عددی{y} وقفہ \عددی{(0,\pi/2)\cup(\pi/2,\pi)} میں پایا جائے گا ، جس کی وجہ سے \عددی{\sec y\tan y\ne 0} ہو گا،  لہٰذا دونوں اطراف کو غیر صفر \عددی{\sec y\tan y} سے تقسیم کیا جا سکتا ہے۔
...
علامت کے بارے میں ہم کیا کر سکتے ہیں؟ ہم دیکھتے ہیں (شکل \حوالہ{شکل_ماورائی_ڈھلوان_مثبت_سیکنٹ}) کہ \عددی{\abs{x}>1} کے لیے \عددی{y=\sec^{-1}x} کی ترسیم کا ڈھلوان مثبت رہتا ہے،  لہٰذا درج ذیل لکھا جا سکتا ہے۔
...
\end{align*}
اگر \عددی{\abs{u}>1} ہو اور \عددی{x} کا \عددی{u} قابل تفرق تفاعل ہو تب زنجیری قاعدہ کے استعمال سے درج ذیل حاصل ہو گا، جو  کلیہ \اردوعدد{5}   ہے۔
\begin{align*}
...
\end{tikzpicture}
\caption{
قوس \عددی{y=\sec^{-1}x} کا ڈھلوان \عددی{x<-1} اور \عددی{x>1} دونوں کے لیے مثبت ہے۔
}
\label{شکل_ماورائی_ڈھلوان_مثبت_سیکنٹ}
\end{figure}

\جزوحصہء{کلیات تکمل}
ہم  جدول \حوالہ{جدول_ماورائی_معکوس_تکونیاتی_تفرق} کے کلیہ \اردوعدد{1}،  \اردوعدد{3}، اور   \اردوعدد{5}  ، جہاں \عددی{a=1} ہے،  سے تکمل کے درج ذیل تین اہم کلیات حاصل ہوتے ہیں جہاں  \عددی{a\ne 0}  مستقل ہے۔
\begin{align}
\int\frac{\dif u}{\sqrt{a^2-u^2}}&=\sin^{-1}(\tfrac{u}{a})+C&&\text{\RL{$u^2<a^2$ کے لیے درست ہے}}\label{مساوات_ماورائی_کلیات_تکمل_الف}\\
\int\frac{\dif u}{a^2+u^2}&=\frac{1}{a}\tan^{-1}(\tfrac{u}{a})+C&&\text{\RL{تمام $u$ کے لیے درست ہے}}\label{مساوات_ماورائی_کلیات_تکمل_ب}\\
\int\frac{\dif u}{u\sqrt{u^2-a^2}}&=\frac{1}{a}\sec^{-1}\abs{\tfrac{u}{a}}+C&&\text{\RL{$u^2>a^2$ کے لیے درست ہے}}\label{مساوات_ماورائی_کلیات_تکمل_پ}
\end{align}
...
\حل
یہاں ریاضی فقرہ \عددی{\sqrt{4x-x^2}} مساوات \حوالہ{مساوات_ماورائی_کلیات_تکمل_الف} تا مساوات \حوالہ{مساوات_ماورائی_کلیات_تکمل_پ} میں سے کسی بھی تکمل میں پائے جانے والے ریاضیاتی عبارت کی طرح نہیں،  لہٰذا ہم اس کا مربع مکمل کرتے ہیں۔
\begin{align*}
4x-x^2=-(x^2-4x)=-(x^2-4x+4)+4=3-(x-2)^2&&\text{\RL{تکمیل مربع}}
\end{align*}
اس کے بعد \عددی{a=2}،  \عددی{u=x-2}،  اور \عددی{\dif u=\dif x}  لینے سے  درج ذیل حاصل ہوتا ہے۔
\begin{align*}
...
\end{align*}
اب \عددی{a=1}، \عددی{u=2x+1}، اور \عددی{\tfrac{\dif u}{2}=\dif x} رکھ کر  درج ذیل حاصل ہو گا۔
\begin{align*}
...
آپ اپنی کرسی کو تختہ سیاہ سے اتنی دور رکھنا چاہتے ہو کہ آپ کا دیکھنے کا زاویہ \عددی{\alpha} اعظم ہو۔ آپ کی کرسی تختہ سیاہ سے کتنی دور ہونی چاہیے؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{\
$3\sqrt{5}\,\si{\meter}$
...
متغیر \عددی{x} کی  کونسی قیمت شکل \حوالہ{شکل_سوال_ماورائی_زیادہ_سے_زیادہ_زاویہ} میں \عددی{\theta} کو بڑے سے بڑا بناتی ہے؟ \عددی{\theta} کی بڑی سے بڑی  قیمت تلاش کریں۔ شروع اس سے کریں کہ \عددی{\theta=\pi-\cot^{-1}x-\cot^{-1}(2-x)} ہو گا۔
\انتہا{سوال}
%=====================
\begin{figure}
\centering
...
\انتہا{سوال}
%=====================
%look at the numbering carefully
\ابتدا{سوال}\شناخت{سوال_ماورائی_الٹ_تکونیاتی_تفرقی_کلیات_الف}
درج ذیل مماثل استعمال کرتے ہوئے    جدول \حوالہ{جدول_ماورائی_معکوس_تکونیاتی_تفرق} میں  \عددی{\cos^{-1}u} کے تفرق  کا کلیہ   \عددی{\sin^{-1} u}  کے تفرق کے کلیہ سے اخذ کریں۔
\begin{align*}
...
%look at the numbering carefully
\ابتدا{سوال}
درج ذیل مماثل استعمال کرتے ہوئے   جدول \حوالہ{جدول_ماورائی_معکوس_تکونیاتی_تفرق}  میں  \عددی{\cot^{-1}u} کے تفرق  کا کلیہ   \عددی{\tan^{-1} u}  کے تفرق کے کلیہ سے اخذ کریں۔
\begin{align*}
...
درج ذیل مماثل استعمال کرتے ہوئے  جدول \حوالہ{جدول_ماورائی_معکوس_تکونیاتی_تفرق} میں  \عددی{\csc^{-1}u} کے تفرق  کا کلیہ   \عددی{\sec^{-1} u}  کے تفرق کے کلیہ سے اخذ کریں۔
\begin{align*}
...
%======================
\ابتدا{سوال}
تفاعل \عددی{y=\tan^{-1}x} کا  درج ذیل تفرق
\begin{align*}
...
%=======================
\ابتدا{سوال}
درج ذیل تفرق کو  حصہ  \حوالہ {حصہ_استعمال_تکمل_الٹ_تفاعل_اور_ان_کے_تفرق} کے مسئلہ \حوالہ{مسئلہ_ماورائی_الٹ_تفرق_قاعدہ} میں پیش معکوس کے تفرق کا قاعدہ استعمال کر کے   اخذ کریں۔
\begin{align*}
...
%======================
\ابتدا{سوال}
درج ذیل دو تفاعلات  میں کیا خاصیت پائی جاتی ہے؟ اس پر تبصرہ کریں۔
\begin{align*}
...
سوال \حوالہ{سوال_ماورائی_حجم_بذریعہ_کتلا_الف} اور سوال \حوالہ{سوال_ماورائی_حجم_بذریعہ_کتلا_ب} میں اجسام کے حجم تلاش کریں۔

\ابتدا{سوال}\شناخت{سوال_ماورائی_حجم_بذریعہ_کتلا_الف}
نقطہ \عددی{x=-1} اور \عددی{x=1} پر محور \عددی{x} کے عمودی    مستویات  کے بیچ ٹھوس جسم پایا جاتا ہے۔ محور \عددی{x} کو  عمودی ، جسم کا رقبہ عمودی تراش درج ذیل ہے۔
\begin{enumerate}[a.]
\item
...
نقطہ \عددی{x=-\tfrac{\sqrt{2}}{2}} اور \عددی{x=\tfrac{\sqrt{2}}{2}} پر محور \عددی{x} کے عمودی مستویات  کے بیچ ٹھوس جسم پایا جاتا ہے۔ محور \عددی{x} کو عمودی ، جسم کا رقبہ عمودی تراش درج ذیل ہے۔
\begin{enumerate}[a.]
\item
...
اعدادی تراکیب سے درج ذیل قیمت تلاش کریں۔ حوالہ کے لیے \عددی{5} مقامات تک درست قیمت \عددی{\sin^{-1}0.6=\num{0.64350}} ہے۔
\begin{align*}
...
%========================
\ابتدا{سوال}
تفاعل \عددی{f(x)=\sin^{-1}x} اور اس کے ابتدائی دو تفرق کو ایک ساتھ ترسیم کریں۔  \عددی{f'} اور \عددی{f''} کی قیمتوں اور علامتوں کے لحاظ سے \عددی{f} کے رویہ اور اس کی ترسیم کی  شکل و صورت  پر تبصرہ کریں۔
\انتہا{سوال}
%====================
\ابتدا{سوال}
تفاعل \عددی{f(x)=\tan^{-1}x} اور اس کے ابتدائی دو تفرق کو ایک ساتھ ترسیم کریں۔  \عددی{f'} اور \عددی{f''} کی قیمتوں اور علامتوں کے لحاظ سے \عددی{f} کے رویہ اور اس کی ترسیم کی شکل و  صورت  پر تبصرہ کریں۔
\انتہا{سوال}

\انتہا{سوالات}
%====================

%sec 7.9 questions end here
%sec 7.9 questions end here


\حصہ{ہذلولی تفاعل}\شناخت{حصہ_ماورائی_ہذلولی_تفاعل}
...
\end{align*} 
قوت نمائی تفاعل \عددی{e^x} کا جفت اور طاق حصہ، جنہیں  بالترتیب \عددی{x} کا ہذلولی کوسائن اور ہذلولی سائن کہتے ہیں، از خود اہمیت کے حامل ہیں۔ یہ لچکدار ٹھوس مادّہ میں لہروں کی حرکت، کھمبوں کے بیچ  آویزاں   برقی تاروں کے لٹکنے کی شکل و صورت،  اور دھاتی \اصطلاح{سرد کار}\حاشیہب{heat sink} میں درجہ  حرارت کی تقسیم کو بیان کرتے ہیں۔

\جزوحصہء{تعریف اور مماثل}
ہذلولی کوسائن اور ہذلولی سائن کی تعریف جدول \حوالہ{جدول_ماورائی_چھ_بنیادی_ہذلولی_تفاعل} کی پہلی دو مساواتیں پیش کرتی ہیں۔ اس جدول میں ہذلولی ٹینجنٹ، ہذلولی کوٹینجنٹ، ہذلولی سیکنٹ، اور ہذلولی کوسیکنٹ کی تعریفات بھی پیش کی گئی ہیں۔ جیسا کہ ہم دیکھیں گے، ہذلولی تفاعل ان تکونیاتی تفاعل کے ساتھ کافی  ملتے جلتے ہیں جن کے توسط سے ان کے نام رکھے گئے ہیں (سوال \حوالہ{سوال_ماورائی_قطع_زائد_تفاعل_نام})۔ ہذلولی تفاعلات  کو شکل \حوالہ{شکل_ماورائی_چھ_بنیادی_ہذلولی_تفاعل} میں ترسیم کیا گیا ہے۔ (ہم \عددی{\sinh} کو \قول{سنچ } اور \عددی{\cosh} کو \قول{کوش}  پڑھتے ہیں۔)
...
\جزوحصہء{مماثل}
ہذلولی تفاعل جدول \حوالہ{جدول_ماورائی_تماثل} میں دیے گئے مماثل کو مطمئن کرتے ہیں۔ ماسوائے علامت میں فرق  کے، ہم ان مماثل کو تکونیاتی تفاعل کے لئے  جانتے ہیں۔

\begin{table}
\caption{ہذلولی تفاعل کے مماثل۔}
...
\begin{tabular}{L}
\toprule
\int \sinh u \dif u=\cosh u +C\\
\int \cosh u \dif u=\sinh u +C\\
\int \sech^2 u \dif u=\tanh u +C\\
\int \csch^2 u \dif u=-\coth u +C\\
\int \sech u \tanh u \dif u=-\sech u +C\\
\int \csch u \coth u \dif u=-\csch u +C\\
\bottomrule
\end{tabular}
\end{subtable}
\end{table} 
...
\جزوحصہء{معکوس ہذلولی تفاعل}
ہم چھ بنیادی ہذلولی تفاعل کو تکمل میں استعمال کرتے ہیں۔ چونکہ \عددی{\tfrac{\dif}{\dif x}(\sinh x)=\cosh x>0} ہے،  لہٰذا \عددی{x} کے لحاظ سے ہذلولی سائن بڑھتا تفاعل ہے۔ ہم اس کے معکوس کو درج ذیل سے ظاہر کرتے ہیں۔
\begin{align*}
y=\sinh^{-1}x
\end{align*}
وقفہ \عددی{-\infty<x<\infty} میں ہر \عددی{x} کے لیے \عددی{y=\sinh^{-1}x} کی قیمت وہ ہو گی جس کے ہذلولی سائن  کی قیمت \عددی{x} ہو۔ تفاعل \عددی{y=\sinh x} اور \عددی{y=\sinh^{-1}x} کی ترسیمات کو شکل \حوالہ{شکل_ماورائی_چھ_بنیادی_الٹ_ہذلولی_ترسیمات}-ا میں پیش کیا گیا ہے۔

جیسا آپ شکل \حوالہ{شکل_ماورائی_چھ_بنیادی_ہذلولی_تفاعل}-ب میں دیکھ سکتے ہیں، تفاعل \عددی{y=\cosh x} یک بہ یک نہیں ہے۔ البتہ اس کا پابند شدہ روپ \عددی{y=\cosh x,\,x\ge 0} یک بہ یک ہے ، لہٰذا اس کا معکوس پایا جائے گا ، جس کو درج ذیل سے ظاہر کیا جاتا ہے۔
\begin{align*}
y=\cosh^{-1}x
\end{align*}
متغیر \عددی{x\ge 1} کے ہر قیمت کے لیے وقفہ \عددی{0\le y\le\infty} میں \عددی{y=\cosh^{-1}x} ایک ایسا عدد ہو گا جس کے ہذلولی کوسائن  کی قیمت \عددی{x} ہو گی۔   تفاعل \عددی{y=\cosh x,\, x\ge 0} اور \عددی{y=\cosh^{-1}x} کی ترسیمات کو شکل \حوالہ{شکل_ماورائی_چھ_بنیادی_الٹ_ہذلولی_ترسیمات}-ب میں دکھایا گیا ہے۔
\begin{figure}
\centering
\begin{subfigure}{0.45\textwidth}
\centering
...
\end{tikzpicture}
\caption
{ہذلولی سائن اور معکوس ہذلولی سائن کی  ترسیمات۔ یہ دونوں لکیر \عددی{y=x} کے لحاظ سے تشاکلی ہیں۔}
\end{subfigure}\hfill
\begin{subfigure}{0.45\textwidth}
\centering
...
\end{tikzpicture}
\caption
{ہذلولی کوسائن اور معکوس ہذلولی کوسائن کی  ترسیمات۔ یہ دونوں لکیر \عددی{y=x} کے لحاظ سے تشاکلی ہیں۔}
\end{subfigure}\hfill
\begin{subfigure}{0.45\textwidth}
\centering
...
\end{tikzpicture}
\caption
{ہذلولی سیکنٹ اور معکوس ہذلولی سیکنٹ کی  ترسیمات۔ یہ دونوں لکیر \عددی{y=x} کے لحاظ سے تشاکلی ہیں۔}
\end{subfigure}\hfill
\begin{subfigure}{0.45\textwidth}
\centering
...
\end{axis}
\end{tikzpicture}
\caption{معکوس ہذلولی کوسیکنٹ کی ترسیم۔}
\end{subfigure}\hfill
\begin{subfigure}{0.45\textwidth}
\centering
...
\end{axis}
\end{tikzpicture}
\caption{معکوس ہذلولی ٹینجنٹ کی ترسیم۔}
\end{subfigure}\hfill
\begin{subfigure}{0.45\textwidth}
\centering
...
\end{axis}
\end{tikzpicture}
\caption{معکوس ہذلولی کوٹینجنٹ کی ترسیم۔}
\end{subfigure}
\caption{چھ بنیادی ہذلولی تفاعل کے معکوس۔}
\label{شکل_ماورائی_چھ_بنیادی_الٹ_ہذلولی_ترسیمات}
\end{figure}

تفاعل \عددی{y=\cosh x} کی طرح \عددی{y=\sech x=\tfrac{1}{\cosh x}} بھی یک بہ یک نہیں ہے، البتہ \عددی{x} کو غیر منفی قیمتوں پر پابند کرنے سے  \عددی{y=\sech x} یک بہ یک ہو گا جس کا معکوس پایا جاتا ہے۔ اس معکوس کو
\begin{align*}
y=\sech^{-1}x
\end{align*}
سے ظاہر کیا جاتا ہے۔ وقفہ \عددی{(0,1]} میں \عددی{x} کی ہر قیمت کے لیے \عددی{y=\sech^{-1}x} وہ عدد ہو گا جس کے معکوس ہذلولی سیکنٹ کی قیمت  \عددی{x} ہو گی۔

ہذلولی کوسیکنٹ، ہذلولی ٹینجنٹ ، اور ہذلولی کوٹینجنٹ اپنے اپنے  پابند دائرہ کار پر  یک بہ یک ہیں ، لہٰذا ان کے معکوس پائے جائیں گے ، جنہیں
\begin{align*}
y=\csch^{-1}x,\quad y=\tanh^{-1}x,\quad y=\coth^{-1}x
\end{align*}
سے ظاہر کیا  جاتا  ہے اور    جنہیں شکل \حوالہ{شکل_ماورائی_چھ_بنیادی_الٹ_ہذلولی_ترسیمات}-د، ہ، و میں ترسیم کیا گیا ہے۔

\جزوحصہء{کارآمد مماثل}
چند کارآمد مماثل کو جدول \حوالہ{جدول_ماورائی_چند_کارآمد_تماثل} میں پیش کیا گیا ہے۔ تفاعل \عددی{\cosh^{-1}x}، \عددی{\sinh^{-1}x}،  اور \عددی{\tanh^{-1}x} کی قیمتیں جانتے ہوئے ان مماثل کے استعمال سے  \عددی{\sech^{-1}x}، \عددی{\csch^{-1}x}،  اور \عددی{\coth^{-1}x} کی قیمتیں حاصل کی جا سکتی ہیں۔

\begin{table}
\caption{معکوس ہذلولی تفاعل کے چند کار آمد مماثل}
...
\جزوحصہء{معکوس ہذلولی تفاعلات کے تفرق اور تکمل}
معکوس ہذلولی تفاعل کا اہم ترین استعمال،  تکمل کے ذریعہ  جدول \حوالہ{جدول_ماورائی_الٹ_ہذلولی_تفرق} میں کلیات تفرق سے کلیات تکمل کا حصول ہے۔

تفاعل \عددی{\tanh^{-1}u} اور \عددی{\coth^{-1}u} کے تفرق پر \عددی{\abs{u}<a} اور \عددی{\abs{u}>1} کی پابندی، ان تفاعلات کی قیمتوں پر پابندی کی وجہ سے ہے (شکل \حوالہ{شکل_ماورائی_چھ_بنیادی_الٹ_ہذلولی_ترسیمات}-ہ، و دیکھیں)۔ کلیات تفرق کو کلیات تکمل میں تبدیل کرتے وقت \عددی{\abs{u}<1} اور \عددی{\abs{u}>1} میں امتیاز اہم ہو گا۔ اگر \عددی{\abs{u}<1} ہو تب \عددی{\tfrac{1}{1-u^2}} کا تکمل \عددی{\tanh^{-1}u+C} ہو گا۔ اس کے برعکس \عددی{\abs{u}>1} کی صورت میں تکمل \عددی{\coth^{-1}u+C} ہو گا۔

\begin{table}
\caption{معکوس ہذلولی تفاعل کے تفرق۔}
...
\ابتدا{مثال}
دکھائیں کہ اگر متغیر \عددی{x} کا تفاعل  \عددی{u} قابل تفرق  ہو اور  \عددی{x} کی قیمتیں \عددی{1} سے زیادہ ہوں تب درج ذیل ہو گا۔
\begin{align*}
...
موزوں  متبادل متغیرات استعمال کرتے ہوئے جدول \حوالہ{جدول_ماورائی_الٹ_ہذلولی_تفرق} میں دیے گئے کلیات تفرق سے  جدول \حوالہ{جدول_ماورائی_الٹ_ہذلولی_تکمل} کے کلیات تکمل اخذ کیے جا سکتے ہیں۔


\begin{table}
\caption{وہ تکمل جو معکوس ہذلولی تفاعل دیتے ہیں۔}
...
\حصہء{سوالات}
\ابتدا{سوالات}
\موٹا{ہذلولی تفاعل کی قیمتیں اور مماثل}\\
سوال \حوالہ{سوال_ماورائی_باقی_ہذلولی_تلاش_الف} تا سوال \حوالہ{سوال_ماورائی_باقی_ہذلولی_تلاش_ب} میں \عددی{\sinh x} یا \عددی{\cosh x} کی ایک قیمت دی گئی ہے۔ مماثل \عددی{\cosh^2x-\sinh^2=1} اور ہذلولی تفاعل کی تعریف استعمال کرتے ہوئے باقی پانچ ہذلولی تفاعلات  کی قیمتیں تلاش کریں۔
...
\coth x=-\tfrac{5}{3},\,\sech x=\tfrac{4}{5},\\
\csch x=-\tfrac{4}{3}$
}}
\انتہا{جواب}
%===========================
...
\ابتدا{جواب}
\wf{\unexpanded{
$\sinh x=\tfrac{8}{15},\,\tanh x=\tfrac{8}{17},\\
\coth x=\tfrac{17}{8},\,\sech x=\tfrac{15}{17},\\
\csch x=\tfrac{15}{8}$
}}
\انتہا{جواب}
%===========================
...
\انتہا{سوال}
%===========================
سوال \حوالہ{سوال_ماورائی_ہذلولی_سادہ_ترین_الف} تا سوال \حوالہ{سوال_ماورائی_ہذلولی_سادہ_ترین_ب} میں ریاضیاتی  فقروں کو قوت نما کے روپ میں لکھ کر ان کی سادہ ترین صورت حاصل کریں۔
...
\موٹا{کلیات تکمل}\\
سوال \حوالہ{سوال_ماورائی_تصدیق_کلیات_تکمل_الف} تا سوال \حوالہ{سوال_ماورائی_تصدیق_کلیات_تکمل_ب} میں دیے  گئے کلیات تکمل کی تصدیق کریں۔
...
\انتہا{سوال}
%======================
\موٹا{معکوس ہذلولی تفاعل اور متعلقہ تکمل کی قیمت کا حصول}\\
ہذلولی تفاعل کو درج ذیل جدول میں پیش  لوگارتھمی روپ میں لکھا جا سکتا ہے۔
...
درج بالا  جدول میں پیش کیے گئے کلیات استعمال کرتے ہوئے سوال \حوالہ{سوال_ماورائی_لوگارتھمی_روپ_الف} تا سوال \حوالہ{سوال_ماورائی_لوگارتھمی_روپ_ب} میں دیے گئے  اعداد  کو لوگارتھمی روپ میں لکھیں۔
...
\انتہا{سوال}
%========================
سوال \حوالہ{سوال_ماورائی_ہذلولی_لوگارتھمی_الف} تا سوال \حوالہ{سوال_ماورائی_ہذلولی_لوگارتھمی_ب} کو (ا) معکوس ہذلولی تفاعل (ب) قدرتی لوگارتھم کے  روپ میں حل کریں۔
...
\ابتدا{سوال}
(ا) مبدا کے لحاظ سے تشاکلی وقفہ پر معین  تفاعل \عددی{f} (یعنی ایسا تفاعل جو \عددی{x} پر معین ہونے کی صورت میں \عددی{-x} پر بھی معین ہو) کے لیے درج ذیل دکھائیں۔
\begin{align}\label{مساوات_ماورائی_جفت_طاق_حصے}
f(x)=\frac{f(x)+f(-x)}{2}+\frac{f(x)-f(-x)}{2}
\end{align}
اس کے بعد دکھائیں کہ \عددی{\tfrac{f(x)+f(-x)}{2}} جفت اور \عددی{\tfrac{f(x)-f(-x)}{2}} طاق ہو گا۔ (ب) اگر \عددی{f} از خود جفت یا طاق ہو تب مساوات \حوالہ{مساوات_ماورائی_جفت_طاق_حصے}  کافی سادہ صورت اختیار کرتی ہے۔ ان نئی مساواتوں کو تلاش کریں۔ اپنے جوابات کی وجہ پیش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%===================
\ابتدا{سوال}
کلیہ \عددی{\sinh^{-1}x=\ln(x+\sqrt{x^2+1}),\,-\infty<x<\infty} اخذ کریں۔ اس کلیہ میں جذر کے ساتھ منفی کے بجائے مثبت علامت کیوں استعمال ہوتی  ہے؟
\انتہا{سوال}
%=====================
\ابتدا{سوال}
ایک جسم پر، جس کی کمیت \عددی{m} ہے،  ساکن حالت سے ثقلی کشش کی وجہ سے  زمین کی طرف گرتے ہوئے ، سمتی رفتار \عددی{v} کے مربع کے متناسب ہوائی مزاحمت عمل کرتی ہے۔یوں \عددی{t} سیکنڈ بعد  جسم کی سمتی رفتار درج ذیل تفرقی مساوات کو مطمئن کرے گی،
\begin{align*}
m\frac{\dif v}{\dif t}&=mg-kv^2
\end{align*}
جہاں \عددی{k} ایک ایسا مستقل ہے جس کی قیمت کا دارومدار جسم کی  \اصطلاح{ہوائی حرکیات}\حاشیہب{aerodynamics} کے خواص اور ہوا کی کثافت پر  ہو گا۔ (ہم فرض کرتے ہیں کہ جسم زیادہ بلندی سے نہیں گرتا۔ یوں ہوائی کثافت میں تبدیلی کو رد کیا جا سکتا ہے۔) 
\begin{enumerate}[a.]
\item
دکھائیں کہ درج ذیل مساوات   درج بالا تفرقی مساوات اور ابتدائی معلومات (\عددی{t=0} پر \عددی{v=0}) کو مطمئن کرتی ہے۔ 
\begin{align*}
...
\item
ایک \اصطلاح{فضائی غوطہ باز}\حاشیہب{skydiver} ، جس کی کمیت \عددی{\SI{70}{\kilo\gram}} ہو، کے لیے \عددی{k=0.23} ہو گا۔ اس فضائی غوطہ باز کی تحدیدی سمتی رفتار کتنی ہو گی؟
\end{enumerate}
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\end{align*}
ہے۔ دکھائیں کہ دونوں صورتوں میں اس جسم کا  اسراع \عددی{\tfrac{\dif^{\,2}s}{\dif t^2}} فاصلہ \عددی{s} کے راست متناسب ہو گا، البتہ پہلی صورت میں یہ مبدا کی جانب اور دوسری صورت میں مبدا سے دوری کے جانب ہو گا۔
\انتہا{سوال}
%==================
\ابتدا{سوال}
ایک ٹریکٹر ٹرالی محور \عددی{x} پر چلتے ہوئے مبدا تک پہنچ کر محور \عددی{y} کے رخ مڑتی ہے۔ ٹرالی کے پہیوں سے ٹریکٹر تک فاصلے کو اکائی تصور کریں۔یوں جب ٹریکٹر کے پہیے \عددی{(1,0)} پر ہوں تب ٹریکٹر  مبدا پر ہو گا۔جب ٹریکٹر مبدا سے محور \عددی{y}  پر چلتا ہے، ٹرالی قوسی راہ \عددی{y=f(x)} اختیار کرتی ہے۔ یہ قوس درج ذیل ابتدائی قیمت مسئلے کا حل ہو گی۔
\begin{align*}
\frac{\dif y}{\dif x}&=-\frac{1}{x\sqrt{1-x^2}}+\frac{x}{\sqrt{1-x^2}}&&\text{\RL{تفرقی مساوات}}\\
y&=0,\quad x=1&&\text{\RL{ابتدائی معلومات}}
\end{align*}
اس ابتدائی قیمت مسئلہ کو حل کریں۔ (آپ کو معکوس ہذلولی تفاعل درکار ہوں گے۔)
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%============================
\ابتدا{سوال}
ربع اول میں بالائی طرف سے قوس \عددی{y=\cosh x} ، زیریں طرف سے قوس \عددی{y=\sinh x}، بائیں سے محور \عددی{y} ، اور دائیں سے لکیر \عددی{x=2}  کے بیچ  موجود خطے کو محور \عددی{x} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔اس جسم کا حجم تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$2\pi$
...
قوس \عددی{y=4\cosh(\tfrac{x}{4}),\, -\ln 16\le x\le \ln 81} کو محور \عددی{x} کے گرد گھما کر سطح طواف پیدا کیا جاتا ہے (شکل \حوالہ{شکل_سوال_ماورائی_کمتر_سطح})۔  سطح طواف کا رقبہ تلاش کریں۔

یہ ثابت کیا جا سکتا ہے کہ  نقطہ \عددی{A} اور \عددی{B} کے بیچ تمام قابل تفرق قوسین میں سب سے کم سطح طواف پیدا کرنے والی قوس \عددی{y=4\cosh\tfrac{x}{4}} ہے۔ یوں \عددی{A} اور \عددی{b} پر واقع سخت دائری تاروں کے بیچ صابن  کے جھاگ کی سطح یہی قوسی صورت اپنائے گی۔
\انتہا{سوال}
%==================
\begin{figure}
\centering
...
\end{tikzpicture}
\caption
{قطع زائد تفاعلات کے نام کی وجہ (سوال \حوالہ{سوال_ماورائی_قطع_زائد_تفاعل_نام})۔}
\label{شکل_سوال_ماورائی_قطع_زائد_تفاعل_نام}
\end{minipage}
\end{figure}
%
\ابتدا{سوال}
(ا) قوس \عددی{y=\cosh x,\,-\ln 2\le x\le \ln 2} کا وسطانی مرکز تلاش کریں۔ (ب) وسطانی مرکز کو \عددی{2}اعشاریہ مقامات  درستگی تک تلاش کریں۔ اس منحنی کو ترسیم کرتے ہوئے وسطانی مرکز کی نشاندہی کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
ب)
\begin{center}
\begin{tikzpicture}[declare function={fx(\x)=\x;fy(\x)=cosh(\x);}]
\begin{axis}[width=0.45\textwidth,clip=false,view/h=110,small,axis lines=middle,xtick={-0.693,0.693},xticklabels={$-\ln 2$,$\ln 2$},ytick={\empty},ztick={\empty},enlargelimits=true, xlabel={$x$}, ylabel={$y$},zlabel={$z$}, xlabel style={anchor=west},ylabel style={anchor=west},zlabel style={anchor=south},colormap={}{gray(0cm)=(0.6);gray(1cm)=(0.9);}]
\addplot[domain=-0.693:0.693]({fx(x)},{fy(x)})node[pos=0,circ]{}node[pos=1,circ]{}node[pos=0,below left]{$(-\ln 2,1.25)$}node[pos=1,below right]{$(\ln 2,1.25)$}node[pos=0.75,below right]{$y=\cosh x$};
\addplot[]coordinates {(0,1.09)}node[circ]{}node[above right]{$(0,1.09)$};
\end{axis}
\end{tikzpicture}
\end{center}
}}
...
\item
اس آخری مساوات کو \عددی{S(u)} کے لیے حل کریں۔ \عددی{S(0)} کی قیمت کتنی ہے؟ تکمل کے مستقل \عددی{C} کی قیمت کتنی ہو گی؟ مستقل \عددی{C} جانتے ہوئے حل \عددی{S(u)} اور \عددی{u} کا تعلق بیان کریں۔
\end{enumerate}
\انتہا{سوال}
%========================
\begin{figure}
...
فرض کریں دو کھمبوں کے بیچ بجلی کا تار  آویزاں ہے (شکل \حوالہ{شکل_سوال_ماورائی_لیزم_الف})۔ اس تار کے فی اکائی لمبائی  کی کمیت \عددی{m} ہے اور تار کے سب سے کم بلند  نقطہ پر افقی تناو \عددی{H} ہے۔ ہم محدد یوں منتخب کرتے ہیں کہ قوسی تار کا نچلا حصہ مبدا سے \عددی{\tfrac{H}{mg}} بلند ہو جہاں \عددی{g=\SI{9.8}{\meter\per\second\squared}} ہے۔ ایسی صورت میں ہم دکھا سکتے ہیں کہ تار کے   آویزاں ہونے کی شکل  ہذلولی کوسائن \عددی{y=\tfrac{H}{mg}\cosh \tfrac{mgx}{H}} ہو گی۔ ایسی قوس کو \اصطلاح{لیزم}\فرہنگ{لیزم}\حاشیہب{catenary}\فرہنگ{catenary} کہتے ہیں۔
\begin{enumerate}[a.]
\item
...
\end{align*}
\item
چونکہ تار ساکن ہے لہٰذا کسی بھی نقطہ پر افقی قوتوں کا مجموعہ صفر ہو گا اور اسی طرح انتصابی قوتوں کا مجموعہ بھی صفر ہو گا۔ یوں دکھائیں کہ \عددی{T=H} اور \عددی{T=mgy} ہو گا۔یوں \عددی{N} پر تناو ، \عددی{y} لمبائی کے تار کے وزن  کے برابر ہو گا۔ 
\end{enumerate}
\انتہا{سوال}
%=====================
\ابتدا{سوال}\شناخت{سوال_ماورائی_لیزم_ب}\ترچھا{لیزم (سوال \حوالہ{سوال_ماورائی_لیزم_الف} جاری)}\\
تار کی لمبائی \عددی{s=\tfrac{1}{a}\sinh x} ہو گی  (شکل \حوالہ{شکل_سوال_ماورائی_لیزم_الف}) جہاں \عددی{a=\tfrac{mg}{H}} ہو گا۔دکھائیں کہ \عددی{N} کے محدد کو \عددی{s} کی صورت میں  درج ذیل لکھا جا سکتا ہے۔
\begin{align*}
...
ایک تار جس کی لمبائی \عددی{\SI{10}{\meter}} اور کمیت \عددی{\SI{0.6}{\kilo\gram\per\meter}} ہے کو ایک جتنی بلندی پر  کھمبوں سے باندھا گیا ہے۔ کھمبوں کے بیچ فاصلہ \عددی{\SI{9}{\meter}} ہے۔
\begin{enumerate}[a.]
\item
...
\end{align*}
دکھائیں کہ مستقل  \عددی{a} درج ذیل کو مطمئن کرتا ہے(سوال \حوالہ{سوال_ماورائی_لیزم_ب} کے نتائج استعمال کریں۔)
...
%sec 7.10 questions ends here
%sec 7.10 questions ends here


\حصہ{یک رتبی تفرقی مساوات}\شناخت{حصہ_ماورائی_یک_رتبی_تفرقی_مساوات}
ہم نے ابتدائی قیمت مسئلہ \عددی{\tfrac{\dif y}{\dif t}=ky,\,y(0)=y_0} کو حل کرتے ہوئے قوت نمائی تبدیلی \عددی{y=y_0e^{kt}} کا قاعدہ حصہ \حوالہ{حصہ_ماورائی_افزائش_تنزل} میں دریافت کیا۔ جیسا کہ ہم نے دیکھا یہ مسئلہ نمو آبادی، تابکار تحلیل، انتقال حرارت اور دیگر اعمال کی نمونہ کشی کرتا ہے۔  ابتدائی قیمت مسئلہ \عددی{\tfrac{\dif y}{\dif x}=f(x,y)} پر  اس حصہ میں ہم غور کریں گے،  جہاں تفاعل \عددی{f} غیر تابع متغیر \عددی{x} اور تابع متغیر \عددی{y} کا تفاعل ہو گا۔ اس مساوات، جو \عددی{\dif y\!/\!\dif t=kt}  کی عمومی صورت ہے (\عددی{t} کو \عددی{x} تصور کریں)،کا استعمال زیادہ  وسیع ہے۔

\جزوحصہء{یک رتبی تفرقی مساوات}
درج ذیل مساوات، جس میں \عددی{f(x,y)} مستوی \عددی{xy} کے متغیرات \عددی{x} اور \عددی{y}  کا تفاعل \عددی{f(x,y)} ہے،   کو \اصطلاح{یک رتبی}\فرہنگ{تفرقی مساوات!یک رتبی}\حاشیہب{first order}\فرہنگ{differential equation!first order} تفرقی مساوات کہتے ہیں۔
\begin{align}\label{مساوات_ماورائی_یک_رتبی_تفرقی_الف}
\frac{\dif y}{\dif x}=f(x,y)
\end{align}
اس مساوات کو ہم \عددی{y'=f(x,y)} بھی لکھتے ہیں۔متغیر \عددی{x} کے کسی وقفہ (جو لامتناہی ہو سکتا ہے) پر معین قابل تفرق تفاعل \عددی{y=y(x)} جس کے لیے
\begin{align*}
...
\end{align*}
\حل
دیا گیا تفاعل ابتدائی شرط کو مطمئن کرتا ہے، یعنی درج ذیل مطمئن ہوتا ہے۔
\begin{align*}
y(2)=\big(\frac{1}{x}+\frac{x}{2}\big)_{x=2}=\frac{1}{2}+\frac{2}{2}=\frac{3}{2}
\end{align*}
یہ دکھانے کی خاطر کہ دیا گیا تفاعل تفرقی مساوات کو بھی مطمئن کرتا ہے، ہم \عددی{y} کی جگہ \عددی{\tfrac{1}{x}+\tfrac{x}{2}} رکھ کر کے تصدیق کرتے ہیں کہ تفرقی مساوات  کے دونوں اطراف یکساں ہیں۔
\begin{align*}
...
\end{align*} 
تفاعل \عددی{y=\tfrac{1}{x}+\tfrac{x}{2}} ابتدائی شرط اور تفرقی مساوات کو مطمئن کرتا ہے ، لہٰذا یہ تفرقی مساوات کا حل ہے۔
\انتہا{مثال}
%=======================

\جزوحصہء{قابل علیحدگی مساوات}
اگر  \عددی{f(x,y)} کو \عددی{x} کے تفاعل \عددی{g(x)} اور \عددی{y} کے تفاعل \عددی{h(y)}  کا حاصل ضرب لکھنا ممکن ہو تب تفرقی مساوات \عددی{y'=f(x,y)} \اصطلاح{قابل علیحدگی}\فرہنگ{تفرقی مساوات!قابل علیحدگی}\حاشیہب{separable}\فرہنگ{differential equation!separable} کہلاتی ہے۔ ایسی صورت میں ہم تفرقی مساوات کو درج ذیل روپ میں لکھ سکتے ہیں۔
\begin{align*}
...
\end{align*}
یوں \عددی{y}کے  اجزاء اور \عددی{\dif y} بائیں ہاتھ جبکہ \عددی{x}  کے اجزاء اور \عددی{\dif x} دائیں ہاتھ منتقل ہوتے ہیں۔ ہم دونوں اطراف کا تکمل لے کر
\begin{align*}
\int\frac{1}{h(y)}\dif y=\int g(x)\dif x
\end{align*}
حاصل کرتے ہیں۔ تکمل سے درکار حل حاصل ہوتا ہے جس میں \عددی{y}، متغیر \عددی{x} کا صریح تفاعل  یا خفی تفاعل ہو گا  اور اس میں   اختیاری  مستقل بھی موجود  ہو گا۔

\ابتدا{مثال}
درج ذیل تفرقی مساوات   حل کریں۔
\begin{align*}
\frac{\dif y}{\dif x}=(1+y^2)e^x
\end{align*}
\حل
چونکہ \عددی{1+y^2} کبھی بھی صفر نہیں ہو سکتا  لہٰذا ہم متغیرات کی علیحدگی سے  اس تفرقی مساوات کو حل کر سکتے ہیں۔ 
\begin{align*}
...
\end{align*} 
مساوات \عددی{\tan^{-1}y=e^x+C} میں \عددی{y} متغیر \عددی{x} کا  خفی تفاعل ہے۔ ہم  دونوں اطراف کا ٹینجنٹ لے کر  ، اس مساوات کو حل کر کے \عددی{y} کو \عددی{x} کا  صریح تفاعل   لکھ سکتے ہیں۔ 
\begin{align*}
\tan(\tan^{-1}y)&=\tan(e^x+C)\\
y&=\tan(e^x+C)
\end{align*}
...
\end{align}
جس میں \عددی{P} اور \عددی{Q} متغیر \عددی{x} کے تفاعل ہوں \اصطلاح{خطی}\فرہنگ{تفرقی مساوات!خطی}\حاشیہب{linear}\فرہنگ{differential equation!linear} یک رتبی مساوات کہلاتی ہے۔ مساوات \حوالہ{مساوات_ماورائی_خطی_یک_رتبی_الف} اس کا  \اصطلاح{معیاری روپ}\فرہنگ{تفرقی مساوات!معیاری روپ}\حاشیہب{standard form}\فرہنگ{differential equation!standard form}  دیتی ہے۔ دھیان رہے کہ اس تفرقی مساوات میں \عددی{\tfrac{\dif y}{\dif x}} کا جزو ضربی \عددی{1} ہے۔
...
\frac{\dif y}{\dif x}&=x+\frac{3}{x}y\quad \quad \text{\RL{$x$سے تقسیم}}\\
\frac{\dif y}{\dif x}-\frac{3}{x}y&=x\quad 
\begin{minipage}{0.45\textwidth}
معیاری  روپ، جس میں درج ذیل ہیں\\
$P(x)=-\tfrac{3}{x}, \, Q(x)=x$ 
\end{minipage}
\end{align*}
\انتہا{مثال}
...
\frac{\dif y}{\dif x}=ky
\end{align*}
اس خطی یک رتبی تفرقی مساوات کا معیاری روپ درج ذیل ہے۔
\begin{align*}
...
y&=\frac{1}{v(x)}\int v(x)Q(x)\dif x&&\text{\RL{$\,y\,$ کے لیے حل کریں}}
\end{aligned}
\end{gather}
یاد رہے کہ \عددی{v(x)} کا انتخاب یوں کیا جاتا ہے کہ \عددی{v\tfrac{\dif y}{\dif x}+Pvy=\tfrac{\dif}{\dif x}(v\cdot y)} ہو۔درج بالا میں تیسرے قدم پر یہی  حقیقت  استعمال کی گئی۔ مساوات \حوالہ{مساوات_ماورائی_خطی_یک_رتبی_ب} کا حل تفاعل \عددی{v(x)} اور \عددی{Q(x)} کی  صورت میں  مساوات \حوالہ{مساوات_ماورائی_خطی_یک_رتبی_پ} دیتی ہے۔ 

کیا \عددی{P(x)} مساوات کے حل میں نہیں پایا جاتا؟ درحقیقت  \عددی{P(x)} بالواسطہ طور پر حل میں پایا جاتا ہے۔ یہ \عددی{v(x)} کے انتخاب میں شامل ہوتا ہے۔ ہم \عددی{v(x)} پر مسلط شرط  سے درج ذیل حاصل کرتے ہیں۔ 
\begin{align*}
...
\end{align*}
اس آخری مساوات کے دونوں اطراف کو \عددی{y} سے تقسیم کرنے سے   درج ذیل حاصل ہو گا ، جہاں تیسرے قدم پر \عددی{v>0} کی وجہ سے \عددی{\ln v} میں مطلق قیمت کی علامت کی ضرورت پیش نہیں آتی۔
\begin{gather}
...
v(x)=e^{\int P(x)\dif x}
\end{align}
ہے۔ تفاعل \عددی{v(x)} کے کلیہ میں \عددی{P(x)} کے ضد تفرق کی عمومی صورت کی ضرورت نہیں ہو گی بلکہ اس کا کوئی بھی ضد تفرق کار آمد ہو گا۔
\انتہا{مسئلہ}
%=================
...
\item
\عددی{P(x)} کا ضد تفرق معلوم کریں۔
\item
...
\end{align*}
\موٹا{قدم دوم:}\quad
\عددی{P(x)} کا (کوئی بھی)   ضد  تفرق تلاش کرتے ہیں۔ 
\begin{align*}
...
xy'=x^2+3y,\quad x>0
\end{align*}
جہاں ابتدائی معلومات \عددی{y(1)=2}  ہے۔
...
\جزوحصہء{سمتی رفتار کے راست متناسب مزاحمتی قوت}
بعض اوقات جب باقی قوتوں کو رد کرنا ممکن ہو، یہ کہنا درست ہو گا کہ حرکت کرتے ہوئے جسم پر لاگو مزاحمت اس کی سمتی رفتار کے راست متناسب ہو گی۔ایک گاڑی جس کا انجن بند ہو اور یہ رک رہی ہو، ایسی ایک مثال ہے۔ ایسا جسم جتنا آہستہ چل رہا ہو، اس پر ہوائی مزاحمت اتنی کم ہو گی۔ اس عمل کو ریاضی کا جامہ پہنانے کی خاطر ہم جسم کو کمیت \عددی{m} سے ظاہر کرتے ہیں ، جو محددی لکیر پر حرکت کرتا ہے۔ لمحہ \عددی{t} پر اس جسم کی رفتار \عددی{v} اور مقام \عددی{s} ہو گا۔ مزاحمتی قوت جسم کی سمتی رفتار کے مخالف  رخ ہو گا ، لہٰذا ہم
\begin{align*}
m\frac{\dif v}{\dif t}&=-kv&& k>0
\end{align*}
لکھ سکتے ہیں ، جس کا  معیاری روپ  درج ذیل ہے۔
\begin{align*}
\frac{\dif v}{\dif t}+\frac{k}{m}v=0
\end{align*}
فرض کریں لمحہ \عددی{t=0} پر جسم کی سمتی رفتار \عددی{v_0} ہے، تب ہم مسئلہ \حوالہ{مسئلہ_ماورائی_حل_خطی_یک_رتبی_تفرقی_مساوات} کی مدد سے  درج ذیل حل حاصل  کرتے ہیں (سوال \حوالہ{سوال_ماورائی_ابتدائی_قیمت_درکار})۔
\begin{align}\label{مساوات_ماورائی_حل_مزاحمت_رفتار_کے_راست}
v=v_0e^{-(k/m)t}
\end{align}

ہم مساوات \حوالہ{مساوات_ماورائی_حل_مزاحمت_رفتار_کے_راست} سے کیا سیکھ سکتے ہیں؟ ہم دیکھتے ہیں کہ اگر \عددی{m} بہت زیادہ ہو، مثلاً ریت سے بھرا ہوا ٹرک،  تب اس جسم کو رکنے کے لیے بہت زیادہ وقت درکار ہو گا۔ اس کے علاوہ ہم اس مساوات کا تکمل لے کر طے شدہ فاصلہ \عددی{s} معلوم کر سکتے ہیں۔ 
...
\end{align*}
ملتا ہے،  جس میں \عددی{t=0} پر \عددی{s=0}  رکھ کر   مستقل \عددی{C} کی قیمت جانتے ہیں۔
\begin{align*}
...
\end{align*}
ہو گا۔ یہ جانے کے لیے کہ یہ جسم کتنا فاصلہ طے کرنے کے بعد رکے گا ہم \عددی{t\to \infty} پر \عددی{s(t)} کی حد تلاش کرتے ہیں۔ چونکہ \عددی{-\tfrac{k}{m}<0} ہے ، لہٰذا \عددی{t\to\infty} کرنے سے \عددی{e^{-(k/m)t}\to 0} ہو گا۔ یوں درج ذیل حاصل ہوتا ہے۔
\begin{align*}
\lim_{t\to \infty}s(t)&=\lim_{t\to \infty}\frac{v_0m}{k}(1-e^{-(k/m)t})\\
&=\frac{v_0m}{k}(1-0)=\frac{v_0m}{k}
\end{align*}
یوں اس  جسم کو رکنے کے لیے درج ذیل فاصلہ درکار ہو گا۔
\begin{align}\label{مساوات_ماورائی_طے_فاصلہ}
\text{\RL{طے فاصلہ}}=\tfrac{v_0m}{k}
\end{align}


چونکہ صرف ریاضیات میں ہم وقت کو لامتناہی تک بڑھا سکتے ہیں ، لہٰذا یہ ایک فرضی فاصلہ ہے۔ حقیقی فاصل اس سے کم ہو گا۔ ہاں یہ درست ہو گا کہ بھاری جسم کو رکنے کے لیے زیادہ وقت درکار ہو گا اور یہ زیادہ دور تک چل کر رکے گا۔

\ابتدا{مثال}
برف پھسلن پر پھسلنے والے \عددی{\SI{80}{\kilo\gram}} شخص کے لیے مساوات \حوالہ{مساوات_ماورائی_حل_مزاحمت_رفتار_کے_راست} میں \عددی{k=\SI{4.4}{\kilo\gram\per\second}} ہو گا۔  یہ شخص \عددی{\SI{3}{\meter\per\second}} کی رفتار سے آہستہ ہو کر  \عددی{\SI{0.25}{\meter\per\second}} کی رفتار تک کتنی دیر میں پہنچے گا؟ اس دورانیے میں یہ شخص کتنا فاصلہ طے کرے گا؟

\حل
ہم مساوات \حوالہ{مساوات_ماورائی_حل_مزاحمت_رفتار_کے_راست} کو \عددی{t} کے لیے حل کرتے ہیں۔
\begin{align*}
3e^{-4.4t/80}&=0.25\\
e^{-4.4t/80}&=\frac{1}{12}\\
...
\end{align*}
اس عرصہ میں طے کیے گئے  فاصلے  کو مساوات \حوالہ{مساوات_ماورائی_طے_فاصلہ} سے حاصل کرتے ہیں۔
\begin{align*}
...
منبع دباو  کے ساتھ لمحہ \عددی{t=0} پر  مزاحمت \عددی{R} اور امالہ \عددی{L} کو سلسلہ وار جوڑا جاتا ہے  (شکل \حوالہ{شکل_مثال_ماورائی_سلسلہ_وار_مزاحمت_امالہ_دور})۔امالہ کی اکائی ہینری \عددی{\si{\henry}} اور مزاحمت کی اکائی اوہم \عددی{\si{\ohm}} ہے۔ اس دور کو درج ذیل مساوات ظاہر کرتی ہے
\begin{align}\label{مساوات_ماورائی_برقی_دور}
L\frac{\dif i}{\dif t}+Ri=V
\end{align}
جہاں \عددی{t} وقت کو، \عددی{i} برقی رو کو ، اور \عددی{V} لاگو برقی دباو کو ظاہر کرتا ہے۔اس مساوات میں \عددی{t} اور \عددی{i} متغیرات  جبکہ \عددی{V}، \عددی{R}، اور \عددی{L} مستقل مقادیر ہیں۔اس مساوات کو حل کرتے ہوئے لمحہ \عددی{t} پر برقی رو \عددی{i(t)} معلوم کی  جا سکتی ہے۔ 
...
\caption{}
\end{subfigure}
\caption{سلسلہ وار مزاحمت و امالہ برقی دور (مثال \حوالہ{مثال_ماورائی_سلسلہ_وار_مزاحمت_امالہ_دور})}
...
مساوات \حوالہ{مساوات_ماورائی_سلسلہ_وار_دور_حل} درحقیقت دو مختلف حل کا مجموعہ ہے۔ اس کا پہلا جزو \عددی{\tfrac{V}{R}} ہے جو  \اصطلاح{برقرار حال حل} کہلاتا   ہے،  جبکہ اس کا دوسرا جزو \عددی{-\tfrac{V}{R}e^{-(R/L)t}}  ہے جو \اصطلاح{عارضی حال حل}   کہلاتا ہے  اور جو \عددی{t\to \infty} کرنے سے صفر ہو گا۔
\انتہا{مثال}
%==========================

%sec 7.11 questions start here
%sec 7.11 questions start here

\حصہء{سوالات}
\ابتدا{سوالات}
\موٹا{حل کی تصدیق}\\
سوال \حوالہ{سوال_ماورائی_تصدیق_حل_الف} اور سوال \حوالہ{سوال_ماورائی_تصدیق_حل_ب} میں تصدیق کریں کہ ہر  دیا گیا تفاعل \عددی{y=f(x)} دی گئی تفرقی مساوات کا حل ہے۔
...
\انتہا{سوال}
%========================
سوال \حوالہ{سوال_ماورائی_مزید_تصدیق_الف} اور سوال \حوالہ{سوال_ماورائی_مزید_تصدیق_ب} میں تصدیق کریں کہ  دیا گیا تفاعل \عددی{y=f(x)} دی گئی  تفرقی مساوات کا حل ہے۔
...
سوال \حوالہ{سوال_ماورائی_قابل_علیحدگی_الف} تا سوال \حوالہ{سوال_ماورائی_قابل_علیحدگی_ب} میں دی گئی  تفرقی مساوات   کو  حل کریں۔
...
\ابتدا{سوال}
کیا درج ذیل مساوات  میں سے کوئی  درست ہے؟ اپنے جواب کی وجہ پیش کریں۔
\begin{align*}
...
ایک مریض کو مستقل شرح سے گلوکوز کی خوراک  درون وریدی  کھلائی  جاتی ہے۔ وقت کے لحاظ سے خون میں گلوکوز کے ارتکاز \عددی{c(t)} کو درج ذیل تفرقی مساوات سے ظاہر کیا جا سکتا ہے،  جہاں \عددی{G}، \عددی{V}،  اور \عددی{k} مثبت مستقل ہیں۔
\begin{align*}
\frac{\dif c}{\dif t}&=\frac{G}{100V}-kc
\end{align*} 
 گلوکوز کی شرح \عددی{G} کو  فی منٹ ملی گرام میں  ناپا جاتا ہے ، جبکہ بدن میں خون کے  حجم  \عددی{V}  کو لٹر میں   ناپا جاتا ہے جو  بالغ  شخص کے لیے تقریباً \عددی{\SI{5}{\liter}} ہو گا۔ ارتکاز \عددی{c(t)} کو ملی گرام فی   سنٹی لٹر   میں ناپا جاتا ہے۔جزو \عددی{-kc} کو اس لیے شامل کیا گیا ہے کہ گلوکوز مسلسل دیگر اجزاء میں تبدیل ہو گا اور اس تبدیلی کی شرح اس وقت  موجود گلوکوز کی مقدار  کے راست متناسب ہو گی۔ (ا) \عددی{c(0)} کو \عددی{c_0} سے ظاہر کرتے ہوئے اس مساوات کو حل کریں۔ (ب) برقرار حال ارتکاز \عددی{\lim_{t\to \infty}c(t)} تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%===================
\ابتدا{سوال}\ترچھا{مسلسل سود در سود}\\
آپ بنک سے \عددی{1000} روپیہ قرضہ لیتے ہیں اور ہر سال مزید \عددی{1000} روپیہ بنک سے قرض کرتے ہیں۔  آپ کو \عددی{\SI{10}{\percent}} سالانہ مسلسل سود در سود دینا ہو گا۔ \عددی{t} سال بعد آپ کی واجب الادا رقم \عددی{x} درج ذیل ابتدائی قیمت مسئلہ دیتی ہے۔
\begin{align*}
\frac{\dif x}{\dif t}=1000+0.1x,\quad x(0)=1000
\end{align*} 
(ا) اس مساوات کو حل کریں۔ (ب) آپ کی واجب الادا  رقم کتنے سالوں میں \عددی{\num{100000}} روپیہ  ہو گی؟
\انتہا{سوال}
%==================
\ابتدا{سوال}\ترچھا{حوض خالی کرنے کے لیے درکار وقت}\\
ایک پانی سے بھرے ہوئے انتصابی بیلنی حوض کی تہہ میں نصب نلکی کو کھول کر آپ  حوض خالی کرنا چاہتے ہیں۔ شروع میں پانی کی نکاسی تیز ہوتی ہے لیکن جیسے جیسے پانی کی سطح  گرتی ہے، پانی کی نکاسی بھی آہستہ ہوتی جاتی ہے۔ ایسی صورت میں پانی کی گہرائی کی شرح تبدیلی، گہرائی \عددی{y} کے جذر کے راست متناسب ہوتی ہے
\begin{align*}
\frac{\dif y}{\dif t}&=-k\sqrt{y}
\end{align*}
جہاں مستقل \عددی{k} کی قیمت ثقلی اسراع، نلکی کے سوراخ کی شکل،  اور حوض کے رقبہ عمودی تراش پر منحصر ہوتی ہے۔

فرض کریں \عددی{t} کو منٹوں میں ناپا جاتا ہے اور \عددی{k=\tfrac{1}{10}} ہے۔  اگر پانی کی گہرائی \عددی{\SI{4}{\meter}} ہو تب حوض کتنی دیر میں  خالی ہو گا؟ 
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{ \عددی{40} منٹ
}}
\انتہا{جواب}
%====================
...
ہوا سے خالی چاند پر کمیت \عددی{m} کے جسم پر ثقلی قوت \عددی{F=-\tfrac{GMm}{s^2}=-\tfrac{GMm}{R^2}\tfrac{R^2}{s^2}=-\tfrac{mgR^2}{s^2}} عمل کرتی ہے،  جہاں  چاند کے مرکز سے جسم تک فاصلہ \عددی{s} اور چاند کا رداس \عددی{R} ہے
 (شکل \حوالہ{شکل_سوال_ماورائی_چاند_پر_کشش_کا_رخ})۔ چونکہ قوت \عددی{F} نیچے  کی طرف  عمل کرتی ہے لہٰذا اس کو  منفی لکھا گیا ہے۔ (ا) ایک جسم کو \عددی{t=0} پر چاند  کی سطح سے  \عددی{v_0} رفتار کے ساتھ اوپر پھینکا جاتا ہے۔ قانون نیوٹن \عددی{F=ma} استعمال کرتے ہوئے  دکھائیں کہ مقام \عددی{s} پر جسم کی رفتار درج ذیل ہو گی۔
\begin{align*}
...
\انتہا{سوال}
%===================
\موٹا{سمتی رفتار کے راست متناسب  مزاحمت}

\ابتدا{سوال}
ایک سائکل سوار \عددی{\SI{21.6}{\kilo\meter\per\hour}}  کی رفتار سے چلتے ہوئے پیڈل گھمانا بند کرتا ہے۔ مساوات \حوالہ{مساوات_ماورائی_حل_مزاحمت_رفتار_کے_راست} میں \عددی{k=\tfrac{20}{7}\,\si{\kilo\gram\per\second}} لیں۔ سائکل اور  سائکل سوار کی  مجموعی کمیت \عددی{\SI{80}{\kilo\gram}} ہے۔  (ا) سائکل سوار  کتنا فاصلہ طے کر کے رکے گا۔ (ب) کتنی دیر بعد سائکل سوار کی رفتار \عددی{\SI{0.5}{\meter\per\second}} ہو گی؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%====================
\ابتدا{سوال}
ایک بحری جہاز،  جس کی کمیت \عددی{\SI{2.5e7}{\kilo\gram}} ہے ، کے لیے  مساوات \حوالہ{مساوات_ماورائی_حل_مزاحمت_رفتار_کے_راست} میں \عددی{k=\SI{44000}{\kilo\gram\per\second}} ہے۔ اس بحری جہاز کا انجن اس لمحے  پر  کام کرنا چھوڑ دیتا ہے جب بحری جہاز  کی رفتار \عددی{\SI{24}{\kilo\meter\per\hour}} ہوتی ہے۔ (ا) یہ بحری جہاز کتنا فاصلہ طے کرنے کے بعد رکے گا؟ (ب) اس کی رفتار کتنی دیر میں \عددی{\SI{0.25}{\meter\per\second}}   ہو گی؟
\انتہا{سوال}
%=================
...
ایک سلسلہ وار \عددی{RL} دور پر لمحہ \عددی{t=0} پر برقی دباو لاگو کیا جاتا ہے۔ کتنی دیر میں برقرار حال برقی رو کی نصف مقدار  تک دور میں برقی رو پہنچے گی؟ آپ دیکھیں گے کہ جواب کا دارومدار \عددی{R} اور \عددی{L} کی قیمتوں پر ہو گا نہ کہ لاگو برقی دباو کی قیمت پر۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\end{align*}
(ا) اس مساوات کو برقی رو \عددی{i} کے لیے حل کریں۔ (ب) برقی رو کتنی دیر میں \عددی{\tfrac{I_0}{2}} ہو گی؟ (ج) لمحہ \عددی{t=\tfrac{L}{R}} پر \عددی{i} کتنا ہو گا۔
\انتہا{سوال}
%=====================
\ابتدا{سوال}\ترچھا{وقتی مستقل}\\
مستقل \عددی{\tfrac{L}{R}} کو مہندس \عددی{RL} دور کا \اصطلاح{وقتی مستقل}\فرہنگ{وقتی مستقل}\حاشیہب{time constant}\فرہنگ{time constant} کہتے ہیں۔ تقریباً \عددی{3} وقتی مستقل دورانیہ میں برقی رو برقرار حال قیمت کے \عددی{\SI{95}{\percent}} قیمت تک پہنچتی ہے۔ یوں وقتی مستقل سے ہم معلوم کر سکتے ہیں کہ دور کتنا جلدی برقرار  حال   اختیار کرے گا۔ (ا) مساوات \حوالہ{مساوات_ماورائی_سلسلہ_وار_دور_حل} میں لمحہ \عددی{t=3\tfrac{L}{R}} پر \عددی{i} تلاش کریں۔ یہ برقرار حال برقی رو کی \عددی{\SI{95}{\percent}} قیمت ہو گی۔ (ب) لمحہ \عددی{t=2\tfrac{L}{R}} پر  مساوات \حوالہ{مساوات_ماورائی_سلسلہ_وار_دور_حل} کتنی برقی رو دیتی ہے؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\item
دکھائیں کہ \عددی{i=\tfrac{V}{R}} مساوات \حوالہ{مساوات_ماورائی_سلسلہ_وار_تفرقی} کا حل ہے اور \عددی{i=Ce^{-(R/L)t}}  درج ذیل مساوات  کو مطمئن کرتا ہے۔
\begin{align*}
...
اگر لمحہ \عددی{t} پر برتن میں کیمیا کی مقدار \عددی{y(t)} اور برتن میں مواد کا کُل حجم \عددی{V(t)} ہو تب کیمیا کے اخراج کی شرح درج ذیل ہو گی۔
\begin{gather}
...
\ابتدا{سوال}
ایک حوض میں ابتدائی طور پر \عددی{500} لٹر نمکین   پانی  موجود ہے،  جس میں \عددی{\SI{25}{\kilo\gram}} نمک حل ہے۔ حوض میں \عددی{\SI{5}{\liter\per\minute}} کی  شرح سے نمکین پانی داخلی ہوتا ہے،  جس میں \عددی{\SI{0.4}{\kilo\gram\per\litre}} نمک ملا ہوا ہے،  جبکہ حوض سے نمکین  پانی کا انخلا \عددی{\SI{4}{\liter\per\minute}} ہے۔ حوض میں نمکین پانی کو مسلسل ہلا کر یکساں رکھا جاتا ہے۔
\begin{enumerate}[a.]
\item
...
\ابتدا{جواب}
\wf{\unexpanded{
(ا) \عددی{\SI{2}{\kilo\gram\per\minute}}، (ب) \عددی{100+t} لٹر، \\
(ج) \عددی{\tfrac{4y}{100+t}\,\si{\kilo\gram\per\minute}}،\\ (د) \عددی{\tfrac{\dif y}{\dif t}=2-\tfrac{4y}{100+t},\, y(0)=25}،\\ \عددی{y(t)=\tfrac{2}{5}(100+t)-\tfrac{15}{(1+t/100)^4}}،\\
(ہ) \عددی{\SI{0.35}{\kilo\gram\per\liter}}
}}
\انتہا{جواب}
%=====================
\ابتدا{سوال}
تیل\اصطلاح{تصفیہ خانہ }\فرہنگ{تصفیہ خانہ}\حاشیہب{refinery}\فرہنگ{refinery}  کے ایک حوض میں \عددی{\SI{10000}{\liter}} تیل   موجود  ہے،  جس میں ابتدائی طور پر \عددی{\SI{50}{\kilo\gram}} اضافی مادّہ شامل ہے۔ سردی کے موسم کی وجہ سے اس میں \عددی{\SI{0.4}{\kilo\gram}} فی لٹر اضافی مواد کو  \عددی{\SI{200}{\liter\per\minute}} شامل کیا جاتا ہے۔ حوض میں تیل کو اچھی طرح ہلا کر یکساں رکھا جاتا ہے۔ حوض سے مرکب کے اخراج   کی شرح \عددی{\SI{225}{\liter\per\minute}} ہے۔ اس عمل کے شروع ہونے کے \عددی{20} منٹ بعد حوض میں اضافی مواد کی مقدار معلوم کریں۔
\انتہا{سوال}
%======================
\ابتدا{سوال}
ایک حوض میں \عددی{\SI{500}{\liter}} خالص پانی  موجود ہے۔ ایک محلول،  جس میں \عددی{\SI{0.1}{\kilo\gram\per\liter}}  کھاد پایا جاتا ہے ، کو \عددی{\SI{5}{\liter\per\minute}} کی  شرح سے حوض میں شامل کیا جاتا ہے۔ حوض سے محلول کا اخراج  \عددی{\SI{15}{\liter\per\minute}} ہے۔ حوض میں کھاد کی اعظم مقدار معلوم کریں اور اس مقدار تک پہنچنے کے لیے درکار وقت معلوم کریں۔
\انتہا{سوال}
%====================
\ابتدا{سوال}
 دفتر کے ایک کمرے میں ابتدائی طور پر \عددی{\SI{150}{\meter\cubed}} صاف ہوا  موجود ہے۔ لمحہ \عددی{t=0} پر قریبی کمرے  میں موجود افسران سگریٹ نوشی شروع کرتے ہیں جس کی وجہ سے  \عددی{\SI{4}{\percent}} زہریلی کاربن مونو اکسائڈ \عددی{\SI{0.01}{\meter\cubed\per\minute}}  کی شرح سے اس کمرے  میں داخل ہوتی ہے،  جہاں ایک پنکھا پوری ہوا کو یکساں رکھتا ہے۔ کمرے سے ہوا کا انخلا \عددی{\SI{0.01}{\meter\cubed\per\minute}} ہے۔  کمرے میں کب زہریلی گیس \عددی{\SI{0.01}{\percent}} ہو گی؟
\انتہا{سوال}

\انتہا{سوالات}
%====================
%sec 7.11 questions end here
%sec 7.11 questions end here

%KKK??? am here

\حصہ{یولر کی اعدادی ترکیب؛ میدان ڈھلوان}
بعض اوقات ہم ابتدائی قیمت مسئلہ \عددی{y=f(x,y),\,y(x_0)=y_0} کا  ٹھیک ٹھیک  حل معلوم نہیں کر سکتے  یا نہیں کرنا چاہتے۔ ایسی صورت میں ہم عموماً کمپیوٹر استعمال کرتے ہوئے موزوں وقفہ پر ہر \عددی{x} کے لیے \عددی{y} کی تخمینی قیمت   تلاش کر سکتے ہیں۔ ایسے حل کو ہم \اصطلاح{اعدادی حل}\فرہنگ{اعدادی!حل}\حاشیہب{numerical solution}\فرہنگ{numerical!solution} کہتے ہیں اور اس حل کو حاصل کرنے کے طریقہ کو \اصطلاح{اعدادی ترکیب}\فرہنگ{اعدادی!ترکیب}\حاشیہب{numerical method}\فرہنگ{numerical!method} کہتے ہیں۔ اعدادی تراکیب عموماً بہت کم وقت میں  درست نتائج  دیتی ہیں اور جہاں بھی تحلیلی حل نا ممکن، غیر ضروری،  یا پیچیدہ ہو، وہاں اعدادی تراکیب کو ترجیح دی جاتی ہے۔ اس حصہ میں ہم ایسی  ایک ترکیب پر غور کرتے ہیں جس کو \اصطلاح{ترکیب یولر}\فرہنگ{ترکیب یولر}\حاشیہب{Euler' method}\فرہنگ{Euler's method} کہتے ہیں۔ 

\جزوحصہء{میدان ڈھلوان}
ابتدائی معلومات \عددی{y(x_0)=y_0}،  تفرقی مساوات \عددی{y'=f(x,y)} پر،  یہ شرط مسلط کرتی ہے کہ تفرقی مساوات کا حل نقطہ  \عددی{(x_0,y_0)} سے گزرے گا اور اس نقطے پر حل کا ڈھلوان \عددی{f(x_0,y_0)} ہو گا۔ ہم \عددی{f} کے دائرہ کار میں منتخب نقطوں \عددی{(x,y)} پر ڈھلوان  \عددی{f(x,y)} کے  چھوٹے  سیدھے خط کھینچ  کر   ڈھلوان کو تصویری جامہ پہنا سکتے ہیں۔ نقطہ \عددی{(x,y)} سے گزرتے ہوئے حل کا  ڈھلوان اس نقطہ پر بنائے گئے  چھوٹے خط کے ڈھلوان کے برابر ہو گا ، لہٰذا یہ خط اس نقطے پر حل کا مماس ہو گا۔ہم ان مماس پر نظر دوڑا کر حل کے رویہ کو جان سکتے ہیں (شکل \حوالہ{شکل_ماورائی_میدان_ڈھلوان})۔

قلم و کاغذ کے ساتھ میدان ڈھلوان بنانا تھکا دینے والا کام ہے۔ اس کتاب کی  تمام مثالوں میں میدان ڈھلوان کمپیوٹر کی مدد سے بنائے گئے۔ آئیں  کمپیوٹر کی مدد سے منحنی حل  کے حصول پر غور کریں۔
\begin{figure}
\centering
\begin{subfigure}{0.45\textwidth}
\centering
...
\end{axis}
\end{tikzpicture}
\caption{میدان ڈھلوان پر مخصوص منحنیات حل۔}
\end{subfigure}
\caption
{تفرقی مساوات \عددی{y'=y-x^2} کے میدان ڈھلوان پر منحنیات حل ترسیم کی گئی ہیں۔ کمپیوٹر پر میدان ڈھلوان کو عموماً سمتیات سے ظاہر کیا جاتا ہے اگرچہ ڈھلوان سمتیہ نہیں ہے۔}
\label{شکل_ماورائی_میدان_ڈھلوان}
\end{figure}

\جزوحصہء{خط بندی کا استعمال}
دی گئی تفرقی مساوات \عددی{\tfrac{\dif y}{\dif x}=f(x,y)} اور ابتدائی معلومات \عددی{y(x_0)=y_0} سے ہم منحنی حل \عددی{y=y(x)} کی تخمین درج ذیل خط بندی
\begin{align*}
...
\end{align*}
سے  کر سکتے ہیں۔ \عددی{x_0} کے   قریبی پڑوس میں تفاعل \عددی{L(x)} اصل حل \عددی{y(x)} کی  اچھی تخمین ہو گا (شکل \حوالہ{شکل_ماورائی_خط_بندی_مماس})۔ ترکیب یولر میں اس طرح کے خط بندیوں کو آپس میں جوڑ کر زیادہ لمبے فاصلے کے لیے حل تلاش کیا جاتا ہے۔ اب اس ترکیب پر غور کرتے ہیں۔

ہم جانتے ہیں کہ نقطہ \عددی{(x_0,y_0)} منحنی حل پر پایا جاتا ہے۔ فرض کریں ہم غیر تابع متغیر کی ایک نئی قیمت \عددی{x_0=x_0+\dif x} منتخب کرتے ہیں۔  اگر بڑھوتری \عددی{\dif x} نہایت  کم ہو تب
\begin{align*}
y_1=L(x_1)=y_0+f(x_0,y_0)\dif x
\end{align*}
اصل حل \عددی{y=y(x_1)} کی اچھی تخمین ہو گا۔ یوں نقطہ \عددی{(x_0,y_0)} سے، جو ٹھیک منحنی حل پر پایا جاتا ہے، ہم نقطہ \عددی{(x_1,y_1)} حاصل کر پائیں ہیں جو منحنی حل پر نقطہ \عددی{(x_1,y(x_1))} کے بہت قریب ہو گا۔
...
\end{tikzpicture}
\caption
{ترکیب یولر کی مدد سے  ابتدائی قیمت مسئلہ\\ \عددی{y'=f(x,y),\, y(x_0)=y_0} کے ابتدائی تین نقطوں کا حصول۔ ہر قدم پر مجموعی خلل بڑھتا ہے۔}
\label{شکل_ماورائی_خط_بندی}
\end{minipage}
\end{figure}

\ابتدا{مثال}\شناخت{مثال_ماورائی_ترکیب_یولر_الف}
درج ذیل ابتدائی قیمت مسئلے کے لیے ترکیب یولر کی مدد سے  ابتدائی تین تخمین \عددی{y_1}، \عددی{y_2} ، اور \عددی{y_3}  حاصل کریں۔
\begin{align*}
y'=1+y,\quad y(0)=1
\end{align*}
...
\end{align*}
کے حل کی تخمینی قیمتیں حاصل ہوتی ہیں۔ اگر ہم غیر تابع متغیر کی منتخب کردہ قیمتوں کے بیچ یکساں فاصلہ رکھیں اور   \عددی{n}    نقطے منتخب کریں تب درج ذیل ہو گا۔
\begin{gather}
...
\end{aligned}
\end{gather}
اس کے بعد ہم متواتر درج ذیل  تخمین حاصل کرتے ہیں۔
\begin{gather}
...
\end{aligned}
\end{gather}
ہم قدموں کی تعداد \عددی{n} جتنی چاہیں رکھ سکتے ہیں، البتہ، \عددی{n} کو بہت بڑا رکھنے سے نتائج میں خلل جمع ہو سکتا ہے۔

\ابتدا{مثال}\شناخت{مثال_ماورائی_یولر_موازنہ}
درج ذیل ابتدائی قیمت مسئلہ کے لیے وقفہ \عددی{0\le x\le 1} پر  ترکیب یولر کی درستگی پر غور کریں۔
\begin{align*}
y'=1+y,\quad y(0)=1
\end{align*}
...
\حل
اس مسئلے کا  ٹھیک ٹھیک  تحلیلی حل \عددی{y=2e^x-1} ہے۔ جدول \حوالہ{جدول_ماورائی_یولر_موازنہ} میں، مساوات \حوالہ{مساوات_ماورائی_ترکیب_یولر_ایکس} اور مساوات \حوالہ{مساوات_ماورائی_ترکیب_یولر_وائے} استعمال کرتے ہوئے، ترکیب یولر سے حاصل \عددی{4} اعشاریہ مقامات تک درست تخمینی  اعدادی نتائج کا تحلیل حل کے ساتھ موازنہ کیا گیا ہے۔ دس قدم بعد \عددی{x=1} تک پہنچ کر ترکیب یولر سے حاصل تخمینی حل میں \عددی{\SI{5.6}{\percent}} خلل پایا جاتا ہے۔
\begin{table}
...
\حل
جدول \حوالہ{جدول_مثال_ماورائی_یولر_زیادہ_قدم} میں  اعدادی  نتائج  کا تحلیلی  ٹھیک  ٹھیک حل کے ساتھ موازنہ کیا گیا ہے۔ آپ دیکھ سکتے ہیں کہ قدموں کی تعداد \عددی{10} سے \عددی{20} کرنے سے خلل کم ہوتا ہے۔ اس مرتبہ \عددی{x=1} پر صرف \عددی{\SI{2.9}{\percent}} خلل پایا جاتا ہے۔ 
\begin{table}
...
ایسا معلوم ہوتا ہے  جیسے ترکیب یولر میں قدموں کی تعداد مزید بڑھا کر اس سے بھی بہتر نتیجہ حاصل ہو گا۔ حقیقت میں ایسا کرنے سے نہ  صرف کمپیوٹر کو حل حاصل کرنے میں زیادہ وقت درکار ہو گا بلکہ کمپیوٹر میں ہندسوں کی تعداد پر پابندی کی وجہ سے پیدا پورم پور خلل بڑھتا ہے۔

خلل اور اس کو کم کرنے کے طریقوں پر یہاں غور نہیں کیا جائے گا۔ انہیں سمجھنے کے لیے اعلیٰ  نصاب درکار ہو گا۔ ترکیب یولر سے  بہتر اعدادی تراکیب پائے جاتے ہیں جنہیں  ہم تفرقی مساوات  کے مطالعے  کے دوران سیکھیں گے۔ اعدادی ترکیب میں قدموں کی تعداد اور خلل کے تعلق پر غور کرنے کے لیے آپ کو سوالات میں موقع ملے گا۔

%sec 7.12 questions start here
%sec 7.12 questions start here

\حصہء{سوالات}
\ابتدا{سوالات}
\موٹا{تخمین یولر}\\
سوال \حوالہ{سوال_ماورائی_یولر_الف} تا سوال \حوالہ{سوال_ماورائی_یولر_ب} میں ترکیب یولر سے دیے گئے ابتدائی قیمت مسئلہ کے اولین تین تخمینی قیمتیں تلاش کریں۔دیا گیا قدم استعمال کریں۔ مسئلے کا تحلیلی حل تلاش کریں اور اپنے تخمین کی درستگی پر غور کریں۔ اپنے نتائج کو \عددی{4} اعشاریہ مقامات تک درست رکھیں۔
...
\ابتدا{جواب}
\wf{\unexpanded{
$y_{\text{تحلیلی}}=\tfrac{x}{2}-\tfrac{4}{x},\, y_1=-0.25,\\
 y_2=0.3,\, y_3=0.75$
}}
\انتہا{جواب}
%======================
...
\ابتدا{جواب}
\wf{\unexpanded{
$y_{\text{\RL{تحلیلی}}}=3e^{x(x+2)},\, y_1=4.2,\\
y_2=6.216,\, y_3=9.697$
}}
\انتہا{جواب}
%======================
...
\ابتدا{جواب}
\wf{\unexpanded{
$y_{\text{\RL{تحلیلی}}}=e^{x^2}+1,\, y_1=2.0,\\
 y_2=2.0202,\, y_3=2.0618$
}}
\انتہا{جواب}
%======================
...
%======================
\ابتدا{سوال}
ترکیب یولر استعمال کرتے ہوئے \عددی{\dif x=0.2} لے کر \عددی{y'=y,\, y(0)=1} کے لیے \عددی{y(1)} تلاش کریں۔ \عددی{y(1)} کی ٹھیک ٹھیک قیمت کتنی ہے؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
%===========================
\ابتدا{سوال}
ترکیب یولر استعمال کرتے ہوئے \عددی{\dif x=0.2} لے کر \عددی{y'=\tfrac{y}{x},\, y(1)=2} کے لیے \عددی{y(2)} تلاش کریں۔ \عددی{y(2)} کی ٹھیک ٹھیک قیمت کتنی ہے؟
\انتہا{سوال}
%==============
\ابتدا{سوال}
ترکیب یولر استعمال کرتے ہوئے \عددی{\dif x=0.5} لے کر \عددی{y'=\tfrac{y^2}{\sqrt{x}},\, y(1)=-1} کے لیے \عددی{y(5)} تلاش کریں۔ \عددی{y(5)} کی ٹھیک ٹھیک قیمت کتنی ہے؟
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
\عددی{y\approx -0.2272}، \\
ٹھیک جواب \عددی{\tfrac{1}{1-2\sqrt{5}}\approx -0.2880} ہے۔
}}
\انتہا{جواب}
%==============
\ابتدا{سوال}
ترکیب یولر استعمال کرتے ہوئے \عددی{\dif x=\tfrac{1}{3}} لے کر \عددی{y'=y-e^{2x},\, y(0)=1} کے لیے \عددی{y(2)} تلاش کریں۔ \عددی{y(2)} کی ٹھیک ٹھیک قیمت کتنی ہے؟
\انتہا{سوال}
%==============
\begin{figure}
\centering
...
\end{figure}
\موٹا{میدان ڈھلوان}\\
سوال \حوالہ{سوال_ماورائی_میدان_ڈھلوان_ملائیں_الف} تا سوال \حوالہ{سوال_ماورائی_میدان_ڈھلوان_ملائیں_ب} میں دی گئی تفرقی مساوات کی  منحنی حل اور میدان ڈھلوان کی نشاندہی شکل \حوالہ{شکل_سوال_ماورائی_میدان_ڈھلوان_ملائیں_الف} میں کریں۔
...
\centering
\begin{tikzpicture}
\begin{axis}[hide axis,small, axis lines*=middle,view={0}{90}, xlabel={$x$},ylabel={$y$},ylabel style={rotate=-90},domain=0:0.1,
 y domain=-8:8, samples=22,xtick={\empty},ytick={\empty},xlabel style={at={(current axis.right of origin)},anchor=west},ylabel style={at={(current axis.above origin)},anchor=south}]
\addplot3[domain=-0:1, domain y=-3:3, -stealth, samples=20,  quiver={u=1, v={(y+2)*(y-2)}, scale arrows=0.05}] (x,y,0);
%\addplot [gray,smooth]{-2(1+exp(-4*x))/(1-exp(-4*x))}; %actual curve
\end{axis}
\end{tikzpicture}
\caption{}
\end{subfigure}\hfill
...
\begin{axis}[hide axis,small, axis lines*=middle,view={0}{90}, xlabel={$x$},ylabel={$y$},ylabel style={rotate=-90},domain=0:0.1,
 y domain=-8:8, samples=22,xtick={\empty},ytick={\empty},xlabel style={at={(current axis.right of origin)},anchor=west},ylabel style={at={(current axis.above origin)},anchor=south}]
\addplot3[domain=-0:1, domain y=-3:3, -stealth, samples=20,  quiver={u=1, v={y*(y+1)*(y-1)}, scale arrows=0.05}] (x,y,0);
\end{axis}
\end{tikzpicture}
\caption{}
\end{subfigure}
...
%==================
\موٹا{کمپیوٹر کا استعمال}\\
سوال \حوالہ{سوال_ماورائی_ترسیمی_غور_الف} تا سوال \حوالہ{سوال_ماورائی_ترسیمی_غور_ب} میں دی گئی تفرقی مساوات پر درج ذیل اقدامات کرتے ہوئے ترسیمی غور کریں۔
\begin{enumerate}[a.]
\item
دی گئی تفرقی مساوات کا میدان ڈھلوان مستوی  \عددی{xy} میں کھینچیں۔
\item
تفرقی مساوات کا عمومی حل کمپیوٹر کے کسی ریاضیاتی   پروگرام کی مدد سے حاصل کریں۔
\item
...
\item
 جزو-ہ کو \عددی{8}، \عددی{16} ، اور \عددی{32} ذیلی وقفوں کے لیے دوبارہ حل کر کے جزو-ہ کے نتائج کے اوپر ترسیم کریں۔
\item
...
\انتہا{سوال}
%======================
سوال \حوالہ{سوال_ماورائی_صریح_حل_غیر_موجود_الف}  اور سوال \حوالہ{سوال_ماورائی_صریح_حل_غیر_موجود_ب} کا  صریح حل   بنیادی تفاعل کی صورت میں نہیں پایا جاتا۔ان تفرقی مساوات پر ترسیمی غور کریں۔ مذکورہ بالا جزو-الف تا جزو-ز میں  زیادہ سے زیادہ  اقدام  کرنے کی کوشش کریں۔
...
(ا) \عددی{2x}، (ب) \عددی{\sin 2x}، (ج) \عددی{3e^{x/2}}، (د) \عددی{2e^{-x/2}\cos 2x} \\
 حلوں کا ایک دوسرے کے ساتھ موازنہ کرنے کی خاطر انہیں وقفہ \عددی{-2\le x\le 6} پر ایک ساتھ ترسیم کریں۔
\انتہا{سوال}
%=====================
\ابتدا{سوال}
(ا) درج ذیل تفرقی مساوات کے میدان ڈھلوان کا خاکہ وقفہ \عددی{-3\le x\le 3,\, -3\le y\le 3} کے لیے  کھینچیں۔
\begin{align*}
y'=\frac{3x^2+4x+2}{2(y-1)}
\end{align*}
(ب) متغیرات کے  علیحدگی کے بعد کمپیوٹر کے ریاضیاتی  پروگرام کی مدد سے تکمل کرتے ہوئے خفی حل تلاش کریں۔ (ج) جزو-ب کے نتیجے کو مستقل \عددی{C=-6,-4,-2,0,2,4,6} کے لیے  ترسیم کریں۔ (د) اس حل کو ترسیم کریں جو ابتدائی شرط \عددی{y(0)=-1} کو مطمئن کرتا ہو۔
\انتہا{سوال}

\انتہا{سوالات}
%==============
%sec 7.12 questions end here
%sec 7.12 questions end here
