...
لوگارتھم کی ایک اور مثال ڈیسی بیل \عددی{\si{\deci\bel}} پیمانہ ہے جو صدا کی بلندی کو ناپنے کے لیے استعمال کیا جاتا ہے۔ اگر صدا کی شدت \عددی{I}  واٹ فی مربع میٹر ہو تب
...
دماغی سیال میں \عددی{[\ce{H3O^+}]} کا گاڑھاپن تقریباً \عددی{\SI{4.8e-8}{\mole\per\liter}} ہے۔ اس سیال کا \عددی{\pH} تلاش کریں۔
\انتہا{سوال}
%====================
%Q79
\ابتدا{سوال}
افزائش کار (ایمپلی فائر) سے حاصل صدا کو جزو \عددی{k} سے ضرب دے کر  سطح صدا  \عددی{\SI{10}{\deci\bel}} مزید بلند  کی  جاتی  ہے۔ جزو \عددی{k} کی قیمت تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$k=10$
...
%Q81
\ابتدا{سوال}
کسی بھی محلول میں \عددی{[\ce{H3O^+}]}  اور \عددی{[OH^-]} کے گاڑھاپن کا حاصل ضرب \عددی{10^{-14}} ہوتا ہے۔
\begin{enumerate}[a.]
\item
\عددی{[\ce{H3O^+}]} کی کیا قیمت گاڑھاپن کا مجموعہ \عددی{S=[\ce{H3O^+}]+[\ce{OH^-}]} کو اقل  کرتی ہے؟
\item
اس محلول کی \عددی{\pH} تلاش کریں  جس میں \عددی{S} کی قیمت اقل ہو۔
\item
...
%Q84
\ابتدا{سوال}
کیا \عددی{x>0} کے لیے  \عددی{x^{\ln 2}} اور \عددی{2^{\ln x}} ایک دوسرے کے برابر ہو سکتے ہیں؟دونوں تفاعل ترسیم کرتے ہوئے بتائیں کیا ہوتا ہے۔
\انتہا{سوال}
%====================
%Q85
\ابتدا{سوال}\ترچھا{$2^x$ کی خط بندی}\\
(ا) نقطہ \عددی{x=0} پر \عددی{f(x)=2^x} کی خط بندی دریافت کریں۔ اس کے بعد عددی سروں کو \عددی{2} اعشاریہ  پور و پور کریں۔ (ب) وقفہ \عددی{-3\le x\le 3} اور وقفہ \عددی{-1\le x\le 1} کے لیے تفاعل اور خط بندی کو ایک ساتھ ترسیم کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
(ا) نقطہ \عددی{x=3} پر \عددی{f(x)=\log_3 x} کی خط بندی تلاش کریں۔ اس کے بعد عددی سروں کو \عددی{2} اعشاریہ تک پور و پور کریں۔   (ب) وقفہ \عددی{0\le x\le 8} اور \عددی{2\le x\le} کے لیے تفاعل اور خط بندی کو ایک ساتھ ترسیم کریں۔
\انتہا{سوال}
%====================
...
\end{align*}
کیلکولیٹر استعمال کرتے ہوئے  \عددی{5} اعشاریہ مقامات تک درستگی تک 
...
اس حصہ میں ہم قوت نما تبدیلی کے قاعدہ کو حاصل کریں گے۔ اس کے علاوہ ان عملی استعمال پر غور کیا جائے گا جن کی وجہ سے لوگارتھمی اور قوت نمائی تفاعل اہمیت کے حامل ہیں۔
...
ہم ابتدائی قیمت مسئلہ کے لیے \عددی{A} کی قیمت حاصل کرنے کی خاطر \عددی{t=0} پر \عددی{y=y_0} کو پر کرتے ہیں۔ 
\begin{align*}
y_0=Ae^{k\cdot 0}=A
\end{align*}
...
A(5)=\num{100000}e^{(0.15)(5)}=\num{211700}
\end{align*}
اگر بنک سال میں ایک بار ربا وصول کرے تب پانچ سال بعد آپ کو درج ذیل قرضہ دینا ہو گا۔
\begin{align*}
A(5)=\num{100000}(1+0.15)^5=\num{201136}
\end{align*}
\انتہا{مثال}
...
\end{align*}
ہو گی۔ یاد رہے کہ ہر مہینہ روپیہ کا قدر کم ہو گا لہٰذا پہلے مہینہ کے \عددی{40000} اور آخری مہینہ کے \عددی{40000} روپیہ کے قدر ایک سے  نہیں ہوں گے۔ہم حساب کو آسان بنانے کی خاطر تصور کرتے ہیں کہ اس شخص کو ماہوار کے بجائے ہر سال \عددی{\num{40000}\times 12=\num{480000}} روپیہ ملتے ہیں جن کی اصل قدر
\begin{align*}
...
t&=\frac{\ln 2}{k}
\end{align*}
اس قیمت \عددی{(t=\tfrac{\ln 2}{k})} کو نصف حیات کہتے ہیں جو صرف \عددی{k} پر منحصر ہے  نا کہ ابتدائی ایٹموں کی تعداد پر۔
\انتہا{مثال}
%=====================
\begin{align}
...
ریڈان 222 گیس کے لیے \عددی{k=0.18} دن ہے لہٰذا اس کی نصف حیات \عددی{3.8} دن ہو گی جبکہ رات کی تاریکی میں  نظر آنے کی خاطر گھڑیوں میں استعمال ہونے والے ریڈیم 226 کا \عددی{k=4.3\times 10^{-4}} سال ہے لہٰذا اس کی نصف حیات \عددی{1600} سال ہو گی۔

\ابتدا{مثال}\ترچھا{پولونیم 210}\\
پولونیم 210 کی نصف حیات کو دنوں میں ناپا جاتا ہے۔ اگر \عددی{t=0} پر پولونیم 210  کے \عددی{} ایٹم پائے جاتے ہوں تب \عددی{t} دنوں بعد اس کے \عددی{y=y_0e^{-5\times 10^{-3}t}} ایٹم ہوں گے۔ اس عنصر کی نصف حیات تلاش کریں۔
...
کاربن 14 جس کی نصف حیات \عددی{5700} سال ہے، کو عموماً قدیم چیزوں کی عمر معلوم کرنے کے لیے استعمال کیا جاتا ہے۔ ایک نمونہ میں \عددی{\SI{10}{\percent}} تابکار کاربن کے ایٹم تبدیل تبدیل ہو چکے ہیں۔ اس نمونے کی عمر تلاش کریں۔
...
کاربن 14 کے علاوہ دیگر تابکار عناصر کو بھی تعین زمان کے لیے استعمال کیا جا سکتا ہے۔ یورینیم (جس کی نصف حیات \عددی{4.5} ارب سال ہے) کو \عددی{2} ارب سال پرانے چٹانوں کے عمر تلاش کرنے کے لیے استعمال کیا گیا ہے۔
...
\انتہا{سوال}
%===================
\ابتدا{سوال}\شناخت{سوال_ماورائی_اوسط_زندگی}\ترچھا{تابکار مادہ کی اوسط حیات}\\
تابکاری تحلیل کی مساوات \عددی{y=y_0e^{-kt}} میں  \عددی{\tfrac{1}{k}} کو تابکار مرکزہ کی \اصطلاح{اوسط حیات}\فرہنگ{اوسط حیات!مرکزہ}\حاشیہب{mean life}\فرہنگ{mean life!nucleus} کہتے ہیں۔ ریڈان مرکزہ کی اوسط حیات تقریباً \عددی{\tfrac{1}{0.18}=5.6} دن ہے۔ کاربن 12 کی اوسط حیات تقریباً \عددی{8000} سال ہے۔ دکھائیں کہ کسی بھی تابکار مادہ کی تین اوسط حیات کے برابر وقت میں \عددی{\SI{95}{\percent}} مادہ تبدیل ہو جائے گا۔ یوں نصف حیات سے آپ با آسانی معلوم کر سکتے ہیں کہ مادہ کتنے عرصہ میں  ختم ہو گا۔
\انتہا{سوال}
%=================
...
\end{align*}
\item
تفاعل \عددی{f(x)=(1+1/x)^x} کی قیمت \عددی{x=10,10^2,10^3,\cdots} کے لیے کیلکولیٹر کی مدد سے تلاش کرتے ہوئے دیکھیں کہ آپ اصل قیمت \عددی{e=\num{2.718281828459045}\cdots} کے کتنے قریب پہنچتے ہیں۔ اگرچہ ہم توقع کرتے ہیں کہ \عددی{x} کی قیمت بڑھانے سے زیادہ بہتر جواب حاصل ہو گا، بعض کیلکولیٹروں  میں پور و پور خلل کی وجہ سے کسی مخصوص حد سے \عددی{x} کی قیمت بڑھنے  کے بعد نتائج کم درست ہوں گے۔
\item
تفاعل \عددی{f(x)=(1+1/x)^x} کو ترسیم کریں۔ یہاں بھی \عددی{x} کی زیادہ بڑی قیمت پر پور و پور خلل کی وجہ سے نتیجہ کم درست ہو گا۔
\end{enumerate}
\انتہا{سوال}
%======================
\ابتدا{سوال}
...
ایسا معلوم ہوتا ہے کہ ترکیب یولر میں قدموں کی تعداد مزید بڑھا کر اس سے بھی بہتر نتیجہ حاصل ہو گا۔ حقیقت میں ایسا کرنے سے نا صرف کمپیوٹر کو حل حاصل کرنے میں زیادہ وقت درکار ہو گا بلکہ کمپیوٹر میں ہندسوں کی تعداد پر پابندی کی وجہ سے پیدا پور و پور خلل بڑھتا ہے۔
