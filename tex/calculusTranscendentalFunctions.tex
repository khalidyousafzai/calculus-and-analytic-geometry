...
وہ اعداد جو ناطق  ضریب  والے کثیر رکنی مساوات کو مطمئن کرتے ہوں \اصطلاح{الجبرائی} کہلاتے ہیں۔چونکہ \عددی{-2} مساوات \عددی{x+2=0} کو مطمئن کرتا ہے، لہٰذا \عددی{-2} الجبرائی عدد ہے۔ اسی طرح   \عددی{\sqrt{3}}  مساوات \عددی{x^2-3=0} کو مطمئن کرتا ہے، لہٰذا \عددی{\sqrt{3}} بھی الجبرائی عدد ہے۔ وہ اعداد جو الجبرائی نہ ہوں، \اصطلاح{ماورائی} کہلاتے ہیں۔یوں  \عددی{e} اور \عددی{\pi} ماورائی اعداد ہیں۔
...
(ا) نقطہ \عددی{x=0} پر \عددی{f(x)=2^x} کی خط بندی دریافت کریں۔ اس کے بعد ضرائب  کو \عددی{2} اعشاریہ مقامات تک   پورم پور کریں۔ (ب) وقفہ \عددی{-3\le x\le 3} اور وقفہ \عددی{-1\le x\le 1} کے لیے تفاعل اور خط بندی کو ایک ساتھ ترسیم کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
(ا) نقطہ \عددی{x=3} پر \عددی{f(x)=\log_3 x} کی خط بندی تلاش کریں۔ اس کے بعد ضرائب کو \عددی{2} اعشاریہ  مقامات تک پورم پور کریں۔   (ب) وقفہ \عددی{0\le x\le 8} اور \عددی{2\le x \le 4} کے لیے تفاعل اور خط بندی کو ایک ساتھ ترسیم کریں۔
\انتہا{سوال}
%====================
...
متغیر \عددی{x} کی  کون سی قیمت شکل \حوالہ{شکل_سوال_ماورائی_زیادہ_سے_زیادہ_زاویہ} میں \عددی{\theta} کو بڑے سے بڑا بناتی ہے؟ \عددی{\theta} کی بڑی سے بڑی  قیمت تلاش کریں۔ شروع اس سے کریں کہ \عددی{\theta=\pi-\cot^{-1}x-\cot^{-1}(2-x)} ہو گا۔
\انتہا{سوال}
%=====================
\begin{figure}
\centering
