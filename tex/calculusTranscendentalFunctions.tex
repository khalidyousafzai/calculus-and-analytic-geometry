...
اس کی تصدیق کرنے کی خاطر ہم دیکھتے ہیں (ذیل دیکھیں)  کہ آیا دونوں مرکب تفاعل شناختی تفاعل دیتے ہیں ۔
\begin{align*}
...
\end{align*}
قدم  \اردوعدد{2}:\quad
جزو (\اردوعدد{1})میں حاصل نتیجہ میں \عددی{x} اور \عددی{y} کا آپس میں تبادلہ کرتے ہیں۔
\begin{align*}
y=\sqrt{x}
\end{align*}
