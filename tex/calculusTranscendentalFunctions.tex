...
منبع دباو  کے ساتھ لمحہ \عددی{t=0} پر  مزاحمت \عددی{R} اور امالہ \عددی{L} کو سلسلہ وار جوڑا جاتا ہے ۔ اس دور کو درج ذیل مساوات ظاہر کرتی ہے
...
L\frac{\dif i}{\dif t}+Ri=V
\end{align*}
اگر \عددی{L=0} (امالہ کی غیر موجودگی) یا \عددی{\tfrac{\dif i}{\dif t}=0} (برقرار حال) ہو تب اس دور میں \عددی{i=\tfrac{V}{R}} ہو گا۔
...
\انتہا{سوال}
%====================
\ابتدا{سوال}\ترچھا{گریزی رفتار}\\
ہوا سے خالی چاند پر کمیت \عددی{m} کے جسم پر ثقلی قوت \عددی{F=-\tfrac{mgR^2}{s^2}} عمل کرتی ہے جہاں  چاند کے مرکز سے جسم تک فاصلہ \عددی{s} اور چاند کا رداس \عددی{R} ہے۔ چونکہ قوت \عددی{F} نیچے رخ عمل کرتا ہے لہٰذا اس کو  منفی لکھا گیا ہے۔ (ا) ایک جسم کو \عددی{t=0} پر سطح چاند سے  \عددی{v_0} رفتار کے ساتھ اوپر پھینکا جاتا ہے۔ قانون نیوٹن \عددی{F=ma} استعمال کرتے ہوئے  دکھائیں کہ مقام \عددی{s} پر جسم کی رفتار درج ذیل ہو گی۔
\begin{align*}
...
ایک سلسلہ وار \عددی{RL} دور پر لمحہ \عددی{t=0} پر برقی دباو لاگو کیا جاتا ہے۔ کتنی دیر میں برقرار حال برقی رو کی نصف قیمت تک دور میں برقی رو پہنچے گی؟ آپ دیکھیں گے کہ جواب کا دارومدار \عددی{R} اور \عددی{L} کی قیمتوں پر ہو گا نا کہ لاگو برقی دباو کی قیمت پر۔\\
جواب:\quad
\عددی{t=\tfrac{L}{R}\ln 2} سیکنڈ بعد
\انتہا{سوال}
%====================
\ابتدا{سوال}\ترچھا{تنزل برقی رو}\\
سلسلہ وار \عددی{RL} دور میں ابتدائی طور پر \عددی{I_0} برقی رو پائی جاتی ہے جو درج ذیل مساوات کے تحت وقت کے ساتھ گھٹتی ہے۔
\begin{align*}
