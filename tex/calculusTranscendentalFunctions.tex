...
%========================
\ابتدا{سوال}
ربع اول میں محددی لکیروں، منحنی \عددی{x=\tfrac{2}{\sqrt{y+1}}}،  اور لکیر \عددی{y=3} کے بیچ  خطے کو محور \عددی{y} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔اس جسم کا حجم تلاش کریں۔
 \انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$4\pi\ln 4$
...
\جزوحصہء{ایسی مساواتیں جن میں $\ln x$ اور $e^x$ پائے جاتے ہوں}
...
فرض کریں ہم کسی مقدار \عددی{y} (جو سمتی رفتار، درجہ حرارت، برقی رو، یا کچھ اور ہو سکتا ہے) میں دلچسپی رکھتے ہیں، جس میں کسی بھی لمحہ \عددی{t} پر اضافہ یا کمی اس لمحہ پائی جانے والی مقدار کے راست متناسب  ہے۔ اگر ہمیں لمحہ \عددی{t=0} پر مقدار کی قیمت \عددی{y_0} بھی معلوم ہو تب ہم درج ذیل ابتدائی قیمت مسئلہ حل کر کے  متغیر \عددی{t} کا تفاعل \عددی{y}  حاصل کر سکتے ہیں۔
\begin{gather}
...
تابکاری  کی شرح کو بغیر تجربہ بھی سمجھا جا سکتا ہے۔ فرض کریں  تابکار عنصر  کے ایک چھوٹے ٹکڑے سے، جس کی کمیت    \عددی{m}   ہے،  فی سیکنڈ  \عددی{c} ذرات خارج ہوتے  ہیں۔یوں ہم توقع کریں گے کہ  اس کے کسی دوسرے ٹکڑے سے، جس کی کمیت بھی       \عددی{m}    ہو، اسی شرح سے ذرات خارج ہوں گے۔یوں  دونوں ٹکڑوں کا مجموعی فی سیکنڈ اخراج    \عددی{(2c)} یعنی دگنا ہو گا۔ دوسرے  لفظوں  میں، کمیت دگنی کرنے سے  (جو  ایٹموں کی تعداد دگنی کرنے کے مترادف ہے) فی سیکنڈ ذرات کا اخراج  دگنا ہو گا۔اسی طرح   \عددی{n} ٹکڑوں سے، جہاں ہر ٹکڑے کی انفرادی کمیت \عددی{m} ہو، فی سیکنڈ اخراج \عددی{n} گنا ہو گا۔ یوں ہم دیکھتے ہیں کہ فی سیکنڈ اخراج اس لمحے کی   کمیت یعنی  ایٹموں کی تعداد \عددی{y} کے راست متناسب ہے، یعنی\عددی{\tfrac{\dif y}{\dif t}\propto y}   ہے۔
...
بعض کیمیائی اعمال میں اجزاء کی تبدیلی کی شرح اس لمحے پر  پائے  جانے والے مواد کی مقدار پر منحصر ہوتی ہے۔ ایسے ایک کیمیائی عمل کو 
\begin{align*}
...
برق گیر  سے برقی نکاسی کی شرح اس پر  پائے جانے والے برقی دباو کے راست متناسب ہے۔ یوں \عددی{t} سیکنڈ بعد اس پر دباو \عددی{V} درج ذیل کلیہ کو مطمئن کرتا ہے۔
\begin{align*}
...
زمانہ قدیم میں ایک آتش فشاں کے پھٹنے سے قریبی درخت جل جاتے ہیں اور آتش فشاں میں ایک جھیل بن جاتا ہے۔ اس جھیل میں پائے جانے والے  کوئلہ میں زندہ درختوں کے لحاظ سے  \عددی{\SI{44.5}{\percent}} کاربن\اردوعدد{14 } پایا جاتا ہے۔ یہ جھیل کتنا قدیم ہے؟\\
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
(ا) آپ کمپیوٹر کی مدد سے ایک کام سرانجام دینا چاہتے ہیں۔ آپ کے پاس تین الخوارزم   ہیں جن  کے لیے کمپیوٹر کو درکار   قدموں کی تعداد  درج ذیل تفاعل دیتے ہیں۔ \عددی{n} کی بڑی قیمت کی صورت میں ان میں سے کون سا الخوارزم سب سے بہتر  ہے؟ اپنے جواب کی وجہ پیش کریں۔
\begin{align*}
...
\انتہا{مثال}
%=====================
\جزوحصہء{ایسے تماثل جن میں معکوس سائن اور معکوس کوسائن پائے جاتے ہوں}
ہم شکل \حوالہ{شکل_ماورائی_کوسائن_اور_الٹ_کوسائن_تعلق} میں دیکھتے ہیں کہ \عددی{x} کا معکوس  کوسائن درج ذیل  تماثل
...
کو موزوں تماثل کے  تفرق  لے کر   کلیات\اردوعدد{1}،  \اردوعدد{3}،  اور \اردوعدد{5}    سے حاصل کیا جا سکتا ہے (سوال \حوالہ{سوال_ماورائی_الٹ_تکونیاتی_تفرقی_کلیات_الف} تا سوال \حوالہ{سوال_ماورائی_الٹ_تکونیاتی_تفرقی_کلیات_ب})۔
...
درج ذیل تماثل استعمال کرتے ہوئے    جدول \حوالہ{جدول_ماورائی_معکوس_تکونیاتی_تفرق} میں  \عددی{\cos^{-1}u} کے تفرق  کا کلیہ   \عددی{\sin^{-1} u}  کے تفرق کے کلیہ سے اخذ کریں۔
\begin{align*}
...
%look at the numbering carefully
\ابتدا{سوال}
درج ذیل تماثل استعمال کرتے ہوئے   جدول \حوالہ{جدول_ماورائی_معکوس_تکونیاتی_تفرق}  میں  \عددی{\cot^{-1}u} کے تفرق  کا کلیہ   \عددی{\tan^{-1} u}  کے تفرق کے کلیہ سے اخذ کریں۔
\begin{align*}
...
درج ذیل تماثل استعمال کرتے ہوئے  جدول \حوالہ{جدول_ماورائی_معکوس_تکونیاتی_تفرق} میں  \عددی{\csc^{-1}u} کے تفرق  کا کلیہ   \عددی{\sec^{-1} u}  کے تفرق کے کلیہ سے اخذ کریں۔
\begin{align*}
...
\جزوحصہء{تماثل}
ہذلولی تفاعل جدول \حوالہ{جدول_ماورائی_تماثل} میں دیے گئے تماثل کو مطمئن کرتے ہیں۔ ماسوائے علامت میں فرق  کے، ہم ان تماثل کو تکونیاتی تفاعل کے لئے  جانتے ہیں۔
...
چند کارآمد تماثل کو جدول \حوالہ{جدول_ماورائی_چند_کارآمد_تماثل} میں پیش کیا گیا ہے۔ تفاعل \عددی{\cosh^{-1}x}، \عددی{\sinh^{-1}x}،  اور \عددی{\tanh^{-1}x} کی قیمتیں جانتے ہوئے ان تماثل کے استعمال سے  \عددی{\sech^{-1}x}، \عددی{\csch^{-1}x}،  اور \عددی{\coth^{-1}x} کی قیمتیں حاصل کی جا سکتی ہیں۔

\begin{table}
\caption{معکوس ہذلولی تفاعل کے چند کارآمد تماثل}
...
سوال \حوالہ{سوال_ماورائی_باقی_ہذلولی_تلاش_الف} تا سوال \حوالہ{سوال_ماورائی_باقی_ہذلولی_تلاش_ب} میں \عددی{\sinh x} یا \عددی{\cosh x} کی ایک قیمت دی گئی ہے۔ تماثل \عددی{\cosh^2x-\sinh^2=1} اور ہذلولی تفاعل کی تعریف استعمال کرتے ہوئے باقی پانچ ہذلولی تفاعلات  کی قیمتیں تلاش کریں۔
...
%============================
\ابتدا{سوال}
ربع اول میں بالائی طرف سے قوس \عددی{y=\cosh x}، زیریں طرف سے قوس \عددی{y=\sinh x}، بائیں سے محور \عددی{y}، اور دائیں سے لکیر \عددی{x=2}  کے بیچ  واقع خطے کو محور \عددی{x} کے گرد گھما کر جسم طواف پیدا کیا جاتا ہے۔اس جسم کا حجم تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$2\pi$
...
\end{align*}
حاصل کرتے ہیں۔ تکمل سے درکار حل حاصل ہوتا ہے جس میں \عددی{y}، متغیر \عددی{x} کا صریح تفاعل  یا خفی تفاعل ہو گا  اور اس میں   اختیاری  مستقل بھی  پایا جائے گا۔
...
آئیں دیکھتے ہیں کہ \عددی{v} سے ضرب دینا کیوں کارآمد ثابت ہوتا ہے۔
\begin{gather}
...
v(x)=e^{\int P(x)\dif x}
\end{align}
ہے۔ تفاعل \عددی{v(x)} کے کلیہ میں \عددی{P(x)} کے ضد تفرق کی عمومی صورت کی ضرورت نہیں ہو گی بلکہ اس کا کوئی بھی ضد تفرق کارآمد ہو گا۔
\انتہا{مسئلہ}
%=================
...
\end{align*} 
 گلوکوز کی شرح \عددی{G} کو  فی منٹ ملی گرام میں  ناپا جاتا ہے، جبکہ بدن میں خون کے  حجم  \عددی{V}  کو لٹر میں   ناپا جاتا ہے جو  بالغ  شخص کے لیے تقریباً \عددی{\SI{5}{\liter}} ہو گا۔ ارتکاز \عددی{c(t)} کو ملی گرام فی   سنٹی لٹر   میں ناپا جاتا ہے۔جزو \عددی{-kc} کو اس لیے شامل کیا گیا ہے کہ گلوکوز مسلسل دیگر اجزاء میں تبدیل ہو گا اور اس تبدیلی کی شرح اس وقت  پائے جانے والے  گلوکوز کی مقدار  کے راست متناسب ہو گی۔ (ا) \عددی{c(0)} کو \عددی{c_0} سے ظاہر کرتے ہوئے اس مساوات کو حل کریں۔ (ب) برقرار حال ارتکاز \عددی{\lim_{t\to \infty}c(t)} تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
...
\ابتدا{سوال}
ایک حوض میں ابتدائی طور پر \عددی{500} لٹر نمکین   پانی   پایا جاتا ہے،  جس میں \عددی{\SI{25}{\kilo\gram}} نمک حل ہے۔ حوض میں \عددی{\SI{5}{\liter\per\minute}} کی  شرح سے نمکین پانی داخلی ہوتا ہے،  جس میں \عددی{\SI{0.4}{\kilo\gram\per\litre}} نمک ملا ہوا ہے،  جبکہ حوض سے نمکین  پانی کا انخلا \عددی{\SI{4}{\liter\per\minute}} ہے۔ حوض میں نمکین پانی کو مسلسل ہلا کر یکساں رکھا جاتا ہے۔
\begin{enumerate}[a.]
\item
...
%=====================
\ابتدا{سوال}
تیل\اصطلاح{تصفیہ خانہ }\فرہنگ{تصفیہ خانہ}\حاشیہب{refinery}\فرہنگ{refinery}  کے ایک حوض میں \عددی{\SI{10000}{\liter}} تیل    پایا جاتا ہے،  جس میں ابتدائی طور پر \عددی{\SI{50}{\kilo\gram}} اضافی مادّہ شامل ہے۔ سردی کے موسم کی وجہ سے اس میں \عددی{\SI{0.4}{\kilo\gram}} فی لٹر اضافی مواد کو  \عددی{\SI{200}{\liter\per\minute}} شامل کیا جاتا ہے۔ حوض میں تیل کو اچھی طرح ہلا کر یکساں رکھا جاتا ہے۔ حوض سے مرکب کے اخراج   کی شرح \عددی{\SI{225}{\liter\per\minute}} ہے۔ اس عمل کے شروع ہونے کے \عددی{20} منٹ بعد حوض میں اضافی مواد کی مقدار معلوم کریں۔
\انتہا{سوال}
%======================
\ابتدا{سوال}
ایک حوض میں \عددی{\SI{500}{\liter}} خالص پانی  پایا جاتا  ہے۔ ایک محلول،  جس میں \عددی{\SI{0.1}{\kilo\gram\per\liter}}  کھاد پایا جاتا ہے، کو \عددی{\SI{5}{\liter\per\minute}} کی  شرح سے حوض میں شامل کیا جاتا ہے۔ حوض سے محلول کا اخراج  \عددی{\SI{15}{\liter\per\minute}} ہے۔ حوض میں کھاد کی اعظم مقدار معلوم کریں اور اس مقدار تک پہنچنے کے لیے درکار وقت معلوم کریں۔
\انتہا{سوال}
%====================
\ابتدا{سوال}
 دفتر کے ایک کمرے میں ابتدائی طور پر \عددی{\SI{150}{\meter\cubed}} صاف ہوا   پائی جاتی ہے۔ لمحہ \عددی{t=0} پر قریبی کمرے  میں   کام کرنے والے  افسران سگریٹ نوشی شروع کرتے ہیں جس کی وجہ سے  \عددی{\SI{4}{\percent}} زہریلی کاربن مونو اکسائڈ \عددی{\SI{0.01}{\meter\cubed\per\minute}}  کی شرح سے اس کمرے  میں داخل ہوتی ہے،  جہاں ایک پنکھا پوری ہوا کو یکساں رکھتا ہے۔ کمرے سے ہوا کا انخلا \عددی{\SI{0.01}{\meter\cubed\per\minute}} ہے۔  کمرے میں کب زہریلی گیس \عددی{\SI{0.01}{\percent}} ہو گی؟
\انتہا{سوال}
