...
\حصہ{قدرتی لوگارتھم}
ریاضیات اور سائنس میں اہم ترین تفاعل اور الٹ کی جوڑی قدرتی لوگارتھم \عددی{\ln x}اور قوت نما تفاعل \عددی{e^x} کی جوڑی ہے۔ تفاعل \عددی{e^x} کا مطلب \عددی{\ln x} سے واضح ہوتا ہے لہٰذا ہم پہلے \عددی{\ln x} کو متعارف کرتے ہیں۔ سب سے پہلے لوگارتھم نے ریاضیات میں بہتری پیدا کی۔ لوگارتھم کی  خوبیوں نے سترھویں صدی میں آفاقی میکانیات کا حساب اور ساحل سے دور سمت شناسی ممکن بنایا۔ اگرچہ آج کل پیچیدہ حساب کمپیوٹر کی مدد سے کیا جاتا ہے، بہر حال لوگارتھم کی خوبیاں آج بھی اتنی ہی اہمیت رکھتی ہیں۔
