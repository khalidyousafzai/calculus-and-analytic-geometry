...
\end{align}
  محددی محوروں کو \عددی{(\mp a,0,0)}، \عددی{(0,\mp b,0)} اور \عددی{(0,0,\mp c)} پر مس کرتا ہے (شکل \حوالہ{شکل_سمتیہ_ترخیمی-سطح})۔ یہ اس مستطیل ڈبہ \عددی{\abs{x}\le a} ،
...
\end{align}
سطح \عددی{x=0} اور سطح \عددی{y=0} کے لحاظ سے تشاکلی ہے۔ قطع زائد قطع مکافی کی ان سطحوں کے ساتھ تقاطع درج ذیل ہوں گے۔
\begin{align}
