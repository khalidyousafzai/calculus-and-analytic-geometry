\باب{سمتیات اور خلا میں تحلیلی ہندسہ}
اس حصہ میں سمتیات اور سہ بُعدی محددی نظام متعارف کیے جائیں گے۔ جیسا ایک متغیر کے تفاعل پر غور کے لیے محددی مستوی موزوں ہے، اسی طرح دو   یا دو سے زیادہ متغیرات کے تفاعل پر غور کے لیے محددی خلاء موزوں ہے۔ ہم محددی مستوی میں تیسرا محور شامل کر کے محددی خلاء پیدا کرتے ہیں۔ یہ محور مستوی  \عددی{xy} سے نیچے اور اس سے اوپر فاصلہ ناپتا ہے۔

\حصہ{مستوی میں سمتیات} 
بعض چیزیں جنہیں ہم ناپتے ہیں کا تعین ان کی مقدار سے ہوتا ہے۔مثال کے طور پر کمیت، لمبائی،  اور وقت قلم بند کرنے کے لیے  ہم صرف ایک عدد اور موزوں اکائی لکھتے ہیں۔ اس کے برعکس قوت، ہٹاؤ، یا سمتی رفتار جاننے کے لیے ہمیں مزید معلومات  درکار ہو گی۔ قوت کو بیان کرنے کے لیے ہمیں اس کی مقدار کے ساتھ وہ رخ بھی جاننا ہو گا جس رخ یہ عمل کرتی ہے۔ کسی جسم کا ہٹاؤ بیان کرنے کے لیے ہمیں اس سمت کا ذکر کرنا ہو گا جس سمت یہ جسم حرکت کرتا ہے اور ساتھ  اس فاصلے  کا ذکر کرنا ہو گا جتنا یہ طے کرتا ہے۔ ایک جسم کی سمتی رفتار بیان کرنے کے لیے ہم حرکت کی سمت اور جسم کی رفتار کی بات کرتے ہیں۔

وہ مقدار جس کی جسامت اور سمت دونوں ہوں ، اسے  عموماً تیر کے نشان سے ظاہر کیا جاتا ہے جہاں مقدار کے رخ کو  تیر کا رخ  مقدار  کی جسامت کو، موزوں اکائیوں میں، تیر کی لمبائی ظاہر کرتی ہے۔

تیر دار لکیروں کو ہم سمت بند خطوط تصور کرتے ہیں  اور \اصطلاح{سمتیات} کہتے ہیں۔

\ابتدا{تعریف}
ایک مستوی میں سمت بند خط کو \اصطلاح{سمتیہ}\فرہنگ{سمتیہ}\حاشیہب{vector}\فرہنگ{vector} کہتے ہیں۔ دو سمتیات صرف اس صورت ایک دوسرے کے برابر یا یکساں ہوں گے جب ان کی مقداریں ایک جتنی ہوں اور ان کے رخ ایک  جیسے   ہوں۔
\انتہا{تعریف}
%===================

یوں اگر سمتیات کو ظاہر کرنے والے تیر  آپس میں متوازی ہوں، ان کی لمبائیاں ایک جتنی ہوں اور ان کا رخ بھی ایک  جیسا  ہو تب یہ ایک ہی  سمتیہ کو ظاہر کرتے ہیں۔اس  کتاب میں سمتیہ کو موٹی لکھائی میں رومانی حروف تہجی، مثلاً   \عددی{\kvec{v}}،  سے ظاہر کیا جائے گا\حاشیہد{قلم و کاغذ استعمال کرتے ہوئے سمتیہ کو رومانی  حروف تہجی پر تیر کا نشان \عددی{\vec{v}} یا نصف تیر کا نشان
$\krightharpoonup{v}$
...
چار تیروں کو شکل \حوالہ{شکل_مثال_سمتیہ_یکساں_چار} میں دکھایا گیا ہے جن کی لمبائیاں اور رخ ایک جیسے ہیں۔ یوں  چاروں  تیر ایک ہی سمتیہ کو ظاہر کرتے ہیں جس کو ہم درج ذیل لکھتے ہیں۔
\begin{align*}
...
\end{tikzpicture}
\caption{سمتیہ کے عددیہ مضرب۔}
\label{شکل_سمتیہ_غیر_سمتی_مضرب}
\end{minipage}
\end{figure}
\جزوحصہء{عددیے  اور عددیہ مضرب}
ہم کسی سمتیہ کو مثبت حقیقی عدد سے ضرب دینے کے لیے اس کی لمبائی کو اس عدد سے ضرب دیتے ہیں (شکل \حوالہ{شکل_سمتیہ_غیر_سمتی_مضرب})۔ سمتیہ کو \عددی{2} سے ضرب دینے کے لیے ہم اس کی لمبائی دگنی کرتے ہیں۔ ایک سمتیہ کو \عددی{1.5} سے ضرب دینے کے لیے ہم اس کی لمبائی \عددی{\SI{50}{\percent}} بڑھاتے ہیں، وغیرہ۔ ایک سمتیہ کو منفی  عدد سے ضرب دینے کے لیے ہم اس کا رخ الٹ کر کے اس کی لمبائی کو عدد کی مطلق قیمت سے ضرب دیتے ہیں۔

اگر \عددی{c} غیر صفر حقیقی عدد اور \عددی{\kvec{v}} ایک سمتیہ ہو تب مثبت \عددی{c} کی صورت میں \عددی{\kvec{v}} اور \عددی{c\kvec{v}} کے رخ ایک  سے ہوں گے جبکہ منفی \عددی{c} کی صورت میں ان کے رخ ایک دوسرے کے مخالف ہوں گے۔ یہاں حقیقی اعداد تبدیلی پیمانہ کے طور پر کام کرتے ہیں اور یہ  \اصطلاح{عددیہ}\فرہنگ{عددیہ}\حاشیہب{scalar}\فرہنگ{scalar} کہلاتے ہیں جبکہ \عددی{c\kvec{v}} کے مضرب کو \عددی{\kvec{v}} کا \اصطلاح{عددیہ مضرب}\فرہنگ{عددیہ!مضرب}\حاشیہب{scalar multiple}\فرہنگ{scalar multiple} کہتے ہیں۔
...
دو غیر صفر سمتیات \عددی{\kvec{v}_1} اور \عددی{\kvec{v}_2} کا جیومیٹریائی مجموعہ لینے کی خاطر \عددی{\kvec{v}_1} کا نمائندہ، مثلاً \عددی{A} سے \عددی{B} تک، ترسیم کر کے \عددی{\kvec{v}_1} کے اختتامی نقطہ (سر) \عددی{B} پر \عددی{\kvec{v}_2}  کے نمائندہ کا ابتدائی نقطہ (دُم)  رکھ کر ترسیم کریں۔ شکل \حوالہ{شکل_سمتیات_کا_مجموعہ} میں
$\kvec{v}_2=\krightharpoonup{BC}$
ہے۔ مجموعہ \عددی{\kvec{v}_1+\kvec{v}_2} اب \عددی{\kvec{v}_1} کی دُم  \عددی{A} سے \عددی{\kvec{v}_2} کے سر  \عددی{C} تک سمتیہ ہو گا۔ یوں اگر
\begin{align*}
...
\end{tikzpicture}
\caption{قاعدہ متوازی الاضلاع۔ مخالف اضلاع یکساں لمبائی ہونے کی وجہ سے \عددی{ABCD} متوازی الاضلاع ہو گا۔}
\label{شکل_سمتیہ_قاعدہ_متوازی_الاضلاع}
\end{minipage}
\end{figure}
\جزوحصہء{اجزاء}
دو سمتیات اس صورت متوازی ہوں گے جب یہ ایک دوسرے کے غیر صفر، عددیہ مضرب ہوں، یعنی جب ان کو ظاہر کرنے والے خطوط متوازی ہوں۔
...
سمتیات کے  مقبول ترین الجبرا میں ہر سمتیہ کو کارتیسی محور کے متوازی اجزاء کی صورت میں بیان کیا جاتا ہے اور یہ اجزاء از خود موزوں \اصطلاح{اساسی}\فرہنگ{اساسی}\حاشیہب{basic}\فرہنگ{basic} سمتیہ، جن کی لمبائی \عددی{1} ہوتی ہے، کے مضرب ہوتے ہیں۔ مثبت محور \عددی{x} کے رخ اساسی سمتیہ نقطہ \عددی{(0,0)} سے نقطہ \عددی{(1,0)} تک تیر سے ظاہر کیا جاتا ہے  اور اس اساسی سمتیہ کی علامت  \عددی{\ai} ہے۔ مثبت محور \عددی{y} کے رخ اساسی سمتیہ نقطہ \عددی{(0,0)} سے نقطہ \عددی{(0,1)} تک تیر سے ظاہر کیا جاتا ہے اور اس اساسی سمتیہ کی علامت  \عددی{\aj} ہے۔ اب عددیہ \عددی{a} کے لیے  محور \عددی{x} کے متوازی  سمتیہ \عددی{a\ai}  کی لمبائی \عددی{\abs{a}} ہو گی جبکہ اس کا رخ \عددی{a>0} کے لیے  دایاں اور  \عددی{a<0} کے لیے بایاں ہو گا۔ اس طرح عددیہ \عددی{b} کے لیے  محور \عددی{y} کے متوازی  سمتیہ \عددی{b\aj}  کی لمبائی \عددی{\abs{b}} ہو گی جبکہ اس کا رخ \عددی{b>0} کے لیے  اوپر اور  \عددی{b<0} کے لیے نیچے ہو گا۔ شکل \حوالہ{شکل_سمتیہ_اساسی} میں سمتیہ 
...
\ابتدا{تعریف}
اگر \عددی{\kvec{v}=a\ai+b\aj} ہو تب \عددی{\ai} اور \عددی{\aj} کے رخ، سمتیہ \عددی{\kvec{v}} کے اجزاء  سمتیات \عددی{a\ai} اور \عددی{b\aj} ہوں گے۔ اعداد \عددی{a} اور \عددی{b}، اساسی سمتیات \عددی{\ai} اور \عددی{\aj} کے رخ، سمتیہ \عددی{\kvec{v}} کے عددیہ اجزاء ہوں گے۔ 
\انتہا{تعریف}
%================
...
دو سمتیات صرف اور صرف اس صورت ایک دوسرے کے برابر ہوں گے جب \عددی{\ai} اور \عددی{\aj} کے رخ، ان کے مطابقتی عددیہ اجزاء ایک دوسرے کے برابر ہوں۔

\جزوحصہء{الجبرائی مجموعہ}
سمتیات کے مطابقتی عددیہ اجزاء کا مجموعہ لے کر ان سمتیات  کا مجموعہ حاصل کیا جا سکتا ہے (شکل \حوالہ{شکل_سمتیات_مجموعی_اجزاء})۔
...
ہم نقطہ \عددی{N_1(x_1,y_1)} سے نقطہ \عددی{N_2(x_2,y_2)} تک سمتیہ کے اجزاء حاصل کرنے کے لیے \عددی{\krightharpoonup{ON_1}=x_1\ai+y_1\aj} کے اجزاء کو \عددی{\krightharpoonup{ON_2}=x_2\ai+y_2\aj} کے اجزاء سے منفی کرتے ہیں۔
...
\حل
ہم قوت \عددی{\kvec{F}=a\ai+b\aj} اور اس کے اجزاء کے لیے مثلث  بناتے ہیں (شکل \حوالہ{شکل_مثال_سمتیہ_ہاتھ_ریڑھی}-ب اور شکل \حوالہ{شکل_مثال_سمتیہ_ہاتھ_ریڑھی}-ج)۔ اس مثلث سے \عددی{a=10\sqrt{3}} اور \عددی{b=10} حاصل ہوتے ہیں۔ قوت کا افقی جزو \عددی{10\sqrt{3}\ai} اور انتصابی جزو \عددی{-10\aj} ہے۔یوں \عددی{\kvec{F}=10\sqrt{3}\ai-10\aj} ہو گا۔  انتصابی جزو کا رخ نیچے ہے لہٰذا یہ منفی ہے۔ 
\انتہا{مثال}
%==================
\begin{figure}
\centering
...
\end{figure}
\جزوحصہء{عددیہ ضرب}
عددیہ ضرب جزو در جزو حاصل کیا جا سکتا ہے۔ اگر \عددی{c} ایک عددیہ اور \عددی{\kvec{v}=a\ai+b\aj} ایک سمتیہ ہو تب درج ذیل ہو گا۔
\begin{align}
...
یوں اگر \عددی{c} عددیہ ہو اور \عددی{\kvec{v}} ایک سمتیہ ہو تب \عددی{\abs{c\kvec{v}}=\abs{c}\abs{\kvec{v}}} ہو گا۔
...
\kvec{0}=0\ai+0\aj
\end{align*}
دھیان رہے کہ صفر سمتیہ \عددی{\kvec{0}} کو ظاہر کرنے کے لیے \عددی{0} کو موٹی لکھائی میں لکھا جاتا ہے۔صفر سمتیہ وہ واحد سمتیہ ہے جس کی لمبائی صفر ہے۔ یہ حقیقت درج ذیل سے واضح ہے۔
\begin{align*}
...
ایک سمتیہ اس صورت ایک خط کے متوازی ہو گا جب سمتیہ کو ظاہر کرنے والا قطعہ اور یہ خط متوازی ہوں۔ ایک غیر انتصابی سمتیہ کا ڈھلوان ان خطوط کا ڈھلوان ہو گی جو اس سمتیہ کے متوازی ہوں۔ یوں \عددی{a\ne 0} کی صورت میں سمتیہ \عددی{\kvec{v}=a\ai+b\aj} کا ڈھلوان \عددی{\tfrac{b}{a}} ہو گا (شکل \حوالہ{شکل_سمتیہ_ڈھلوان_تعریف})۔
...
\end{tikzpicture}
\caption{اگر \عددی{a\ne 0} ہو تب سمتیہ \عددی{\kvec{v}=a\ai+b\aj} کا ڈھلوان \عددی{\tfrac{b}{a}} ہو گی۔}
...
اس نقطہ پر منحنی کے مماس کا ڈھلوان درج ذیل ہو گی۔
\begin{align*}
y'=\left.\frac{3x^2}{2}\right\vert_{x=1}=\frac{3}{2}
\end{align*}
ہم اتنی ڈھلوان کی اکائی سمتیہ تلاش کرتے ہیں۔ سمتیہ \عددی{\kvec{v}=2\ai+3\aj} اور اس کے ہر غیر صفر مضرب کا ڈھلوان \عددی{\tfrac{3}{2}} ہے۔ سمتیہ  \عددی{\kvec{v}} کا ایسا مضرب معلوم کرنے کے لیے جس کی لمبائی \عددی{1} ہو ہم \عددی{\kvec{v}} کو 
\begin{align*}
...
نقطہ \عددی{(1,1)} پر منحنی کا عمودی سمتیہ تلاش کرنے کی خاطر ہم ایسا اکائی سمتیہ معلوم کرتے ہیں جس کا ڈھلوان \عددی{\kvec{u}} کے  ڈھلوان کا  منفی مقلوب  کے  ہو۔ ہم \عددی{\kvec{u}} کے عددیہ اجزاء کے مقامات آپس میں تبدیل کر کے اور ان میں سے کسی ایک کی علامت بدل کر ایسا سمتیہ معلوم کر سکتے ہیں۔ یوں درج ذیل حاصل ہو گا۔
\begin{align*}
...
\انتہا{مثال}
%====================
%sec 11.1 questions start here
%sec 11.1 questions start here
\حصہء{سوالات}
\ابتدا{سوالات}
\موٹا{جیومیٹری اور حساب}\\
\ابتدا{سوال}\شناخت{سوال_سمتیہ_الف}
مستوی میں پائے جانے والے سمتیات \عددی{\kvec{A}}، \عددی{\kvec{B}} اور \عددی{\kvec{C}} کو شکل \حوالہ{شکل_سوال_سمتیہ_الف} میں دکھایا گیا ہے۔ انہیں کاغذ پر اتار کر سر کے ساتھ دُم جوڑ کر درج ذیل ترسیم کریں۔
\begin{multicols}{4}
\begin{enumerate}[a.]
\item
$\kvec{A}+\kvec{B}$
...
مستوی میں پائے جانے والے سمتیات \عددی{\kvec{A}}، \عددی{\kvec{B}} اور \عددی{\kvec{C}} کو شکل \حوالہ{شکل_سوال_سمتیہ_ب} میں دکھایا گیا ہے۔ انہیں کاغذ پر اتار کر سر کے ساتھ دُم جوڑ کر درج ذیل ترسیم کریں۔
\begin{multicols}{4}
\begin{enumerate}[a.]
\item
$\kvec{A}-\kvec{B}$
...
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{$(6-\tfrac{\sqrt{3}}{\pi})\ai-20\aj$}}
\انتہا{جواب}
%====================
...
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{(ا) \عددی{\kvec{w}=\kvec{v}+\kvec{u}} (ب) \عددی{\kvec{v}=\kvec{w}-\kvec{u}}}}
\انتہا{جواب}
%===================
%Q8
...
نقاط \عددی{N_1(5,7)} اور \عددی{N_2(2,9)} کے بیچ قطعہ \عددی{\krightharpoonup{N_1N_2}} تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
\begin{minipage}{0.45\textwidth}
...
\addplot[-latex,thick] plot coordinates {(0,0)(-3,2)}node[pos=0.85,above right]{$-3\ai+2\aj$};
\end{axis}
\end{tikzpicture}
\end{minipage}
}}
...
%Q10
\ابتدا{سوال}
نقاط \عددی{N_1(1,2)} اور \عددی{N_2(-3,5)} کے بیچ قطعہ \عددی{\krightharpoonup{N_1N_2}}  تلاش کریں۔
\انتہا{سوال}
%======================
\ابتدا{سوال}\شناخت{سوال_سمتیہ_نقطہ_ب}
نقاط \عددی{A(-5,3)} اور \عددی{B(-10,8)} کے بیچ قطعہ \عددی{\krightharpoonup{AB}}  تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
\begin{minipage}{0.45\textwidth}
...
\addplot[-latex,thick] plot coordinates {(0,0)(-5,5)}node[pos=0.5,below left]{$-5\ai+5\aj$};
\end{axis}
\end{tikzpicture}
\end{minipage}
}}
...
%Q12
\ابتدا{سوال}
نقاط \عددی{A(-7,-8)} اور \عددی{B(6,11)} کے بیچ قطعہ \عددی{\krightharpoonup{AB}}  تلاش کریں۔
\انتہا{سوال}
%======================
\ابتدا{سوال}\شناخت{سوال_سمتیہ_نقطہ_پ}
نقاط \عددی{N_1(1,3)} اور \عددی{N_2(2,-1)} کے بیچ قطعہ \عددی{\krightharpoonup{N_1N_2}}  تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
\begin{minipage}{0.45\textwidth}
...
\addplot[-latex,thick] plot coordinates {(0,0)(1,-4)}node[pos=0.5,below left]{$\ai-4\aj$};
\end{axis}
\end{tikzpicture}
\end{minipage}
}}
...
%Q14
\ابتدا{سوال}
نقاط \عددی{N_3(1,3)} اور \عددی{N_4} کے بیچ قطعہ \عددی{\krightharpoonup{N_3N_4}}  تلاش کریں جہاں \عددی{N_1(2,-1)} اور \عددی{N_2(-4,3)} کو ملانے والے قطعہ کا وسطی نقطہ \عددی{N_4} ہے۔
\انتہا{سوال}
%======================
...
\addplot[-latex,thick] plot coordinates {(0,0)(1,1)}node[below right]{$\krightharpoonup{AB}=\ai+\aj$};
\addplot[-latex,thick] plot coordinates {(0,0)(-1,-1)}node[below right]{$\krightharpoonup{CD}=\ai-\aj$};
\addplot[]plot coordinates {(0,0)}node[circ]{}node[pin={[font=\tiny,pin distance=0.1cm]135:{$\krightharpoonup{AB}+\krightharpoonup{CD}=\kvec{0}$}}]{};
\end{axis}
\end{tikzpicture}
\end{minipage}
}}
...
زاویہ \عددی{\theta=\tfrac{\pi}{6}} اور \عددی{\theta=\tfrac{2\pi}{3}} کے لیے اکائی سمتیات \عددی{\kvec{u}=(\cos\theta)\ai+(\sin\theta)\aj} ترسیم کریں۔ دائرہ \عددی{x^2+y^2=1} کی ترسیم بھی شامل کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
\begin{minipage}{0.45\textwidth}
...
%Q20
\ابتدا{سوال}
زاویہ \عددی{\theta=-\tfrac{\pi}{4}} اور \عددی{\theta=-\tfrac{3\pi}{4}} کے لیے اکائی سمتیات \عددی{\kvec{u}=(\cos\theta)\ai+(\sin\theta)\aj} ترسیم کریں۔ دائرہ \عددی{x^2+y^2=1} کی ترسیم بھی شامل کریں۔
\انتہا{سوال}
%======================
...
\addplot[-latex,thick]plot coordinates {(0,0)(\k,\k)}node[pos=0.5,left]{$-\tfrac{\sqrt{2}}{2}\ai-\tfrac{\sqrt{2}}{2}\aj$};
\end{axis}
\end{tikzpicture}
\end{minipage}
}}
...
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{$\tfrac{3}{5}\ai-\tfrac{4}{5}\aj$}}
\انتہا{جواب}
%==================
%Q24
...
\ابتدا{جواب}
\wf{\unexpanded{
$\kvec{u}=\tfrac{1}{\sqrt{17}}\ai+\tfrac{4}{\sqrt{17}}\aj,\\
-\kvec{u}=-\tfrac{1}{\sqrt{17}}\ai-\tfrac{4}{\sqrt{17}}\aj,\\
 \kvec{n}=\tfrac{4}{\sqrt{17}}\ai-\tfrac{1}{\sqrt{17}}\aj,\\
 -\kvec{n}{=}-\tfrac{4}{\sqrt{17}}\ai+\tfrac{1}{\sqrt{17}}\aj\\$
}}
\wf{\unexpanded{
\begin{minipage}{0.45\textwidth}
...
\draw[-latex,thick] (axis cs:2,4)--(axis cs:2+\k,4+4*\k)node[above right]{$\kvec{u}$};
\draw[-latex,thick] (axis cs:2,4)--(axis cs:2-\k,4-4*\k)node[xshift=1.5ex]{$-\kvec{u}$};
\draw[-latex,thick] (axis cs:2,4)--(axis cs:2+4*\k,4-\k)node[right]{$\kvec{n}$};
\draw[-latex,thick] (axis cs:2,4)--(axis cs:2-4*\k,4+\k)node[yshift=1ex]{$-\kvec{n}$};
\end{axis}
\end{tikzpicture}
\end{minipage}
}}
...
\ابتدا{جواب}
\wf{\unexpanded{
$\kvec{u}=\tfrac{1}{\sqrt{5}}(2\ai+\aj),\\
-\kvec{u}=\tfrac{1}{\sqrt{5}}(-2\ai-\aj),\\
\kvec{n}=\tfrac{1}{\sqrt{5}}(-\ai+2\aj),\\
 -\kvec{n}=\tfrac{1}{\sqrt{5}}(\ai-2\aj),\\$
\begin{minipage}{0.22\textwidth}
\centering
...
\addplot[-latex,thick] plot coordinates {(1,pi/4)(1+\k,pi/4+1/2*\k)}node[above]{$\kvec{u}$};
\addplot[-latex,thick] plot coordinates {(1,pi/4)(1-\k,pi/4-1/2*\k)}node[left]{$-\kvec{u}$};
\addplot[-latex,thick] plot coordinates {(1,pi/4)(1+1/2*\k,pi/4-\k)}node[below]{$\kvec{n}$};
\addplot[-latex,thick] plot coordinates {(1,pi/4)(1-1/2*\k,pi/4+\k)}node[above]{$-\kvec{n}$};
\end{axis}
\end{tikzpicture}
\end{minipage}
}}
...
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{$\kvec{u}=\pm\tfrac{1}{5}(-4\ai+3\aj),\\
 \kvec{v}=\pm\tfrac{1}{5}(3\ai+4\aj)$}}
\انتہا{جواب}
%=====================
%Q30
\ابتدا{سوال}
...
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{$\kvec{u}=\pm\tfrac{1}{2}(\ai+\sqrt{3}\aj),\\
 \kvec{v}=\pm\tfrac{1}{2}(-\sqrt{3}\ai+\aj)$}}
\انتہا{جواب}
%=====================
%Q32
...
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{$13(\tfrac{5}{13}\ai+\tfrac{12}{13}\aj)$}}
\انتہا{جواب}
%====================
%Q34
...
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{$\tfrac{3}{5}\ai-\tfrac{4}{5}\aj,\quad -\tfrac{3}{5}\ai+\tfrac{4}{5}\aj$}}
\انتہا{جواب}
%=======================
%Q36
\ابتدا{سوال}
...
%=========================
\ابتدا{سوال}
دکھائیں کہ \عددی{\kvec{A}=3\ai+6\aj} اور \عددی{\kvec{B}=-\ai-2\aj} ایک دوسرے کے مخالف رخ ہیں۔ دونوں کا خاکہ بنائیں۔
\انتہا{سوال}
%=======================
%Q38
\ابتدا{سوال}
دکھائیں کہ \عددی{\kvec{A}=3\ai+6\aj} اور \عددی{\kvec{B}=\tfrac{1}{2}\ai+\aj} کے رخ ایک دوسرے جیسے ہیں۔
\انتہا{سوال}
%=======================
...
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{$5\sqrt{3}\ai,\quad 5\aj$}}
\انتہا{جواب}
%===================
%Q40
\ابتدا{سوال}
...
سمتیہ \عددی{\kvec{A}=2\ai+\aj}، \عددی{\kvec{B}=\ai+\aj} اور \عددی{\kvec{C}=\ai-\aj} دیے گئے ہیں۔ ایسے عددیے  \عددی{\alpha} اور \عددی{\beta} کہ \عددی{\kvec{A}=\alpha\kvec{B}+\beta\kvec{C}} ہو۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{$\alpha=\tfrac{3}{2},\quad \beta=\tfrac{1}{2}$}}
\انتہا{جواب}
%=================
%Q42
\ابتدا{سوال}
...
%====================
\ابتدا{سوال}
 ایک پرندہ اپنے گھونسلے سے اڑ کر، مشرق سے شمال کی طرف \عددی{60^{\circ}} پر  \عددی{5} کلومیٹر دور ایک درخت پر  آرام کے لیے بیٹھتا ہے۔ اس کے بعد یہ جنوب مشرق رخ \عددی{10} کلومیٹر دور ایک کھنبے پر اڑ کر  بیٹھتا ہے۔ مستوی \عددی{xy} کے مبدا پر گھونسلا، مثبت محور \عددی{x} پر مشرق اور مثبت محور \عددی{y} پر شمال  رکھ (ا) درخت کا مقام تلاش کریں۔ (ب) کھنبے کا مقام تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
(ا) 
$(5\cos 60^{\circ},5\sin 60^{\circ})=(\tfrac{5}{2},\tfrac{5\sqrt{3}}{2})$\\
 (ب) 
$(5\cos 60^{}+10\cos 315^{},5\sin 60^{\circ}+\\10\sin 315^{\circ})=(\tfrac{5+\sqrt{2}}{2},\tfrac{5\sqrt{3}-10\sqrt{2}}{2})$
}}
\انتہا{جواب}
%===================
%Q44
\ابتدا{سوال}
 ایک پرندہ اپنے گھونسلے سے اڑ کر، شمال مشرق رخ \عددی{7} کلومیٹر دور ایک درخت پر آرام کرتا ہے۔ اس کے بعد یہ مغرب سے  \عددی{30^{\circ}} زاویہ جنوب کے رخ \عددی{8} کلومیٹر دور ایک کھنبے پر اڑ کر بیٹھتا ہے۔ مستوی \عددی{xy} کے مبدا پر گھونسلا، مثبت محور \عددی{x} پر مشرق اور مثبت محور \عددی{y} پر شمال  رکھ (ا) درخت کا مقام تلاش کریں۔ (ب) کھنبے کا مقام تلاش کریں۔
\انتہا{سوال}
%===================
\ابتدا{سوال}
مستوی میں \عددی{\kvec{v}} ایک سمتیہ ہے جو محور \عددی{y} کے متوازی نہیں ہے۔ سمتیہ \عددی{\kvec{v}} کا ڈھلوان اور سمتیہ \عددی{-\kvec{v}} کا ڈھلوان کا آپس میں کیا تعلق ہو گا؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$-\kvec{v}=-a\ai-b\aj$
...
ہم اب سہ بُعدی کارتیسی محدد بیان کرتے ہیں اور فضا میں اپنا راستہ تلاش کرنا سیکھتے ہیں۔ ہم فاصلہ کی تعریف جانیں گے،  فضا میں سمتیات کے ساتھ کام کرنا (مستوی کے قواعد اب بھی لاگو ہوں گے، پس اب ایک محدد بڑھ جائے گا)، اور نقطوں کے سلسلہ کی مساوات اور عدم مساوات کے ساتھ تعلق سیکھیں گے۔

\جزوحصہء{کارتیسی محدد} 
فضا میں نقطہ کی تلاش کے لیے تین آپس میں عمودی محددی محور استعمال کیے جاتے ہیں۔  شکل \حوالہ{شکل_سمتیہ_دایاں_کارتیسی_نظام} میں محور \عددی{Ox}، \عددی{Oy} اور \عددی{Oz} دایاں ہاتھ محددی نظام دیتے ہیں۔ دائیں ہاتھ کے نظام میں، انگوٹھے کو باقی انگلیوں کے ساتھ زاویہ قائمہ پر رکھتے ہوئے، اگر آپ اپنے دائیں ہاتھ کی چار انگلیوں کو مثبت محور \عددی{x} پر رکھ کر انہیں مثبت محور \عددی{y} کی جانب موڑیں تب آپ کا انگوٹھا مثبت محور \عددی{z} پر ہو گا۔
...
\midrule
$z\ge 0$ &
مستوی  \عددی{xy} میں اور اس سے اوپر نصف فضا میں تمام نقطے۔\\
$x=-3$&
...
سمت بند خطوط کا سلسلہ جو قوت، ہٹاؤ، اور سمتی رفتار ظاہر کرتے ہوں سمتیات کہلاتے ہیں، جیسے یہ مستوی میں کہلائے جاتے ہیں۔ سمتی مجموعہ، سمتی تفریق اور عددیہ ضرب کے وہی قواعد یہاں بھی کارآمد ہوں گے۔
...
کسی بھی سمتیات \عددی{\kvec{A}=a_1\ai+a_2\aj+a_3\ak} اور \عددی{\kvec{B}=b_1\ai+b_2\aj+b_3\ak} کے لیے درج ذیل ہوں گے۔
\begin{align*}
...
\جزوحصہء{عددیہ ضرب}
\ابتدا{تعریف}
اگر \عددی{c} عددیہ اور \عددی{\kvec{A}} ایک سمتیہ ہو تب درج ذیل ہو گا۔
\begin{align*}
...
اگر ہم سمتیہ \عددی{\kvec{A}=a_1\ai+a_2\aj+a_3\ak} کو عددیہ \عددی{c} سے ضرب دیں تب، مستوی میں عددیہ ضرب کی طرح اور انہیں وجوہات کی بنا،  \عددی{c\kvec{A}} کی لمبائی \عددی{\abs{c}} ضرب \عددی{\kvec{A}} کی لمبائی ہو گی:
\begin{gather}
\begin{aligned}
c\kvec{A}&=ca_1\ai+ca_2\aj+ca_3\ak\\
...
\جزوحصہء{اکائی سمتیات}
فضا میں اکائی سمتیہ کی لمبائی \عددی{1} ہو گی۔ اساسی سمتیات درج ذیل کی وجہ سے اکائی سمتیات ہیں۔
\begin{align*}
...
\end{tikzpicture}
\caption
{نقاط \عددی{N_1} اور \عددی{N_2} کے محدد کی اوسط قطعہ \عددی{N_1N_2} کے وسطی نقطہ کے محدد ہوں گے۔}
\label{شکل_سمتیہ_قطع_کا_وسطی_نقطہ}
\end{figure}
\جزوحصہء{وسطی نقاط}
کسی بھی قطعہ کا وسطی نقطہ اوسط کی مدد سے حاصل کیا جاتا ہے۔ نقطہ \عددی{N_1(x_1,y_1,z_1)} اور \عددی{N_2(x_2,y_2,z_2)} کا وسطی نقطہ درج ذیل ہو گا۔
\begin{align*}
...
\ابتدا{مثال}
نقطہ \عددی{N_1(3,-2,0)} اور \عددی{N_2(7,4,4,)} کو ملانے والی قطعہ کا وسطی نقطہ درج ذیل ہو گا۔
\begin{align*}
\big(\frac{3+7}{2},\frac{-2+4}{2},\frac{0+4}{2}\big)=(5,1,2)
\end{align*}
\انتہا{مثال}
%=====================
%start of sec 11.2 questions
%start of sec 11.2 questions
\حصہء{سوالات}
\ابتدا{سوالات}
...
رداس \عددی{1} اور \عددی{2} کے کرہ جن کے مراکز مبدا پر ہوں میں بند خطہ۔ (بند خطہ سے مراد ہے کہ کرہ کی سطحیں بھی اس خطہ میں شامل ہوں گی۔ کروی سطحوں کو شامل نہ کرنے کے لیے ہم آزاد خطے کی اصطلاح استعمال کرتے ہیں۔)
\انتہا{سوال}
%======================
...
\حصہ{ضرب نقطہ}
ہم اب ضرب نقطہ پر غور کرتے ہیں جو سمتیات کو آپس میں ضرب دینے کے دو طریقوں میں سے ایک ہے۔ چونکہ ضرب نقطہ کا نتیجہ عددیہ ہوتا ہے لہٰذا ضرب نقطہ کو \اصطلاح{عددیہ ضرب}\فرہنگ{عددیہ!ضرب}\فرہنگ{ضرب!عددیہ}\حاشیہب{scalar product}\فرہنگ{scalar!product} بھی کہتے ہیں۔
...
\ابتدا{تعریف}
سمتیات \عددی{\kvec{A}} اور \عددی{\kvec{B}} کے عددیہ ضرب (ضرب نقطہ) سے مراد درج ذیل عدد ہے
...
سمتیات \عددی{\kvec{A}} اور \عددی{\kvec{B}} کے ضرب نقطہ کو \عددی{\kvec{A}} اور \عددی{\kvec{B}} کے بیچ نقطہ سے ظاہر کیا جاتا ہے یعنی \عددی{\kvec{A}\cdot\kvec{B}} جس کی وجہ سے یہ ضرب نقطہ کہلاتا ہے۔
...
چونکہ عددیہ ضرب کی علامت \عددی{\cos\theta} پر منحصر ہے لہٰذا عددیہ ضرب کا نتیجہ زاویہ حادہ کی صورت میں مثبت، زاویہ منفرجہ کی صورت میں  منفی (اور زاویہ قائمہ کی صورت میں صفر ہو گا)۔
...
ایک مثلث جس کے اضلاع \عددی{\kvec{A}}، \عددی{\kvec{B}} اور \عددی{\kvec{C}} ہوں کے لیے قاعدہ کوسائن درج ذیل ہو گا (شکل \حوالہ{شکل_سمتیہ_قاعدہ_کوسائن})۔
\begin{align*}
...
\end{align}
حاصل ہوتا ہے لہٰذا دو سمتیات کا عددیہ ضرب لینے کی خاطر ہم اس کے مطابقتی \عددی{\ai}، \عددی{\aj} اور \عددی{\ak} اجزاء کو ضرب دے کر ان کا مجموعہ لیتے ہیں۔
\begin{figure}
\centering
\begin{tikzpicture}[font=\small,]
...
مساوات \حوالہ{مساوات_سمتیہ_غیر_سمتی_ضرب_تعریف} کو \عددی{\theta} کے لیے حل کر کے ان سمتیات کے بیچ زاویہ حاصل ہو گا۔
...
\end{align}
دوسرے لفظوں میں، ضرب نقطہ \اصطلاح{تعویضی}\فرہنگ{تعویضی}\حاشیہب{commutative}\فرہنگ{commutative} ہے۔ ہم مساوات \حوالہ{مساوات_سمتیہ_غیر_سمتی_ضرب_کا_کلیہ} سے  یہ بھی دیکھتے ہیں کہ مستقل (یا عددیہ) عدد \عددی{c} کی صورت میں درج ذیل ہو گا۔
...
دو غیر صفر سمتیات \عددی{\kvec{A}} اور \عددی{\kvec{B}} تب \اصطلاح{عمودی}\فرہنگ{عمودی}\حاشیہب{orthogonal}\فرہنگ{orthogonal} ہوں گے جب ان  کے بیچ زاویہ \عددی{\tfrac{\pi}{2}} ہو ۔ یوں \عددی{\cos\tfrac{\pi}{2}=0} کی وجہ سے عمودی سمتیات کے لیے \عددی{\kvec{A}\cdot\kvec{B}=0} ہو گا۔ اسی طرح  اگر \عددی{\kvec{A}} اور \عددی{\kvec{B}} غیر صفر سمتیات ہوں اور \عددی{\kvec{A}\cdot\kvec{B}=\abs{\kvec{A}}\abs{\kvec{B}}\cos\theta=0} ہو تب \عددی{\cos\theta=0} یعنی \عددی{\theta=\cos^{-1}0=\tfrac{\pi}{2}} ہو گا۔

دو غیر صفر سمتیات \عددی{\kvec{A}} اور \عددی{\kvec{B}} صرف اور صرف اس صورت عمودی ہوں گے جب \عددی{\kvec{A}\cdot\kvec{B}=0} ہو۔

\ابتدا{مثال}
سمتیات \عددی{\kvec{A}=3\ai-2\aj+\ak} اور \عددی{\kvec{B}=2\aj+4\ak} درج ذیل کی وجہ سے عمودی ہیں۔
\begin{align*}
...
عدد \عددی{\abs{\kvec{B}}\cos\theta} کو \اصطلاح{\عددی{\kvec{B}} کا \عددی{\kvec{A}} کے رخ عددیہ جزو} کہتے ہیں۔ درج ذیل کی بنا
\begin{align}\label{مساوات_سمتیہ_غیر_سمتی_جزو}
\abs{\kvec{B}}\cos\theta=\kvec{B}\cdot\frac{\kvec{A}}{\abs{\kvec{A}}}
\end{align}
ہم عددیہ جزو حاصل کرنے کی خاطر \عددی{\kvec{B}} کی ضرب نقطہ \عددی{\kvec{A}} کے رخ کے ساتھ لیں گے۔ مساوات \حوالہ{مساوات_سمتیہ_تظلیل_الف} کہتی ہے کہ \عددی{\kvec{B}} کا \عددی{\kvec{A}} پر تظلیل، \عددی{\kvec{A}} کے رخ \عددی{\kvec{B}} کے عددیہ جزو ضرب رخ \عددی{\kvec{A}} کے برابر ہو گا۔ 

جہاں مساوات \حوالہ{مساوات_سمتیہ_تظلیل_الف} کا پہلا حصہ \عددی{\kvec{A}} کے رخ \عددی{\kvec{B}} کے اثر کی بات کرتی ہے، اس کا دوسرا حصہ حساب کے لیے موزوں ہے چونکہ یہ جذر سے چھٹکارا دیتا ہے۔

\ابتدا{مثال}
سمتیہ \عددی{\kvec{B}=6\ai+3\aj+2\ak} کا \عددی{\kvec{A}=\ai-2\aj-2\ak} پر سمتی تظلیل تلاش کریں اور \عددی{\kvec{A}} کے رخ \عددی{\kvec{B}} کا عددیہ جزو تلاش کریں۔
...
\end{align*}
ہم \عددی{\kvec{A}} کے رخ \عددی{\kvec{B}} کا عددیہ جزو مساوات \حوالہ{مساوات_سمتیہ_غیر_سمتی_جزو} کی مدد سے حاصل کرتے ہیں۔
\begin{align*}
...
\begin{align*}
\kvec{B}=\frac{\kvec{B}\cdot\kvec{A}}{\kvec{A}\cdot\kvec{A}}\kvec{A}+\big(\kvec{B}-\frac{\kvec{B}\cdot\kvec{A}}{\kvec{A}\cdot\kvec{A}}\kvec{A}\big)&=\frac{5}{10}(3\ai-\aj)+\big(2\ai+\aj-3\ak-\frac{5}{10}(3\ai-\aj)\big)\\
&=\big(\frac{3}{2}\ai-\frac{1}{2}\aj\big)+\big(\frac{1}{2}\ai+\frac{3}{2}\aj-3\ak\big)
\end{align*}
آپ تسلی کر لیں کہ دائیں ہاتھ پہلا جزو \عددی{\tfrac{1}{2}\kvec{A}} کے برابر ہے۔دائیں ہاتھ دوسرا جزو درج ذیل کی وجہ سے \عددی{\kvec{A}} کو عمودی ہے۔
\begin{align*}
...
\end{tikzpicture}
\caption{ہٹاؤ \عددی{\kvec{D}} کے دوران مستقل قوت \عددی{\kvec{F}} کا کام \عددی{(\abs{\kvec{F}}\cos\theta)\abs{\kvec{D}}} ہو گا۔}
\label{شکل_سمتیہ_کام_کی_تعریف}
\end{figure}

\ابتدا{تعریف}
ہٹاؤ \عددی{\kvec{D}=\krightharpoonup{NQ}} کے دوران مستقل قوت \عددی{\kvec{F}} کا کام
\begin{align}\label{مساوات_سمتیہ_کام_کی_تعریف}
W=\kvec{F}\cdot\kvec{D}=\abs{\kvec{F}}\abs{\kvec{D}}\cos\theta
\end{align}
ہو گا جہاں ہٹاؤ اور قوت کے بیچ زاویہ \عددی{\theta} ہے۔
\انتہا{تعریف}
%====================
...
\انتہا{مثال}
%===================
%sec 11.3 questiions start here
%sec 11.3 questiions start here
\حصہء{سوالات}
\ابتدا{سوالات}
...
\item
\عددی{\kvec{A}} کے رخ \عددی{\kvec{B}} کا عددیہ جزو۔
\item
...
$
(\kvec{v}_1-\kvec{v}_2)\cdot(\kvec{v}_1+\kvec{v}_2)=\kvec{v}_1\cdot\kvec{v}_1+\\
\kvec{v}_1\cdot\kvec{v}_2-\kvec{v}_2\cdot\kvec{v}_1-\kvec{v}_2\cdot\kvec{v}_2=\\
\abs{\kvec{v}_1}^2-\abs{\kvec{v}_2}^2
$
}}
 \انتہا{جواب}
%==========
...
%===============
\ابتدا{سوال}
ثابت کریں کہ ایک متوازی الاضلاع صرف اور صرف اس صورت مستطیل ہو گا جب اس کے وتروں  کی لمبائی ایک سی  ہو۔ ترکھان اس حقیقت کو عموماً استعمال کرتا ہے۔
\انتہا{سوال}
%==========
\ابتدا{سوال}
...
%=============
\ابتدا{سوال}
ایک اہرام کے مربع قاعدہ \عددی{OABC} کے ضلع  کی لمبائی \عددی{1} اکائی ہے  اور اہرام کی چوٹی \عددی{D} ہے۔اہرام کا قد بھی \عددی{1} اکائی ہے۔ یوں نقطہ  \عددی{D} ٹھیک وتر \عددی{OB} کے وسطی نقطہ کے سیدھا اوپر  ہو گا۔ قطعہ \عددی{\krightharpoonup{OB}} اور \عددی{\krightharpoonup{OD}} کے بیچ زاویہ تلاش کریں۔
\انتہا{سوال}
\ابتدا{جواب}
\wf{\unexpanded{
$\tan^{-1}\sqrt{2}$
...
%====================
\ابتدا{سوال}
پانی کی نالی میں ایک جوڑ ہے۔اس جوڑ سے  شمال رخ نالی کا ڈھلوان \عددی{\SI{10}{\percent}} ہے جبکہ جوڑ سے مشرق رخ نالی کا ڈھلوان \عددی{\SI{20}{\percent}} ہے۔ اس جوڑ پر نالی کے دو حصوں کے بیچ زاویہ کتنا ہو گا؟
\انتہا{سوال}
%==================
%
\موٹا{نظریہ اور مثالیں}\\
...
\begin{enumerate}[a.]
\item
کسی بھی سمتیات \عددی{\kvec{u}} اور \عددی{\kvec{v}} کے لیے عدم مساوات \عددی{\abs{\kvec{u}\cdot\kvec{v}}\le \abs{\kvec{u}}\abs{\kvec{v}}} کو \عددی{\kvec{u}\cdot\kvec{v}=\abs{\kvec{u}}\abs{\kvec{v}}\cos\theta} کی مدد سے دکھائیں۔
\item
...
%==========
\ابتدا{سوال}
فرض کریں \عددی{\kvec{A}}، \عددی{\kvec{B}} اور \عددی{\kvec{C}} آپس میں عمودی اکائی سمتیات ہیں۔ اگر \عددی{\kvec{D}=\alpha\kvec{A}+\beta\kvec{B}+\gamma\kvec{C}} ہو جہاں \عددی{\alpha}، \عددی{\beta} اور \عددی{\gamma} عددیہ ہیں تب دکھائیں کہ \عددی{\alpha=\kvec{D}\cdot\kvec{A}}، \عددی{\beta=\kvec{D}\cdot\kvec{B}} اور \عددی{\gamma=\kvec{D}\cdot\kvec{C}} ہوں گے۔ 
\انتہا{سوال}
%===================
...
دکھائیں کہ سمتیہ \عددی{\kvec{v}=a\ai+b\aj} لکیر \عددی{ax+by=c} کو عمودی ہے۔ ایسا کرنے کی خاطر دکھائیں کہ اس لکیر کا ڈھلوان، اس سمتیہ کے ڈھلوان کا منفی مقلوب ہے۔
\انتہا{سوال}
%==========================
\ابتدا{سوال}\شناخت{سوال_سمتیہ_لکیر_متوازی_سمتیہ}
دکھائی کہ سمتیہ \عددی{\kvec{v}=a\ai+b\aj} لکیر \عددی{bx-ay=c} کے متوازی ہے۔ ایسا کرنے کی خاطر دکھائیں کہ لکیر کا ڈھلوان اور سمتیہ کا ڈھلوان ایک دوسرے جیسے  ہیں۔
\انتہا{سوال}
%====================
...
\انتہا{سوالات}
%sec 11.3 questions end here
%sec 11.3 questions end here

\حصہ{صلیبی ضرب}\شناخت{حصہ_صلیبی_ضرب}
...
برقیات، مقناطیسیت، صلیبی ضرب، حرکت سیال اور میکانیات مدار میں قوتوں کے اثرات پر غور میں صلیبی ضرب اہم کردار ادا کرتے ہیں۔ آئیں صلیبی ضرب کے خواص پر غور کریں۔ 
...
\end{align}
\انتہا{تعریف}
چونکہ سمتیہ \عددی{\kvec{A}\times\kvec{B}} اکائی عمودی سمتیہ \عددی{\kvec{n}} کا عددیہ مضرب ہے لہٰذا یہ \عددی{\kvec{A}} اور \عددی{\kvec{B}} دونوں کو عمودی ہو گا۔ سمتیات \عددی{\kvec{A}} اور \عددی{\kvec{B}} کے سمتی ضرب کو عموماً \عددی{\kvec{A}} اور \عددی{\kvec{B}} کا \اصطلاح{صلیبی ضرب}\فرہنگ{صلیبی!ضرب}\فرہنگ{ضرب!صلیبی}\حاشیہب{cross product}\فرہنگ{product!cross} کہتے ہیں۔ صلیبی ضرب کو صلیب کے نشان \عددی{\times} سے ظاہر کیا جاتا ہے اور اسی کی وجہ سے یہ صلیبی ضرب کہلاتا ہے۔
%=========================
...
\begin{align}
(r\kvec{A})\times (s\kvec{B})&=(rs)(\kvec{A}\times\kvec{B})&&\text{\RL{عددیہ قاعدہ حاصل تقسیم}}\label{مساوات_سمتیہ_غیر_سمتی_قاعدہ_تقسیم}\\
\kvec{A}\times (\kvec{B}+\kvec{C})&=\kvec{A}\times\kvec{B}+\kvec{A}\times\kvec{C}&&\text{\RL{سمتی قاعدہ حاصل تقسیم}}\label{مساوات_سمتیہ_سمتی_قاعدہ_تقسیم_الف}\\
(\kvec{B}+\kvec{C})\times \kvec{A}&=\kvec{B}\times \kvec{A}+\kvec{C}\times\kvec{A}&&\text{\RL{سمتی قاعدہ حاصل تقسیم}}\label{مساوات_سمتیہ_سمتی_قاعدہ_تقسیم_ب}
\end{align}
...
%==========================
\ابتدا{مثال}
صلیبی ضرب \عددی{\kvec{A}\times\kvec{B}} اور \عددی{\kvec{B}\times\kvec{A}} درج ذیل سمتیات کے لیے حاصل کریں۔
\begin{align*}
...
\جزوحصہء{عددیہ سہ ضرب}
ضرب \عددی{(\kvec{A}\times\kvec{B})\cdot \kvec{C}} کو \عددی{\kvec{A}}، \عددی{\kvec{B}} اور \عددی{\kvec{C}} کا عددیہ سہ ضرب کہتے ہیں جہاں سمتیات کی ترتیب یہی ہے۔ آپ دیکھ سکتے ہیں (شکل \حوالہ{شکل_سمتیہ_حجم_مستطیلی_متوازی_السطوح}) کہ عددیہ سہ ضرب کی مطلق قیمت
\begin{align*}
...
\end{align}
اب عددیہ ضرب تعویضی ہے لہٰذا مساوات \حوالہ{مساوات_سمتیہ_حجم_کی_مساوات} سے درج ذیل حاصل ہوتا ہے۔
\begin{align}
(\kvec{A}\times\kvec{B})\cdot\kvec{C}=\kvec{A}\cdot(\kvec{A}\times\kvec{C})
\end{align}
آپ دیکھ سکتے ہیں کہ عددیہ سہ ضرب میں سمتیات کا مقام تبدیل کیے بغیر صلیبی ضرب اور نقطہ ضرب کے مقامات کو بدلا جا سکتا ہے۔

عددیہ سہ ضرب کی قیمت مقطع سے حاصل کی جا سکتی ہے:
\begin{align*}
...
\ابتدا{جواب}
\wf{\unexpanded{
\عددی{\abs{\kvec{A}\times\kvec{B}}=6}، رخ \عددی{-\ak}؛\\
 \عددی{\abs{\kvec{B}\times\kvec{A}}=6}، رخ \عددی{\ak}
}}
 \انتہا{جواب}
%==========================
\ابتدا{سوال}
...
%======================
\ابتدا{سوال}
دکھائیں کہ ماسوائے انحطاطی صورت \عددی{\kvec{A}} اور \عددی{\kvec{B}} کے مستوی میں \عددی{(\kvec{A}\times\kvec{B})\times\kvec{C}} پایا جائے گا جبکہ \عددی{\kvec{B}} اور \عددی{\kvec{C}} کے مستوی میں \عددی{\kvec{A}\times(\kvec{B}\times\kvec{C})} پایا جائے گا۔ انحطاطی صورت کس کو کہتے ہیں؟
\انتہا{سوال}
%=====================
...
\end{align*}
 ...
 \انتہا{جواب}
%====================
\ابتدا{سوال}\ترچھا{دو گنا منسوخی}\\
...
\end{align*}
اگرمستوی  \عددی{xy} میں گھڑی کے الٹ رخ \عددی{\kvec{A}} سے \عددی{\kvec{B}} چلتے ہوئے  زاویہ حادہ  ہو تب \عددی{(+)} علامت جبکہ گھڑی کے رخ چلتے ہوئے زاویہ حادہ ہونے کی صورت میں \عددی{(-)} علامت استعمال ہو گی۔
}}
 \انتہا{جواب}
%===============
\ابتدا{سوال}
...
\end{align}
مساوات \حوالہ{مساوات_سمتیہ_خط_کی_مساوات_الف} کے دونوں اطراف مطابقتی اجزاء کو ایک دوسرے کے برابر لکھتے ہوئے تین عددیہ مساوات حاصل ہوں گے جن میں مقدار معلوم \عددی{t} پایا جائے گا:
\begin{align*}
...
دو  نقطوں کے بیچ خطی قطعہ  کی مقدار معلوم مساوات تلاش کرنے کی خاطر ہم پہلے    ان نقطوں کے بیچ خط کی مقدار معلوم مساوات حاصل کرتے ہیں۔اس کے بعد ہم قطعہ کے آخری سروں پر   \عددی{t} کی قیمتیں تلاش کر کے \عددی{t} کو ان قیمتوں کے بیچ بند وقفہ پر رہنے کا پابند بناتے ہیں۔ خط کی مساوات بشمول   پابند وقفہ قطعہ کی  مقدار معلوم مساوات ہو گی۔


%=====================
\ابتدا{مثال}
نقطہ \عددی{N(-3,2,-3)} اور \عددی{Q(1,-1,4)} کے بیچ قطعہ کی مقدار معلوم مساوات تلاش کریں۔
...
\end{align*}
  مساوات \حوالہ{مساوات_مثال_سمتیہ_الف} بشمول  \عددی{0\le t\le 1} کی پابندی  قطعہ کی مقدار معلوم مساوات ہو گی:
\begin{align*}
...
\end{tikzpicture}
\caption{سطح میں نقاط  \عددی{N_0} اور \عددی{N} کے بیچ سمتی قطعہ اور سطح کا قائمہ سمتیہ \عددی{\kvec{n}} ایک دوسرے کے عمودی ہوں گے۔}
...
آپ مثال \حوالہ{مثال_سمتیہ_مستوی_کی_مساوات} میں دیکھ سکتے ہیں کہ \عددی{\kvec{n}=5\ai+2\aj-\ak} کے  ضریب  مساوات \عددی{5x+2y-z=-22} میں \عددی{x}، \عددی{y} اور \عددی{z} کے  ضریب   کی طور پر ابھرتے ہیں۔ ایسا واقعاتی طور پر نہیں ہوا بلکہ   مساوات \حوالہ{مساوات_سمتیہ_مستوی_ب}  کو \عددی{Ax+By+Cz=D} لکھنا ممکن ہے جہاں \عددی{D=Ax_0+By_0+Cz_0} ہو گا۔یوں  
\begin{align*}
...
مساوات \عددی{3x+2y+6z=6} کے ضرائب  سے درج ذیل عمودی سمتیہ حاصل ہو گا۔
\begin{align*}
...
\end{align*}
سمتیہ \عددی{14\ai+2\aj+15\ak} کا ہر غیر صفر عددیہ مضرب بھی درست جواب ہو گا۔
\انتہا{مثال}
%================
\ابتدا{مثال}
...
%=================
\ابتدا{سوال}
وہ نقاط تلاش کریں جن پر لکیر \عددی{x=1+2t,\,y=-1-t,\,z=3t} محوری مستوی کو مس کرتی ہو۔ جواب تک پہنچنے کے لیے اپنا   طریقہ سوچ بیان کریں۔
\انتہا{سوال}
%==========
\ابتدا{جواب}
...
%====================
\ابتدا{سوال}
غیر صفر اعداد \عددی{a}، \عددی{b} اور \عددی{c} کے لیے \عددی{\tfrac{x}{a}+\tfrac{y}{b}+\tfrac{z}{c}=1} کی ترسیم ایک سطح ہو گی۔ کن سطحوں کی مساوات ایسی ہو گی؟
\انتہا{سوال}
%==========
\ابتدا{جواب}
\wf{\unexpanded{
...
%================
\ابتدا{سوال}
کمپیوٹر  تصویر کشی    کے ایک مسئلہ پر غور کرتے ہیں۔ آپ کی آنکھ \عددی{(4,0,0)} پر ہے۔آپ مثلث چادر کو دیکھ رہے ہیں جس کے راس \عددی{(1,0,1)}، \عددی{(1,1,0)}  اور  \عددی{(-2,2,2)} ہیں۔ نقطہ \عددی{(1,0,0,)} سے \عددی{(0,2,2)} تک قطعہ اس چادر  کو چھیر کر  گزرتا ہے۔ اس قطعہ  کا کون سا حصہ نظر سے اوجھل ہو گا؟
\انتہا{سوال}
%====================================
\انتہا{سوالات}
%%%%%%%%%%%%%%%%%%%%
...
نلکی یا دیگر تین بُعدی سطحوں کو ترسیم کرتے ہوئے یا قلم و کاغذ سے  ان کا خاکہ بناتے ہوئے   ان سطحوں کا محددی سطحوں  کے متوازی سطحوں کے ساتھ خط تقاطع کو دیکھنا مفید ثابت ہوتا ہے۔ ان  منحنیات کو  \اصطلاح{عمودی تراش}\فرہنگ{عمودی!تراش}\حاشیہب{cross section}\فرہنگ{cross section}  کہتے ہیں۔
...
\حل
فرض کریں مستوی \عددی{xy} میں  قطع مکافی \عددی{y=x^2} پر نقطہ \عددی{N_0(x_0,x_0^2,0)} پایا جاتا ہو۔ تب کسی بھی \عددی{z} کے لیے  چونکہ نقطہ \عددی{Q(x_0,x_0^2,z)} محور \عددی{z} کے متوازی  لکیر  \عددی{x=x_0,\,y=x_0^2}،جو نقطہ \عددی{N_0} سے گزرتی ہے،    پر پایا جائے گا  لہٰذا  \عددی{Q} اس نلکی پر پایا جائے گا (شکل \حوالہ{شکل_مثال_سمتیہ_نلکی_قطع_مکافی}-ب)۔

اس طرح  \عددی{z} کی قیمت سے قطع نظر  اس سطح پر پائے جانے والے  تمام نقاط  مساوات \عددی{y=x^2} کو مطمئن کریں گے۔ یوں \عددی{y=x^2} اس نلکی  کی مساوات ہو گی۔اس کی وجہ سے ہم اس نلکی کو \قول{نلکی \عددی{y=x^2}} کہتے ہیں۔
\انتہا{مثال}
%============
...
\end{subfigure}
\caption{
محور \عددی{x} کے متوازی  اور   مستوی \عددی{yz} میں  پائی جانے والی وہ لکیریں   جو قطع زائد \عددی{y^2-z^2=1} سے گزرتی  ہوں، قطع زائد نلکی \عددی{y^2-z^2=1} پیدا کرتی ہیں۔محور \عددی{x} کے عمودی  سطحیں اس سے قطع زائد کاٹتی ہیں۔}
...
دائری قطع مکافی سطحوں سے حصے تراش  کر بطور  ریڈیو دور بین،  مصنوعی سیارے  کے  تعاقب کار،  اور خورد امواج ریڈیو   کے اینٹینا  استعمال کیے جاتے ہیں۔
\انتہا{مثال}
%=================
\begin{figure}
\centering
...
یہ پوری سطح آپس میں جُڑی ہوئی ہے یعنی اس سطح پر چل کر  کسی ایک نقطہ سے دوسرے نقطہ تک پہنچا جا سکتا ہے۔ اسی  لیے اس کو یک چادری قطع مکافی سطح کہتے ہیں۔ اگلی مثال  میں دو چادر  کی سطح پائی جاتی ہے۔
...
\end{align*}
کے راس اور ماسکے محور \عددی{z} پر پائے  جاتے ہیں۔ یہ سطح دو حصوں میں تقسیم ہے۔ پہلا حصہ سطح \عددی{z=c} سے اوپر اور دوسرا حصہ سطح \عددی{z=-c} سے نیچے پایا جاتا ہے۔ اسی لیے اس کو دو چادری سطح کہتے ہیں۔

مساوات \حوالہ{مساوات_سمتیہ_یک_چادری_قطع_زائد} اور مساوات \حوالہ{مساوات_سمتیہ_دو_چادری_قطع_زائد} میں منفی اجزاء کی تعداد ایک سا نہیں ہے۔ دونوں  صورتوں میں منفی اجزاء کی تعداد اور چادروں کی تعداد ایک سی  ہے۔   مساوات  \حوالہ{مساوات_سمتیہ_یک_چادری_قطع_زائد}یا  مساوات \حوالہ{مساوات_سمتیہ_دو_چادری_قطع_زائد} میں دائیں ہاتھ \عددی{1} کی جگہ  \عددی{0} پر کرنے سے ترخیمی مخروط کی مساوات
\begin{align*}
\frac{x^2}{a^2}+\frac{y^2}{b^2}=\frac{z^2}{c^2}
\end{align*}
...
\حصہء{سوالات}
\ابتدا{سوالات}
\موٹا{سطحوں کی مساوات  پہچانیے}\\
سوال \حوالہ{سوال_سمتیہ_سطح_اور_مساوات_ملائیں_الف} تا سوال \حوالہ{سوال_سمتیہ_سطح_اور_مساوات_ملائیں_ڈ}   میں سطحوں کی   مساوات دی گئی ہیں۔  ان کے اشکال کو  (ا)  تا (ز) میں پہچانیے۔ سطح کی قسم (قطع مکافی سطح، قطع زائد سطح، وغیرہ) بھی پہچانیے۔
...
%====================
\ابتدا{سوال}
محور \عددی{z} کے عمودی سطحیں   ترخیمی  سطح کے دونوں سروں سے   برابر حصے کاٹ کر دکھائی  گئی  ڈرمی    پیدا کرتی ہیں۔ محور \عددی{z} کے قائمہ ، عمودی تراش دائری ہیں۔  ڈرمی  کا قد \عددی{2h}،  وسطی رداس \عددی{R} اور سروں کے رداس \عددی{r} ہیں۔ ڈرمی کے حجم کا کلیہ تلاش کریں۔ اب دو باتوں  کی تصدیق کریں۔  کیا  ڈرمی کے اطراف سیدھا کرنے سے آپ کا کلیہ، قد \عددی{2h} اور رداس \عددی{R} کے  نلکی کا حجم دیتا ہے؟  کیا \عددی{r=0} اور \عددی{h=R}  کی صورت میں، جب   ڈرمی    کی شکل ایک کرہ مانند ہو گی، آپ کا کلیہ کرہ کا حجم دیتا ہے؟
\begin{center}
\begin{tikzpicture}[]
...
\frac{x^2}{a^2}+\frac{y^2}{b^2}=\frac{z}{c}
\end{align*}
سے ایک حصہ کاٹتا ہے۔دکھائیں کہ اس حصے  کا حجم ،  حصہ کے قاعدہ کا نصف ضرب قد کے برابر ہو گا۔ (شکل \حوالہ{شکل_مثال_سمتیہ_ترخیمی_سطح} میں \عددی{h=c} کے لیے یہ حصہ دکھایا گیا ہے۔)
\انتہا{سوال}
%===================
\ابتدا{سوال}
...
\جزوحصہء{نلکی محدد}
ہم مستوی  \عددی{xy} میں قطبی محدد   کے ساتھ  محور \عددی{z} شامل کر کے فضا کی  نلکی محدد حاصل کرتے ہیں۔ہم یہاں قطبی محدد کا  رداس  \عددی{\rho} اور زاویہ   \عددی{\phi} لکھیں  گے  \حاشیہد{تا کہ ہم  \عددی{r} اور \عددی{\theta} کو کروی محدد کے لیے استعمال کر سکیں}۔ یوں فضا میں ہر نقطہ  کو   ایک یا ایک سے زیادہ  تین اعداد کی جوڑی \عددی{(\rho,\phi,z)}مختص کی جا سکتی ہے (شکل \حوالہ{شکل_سمتیہ_نقطہ_کے_نلکی_محدد})۔
\begin{figure}
\centering
...
\draw[](0,0,1)--++(\ang:1.5)--++(0,0,-2)node[pin={[align=right]-20:{\RL{سطح \عددی{\phi=\tfrac{\pi}{4}} جس کے}\\   \RL{لیے \عددی{\rho>0}}}}]{}--++(\ang:-0.5)coordinate(kb);
...
\end{tikzpicture}
\caption
{قلب نما مساوات \عددی{\rho=1+\cos\phi} فضا میں نلکی کو ظاہر کرتی ہے جس کی  عمودی تراش محور \عددی{z} کو قائمہ ہے (مثال \حوالہ{مثال_سمتیہ-قلب_نما_نلکی})۔}
...
رداس \عددی{a} کے کرہ کی کروی محدد میں  مساوات \عددی{r=a} ہو گی  جہاں کرہ کا مرکز مبدا پر ہے (شکل \حوالہ{شکل_سمتیہ_مستقل_کروی_محدد}-ا)۔ مساوات \عددی{\theta=\theta_0} ایک ترخیم کو ظاہر کرتی ہے جس کا راس مبدا پر ہے اور جس کا محور محور \عددی{z} پر ہے۔(ہم ترخیم کے تصور کو وسعت دیتے ہوئے مستوی \عددی{xy} کو ترخیم \عددی{\theta=\tfrac{\pi}{2}} تصور کرتے ہیں۔) اگر \عددی{\theta} کی قیمت \عددی{\tfrac{\pi}{2}} سے زیادہ ہو تب ترخیم نیچے رخ کھلتا ہے۔کروی محدد میں بالکل نلکی محدد کی طرح \عددی{\phi=\phi_0}  اس سطح کو ظاہر کرتی ہے جس میں محور \عددی{z} شامل ہو اور  جو مثبت محور \عددی{x} کے ساتھ زاویہ \عددی{\phi_0} بناتا ہو۔
...
\حل
پہلا حل جیومیٹری استعمال کرتے ہوئے حاصل کرتے ہیں۔ ترخیم محور \عددی{z} کے لحاظ سے تشاکلی ہے اور مستوی \عددی{yz} کے ربع  اول  کو خط \عددی{z=y} میں قطع کرتا ہے۔یوں مثبت محور \عددی{z}  اور  ترخیم کے بیچ زاویہ \عددی{\tfrac{\pi}{4}} ہو گا۔ترخیم ان نقطوں پر مبنی ہے جن کے کروی محدد \عددی{\theta} کی قیمت \عددی{\tfrac{\pi}{4}} ہے لہٰذا اس کی مساوات \عددی{\theta=\tfrac{\pi}{4}} ہو گی۔
...
سوال \حوالہ{سوال_سمتیہ_عدم_مساوات_الف} تا سوال \حوالہ{سوال_سمتیہ_عدم_مساوات_ب} میں کسی ایک محددی نظام (کارتیسی، نلکی، کروی) میں دی گئی مساوات  اور  عدم مساوات کو باقی دو محددی نظام میں لکھیں۔ ان اشکال کو پہچانیے۔
...
نلکی محدد میں مساوات \عددی{\rho=f(z)}  ایک سطح کو ظاہر کرتی ہے۔ اس سطح میں کون سی تشاکلی پائی جائے گی؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
%==========
\ابتدا{جواب}
\wf{\unexpanded{
...
\begin{enumerate}[a.]
\item
دی گئی مساوات کو \عددی{\rho} (نلکی محدد)   یا \عددی{r}  (کروی محدد) کے لیے حل کریں۔ مثبت  جذر کا فقرہ منتخب کرتے ہوئے  اس کی سادہ صورت دریافت کریں۔
\item
\عددی{\rho} بالمقابل \عددی{\phi} اور \عددی{z} یا \عددی{r} بالمقابل \عددی{\theta} اور \عددی{\phi} ترسیم کریں (جیسا مناسب ہو)۔ ترسیم کے لیے دیا گیا وقفہ استعمال کریں۔
\item
