...
%=====================
\ابتدا{سوال}
سطح \عددی{z=3} میں اس خط کی مساوات تلاش کریں جو \عددی{\ai} کے ساتھ \عددی{\tfrac{\pi}{6}} ریڈیئن اور \عددی{\ai} کے ساتھ \عددی{\tfrac{\pi}{3}} ریڈیئن زاویہ بناتا ہو۔ اپنے طریقہ سوچ بیان کریں۔
\انتہا{سوال}
%====================
\ابتدا{سوال}
