...
\ابتدا{جواب}
\wf{\unexpanded{
\عددی{x^2+y^2+(z-5/2)^2=25/4}، \عددی{\rho^2+z^2=5z}، رداس \عددی{5/2} کا کرہ جس کا مرکز \عددی{(0,0,5/2)} ہے۔
}}
\انتہا{جواب}
\انتہا{سوال}
%==================
...
\ابتدا{جواب}
\wf{\unexpanded{
\عددی{z=4-4(x^2+y^2)}، \عددی{0\le z\le 4}؛ \عددی{r\cos\theta=4-4\rho^2\sin^2\theta}، \عددی{0\le \theta\le \pi/2}، قطع مکافی سطح  \عددی{z=4-4(x^2+y^2)} کا بالائی حصہ جس کو مستوی \عددی{xy} کاٹتا ہے۔
}}
\انتہا{جواب}
\انتہا{سوال}
%==================
