...
$x^2+y^2+z^2\le4$&
ٹھوس کرہ جو \عددی{x^2+y^2+z^2=4} کے سطح اور اندرون پر مشتمل ہو۔\\
$x^2+y^2+z^2>4$&
...
(ج) 
$x^2+y^2\le 1,\,$
جہاں \عددی{x} پر کوئی شرط لاگو نہیں ہے۔
\انتہا{سوال}
%==================
\ابتدا{سوال}
(ا)
...
%=============
\ابتدا{سوال}
ایک مستوی جو نقطہ \عددی{(3,-1,1)} پر (ا) مستوی \عددی{xy}، (ب) مستوی \عددی{yz}، (ج) مستوی \عددی{xz} کو عمودی ہے۔ 
\انتہا{سوال}
%=============
\ابتدا{سوال}
...
%================
\ابتدا{سوال}
وہ دائرہ جس کا رداس \عددی{1} اور مرکز \عددی{(-3,4,1)} ہو اور جو (ا) مستوی \عددی{xy}، (ب) مستوی \عددی{yz}، (ج) مستوی \عددی{xz} کے متوازی ہو۔
\انتہا{سوال}
%================
\ابتدا{سوال}
...
%=================
\ابتدا{سوال}
فضا میں وہ نقطے جن کا فاصلہ مبدا اور نقطہ \عددی{(0,2,0)} سے یکساں ہو۔  
\انتہا{سوال}
%=============
\ابتدا{سوال}
وہ دائرہ جس میں نقطہ \عددی{(1,1,3)} سے گزرتا ہوا ایسا مستوی جو محور \عددی{z} کے عمودی ہو ایک ایسے دائرہ کو جا ملتا ہے  جس کا رداس \عددی{5} اور مرکز \عددی{(0,0,0)} ہیں۔
\انتہا{سوال}
%==================
