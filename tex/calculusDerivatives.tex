...
\ابتدا{قانون}\موٹا{مستقل کا تفرق}\\
...
\ابتدا{قانون}\موٹا{قاعدہ طاقت برائے مثبت عدد صحیح}\\
...
\ابتدا{قانون}\موٹا{قاعدہ مستقل مضرب}\\
...
%======================
\ابتدا{مثال}
قابل تفرق تفاعل کے منفی کا تفرق اس تفاعل کے تفرق کا منفی ہو گا۔قاعدہ تین میں \عددی{c=-1} لیتے ہوئے درج ذیل ملتا ہے۔
\begin{align*}
