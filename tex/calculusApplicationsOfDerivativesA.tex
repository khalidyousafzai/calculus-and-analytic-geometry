...
%==================
\ابتدا{سوال}
فرض کریں کہ \عددی{f(x)} اور \عددی{g(x)} قابل تفرق ہیں جنہیں شکل میں دکھایا گیا ہے۔ ان کے بیچ زیادہ سے زیادہ فاصلہ نقطہ \عددی{x=c} پر پایا جاتا ہے۔کیا اس نقطے پر ان تفاعل کے مماس میں کوئی خاص بات پائی جاتی ہے؟ اپنے جواب کی وجہ پیش کریں۔
\انتہا{سوال}
%===================
