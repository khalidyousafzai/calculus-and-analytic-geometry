...
مروڑ کا ایک مقبول کلیہ جو اعلٰی  نصاب میں  حاصل کیا جاتا ہے درج ذیل ہے جہاں ایک نقطہ، \عددی{t} کے لحاظ سے ایک تفرق کو ظاہر کرتا ہے۔ یوں \عددی{\dot{x}=\tfrac{\dif x}{\dif t}}، \عددی{\ddot{x}=\tfrac{\dif^{\,2}x}{\dif t^2}} اور \عددی{\dddot{x}=\tfrac{\dif^{\,3}x}{\dif t^3}} ہوں گے۔ 
