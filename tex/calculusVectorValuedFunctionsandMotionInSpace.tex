...
چونکہ زیر بحث منحنیات کے لیے \عددی{\tfrac{\dif s}{\dif t}>0} ہے  لہٰذا \عددی{s} ایک ایک مطابقت رکھتا ہے اور اس کا الٹ پایا جائے گا جو \عددی{t}  کو بطور \عددی{s} کا قابل تفرق تفاعل دے گا (حصہ \حوالہ{حصہ_استعمال_تکمل_الٹ_تفاعل_اور_ان_کے_تفرق})۔ اس الٹ کا تفرق درج ذیل ہو گا۔
