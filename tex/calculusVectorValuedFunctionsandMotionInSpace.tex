...
قوت کشش، بریک  یا انجن کی طاقت کی وجہ سے کسی جسم کی اسراع کے مماسی جزو میں ہم عموماً دلچسپی رکھتے ہیں جو اس قوت کی وجہ سے پیدا ہوتی ہے۔ہم زنجیری قاعدہ استعمال کرتے ہوئے \عددی{\kvec{v}} کے لئے
\begin{align*}
...
درج ذیل حرکت کے لئے \عددی{\kvec{T}} اور \عددی{\kvec{N}} حاصل کیے بغیر اسراع \عددی{\kvec{a}=a_T\kvec{T}+a_N\kvec{N}} روپ میں لکھیں۔
\begin{align*}
...
%=========
\ابتدا{سوال}
دکھائیں کہ ترخیم \عددی{x=a\cos t,\,y=b\sin t,\, a>b>0} کا  زیادہ سے زیادہ انحنا اس کے محور اکبر پر اور کم سے کم انحنا اس کے  محور اصغر  پر ہو گا۔(گزشتہ سوال کی طرح یہ حقیقت بھی ہر ترخیم کے لئے درست ہو گی۔)
\انتہا{سوال}
%===========
